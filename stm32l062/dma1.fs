...
[ifndef] DMA1_DEF
  ...
  [ifdef] DMA1_CSELR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DMA1_C1S                       \ [0x00 : 4] DMA channel 1 selection
    $04 constant DMA1_C2S                       \ [0x04 : 4] DMA channel 2 selection
    $08 constant DMA1_C3S                       \ [0x08 : 4] DMA channel 3 selection
    $0c constant DMA1_C4S                       \ [0x0c : 4] DMA channel 4 selection
    $10 constant DMA1_C5S                       \ [0x10 : 4] DMA channel 5 selection
    $14 constant DMA1_C6S                       \ [0x14 : 4] DMA channel 6 selection
    $18 constant DMA1_C7S                       \ [0x18 : 4] DMA channel 7 selection
  [then]
