...
$00010000 constant TIM3_SMCR_SMS_3                                  \ Slave mode selection bit3
...
$00008000 constant TIM3_CCMR2_OUTPUT_O24CE                          \ Output compare 4 clear enable
$00010000 constant TIM3_CCMR2_OUTPUT_OC3M_3                         \ Output compare 3 mode bit3
$01000000 constant TIM3_CCMR2_OUTPUT_OC4M_3                         \ Output compare 4 mode bit3
...
$00008000 constant TIM3_CCER_CC4NP                                  \ Capture/Compare 3 output Polarity
...
$0000ffff constant TIM3_CNT_CNTL                                    \ Low counter value
$7fff0000 constant TIM3_CNT_CNTH                                    \ High counter value
$80000000 constant TIM3_CNT_CNT_OR_UIFCPY                           \ if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access
...
$0000ffff constant TIM3_ARR_ARRL                                    \ Low Auto-reload value
$ffff0000 constant TIM3_ARR_ARRH                                    \ High Auto-reload value
...
$0000ffff constant TIM3_CCR1_CCR1L                                  \ Low Capture/Compare 1 value
$ffff0000 constant TIM3_CCR1_CCR1H                                  \ High Capture/Compare 1 value (on TIM2)
...
$0000ffff constant TIM3_CCR2_CCR2L                                  \ Low Capture/Compare 2 value
$ffff0000 constant TIM3_CCR2_CCR2H                                  \ High Capture/Compare 2 value (on TIM2)
...
$0000ffff constant TIM3_CCR3_CCR3L                                  \ Low Capture/Compare value
$ffff0000 constant TIM3_CCR3_CCR3H                                  \ High Capture/Compare value (on TIM2)
...
$0000ffff constant TIM3_CCR4_CCR4L                                  \ Low Capture/Compare value
$ffff0000 constant TIM3_CCR4_CCR4H                                  \ High Capture/Compare value (on TIM2)
