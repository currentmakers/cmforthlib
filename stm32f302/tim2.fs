...
$00010000 constant TIM2_SMCR_SMS_3                                  \ Slave mode selection bit3
...
$00008000 constant TIM2_CCMR2_OUTPUT_O24CE                          \ Output compare 4 clear enable
$00010000 constant TIM2_CCMR2_OUTPUT_OC3M_3                         \ Output compare 3 mode bit3
$01000000 constant TIM2_CCMR2_OUTPUT_OC4M_3                         \ Output compare 4 mode bit3
...
$7fff0000 constant TIM2_CNT_CNTH                                    \ High counter value
$80000000 constant TIM2_CNT_CNT_OR_UIFCPY                           \ if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access
...
$ffff0000 constant TIM2_CCR1_CCR1H                                  \ High Capture/Compare 1 value (on TIM2)
...
$ffff0000 constant TIM2_CCR2_CCR2H                                  \ High Capture/Compare 2 value (on TIM2)
...
$ffff0000 constant TIM2_CCR3_CCR3H                                  \ High Capture/Compare value (on TIM2)
...
$ffff0000 constant TIM2_CCR4_CCR4H                                  \ High Capture/Compare value (on TIM2)
