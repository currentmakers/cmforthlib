...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_SMCR_DEF
    ...
    $10 constant TIM2_SMS_3                     \ [0x10] Slave mode selection bit3
  [then]
  ...
  [ifdef] TIM2_CCMR2_Output_DEF
    ...
    $0f constant TIM2_O24CE                     \ [0x0f] Output compare 4 clear enable
    $10 constant TIM2_OC3M_3                    \ [0x10] Output compare 3 mode bit3
    $18 constant TIM2_OC4M_3                    \ [0x18] Output compare 4 mode bit3
  [then]
  ...
  [ifdef] TIM2_CCER_DEF
    ...
    $0f constant TIM2_CC4NP                     \ [0x0f] Capture/Compare 3 output Polarity
  [then]
  ...
  [ifdef] TIM2_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CNTL                      \ [0x00 : 16] Low counter value
    $10 constant TIM2_CNTH                      \ [0x10 : 15] High counter value
    $1f constant TIM2_CNT_or_UIFCPY             \ [0x1f] if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access
  [then]
  ...
  [ifdef] TIM2_ARR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_ARRL                      \ [0x00 : 16] Low Auto-reload value
    $10 constant TIM2_ARRH                      \ [0x10 : 16] High Auto-reload value
  [then]
  ...
  [ifdef] TIM2_CCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CCR1L                     \ [0x00 : 16] Low Capture/Compare 1 value
    $10 constant TIM2_CCR1H                     \ [0x10 : 16] High Capture/Compare 1 value (on TIM2)
  [then]
  ...
  [ifdef] TIM2_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CCR2L                     \ [0x00 : 16] Low Capture/Compare 2 value
    $10 constant TIM2_CCR2H                     \ [0x10 : 16] High Capture/Compare 2 value (on TIM2)
  [then]
  ...
  [ifdef] TIM2_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CCR3L                     \ [0x00 : 16] Low Capture/Compare value
    $10 constant TIM2_CCR3H                     \ [0x10 : 16] High Capture/Compare value (on TIM2)
  [then]
  ...
  [ifdef] TIM2_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CCR4L                     \ [0x00 : 16] Low Capture/Compare value
    $10 constant TIM2_CCR4H                     \ [0x10 : 16] High Capture/Compare value (on TIM2)
  [then]
