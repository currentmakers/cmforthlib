...
[ifndef] TIM17_DEF
  ...
  [ifdef] TIM17_DIER_DEF
    ...
    $06 constant TIM17_TIE                      \ [0x06] Trigger interrupt enable
    ...
    $0e constant TIM17_TDE                      \ [0x0e] Trigger DMA request enable
  [then]
  ...
  [ifdef] TIM17_CCMR1_Output_DEF
    ...
    $10 constant TIM17_OC1M_3                   \ [0x10] Output Compare 1 mode
  [then]
