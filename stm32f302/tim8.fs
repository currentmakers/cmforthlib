...
[ifndef] TIM8_DEF
  ...
  [ifdef] TIM8_SMCR_DEF
    ...
    $10 constant TIM8_SMS3                      \ [0x10] Slave mode selection bit 3
  [then]
  ...
  [ifdef] TIM8_SR_DEF
    ...
    $10 constant TIM8_C5IF                      \ [0x10] Capture/Compare 5 interrupt flag
    $11 constant TIM8_C6IF                      \ [0x11] Capture/Compare 6 interrupt flag
  [then]
  ...
  [ifdef] TIM8_CCMR1_Input_DEF
    ...
    \
    $00 constant TIM8_CC1S                      \ [0x00 : 2] Capture/Compare 1 selection
    $02 constant TIM8_IC1PCS                    \ [0x02 : 2] Input capture 1 prescaler
  ...
  [ifdef] TIM8_CCMR2_Output_DEF
    ...
    $18 constant TIM8_OC4M_3                    \ [0x18] Output Compare 4 mode bit 3
  [then]
  ...
  [ifdef] TIM8_CCER_DEF
    ...
    $0f constant TIM8_CC4NP                     \ [0x0f] Capture/Compare 4 output Polarity
  ...
  [ifdef] TIM8_RCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_REP                       \ [0x00 : 16] Repetition counter value
  [then]
  ...
  [ifdef] TIM8_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_CCR3                      \ [0x00 : 16] Capture/Compare 3 value
  [then]
  ...
  [ifdef] TIM8_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_CCR4                      \ [0x00 : 16] Capture/Compare 3 value
  [then]
  ...
  [ifdef] TIM8_CCMR3_Output_DEF
    ...
    $10 constant TIM8_OC5M_3                    \ [0x10] Outout Compare 5 mode bit 3
    $18 constant TIM8_OC6M_3                    \ [0x18] Outout Compare 6 mode bit 3
  [then]
  ...
  [ifdef] TIM8_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_TIM8_ETR_ADC2_RMP         \ [0x00 : 2] TIM8_ETR_ADC2 remapping capability
    $02 constant TIM8_TIM8_ETR_ADC3_RMP         \ [0x02 : 2] TIM8_ETR_ADC3 remapping capability
  [then]
  ...
  $18 constant TIM8_CCMR1_OUTPUT        \ capture/compare mode register (output mode)
  $18 constant TIM8_CCMR1_INPUT         \ capture/compare mode register 1 (input mode)
  $1C constant TIM8_CCMR2_OUTPUT        \ capture/compare mode register (output mode)
  ...
  $5C constant TIM8_CCR6                \ capture/compare register 6
  $60 constant TIM8_OR                  \ option registers
