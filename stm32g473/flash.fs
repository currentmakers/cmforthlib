...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_ACR_DEF
    ...
    $12 constant FLASH_DBG_SWEN                 \ [0x12] Debug software enable
  [then]
  ...
  [ifdef] FLASH_CR_DEF
    ...
    $1c constant FLASH_SEC_PROT1                \ [0x1c] SEC_PROT1
  ...
  [ifdef] FLASH_ECCR_DEF
    ...
    $18 constant FLASH_ECCIE                    \ [0x18] ECCIE
  ...
  [ifdef] FLASH_OPTR_DEF
    ...
    $19 constant FLASH_CCMSRAM_RST              \ [0x19] CCM SRAM Erase when system reset
    $1a constant FLASH_nSWBOOT0                 \ [0x1a] nSWBOOT0
    $1b constant FLASH_nBOOT0                   \ [0x1b] nBOOT0
    $1c constant FLASH_NRST_MODE                \ [0x1c : 2] NRST_MODE
    $1e constant FLASH_IRHEN                    \ [0x1e] IRHEN
  [then]
  ...
  [ifdef] FLASH_PCROP1SR_DEF
    ...
    \
    $00 constant FLASH_PCROP1_STRT              \ [0x00 : 15] Bank 1 PCROP area start offset
  [then]
  ...
  [ifdef] FLASH_PCROP1ER_DEF
    ...
    \
    $00 constant FLASH_PCROP1_END               \ [0x00 : 15] Bank 1 PCROP area end offset
  ...
  [ifdef] FLASH_SEC1R_DEF
    \
    \ @brief securable area bank1 register
    \ Address offset: 0x70
    \ Reset value: 0xFF00FF00
    \
    $00 constant FLASH_SEC_SIZE1                \ [0x00 : 8] SEC_SIZE1
    $10 constant FLASH_BOOT_LOCK                \ [0x10] BOOT_LOCK
  [then]
  ...
  $70 constant FLASH_SEC1R              \ securable area bank1 register
