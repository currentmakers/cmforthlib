...
[ifndef] TIM4_DEF
  ...
  [ifdef] TIM4_TIM4_CR2_DEF
    ...
    $04 constant TIM4_MMS                       \ [0x04 : 3] MMS[2:0]: Master mode selection
  ...
  [ifdef] TIM4_TIM4_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_SMS                       \ [0x00 : 3] SMS[2:0]: Slave mode selection
    $03 constant TIM4_OCCS                      \ [0x03] OCREF clear selection
    $04 constant TIM4_TS                        \ [0x04 : 3] TS[2:0]: Trigger selection
  ...
  [ifdef] TIM4_TIM4_CCMR1_ALTERNATE1_DEF
    \
    \ @brief TIM4 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM4_TIM4_CCMR2_ALTERNATE1_DEF
    \
    \ @brief TIM4 capture/compare mode register 2
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM4_TIM4_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CNT                       \ [0x00 : 16] Counter value
    $1f constant TIM4_UIFCPY                    \ [0x1f] Value depends on IUFREMAP in TIMx_CR1.
  [then]
  ...
  [ifdef] TIM4_TIM4_ARR_DEF
    ...
    \
    $00 constant TIM4_ARR                       \ [0x00 : 20] Low Auto-reload value
  [then]
  ...
  [ifdef] TIM4_TIM4_CCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR1                      \ [0x00 : 20] Capture/compare 1 value
  [then]
  ...
  [ifdef] TIM4_TIM4_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR2                      \ [0x00 : 20] Capture/compare 1 value
  [then]
  ...
  [ifdef] TIM4_TIM4_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR3                      \ [0x00 : 20] Capture/compare 3 value
  [then]
  ...
  [ifdef] TIM4_TIM4_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR4                      \ [0x00 : 20] Capture/compare 4 value
  [then]
  ...
  $18 constant TIM4_TIM4_CCMR1_ALTERNATE1    \ TIM4 capture/compare mode register 1
  $1C constant TIM4_TIM4_CCMR2          \ TIM4 capture/compare mode register 2
  $1C constant TIM4_TIM4_CCMR2_ALTERNATE1    \ TIM4 capture/compare mode register 2
