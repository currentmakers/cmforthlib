...
[ifndef] GPIOE_DEF
  ...
  [ifdef] GPIOE_GPIOE_ODR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIOE_OD0                      \ [0x00] Port output data I/O pin y
    $01 constant GPIOE_OD1                      \ [0x01] Port output data I/O pin y
    $02 constant GPIOE_OD2                      \ [0x02] Port output data I/O pin y
    $03 constant GPIOE_OD3                      \ [0x03] Port output data I/O pin y
    $04 constant GPIOE_OD4                      \ [0x04] Port output data I/O pin y
    $05 constant GPIOE_OD5                      \ [0x05] Port output data I/O pin y
    $06 constant GPIOE_OD6                      \ [0x06] Port output data I/O pin y
    $07 constant GPIOE_OD7                      \ [0x07] Port output data I/O pin y
    $08 constant GPIOE_OD8                      \ [0x08] Port output data I/O pin y
    $09 constant GPIOE_OD9                      \ [0x09] Port output data I/O pin y
    $0a constant GPIOE_OD10                     \ [0x0a] Port output data I/O pin y
    $0b constant GPIOE_OD11                     \ [0x0b] Port output data I/O pin y
    $0c constant GPIOE_OD12                     \ [0x0c] Port output data I/O pin y
    $0d constant GPIOE_OD13                     \ [0x0d] Port output data I/O pin y
    $0e constant GPIOE_OD14                     \ [0x0e] Port output data I/O pin y
    $0f constant GPIOE_OD15                     \ [0x0f] Port output data I/O pin y
  [then]
  ...
  [ifdef] GPIOE_GPIOE_HSLVR_DEF
    \
    \ @brief GPIO high-speed low-voltage register
    \ Address offset: 0x2C
    \ Reset value: 0x00000000
    \
    $00 constant GPIOE_HSLV0                    \ [0x00] Port x high-speed low-voltage configuration
    $01 constant GPIOE_HSLV1                    \ [0x01] Port x high-speed low-voltage configuration
    $02 constant GPIOE_HSLV2                    \ [0x02] Port x high-speed low-voltage configuration
    $03 constant GPIOE_HSLV3                    \ [0x03] Port x high-speed low-voltage configuration
    $04 constant GPIOE_HSLV4                    \ [0x04] Port x high-speed low-voltage configuration
    $05 constant GPIOE_HSLV5                    \ [0x05] Port x high-speed low-voltage configuration
    $06 constant GPIOE_HSLV6                    \ [0x06] Port x high-speed low-voltage configuration
    $07 constant GPIOE_HSLV7                    \ [0x07] Port x high-speed low-voltage configuration
    $08 constant GPIOE_HSLV8                    \ [0x08] Port x high-speed low-voltage configuration
    $09 constant GPIOE_HSLV9                    \ [0x09] Port x high-speed low-voltage configuration
    $0a constant GPIOE_HSLV10                   \ [0x0a] Port x high-speed low-voltage configuration
    $0b constant GPIOE_HSLV11                   \ [0x0b] Port x high-speed low-voltage configuration
    $0c constant GPIOE_HSLV12                   \ [0x0c] Port x high-speed low-voltage configuration
    $0d constant GPIOE_HSLV13                   \ [0x0d] Port x high-speed low-voltage configuration
    $0e constant GPIOE_HSLV14                   \ [0x0e] Port x high-speed low-voltage configuration
    $0f constant GPIOE_HSLV15                   \ [0x0f] Port x high-speed low-voltage configuration
  [then]
  ...
  [ifdef] GPIOE_GPIOE_SECCFGR_DEF
    ...
    \
    $00 constant GPIOE_SEC0                     \ [0x00] I/O pin of Port x secure bit enable y
    $01 constant GPIOE_SEC1                     \ [0x01] I/O pin of Port x secure bit enable y
    $02 constant GPIOE_SEC2                     \ [0x02] I/O pin of Port x secure bit enable y
    $03 constant GPIOE_SEC3                     \ [0x03] I/O pin of Port x secure bit enable y
    $04 constant GPIOE_SEC4                     \ [0x04] I/O pin of Port x secure bit enable y
    $05 constant GPIOE_SEC5                     \ [0x05] I/O pin of Port x secure bit enable y
    $06 constant GPIOE_SEC6                     \ [0x06] I/O pin of Port x secure bit enable y
    $07 constant GPIOE_SEC7                     \ [0x07] I/O pin of Port x secure bit enable y
    $08 constant GPIOE_SEC8                     \ [0x08] I/O pin of Port x secure bit enable y
    $09 constant GPIOE_SEC9                     \ [0x09] I/O pin of Port x secure bit enable y
    $0a constant GPIOE_SEC10                    \ [0x0a] I/O pin of Port x secure bit enable y
    $0b constant GPIOE_SEC11                    \ [0x0b] I/O pin of Port x secure bit enable y
    $0c constant GPIOE_SEC12                    \ [0x0c] I/O pin of Port x secure bit enable y
    $0d constant GPIOE_SEC13                    \ [0x0d] I/O pin of Port x secure bit enable y
    $0e constant GPIOE_SEC14                    \ [0x0e] I/O pin of Port x secure bit enable y
    $0f constant GPIOE_SEC15                    \ [0x0f] I/O pin of Port x secure bit enable y
  [then]
  ...
  $2C constant GPIOE_GPIOE_HSLVR        \ GPIO high-speed low-voltage register
