...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_RTC_MISR_DEF
    ...
    $01 constant RTC_ALRBMF                     \ [0x01] Alarm B nonsecure masked flag
    $02 constant RTC_WUTMF                      \ [0x02] Wake-up timer nonsecure masked flag
    $03 constant RTC_TSMF                       \ [0x03] Timestamp nonsecure masked flag
    $04 constant RTC_TSOVMF                     \ [0x04] Timestamp overflow nonsecure masked flag
    $05 constant RTC_ITSMF                      \ [0x05] Internal timestamp nonsecure masked flag
    $06 constant RTC_SSRUMF                     \ [0x06] SSR underflow nonsecure masked flag
  [then]
  ...
  $54 constant RTC_RTC_MISR             \ RTC nonsecure masked interrupt status register
