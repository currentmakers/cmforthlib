...
[ifndef] SDMMC_DEF
  ...
  [ifdef] SDMMC_SDMMC_STAR_DEF
    ...
    $0c constant SDMMC_DPSMACT                  \ [0x0c] Data path state machine active, i.
    $0d constant SDMMC_CPSMACT                  \ [0x0d] Command path state machine active, i.
  ...
  [ifdef] SDMMC_SDMMC_IDMALAR_DEF
    ...
    $1e constant SDMMC_ULS                      \ [0x1e] Update SDMMC_IDMABSIZE from the next linked list when in linked list mode (SDMMC_IDMACTRLR.
    $1f constant SDMMC_ULA                      \ [0x1f] Update SDMMC_IDMALAR from linked list when in linked list mode (SDMMC_IDMACTRLR.
  [then]
