...
[ifndef] LPTIM2_DEF
  ...
  [ifdef] LPTIM2_LPTIM2_ISR_ALTERNATE1_DEF
    \
  ...
  [ifdef] LPTIM2_LPTIM2_ICR_ALTERNATE1_DEF
    \
  ...
  [ifdef] LPTIM2_LPTIM2_DIER_ALTERNATE1_DEF
    \
  ...
  \ @brief LPTIM2 address block description
  \
  $00 constant LPTIM2_LPTIM2_ISR        \ LPTIM2 interrupt and status register [alternate]
  $00 constant LPTIM2_LPTIM2_ISR_ALTERNATE1    \ LPTIM2 interrupt and status register
  $04 constant LPTIM2_LPTIM2_ICR        \ LPTIM2 interrupt clear register [alternate]
  $04 constant LPTIM2_LPTIM2_ICR_ALTERNATE1    \ LPTIM2 interrupt clear register
  $08 constant LPTIM2_LPTIM2_DIER       \ LPTIM2 interrupt enable register [alternate]
  $08 constant LPTIM2_LPTIM2_DIER_ALTERNATE1    \ LPTIM2 interrupt enable register
  $0C constant LPTIM2_LPTIM_CFGR        \ LPTIM configuration register
  $10 constant LPTIM2_LPTIM_CR          \ LPTIM control register
  $14 constant LPTIM2_LPTIM_CCR1        \ LPTIM compare register 1
  $18 constant LPTIM2_LPTIM_ARR         \ LPTIM autoreload register
  $1C constant LPTIM2_LPTIM_CNT         \ LPTIM counter register
  $24 constant LPTIM2_LPTIM_CFGR2       \ LPTIM configuration register 2
  $28 constant LPTIM2_LPTIM_RCR         \ LPTIM repetition register
  $2C constant LPTIM2_LPTIM_CCMR1       \ LPTIM capture/compare mode register 1
  $34 constant LPTIM2_LPTIM_CCR2        \ LPTIM compare register 2
