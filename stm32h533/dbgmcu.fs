...
$00000002 constant DBGMCU_DBGMCU_CR_DBG_STOP                        \ Allows debug in Stop mode
$00000004 constant DBGMCU_DBGMCU_CR_DBG_STANDBY                     \ Allows debug in Standby mode
$00000010 constant DBGMCU_DBGMCU_CR_TRACE_IOEN                      \ trace pin enable
$00000020 constant DBGMCU_DBGMCU_CR_TRACE_EN                        \ trace port and clock enable.
$000000c0 constant DBGMCU_DBGMCU_CR_TRACE_MODE                      \ trace pin assignment
$00010000 constant DBGMCU_DBGMCU_CR_DCRT                            \ Debug credentials reset type
...
$0000ffff constant DBGMCU_DBGMCU_SR_AP_PRESENT                      \ Bit n identifies whether access port AP n is present in device
$ffff0000 constant DBGMCU_DBGMCU_SR_AP_ENABLED                      \ Bit n identifies whether access port AP n is open (can be accessed via the debug port) or locked (debug access to the AP is blocked)
...
$00000000 constant DBGMCU_DBGMCU_DBG_AUTH_HOST_MESSAGE              \ Debug host to device mailbox message.
...
$00000000 constant DBGMCU_DBGMCU_DBG_AUTH_DEVICE_MESSAGE            \ Device to debug host mailbox message.
...
$00000001 constant DBGMCU_DBGMCU_DBG_AUTH_ACK_HOST_ACK              \ Host to device acknowledge.
$00000002 constant DBGMCU_DBGMCU_DBG_AUTH_ACK_DEV_ACK               \ Device to host acknowledge.
