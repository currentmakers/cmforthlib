...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_TIM2_CR2_DEF
    ...
    $04 constant TIM2_MMS                       \ [0x04 : 3] MMS[0]: Master mode selection
    $07 constant TIM2_TI1S                      \ [0x07] tim_ti1 selection
    $19 constant TIM2_MMS_1                     \ [0x19] MMS[3]
    $1c constant TIM2_ADSYNC                    \ [0x1c] ADC synchronization
  [then]
  ...
  [ifdef] TIM2_TIM2_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_SMS                       \ [0x00 : 3] SMS[0]: Slave mode selection
    $03 constant TIM2_OCCS                      \ [0x03] OCREF clear selection
    $04 constant TIM2_TS                        \ [0x04 : 3] TS[0]: Trigger selection
