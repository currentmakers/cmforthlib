...
[ifndef] UCPD_DEF
  ...
  [ifdef] UCPD_UCPD_CFGR2_DEF
    ...
    $03 constant UCPD_WUPEN                     \ [0x03] Wakeup from Stop mode enable
  [then]
  ...
  [ifdef] UCPD_UCPD_RX_ORDSETR_DEF
    ...
    $03 constant UCPD_RXSOP3OF4                 \ [0x03] The bit indicates the number of correct K-codes. For debug purposes only.
