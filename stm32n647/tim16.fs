...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_TIM16_CR1_DEF
    ...
    $0c constant TIM16_DITHEN                   \ [0x0c] Dithering enable
  [then]
  ...
  [ifdef] TIM16_TIM16_CR2_DEF
    ...
    $08 constant TIM16_OIS1                     \ [0x08] Output Idle state 1 (tim_oc1 output)
    $09 constant TIM16_OIS1N                    \ [0x09] Output Idle state 1 (tim_oc1n output)
  [then]
  ...
  [ifdef] TIM16_TIM16_CCMR1_OUTPUT_DEF
    ...
    $04 constant TIM16_OC1M                     \ [0x04 : 3] OC1M[2:0]: Output Compare 1 mode
  ...
  [ifdef] TIM16_TIM16_RCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_REP                      \ [0x00 : 8] Repetition counter reload value
  [then]
  ...
  [ifdef] TIM16_TIM16_DTR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_DTGF                     \ [0x00 : 8] Dead-time falling edge generator setup
  ...
  [ifdef] TIM16_TIM16_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1SEL                   \ [0x00 : 4] selects tim_ti1_in[15:0] input
  [then]
  ...
  [ifdef] TIM16_TIM16_AF1_DEF
    ...
    $08 constant TIM16_BKCMP8E                  \ [0x08] tim_brk_cmp8 enable
  ...
  $18 constant TIM16_TIM16_CCMR1_OUTPUT \ TIM16 capture/compare mode register 1
