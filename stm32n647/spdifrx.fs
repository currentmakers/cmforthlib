...
[ifndef] SPDIFRX_DEF
  ...
  [ifdef] SPDIFRX_SPDIFRX_CR_DEF
    ...
    \
    $00 constant SPDIFRX_SPDIFRXEN              \ [0x00 : 2] Peripheral block enableless thansup>(1)less than/sup>
    $02 constant SPDIFRX_RXDMAEN                \ [0x02] Receiver DMA enable for data flowless thansup>(1)less than/sup>
    $03 constant SPDIFRX_RXSTEO                 \ [0x03] Stereo modeless thansup>(1)less than/sup>
    $04 constant SPDIFRX_DRFMT                  \ [0x04 : 2] RX data formatless thansup>(1)less than/sup>
    $06 constant SPDIFRX_PMSK                   \ [0x06] Mask parity error bitless thansup>(1)less than/sup>
    $07 constant SPDIFRX_VMSK                   \ [0x07] Mask of validity bitless thansup>(1)less than/sup>
    $08 constant SPDIFRX_CUMSK                  \ [0x08] Mask of channel status and user bitsless thansup>(1)less than/sup>
    $09 constant SPDIFRX_PTMSK                  \ [0x09] Mask of preamble type bitsless thansup>(1)less than/sup>
    $0a constant SPDIFRX_CBDMAEN                \ [0x0a] Control buffer DMA enable for control flowless thansup>(1)less than/sup>
    $0b constant SPDIFRX_CHSEL                  \ [0x0b] Channel selectionless thansup>(1)less than/sup>
    $0c constant SPDIFRX_NBTR                   \ [0x0c : 2] Maximum allowed re-tries during synchronization phaseless thansup>(1)less than/sup>
    $0e constant SPDIFRX_WFA                    \ [0x0e] Wait for activityless thansup>(1)less than/sup>
  ...
  [ifdef] SPDIFRX_SPDIFRX_DIR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SPDIFRX_THI                    \ [0x00 : 13] threshold HIGH (THI = 2.5 x UI / Tless thansub>spdifrx_ker_ckless than/sub>)
    $10 constant SPDIFRX_TLO                    \ [0x10 : 13] threshold LOW (TLO = 1.5 x UI / Tless thansub>spdifrx_ker_ckless than/sub>)
  [then]
