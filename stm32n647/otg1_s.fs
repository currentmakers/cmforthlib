...
$00000004 constant OTG1_S_OTG_GOTGCTL_VBVALOEN                      \ Vless thansub>BUSless than/sub> valid override enable.
$00000008 constant OTG1_S_OTG_GOTGCTL_VBVALOVAL                     \ Vless thansub>BUSless than/sub> valid override value.
