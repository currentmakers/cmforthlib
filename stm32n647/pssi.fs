...
$20000000 constant PSSI_PSSI_CR_CKSRC                               \ Clock source
...
\ @brief Parallel synchronous slave interface
\
$48026400 constant PSSI_PSSI_CR   \ offset: 0x00 : PSSI control register
$48026404 constant PSSI_PSSI_SR   \ offset: 0x04 : PSSI status register
$48026408 constant PSSI_PSSI_RIS  \ offset: 0x08 : PSSI raw interrupt status register
$4802640c constant PSSI_PSSI_IER  \ offset: 0x0C : PSSI interrupt enable register
$48026410 constant PSSI_PSSI_MIS  \ offset: 0x10 : PSSI masked interrupt status register
$48026414 constant PSSI_PSSI_ICR  \ offset: 0x14 : PSSI interrupt clear register
$48026428 constant PSSI_PSSI_DR   \ offset: 0x28 : PSSI data register
