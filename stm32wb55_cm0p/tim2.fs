...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_CNT_DEF
    ...
    $10 constant TIM2_CNT_H                     \ [0x10 : 15] High counter value (TIM2 only)
    $1f constant TIM2_UIFCPY                    \ [0x1f] Value depends on IUFREMAP in TIM2_CR1.
  [then]
  ...
  [ifdef] TIM2_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_ITR_RMP                   \ [0x00] Internal trigger remap
    $01 constant TIM2_ETR_RMP                   \ [0x01] External trigger remap
  ...
  [ifdef] TIM2_AF_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0e constant TIM2_ETRSEL                    \ [0x0e : 3] External trigger source selection
  [then]
  ...
  $50 constant TIM2_OR                  \ TIM2 option register
  $60 constant TIM2_AF                  \ TIM2 alternate function option register 1
