...
[ifndef] OTG_FS_GLOBAL_DEF
  ...
  [ifdef] OTG_FS_GLOBAL_FS_DIEPTXF4_DEF
    \
  ...
  [ifdef] OTG_FS_GLOBAL_FS_DIEPTXF5_DEF
    \
  ...
  $104 constant OTG_FS_GLOBAL_FS_DIEPTXF1    \ OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF1)
  $108 constant OTG_FS_GLOBAL_FS_DIEPTXF2    \ OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF2)
  $10C constant OTG_FS_GLOBAL_FS_DIEPTXF3    \ OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF3)
  $110 constant OTG_FS_GLOBAL_FS_DIEPTXF4    \ OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF4)
  $114 constant OTG_FS_GLOBAL_FS_DIEPTXF5    \ OTG_FS device IN endpoint transmit FIFO size register (OTG_FS_DIEPTXF5)
