...
[ifndef] OCTOSPI_DEF
  ...
  [ifdef] OCTOSPI_DCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_MAXTRAN                \ [0x00 : 8] Maximum transfer
    $10 constant OCTOSPI_CSBOUND                \ [0x10 : 5] CS boundary
  [then]


  [ifdef] OCTOSPI_DCR4_DEF
    \
    \ @brief DCR4
    \ Address offset: 0x14
    \ Reset value: 0x00000000
  ...
  [ifdef] OCTOSPI_SR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_TEF                    \ [0x00] Clear transfer error flag
    $01 constant OCTOSPI_TCF                    \ [0x01] Clear transfer complete flag
    $02 constant OCTOSPI_FTF                    \ [0x02] FIFO threshold flag
    $03 constant OCTOSPI_SMF                    \ [0x03] Clear status match flag
    $04 constant OCTOSPI_TOF                    \ [0x04] Clear timeout flag
  ...
  [ifdef] OCTOSPI_AR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_ADRESS                 \ [0x00 : 32] Adress
  [then]
  ...
  [ifdef] OCTOSPI_PSMAR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_MATCH                  \ [0x00 : 32] Match
  [then]
  ...
  [ifdef] OCTOSPI_WCCR_DEF
    ...
    $14 constant OCTOSPI_ABSIZE                 \ [0x14 : 2] Alternate bytes size
    $18 constant OCTOSPI_DMODE                  \ [0x18 : 3] Data mode
    $1b constant OCTOSPI_DDTR                   \ [0x1b] DDTR
    $1d constant OCTOSPI_DQSE                   \ [0x1d] DQSE
  [then]
  ...
  [ifdef] OCTOSPI_WTCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_DCYC                   \ [0x00 : 5] DCYC
  [then]
  ...
  $90 constant OCTOSPI_PIR              \ OCTOSPI polling interval register
  $100 constant OCTOSPI_CCR             \ polling interval register
  $108 constant OCTOSPI_TCR             \ communication configuration register
  $110 constant OCTOSPI_IR              \ timing configuration register
  $120 constant OCTOSPI_ABR             \ instruction register
  $130 constant OCTOSPI_LPTR            \ alternate bytes register
  $140 constant OCTOSPI_WPCCR           \ low-power timeout register
  $148 constant OCTOSPI_WPTCR           \ wrap timing configuration register
  $150 constant OCTOSPI_WPIR            \ wrap instruction register
  $160 constant OCTOSPI_WPABR           \ wrap alternate bytes register
  ...
  $190 constant OCTOSPI_WIR             \ OCTOSPI write instruction register
