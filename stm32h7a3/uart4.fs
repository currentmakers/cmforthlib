...
$20000000 constant UART4_CR1_FIFOEN                                 \ FIFO mode enable
$40000000 constant UART4_CR1_TXFEIE                                 \ TXFIFO empty interrupt enable
$80000000 constant UART4_CR1_RXFFIE                                 \ RXFIFO Full interrupt enable
...
$00000001 constant UART4_CR2_SLVEN                                  \ Synchronous Slave mode enable
$00000008 constant UART4_CR2_DIS_NSS                                \ When the DSI_NSS bit is set, the NSS pin input is ignored
...
$00800000 constant UART4_CR3_TXFTIE                                 \ TXFIFO threshold interrupt enable
$01000000 constant UART4_CR3_TCBGTIE                                \ Transmission Complete before guard time, interrupt enable
$0e000000 constant UART4_CR3_RXFTCFG                                \ Receive FIFO threshold configuration
$10000000 constant UART4_CR3_RXFTIE                                 \ RXFIFO threshold interrupt enable
$e0000000 constant UART4_CR3_TXFTCFG                                \ TXFIFO threshold configuration
...
$0000000f constant UART4_BRR_BRR_0_3                                \ DIV_Fraction
$0000fff0 constant UART4_BRR_BRR_4_15                               \ DIV_Mantissa
...
$00002000 constant UART4_ISR_UDR                                    \ SPI slave underrun error flag
...
$00800000 constant UART4_ISR_TXFE                                   \ TXFIFO Empty
$01000000 constant UART4_ISR_RXFF                                   \ RXFIFO Full
$02000000 constant UART4_ISR_TCBGT                                  \ Transmission complete before guard time flag
$04000000 constant UART4_ISR_RXFT                                   \ RXFIFO threshold flag
$08000000 constant UART4_ISR_TXFT                                   \ TXFIFO threshold flag
...
$00000020 constant UART4_ICR_TXFECF                                 \ TXFIFO empty clear flag
$00000040 constant UART4_ICR_TCCF                                   \ Transmission complete clear flag
$00000080 constant UART4_ICR_TCBGTC                                 \ Transmission complete before Guard time clear flag
...
$00002000 constant UART4_ICR_UDRCF                                  \ SPI slave underrun clear flag
...
$0000000f constant UART4_PRESC_PRESCALER                            \ Clock prescaler
...
$40004c2c constant UART4_PRESC    \ offset: 0x2C : USART prescaler register
