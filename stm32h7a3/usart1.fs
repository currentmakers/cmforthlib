...
$00000008 constant USART1_CR2_DIS_NSS                               \ When the DSI_NSS bit is set, the NSS pin input is ignored
...
$0000000f constant USART1_BRR_BRR_0_3                               \ DIV_Fraction
$0000fff0 constant USART1_BRR_BRR_4_15                              \ DIV_Mantissa
...
$00000080 constant USART1_ICR_TCBGTC                                \ Transmission complete before Guard time clear flag
...
\ @brief Universal synchronous asynchronous receiver transmitter
\
$40011000 constant USART1_CR1     \ offset: 0x00 : Control register 1
$40011004 constant USART1_CR2     \ offset: 0x04 : Control register 2
$40011008 constant USART1_CR3     \ offset: 0x08 : Control register 3
$4001100c constant USART1_BRR     \ offset: 0x0C : Baud rate register
$40011010 constant USART1_GTPR    \ offset: 0x10 : Guard time and prescaler register
$40011014 constant USART1_RTOR    \ offset: 0x14 : Receiver timeout register
$40011018 constant USART1_RQR     \ offset: 0x18 : Request register
$4001101c constant USART1_ISR     \ offset: 0x1C : Interrupt & status register
$40011020 constant USART1_ICR     \ offset: 0x20 : Interrupt flag clear register
$40011024 constant USART1_RDR     \ offset: 0x24 : Receive data register
$40011028 constant USART1_TDR     \ offset: 0x28 : Transmit data register
$4001102c constant USART1_PRESC   \ offset: 0x2C : USART prescaler register
