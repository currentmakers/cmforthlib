...
[ifndef] DMA2D_DEF
  ...
  [ifdef] DMA2D_CR_DEF
    ...
    \
    $00 constant DMA2D_START                    \ [0x00] Start This bit can be used to launch the DMA2D according to the parameters loaded in the various configuration registers
  ...
  \ @brief DMA2D
  \
  $00 constant DMA2D_CR                 \ DMA2D control register
  $04 constant DMA2D_ISR                \ DMA2D Interrupt Status Register
  $08 constant DMA2D_IFCR               \ DMA2D interrupt flag clear register
  $0C constant DMA2D_FGMAR              \ DMA2D foreground memory address register
  $10 constant DMA2D_FGOR               \ DMA2D foreground offset register
  $14 constant DMA2D_BGMAR              \ DMA2D background memory address register
  $18 constant DMA2D_BGOR               \ DMA2D background offset register
  $1C constant DMA2D_FGPFCCR            \ DMA2D foreground PFC control register
  $20 constant DMA2D_FGCOLR             \ DMA2D foreground color register
  $24 constant DMA2D_BGPFCCR            \ DMA2D background PFC control register
  $28 constant DMA2D_BGCOLR             \ DMA2D background color register
  $2C constant DMA2D_DFGCMAR            \ DMA2D foreground CLUT memory address register
  $30 constant DMA2D_BGCMAR             \ DMA2D background CLUT memory address register
  $34 constant DMA2D_OPFCCR             \ DMA2D output PFC control register
  $38 constant DMA2D_OCOLR              \ DMA2D output color register
  $3C constant DMA2D_OMAR               \ DMA2D output memory address register
  $40 constant DMA2D_OOR                \ DMA2D output offset register
  $44 constant DMA2D_NLR                \ DMA2D number of line register
  $48 constant DMA2D_LWR                \ DMA2D line watermark register
  $4C constant DMA2D_AMTCR              \ DMA2D AXI master timer configuration register
