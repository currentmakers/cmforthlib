...
[ifndef] LPUART_DEF
  ...
  [ifdef] LPUART_CR1_enabled_DEF
    ...
    $07 constant LPUART_TXFNFIE                 \ [0x07] interrupt enable
    ...
    $10 constant LPUART_DEDT                    \ [0x10 : 5] DEDT
    $15 constant LPUART_DEAT                    \ [0x15 : 5] DEAT
  ...
  [ifdef] LPUART_CR1_disabled_DEF
    ...
    $15 constant LPUART_DEAT                    \ [0x15 : 5] DEAT
    $1c constant LPUART_M1                      \ [0x1c] Word length
    $1d constant LPUART_FIFOEN                  \ [0x1d] FIFOEN
  [then]
  ...
  [ifdef] LPUART_ISR_enabled_DEF
    ...
    $02 constant LPUART_NE                      \ [0x02] NE
    $03 constant LPUART_ORE                     \ [0x03] ORE
    $04 constant LPUART_IDLE                    \ [0x04] IDLE
    $05 constant LPUART_RXFNE                   \ [0x05] RXFNE
    $06 constant LPUART_TC                      \ [0x06] TC
    $07 constant LPUART_TXFNF                   \ [0x07] TXFNF
  ...
  \ @brief Universal synchronous asynchronous receiver transmitter
  \
  $00 constant LPUART_CR1_ENABLED       \ Control register 1
  $00 constant LPUART_CR1_DISABLED      \ Control register 1
  ...
  $1C constant LPUART_ISR_ENABLED       \ Interrupt and status register
  $1C constant LPUART_ISR_DISABLED      \ Interrupt and status register
