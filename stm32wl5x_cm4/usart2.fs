...
$00000002 constant USART2_CR1_UESM                                  \ USART enable in low-power mode
...
$00000020 constant USART2_CR1_RXNEIE                                \ Receive data register not empty/RXFIFO not empty interrupt enable
$00000040 constant USART2_CR1_TCIE                                  \ Transmission complete interrupt enable
$00000080 constant USART2_CR1_TXEIE                                 \ Transmit data register empty/TXFIFO not full interrupt enable
...
$00100000 constant USART2_CR1_DEDT4                                 \ Driver Enable deassertion time
...
$0f000000 constant USART2_CR2_ADD3_0                                \ Address of the USART node
$f0000000 constant USART2_CR2_ADD7_4                                \ Address of the USART node
...
$00001000 constant USART2_CR3_OVRDIS                                \ OVRDIS: Overrun Disable
...
$000e0000 constant USART2_CR3_SCARCNT2_0                            \ Smartcard auto-retry count
$00300000 constant USART2_CR3_WUS                                   \ Wakeup from low-power mode interrupt flag selection
$00400000 constant USART2_CR3_WUFIE                                 \ Wakeup from low-power mode interrupt enable
$00800000 constant USART2_CR3_TXFTIE                                \ TXFIFO threshold interrupt enable
...
$00000004 constant USART2_ISR_NE                                    \ NE
...
$00002000 constant USART2_ISR_UDR                                   \ UDR
...
$00800000 constant USART2_ISR_TXFE                                  \ TXFE
$01000000 constant USART2_ISR_RXFF                                  \ RXFF
$02000000 constant USART2_ISR_TCBGT                                 \ TCBGT
$04000000 constant USART2_ISR_RXFT                                  \ RXFT
$08000000 constant USART2_ISR_TXFT                                  \ TXFT
...
$00100000 constant USART2_ICR_WUCF                                  \ Wakeup from low-power mode clear flag
...
$4000441c constant USART2_ISR     \ offset: 0x1C : interrupt and status register
...
$4000442c constant USART2_PRESC   \ offset: 0x2C : prescaler register
