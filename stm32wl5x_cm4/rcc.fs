...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    $14 constant RCC_IPCCRST                    \ [0x14] IPCCRST
  ...
  [ifdef] RCC_APB1RSTR1_DEF
    ...
    $1d constant RCC_DACRST                     \ [0x1d] DAC1 reset
  ...
  [ifdef] RCC_APB1SMENR1_DEF
    ...
    $1d constant RCC_DACSMEN                    \ [0x1d] DAC1 clock enable during CPU1 CSleep mode.
  ...
  [ifdef] RCC_EXTCFGR_DEF
    ...
    $04 constant RCC_C2HPRE                     \ [0x04 : 4] [dual core device only] HCLK2 prescaler (CPU2)
    $10 constant RCC_SHDHPREF                   \ [0x10] HCLK3 shared prescaler flag (AHB3, Flash, and SRAM2)
    $11 constant RCC_C2HPREF                    \ [0x11] CLK2 prescaler flag (CPU2)
  [then]
  ...
  [ifdef] RCC_C2AHB1ENR_DEF
    ...
    $02 constant RCC_DMAMUX1EN                  \ [0x02] CPU2 DMAMUX1 clock enable
  ...
  [ifdef] RCC_C2AHB3ENR_DEF
    ...
    \ Reset value: 0x02080000
    \
    $10 constant RCC_PKAEN                      \ [0x10] CPU2 PKA accelerator clock enable
    $11 constant RCC_AESEN                      \ [0x11] CPU2 AES accelerator clock enable
    $12 constant RCC_RNGEN                      \ [0x12] CPU2 True RNG clocks enable
    $13 constant RCC_HSEMEN                     \ [0x13] CPU2 HSEM clock enable
    $14 constant RCC_IPCCEN                     \ [0x14] CPU2 IPCC interface clock enable
    $19 constant RCC_FLASHEN                    \ [0x19] CPU2 Flash interface clock enable
  [then]
  ...
  [ifdef] RCC_C2APB1ENR1_DEF
    ...
    $0e constant RCC_SPI2S2EN                   \ [0x0e] CPU2 SPI2S2 clock enable
    $11 constant RCC_USART2EN                   \ [0x11] CPU2 USART2 clock enable
    $15 constant RCC_I2C1EN                     \ [0x15] CPU2 I2C1 clocks enable
    $16 constant RCC_I2C2EN                     \ [0x16] CPU2 I2C2 clocks enable
    $17 constant RCC_I2C3EN                     \ [0x17] CPU2 I2C3 clocks enable
    $1d constant RCC_DAC1EN                     \ [0x1d] CPU2 DAC1 clock enable
    $1f constant RCC_LPTIM1EN                   \ [0x1f] CPU2 Low power timer 1 clocks enable
  [then]
  ...
  [ifdef] RCC_C2APB1ENR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_LPUART1EN                  \ [0x00] CPU2 Low power UART 1 clocks enable
    $05 constant RCC_LPTIM2EN                   \ [0x05] CPU2 Low power timer 2 clocks enable
    $06 constant RCC_LPTIM3EN                   \ [0x06] CPU2 Low power timer 3 clocks enable
  [then]
  ...
  [ifdef] RCC_C2APB3ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_SUBGHZSPIEN                \ [0x00] CPU2 sub-GHz radio SPI clock enable
  [then]
  ...
  [ifdef] RCC_C2AHB1SMENR_DEF
    ...
    \ Reset value: 0x00001007
    \
    $00 constant RCC_DMA1SMEN                   \ [0x00] DMA1 clock enable during CPU2 CSleep mode.
    $01 constant RCC_DMA2SMEN                   \ [0x01] DMA2 clock enable during CPU2 CSleep mode.
    $02 constant RCC_DMAMUX1SMEN                \ [0x02] DMAMUX1 clock enable during CPU2 CSleep mode.
    $0c constant RCC_CRCSMEN                    \ [0x0c] CRC clock enable during CPU2 CSleep mode.
  [then]
  ...
  [ifdef] RCC_C2AHB2SMENR_DEF
    ...
    \ Reset value: 0x00000087
    \
    $00 constant RCC_GPIOASMEN                  \ [0x00] IO port A clock enable during CPU2 CSleep mode.
    $01 constant RCC_GPIOBSMEN                  \ [0x01] IO port B clock enable during CPU2 CSleep mode.
    $02 constant RCC_GPIOCSMEN                  \ [0x02] IO port C clock enable during CPU2 CSleep mode.
    $07 constant RCC_GPIOHSMEN                  \ [0x07] IO port H clock enable during CPU2 CSleep mode.
  [then]
  ...
  [ifdef] RCC_C2AHB3SMENR_DEF
    ...
    \ Reset value: 0x03870000
    \
    $10 constant RCC_PKASMEN                    \ [0x10] PKA accelerator clock enable during CPU2 CSleep mode.
    $11 constant RCC_AESSMEN                    \ [0x11] AES accelerator clock enable during CPU2 CSleep mode.
    $12 constant RCC_RNGSMEN                    \ [0x12] True RNG clock enable during CPU2 CSleep and CStop mode.
    $17 constant RCC_SRAM1SMEN                  \ [0x17] SRAM1 interface clock enable during CPU2 CSleep mode.
    $18 constant RCC_SRAM2SMEN                  \ [0x18] SRAM2 memory interface clock enable during CPU2 CSleep mode.
    $19 constant RCC_FLASHSMEN                  \ [0x19] Flash interface clock enable during CPU2 CSleep mode.
  [then]
  ...
  [ifdef] RCC_C2APB1SMENR1_DEF
    ...
    \
    $00 constant RCC_TIM2SMEN                   \ [0x00] TIM2 timer clock enable during CPU2 CSleep mode.
    $0a constant RCC_RTCAPBSMEN                 \ [0x0a] RTC bus clock enable during CPU2 CSleep mode.
    $0e constant RCC_SPI2S2SMEN                 \ [0x0e] SPI2S2 clock enable during CPU2 CSleep mode.
    $11 constant RCC_USART2SMEN                 \ [0x11] USART2 clock enable during CPU2 CSleep mode.
    $15 constant RCC_I2C1SMEN                   \ [0x15] I2C1 clock enable during CPU2 CSleep and CStop modes
    $16 constant RCC_I2C2SMEN                   \ [0x16] I2C2 clock enable during CPU2 CSleep and CStop modes
    $17 constant RCC_I2C3SMEN                   \ [0x17] I2C3 clock enable during CPU2 CSleep and CStop modes
    $1d constant RCC_DAC1SMEN                   \ [0x1d] DAC1 clock enable during CPU2 CSleep mode.
    $1f constant RCC_LPTIM1SMEN                 \ [0x1f] Low power timer 1 clock enable during CPU2 CSleep and CStop mode
  [then]
  ...
  [ifdef] RCC_C2APB1SMENR2_DEF
    ...
    \ Reset value: 0x00000061
    \
    $00 constant RCC_LPUART1SMEN                \ [0x00] Low power UART 1 clock enable during CPU2 CSleep and CStop mode
    $05 constant RCC_LPTIM2SMEN                 \ [0x05] Low power timer 2 clocks enable during CPU2 CSleep and CStop modes.
    $06 constant RCC_LPTIM3SMEN                 \ [0x06] Low power timer 3 clocks enable during CPU2 CSleep and CStop modes.
  [then]
  ...
  [ifdef] RCC_C2APB2SMENR_DEF
    ...
    \ Reset value: 0x00065A00
    \
    $09 constant RCC_ADCSMEN                    \ [0x09] ADC clocks enable during CPU2 Csleep and CStop modes
    $0b constant RCC_TIM1SMEN                   \ [0x0b] TIM1 timer clock enable during CPU2 CSleep mode
    $0c constant RCC_SPI1SMEN                   \ [0x0c] SPI1 clock enable during CPU2 CSleep mode
    $0e constant RCC_USART1SMEN                 \ [0x0e] USART1clock enable during CPU2 CSleep and CStop mode
    $11 constant RCC_TIM16SMEN                  \ [0x11] TIM16 timer clock enable during CPU2 CSleep mode
    $12 constant RCC_TIM17SMEN                  \ [0x12] TIM17 timer clock enable during CPU2 CSleep mode
  [then]
  ...
  [ifdef] RCC_C2APB3SMENR_DEF
    ...
    \ Reset value: 0x00000001
    \
    $00 constant RCC_SUBGHZSPISMEN              \ [0x00] sub-GHz radio SPI clock enable during CPU2 CSleep and CStop modes
  [then]
  ...
  $150 constant RCC_C2AHB3ENR           \ CPU2 AHB3 peripheral clock enable register [dual core device only]
  $158 constant RCC_C2APB1ENR1          \ CPU2 APB1 peripheral clock enable register 1 [dual core device only]
  $15C constant RCC_C2APB1ENR2          \ CPU2 APB1 peripheral clock enable register 2 [dual core device only]
  $160 constant RCC_C2APB2ENR           \ CPU2 APB2 peripheral clock enable register [dual core device only]
  $164 constant RCC_C2APB3ENR           \ CPU2 APB3 peripheral clock enable register [dual core device only]
  $168 constant RCC_C2AHB1SMENR         \ CPU2 AHB1 peripheral clocks enable in Sleep modes register [dual core device only]
  $16C constant RCC_C2AHB2SMENR         \ CPU2 AHB2 peripheral clocks enable in Sleep modes register [dual core device only]
  $170 constant RCC_C2AHB3SMENR         \ CPU2 AHB3 peripheral clocks enable in Sleep mode register [dual core device only]
  $178 constant RCC_C2APB1SMENR1        \ CPU2 APB1 peripheral clocks enable in Sleep mode register 1 [dual core device only]
  $17C constant RCC_C2APB1SMENR2        \ CPU2 APB1 peripheral clocks enable in Sleep mode register 2 [dual core device only]
  $180 constant RCC_C2APB2SMENR         \ CPU2 APB2 peripheral clocks enable in Sleep mode register [dual core device only]
  $184 constant RCC_C2APB3SMENR         \ CPU2 APB3 peripheral clock enable in Sleep mode register [dual core device only]
