...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CFGR_DEF
    ...
    $16 constant RCC_OTGFSPRE                   \ [0x16] USB OTG FS prescaler
    $18 constant RCC_MCO                        \ [0x18 : 4] Microcontroller clock output
  [then]
  ...
  [ifdef] RCC_CIR_DEF
    ...
    $05 constant RCC_PLL2RDYF                   \ [0x05] PLL2 Ready Interrupt flag
    $06 constant RCC_PLL3RDYF                   \ [0x06] PLL3 Ready Interrupt flag
    ...
    $0d constant RCC_PLL2RDYIE                  \ [0x0d] PLL2 Ready Interrupt Enable
    $0e constant RCC_PLL3RDYIE                  \ [0x0e] PLL3 Ready Interrupt Enable
    ...
    $15 constant RCC_PLL2RDYC                   \ [0x15] PLL2 Ready Interrupt Clear
    $16 constant RCC_PLL3RDYC                   \ [0x16] PLL3 Ready Interrupt Clear
  ...
  [ifdef] RCC_APB1RSTR_DEF
    ...
    $13 constant RCC_USART4RST                  \ [0x13] USART 4 reset
    $14 constant RCC_USART5RST                  \ [0x14] USART 5 reset
  ...
  [ifdef] RCC_AHBENR_DEF
    ...
    $0c constant RCC_OTGFSEN                    \ [0x0c] USB OTG FS clock enable
    $0e constant RCC_ETHMACEN                   \ [0x0e] Ethernet MAC clock enable
    $0f constant RCC_ETHMACTXEN                 \ [0x0f] Ethernet MAC TX clock enable
    $10 constant RCC_ETHMACRXEN                 \ [0x10] Ethernet MAC RX clock enable
  [then]
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $0a constant RCC_ADC2EN                     \ [0x0a] ADC 2 interface clock enable
  ...
  [ifdef] RCC_AHBRSTR_DEF
    ...
    $0e constant RCC_ETHMACRST                  \ [0x0e] Ethernet MAC reset
  [then]
  ...
  [ifdef] RCC_CFGR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_PREDIV1                    \ [0x00 : 4] PREDIV1 division factor
    $04 constant RCC_PREDIV2                    \ [0x04 : 4] PREDIV2 division factor
    $08 constant RCC_PLL2MUL                    \ [0x08 : 4] PLL2 Multiplication Factor
    $0c constant RCC_PLL3MUL                    \ [0x0c : 4] PLL3 Multiplication Factor
    $10 constant RCC_PREDIV1SRC                 \ [0x10] PREDIV1 entry clock source
    $11 constant RCC_I2S2SRC                    \ [0x11] I2S2 clock source
    $12 constant RCC_I2S3SRC                    \ [0x12] I2S3 clock source
  [then]
  ...
  $28 constant RCC_AHBRSTR              \ AHB peripheral clock reset register (RCC_AHBRSTR)
  $2C constant RCC_CFGR2                \ Clock configuration register2 (RCC_CFGR2)
