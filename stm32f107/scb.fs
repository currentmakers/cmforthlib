...
[ifndef] SCB_DEF
  ...
  [ifdef] SCB_CFSR_UFSR_BFSR_MMFSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SCB_IACCVIOL                   \ [0x00] IACCVIOL
    $01 constant SCB_DACCVIOL                   \ [0x01] DACCVIOL
    $03 constant SCB_MUNSTKERR                  \ [0x03] MUNSTKERR
    $04 constant SCB_MSTKERR                    \ [0x04] MSTKERR
    $05 constant SCB_MLSPERR                    \ [0x05] MLSPERR
    $07 constant SCB_MMARVALID                  \ [0x07] MMARVALID
  ...
  $24 constant SCB_SHCRS                \ System handler control and state register
