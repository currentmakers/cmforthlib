...
[ifndef] UART5_DEF
  ...
  \ @brief Universal asynchronous receiver transmitter
  \
  $00 constant UART5_SR                 \ UART5 SR
  $04 constant UART5_DR                 \ UART5 DR
  $08 constant UART5_BRR                \ UART5 BRR
  $0C constant UART5_CR1                \ UART5 CR1
  $10 constant UART5_CR2                \ UART5 CR2
  $14 constant UART5_CR3                \ UART5 CR3
