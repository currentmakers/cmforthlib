...
[ifndef] ADC1_DEF
  ...
  [ifdef] ADC1_CR1_DEF
    ...
    $10 constant ADC1_DUALMOD                   \ [0x10 : 4] Dual mode selection
  ...
  [ifdef] ADC1_SMPR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_SMP10                     \ [0x00 : 3] Channel 10 sampling time selection
    $03 constant ADC1_SMP11                     \ [0x03 : 3] Channel 11 sampling time selection
    $06 constant ADC1_SMP12                     \ [0x06 : 3] Channel 12 sampling time selection
    $09 constant ADC1_SMP13                     \ [0x09 : 3] Channel 13 sampling time selection
    $0c constant ADC1_SMP14                     \ [0x0c : 3] Channel 14 sampling time selection
    $0f constant ADC1_SMP15                     \ [0x0f : 3] Channel 15 sampling time selection
    $12 constant ADC1_SMP16                     \ [0x12 : 3] Channel 16 sampling time selection
    $15 constant ADC1_SMP17                     \ [0x15 : 3] Channel 17 sampling time selection
  [then]
  ...
  [ifdef] ADC1_SMPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_SMP0                      \ [0x00 : 3] Channel 0 sampling time selection
    $03 constant ADC1_SMP1                      \ [0x03 : 3] Channel 1 sampling time selection
    $06 constant ADC1_SMP2                      \ [0x06 : 3] Channel 2 sampling time selection
    $09 constant ADC1_SMP3                      \ [0x09 : 3] Channel 3 sampling time selection
    $0c constant ADC1_SMP4                      \ [0x0c : 3] Channel 4 sampling time selection
    $0f constant ADC1_SMP5                      \ [0x0f : 3] Channel 5 sampling time selection
    $12 constant ADC1_SMP6                      \ [0x12 : 3] Channel 6 sampling time selection
    $15 constant ADC1_SMP7                      \ [0x15 : 3] Channel 7 sampling time selection
    $18 constant ADC1_SMP8                      \ [0x18 : 3] Channel 8 sampling time selection
    $1b constant ADC1_SMP9                      \ [0x1b : 3] Channel 9 sampling time selection
  [then]
  ...
  [ifdef] ADC1_DR_DEF
    ...
    $10 constant ADC1_ADC2DATA                  \ [0x10 : 16] ADC2 data
  [then]
