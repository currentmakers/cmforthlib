...
[ifndef] ADC2_DEF
  ...
  [ifdef] ADC2_SMPR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC2_SMP10                     \ [0x00 : 3] Channel 10 sampling time selection
    $03 constant ADC2_SMP11                     \ [0x03 : 3] Channel 11 sampling time selection
    $06 constant ADC2_SMP12                     \ [0x06 : 3] Channel 12 sampling time selection
    $09 constant ADC2_SMP13                     \ [0x09 : 3] Channel 13 sampling time selection
    $0c constant ADC2_SMP14                     \ [0x0c : 3] Channel 14 sampling time selection
    $0f constant ADC2_SMP15                     \ [0x0f : 3] Channel 15 sampling time selection
    $12 constant ADC2_SMP16                     \ [0x12 : 3] Channel 16 sampling time selection
    $15 constant ADC2_SMP17                     \ [0x15 : 3] Channel 17 sampling time selection
  [then]
  ...
  [ifdef] ADC2_SMPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC2_SMP0                      \ [0x00 : 3] Channel 0 sampling time selection
    $03 constant ADC2_SMP1                      \ [0x03 : 3] Channel 1 sampling time selection
    $06 constant ADC2_SMP2                      \ [0x06 : 3] Channel 2 sampling time selection
    $09 constant ADC2_SMP3                      \ [0x09 : 3] Channel 3 sampling time selection
    $0c constant ADC2_SMP4                      \ [0x0c : 3] Channel 4 sampling time selection
    $0f constant ADC2_SMP5                      \ [0x0f : 3] Channel 5 sampling time selection
    $12 constant ADC2_SMP6                      \ [0x12 : 3] Channel 6 sampling time selection
    $15 constant ADC2_SMP7                      \ [0x15 : 3] Channel 7 sampling time selection
    $18 constant ADC2_SMP8                      \ [0x18 : 3] Channel 8 sampling time selection
    $1b constant ADC2_SMP9                      \ [0x1b : 3] Channel 9 sampling time selection
  [then]
  ...
  [ifdef] ADC2_JOFR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC2_JOFFSET1                  \ [0x00 : 12] Data offset for injected channel x
  [then]
  ...
  [ifdef] ADC2_JOFR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC2_JOFFSET2                  \ [0x00 : 12] Data offset for injected channel x
  [then]
  ...
  [ifdef] ADC2_JOFR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC2_JOFFSET3                  \ [0x00 : 12] Data offset for injected channel x
  [then]
  ...
  [ifdef] ADC2_JOFR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC2_JOFFSET4                  \ [0x00 : 12] Data offset for injected channel x
  [then]
