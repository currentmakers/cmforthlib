...
[ifndef] STK_DEF
  ...
  \ @brief SysTick timer
  \
  $00 constant STK_CSR                  \ SysTick control and status register
  $04 constant STK_RVR                  \ SysTick reload value register
  $08 constant STK_CVR                  \ SysTick current value register
