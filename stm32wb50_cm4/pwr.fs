...
$0000000f constant PWR_CR5_SDVOS                                    \ Step Down converter voltage output scaling
$00000070 constant PWR_CR5_SDSC                                     \ Step Down converter supplt startup current selection
$00000100 constant PWR_CR5_BORHC                                    \ BORH configuration selection
$00000200 constant PWR_CR5_SMPSCFG                                  \ VOS configuration selection (non user)
$00004000 constant PWR_CR5_SDBEN                                    \ Enable Step Down converter Bypass mode enabled
$00008000 constant PWR_CR5_SDEB                                     \ Enable Step Down converter SMPS mode enabled
