...
[ifndef] TIM5_DEF
  ...
  [ifdef] TIM5_CCER_DEF
    ...
    $0f constant TIM5_CC4NP                     \ [0x0f] Capture/Compare 3 output Polarity
  [then]
  ...
  [ifdef] TIM5_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_CNTL                      \ [0x00 : 16] Low counter value
    $10 constant TIM5_CNTH                      \ [0x10 : 16] High counter value
  [then]
  ...
  [ifdef] TIM5_ARR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_ARRL                      \ [0x00 : 16] Low Auto-reload value
    $10 constant TIM5_ARRH                      \ [0x10 : 16] High Auto-reload value
  [then]
  ...
  [ifdef] TIM5_CCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_CCR1L                     \ [0x00 : 16] Low Capture/Compare 1 value
    $10 constant TIM5_CCR1H                     \ [0x10 : 16] High Capture/Compare 1 value
  [then]
  ...
  [ifdef] TIM5_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_CCR2L                     \ [0x00 : 16] Low Capture/Compare 2 value
    $10 constant TIM5_CCR2H                     \ [0x10 : 16] High Capture/Compare 2 value
  [then]
  ...
  [ifdef] TIM5_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_CCR3L                     \ [0x00 : 16] Low Capture/Compare value
    $10 constant TIM5_CCR3H                     \ [0x10 : 16] High Capture/Compare value
  [then]
  ...
  [ifdef] TIM5_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_CCR4L                     \ [0x00 : 16] Low Capture/Compare value
    $10 constant TIM5_CCR4H                     \ [0x10 : 16] High Capture/Compare value
  [then]
  ...
  $50 constant TIM5_OR                  \ option register
