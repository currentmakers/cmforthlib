...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_CR_DEF
    ...
    $09 constant PWR_ENSD1                      \ [0x09] ENable SD1 ADC
    $0a constant PWR_ENSD2                      \ [0x0a] ENable SD2 ADC
    $0b constant PWR_ENSD3                      \ [0x0b] ENable SD3 ADC
  [then]
  ...
  [ifdef] PWR_CSR_DEF
    ...
    $09 constant PWR_EWUP2                      \ [0x09] Enable WKUP2 pin
    $0a constant PWR_EWUP3                      \ [0x0a] Enable WKUP3 pin
  [then]
