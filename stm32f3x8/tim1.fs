...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_SMCR_DEF
    ...
    $10 constant TIM1_SMS3                      \ [0x10] Slave mode selection bit 3
  [then]
  ...
  [ifdef] TIM1_SR_DEF
    ...
    $10 constant TIM1_C5IF                      \ [0x10] Capture/Compare 5 interrupt flag
    $11 constant TIM1_C6IF                      \ [0x11] Capture/Compare 6 interrupt flag
  [then]
  ...
  [ifdef] TIM1_CCMR1_Input_DEF
    ...
    \
    $00 constant TIM1_CC1S                      \ [0x00 : 2] Capture/Compare 1 selection
    $02 constant TIM1_IC1PCS                    \ [0x02 : 2] Input capture 1 prescaler
  ...
  [ifdef] TIM1_CCER_DEF
    ...
    $0f constant TIM1_CC4NP                     \ [0x0f] Capture/Compare 4 output Polarity
  ...
  [ifdef] TIM1_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_CCR3                      \ [0x00 : 16] Capture/Compare 3 value
  [then]
  ...
  [ifdef] TIM1_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_CCR4                      \ [0x00 : 16] Capture/Compare 3 value
  [then]
  ...
  [ifdef] TIM1_CCMR3_Output_DEF
    ...
    $10 constant TIM1_OC5M_3                    \ [0x10] Outout Compare 5 mode bit 3
    $18 constant TIM1_OC6M_3                    \ [0x18] Outout Compare 6 mode bit 3
  [then]
  ...
  [ifdef] TIM1_OR_DEF
    ...
    $02 constant TIM1_TIM1_ETR_ADC4_RMP         \ [0x02 : 2] TIM1_ETR_ADC4 remapping capability
  [then]
  ...
  $60 constant TIM1_OR                  \ option registers
