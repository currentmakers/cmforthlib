...
[ifndef] USART1_DEF
  ...
  [ifdef] USART1_CR2_DEF
    ...
    $18 constant USART1_ADD0                    \ [0x18 : 4] Address of the USART node
    $1c constant USART1_ADD4                    \ [0x1c : 4] Address of the USART node
  [then]
  ...
  [ifdef] USART1_ISR_DEF
    ...
    $14 constant USART1_WUF                     \ [0x14] Wakeup from Stop mode flag
  ...
  [ifdef] USART1_ICR_DEF
    ...
    $0c constant USART1_EOBCF                   \ [0x0c] End of timeout clear flag
