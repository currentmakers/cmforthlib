...
$00000080 constant I2C1_I2C_CR1_ERRIE                               \ Error interrupts enable Note: Any of these errors generate an interrupt: Note: Arbitration Loss (ARLO) Note: Bus Error detection (BERR) Note: Overrun/Underrun (OVR) Note: Timeout detection (TIMEOUT) Note: PEC error detection (PECERR) Note: Alert pin event detection (ALERT)
...
$00040000 constant I2C1_I2C_CR1_WUPEN                               \ Wakeup from Stop mode enable Note: If the Wakeup from Stop mode feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation. Note: WUPEN can be set only when DNF = '0000'
$00080000 constant I2C1_I2C_CR1_GCEN                                \ General call enable
$00100000 constant I2C1_I2C_CR1_SMBHEN                              \ SMBus host address enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
$00200000 constant I2C1_I2C_CR1_SMBDEN                              \ SMBus device default address enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
$00400000 constant I2C1_I2C_CR1_ALERTEN                             \ SMBus alert enable Note: When ALERTEN=0, the SMBA pin can be used as a standard GPIO. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
$00800000 constant I2C1_I2C_CR1_PECEN                               \ PEC enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
...
$000f0000 constant I2C1_I2C_TIMINGR_SDADEL                          \ Data hold time This field is used to generate the delay t<sub>SDADEL </sub>between SCL falling edge and SDA edge. In master mode and in slave mode with NOSTRETCH = 0, the SCL line is stretched low during t<sub>SDADEL</sub>. t<sub>SDADEL</sub>= SDADEL x t<sub>PRESC</sub> Note: SDADEL is used to generate t<sub>HD:DAT </sub>timing.
...
$00001000 constant I2C1_I2C_ISR_TIMEOUT                             \ Timeout or t<sub>LOW</sub> detection flag This flag is set by hardware when a timeout or extended clock timeout occurred. It is cleared by software by setting the TIMEOUTCF bit. Note: This bit is cleared by hardware when PE = 0. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
...
$00000800 constant I2C1_I2C_ICR_PECCF                               \ PEC Error flag clear Writing 1 to this bit clears the PECERR flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
$00001000 constant I2C1_I2C_ICR_TIMOUTCF                            \ Timeout detection flag clear Writing 1 to this bit clears the TIMEOUT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
$00002000 constant I2C1_I2C_ICR_ALERTCF                             \ Alert flag clear Writing 1 to this bit clears the ALERT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to '0'. Refer to Section 52.3: I2C implementation.
...
\ @brief I2C address block description
\
$41000000 constant I2C1_I2C_CR1   \ offset: 0x00 : I2C control register 1
$41000004 constant I2C1_I2C_CR2   \ offset: 0x04 : I2C control register 2
$41000008 constant I2C1_I2C_OAR1  \ offset: 0x08 : I2C own address 1 register
$4100000c constant I2C1_I2C_OAR2  \ offset: 0x0C : I2C own address 2 register
$41000010 constant I2C1_I2C_TIMINGR  \ offset: 0x10 : I2C timing register
$41000014 constant I2C1_I2C_TIMEOUTR  \ offset: 0x14 : I2C timeout register
$41000018 constant I2C1_I2C_ISR   \ offset: 0x18 : I2C interrupt and status register
$4100001c constant I2C1_I2C_ICR   \ offset: 0x1C : I2C interrupt clear register
$41000020 constant I2C1_I2C_PECR  \ offset: 0x20 : I2C PEC register
$41000024 constant I2C1_I2C_RXDR  \ offset: 0x24 : I2C receive data register
$41000028 constant I2C1_I2C_TXDR  \ offset: 0x28 : I2C transmit data register
