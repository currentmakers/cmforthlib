...
[ifndef] GPIO_DEF
  ...
  [ifdef] GPIO_AFRL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIO_AFSEL0                    \ [0x00 : 4] Alternate function selection for port x bit y (y = 0..7)
    $04 constant GPIO_AFSEL1                    \ [0x04 : 4] Alternate function selection for port x bit y (y = 0..7)
    $08 constant GPIO_AFSEL2                    \ [0x08 : 4] Alternate function selection for port x bit y (y = 0..7)
    $0c constant GPIO_AFSEL3                    \ [0x0c : 4] Alternate function selection for port x bit y (y = 0..7)
    $10 constant GPIO_AFSEL4                    \ [0x10 : 4] Alternate function selection for port x bit y (y = 0..7)
    $14 constant GPIO_AFSEL5                    \ [0x14 : 4] Alternate function selection for port x bit y (y = 0..7)
    $18 constant GPIO_AFSEL6                    \ [0x18 : 4] Alternate function selection for port x bit y (y = 0..7)
    $1c constant GPIO_AFSEL7                    \ [0x1c : 4] Alternate function selection for port x bit y (y = 0..7)
  [then]
  ...
  [ifdef] GPIO_AFRH_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIO_AFSEL8                    \ [0x00 : 4] Alternate function selection for port x bit y (y = 8..15)
    $04 constant GPIO_AFSEL9                    \ [0x04 : 4] Alternate function selection for port x bit y (y = 8..15)
    $08 constant GPIO_AFSEL10                   \ [0x08 : 4] Alternate function selection for port x bit y (y = 8..15)
    $0c constant GPIO_AFSEL11                   \ [0x0c : 4] Alternate function selection for port x bit y (y = 8..15)
    $10 constant GPIO_AFSEL12                   \ [0x10 : 4] Alternate function selection for port x bit y (y = 8..15)
    $14 constant GPIO_AFSEL13                   \ [0x14 : 4] Alternate function selection for port x bit y (y = 8..15)
    $18 constant GPIO_AFSEL14                   \ [0x18 : 4] Alternate function selection for port x bit y (y = 8..15)
    $1c constant GPIO_AFSEL15                   \ [0x1c : 4] Alternate function selection for port x bit y (y = 8..15)
  [then]
  ...
  [ifdef] GPIO_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIO_BR0                       \ [0x00] Port Reset bit
    $01 constant GPIO_BR1                       \ [0x01] Port Reset bit
    $02 constant GPIO_BR2                       \ [0x02] Port Reset bit
    $03 constant GPIO_BR3                       \ [0x03] Port Reset bit
    $04 constant GPIO_BR4                       \ [0x04] Port Reset bit
    $05 constant GPIO_BR5                       \ [0x05] Port Reset bit
    $06 constant GPIO_BR6                       \ [0x06] Port Reset bit
    $07 constant GPIO_BR7                       \ [0x07] Port Reset bit
    $08 constant GPIO_BR8                       \ [0x08] Port Reset bit
    $09 constant GPIO_BR9                       \ [0x09] Port Reset bit
    $0a constant GPIO_BR10                      \ [0x0a] Port Reset bit
    $0b constant GPIO_BR11                      \ [0x0b] Port Reset bit
    $0c constant GPIO_BR12                      \ [0x0c] Port Reset bit
    $0d constant GPIO_BR13                      \ [0x0d] Port Reset bit
    $0e constant GPIO_BR14                      \ [0x0e] Port Reset bit
    $0f constant GPIO_BR15                      \ [0x0f] Port Reset bit
  [then]
