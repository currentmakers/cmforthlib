...
[ifndef] LPUART_DEF
  ...
  [ifdef] LPUART_HWCFGR2_DEF
    \
    \ @brief LPUART Hardware Configuration register 2
    \ Address offset: 0x3EC
    \ Reset value: 0x00000013
    \
    $00 constant LPUART_CFG1                    \ [0x00 : 4] LUART hardware configuration 1
    $04 constant LPUART_CFG2                    \ [0x04 : 4] LUART hardware configuration 2
  [then]


  [ifdef] LPUART_HWCFGR1_DEF
    \
    ...
    $00 constant LPUART_CFG1                    \ [0x00 : 4] LUART hardware configuration 1
    $04 constant LPUART_CFG2                    \ [0x04 : 4] LUART hardware configuration 2
    $08 constant LPUART_CFG3                    \ [0x08 : 4] LUART hardware configuration 1
    $0c constant LPUART_CFG4                    \ [0x0c : 4] LUART hardware configuration 2
    $10 constant LPUART_CFG5                    \ [0x10 : 4] LUART hardware configuration 2
    $14 constant LPUART_CFG6                    \ [0x14 : 4] LUART hardware configuration 2
    $18 constant LPUART_CFG7                    \ [0x18 : 4] LUART hardware configuration 2
    $1c constant LPUART_CFG8                    \ [0x1c : 4] LUART hardware configuration 2
  [then]


  [ifdef] LPUART_VERR_DEF
    \
    \ @brief EXTI IP Version register
    \ Address offset: 0x3F4
    \ Reset value: 0x00000023
    \
    $00 constant LPUART_MINREV                  \ [0x00 : 4] Minor Revision number
    $04 constant LPUART_MAJREV                  \ [0x04 : 4] Major Revision number
  [then]


  [ifdef] LPUART_IPIDR_DEF
    \
    \ @brief EXTI Identification register
    \ Address offset: 0x3F8
    \ Reset value: 0x00130003
    \
    $00 constant LPUART_IPID                    \ [0x00 : 32] IP Identification
  [then]


  [ifdef] LPUART_SIDR_DEF
    \
    \ @brief EXTI Size ID register
    \ Address offset: 0x3FC
    \ Reset value: 0xA3C5DD01
    \
    $00 constant LPUART_SID                     \ [0x00 : 32] Size Identification
  [then]
  ...
  $3EC constant LPUART_HWCFGR2          \ LPUART Hardware Configuration register 2
  $3F0 constant LPUART_HWCFGR1          \ LPUART Hardware Configuration register 1
  $3F4 constant LPUART_VERR             \ EXTI IP Version register
  $3F8 constant LPUART_IPIDR            \ EXTI Identification register
  $3FC constant LPUART_SIDR             \ EXTI Size ID register
