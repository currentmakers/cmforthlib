...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_AF1_DEF
    ...
    $08 constant TIM16_BKDFBK1E                 \ [0x08] BRK DFSDM_BREAK1 enable
    $09 constant TIM16_BKINP                    \ [0x09] BRK BKIN input polarity
    $0a constant TIM16_BKCMP1P                  \ [0x0a] BRK COMP1 input polarity
    $0b constant TIM16_BKCMP2P                  \ [0x0b] BRK COMP2 input polarit
  [then]
  ...
  [ifdef] TIM16_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1SEL                   \ [0x00 : 4] selects input
    $08 constant TIM16_TI2SEL                   \ [0x08 : 4] selects input
  [then]
