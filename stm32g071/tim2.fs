...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_IOCREF_CLR                \ [0x00] IOCREF_CLR
  [then]
  ...
  [ifdef] TIM2_AF1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0e constant TIM2_ETRSEL                    \ [0x0e : 4] External trigger source selection
  [then]
  ...
  [ifdef] TIM2_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_TI1SEL                    \ [0x00 : 4] TI1SEL
    $08 constant TIM2_TI2SEL                    \ [0x08 : 4] TI2SEL
  [then]
