...
$00000080 constant HDMI_CEC_CEC_CFGR_BRDNOGEN                       \ Avoid Error-Bit Generation in Broadcast The BRDNOGEN bit is set and cleared by software.
$00000100 constant HDMI_CEC_CEC_CFGR_SFTOPT                         \ SFT Option Bit The SFTOPT bit is set and cleared by software.
