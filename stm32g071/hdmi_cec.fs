...
[ifndef] HDMI_CEC_DEF
  ...
  [ifdef] HDMI_CEC_CEC_CFGR_DEF
    ...
    $07 constant HDMI_CEC_BRDNOGEN              \ [0x07] Avoid Error-Bit Generation in Broadcast The BRDNOGEN bit is set and cleared by software.
    $08 constant HDMI_CEC_SFTOPT                \ [0x08] SFT Option Bit The SFTOPT bit is set and cleared by software.
