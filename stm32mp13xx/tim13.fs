...
$00000300 constant TIM13_TIM13_CR1_CKD                              \ Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and sampling clock used by the digital filters (TIx),
...
$00000200 constant TIM13_TIM13_SR_CC1OF                             \ Capture/Compare 1 overcapture flag This flag is set by hardware only when the corresponding channel is configured in input capture mode. It is cleared by software by writing it to '0â.
...
$00000008 constant TIM13_TIM13_CCMR1_OUTPUT_OC1PE                   \ Output compare 1 preload enable Note: The PWM mode can be used without validating the preload register only in one pulse mode (OPM bit set in TIMx_CR1 register). Else the behavior is not guaranteed.
$00000070 constant TIM13_TIM13_CCMR1_OUTPUT_OC1M1                   \ Output compare 1 mode (refer to bit 16 for OC1M[3]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M[3] bit is not contiguous, located in bit 16.
$00010000 constant TIM13_TIM13_CCMR1_OUTPUT_OC1M2                   \ Output compare 1 mode (refer to bit 16 for OC1M[3]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas OC1 active level depends on CC1P bit. Others: Reserved Note: In PWM mode 1 or 2, the OCREF level changes when the result of the comparison changes or when the output compare mode switches from frozen to PWM mode. Note: The OC1M[3] bit is not contiguous, located in bit 16.
...
$0000000c constant TIM13_TIM13_CCMR1_INPUT_IC1PSC                   \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E=â0â (TIMx_CCER register).
...
$00000002 constant TIM13_TIM13_CCER_CC1P                            \ Capture/Compare 1 output Polarity. When CC1 channel is configured as input, both CC1NP/CC1P bits select the active polarity of TI1FP1 and TI2FP1 for trigger or capture operations. CC1NP=0, CC1P=0: non-inverted/rising edge. The circuit is sensitive to TIxFP1 rising edge (capture or trigger operations in reset, external clock or trigger mode), TIxFP1 is not inverted (trigger operation in gated mode or encoder mode). CC1NP=0, CC1P=1: inverted/falling edge. The circuit is sensitive to TIxFP1 falling edge (capture or trigger operations in reset, external clock or trigger mode), TIxFP1 is inverted (trigger operation in gated mode or encoder mode). CC1NP=1, CC1P=1: non-inverted/both edges/ The circuit is sensitive to both TIxFP1 rising and falling edges (capture or trigger operations in reset, external clock or trigger mode), TIxFP1is not inverted (trigger operation in gated mode). This configuration must not be used in encoder mode. CC1NP=1, CC1P=0: This configuration is reserved, it must not be used.
$00000008 constant TIM13_TIM13_CCER_CC1NP                           \ Capture/Compare 1 complementary output Polarity. CC1 channel configured as output: CC1NP must be kept cleared. CC1 channel configured as input: CC1NP bit is used in conjunction with CC1P to define TI1FP1 polarity (refer to CC1P description).
...
$0000ffff constant TIM13_TIM13_ARR_ARR                              \ Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$0000000f constant TIM13_TIM13_TISEL_TI1SEL                         \ selects TI1[0] to TI1[15] input Other: Reserved


\
\ @brief TIM register block
\
$4c008000 constant TIM13_TIM13_CR1  \ offset: 0x00 : TIM13 control register 1
$4c00800c constant TIM13_TIM13_DIER  \ offset: 0x0C : TIM13 Interrupt enable register
$4c008010 constant TIM13_TIM13_SR  \ offset: 0x10 : TIM13 status register
$4c008014 constant TIM13_TIM13_EGR  \ offset: 0x14 : TIM13 event generation register
$4c008018 constant TIM13_TIM13_CCMR1_OUTPUT  \ offset: 0x18 : TIM13 capture/compare mode register 1 [alternate]
$4c008018 constant TIM13_TIM13_CCMR1_INPUT  \ offset: 0x18 : TIM13 capture/compare mode register 1 [alternate]
$4c008020 constant TIM13_TIM13_CCER  \ offset: 0x20 : TIM13 capture/compare enable register
$4c008024 constant TIM13_TIM13_CNT  \ offset: 0x24 : TIM13 counter
$4c008028 constant TIM13_TIM13_PSC  \ offset: 0x28 : TIM13 prescaler
$4c00802c constant TIM13_TIM13_ARR  \ offset: 0x2C : TIM13 auto-reload register
$4c008034 constant TIM13_TIM13_CCR1  \ offset: 0x34 : TIM13 capture/compare register 1
$4c008068 constant TIM13_TIM13_TISEL  \ offset: 0x68 : TIM13 timer input selection register
