...
[ifndef] USART_DEF
  ...
  [ifdef] USART_CR1_FIFO_enabled_DEF
    ...
    $10 constant USART_DEDT                     \ [0x10 : 5] DEDT
    $15 constant USART_DEAT                     \ [0x15 : 5] DEAT
  ...
  [ifdef] USART_CR2_DEF
    ...
    $03 constant USART_DIS_NSS                  \ [0x03] When the DSI_NSS bit is set, the NSS pin input will be ignored
    ...
    $12 constant USART_TAINV                    \ [0x12] Binary data inversion
    ...
    $18 constant USART_ADD0_3                   \ [0x18 : 4] Address of the USART node
    $1c constant USART_ADD4_7                   \ [0x1c : 4] Address of the USART node
  [then]
  ...
  [ifdef] USART_CR3_DEF
    ...
    $01 constant USART_IREN                     \ [0x01] Ir mode enable
    $02 constant USART_IRLP                     \ [0x02] Ir low-power
    ...
    $17 constant USART_TXFTIE                   \ [0x17] threshold interrupt enable
    $18 constant USART_TCBGTIE                  \ [0x18] Tr Complete before guard time, interrupt enable
  ...
  [ifdef] USART_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART_BRR_0_3                  \ [0x00 : 4] BRR_0_3
    $04 constant USART_BRR_4_15                 \ [0x04 : 12] BRR_4_15
  [then]
  ...
  [ifdef] USART_HWCFGR2_DEF
    \
    \ @brief USART Hardware Configuration register 2
    \ Address offset: 0x3EC
    \ Reset value: 0x00000014
    \
    $00 constant USART_CFG1                     \ [0x00 : 4] CFG1
    $04 constant USART_CFG2                     \ [0x04 : 4] CFG2
  [then]


  [ifdef] USART_HWCFGR1_DEF
    \
    ...
    $00 constant USART_CFG1                     \ [0x00 : 4] CFG1
    $04 constant USART_CFG2                     \ [0x04 : 4] CFG2
    $08 constant USART_CFG3                     \ [0x08 : 4] CFG3
    $0c constant USART_CFG4                     \ [0x0c : 4] CFG4
    $10 constant USART_CFG5                     \ [0x10 : 4] CFG5
    $14 constant USART_CFG6                     \ [0x14 : 4] CFG6
    $18 constant USART_CFG7                     \ [0x18 : 4] CFG7
    $1c constant USART_CFG8                     \ [0x1c : 4] CFG8
  [then]


  [ifdef] USART_VERR_DEF
    \
    \ @brief EXTI IP Version register
    \ Address offset: 0x3F4
    \ Reset value: 0x00000023
    \
    $00 constant USART_MINREV                   \ [0x00 : 4] Minor Revision number
    $04 constant USART_MAJREV                   \ [0x04 : 4] Major Revision number
  [then]


  [ifdef] USART_IPIDR_DEF
    \
    \ @brief EXTI Identification register
    \ Address offset: 0x3F8
    \ Reset value: 0x00130003
    \
    $00 constant USART_IPID                     \ [0x00 : 32] IP Identification
  [then]


  [ifdef] USART_SIDR_DEF
    \
    \ @brief EXTI Size ID register
    \ Address offset: 0x3FC
    \ Reset value: 0xA3C5DD01
    \
    $00 constant USART_SID                      \ [0x00 : 32] Size Identification
  [then]
  ...
  $1C constant USART_ISR_FIFO_ENABLED   \ USART interrupt and status register
  $1C constant USART_ISR_FIFO_DISABLED  \ USART interrupt and status register
  ...
  $3EC constant USART_HWCFGR2           \ USART Hardware Configuration register 2
  $3F0 constant USART_HWCFGR1           \ USART Hardware Configuration register 1
  $3F4 constant USART_VERR              \ EXTI IP Version register
  $3F8 constant USART_IPIDR             \ EXTI Identification register
  $3FC constant USART_SIDR              \ EXTI Size ID register
