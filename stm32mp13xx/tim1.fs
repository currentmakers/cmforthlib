...
$00000003 constant TIM1_TIM1_CCMR1_OUTPUT_CC1S                      \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = '0â in TIMx_CCER).
...
$00000008 constant TIM1_TIM1_CCMR1_OUTPUT_OC1PE                     \ Output Compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S=â00â (the channel is configured in output). The PWM mode can be used without validating the preload register only in one pulse mode (OPM bit set in TIMx_CR1 register). Else the behavior is not guaranteed.
$00000070 constant TIM1_TIM1_CCMR1_OUTPUT_OC1M1                     \ Output Compare 1 mode These bits define the behavior of the output reference signal OC1REF from which OC1 and OC1N are derived. OC1REF is active high whereas OC1 and OC1N active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S=â00â (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from âfrozenâ mode to âPWMâ mode. Note: On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated. Note: The OC1M[3] bit is not contiguous, located in bit 16.
$00000080 constant TIM1_TIM1_CCMR1_OUTPUT_OC1CE                     \ Output Compare 1 clear enable
$00000300 constant TIM1_TIM1_CCMR1_OUTPUT_CC2S                      \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = '0â in TIMx_CCER).
$00000400 constant TIM1_TIM1_CCMR1_OUTPUT_OC2FE                     \ Output Compare 2 fast enable Refer to OC1FE description.
$00000800 constant TIM1_TIM1_CCMR1_OUTPUT_OC2PE                     \ Output Compare 2 preload enable Refer to OC1PE description.
$00007000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2M1                     \ Output Compare 2 mode Refer to OC1M[3:0] description.
$00008000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2CE                     \ Output Compare 2 clear enable Refer to OC1CE description.
$00010000 constant TIM1_TIM1_CCMR1_OUTPUT_OC1M2                     \ Output Compare 1 mode These bits define the behavior of the output reference signal OC1REF from which OC1 and OC1N are derived. OC1REF is active high whereas OC1 and OC1N active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S=â00â (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from âfrozenâ mode to âPWMâ mode. Note: On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated. Note: The OC1M[3] bit is not contiguous, located in bit 16.
$01000000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2M2                     \ Output Compare 2 mode Refer to OC1M[3:0] description.
...
$0000000c constant TIM1_TIM1_CCMR1_INPUT_IC1PSC                     \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E=â0â (TIMx_CCER register).
...
$00000c00 constant TIM1_TIM1_CCMR1_INPUT_IC2PSC                     \ Input capture 2 prescaler Refer to IC1PSC[1:0] description.
$0000f000 constant TIM1_TIM1_CCMR1_INPUT_IC2F                       \ Input capture 2 filter Refer to IC1F[3:0] description.
...
$00000003 constant TIM1_TIM1_CCMR2_OUTPUT_CC3S                      \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0â in TIMx_CCER).
$00000004 constant TIM1_TIM1_CCMR2_OUTPUT_OC3FE                     \ Output compare 3 fast enable Refer to OC1FE description.
$00000008 constant TIM1_TIM1_CCMR2_OUTPUT_OC3PE                     \ Output compare 3 preload enable Refer to OC1PE description.
$00000070 constant TIM1_TIM1_CCMR2_OUTPUT_OC3M1                     \ Output compare 3 mode Refer to OC1M[3:0] description.
$00000080 constant TIM1_TIM1_CCMR2_OUTPUT_OC3CE                     \ Output compare 3 clear enable Refer to OC1CE description.
$00000300 constant TIM1_TIM1_CCMR2_OUTPUT_CC4S                      \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0â in TIMx_CCER).
$00000400 constant TIM1_TIM1_CCMR2_OUTPUT_OC4FE                     \ Output compare 4 fast enable Refer to OC1FE description.
$00000800 constant TIM1_TIM1_CCMR2_OUTPUT_OC4PE                     \ Output compare 4 preload enable Refer to OC1PE description.
$00007000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4M1                     \ Output compare 4 mode Refer to OC3M[3:0] description.
$00008000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4CE                     \ Output compare 4 clear enable Refer to OC1CE description.
$00010000 constant TIM1_TIM1_CCMR2_OUTPUT_OC3M2                     \ Output compare 3 mode Refer to OC1M[3:0] description.
$01000000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4M2                     \ Output compare 4 mode Refer to OC3M[3:0] description.
...
$0000000c constant TIM1_TIM1_CCMR2_INPUT_IC3PSC                     \ Input capture 3 prescaler Refer to IC1PSC[1:0] description.
$000000f0 constant TIM1_TIM1_CCMR2_INPUT_IC3F                       \ Input capture 3 filter Refer to IC1F[3:0] description.
...
$00000c00 constant TIM1_TIM1_CCMR2_INPUT_IC4PSC                     \ Input capture 4 prescaler Refer to IC1PSC[1:0] description.
$0000f000 constant TIM1_TIM1_CCMR2_INPUT_IC4F                       \ Input capture 4 filter Refer to IC1F[3:0] description.
...
$00000004 constant TIM1_TIM1_CCMR3_OC5FE                            \ Output compare 5 fast enable Refer to OC1FE description.
$00000008 constant TIM1_TIM1_CCMR3_OC5PE                            \ Output compare 5 preload enable Refer to OC1PE description.
$00000070 constant TIM1_TIM1_CCMR3_OC5M1                            \ Output compare 5 mode Refer to OC1M description.
$00000080 constant TIM1_TIM1_CCMR3_OC5CE                            \ Output compare 5 clear enable Refer to OC1CE description.
$00000400 constant TIM1_TIM1_CCMR3_OC6FE                            \ Output compare 6 fast enable Refer to OC1FE description.
$00000800 constant TIM1_TIM1_CCMR3_OC6PE                            \ Output compare 6 preload enable Refer to OC1PE description.
$00007000 constant TIM1_TIM1_CCMR3_OC6M1                            \ Output compare 6 mode Refer to OC1M description.
$00008000 constant TIM1_TIM1_CCMR3_OC6CE                            \ Output compare 6 clear enable Refer to OC1CE description.
$00010000 constant TIM1_TIM1_CCMR3_OC5M2                            \ Output compare 5 mode Refer to OC1M description.
$01000000 constant TIM1_TIM1_CCMR3_OC6M2                            \ Output compare 6 mode Refer to OC1M description.
...
$0000ffff constant TIM1_TIM1_CCR6_CCR6                              \ Capture/Compare 6 value CCR6 is the value to be loaded in the actual capture/compare 6 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR3 register (bit OC6PE). Else the preload value is copied in the active capture/compare 6 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on OC6 output.
...
$00000001 constant TIM1_TIM1_AF1_BKINE                              \ BRK BKIN input enable This bit enables the BKIN alternate function input for the timerâs BRK input. BKIN input is 'ORedâ with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF1_BKDF1BK0E                          \ BRK dfsdm1_break[0] enable This bit enables the dfsdm1_break[0] for the timerâs BRK input. dfsdm1_break[0] output is 'ORedâ with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000001 constant TIM1_TIM1_AF2_BK2INE                             \ BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timerâs BRK2 input. BKIN2 input is 'ORedâ with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF2_BK2DF1BK1E                         \ BRK2 dfsdm1_break[1] enable This bit enables the dfsdm1_break[1] for the timerâs BRK2 input. dfsdm1_break[1] output is 'ORedâ with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
\ @brief TIM
\
$44000000 constant TIM1_TIM1_CR1  \ offset: 0x00 : Counter enable Note: External clock, gated mode and encoder mode can work only if the CEN bit has been previously set by software. However trigger mode can set the CEN bit automatically by hardware.
$44000004 constant TIM1_TIM1_CR2  \ offset: 0x04 : Capture/compare preloaded control Note: This bit acts only on channels that have a complementary output.
$44000008 constant TIM1_TIM1_SMCR  \ offset: 0x08 : Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=00100). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$4400000c constant TIM1_TIM1_DIER  \ offset: 0x0C : Update interrupt enable
$44000010 constant TIM1_TIM1_SR   \ offset: 0x10 : Update interrupt flag This bit is set by hardware on an update event. It is cleared by software. At overflow or underflow regarding the repetition counter value (update if repetition counter = 0) and if the UDIS=0 in the TIMx_CR1 register. When CNT is reinitialized by software using the UG bit in TIMx_EGR register, if URS=0 and UDIS=0 in the TIMx_CR1 register. When CNT is reinitialized by a trigger event (refer to control register (TIM1_SMCRTIMx_SMCR)(x = 1, 8)), if URS=0 and UDIS=0 in the TIMx_CR1 register.
$44000014 constant TIM1_TIM1_EGR  \ offset: 0x14 : Update generation This bit can be set by software, it is automatically cleared by hardware.
$44000018 constant TIM1_TIM1_CCMR1_OUTPUT  \ offset: 0x18 : TIM1 capture/compare mode register 1
$44000018 constant TIM1_TIM1_CCMR1_INPUT  \ offset: 0x18 : TIM1 capture/compare mode register 1 [alternate]
$4400001c constant TIM1_TIM1_CCMR2_OUTPUT  \ offset: 0x1C : TIM1 capture/compare mode register 2 [alternate]
$4400001c constant TIM1_TIM1_CCMR2_INPUT  \ offset: 0x1C : TIM1 capture/compare mode register 2 [alternate]
$44000020 constant TIM1_TIM1_CCER  \ offset: 0x20 : Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to for details. Note: On channels having a complementary output, this bit is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the CC1E active bit takes the new value from the preloaded bit only when a Commutation event is generated.
$44000024 constant TIM1_TIM1_CNT  \ offset: 0x24 : Counter value
$44000028 constant TIM1_TIM1_PSC  \ offset: 0x28 : Prescaler value The counter clock frequency (CK_CNT) is equal to fCK_PSC / (PSC[15:0] + 1). PSC contains the value to be loaded in the active prescaler register at each update event (including when the counter is cleared through UG bit of TIMx_EGR register or through trigger controller when configured in âreset modeâ).
$4400002c constant TIM1_TIM1_ARR  \ offset: 0x2C : Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
$44000030 constant TIM1_TIM1_RCR  \ offset: 0x30 : Repetition counter value These bits allow the user to set-up the update rate of the compare registers (i.e. periodic transfers from preload to active registers) when preload registers are enable, as well as the update interrupt generation rate, if this interrupt is enable. Each time the REP_CNT related downcounter reaches zero, an update event is generated and it restarts counting from REP value. As REP_CNT is reloaded with REP value only at the repetition update event U_RC, any write to the TIMx_RCR register is not taken in account until the next repetition update event. It means in PWM mode (REP+1) corresponds to: the number of PWM periods in edge-aligned mode the number of half PWM period in center-aligned mode.
$44000034 constant TIM1_TIM1_CCR1  \ offset: 0x34 : Capture/Compare 1 value If channel CC1 is configured as output: CCR1 is the value to be loaded in the actual capture/compare 1 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR1 register (bit OC1PE). Else the preload value is copied in the active capture/compare 1 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on OC1 output. If channel CC1 is configured as input: CR1 is the counter value transferred by the last input capture 1 event (IC1). The TIMx_CCR1 register is read-only and cannot be programmed.
$44000038 constant TIM1_TIM1_CCR2  \ offset: 0x38 : Capture/Compare 2 value If channel CC2 is configured as output: CCR2 is the value to be loaded in the actual capture/compare 2 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR1 register (bit OC2PE). Else the preload value is copied in the active capture/compare 2 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on OC2 output. If channel CC2 is configured as input: CCR2 is the counter value transferred by the last input capture 2 event (IC2). The TIMx_CCR2 register is read-only and cannot be programmed.
$4400003c constant TIM1_TIM1_CCR3  \ offset: 0x3C : Capture/Compare value If channel CC3 is configured as output: CCR3 is the value to be loaded in the actual capture/compare 3 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR2 register (bit OC3PE). Else the preload value is copied in the active capture/compare 3 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signalled on OC3 output. If channel CC3 is configured as input: CCR3 is the counter value transferred by the last input capture 3 event (IC3). The TIMx_CCR3 register is read-only and cannot be programmed.
$44000040 constant TIM1_TIM1_CCR4  \ offset: 0x40 : Capture/Compare value If channel CC4 is configured as output: CCR4 is the value to be loaded in the actual capture/compare 4 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR2 register (bit OC4PE). Else the preload value is copied in the active capture/compare 4 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signalled on OC4 output. If channel CC4 is configured as input: CCR4 is the counter value transferred by the last input capture 4 event (IC4). The TIMx_CCR4 register is read-only and cannot be programmed.
$44000044 constant TIM1_TIM1_BDTR  \ offset: 0x44 : Dead-time generator setup This bit-field defines the duration of the dead-time inserted between the complementary outputs. DT correspond to this duration. DTG[7:5]Â =Â 0xx => DTÂ =Â DTG[7:0]Â xÂ tDTG with tDTGÂ =Â tDTS. DTG[7:5]Â =Â 10x => DTÂ =Â (64Â +Â DTG[5:0])Â xÂ tDTG with tDTGÂ =Â 2Â xÂ tDTS. DTG[7:5]Â =Â 110 => DTÂ =Â (32Â +Â DTG[4:0])Â xÂ tDTG with tDTGÂ =Â 8Â xÂ tDTS. DTG[7:5]Â =Â 111 => DTÂ =Â (32Â +Â DTG[4:0])Â xÂ tDTG with tDTGÂ =Â 16Â xÂ tDTS. Example if tDTSÂ =Â 125Â ns (8Â MHz), dead-time possible values are: 0 to 15875Â ns by 125Â ns steps, 16Â Î¼s to 31750Â nsÂ  by 250Â ns steps, 32Â Î¼s to 63Â Î¼s by 1Â Î¼s steps, 64Â Î¼s to 126Â Î¼s by 2Â Î¼s steps Note: This bit-field can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
$44000048 constant TIM1_TIM1_DCR  \ offset: 0x48 : DMA base address This 5-bits vector defines the base-address for DMA transfers (when read/write access are done through the TIMx_DMAR address). DBA is defined as an offset starting from the address of the TIMx_CR1 register. Example: ...
$4400004c constant TIM1_TIM1_DMAR  \ offset: 0x4C : DMA register for burst accesses A read or write operation to the DMAR register accesses the register located at the address (TIMx_CR1 address) + (DBA + DMA index) x 4 where TIMx_CR1 address is the address of the control register 1, DBA is the DMA base address configured in TIMx_DCR register, DMA index is automatically controlled by the DMA transfer, and ranges from 0 to DBL (DBL configured in TIMx_DCR).
$44000054 constant TIM1_TIM1_CCMR3  \ offset: 0x54 : TIM1 capture/compare mode register 3
$44000058 constant TIM1_TIM1_CCR5  \ offset: 0x58 : Capture/Compare 5 value CCR5 is the value to be loaded in the actual capture/compare 5 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR3 register (bit OC5PE). Else the preload value is copied in the active capture/compare 5 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on OC5 output.
$4400005c constant TIM1_TIM1_CCR6  \ offset: 0x5C : Capture/Compare 6 value CCR6 is the value to be loaded in the actual capture/compare 6 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR3 register (bit OC6PE). Else the preload value is copied in the active capture/compare 6 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on OC6 output.
$44000060 constant TIM1_TIM1_AF1  \ offset: 0x60 : BRK BKIN input enable This bit enables the BKIN alternate function input for the timerâs BRK input. BKIN input is 'ORedâ with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$44000064 constant TIM1_TIM1_AF2  \ offset: 0x64 : BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timerâs BRK2 input. BKIN2 input is 'ORedâ with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$44000068 constant TIM1_TIM1_TISEL  \ offset: 0x68 : selects TI1[0] to TI1[15] input Others: Reserved
