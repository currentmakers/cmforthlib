...
$00000040 constant I2C1_I2C_CR1_TCIE                                \ Transfer Complete interrupt enable Note: Any of these events generate an interrupt: Transfer Complete (TC) Transfer Complete Reload (TCR)
...
$00040000 constant I2C1_I2C_CR1_WUPEN                               \ Wakeup from Stop mode enable Note: If the Wakeup from Stop mode feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to . Note: WUPEN can be set only when DNF = ‘0000’
$00080000 constant I2C1_I2C_CR1_GCEN                                \ General call enable
$00100000 constant I2C1_I2C_CR1_SMBHEN                              \ SMBus host address enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00200000 constant I2C1_I2C_CR1_SMBDEN                              \ SMBus device default address enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00400000 constant I2C1_I2C_CR1_ALERTEN                             \ SMBus alert enable Note: When ALERTEN=0, the SMBA pin can be used as a standard GPIO. If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00800000 constant I2C1_I2C_CR1_PECEN                               \ PEC enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
...
$000003ff constant I2C1_I2C_CR2_SADD                                \ Slave address (master mode) In 7-bit addressing mode (ADD10 = 0): SADD[7:1] should be written with the 7-bit slave address to be sent. The bits SADD[9], SADD[8] and SADD[0] are don't care. In 10-bit addressing mode (ADD10 = 1): SADD[9:0] should be written with the 10-bit slave address to be sent. Note: Changing these bits when the START bit is set is not allowed.
...
$00ff0000 constant I2C1_I2C_CR2_NBYTES                              \ Number of bytes The number of bytes to be transmitted/received is programmed there. This field is don’t care in slave mode with SBC=0. Note: Changing these bits when the START bit is set is not allowed.
...
$000003ff constant I2C1_I2C_OAR1_OA1                                \ Interface own slave address 7-bit addressing mode: OA1[7:1] contains the 7-bit own slave address. The bits OA1[9], OA1[8] and OA1[0] are don't care. 10-bit addressing mode: OA1[9:0] contains the 10-bit own slave address. Note: These bits can be written only when OA1EN=0.
...
$f0000000 constant I2C1_I2C_TIMINGR_PRESC                           \ Timing prescaler This field is used to prescale i2c_ker_ck in order to generate the clock period tPRESC used for data setup and hold counters (refer to ) and for SCL high and low level counters (refer to ). tPRESC = (PRESC+1) x tI2CCLK
...
$00000800 constant I2C1_I2C_ICR_PECCF                               \ PEC Error flag clear Writing 1 to this bit clears the PECERR flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00001000 constant I2C1_I2C_ICR_TIMOUTCF                            \ Timeout detection flag clear Writing 1 to this bit clears the TIMEOUT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00002000 constant I2C1_I2C_ICR_ALERTCF                             \ Alert flag clear Writing 1 to this bit clears the ALERT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
...
$0000000f constant I2C1_I2C_HWCFGR_SMBUS                            \ SMBus mode
$000000f0 constant I2C1_I2C_HWCFGR_ASYN                             \ Independent kernel clock
$00000f00 constant I2C1_I2C_HWCFGR_WKP                              \ Wakeup from Stop mode
...
$0000000f constant I2C1_I2C_VERR_MINREV                             \ Minor revision
$000000f0 constant I2C1_I2C_VERR_MAJREV                             \ Major revision
...
$00000000 constant I2C1_I2C_IPIDR_ID                                \ Identifier.
...
$00000000 constant I2C1_I2C_SIDR_SID                                \ Size identifier.


\
\ @brief I2C
\
$40012000 constant I2C1_I2C_CR1   \ offset: 0x00 : I2C control register 1
$40012004 constant I2C1_I2C_CR2   \ offset: 0x04 : I2C control register 2
$40012008 constant I2C1_I2C_OAR1  \ offset: 0x08 : I2C own address 1 register
$4001200c constant I2C1_I2C_OAR2  \ offset: 0x0C : I2C own address 2 register
$40012010 constant I2C1_I2C_TIMINGR  \ offset: 0x10 : I2C timing register
$40012014 constant I2C1_I2C_TIMEOUTR  \ offset: 0x14 : I2C timeout register
$40012018 constant I2C1_I2C_ISR   \ offset: 0x18 : I2C interrupt and status register
$4001201c constant I2C1_I2C_ICR   \ offset: 0x1C : I2C interrupt clear register
$40012020 constant I2C1_I2C_PECR  \ offset: 0x20 : I2C PEC register
$40012024 constant I2C1_I2C_RXDR  \ offset: 0x24 : I2C receive data register
$40012028 constant I2C1_I2C_TXDR  \ offset: 0x28 : I2C transmit data register
