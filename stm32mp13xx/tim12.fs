...
$00000300 constant TIM12_TIM12_CR1_CKD                              \ Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and sampling clock used by the digital filters (TIx),
...
$00000070 constant TIM12_TIM12_CR2_MMS                              \ Master mode selection These bits allow to select the information to be sent in master mode to slave timers for synchronization (TRGO). The combination is as follows:
$00000080 constant TIM12_TIM12_CR2_TI1S                             \ TI1 selection
...
$00000200 constant TIM12_TIM12_SR_CC1OF                             \ Capture/Compare 1 overcapture flag This flag is set by hardware only when the corresponding channel is configured in input capture mode. It is cleared by software by writing it to '0â.
...
$00000008 constant TIM12_TIM12_CCMR1_OUTPUT_OC1PE                   \ Output compare 1 preload enable Note: The PWM mode can be used without validating the preload register only in one-pulse mode (OPM bit set in the TIMx_CR1 register). Else the behavior is not guaranteed.
$00000070 constant TIM12_TIM12_CCMR1_OUTPUT_OC1M1                   \ Output compare 1 mode (refer to bit 16 for OC1M[3]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas the active level of OC1 depends on the CC1P. Note: In PWM mode 1 or 2, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from âfrozenâ mode to âPWMâ mode. Note: The OC1M[3] bit is not contiguous, located in bit 16.
...
$00007000 constant TIM12_TIM12_CCMR1_OUTPUT_OC2M1                   \ Output compare 2 mode Refer to OC1M[3:0] for bit description.
$00010000 constant TIM12_TIM12_CCMR1_OUTPUT_OC1M2                   \ Output compare 1 mode (refer to bit 16 for OC1M[3]) These bits define the behavior of the output reference signal OC1REF from which OC1 is derived. OC1REF is active high whereas the active level of OC1 depends on the CC1P. Note: In PWM mode 1 or 2, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from âfrozenâ mode to âPWMâ mode. Note: The OC1M[3] bit is not contiguous, located in bit 16.
$01000000 constant TIM12_TIM12_CCMR1_OUTPUT_OC2M2                   \ Output compare 2 mode Refer to OC1M[3:0] for bit description.
...
$0000000c constant TIM12_TIM12_CCMR1_INPUT_IC1PSC                   \ Input capture 1 prescaler This bitfield defines the ratio of the prescaler acting on the CC1 input (IC1). The prescaler is reset as soon as CC1E=â0â (TIMx_CCER register).
...
$00000008 constant TIM12_TIM12_CCER_CC1NP                           \ Capture/Compare 1 complementary output Polarity CC1 channel configured as output: CC1NP must be kept cleared CC1 channel configured as input: CC1NP is used in conjunction with CC1P to define TI1FP1/TI2FP1 polarity (refer to CC1P description).
...
$0000ffff constant TIM12_TIM12_CNT_CNT                              \ Counter value
...
$0000ffff constant TIM12_TIM12_ARR_ARR                              \ Auto-reload value ARR is the value to be loaded into the actual auto-reload register. Refer to the for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$0000000f constant TIM12_TIM12_TISEL_TI1SEL                         \ selects TI1[0] to TI1[15] input Other: Reserved
$00000f00 constant TIM12_TIM12_TISEL_TI2SEL                         \ selects TI2[0] to TI2[15] input Other: Reserved


\
\ @brief TIM register block
\
$4c007000 constant TIM12_TIM12_CR1  \ offset: 0x00 : TIM12 control register 1
$4c007004 constant TIM12_TIM12_CR2  \ offset: 0x04 : TIM12 control register 2
$4c007008 constant TIM12_TIM12_SMCR  \ offset: 0x08 : TIM12 slave mode control register
$4c00700c constant TIM12_TIM12_DIER  \ offset: 0x0C : TIM12 Interrupt enable register
$4c007010 constant TIM12_TIM12_SR  \ offset: 0x10 : TIM12 status register
$4c007014 constant TIM12_TIM12_EGR  \ offset: 0x14 : TIM12 event generation register
$4c007018 constant TIM12_TIM12_CCMR1_OUTPUT  \ offset: 0x18 : TIM12 capture/compare mode register 1 [alternate]
$4c007018 constant TIM12_TIM12_CCMR1_INPUT  \ offset: 0x18 : TIM12 capture/compare mode register 1 [alternate]
$4c007020 constant TIM12_TIM12_CCER  \ offset: 0x20 : TIM12 capture/compare enable register
$4c007024 constant TIM12_TIM12_CNT  \ offset: 0x24 : TIM12 counter
$4c007028 constant TIM12_TIM12_PSC  \ offset: 0x28 : TIM12 prescaler
$4c00702c constant TIM12_TIM12_ARR  \ offset: 0x2C : TIM12 auto-reload register
$4c007034 constant TIM12_TIM12_CCR1  \ offset: 0x34 : TIM12 capture/compare register 1
$4c007038 constant TIM12_TIM12_CCR2  \ offset: 0x38 : TIM12 capture/compare register 2
$4c007068 constant TIM12_TIM12_TISEL  \ offset: 0x68 : TIM12 timer input selection register
