...
$00000001 constant LPTIM1_LPTIM_ISR_CMPM                            \ Compare match The CMPM bit is set by hardware to inform application that LPTIM_CNT register value reached the LPTIM_CMP registerâs value.
$00000002 constant LPTIM1_LPTIM_ISR_ARRM                            \ Autoreload match ARRM is set by hardware to inform application that LPTIM_CNT registerâs value reached the LPTIM_ARR registerâs value. ARRM flag can be cleared by writing 1 to the ARRMCF bit in the LPTIM_ICR register.
$00000004 constant LPTIM1_LPTIM_ISR_EXTTRIG                         \ External trigger edge event EXTTRIG is set by hardware to inform application that a valid edge on the selected external trigger input has occurred. If the trigger is ignored because the timer has already started, then this flag is not set. EXTTRIG flag can be cleared by writing 1 to the EXTTRIGCF bit in the LPTIM_ICR register.
$00000008 constant LPTIM1_LPTIM_ISR_CMPOK                           \ Compare register update OK CMPOK is set by hardware to inform application that the APB bus write operation to the LPTIM_CMP register has been successfully completed.
$00000010 constant LPTIM1_LPTIM_ISR_ARROK                           \ Autoreload register update OK ARROK is set by hardware to inform application that the APB bus write operation to the LPTIM_ARR register has been successfully completed. ARROK flag can be cleared by writing 1 to the ARROKCF bit in the LPTIM_ICR register.
$00000020 constant LPTIM1_LPTIM_ISR_UP                              \ Counter direction change down to up In Encoder mode, UP bit is set by hardware to inform application that the counter direction has changed from down to up. UP flag can be cleared by writing 1 to the UPCF bit in the LPTIM_ICR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Please refer to .
$00000040 constant LPTIM1_LPTIM_ISR_DOWN                            \ Counter direction change up to down In Encoder mode, DOWN bit is set by hardware to inform application that the counter direction has changed from up to down. DOWN flag can be cleared by writing 1 to the DOWNCF bit in the LPTIM_ICR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Please refer to .
...
$00000001 constant LPTIM1_LPTIM_ICR_CMPMCF                          \ Compare match clear flag Writing 1 to this bit clears the CMPM flag in the LPTIM_ISR register
$00000002 constant LPTIM1_LPTIM_ICR_ARRMCF                          \ Autoreload match clear flag Writing 1 to this bit clears the ARRM flag in the LPTIM_ISR register
$00000004 constant LPTIM1_LPTIM_ICR_EXTTRIGCF                       \ External trigger valid edge clear flag Writing 1 to this bit clears the EXTTRIG flag in the LPTIM_ISR register
$00000008 constant LPTIM1_LPTIM_ICR_CMPOKCF                         \ Compare register update OK clear flag Writing 1 to this bit clears the CMPOK flag in the LPTIM_ISR register
$00000010 constant LPTIM1_LPTIM_ICR_ARROKCF                         \ Autoreload register update OK clear flag Writing 1 to this bit clears the ARROK flag in the LPTIM_ISR register
$00000020 constant LPTIM1_LPTIM_ICR_UPCF                            \ Direction change to UP clear flag Writing 1 to this bit clear the UP flag in the LPTIM_ISR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Please refer to .
$00000040 constant LPTIM1_LPTIM_ICR_DOWNCF                          \ Direction change to down clear flag Writing 1 to this bit clear the DOWN flag in the LPTIM_ISR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Please refer to .
...
$00000001 constant LPTIM1_LPTIM_IER_CMPMIE                          \ Compare match Interrupt Enable
$00000002 constant LPTIM1_LPTIM_IER_ARRMIE                          \ Autoreload match Interrupt Enable
$00000004 constant LPTIM1_LPTIM_IER_EXTTRIGIE                       \ External trigger valid edge Interrupt Enable
$00000008 constant LPTIM1_LPTIM_IER_CMPOKIE                         \ Compare register update OK Interrupt Enable
$00000010 constant LPTIM1_LPTIM_IER_ARROKIE                         \ Autoreload register update OK Interrupt Enable
$00000020 constant LPTIM1_LPTIM_IER_UPIE                            \ Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Please refer to .
$00000040 constant LPTIM1_LPTIM_IER_DOWNIE                          \ Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Please refer to .
...
$0000e000 constant LPTIM1_LPTIM_CFGR_TRIGSEL                        \ Trigger selector The TRIGSEL bits select the trigger source that will serve as a trigger event for the LPTIM among the below 8 available sources: See for details.
...
$00200000 constant LPTIM1_LPTIM_CFGR_WAVPOL                         \ Waveform shape polarity The WAVEPOL bit controls the output polarity
$00400000 constant LPTIM1_LPTIM_CFGR_PRELOAD                        \ Registers update mode The PRELOAD bit controls the LPTIM_ARR and the LPTIM_CMP registers update modality
...
$00000010 constant LPTIM1_LPTIM_CR_RSTARE                           \ Reset after read enable This bit is set and cleared by software. When RSTARE is set to '1', any read access to LPTIM_CNT register will asynchronously reset LPTIM_CNT register content.
...
$0000ffff constant LPTIM1_LPTIM_CMP_CMP                             \ Compare value CMP is the compare value used by the LPTIM.
...
$0000ffff constant LPTIM1_LPTIM_ARR_ARR                             \ Auto reload value ARR is the autoreload value for the LPTIM. This value must be strictly greater than the CMP[15:0] value.
...
$00000003 constant LPTIM1_LPTIM_CFGR2_IN1SEL                        \ LPTIM input 1 selection The IN1SEL bits control the LPTIM Input 1 multiplexer, which connects LPTIM Input 1 to one of the available inputs. For connection details refer to . Note: If LPTIM does not implement external input clock, these bits are reserved. Please refer to .
$00000030 constant LPTIM1_LPTIM_CFGR2_IN2SEL                        \ LPTIM input 2 selection The IN2SEL bits control the LPTIM Input 2 multiplexer, which connect LPTIM Input 2 to one of the available inputs. For connection details refer to . Note: If the LPTIM does not support encoder mode feature, these bits are reserved. Please refer to .
...
$0000000f constant LPTIM1_LPTIM_VERR_MINREV                         \ Minor revision This is a read only bit-field and is read as MINREV[3:0] = 4.
$000000f0 constant LPTIM1_LPTIM_VERR_MAJREV                         \ Major revision This is read only bit-field and is read as MAJREV[7:4] = 1.
...
$00000000 constant LPTIM1_LPTIM_PIDR_P_ID                           \ Peripheral type identifier This a read only register and is always read as P_ID[31:0] = 0x00120011.
...
$00000000 constant LPTIM1_LPTIM_SIDR_S_ID                           \ Registers map size identifier This a read only register and is always read as S_ID[31:0] = 0xA3C5DD01. This register identifies the size of the memory region allocated to the LPTIM registers. The size of this memory region is 1Â KB.
