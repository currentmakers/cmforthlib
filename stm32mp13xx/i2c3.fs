...
$f0000000 constant I2C3_I2C_TIMINGR_PRESC                           \ Timing prescaler This field is used to prescale i2c_ker_ck in order to generate the clock period tPRESC used for data setup and hold counters (refer to ) and for SCL high and low level counters (refer to ). tPRESC = (PRESC+1) x tI2CCLK
...
$00000800 constant I2C3_I2C_ICR_PECCF                               \ PEC Error flag clear Writing 1 to this bit clears the PECERR flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00001000 constant I2C3_I2C_ICR_TIMOUTCF                            \ Timeout detection flag clear Writing 1 to this bit clears the TIMEOUT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
$00002000 constant I2C3_I2C_ICR_ALERTCF                             \ Alert flag clear Writing 1 to this bit clears the ALERT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to ‘0’. Refer to .
...
$0000000f constant I2C3_I2C_HWCFGR_SMBUS                            \ SMBus mode
$000000f0 constant I2C3_I2C_HWCFGR_ASYN                             \ Independent kernel clock
$00000f00 constant I2C3_I2C_HWCFGR_WKP                              \ Wakeup from Stop mode
...
$0000000f constant I2C3_I2C_VERR_MINREV                             \ Minor revision
$000000f0 constant I2C3_I2C_VERR_MAJREV                             \ Major revision
...
$00000000 constant I2C3_I2C_IPIDR_ID                                \ Identifier.
...
$00000000 constant I2C3_I2C_SIDR_SID                                \ Size identifier.


\
\ @brief I2C3 event interrupt
\
$4c004000 constant I2C3_I2C_CR1   \ offset: 0x00 : I2C control register 1
$4c004004 constant I2C3_I2C_CR2   \ offset: 0x04 : I2C control register 2
$4c004008 constant I2C3_I2C_OAR1  \ offset: 0x08 : I2C own address 1 register
$4c00400c constant I2C3_I2C_OAR2  \ offset: 0x0C : I2C own address 2 register
$4c004010 constant I2C3_I2C_TIMINGR  \ offset: 0x10 : I2C timing register
$4c004014 constant I2C3_I2C_TIMEOUTR  \ offset: 0x14 : I2C timeout register
$4c004018 constant I2C3_I2C_ISR   \ offset: 0x18 : I2C interrupt and status register
$4c00401c constant I2C3_I2C_ICR   \ offset: 0x1C : I2C interrupt clear register
$4c004020 constant I2C3_I2C_PECR  \ offset: 0x20 : I2C PEC register
$4c004024 constant I2C3_I2C_RXDR  \ offset: 0x24 : I2C receive data register
$4c004028 constant I2C3_I2C_TXDR  \ offset: 0x28 : I2C transmit data register
$4c0043f0 constant I2C3_I2C_HWCFGR  \ offset: 0x3F0 : I2C hardware configuration register
$4c0043f4 constant I2C3_I2C_VERR  \ offset: 0x3F4 : I2C version register
$4c0043f8 constant I2C3_I2C_IPIDR  \ offset: 0x3F8 : I2C identification register
$4c0043fc constant I2C3_I2C_SIDR  \ offset: 0x3FC : I2C size identification register
