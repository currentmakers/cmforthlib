...
[ifndef] SYSTEM_CTRL_DEF
  ...
  [ifdef] SYSTEM_CTRL_IO_DTR_DEF
    ...
    $04 constant SYSTEM_CTRL_PA4_DT             \ [0x04] PA4_DT:Interrupt Detection Type for port A I/Os.
    $05 constant SYSTEM_CTRL_PA5_DT             \ [0x05] PA5_DT:Interrupt Detection Type for port A I/Os.
    $06 constant SYSTEM_CTRL_PA6_DT             \ [0x06] PA6_DT:Interrupt Detection Type for port A I/Os.
    $07 constant SYSTEM_CTRL_PA7_DT             \ [0x07] PA7_DT:Interrupt Detection Type for port A I/Os.
    ...
    $18 constant SYSTEM_CTRL_PB8_DT             \ [0x18] PB8_DT:Interrupt Detection Type for port B I/Os.
    $19 constant SYSTEM_CTRL_PB9_DT             \ [0x19] PB9_DT:Interrupt Detection Type for port B I/Os.
    $1a constant SYSTEM_CTRL_PB10_DT            \ [0x1a] PB10_DT:Interrupt Detection Type for port B I/Os.
    $1b constant SYSTEM_CTRL_PB11_DT            \ [0x1b] PB11_DT:Interrupt Detection Type for port B I/Os.
  ...
  [ifdef] SYSTEM_CTRL_IO_IBER_DEF
    ...
    $04 constant SYSTEM_CTRL_PA4_IBE            \ [0x04] PA4_IBE: Interrupt edge selection for Port A I/Os.
    $05 constant SYSTEM_CTRL_PA5_IBE            \ [0x05] PA5_IBE: Interrupt edge selection for Port A I/Os.
    $06 constant SYSTEM_CTRL_PA6_IBE            \ [0x06] PA6_IBE: Interrupt edge selection for Port A I/Os.
    $07 constant SYSTEM_CTRL_PA7_IBE            \ [0x07] PA7_IBE: Interrupt edge selection for Port A I/Os.
    ...
    $0c constant SYSTEM_CTRL_PA12_IBE           \ [0x0c] PA12_IBE: Interrupt edge selection for Port A I/Os.
    $0d constant SYSTEM_CTRL_PA13_IBE           \ [0x0d] PA13_IBE: Interrupt edge selection for Port A I/Os.
    $0e constant SYSTEM_CTRL_PA14_IBE           \ [0x0e] PA14_IBE: Interrupt edge selection for Port A I/Os.
    $0f constant SYSTEM_CTRL_PA15_IBE           \ [0x0f] PA15_IBE: Interrupt edge selection for Port A I/Os.
    $10 constant SYSTEM_CTRL_PB0_IBE            \ [0x10] PB0_IBE: Interrupt edge selection for port B I/Os.
    $11 constant SYSTEM_CTRL_PB1_IBE            \ [0x11] PB1_IBE: Interrupt edge selection for port B I/Os.
    $12 constant SYSTEM_CTRL_PB2_IBE            \ [0x12] PB2_IBE: Interrupt edge selection for port B I/Os.
    $13 constant SYSTEM_CTRL_PB3_IBE            \ [0x13] PB3_IBE: Interrupt edge selection for port B I/Os.
    $14 constant SYSTEM_CTRL_PB4_IBE            \ [0x14] PB4_IBE: Interrupt edge selection for port B I/Os.
    $15 constant SYSTEM_CTRL_PB5_IBE            \ [0x15] PB5_IBE: Interrupt edge selection for port B I/Os.
    $16 constant SYSTEM_CTRL_PB6_IBE            \ [0x16] PB6_IBE: Interrupt edge selection for port B I/Os.
    $17 constant SYSTEM_CTRL_PB7_IBE            \ [0x17] PB7_IBE: Interrupt edge selection for port B I/Os.
    $18 constant SYSTEM_CTRL_PB8_IBE            \ [0x18] PB8_IBE: Interrupt edge selection for port B I/Os.
    $19 constant SYSTEM_CTRL_PB9_IBE            \ [0x19] PB9_IBE: Interrupt edge selection for port B I/Os.
    $1a constant SYSTEM_CTRL_PB10_IBE           \ [0x1a] PB10_IBE: Interrupt edge selection for port B I/Os.
    $1b constant SYSTEM_CTRL_PB11_IBE           \ [0x1b] PB11_IBE: Interrupt edge selection for port B I/Os.
  ...
  [ifdef] SYSTEM_CTRL_IO_IEVR_DEF
    ...
    $04 constant SYSTEM_CTRL_PA4_IEV            \ [0x04] PA4_IEV : Interrupt polarity event for Port A I/Os.
    $05 constant SYSTEM_CTRL_PA5_IEV            \ [0x05] PA5_IEV : Interrupt polarity event for Port A I/Os.
    $06 constant SYSTEM_CTRL_PA6_IEV            \ [0x06] PA6_IEV : Interrupt polarity event for Port A I/Os.
    $07 constant SYSTEM_CTRL_PA7_IEV            \ [0x07] PA7_IEV : Interrupt polarity event for Port A I/Os.
    ...
    $0c constant SYSTEM_CTRL_PA12_IEV           \ [0x0c] PA12_IEV : Interrupt polarity event for Port A I/Os.
    $0d constant SYSTEM_CTRL_PA13_IEV           \ [0x0d] PA13_IEV : Interrupt polarity event for Port A I/Os.
    $0e constant SYSTEM_CTRL_PA14_IEV           \ [0x0e] PA14_IEV : Interrupt polarity event for Port A I/Os.
    $0f constant SYSTEM_CTRL_PA15_IEV           \ [0x0f] PA15_IEV : Interrupt polarity event for Port A I/Os.
    ...
    $18 constant SYSTEM_CTRL_PB8_IEV            \ [0x18] PB8_IEV : Interrupt polarity event for Port B I/Os.
    $19 constant SYSTEM_CTRL_PB9_IEV            \ [0x19] PB9_IEV : Interrupt polarity event for Port B I/Os.
    $1a constant SYSTEM_CTRL_PB10_IEV           \ [0x1a] PB10_IEV : Interrupt polarity event for Port B I/Os.
    $1b constant SYSTEM_CTRL_PB11_IEV           \ [0x1b] PB11_IEV : Interrupt polarity event for Port B I/Os.
  ...
  [ifdef] SYSTEM_CTRL_IO_IER_DEF
    ...
    $04 constant SYSTEM_CTRL_PA4_IE             \ [0x04] PA4_IE: Interrupt enable for port A I/Os.
    $05 constant SYSTEM_CTRL_PA5_IE             \ [0x05] PA5_IE: Interrupt enable for port A I/Os.
    $06 constant SYSTEM_CTRL_PA6_IE             \ [0x06] PA6_IE: Interrupt enable for port A I/Os.
    $07 constant SYSTEM_CTRL_PA7_IE             \ [0x07] PA7_IE: Interrupt enable for port A I/Os.
    ...
    $0c constant SYSTEM_CTRL_PA12_IE            \ [0x0c] PA12_IE: Interrupt enable for port A I/Os.
    $0d constant SYSTEM_CTRL_PA13_IE            \ [0x0d] PA13_IE: Interrupt enable for port A I/Os.
    $0e constant SYSTEM_CTRL_PA14_IE            \ [0x0e] PA14_IE: Interrupt enable for port A I/Os.
    $0f constant SYSTEM_CTRL_PA15_IE            \ [0x0f] PA15_IE: Interrupt enable for port A I/Os.
    ...
    $18 constant SYSTEM_CTRL_PB8_IE             \ [0x18] PB8_IE: Interrupt enable for port B I/Os.
    $19 constant SYSTEM_CTRL_PB9_IE             \ [0x19] PB9_IE: Interrupt enable for port B I/Os.
    $1a constant SYSTEM_CTRL_PB10_IE            \ [0x1a] PB10_IE: Interrupt enable for port B I/Os.
    $1b constant SYSTEM_CTRL_PB11_IE            \ [0x1b] PB11_IE: Interrupt enable for port B I/Os.
  ...
  [ifdef] SYSTEM_CTRL_IO_ISCR_DEF
    ...
    $04 constant SYSTEM_CTRL_PA4_ISC            \ [0x04] PA4_ISC: Interrupt status (before mask) for port a I/Os..
    $05 constant SYSTEM_CTRL_PA5_ISC            \ [0x05] PA5_ISC: Interrupt status (before mask) for port a I/Os..
    $06 constant SYSTEM_CTRL_PA6_ISC            \ [0x06] PA6_ISC: Interrupt status (before mask) for port a I/Os..
    $07 constant SYSTEM_CTRL_PA7_ISC            \ [0x07] PA7_ISC: Interrupt status (before mask) for port a I/Os..
    ...
    $0c constant SYSTEM_CTRL_PA12_ISC           \ [0x0c] PA12_ISC: Interrupt status (before mask) for port a I/Os.
    $0d constant SYSTEM_CTRL_PA13_ISC           \ [0x0d] PA13_ISC: Interrupt status (before mask) for port a I/Os.
    $0e constant SYSTEM_CTRL_PA14_ISC           \ [0x0e] PA14_ISC: Interrupt status (before mask) for port a I/Os.
    $0f constant SYSTEM_CTRL_PA15_ISC           \ [0x0f] PA15_ISC: Interrupt status (before mask) for port a I/Os.
    ...
    $18 constant SYSTEM_CTRL_PB8_ISC            \ [0x18] PB8_ISC: Interrupt status (before mask) for port B I/Os..
    $19 constant SYSTEM_CTRL_PB9_ISC            \ [0x19] PB9_ISC: Interrupt status (before mask) for port B I/Os..
    $1a constant SYSTEM_CTRL_PB10_ISC           \ [0x1a] PB10_ISC: Interrupt status (before mask) for port B I/Os..
    $1b constant SYSTEM_CTRL_PB11_ISC           \ [0x1b] PB11_ISC: Interrupt status (before mask) for port B I/Os..
