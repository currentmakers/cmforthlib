...
$00000002 constant PWRC_CR1_ENSDNBOR                                \ Enable BOR reset supervising during SHUTDOWN mode.
...
$00000040 constant PWRC_CR2_RAMRET2                                 \ Enables the RAM2 bank retention in DEEPSTOP mode.
$00000080 constant PWRC_CR2_RAMRET3                                 \ Enables the RAM3 bank retention in DEEPSTOP mode.
$00000200 constant PWRC_CR2_ENTS                                    \ Enable the temperature sensor.
$00000400 constant PWRC_CR2_LSILPMUFEN                              \ LSI LPMU force enable.
...
$0000ffff constant PWRC_PUCRA_PUA                                   \ PUA[x] : Pull Up Pull up activation on port A[i] pad when APC bit of PWRC CR3 is set
...
$0000ffff constant PWRC_PDCRA_PDA                                   \ PDA[x]: Pull Down Pull Down activation on port A[i] pad when APC bit of PWRC CR3 is set
...
$0000ffff constant PWRC_PUCRB_PUB                                   \ PUB[x] : Pull Up Pull up activation on port B[i] pad when APC bit of PWRC CR3 is set
...
$0000ffff constant PWRC_PDCRB_PDB                                   \ PDB[x]: Pull Down Pull Down activation on port B[i] pad when APC bit of PWRC CR3 is set
...
$00000100 constant PWRC_CR6_EWU20                                   \ Enable wakeup on PB8 I/O event.
$00000200 constant PWRC_CR6_EWU21                                   \ Enable wakeup on PB9 I/O event.
$00000400 constant PWRC_CR6_EWU22                                   \ Enable wakeup on PB10 I/O event.
$00000800 constant PWRC_CR6_EWU23                                   \ Enable wakeup on PB11 I/O event.
$00001000 constant PWRC_CR6_EWU24                                   \ Enable wakeup on PA12 I/O event.
$00002000 constant PWRC_CR6_EWU25                                   \ Enable wakeup on PA13 I/O event.
$00004000 constant PWRC_CR6_EWU26                                   \ Enable wakeup on PA14 I/O event.
$00008000 constant PWRC_CR6_EWU27                                   \ Enable wakeup on PA15 I/O event.
...
$00000100 constant PWRC_CR7_WUP20                                   \ Wake-up polarity for PB8 IO event.
$00000200 constant PWRC_CR7_WUP21                                   \ Wake-up polarity for PB9 IO event.
$00000400 constant PWRC_CR7_WUP22                                   \ Wake-up polarity for PB10 IO event.
$00000800 constant PWRC_CR7_WUP23                                   \ Wake-up polarity for PB11 IO event.
$00001000 constant PWRC_CR7_WUP24                                   \ Wake-up polarity for PB12 IO event.
$00002000 constant PWRC_CR7_WUP25                                   \ Wake-up polarity for PB13 IO event.
$00004000 constant PWRC_CR7_WUP26                                   \ Wake-up polarity for PB14 IO event.
$00008000 constant PWRC_CR7_WUP27                                   \ Wake-up polarity for PB15 IO event.
...
$00000080 constant PWRC_SR3_WUF19                                   \ PA7 I/O wake-up flag.
$00000100 constant PWRC_SR3_WUF20                                   \ PB8 I/O wake-up flag.
$00000200 constant PWRC_SR3_WUF21                                   \ PB9 I/O wake-up flag.
$00000400 constant PWRC_SR3_WUF22                                   \ PB10 I/O wake-up flag.
$00000800 constant PWRC_SR3_WUF23                                   \ PB11 I/O wake-up flag.
$00001000 constant PWRC_SR3_WUF24                                   \ PB12 I/O wake-up flag.
$00002000 constant PWRC_SR3_WUF25                                   \ PB13 I/O wake-up flag.
$00004000 constant PWRC_SR3_WUF26                                   \ PB14 I/O wake-up flag.
$00008000 constant PWRC_SR3_WUF27                                   \ PB15 I/O wake-up flag.
...
$00000003 constant PWRC_IOXCFG_IOCFG0                               \ Drive configuration for PA8.
$0000000c constant PWRC_IOXCFG_IOCFG1                               \ Drive configuration for PA9.
$00000030 constant PWRC_IOXCFG_IOCFG2                               \ Drive configuration for PA10.
$000000c0 constant PWRC_IOXCFG_IOCFG3                               \ Drive configuration for PA11.
$00000300 constant PWRC_IOXCFG_IOCFG4                               \ Drive configuration for PA4.
$00000c00 constant PWRC_IOXCFG_IOCFG5                               \ Drive configuration for PA5.
$00003000 constant PWRC_IOXCFG_IOCFG6                               \ Drive configuration for PA6.
$0000c000 constant PWRC_IOXCFG_IOCFG7                               \ Drive configuration for PA7.
...
$48500040 constant PWRC_IOXCFG    \ offset: 0x40 : IOxCFG register
