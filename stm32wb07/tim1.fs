...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_CR2_DEF
    ...
    $07 constant TIM1_TI1S                      \ [0x07] TI1S: TI1 selection 0: The TIMx_CH1 pin is connected to TI1 input. 1: The TIMx_CH1, CH2 and CH3 pins are connected to the TI1 input (XOR combination)
  ...
  [ifdef] TIM1_DIER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_UIE                       \ [0x00] UIE: Update interrupt enable 0: Update interrupt disabled 1: Update interrupt enabled
    $01 constant TIM1_CC1IE                     \ [0x01] CC1IE: Capture/Compare 1 interrupt enable 0: CC1 interrupt disabled. 1: CC1 interrupt enabled
    $02 constant TIM1_CC2IE                     \ [0x02] CC2IE: Capture/Compare 2 interrupt enable 0: CC2 interrupt disabled 1: CC2 interrupt enabled
    $03 constant TIM1_CC3IE                     \ [0x03] CC3IE: Capture/Compare 3 interrupt enable 0: CC3 interrupt disabled 1: CC3 interrupt enabled
    $04 constant TIM1_CC4IE                     \ [0x04] CC4IE: Capture/Compare 4 interrupt enable 0: CC4 interrupt disabled 1: CC4 interrupt enabled
    $05 constant TIM1_COMIE                     \ [0x05] COM interrupt enable
    $06 constant TIM1_TIE                       \ [0x06] TIE: Trigger interrupt enable 0: Trigger interrupt disabled 1: Trigger interrupt enabled
  ...
  [ifdef] TIM1_CCMR2_in_DEF
    ...
    \
    $00 constant TIM1_CC3S                      \ [0x00 : 2] CC3S: Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. 00: CC3 channel is configured as output 01: CC3 channel is configured as input, IC3 is mapped on TI3 10: CC3 channel is configured as input, IC3 is mapped on TI4 11: CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) Note: CC3S bits are writable only when the channel is OFF (CC3E = '0' in TIMx_CCER).
    $02 constant TIM1_IC3PSC                    \ [0x02 : 2] IC3PSC: Input capture 3 prescaler
    $04 constant TIM1_IC3F                      \ [0x04 : 4] IC3F: Input capture 3 filter
    $08 constant TIM1_CC4S                      \ [0x08 : 2] CC4S: Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. 00: CC4 channel is configured as output 01: CC4 channel is configured as input, IC4 is mapped on TI4 10: CC4 channel is configured as input, IC4 is mapped on TI3 11: CC4 channel is configured as input, IC4 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) Note: CC4S bits are writable only when the channel is OFF (CC4E = '0' in TIMx_CCER).
    $0a constant TIM1_IC4PSC                    \ [0x0a : 2] IC4PSC: Input capture 4 prescaler
    $0c constant TIM1_IC4F                      \ [0x0c : 4] IC4F: Input capture 4 filter
  [then]
  ...
  [ifdef] TIM1_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_CNT                       \ [0x00 : 16] CNT[15:0]: Counter value
    $1f constant TIM1_UIFCPY                    \ [0x1f] UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register. If the UIFREMAP bit in TIMx_CR1 is reset, bit 31 is reserved and read as 0.
  [then]
  ...
  [ifdef] TIM1_PSC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_PSC                       \ [0x00 : 16] PSC[15:0]: Prescaler value The counter clock frequency (CK_CNT) is equal to fCK_PSC / (PSC[15:0] + 1). PSC contains the value to be loaded in the active prescaler register at each update event (including when the counter is cleared through UG bit of TIMx_EGR register or through trigger controller when configured in 'reset mode').
  [then]
  ...
  [ifdef] TIM1_ARR_DEF
    ...
    \
    $00 constant TIM1_ARR                       \ [0x00 : 16] ARR[15:0]: Prescaler value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 22.3.1: Time-base unit on page 418 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM1_BDTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_DTG                       \ [0x00 : 8] Deadtime generator setup.
  ...
  [ifdef] TIM1_CCMR3_DEF
    ...
    $04 constant TIM1_OC5M_2_0                  \ [0x04 : 3] Output compare 5 mode.
    ...
    $0c constant TIM1_OC6M_2_0                  \ [0x0c : 3] Output compare 6 mode.
    $0f constant TIM1_OC6CE                     \ [0x0f] Output compare 6 clear enable.
    $10 constant TIM1_OC5M_3                    \ [0x10] Output compare 5 mode - bit 3.
    $18 constant TIM1_OC6M_3                    \ [0x18] Output compare 6 mode - bit 3.
  [then]


  [ifdef] TIM1_CCMR3_in_DEF
    \
    \ @brief IC5PSC: Input capture 1 prescaler
    \ Address offset: 0x54
    \ Reset value: 0x00000000
    \
    $02 constant TIM1_IC5PSC                    \ [0x02 : 2] IC5PSC: Input capture 1 prescaler
    $04 constant TIM1_IC5F                      \ [0x04 : 4] Bits 7:4 IC1F[3:0]: Input capture 1 filter
    $0a constant TIM1_IC6PSC                    \ [0x0a : 2] IC6PSC[1:0]: Input capture 2 prescaler
    $0c constant TIM1_IC6F                      \ [0x0c : 4] IC2F: Input capture 2 filter
  [then]
  ...
  \ @brief TIM1 interrupt
  \
  $00 constant TIM1_CR1                 \ CR1 register
  $04 constant TIM1_CR2                 \ CR2 register
  $08 constant TIM1_SMCR                \ SMCR register
  $0C constant TIM1_DIER                \ DIER register
  $10 constant TIM1_SR                  \ SR register
  $14 constant TIM1_EGR                 \ EGR register
  $18 constant TIM1_CCMR1               \ CCMR1 register
  $18 constant TIM1_CCMR1_IN            \ CC1S: Capture/Compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. 00: CC1 channel is configured as output 01: CC1 channel is configured as input, IC1 is mapped on TI1 1x: Reserved Note: CC1S bits are writable only when the channel is OFF (CC1E = '0' in TIMx_CCER).
  $1C constant TIM1_CCMR2               \ CCMR2 register
  $1C constant TIM1_CCMR2_IN            \ CC3S: Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. 00: CC3 channel is configured as output 01: CC3 channel is configured as input, IC3 is mapped on TI3 10: CC3 channel is configured as input, IC3 is mapped on TI4 11: CC3 channel is configured as input, IC3 is mapped on TRC. This mode is working only if an internal trigger input is selected through TS bit (TIMx_SMCR register) Note: CC3S bits are writable only when the channel is OFF (CC3E = '0' in TIMx_CCER).
  $20 constant TIM1_CCER                \ CCER register
  $24 constant TIM1_CNT                 \ CNT register
  $28 constant TIM1_PSC                 \ PSC register
  $2C constant TIM1_ARR                 \ ARR register
  $30 constant TIM1_RCR                 \ RCR register
  $34 constant TIM1_CCR1                \ CCR1 register
  $38 constant TIM1_CCR2                \ CCR2 register
  $3C constant TIM1_CCR3                \ CCR3 register
  $40 constant TIM1_CCR4                \ CCR4 register
  $44 constant TIM1_BDTR                \ BDTR register
  $54 constant TIM1_CCMR3               \ CCMR3 register
  $54 constant TIM1_CCMR3_IN            \ IC5PSC: Input capture 1 prescaler
  $58 constant TIM1_CCR5                \ CCR5 register
  $5C constant TIM1_CCR6                \ CCR6 register
  $60 constant TIM1_AF1                 \ AF1 register
  $64 constant TIM1_AF2                 \ AF2 register
