...
$00010000 constant SDMMC2_CLKCR_NEGEDGE                             \ SDIO_CK dephasing selection bit
$00020000 constant SDMMC2_CLKCR_HWFC_EN                             \ HW Flow Control enable
$00040000 constant SDMMC2_CLKCR_DDR                                 \ Data rate signaling selection
$00080000 constant SDMMC2_CLKCR_BUSSPEED                            \ Bus speed mode selection between DS, HS, SDR12, SDR25 and SDR50,DDR50, SDR104
...
$00000800 constant SDMMC2_CMDR_WAITPEND                             \ CPSM Waits for ends of data transfer (CmdPend internal signal) from DPSM
...
$00000000 constant SDMMC2_RESP1_CARDSTATUS1                         \ CARDSTATUS1
...
$00000000 constant SDMMC2_RESP2_CARDSTATUS2                         \ CARDSTATUS2
...
$00000000 constant SDMMC2_RESP3_CARDSTATUS3                         \ CARDSTATUS3
...
$00000000 constant SDMMC2_RESP4_CARDSTATUS4                         \ CARDSTATUS4
...
$00000000 constant SDMMC2_DTIMER_DATATIME                           \ Data and R1b busy timeout period
...
$0000000c constant SDMMC2_DCTRL_DTMODE                              \ Data transfer mode selection
...
$00000010 constant SDMMC2_STAR_TXUNDERR                             \ Transmit FIFO underrun error (masked by hardware when IDMA is enabled)
$00000020 constant SDMMC2_STAR_RXOVERR                              \ Received FIFO overrun error (masked by hardware when IDMA is enabled)
$00000040 constant SDMMC2_STAR_CMDREND                              \ Command response received (CRC check passed, or no CRC)
$00000080 constant SDMMC2_STAR_CMDSENT                              \ Command sent (no response required)
$00000100 constant SDMMC2_STAR_DATAEND                              \ Data transfer ended correctly
...
$00004000 constant SDMMC2_STAR_TXFIFOHE                             \ Transmit FIFO half empty
$00008000 constant SDMMC2_STAR_RXFIFOHF                             \ Receive FIFO half full
...
$04000000 constant SDMMC2_MASKR_CKSTOPIE                            \ Voltage Switch clock stopped interrupt enable
$10000000 constant SDMMC2_MASKR_IDMABTCIE                           \ IDMA buffer transfer complete interrupt enable
...
$0001ffe0 constant SDMMC2_SDMMC_IDMABSIZER_IDMABNDT                 \ Number of bytes per buffer
...
$00000000 constant SDMMC2_SDMMC_IDMABASER_IDMABASE                  \ Buffer memory base address bits [31:2], shall be word aligned (bit [1:0] are always 0 and read only)
...
$0000fffc constant SDMMC2_SDMMC_IDMALAR_IDMALA                      \ Acknowledge linked list buffer ready
...
\ @brief SDMMC2 global interrupt
\
$420c8c00 constant SDMMC2_POWER   \ offset: 0x00 : power control register
$420c8c04 constant SDMMC2_CLKCR   \ offset: 0x04 : clock control register
$420c8c08 constant SDMMC2_ARGR    \ offset: 0x08 : argument register
$420c8c0c constant SDMMC2_CMDR    \ offset: 0x0C : command register
$420c8c10 constant SDMMC2_RESPCMDR  \ offset: 0x10 : command response register
$420c8c14 constant SDMMC2_RESP1   \ offset: 0x14 : response 1 register
$420c8c18 constant SDMMC2_RESP2   \ offset: 0x18 : response 2 register
$420c8c1c constant SDMMC2_RESP3   \ offset: 0x1C : response 3 register
$420c8c20 constant SDMMC2_RESP4   \ offset: 0x20 : response 4 register
$420c8c24 constant SDMMC2_DTIMER  \ offset: 0x24 : data timer register
$420c8c28 constant SDMMC2_DLENR   \ offset: 0x28 : data length register
$420c8c2c constant SDMMC2_DCTRL   \ offset: 0x2C : data control register
$420c8c30 constant SDMMC2_DCNTR   \ offset: 0x30 : data counter register
$420c8c34 constant SDMMC2_STAR    \ offset: 0x34 : status register
$420c8c38 constant SDMMC2_ICR     \ offset: 0x38 : interrupt clear register
$420c8c3c constant SDMMC2_MASKR   \ offset: 0x3C : mask register
$420c8c40 constant SDMMC2_ACKTIMER  \ offset: 0x40 : acknowledgment timer register
$420c8c50 constant SDMMC2_SDMMC_IDMACTRLR  \ offset: 0x50 : DMA control register
$420c8c54 constant SDMMC2_SDMMC_IDMABSIZER  \ offset: 0x54 : buffer size register
$420c8c58 constant SDMMC2_SDMMC_IDMABASER  \ offset: 0x58 : buffer base address register
$420c8c64 constant SDMMC2_SDMMC_IDMALAR  \ offset: 0x64 : linked list address register
$420c8c68 constant SDMMC2_SDMMC_IDMABAR  \ offset: 0x68 : linked list memory base register
$420c8c80 constant SDMMC2_FIFOR0  \ offset: 0x80 : data FIFO register 0
$420c8c84 constant SDMMC2_FIFOR1  \ offset: 0x84 : data FIFO register 1
$420c8c88 constant SDMMC2_FIFOR2  \ offset: 0x88 : data FIFO register 2
$420c8c8c constant SDMMC2_FIFOR3  \ offset: 0x8C : data FIFO register 3
$420c8c90 constant SDMMC2_FIFOR4  \ offset: 0x90 : data FIFO register 4
$420c8c94 constant SDMMC2_FIFOR5  \ offset: 0x94 : data FIFO register 5
$420c8c98 constant SDMMC2_FIFOR6  \ offset: 0x98 : data FIFO register 6
$420c8c9c constant SDMMC2_FIFOR7  \ offset: 0x9C : data FIFO register 7
$420c8ca0 constant SDMMC2_FIFOR8  \ offset: 0xA0 : data FIFO register 8
$420c8ca4 constant SDMMC2_FIFOR9  \ offset: 0xA4 : data FIFO register 9
$420c8ca8 constant SDMMC2_FIFOR10  \ offset: 0xA8 : data FIFO register 10
$420c8cac constant SDMMC2_FIFOR11  \ offset: 0xAC : data FIFO register 11
$420c8cb0 constant SDMMC2_FIFOR12  \ offset: 0xB0 : data FIFO register 12
$420c8cb4 constant SDMMC2_FIFOR13  \ offset: 0xB4 : data FIFO register 13
$420c8cb8 constant SDMMC2_FIFOR14  \ offset: 0xB8 : data FIFO register 14
$420c8cbc constant SDMMC2_FIFOR15  \ offset: 0xBC : data FIFO register 15
