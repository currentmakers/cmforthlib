...
[ifndef] OTFDEC1_DEF
  ...
  [ifdef] OTFDEC1_R1CFGR_DEF
    ...
    $10 constant OTFDEC1_REGx_VERSION           \ [0x10 : 16] region firmware version
  [then]
  ...
  [ifdef] OTFDEC1_R1STARTADDR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTFDEC1_REGx_START_ADDR        \ [0x00 : 32] Region AXI start address
  [then]
  ...
  [ifdef] OTFDEC1_R1ENDADDR_DEF
    ...
    \
    $00 constant OTFDEC1_REGx_END_ADDR          \ [0x00 : 32] Region AXI end address
  [then]
  ...
  [ifdef] OTFDEC1_R1NONCER0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTFDEC1_REGx_NONCE             \ [0x00 : 32] REGx_NONCE
  [then]
  ...
  [ifdef] OTFDEC1_R1NONCER1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTFDEC1_REGx_NONCE             \ [0x00 : 32] Region nonce
  [then]
  ...
  [ifdef] OTFDEC1_R1KEYR0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTFDEC1_REGx_KEY               \ [0x00 : 32] REGx_KEY
  [then]
  ...
  [ifdef] OTFDEC1_R2NONCER1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTFDEC1_REGx_NONCE             \ [0x00 : 32] Region nonce, bits [63:32]REGx_NONCE[63:32]
  [then]
  ...
  [ifdef] OTFDEC1_R2KEYR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTFDEC1_REGx_KEY_              \ [0x00 : 32] REGx_KEY
  [then]
  ...
  $8C constant OTFDEC1_R4ENDADDR        \ OTFDEC region x end address register
