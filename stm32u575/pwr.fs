...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_PWR_CR2_DEF
    ...
    $0c constant PWR_PKARAMPDS                  \ [0x0c] PKA SRAM power-down
  ...
  [ifdef] PWR_PWR_VOSR_DEF
    ...
    $12 constant PWR_BOOSTEN                    \ [0x12] EPOD booster enable
  [then]
  ...
  [ifdef] PWR_PWR_SVMCR_DEF
    ...
    $1c constant PWR_USV                        \ [0x1c] VDDUSB independent USB supply valid
    ...
    $1e constant PWR_ASV                        \ [0x1e] VDDA independent analog supply valid
  [then]
  ...
  [ifdef] PWR_PWR_PUCRA_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port A pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port A pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port A pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port A pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port A pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port A pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port A pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port A pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port A pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port A pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port A pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port A pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port A pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port A pull-up bit
  ...
  [ifdef] PWR_PWR_PDCRA_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port A pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port A pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port A pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port A pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port A pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port A pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port A pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port A pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port A pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port A pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port A pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port A pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port A pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port A pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRB_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port B pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port B pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port B pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port B pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port B pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port B pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port B pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port B pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port B pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port B pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port B pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port B pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port B pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port B pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port B pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port B pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRB_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port B pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port B pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port B pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port B pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port B pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port B pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port B pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port B pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port B pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port B pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port B pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port B pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port B pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port B pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port B pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port C pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port C pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port C pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port C pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port C pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port C pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port C pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port C pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port C pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port C pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port C pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port C pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port C pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port C pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port C pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port C pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port C pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port C pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port C pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port C pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port C pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port C pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port C pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port C pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port C pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port C pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port C pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port C pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port C pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port C pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port C pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port C pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRD_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port D pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port D pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port D pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port D pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port D pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port D pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port D pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port D pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port D pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port D pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port D pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port D pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port D pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port D pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port D pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port D pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRD_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port D pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port D pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port D pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port D pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port D pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port D pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port D pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port D pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port D pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port D pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port D pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port D pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port D pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port D pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port D pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port D pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRE_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port E pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port E pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port E pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port E pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port E pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port E pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port E pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port E pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port E pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port E pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port E pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port E pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port E pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port E pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port E pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port E pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRE_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port E pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port E pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port E pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port E pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port E pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port E pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port E pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port E pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port E pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port E pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port E pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port E pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port E pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port E pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port E pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port E pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRF_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port F pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port F pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port F pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port F pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port F pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port F pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port F pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port F pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port F pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port F pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port F pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port F pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port F pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port F pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port F pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port F pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRF_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port F pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port F pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port F pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port F pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port F pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port F pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port F pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port F pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port F pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port F pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port F pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port F pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port F pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port F pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port F pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port F pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRG_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port G pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port G pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port G pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port G pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port G pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port G pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port G pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port G pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port G pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port G pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port G pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port G pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port G pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port G pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port G pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port G pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRG_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port G pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port G pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port G pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port G pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port G pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port G pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port G pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port G pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port G pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port G pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port G pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port G pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port G pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port G pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port G pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port G pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRH_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port H pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port H pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port H pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port H pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port H pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port H pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port H pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port H pull-up bit
    $08 constant PWR_PU8                        \ [0x08] Port H pull-up bit
    $09 constant PWR_PU9                        \ [0x09] Port H pull-up bit
    $0a constant PWR_PU10                       \ [0x0a] Port H pull-up bit
    $0b constant PWR_PU11                       \ [0x0b] Port H pull-up bit
    $0c constant PWR_PU12                       \ [0x0c] Port H pull-up bit
    $0d constant PWR_PU13                       \ [0x0d] Port H pull-up bit
    $0e constant PWR_PU14                       \ [0x0e] Port H pull-up bit
    $0f constant PWR_PU15                       \ [0x0f] Port H pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRH_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port H pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port H pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port H pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port H pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port H pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port H pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port H pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port H pull-down bit
    $08 constant PWR_PD8                        \ [0x08] Port H pull-down bit
    $09 constant PWR_PD9                        \ [0x09] Port H pull-down bit
    $0a constant PWR_PD10                       \ [0x0a] Port H pull-down bit
    $0b constant PWR_PD11                       \ [0x0b] Port H pull-down bit
    $0c constant PWR_PD12                       \ [0x0c] Port H pull-down bit
    $0d constant PWR_PD13                       \ [0x0d] Port H pull-down bit
    $0e constant PWR_PD14                       \ [0x0e] Port H pull-down bit
    $0f constant PWR_PD15                       \ [0x0f] Port H pull-down bit
  [then]
  ...
  [ifdef] PWR_PWR_PUCRI_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PU0                        \ [0x00] Port I pull-up bit
    $01 constant PWR_PU1                        \ [0x01] Port I pull-up bit
    $02 constant PWR_PU2                        \ [0x02] Port I pull-up bit
    $03 constant PWR_PU3                        \ [0x03] Port I pull-up bit
    $04 constant PWR_PU4                        \ [0x04] Port I pull-up bit
    $05 constant PWR_PU5                        \ [0x05] Port I pull-up bit
    $06 constant PWR_PU6                        \ [0x06] Port I pull-up bit
    $07 constant PWR_PU7                        \ [0x07] Port I pull-up bit
  [then]
  ...
  [ifdef] PWR_PWR_PDCRI_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_PD0                        \ [0x00] Port I pull-down bit
    $01 constant PWR_PD1                        \ [0x01] Port I pull-down bit
    $02 constant PWR_PD2                        \ [0x02] Port I pull-down bit
    $03 constant PWR_PD3                        \ [0x03] Port I pull-down bit
    $04 constant PWR_PD4                        \ [0x04] Port I pull-down bit
    $05 constant PWR_PD5                        \ [0x05] Port I pull-down bit
    $06 constant PWR_PD6                        \ [0x06] Port I pull-down bit
    $07 constant PWR_PD7                        \ [0x07] Port I pull-down bit
  [then]
  ...
  $3C constant PWR_PWR_SVMSR            \ Regulator selection
  ...
  $60 constant PWR_PWR_PUCRC            \ PWR port C pull-up control register
