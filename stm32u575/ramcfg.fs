...
[ifndef] RAMCFG_DEF
  ...
  \ @brief RAMCFG
  \
  $00 constant RAMCFG_RAM1CR            \ RAMCFG SRAM x control register
  $08 constant RAMCFG_RAM1ISR           \ RAMCFG RAMx interrupt status register
  $28 constant RAMCFG_RAM1ERKEYR        \ RAMCFG SRAM x erase key register
  $40 constant RAMCFG_RAM2CR            \ RAMCFG SRAM x control register
  $44 constant RAMCFG_RAM2IER           \ RAMCFG SRAM x interrupt enable register
  $48 constant RAMCFG_RAM2ISR           \ RAMCFG RAMx interrupt status register
  $4C constant RAMCFG_RAM2SEAR          \ RAMCFG RAM x ECC single error address register
  $50 constant RAMCFG_RAM2DEAR          \ RAMCFG RAM x ECC double error address register
  $54 constant RAMCFG_RAM2ICR           \ RAMCFG RAM x interrupt clear register x
  $58 constant RAMCFG_RAM2WPR1          \ RAMCFG SRAM2 write protection register 1
  $5C constant RAMCFG_RAM2WPR2          \ RAMCFG SRAM2 write protection register 2
  $64 constant RAMCFG_RAM2ECCKEYR       \ RAMCFG SRAM x ECC key register
  $68 constant RAMCFG_RAM2ERKEYR        \ RAMCFG SRAM x erase key register
  $80 constant RAMCFG_RAM3CR            \ RAMCFG SRAM x control register
  $84 constant RAMCFG_RAM3IER           \ RAMCFG SRAM x interrupt enable register
  $88 constant RAMCFG_RAM3ISR           \ RAMCFG RAMx interrupt status register
  $8C constant RAMCFG_RAM3SEAR          \ RAMCFG RAM x ECC single error address register
  $90 constant RAMCFG_RAM3DEAR          \ RAMCFG RAM x ECC double error address register
  $94 constant RAMCFG_RAM3ICR           \ RAMCFG RAM x interrupt clear register x
  $A4 constant RAMCFG_RAM3ECCKEYR       \ RAMCFG SRAM x ECC key register
  $A8 constant RAMCFG_RAM3ERKEYR        \ RAMCFG SRAM x erase key register
  $C0 constant RAMCFG_RAM4CR            \ RAMCFG SRAM x control register
  $C8 constant RAMCFG_RAM4ISR           \ RAMCFG RAMx interrupt status register
  $E8 constant RAMCFG_RAM4ERKEYR        \ RAMCFG SRAM x erase key register
  $100 constant RAMCFG_RAM5CR           \ RAMCFG SRAM x control register
  $104 constant RAMCFG_RAM5IER          \ RAMCFG SRAM x interrupt enable register
  $108 constant RAMCFG_RAM5ISR          \ RAMCFG RAMx interrupt status register
  $10C constant RAMCFG_RAM5SEAR         \ RAMCFG RAM x ECC single error address register
  $110 constant RAMCFG_RAM5DEAR         \ RAMCFG RAM x ECC double error address register
  $114 constant RAMCFG_RAM5ICR          \ RAMCFG RAM x interrupt clear register x
