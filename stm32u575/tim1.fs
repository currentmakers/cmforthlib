...
$00000300 constant TIM1_TIM1_CR1_CKD                                \ Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),
...
$00000070 constant TIM1_TIM1_CR2_MMS0_2                             \ Master mode selection
$00000080 constant TIM1_TIM1_CR2_TI1S                               \ TI1 selection
$00000100 constant TIM1_TIM1_CR2_OIS1                               \ Output Idle state 1
$00000200 constant TIM1_TIM1_CR2_OIS1N                              \ Output Idle state 1
$00000400 constant TIM1_TIM1_CR2_OIS2                               \ Output Idle state 2
$00000800 constant TIM1_TIM1_CR2_OIS2N                              \ Output Idle state 2
$00001000 constant TIM1_TIM1_CR2_OIS3                               \ Output Idle state 3
$00002000 constant TIM1_TIM1_CR2_OIS3N                              \ Output Idle state 3
$00004000 constant TIM1_TIM1_CR2_OIS4                               \ Output Idle state 4
$00008000 constant TIM1_TIM1_CR2_OIS4N                              \ Output Idle state 4 (OC5 output)
$00010000 constant TIM1_TIM1_CR2_OIS5                               \ Output Idle state 5
$00040000 constant TIM1_TIM1_CR2_OIS6                               \ Output Idle state 6
$00f00000 constant TIM1_TIM1_CR2_MMS2                               \ Master mode selection 2
$02000000 constant TIM1_TIM1_CR2_MMS_3                              \ Master mode selection 2
...
$00000007 constant TIM1_TIM1_SMCR_SMS1                              \ Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo or the tim_trgo2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$00000008 constant TIM1_TIM1_SMCR_OCCS                              \ OCREF clear selection This bit is used to select the OCREF clear source.
$00000070 constant TIM1_TIM1_SMCR_TS1                               \ Trigger selection - bit 4:3 Refer to TS[2:0] description - bits 6:4 null Trigger selection This bitfield is combined with TS[4:3] bits. This bit-field selects the trigger input to be used to synchronize the counter. others: Reserved See for more details on tim_itrx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00300000 constant TIM1_TIM1_SMCR_TS2                               \ Trigger selection - bit 4:3 Refer to TS[2:0] description - bits 6:4 null Trigger selection This bitfield is combined with TS[4:3] bits. This bit-field selects the trigger input to be used to synchronize the counter. others: Reserved See for more details on tim_itrx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00000200 constant TIM1_TIM1_SR_CC1OF                               \ Capture/compare 1 overcapture flag This flag is set by hardware only when the corresponding channel is configured in input capture mode. It is cleared by software by writing it to '0â.
...
$00100000 constant TIM1_TIM1_SR_IDXF                                \ Index interrupt flag This flag is set by hardware when an index event is detected. It is cleared by software by writing it to '0â.
$00200000 constant TIM1_TIM1_SR_DIRF                                \ Direction change interrupt flag This flag is set by hardware when the direction changes in encoder mode (DIR bit value in TIMx_CR is changing). It is cleared by software by writing it to '0â.
$00400000 constant TIM1_TIM1_SR_IERRF                               \ Index error interrupt flag This flag is set by hardware when an index error is detected. It is cleared by software by writing it to '0â.
$00800000 constant TIM1_TIM1_SR_TERRF                               \ Transition error interrupt flag This flag is set by hardware when a transition error is detected in encoder mode. It is cleared by software by writing it to '0â.
...
$00000070 constant TIM1_TIM1_CCMR1_OUTPUT_OC1M                      \ Output Compare 1 mode
...
$00007000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2M                      \ Output Compare 2 mode
$00008000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2CE                     \ Output Compare 2 clear enable
$00010000 constant TIM1_TIM1_CCMR1_OUTPUT_OC1M_BIT3                 \ Output Compare 1 mode - bit 3
$01000000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2M_BIT3                 \ Output Compare 2 mode - bit 3
...
$00000003 constant TIM1_TIM1_CCMR1_INPUT_CC1S                       \ Capture/compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = '0â in TIMx_CCER).
$0000000c constant TIM1_TIM1_CCMR1_INPUT_IC1PSC                     \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=â0â (TIMx_CCER register).
...
$00000300 constant TIM1_TIM1_CCMR1_INPUT_CC2S                       \ Capture/compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = '0â in TIMx_CCER).
...
$00000003 constant TIM1_TIM1_CCMR2_OUTPUT_CC3S_1_0                  \ Capture/Compare 3 selection
...
$00000070 constant TIM1_TIM1_CCMR2_OUTPUT_OC3M_2_0                  \ Output compare 3 mode
$00000080 constant TIM1_TIM1_CCMR2_OUTPUT_OC3CE                     \ Output compare 3 clear enable
$00000300 constant TIM1_TIM1_CCMR2_OUTPUT_CC4S_1_0                  \ Capture/Compare 4 selection
...
$00007000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4M_3_0                  \ Output compare 4 mode
$00008000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4CE                     \ Output compare 4 clear enable
$00010000 constant TIM1_TIM1_CCMR2_OUTPUT_OC3M_3                    \ Output compare 3 mode
$01000000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4M_BIT3                 \ Output Compare 4 mode - bit 3
...
$00000003 constant TIM1_TIM1_CCMR2_INPUT_CC3S                       \ Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0â in TIMx_CCER).
...
$00000300 constant TIM1_TIM1_CCMR2_INPUT_CC4S                       \ Capture/compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0â in TIMx_CCER).
...
$00000070 constant TIM1_TIM1_CCMR3_OC5M1                            \ Output compare 5 mode
...
$00007000 constant TIM1_TIM1_CCMR3_OC6M1                            \ Output compare 6 mode
$00008000 constant TIM1_TIM1_CCMR3_OC6CE                            \ Output compare 6 clear enable
$00010000 constant TIM1_TIM1_CCMR3_OC5M2                            \ Output compare 5 mode
$01000000 constant TIM1_TIM1_CCMR3_OC6M2                            \ Output compare 6 mode
...
$00ff0000 constant TIM1_TIM1_ECR_PW                                 \ Pulse width This bitfield defines the pulse duration, as following: tPW = PW[7:0] x tPWG
$07000000 constant TIM1_TIM1_ECR_PWPRSC                             \ Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tPWG = (2(PWPRSC[2:0])) x ttim_ker_ck
...
$0000000f constant TIM1_TIM1_TISEL_TI1SEL                           \ Selects tim_ti1[0..15] input ... Refer to for interconnects list.
$00000f00 constant TIM1_TIM1_TISEL_TI2SEL                           \ Selects tim_ti2[0..15] input ... Refer to for interconnects list.
$000f0000 constant TIM1_TIM1_TISEL_TI3SEL                           \ Selects tim_ti3[0..15] input ... Refer to for interconnects list.
$0f000000 constant TIM1_TIM1_TISEL_TI4SEL                           \ Selects tim_ti4[0..15] input ... Refer to for interconnects list.
...
$00000001 constant TIM1_TIM1_AF1_BKINE                              \ TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timerâs tim_brk input. TIMx_BKIN input is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM1_TIM1_AF1_BKCMP1E                            \ tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timerâs tim_brk input. tim_brk_cmp1 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF1_BKCMP2E                            \ tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timerâs tim_brk input. tim_brk_cmp2 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000008 constant TIM1_TIM1_AF1_BKCMP3E                            \ tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timerâs tim_brk input. tim_brk_cmp3 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000010 constant TIM1_TIM1_AF1_BKCMP4E                            \ tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timerâs tim_brk input. tim_brk_cmp4 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000020 constant TIM1_TIM1_AF1_BKCMP5E                            \ tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timerâs tim_brk input. tim_brk_cmp5 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000040 constant TIM1_TIM1_AF1_BKCMP6E                            \ tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timerâs tim_brk input. tim_brk_cmp6 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000080 constant TIM1_TIM1_AF1_BKCMP7E                            \ tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timerâs tim_brk input. tim_brk_cmp7 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF1_BKCMP8E                            \ tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timerâs tim_brk input. tim_brk_cmp8 output is 'ORedâ with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$0003c000 constant TIM1_TIM1_AF1_ETRSEL                             \ etr_in source selection These bits select the etr_in input source. ... Refer to for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000001 constant TIM1_TIM1_AF2_BK2INE                             \ TIMx_BKIN2 input enable This bit enables the TIMx_BKIN2 alternate function input for the timerâs tim_brk2 input. TIMx_BKIN2 input is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM1_TIM1_AF2_BK2CMP1E                           \ tim_brk2_cmp1 enable This bit enables the tim_brk2_cmp1 for the timerâs tim_brk2 input. tim_brk2_cmp1 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF2_BK2CMP2E                           \ tim_brk2_cmp2 enable This bit enables the tim_brk2_cmp2 for the timerâs tim_brk2 input. tim_brk2_cmp2 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000008 constant TIM1_TIM1_AF2_BK2CMP3E                           \ tim_brk2_cmp3 enable This bit enables the tim_brk2_cmp3 for the timerâs tim_brk2 input. tim_brk2_cmp3 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000010 constant TIM1_TIM1_AF2_BK2CMP4E                           \ tim_brk2_cmp4 enable This bit enables the tim_brk2_cmp4 for the timerâs tim_brk2 input. tim_brk2_cmp4 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000020 constant TIM1_TIM1_AF2_BK2CMP5E                           \ tim_brk2_cmp5 enable This bit enables the tim_brk2_cmp5 for the timerâs tim_brk2 input. tim_brk2_cmp5 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000040 constant TIM1_TIM1_AF2_BK2CMP6E                           \ tim_brk2_cmp6 enable This bit enables the tim_brk2_cmp6 for the timerâs tim_brk2 input. tim_brk2_cmp6 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000080 constant TIM1_TIM1_AF2_BK2CMP7E                           \ tim_brk2_cmp7 enable This bit enables the tim_brk2_cmp7 for the timerâs tim_brk2 input. tim_brk2_cmp7 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF2_BK2CMP8E                           \ tim_brk2_cmp8 enable This bit enables the tim_brk2_cmp8 for the timerâs tim_brk2 input. tim_brk2_cmp8 output is 'ORedâ with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00070000 constant TIM1_TIM1_AF2_OCRSEL                             \ ocref_clr source selection These bits select the ocref_clr input source. ... Refer to for product specific information. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$40012c18 constant TIM1_TIM1_CCMR1_OUTPUT  \ offset: 0x18 : capture/compare mode register 1 (output mode)
$40012c18 constant TIM1_TIM1_CCMR1_INPUT  \ offset: 0x18 : TIM1 capture/compare mode register 1 [alternate]
$40012c1c constant TIM1_TIM1_CCMR2_OUTPUT  \ offset: 0x1C : capture/compare mode register 2 (output mode)
