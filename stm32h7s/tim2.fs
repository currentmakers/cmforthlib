...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_TIM2_SMCR_DEF
    ...
    $03 constant TIM2_OCCS                      \ [0x03] OCREF clear selection This bit is used to select the OCREF clear source Note: If the OCREF clear selection feature is not supported, this bit is reserved and forced by hardware to 0. Section 65.3: TIM2/TIM3/TIM4/TIM5 implementation.
  ...
  [ifdef] TIM2_TIM2_CNT_DEF
    ...
    $1f constant TIM2_UIFCPY_CNT                \ [0x1f] Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 CNT[31]: Most significant bit of counter value If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register
  [then]
  ...
  [ifdef] TIM2_TIM2_ECR_DEF
    ...
    $10 constant TIM2_PW                        \ [0x10 : 8] Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW[7:0] x t<sub>PWG</sub>
    $18 constant TIM2_PWPRSC                    \ [0x18 : 3] Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t<sub>PWG</sub> = (2<sup>(PWPRSC[2:0])</sup>) x t<sub>tim_ker_ck</sub>
  [then]
  ...
  [ifdef] TIM2_TIM2_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_TI1SEL                    \ [0x00 : 4] Selects tim_ti1[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
    $08 constant TIM2_TI2SEL                    \ [0x08 : 4] Selects tim_ti2[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
    $10 constant TIM2_TI3SEL                    \ [0x10 : 4] Selects tim_ti3[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
    $18 constant TIM2_TI4SEL                    \ [0x18 : 4] Selects tim_ti4[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
  [then]
  ...
  [ifdef] TIM2_TIM2_AF1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0e constant TIM2_ETRSEL                    \ [0x0e : 4] etr_in source selection These bits select the etr_in input source. ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
  [then]
  ...
  [ifdef] TIM2_TIM2_AF2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $10 constant TIM2_OCRSEL                    \ [0x10 : 3] ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
  [then]
  ...
  $18 constant TIM2_TIM2_CCMR1_INPUT    \ TIM2 capture/compare mode register 1
  $18 constant TIM2_TIM2_CCMR1_OUTPUT   \ TIM2 capture/compare mode register 1
  $1C constant TIM2_TIM2_CCMR2_INPUT    \ TIM2 capture/compare mode register 2
  $1C constant TIM2_TIM2_CCMR2_OUTPUT   \ TIM2 capture/compare mode register 2
