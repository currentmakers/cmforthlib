...
$00000010 constant LTDC_LTDC_L1CR_CLUTEN                            \ color look-up table enable This bit is set and cleared by software. The CLUT is only meaningful for L8, AL44 and AL88 pixel format. Refer to Color look-up table (CLUT)
...
$00000fff constant LTDC_LTDC_L1WHPCR_WHSTPOS                        \ window horizontal start position These bits configure the first visible pixel of a line of the layer window. WHSTPOS[11:0] must be UNDER OR EQUAL AAW[11:0] bits (programmed in LTDC_AWCR register).
$0fff0000 constant LTDC_LTDC_L1WHPCR_WHSPPOS                        \ window horizontal stop position These bits configure the last visible pixel of a line of the layer window. WHSPPOS[11:0] must be more or equal to AHBP[11:0] bits + 1 (programmed in LTDC_BPCR register).
...
$000007ff constant LTDC_LTDC_L1WVPCR_WVSTPOS                        \ window vertical start position These bits configure the first visible line of the layer window. WVSTPOS[10:0] must be UNDER OR EQUAL AAH[10:0] bits (programmed in LTDC_AWCR register).
$07ff0000 constant LTDC_LTDC_L1WVPCR_WVSPPOS                        \ window vertical stop position These bits configure the last visible line of the layer window. WVSPPOS[10:0] must be more or equal to AVBP[10:0] bits + 1 (programmed in LTDC_BPCR register).
...
$00001fff constant LTDC_LTDC_L1CFBLR_CFBLL                          \ color frame buffer line length These bits define the length of one line of pixels in bytes + 7. The line length is computed as follows: active high width * number of bytes per pixel + 7.
...
$00000010 constant LTDC_LTDC_L2CR_CLUTEN                            \ color look-up table enable This bit is set and cleared by software. The CLUT is only meaningful for L8, AL44 and AL88 pixel format. Refer to Color look-up table (CLUT)
...
$00000fff constant LTDC_LTDC_L2WHPCR_WHSTPOS                        \ window horizontal start position These bits configure the first visible pixel of a line of the layer window. WHSTPOS[11:0] must be UNDER OR EQUAL AAW[11:0] bits (programmed in LTDC_AWCR register).
$0fff0000 constant LTDC_LTDC_L2WHPCR_WHSPPOS                        \ window horizontal stop position These bits configure the last visible pixel of a line of the layer window. WHSPPOS[11:0] must be more or equal to AHBP[11:0] bits + 1 (programmed in LTDC_BPCR register).
...
$000007ff constant LTDC_LTDC_L2WVPCR_WVSTPOS                        \ window vertical start position These bits configure the first visible line of the layer window. WVSTPOS[10:0] must be UNDER OR EQUAL AAH[10:0] bits (programmed in LTDC_AWCR register).
$07ff0000 constant LTDC_LTDC_L2WVPCR_WVSPPOS                        \ window vertical stop position These bits configure the last visible line of the layer window. WVSPPOS[10:0] must be more or equal to AVBP[10:0] bits + 1 (programmed in LTDC_BPCR register).
...
$00001fff constant LTDC_LTDC_L2CFBLR_CFBLL                          \ color frame buffer line length These bits define the length of one line of pixels in bytes + 7. The line length is computed as follows: active high width * number of bytes per pixel + 7.
...
\ @brief LTDC register block
\
$50001008 constant LTDC_LTDC_SSCR  \ offset: 0x08 : LTDC synchronization size configuration register
$5000100c constant LTDC_LTDC_BPCR  \ offset: 0x0C : LTDC back porch configuration register
$50001010 constant LTDC_LTDC_AWCR  \ offset: 0x10 : LTDC active width configuration register
$50001014 constant LTDC_LTDC_TWCR  \ offset: 0x14 : LTDC total width configuration register
$50001018 constant LTDC_LTDC_GCR  \ offset: 0x18 : LTDC global control register
$50001024 constant LTDC_LTDC_SRCR  \ offset: 0x24 : LTDC shadow reload configuration register
$5000102c constant LTDC_LTDC_BCCR  \ offset: 0x2C : LTDC background color configuration register
$50001034 constant LTDC_LTDC_IER  \ offset: 0x34 : LTDC interrupt enable register
$50001038 constant LTDC_LTDC_ISR  \ offset: 0x38 : LTDC interrupt status register
$5000103c constant LTDC_LTDC_ICR  \ offset: 0x3C : LTDC interrupt clear register
$50001040 constant LTDC_LTDC_LIPCR  \ offset: 0x40 : LTDC line interrupt position configuration register
$50001044 constant LTDC_LTDC_CPSR  \ offset: 0x44 : LTDC current position status register
$50001048 constant LTDC_LTDC_CDSR  \ offset: 0x48 : LTDC current display status register
$50001084 constant LTDC_LTDC_L1CR  \ offset: 0x84 : LTDC layer 1 control register
$50001088 constant LTDC_LTDC_L1WHPCR  \ offset: 0x88 : LTDC layer 1 window horizontal position configuration register
$5000108c constant LTDC_LTDC_L1WVPCR  \ offset: 0x8C : LTDC layer 1 window vertical position configuration register
$50001090 constant LTDC_LTDC_L1CKCR  \ offset: 0x90 : LTDC layer 1 color keying configuration register
$50001094 constant LTDC_LTDC_L1PFCR  \ offset: 0x94 : LTDC layer 1 pixel format configuration register
$50001098 constant LTDC_LTDC_L1CACR  \ offset: 0x98 : LTDC layer 1 constant alpha configuration register
$5000109c constant LTDC_LTDC_L1DCCR  \ offset: 0x9C : LTDC layer 1 default color configuration register
$500010a0 constant LTDC_LTDC_L1BFCR  \ offset: 0xA0 : LTDC layer 1 blending factors configuration register
$500010ac constant LTDC_LTDC_L1CFBAR  \ offset: 0xAC : LTDC layer 1 color frame buffer address register
$500010b0 constant LTDC_LTDC_L1CFBLR  \ offset: 0xB0 : LTDC layer 1 color frame buffer length register
$500010b4 constant LTDC_LTDC_L1CFBLNR  \ offset: 0xB4 : LTDC layer 1 color frame buffer line number register
$500010c4 constant LTDC_LTDC_L1CLUTWR  \ offset: 0xC4 : LTDC layer 1 CLUT write register
$50001104 constant LTDC_LTDC_L2CR  \ offset: 0x104 : LTDC layer 2 control register
$50001108 constant LTDC_LTDC_L2WHPCR  \ offset: 0x108 : LTDC layer 2 window horizontal position configuration register
$5000110c constant LTDC_LTDC_L2WVPCR  \ offset: 0x10C : LTDC layer 2 window vertical position configuration register
$50001110 constant LTDC_LTDC_L2CKCR  \ offset: 0x110 : LTDC layer 2 color keying configuration register
$50001114 constant LTDC_LTDC_L2PFCR  \ offset: 0x114 : LTDC layer 2 pixel format configuration register
$50001118 constant LTDC_LTDC_L2CACR  \ offset: 0x118 : LTDC layer 2 constant alpha configuration register
$5000111c constant LTDC_LTDC_L2DCCR  \ offset: 0x11C : LTDC layer 2 default color configuration register
$50001120 constant LTDC_LTDC_L2BFCR  \ offset: 0x120 : LTDC layer 2 blending factors configuration register
$5000112c constant LTDC_LTDC_L2CFBAR  \ offset: 0x12C : LTDC layer 2 color frame buffer address register
$50001130 constant LTDC_LTDC_L2CFBLR  \ offset: 0x130 : LTDC layer 2 color frame buffer length register
$50001134 constant LTDC_LTDC_L2CFBLNR  \ offset: 0x134 : LTDC layer 2 color frame buffer line number register
$50001144 constant LTDC_LTDC_L2CLUTWR  \ offset: 0x144 : LTDC layer 2 CLUT write register
