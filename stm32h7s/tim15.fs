...
$00000300 constant TIM15_TIM15_CR1_CKD                              \ Clock division This bitfield indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t<sub>DTS</sub>) used by the dead-time generators and the digital filters (tim_tix)
$00000800 constant TIM15_TIM15_CR1_UIFREMAP                         \ UIF status bit remapping
$00001000 constant TIM15_TIM15_CR1_DITHEN                           \ Dithering enable Note: The DITHEN bit can only be modified when CEN bit is reset.
...
$00000070 constant TIM15_TIM15_CR2_MMS                              \ Master mode selection These bits are used to select the information to be sent in master mode to slave timers for synchronization (tim_trgo). The combination is as follows:
$00000080 constant TIM15_TIM15_CR2_TI1S                             \ tim_ti1 selection
$00000100 constant TIM15_TIM15_CR2_OIS1                             \ Output Idle state 1 (tim_oc1 output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BKR register).
$00000200 constant TIM15_TIM15_CR2_OIS1N                            \ Output Idle state 1 (tim_oc1n output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIM15_BKR register).
$00000400 constant TIM15_TIM15_CR2_OIS2                             \ Output idle state 2 (tim_oc2 output) Note: This bit cannot be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in the TIM15_BKR register).
...
$00000400 constant TIM15_TIM15_DIER_CC2DE                           \ Capture/Compare 2 DMA request enable
...
$00000020 constant TIM15_TIM15_SR_COMIF                             \ COM interrupt flag This flag is set by hardware on a COM event (once the capture/compare control bits CCxE, CCxNE, OCxM have been updated). It is cleared by software.
...
$00000003 constant TIM15_TIM15_CCMR1_INPUT_CC1S                     \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIM15_CCER).
$0000000c constant TIM15_TIM15_CCMR1_INPUT_IC1PSC                   \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=0 (TIM15_CCER register).
$000000f0 constant TIM15_TIM15_CCMR1_INPUT_IC1F                     \ Input capture 1 filter This bit-field defines the frequency used to sample tim_ti1 input and the length of the digital filter applied to tim_ti1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
$00000300 constant TIM15_TIM15_CCMR1_INPUT_CC2S                     \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIM15_CCER).
$00000c00 constant TIM15_TIM15_CCMR1_INPUT_IC2PSC                   \ Input capture 2 prescaler
$0000f000 constant TIM15_TIM15_CCMR1_INPUT_IC2F                     \ Input capture 2 filter
...
$00000003 constant TIM15_TIM15_CCMR1_OUTPUT_CC1S                    \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIM15_CCER).
$00000004 constant TIM15_TIM15_CCMR1_OUTPUT_OC1FE                   \ Output Compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
$00000008 constant TIM15_TIM15_CCMR1_OUTPUT_OC1PE                   \ Output Compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S=00 (the channel is configured in output).
$00000070 constant TIM15_TIM15_CCMR1_OUTPUT_OC1M                    \ OC1M[2:0]: Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 and tim_oc1n are derived. tim_oc1ref is active high whereas tim_oc1 and tim_oc1n active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S=00 (the channel is configured in output). Note: In PWM mode, the tim_ocxref level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode. Note: On channels that have a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIM15_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated.
$00000080 constant TIM15_TIM15_CCMR1_OUTPUT_OC1CE                   \ Output compare 1 clear enable
$00000300 constant TIM15_TIM15_CCMR1_OUTPUT_CC2S                    \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIM15_CCER).
$00000400 constant TIM15_TIM15_CCMR1_OUTPUT_OC2FE                   \ Output compare 2 fast enable
$00000800 constant TIM15_TIM15_CCMR1_OUTPUT_OC2PE                   \ Output compare 2 preload enable
$00007000 constant TIM15_TIM15_CCMR1_OUTPUT_OC2M                    \ OC2M[2:0]: Output compare 2 mode
$00008000 constant TIM15_TIM15_CCMR1_OUTPUT_OC2CE                   \ Output compare 2 clear enable
$00010000 constant TIM15_TIM15_CCMR1_OUTPUT_OC1M_1                  \ OC1M[3]
$01000000 constant TIM15_TIM15_CCMR1_OUTPUT_OC2M_1                  \ OC2M[3]
...
$0000ffff constant TIM15_TIM15_CNT_CNT                              \ Counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register only holds the non-dithered part in CNT[15:0]. The fractional part is not available.
$80000000 constant TIM15_TIM15_CNT_UIFCPY                           \ UIF Copy This bit is a read-only copy of the UIF bit in the TIM15_ISR register.
...
$00001000 constant TIM15_TIM15_BDTR_BKE                             \ Break enable 1; Break inputs (tim_brk and tim_sys_brk clock failure event) enabled This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
$00002000 constant TIM15_TIM15_BDTR_BKP                             \ Break polarity Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
$00004000 constant TIM15_TIM15_BDTR_AOE                             \ Automatic output enable Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00008000 constant TIM15_TIM15_BDTR_MOE                             \ Main output enable This bit is cleared asynchronously by hardware as soon as the tim_brk input is active. It is set by software or automatically depending on the AOE bit. It is acting only on the channels which are configured in output. See tim_ocx/tim_ocxn enable description for more details (Section 68.7.9: TIM15 capture/compare enable register (TIM15_CCER) on page 4085).
...
$0000000f constant TIM15_TIM15_TISEL_TI1SEL                         \ selects tim_ti1_in[15:0] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
$00000f00 constant TIM15_TIM15_TISEL_TI2SEL                         \ selects tim_ti2_in[15:0] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
...
$00000001 constant TIM15_TIM15_AF1_BKINE                            \ TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timers tim_brk input. TIMx_BKIN input is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000002 constant TIM15_TIM15_AF1_BKCMP1E                          \ tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timers tim_brk input. tim_brk_cmp1 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000004 constant TIM15_TIM15_AF1_BKCMP2E                          \ tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timers tim_brk input. tim_brk_cmp2 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000008 constant TIM15_TIM15_AF1_BKCMP3E                          \ tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timers tim_brk input. tim_brk_cmp3 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000010 constant TIM15_TIM15_AF1_BKCMP4E                          \ tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timers tim_brk input. tim_brk_cmp4 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000020 constant TIM15_TIM15_AF1_BKCMP5E                          \ tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timers tim_brk input. tim_brk_cmp5 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000040 constant TIM15_TIM15_AF1_BKCMP6E                          \ tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timers tim_brk input. tim_brk_cmp6 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000080 constant TIM15_TIM15_AF1_BKCMP7E                          \ tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timers tim_brk input. COMP7 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000100 constant TIM15_TIM15_AF1_BKCMP8E                          \ tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. mdf_brkx output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000200 constant TIM15_TIM15_AF1_BKINP                            \ TIMx_BKIN input polarity This bit selects the TIMx_BKIN alternate function input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000400 constant TIM15_TIM15_AF1_BKCMP1P                          \ tim_brk_cmp1 input polarity This bit selects the tim_brk_cmp1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000800 constant TIM15_TIM15_AF1_BKCMP2P                          \ tim_brk_cmp2 input polarity This bit selects the tim_brk_cmp2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00001000 constant TIM15_TIM15_AF1_BKCMP3P                          \ tim_brk_cmp3 input polarity This bit selects the tim_brk_cmp3 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00002000 constant TIM15_TIM15_AF1_BKCMP4P                          \ tim_brk_cmp4 input polarity This bit selects the tim_brk_cmp4 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
...
$0000001f constant TIM15_TIM15_DCR_DBA                              \ DMA base address This 5-bit field defines the base-address for DMA transfers (when read/write access are done through the TIM15_DMAR address). DBA is defined as an offset starting from the address of the TIM15_CR1 register. Example: ...
$00001f00 constant TIM15_TIM15_DCR_DBL                              \ DMA burst length This 5-bit field defines the length of DMA transfers (the timer recognizes a burst transfer when a read or a write access is done to the TIM15_DMAR address). ...
$000f0000 constant TIM15_TIM15_DCR_DBSS                             \ DMA burst source selection This bitfield defines the interrupt source that triggers the DMA burst transfers (the timer recognizes a burst transfer when a read or a write access is done to the TIMx_DMAR address). Other: reserved
...
$00000000 constant TIM15_TIM15_DMAR_DMAB                            \ DMA register for burst accesses A read or write operation to the DMAR register accesses the register located at the address (TIM15_CR1 address) + (DBA + DMA index) x 4 where TIM15_CR1 address is the address of the control register 1, DBA is the DMA base address configured in TIM15_DCR register, DMA index is automatically controlled by the DMA transfer, and ranges from 0 to DBL (DBL configured in TIM15_DCR).


\
\ @brief General purpose timers
\
$42004000 constant TIM15_TIM15_CR1  \ offset: 0x00 : TIM15 control register 1
$42004004 constant TIM15_TIM15_CR2  \ offset: 0x04 : TIM15 control register 2
$42004008 constant TIM15_TIM15_SMCR  \ offset: 0x08 : TIM15 slave mode control register
$4200400c constant TIM15_TIM15_DIER  \ offset: 0x0C : TIM15 DMA/interrupt enable register
$42004010 constant TIM15_TIM15_SR  \ offset: 0x10 : TIM15 status register
$42004014 constant TIM15_TIM15_EGR  \ offset: 0x14 : TIM15 event generation register
$42004018 constant TIM15_TIM15_CCMR1_INPUT  \ offset: 0x18 : TIM15 capture/compare mode register 1 [alternate]
$42004018 constant TIM15_TIM15_CCMR1_OUTPUT  \ offset: 0x18 : TIM15 capture/compare mode register 1 [alternate]
$42004020 constant TIM15_TIM15_CCER  \ offset: 0x20 : TIM15 capture/compare enable register
$42004024 constant TIM15_TIM15_CNT  \ offset: 0x24 : TIM15 counter
$42004028 constant TIM15_TIM15_PSC  \ offset: 0x28 : TIM15 prescaler
$4200402c constant TIM15_TIM15_ARR  \ offset: 0x2C : TIM15 auto-reload register
$42004030 constant TIM15_TIM15_RCR  \ offset: 0x30 : TIM15 repetition counter register
$42004034 constant TIM15_TIM15_CCR1  \ offset: 0x34 : TIM15 capture/compare register 1
$42004038 constant TIM15_TIM15_CCR2  \ offset: 0x38 : TIM15 capture/compare register 2
$42004044 constant TIM15_TIM15_BDTR  \ offset: 0x44 : TIM15 break and dead-time register
$42004054 constant TIM15_TIM15_DTR2  \ offset: 0x54 : TIM15 timer deadtime register 2
$4200405c constant TIM15_TIM15_TISEL  \ offset: 0x5C : TIM15 input selection register
$42004060 constant TIM15_TIM15_AF1  \ offset: 0x60 : TIM15 alternate function register 1
$42004064 constant TIM15_TIM15_AF2  \ offset: 0x64 : TIM15 alternate function register 2
$420043dc constant TIM15_TIM15_DCR  \ offset: 0x3DC : TIM15 DMA control register
$420043e0 constant TIM15_TIM15_DMAR  \ offset: 0x3E0 : TIM15 DMA address for full transfer
