...
[ifndef] GFXMMU_DEF
  ...
  [ifdef] GFXMMU_GFXMMU_CR_DEF
    ...
    \
    $00 constant GFXMMU_B0OIE                   \ [0x00] Buffer 0 overflow interrupt enable This bit enables the buffer 0 overflow interrupt.
    $01 constant GFXMMU_B1OIE                   \ [0x01] Buffer 1 overflow interrupt enable This bit enables the buffer 1 overflow interrupt.
    $02 constant GFXMMU_B2OIE                   \ [0x02] Buffer 2 overflow interrupt enable This bit enables the buffer 2 overflow interrupt.
    $03 constant GFXMMU_B3OIE                   \ [0x03] Buffer 3 overflow interrupt enable This bit enables the buffer 3 overflow interrupt.
    $04 constant GFXMMU_AMEIE                   \ [0x04] AXI master error interrupt enable This bit enables the AXI master error interrupt.
    $06 constant GFXMMU_BS                      \ [0x06] Block size This bit defines the size of the blocks
    $0f constant GFXMMU_ATE                     \ [0x0f] Address translation enable This bit enables the address translation based on the values programmed in the LUT.
    $18 constant GFXMMU_B0PE                    \ [0x18] Buffer 0 packing enable This bit enables the packing on buffer 0. The packing is functional only if the block size is configured in 12-byte mode. In 16-byte mode, this bit is ignored.
    $19 constant GFXMMU_B0PM                    \ [0x19] Buffer 0 packing mode This bit selects the byte to be removed during packing operations on buffer 0
    $1a constant GFXMMU_B1PE                    \ [0x1a] Buffer 1 packing enable This bit enables the packing on buffer 1. The packing is functional only if the block size is configured in 12-byte mode. In 16-byte mode, this bit is ignored.
    $1b constant GFXMMU_B1PM                    \ [0x1b] Buffer 1 packing mode This bit selects the byte to be removed during packing operations on buffer 1
    $1c constant GFXMMU_B2PE                    \ [0x1c] Buffer 2 packing enable This bit enables the packing on buffer 2. The packing is functional only if the block size is configured in 12-byte mode. In 16-byte mode, this bit is ignored.
    $1d constant GFXMMU_B2PM                    \ [0x1d] Buffer 2 packing mode This bit selects the byte to be removed during packing operations on buffer 2
    $1e constant GFXMMU_B3PE                    \ [0x1e] Buffer 3 packing enable This bit enables the packing on buffer 3. The packing is functional only if the block size is configured in 12-byte mode. In 16-byte mode, this bit is ignored.
    $1f constant GFXMMU_B3PM                    \ [0x1f] Buffer 3 packing mode This bit selects the byte to be removed during packing operations on buffer 3
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_SR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_B0OF                    \ [0x00] Buffer 0 overflow flag This bit is set when an overflow occurs during the offset calculation of the buffer 0. It is cleared by writing 1 to CB0OF.
    $01 constant GFXMMU_B1OF                    \ [0x01] Buffer 1 overflow flag This bit is set when an overflow occurs during the offset calculation of the buffer 1. It is cleared by writing 1 to CB1OF.
    $02 constant GFXMMU_B2OF                    \ [0x02] Buffer 2 overflow flag This bit is set when an overflow occurs during the offset calculation of the buffer 2. It is cleared by writing 1 to CB2OF.
    $03 constant GFXMMU_B3OF                    \ [0x03] Buffer 3 overflow flag This bit is set when an overflow occurs during the offset calculation of the buffer 3. It is cleared by writing 1 to CB3OF.
    $04 constant GFXMMU_AMEF                    \ [0x04] AXI master error flag This bit is set when an AXI error happens during a transaction. It is cleared by writing 1 to CAMEF.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_FCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_CB0OF                   \ [0x00] Clear buffer 0 overflow flag Writing 1 clears the buffer 0 overflow flag in the GFXMMU_SR register.
    $01 constant GFXMMU_CB1OF                   \ [0x01] Clear buffer 1 overflow flag Writing 1 clears the buffer 1 overflow flag in the GFXMMU_SR register.
    $02 constant GFXMMU_CB2OF                   \ [0x02] Clear buffer 2 overflow flag Writing 1 clears the buffer 2 overflow flag in the GFXMMU_SR register.
    $03 constant GFXMMU_CB3OF                   \ [0x03] Clear buffer 3 overflow flag Writing 1 clears the buffer 3 overflow flag in the GFXMMU_SR register.
    $04 constant GFXMMU_CAMEF                   \ [0x04] Clear AXI master error flag Writing 1 clears the AXI master error flag in the GFXMMU_SR register.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_DVR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_DV                      \ [0x00 : 32] Default value This field indicates the default 32-bit value which is returned when a master accesses a virtual memory location not physically mapped.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_DAR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_DA                      \ [0x00 : 8] Default alpha This field indicates the default 8-bit value which is merged with the 24-bit value when a master accesses a virtual memory location in packed mode.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_B0CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $04 constant GFXMMU_PBO                     \ [0x04 : 19] Physical buffer offset Offset of the physical buffer.
    $17 constant GFXMMU_PBBA                    \ [0x17 : 9] Physical buffer base address Base address MSB of the physical buffer.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_LUT0L_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_EN                      \ [0x00] Enable Line enable.
    $08 constant GFXMMU_FVB                     \ [0x08 : 8] First valid block Number of the first valid block of line number x.
    $10 constant GFXMMU_LVB                     \ [0x10 : 8] Last valid block Number of the last valid block of line number X.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_LUT0H_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_LO                      \ [0x00 : 18] Line offset Line offset of line number x expressed in number of blocks
  [then]
