...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_TIM16_CR1_DEF
    ...
    $08 constant TIM16_CKD                      \ [0x08 : 2] Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t<sub>DTS</sub>)used by the dead-time generators and the digital filters (tim_tix),
  ...
  [ifdef] TIM16_TIM16_CCMR1_INPUT_DEF
    \
  ...
  [ifdef] TIM16_TIM16_CCMR1_OUTPUT_DEF
    \
    \ @brief TIM16 capture/compare mode register 1 [alternate]
    \ Address offset: 0x18
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_CC1S                     \ [0x00 : 2] Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIM15_CCER).
    ...
    $03 constant TIM16_OC1PE                    \ [0x03] Output Compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S=00 (the channel is configured in output).
    ...
    $08 constant TIM16_CC2S                     \ [0x08 : 2] Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIM15_CCER).
    $0a constant TIM16_OC2FE                    \ [0x0a] Output compare 2 fast enable
    $0b constant TIM16_OC2PE                    \ [0x0b] Output compare 2 preload enable
    $0c constant TIM16_OC2M                     \ [0x0c : 3] OC2M[2:0]: Output compare 2 mode
    $0f constant TIM16_OC2CE                    \ [0x0f] Output compare 2 clear enable
    $10 constant TIM16_OC1M_1                   \ [0x10] OC1M[3]
    $18 constant TIM16_OC2M_1                   \ [0x18] OC2M[3]
  [then]


  [ifdef] TIM16_TIM16_CCER_DEF
    \
    \ @brief TIM16 capture/compare enable register
    \ Address offset: 0x20
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_CC1E                     \ [0x00] Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 680 for details.
  ...
  [ifdef] TIM16_TIM16_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1SEL                   \ [0x00 : 4] selects tim_ti1_in[15:0] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
  [then]
  ...
  [ifdef] TIM16_TIM16_AF1_DEF
    ...
    $01 constant TIM16_BKCMP1E                  \ [0x01] tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timers tim_brk input. tim_brk_cmp1 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM16_BKCMP2E                  \ [0x02] tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timers tim_brk input. tim_brk_cmp2 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $03 constant TIM16_BKCMP3E                  \ [0x03] tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timers tim_brk input. tim_brk_cmp3 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $04 constant TIM16_BKCMP4E                  \ [0x04] tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timers tim_brk input. tim_brk_cmp4 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $05 constant TIM16_BKCMP5E                  \ [0x05] tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timers tim_brk input. tim_brk_cmp5 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $06 constant TIM16_BKCMP6E                  \ [0x06] tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timers tim_brk input. tim_brk_cmp6 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $07 constant TIM16_BKCMP7E                  \ [0x07] tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timers tim_brk input. tim_brk_cmp7 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $08 constant TIM16_BKCMP8E                  \ [0x08] tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. mdf_brkx output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  [ifdef] TIM16_TIM16_AF2_DEF
    \
    \ @brief TIM16 alternate function register 2
    \ Address offset: 0x64
    \ Reset value: 0x00000000
    \
    $10 constant TIM16_OCRSEL                   \ [0x10 : 3] tim_ocref_clr source selection These bits select the tim_ocref_clr input source. Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]


  [ifdef] TIM16_TIM16_DCR_DEF
    \
  ...
  \ @brief General purpose timers
  \
  $00 constant TIM16_TIM16_CR1          \ TIM16 control register 1
  $04 constant TIM16_TIM16_CR2          \ TIM16 control register 2
  $0C constant TIM16_TIM16_DIER         \ TIM16 DMA/interrupt enable register
  $10 constant TIM16_TIM16_SR           \ TIM16 status register
  $14 constant TIM16_TIM16_EGR          \ TIM16 event generation register
  $18 constant TIM16_TIM16_CCMR1_INPUT  \ TIM16 capture/compare mode register 1
  $18 constant TIM16_TIM16_CCMR1_OUTPUT \ TIM16 capture/compare mode register 1 [alternate]
  $20 constant TIM16_TIM16_CCER         \ TIM16 capture/compare enable register
  $24 constant TIM16_TIM16_CNT          \ TIM16 counter
  $28 constant TIM16_TIM16_PSC          \ TIM16 prescaler
  $2C constant TIM16_TIM16_ARR          \ TIM16 auto-reload register
  $30 constant TIM16_TIM16_RCR          \ TIM16 repetition counter register
  $34 constant TIM16_TIM16_CCR1         \ TIM16 capture/compare register 1
  $44 constant TIM16_TIM16_BDTR         \ TIM16 break and dead-time register
  $54 constant TIM16_TIM16_DTR2         \ TIM16 timer deadtime register 2
  $5C constant TIM16_TIM16_TISEL        \ TIM16 input selection register
  $60 constant TIM16_TIM16_AF1          \ TIM16 alternate function register 1
  $64 constant TIM16_TIM16_AF2          \ TIM16 alternate function register 2
  $3DC constant TIM16_TIM16_DCR         \ TIM16 DMA control register
  $3E0 constant TIM16_TIM16_DMAR        \ TIM16/TIM17 DMA address for full transfer
