...
[ifndef] DTS_DEF
  ...
  [ifdef] DTS_DTS_CFGR1_DEF
    ...
    $08 constant DTS_TS1_INTRIG_SEL             \ [0x08 : 4] Input trigger selection bit for temperature sensor 1 These bits are set and cleared by software. They select which input triggers a temperature measurement. Refer to Section 30.3.10: Trigger input.
