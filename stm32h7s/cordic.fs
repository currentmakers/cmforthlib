...
[ifndef] CORDIC_DEF
  ...
  [ifdef] CORDIC_CORDIC_CSR_DEF
    ...
    \
    $00 constant CORDIC_FUNC                    \ [0x00 : 4] Function 10 to 15: reserved
    $04 constant CORDIC_PRECISION               \ [0x04 : 4] Precision required (number of iterations) 1 to 15: (Number of iterations)/4 To determine the number of iterations needed for a given accuracy refer to Table 193. Note that for most functions, the recommended range for this field is 3 to 6.
    $08 constant CORDIC_SCALE                   \ [0x08 : 3] Scaling factor The value of this field indicates the scaling factor applied to the arguments and/or results. A value n implies that the arguments have been multiplied by a factor 2<sup>-n</sup>, and/or the results need to be multiplied by 2<sup>n</sup>. Refer to Section 24.3.2 for the applicability of the scaling factor for each function and the appropriate range.
