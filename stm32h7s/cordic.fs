...
$0000000f constant CORDIC_CORDIC_CSR_FUNC                           \ Function 10 to 15: reserved
$000000f0 constant CORDIC_CORDIC_CSR_PRECISION                      \ Precision required (number of iterations) 1 to 15: (Number of iterations)/4 To determine the number of iterations needed for a given accuracy refer to Table 193. Note that for most functions, the recommended range for this field is 3 to 6.
$00000700 constant CORDIC_CORDIC_CSR_SCALE                          \ Scaling factor The value of this field indicates the scaling factor applied to the arguments and/or results. A value n implies that the arguments have been multiplied by a factor 2<sup>-n</sup>, and/or the results need to be multiplied by 2<sup>n</sup>. Refer to Section 24.3.2 for the applicability of the scaling factor for each function and the appropriate range.
...
\ @brief CORDIC register block
\
$48004400 constant CORDIC_CORDIC_CSR  \ offset: 0x00 : CORDIC control/status register
$48004404 constant CORDIC_CORDIC_WDATA  \ offset: 0x04 : CORDIC argument register
$48004408 constant CORDIC_CORDIC_RDATA  \ offset: 0x08 : CORDIC result register
