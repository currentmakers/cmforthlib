...
$00000004 constant RCC_RCC_AHB3RSTR_CRYPRST                         \ CRYP block reset Set and reset by software.
$00000010 constant RCC_RCC_AHB3RSTR_SAESRST                         \ SAES block reset Set and reset by software.
$00000040 constant RCC_RCC_AHB3RSTR_PKARST                          \ PKA block reset Set and reset by software.
...
$00000004 constant RCC_RCC_AHB3ENR_CRYPEN                           \ CRYP peripheral clock enable Set and reset by software.
$00000010 constant RCC_RCC_AHB3ENR_SAESEN                           \ SAES peripheral clock enable Set and reset by software. This bit controls the enable of the clock delivered to the SAES.
$00000040 constant RCC_RCC_AHB3ENR_PKAEN                            \ PKA peripheral clock enable Set and reset by software.
...
$00000004 constant RCC_RCC_AHB3LPENR_CRYPLPEN                       \ CRYP peripheral clock enable in low-power mode Set and reset by software.
$00000010 constant RCC_RCC_AHB3LPENR_SAESLPEN                       \ SAES peripheral clock enable in low-power mode Set and reset by software.
$00000040 constant RCC_RCC_AHB3LPENR_PKALPEN                        \ PKA peripheral clock enable in low-power mode Set and reset by software.
