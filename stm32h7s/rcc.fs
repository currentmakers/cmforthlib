...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_RCC_AHB3RSTR_DEF
    ...
    $02 constant RCC_CRYPRST                    \ [0x02] CRYP block reset Set and reset by software.
    $04 constant RCC_SAESRST                    \ [0x04] SAES block reset Set and reset by software.
    $06 constant RCC_PKARST                     \ [0x06] PKA block reset Set and reset by software.
  [then]
  ...
  [ifdef] RCC_RCC_AHB3ENR_DEF
    ...
    $02 constant RCC_CRYPEN                     \ [0x02] CRYP peripheral clock enable Set and reset by software.
    $04 constant RCC_SAESEN                     \ [0x04] SAES peripheral clock enable Set and reset by software. This bit controls the enable of the clock delivered to the SAES.
    $06 constant RCC_PKAEN                      \ [0x06] PKA peripheral clock enable Set and reset by software.
  [then]
  ...
  [ifdef] RCC_RCC_AHB3LPENR_DEF
    ...
    $02 constant RCC_CRYPLPEN                   \ [0x02] CRYP peripheral clock enable in low-power mode Set and reset by software.
    $04 constant RCC_SAESLPEN                   \ [0x04] SAES peripheral clock enable in low-power mode Set and reset by software.
    $06 constant RCC_PKALPEN                    \ [0x06] PKA peripheral clock enable in low-power mode Set and reset by software.
  [then]
