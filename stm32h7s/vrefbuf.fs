...
[ifndef] VREFBUF_DEF
  ...
  [ifdef] VREFBUF_VREFBUF_CSR_DEF
    ...
    $01 constant VREFBUF_HIZ                    \ [0x01] High impedance mode This bit controls the analog switch to connect or not the V<sub>REF+</sub> pin. Refer to Table 229: VREF buffer modes for the mode descriptions depending on ENVR bit configuration.
