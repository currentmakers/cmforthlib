...
[ifndef] LPUART1_DEF
  ...
  [ifdef] LPUART1_LPUART_RDR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LPUART1_RDR                    \ [0x00 : 9] Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 938). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit.
  [then]
  ...
  \ @brief Low-power universal asynchronous receiver transmitter
  \
  $00 constant LPUART1_LPUART_CR1_ENABLED    \ LPUART control register 1
  $00 constant LPUART1_LPUART_CR1_DISABLED    \ LPUART control register 1
  ...
  $1C constant LPUART1_LPUART_ISR_ENABLED    \ LPUART interrupt and status register
  $1C constant LPUART1_LPUART_ISR_DISABLED    \ LPUART interrupt and status register
