...
$00000010 constant RTC_RTC_CR_REFCKON                               \ RTC_REFIN reference clock detection enable (50 or 60 Hz) Note: BIN must be 0x00 and PREDIV_S must be 0x00FF.
...
$00080000 constant RTC_RTC_CR_COSEL                                 \ Calibration output selection When COE = 1, this bit selects which signal is output on CALIB. These frequencies are valid for RTCCLK at 32.768 kHz and prescalers at their default values (PREDIV_A = 127 and PREDIV_S = 255). Refer to .
...
$00000000 constant RTC_RTC_TSSSR_SS                                 \ Sub second value/Synchronous binary counter values SS[31:0] is the value of the synchronous prescaler counter when the timestamp event occurred.
...
$00007fff constant RTC_RTC_ALRMASSR_SS                              \ Sub seconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm A is to be activated. Only bits 0 up MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRMABINR, and so can also be read or written through RTC_ALRMABINR.
$3f000000 constant RTC_RTC_ALRMASSR_MASKSS                          \ Mask the most-significant bits starting at this bit 2: SS[31:2] are don't care in Alarm A comparison. Only SS[1:0] are compared. ... 31: SS[31] is don't care in Alarm A comparison. Only SS[30:0] are compared. From 32 to 63: All 32 SS bits are compared and must match to activate alarm. Note: In BCD mode (BIN=00) the overflow bits of the synchronous counter (bits 31:15) are never compared. These bits can be different from 0 only after a shift operation.
...
$00007fff constant RTC_RTC_ALRMBSSR_SS                              \ Sub seconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR.
$3f000000 constant RTC_RTC_ALRMBSSR_MASKSS                          \ Mask the most-significant bits starting at this bit 2: SS[31:2] are don't care in Alarm B comparison. Only SS[1:0] are compared. ... 31: SS[31] is don't care in Alarm B comparison. Only SS[30:0] are compared. From 32 to 63: All 32 SS bits are compared and must match to activate alarm. Note: In BCD mode (BIN=00)The overflow bits of the synchronous counter (bits 15) is never compared. This bit can be different from 0 only after a shift operation.
...
$00000008 constant RTC_RTC_MISR_TSMF                                \ Timestamp non-secure masked flag This flag is set by hardware when a timestamp non-secure interrupt occurs. If ITSF flag is set, TSF must be cleared together with ITSF.
$00000010 constant RTC_RTC_MISR_TSOVMF                              \ Timestamp overflow non-secure masked flag This flag is set by hardware when a timestamp interrupt occurs while TSMF is already set. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared.
$00000020 constant RTC_RTC_MISR_ITSMF                               \ Internal timestamp non-secure masked flag This flag is set by hardware when a timestamp on the internal event occurs and timestamp non-secure interrupt is raised.
...
$00000008 constant RTC_RTC_SMISR_TSMF                               \ Timestamp interrupt secure masked flag This flag is set by hardware when a timestamp secure interrupt occurs. If ITSF flag is set, TSF must be cleared together with ITSF.
...
$00000020 constant RTC_RTC_SMISR_ITSMF                              \ Internal timestamp interrupt secure masked flag This flag is set by hardware when a timestamp on the internal event occurs and timestamp secure interrupt is raised.
...
$00000001 constant RTC_RTC_OR_OUT2_RMP                              \ RTC_OUT2 mapping
...
\ @brief Real-time clock
\
$44007800 constant RTC_RTC_TR     \ offset: 0x00 : RTC time register
$44007804 constant RTC_RTC_DR     \ offset: 0x04 : RTC date register
$44007808 constant RTC_RTC_SSR    \ offset: 0x08 : RTC sub second register
$4400780c constant RTC_RTC_ICSR   \ offset: 0x0C : RTC initialization control and status register
$44007810 constant RTC_RTC_PRER   \ offset: 0x10 : RTC prescaler register
$44007814 constant RTC_RTC_WUTR   \ offset: 0x14 : RTC wakeup timer register
$44007818 constant RTC_RTC_CR     \ offset: 0x18 : RTC control register
$4400781c constant RTC_RTC_PRIVCFGR  \ offset: 0x1C : RTC privilege mode control register
$44007820 constant RTC_RTC_SECCFGR  \ offset: 0x20 : RTC secure configuration register
$44007824 constant RTC_RTC_WPR    \ offset: 0x24 : RTC write protection register
$44007828 constant RTC_RTC_CALR   \ offset: 0x28 : RTC calibration register
$4400782c constant RTC_RTC_SHIFTR  \ offset: 0x2C : RTC shift control register
$44007830 constant RTC_RTC_TSTR   \ offset: 0x30 : RTC timestamp time register
$44007834 constant RTC_RTC_TSDR   \ offset: 0x34 : RTC timestamp date register
$44007838 constant RTC_RTC_TSSSR  \ offset: 0x38 : RTC timestamp sub second register
$44007840 constant RTC_RTC_ALRMAR  \ offset: 0x40 : RTC alarm A register
$44007844 constant RTC_RTC_ALRMASSR  \ offset: 0x44 : RTC alarm A sub second register
$44007848 constant RTC_RTC_ALRMBR  \ offset: 0x48 : RTC alarm B register
$4400784c constant RTC_RTC_ALRMBSSR  \ offset: 0x4C : RTC alarm B sub second register
$44007850 constant RTC_RTC_SR     \ offset: 0x50 : RTC status register
$44007854 constant RTC_RTC_MISR   \ offset: 0x54 : RTC non-secure masked interrupt status register
$44007858 constant RTC_RTC_SMISR  \ offset: 0x58 : RTC secure masked interrupt status register
$4400785c constant RTC_RTC_SCR    \ offset: 0x5C : RTC status clear register
$44007860 constant RTC_RTC_OR     \ offset: 0x60 : RTC option register
$44007870 constant RTC_RTC_ALRABINR  \ offset: 0x70 : RTC alarm A binary mode register
$44007874 constant RTC_RTC_ALRBBINR  \ offset: 0x74 : RTC alarm B binary mode register
