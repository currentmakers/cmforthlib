...
[ifndef] GTZC1_TZSC_DEF
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_CR_DEF
    ...
    \
    $00 constant GTZC1_TZSC_LCK                 \ [0x00] lock the configuration of GTZC1_TZSC_SECCFGRx and GTZC1_TZSC_PRIVCFGRx until next reset This bit is cleared by default and once set, it can not be reset until system reset.
  [then]
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_SECCFGR1_DEF
    ...
    $07 constant GTZC1_TZSC_TIM13SEC            \ [0x07] secure access mode for TIM13
    $08 constant GTZC1_TZSC_TIM14SEC            \ [0x08] secure access mode for TIM14
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_SECCFGR2_DEF
    ...
    $0d constant GTZC1_TZSC_TIM16SEC            \ [0x0d] secure access mode for TIM16
    $0e constant GTZC1_TZSC_TIM17SEC            \ [0x0e] secure access mode for TIM17
    ...
    $18 constant GTZC1_TZSC_SPI5SEC             \ [0x18] secure access mode for SPI5
    ...
    $1b constant GTZC1_TZSC_I2C4SEC             \ [0x1b] secure access mode for I2C4
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_SECCFGR3_DEF
    ...
    $15 constant GTZC1_TZSC_SDMMC1SEC           \ [0x15] secure access mode for SDMMC2
    $16 constant GTZC1_TZSC_SDMMC2SEC           \ [0x16] secure access mode for SDMMC1
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_PRIVCFGR1_DEF
    ...
    $06 constant GTZC1_TZSC_TIM12PRIV           \ [0x06] privileged access mode for TIM12
    $07 constant GTZC1_TZSC_TIM13PRIV           \ [0x07] privileged access mode for TIM13
    $08 constant GTZC1_TZSC_TIM14PRIV           \ [0x08] privileged access mode for TIM14
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_PRIVCFGR2_DEF
    ...
    $0e constant GTZC1_TZSC_TIM17PRIV           \ [0x0e] privileged access mode for TIM17
    ...
    $18 constant GTZC1_TZSC_SPI5PRIV            \ [0x18] privileged access mode for SPI5
    ...
    $1b constant GTZC1_TZSC_I2C4PRIV            \ [0x1b] privileged access mode for I2C4
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_PRIVCFGR3_DEF
    ...
    $15 constant GTZC1_TZSC_SDMMC2PRIV          \ [0x15] privileged access mode for SDMMC2
    $16 constant GTZC1_TZSC_SDMMC1PRIV          \ [0x16] privileged access mode for SDMMC1
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_MPCWM1ACFGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GTZC1_TZSC_SREN                \ [0x00] Sub-region z enable Note: External memories that are watermark controlled start fully non-secure/unprivileged at reset when TZEN = 0xC3. When TZEN = 0xB4, external memories start fully secure/fully privileged (inverted reset-value).
    $01 constant GTZC1_TZSC_SRLOCK              \ [0x01] Sub-region A lock This bit, once set, can be cleared only by a system reset.
    $08 constant GTZC1_TZSC_SEC                 \ [0x08] Secure sub-region A of base region x This bit is taken into account only if SREN is set.
    $09 constant GTZC1_TZSC_PRIV                \ [0x09] Privileged sub-region A of base region x This bit is taken into account only if SREN is set.
  [then]
  ...
  [ifdef] GTZC1_TZSC_GTZC1_TZSC_MPCWM1BCFGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GTZC1_TZSC_SREN                \ [0x00] Sub-region B enable Note: External memories that are watermark controlled start fully non-secure/unprivileged at reset when TZEN = 0xC3. When TZEN = 0xB4, external memories start fully secure/fully privileged (inverted reset-value).
    $01 constant GTZC1_TZSC_SRLOCK              \ [0x01] Sub-region B lock This bit, once set, can be cleared only by a system reset.
    $08 constant GTZC1_TZSC_SEC                 \ [0x08] Secure sub-region B of base region x This bit is taken into account only if SREN is set.
    $09 constant GTZC1_TZSC_PRIV                \ [0x09] Privileged sub-region B of base region x This bit is taken into account only if SREN is set.
  [then]
  ...
  $40 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM1ACFGR    \ GTZC1 TZSC memory 1 sub-region A watermark configuration register
  $44 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM1AR    \ GTZC1 TZSC memory 1 sub-region A watermark register
  $48 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM1BCFGR    \ GTZC1 TZSC memory 1 sub-region B watermark configuration register
  $4C constant GTZC1_TZSC_GTZC1_TZSC_MPCWM1BR    \ GTZC1 TZSC memory 1 sub-region B watermark register
  $50 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM2ACFGR    \ GTZC1 TZSC memory 2 sub-region A watermark configuration register
  $54 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM2AR    \ GTZC1 TZSC memory 2 sub-region A watermark register
  $58 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM2BCFGR    \ GTZC1 TZSC memory 2 sub-region B watermark configuration register
  $5C constant GTZC1_TZSC_GTZC1_TZSC_MPCWM2BR    \ GTZC1 TZSC memory 2 sub-region B watermark register
  $60 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM3ACFGR    \ GTZC1 TZSC memory 3 sub-region A watermark configuration register
  $64 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM3AR    \ GTZC1 TZSC memory 3 sub-region A watermark register
  $68 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM3BCFGR    \ GTZC1 TZSC memory 3 sub-region B watermark configuration register
  $6C constant GTZC1_TZSC_GTZC1_TZSC_MPCWM3BR    \ GTZC1 TZSC memory 3 sub-region B watermark register
  $70 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM4ACFGR    \ GTZC1 TZSC memory 4 sub-region A watermark configuration register
  $74 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM4AR    \ GTZC1 TZSC memory 4 sub-region A watermark register
  $78 constant GTZC1_TZSC_GTZC1_TZSC_MPCWM4BCFGR    \ GTZC1 TZSC memory 4 sub-region B watermark configuration register
  $7C constant GTZC1_TZSC_GTZC1_TZSC_MPCWM4BR    \ GTZC1 TZSC memory 4 sub-region B watermark register
