...
$00010000 constant FLASH_FLASH_OPTSR_CUR_IO_VDD_HSLV                \ High-speed IO at low Vsub DD/sub voltage configuration bit. This bit can be set only with Vsub DD/sub below 2.7V.
$00020000 constant FLASH_FLASH_OPTSR_CUR_IO_VDDIO2_HSLV             \ High-speed IO at low Vsub DDIO2/sub voltage configuration bit. This bit can be set only with Vsub DDIO2/sub below 2.7V.
