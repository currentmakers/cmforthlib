...
$00000300 constant TIM15_TIM15_CR1_CKD                              \ Clock division This bitfield indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tDTS) used by the dead-time generators and the digital filters (tim_tix)
...
$00000070 constant TIM15_TIM15_CR2_MMS                              \ Master mode selection These bits allow to select the information to be sent in master mode to slave timers for synchronization (tim_trgo). The combination is as follows:
...
$00000007 constant TIM15_TIM15_SMCR_SMS                             \ Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Others: Reserved. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS='00100'). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$00000070 constant TIM15_TIM15_SMCR_TS                              \ Trigger selection This bit field selects the trigger input to be used to synchronize the counter. Others: Reserved See for more details on tim_itrx meaning for each timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
$00000080 constant TIM15_TIM15_SMCR_MSM                             \ Master/slave mode
$00010000 constant TIM15_TIM15_SMCR_SMS_2                           \ Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Others: Reserved. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS='00100'). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$00300000 constant TIM15_TIM15_SMCR_TS_2                            \ Trigger selection This bit field selects the trigger input to be used to synchronize the counter. Others: Reserved See for more details on tim_itrx meaning for each timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00007000 constant TIM15_TIM15_CCMR1_OUTPUT_OC2M1                   \ Output compare 2 mode
$00008000 constant TIM15_TIM15_CCMR1_OUTPUT_OC2CE                   \ Output compare 2 clear enable
$00010000 constant TIM15_TIM15_CCMR1_OUTPUT_OC1M2                   \ Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 and tim_oc1n are derived. tim_oc1ref is active high whereas tim_oc1 and tim_oc1n active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S='00' (the channel is configured in output). In PWM mode, the tim_ocxref level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode. On channels that have a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIM15_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated.
$01000000 constant TIM15_TIM15_CCMR1_OUTPUT_OC2M2                   \ Output compare 2 mode
...
$00000001 constant TIM15_TIM15_CCER_CC1E                            \ Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to for details.
...
$00002000 constant TIM15_TIM15_BDTR_BKP                             \ Break polarity Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register). Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
...
$0000000f constant TIM15_TIM15_TISEL_TI1SEL                         \ selects tim_ti1_in[0..15] input ... Refer to for interconnects list.
$00000f00 constant TIM15_TIM15_TISEL_TI2SEL                         \ selects tim_ti2_in[0..15] input ... Refer to for interconnects list.
...
$00000002 constant TIM15_TIM15_AF1_BKCMP1E                          \ tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timer's tim_brk input. tim_brk_cmp1 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000004 constant TIM15_TIM15_AF1_BKCMP2E                          \ tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timer's tim_brk input. tim_brk_cmp2 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000008 constant TIM15_TIM15_AF1_BKCMP3E                          \ tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timer's tim_brk input. tim_brk_cmp3 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000010 constant TIM15_TIM15_AF1_BKCMP4E                          \ tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timer's tim_brk input. tim_brk_cmp4 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000020 constant TIM15_TIM15_AF1_BKCMP5E                          \ tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timer's tim_brk input. tim_brk_cmp5 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000040 constant TIM15_TIM15_AF1_BKCMP6E                          \ tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timer's tim_brk input. tim_brk_cmp6 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000080 constant TIM15_TIM15_AF1_BKCMP7E                          \ tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timer's tim_brk input. COMP7 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
$00000100 constant TIM15_TIM15_AF1_BKCMP8E                          \ tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timer's tim_brk input. mdf_brkx output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
...
$00070000 constant TIM15_TIM15_AF2_OCRSEL                           \ ocref_clr source selection These bits select the ocref_clr input source. Refer to for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIM15_BDTR register).
...
$40014018 constant TIM15_TIM15_CCMR1_INPUT  \ offset: 0x18 : TIM15 capture/compare mode register 1 [alternate]
$40014018 constant TIM15_TIM15_CCMR1_OUTPUT  \ offset: 0x18 : TIM15 capture/compare mode register 1 [alternate]
...
$40014054 constant TIM15_TIM15_DTR2  \ offset: 0x54 : TIM15 timer deadtime register 2
$4001405c constant TIM15_TIM15_TISEL  \ offset: 0x5C : TIM15 input selection register
$40014060 constant TIM15_TIM15_AF1  \ offset: 0x60 : TIM15 alternate function register 1
$40014064 constant TIM15_TIM15_AF2  \ offset: 0x64 : TIM15 alternate function register 2
$400143dc constant TIM15_TIM15_DCR  \ offset: 0x3DC : TIM15 DMA control register
$400143e0 constant TIM15_TIM15_DMAR  \ offset: 0x3E0 : TIM15 DMA address for full transfer
