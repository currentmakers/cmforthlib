...
[ifndef] SDIO_DEF
  ...
  [ifdef] SDIO_RESP1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS1               \ [0x00 : 32] see Table 132.
  [then]
  ...
  [ifdef] SDIO_RESP2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS2               \ [0x00 : 32] see Table 132.
  [then]
  ...
  [ifdef] SDIO_RESP3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS3               \ [0x00 : 32] see Table 132.
  [then]
  ...
  [ifdef] SDIO_RESP4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS4               \ [0x00 : 32] see Table 132.
  [then]
  ...
  [ifdef] SDIO_FIFO_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_FIFOData                  \ [0x00 : 32] Receive and transmit FIFO data
  [then]
