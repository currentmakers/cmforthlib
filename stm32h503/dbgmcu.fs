...
[ifndef] DBGMCU_DEF
  ...
  [ifdef] DBGMCU_DBGMCU_IDCODE_DEF
    ...
    $10 constant DBGMCU_REV_ID                  \ [0x10 : 16] revision This field indicates the revision of the device.
  [then]
  ...
  [ifdef] DBGMCU_DBGMCU_APB3FZR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0c constant DBGMCU_DBG_I3C2_STOP           \ [0x0c] I3C2 SCL stall counter stop in debug
