...
$ffff0000 constant DBGMCU_DBGMCU_IDCODE_REV_ID                      \ revision This field indicates the revision of the device.
...
$00001000 constant DBGMCU_DBGMCU_APB3FZR_DBG_I3C2_STOP              \ I3C2 SCL stall counter stop in debug
