...
$00000200 constant LPTIM1_LPTIM_ICR_OUTPUT_CC2CF                    \ Capture/compare 2 clear flag Writing 1 to this bit clears the CC2IF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
$00080000 constant LPTIM1_LPTIM_ICR_OUTPUT_CMP2OKCF                 \ Compare register 2 update OK clear flag Writing 1 to this bit clears the CMP2OK flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
...
$00000200 constant LPTIM1_LPTIM_DIER_OUTPUT_CC2IE                   \ Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
$00080000 constant LPTIM1_LPTIM_DIER_OUTPUT_CMP2OKIE                \ Compare register 2 update OK interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Please refer to .
$00800000 constant LPTIM1_LPTIM_DIER_OUTPUT_UEDE                    \ Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Please refer to .
...
$00200000 constant LPTIM1_LPTIM_CFGR_WAVPOL                         \ Waveform shape polarity The WAVPOL bit controls the output polarity Note: If the LPTIM implements at least one capture/compare channel, this bit is reserved. Please refer to .
...
\ @brief Low power timer
\
$44004400 constant LPTIM1_LPTIM_ISR_OUTPUT  \ offset: 0x00 : LPTIM1 interrupt and status register [alternate]
$44004400 constant LPTIM1_LPTIM_ISR_INTPUT  \ offset: 0x00 : LPTIM1 interrupt and status register [alternate]
$44004404 constant LPTIM1_LPTIM_ICR_OUTPUT  \ offset: 0x04 : LPTIM1 interrupt clear register [alternate]
$44004404 constant LPTIM1_LPTIM_ICR_INTPUT  \ offset: 0x04 : LPTIM interrupt clear register
$44004408 constant LPTIM1_LPTIM_DIER_OUTPUT  \ offset: 0x08 : LPTIM1 interrupt enable register [alternate]
