...
[ifndef] HASH_DEF
  ...
  [ifdef] HASH_HASH_CR_DEF
    ...
    $10 constant HASH_LKEY                      \ [0x10] Long key selection The application must set this bit if the HMAC key is greater than the block size (64 bytes) This selection is only taken into account when the INIT and MODE bits are set (HMAC mode selected). Changing this bit during a computation has no effect.
    $11 constant HASH_ALGO                      \ [0x11 : 2] Algorithm selection These bits select the hash algorithm: This selection is only taken into account when the INIT bit is set. Changing this bitfield during a computation has no effect. When the ALGO bitfield is updated and INIT bit is set, NBWE in HASH_SR is automatically updated to 0x11.
  [then]
  ...
  [ifdef] HASH_HASH_HRA0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H0                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HRA1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H1                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HRA2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H2                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HRA3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H3                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HRA4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H4                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS0                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS1                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS2                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS3                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS4                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS5                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS6                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR7_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS7                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR8_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS8                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR9_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS9                       \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR10_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS10                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR11_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS11                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR12_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS12                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR13_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS13                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR14_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS14                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR15_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS15                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR16_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS16                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR17_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS17                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR18_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS18                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR19_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS19                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR20_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS20                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR21_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS21                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR22_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS22                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR23_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS23                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR24_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS24                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR25_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS25                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR26_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS26                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR27_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS27                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR28_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS28                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR29_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS29                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR30_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS30                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR31_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS31                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR32_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS32                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR33_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS33                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR34_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS34                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR35_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS35                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR36_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS36                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR37_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS37                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR38_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS38                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR39_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS39                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR40_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS40                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR41_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS41                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR42_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS42                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR43_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS43                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR44_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS44                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR45_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS45                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR46_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS46                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR47_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS47                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR48_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS48                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR49_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS49                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR50_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS50                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR51_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS51                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR52_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS52                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_CSR53_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS53                      \ [0x00 : 32] Context swap x Refer to Section 24.7.7: HASH context swap registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H5                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H6                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
  ...
  [ifdef] HASH_HASH_HR7_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H7                        \ [0x00 : 32] Hash data x Refer to Section 24.7.4: HASH digest registers introduction.
  [then]
