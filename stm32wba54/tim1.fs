...
$00000060 constant TIM1_TIM1_CR1_CMS                                \ Center-aligned mode selection Note: It is not allowed to switch from edge-aligned mode to center-aligned mode as long as the counter is enabled (CEN=1)
$00000080 constant TIM1_TIM1_CR1_ARPE                               \ Auto-reload preload enable
$00000300 constant TIM1_TIM1_CR1_CKD                                \ Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tsubDTS/sub)used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),
$00000800 constant TIM1_TIM1_CR1_UIFREMAP                           \ UIF status bit remapping
$00001000 constant TIM1_TIM1_CR1_DITHEN                             \ Dithering enable Note: The DITHEN bit can only be modified when CEN bit is reset.
...
$00000070 constant TIM1_TIM1_CR2_MMS                                \ MMS[2:0]: Master mode selection These bits select the information to be sent in master mode to slave timers for synchronization (tim_trgo). The combination is as follows: Other codes reserved Note: The clock of the slave timer or ADC must be enabled prior to receive events from the master timer, and must not be changed on-the-fly while triggers are received from the master timer.
$00000080 constant TIM1_TIM1_CR2_TI1S                               \ tim_ti1 selection
$00000100 constant TIM1_TIM1_CR2_OIS1                               \ Output idle state 1 (tim_oc1 output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
$00000200 constant TIM1_TIM1_CR2_OIS1N                              \ Output idle state 1 (tim_oc1n output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
$00000400 constant TIM1_TIM1_CR2_OIS2                               \ Output idle state 2 (tim_oc2 output) Refer to OIS1 bit
$00000800 constant TIM1_TIM1_CR2_OIS2N                              \ Output idle state 2 (tim_oc2n output) Refer to OIS1N bit
$00001000 constant TIM1_TIM1_CR2_OIS3                               \ Output idle state 3 (tim_oc3n output) Refer to OIS1 bit
$00002000 constant TIM1_TIM1_CR2_OIS3N                              \ Output idle state 3 (tim_oc3n output) Refer to OIS1N bit
$00004000 constant TIM1_TIM1_CR2_OIS4                               \ Output idle state 4 (tim_oc4 output) Refer to OIS1 bit
$00008000 constant TIM1_TIM1_CR2_OIS4N                              \ Output idle state 4 (tim_oc4n output) Refer to OIS1N bit
$00010000 constant TIM1_TIM1_CR2_OIS5                               \ Output idle state 5 (tim_oc5 output) Refer to OIS1 bit
$00040000 constant TIM1_TIM1_CR2_OIS6                               \ Output idle state 6 (tim_oc6 output) Refer to OIS1 bit
...
$00003000 constant TIM1_TIM1_SMCR_ETPS                              \ External trigger prescaler External trigger signal tim_etrp frequency must be at most 1/4 of TIMxCLK frequency. A prescaler can be enabled to reduce tim_etrp frequency. It is useful when inputting fast external clocks on tim_etr_in.
...
$00008000 constant TIM1_TIM1_SMCR_ETP                               \ External trigger polarity This bit selects whether tim_etr_in or tim_etr_in is used for trigger operations
$00010000 constant TIM1_TIM1_SMCR_SMS_1                             \ SMS[3]
$00300000 constant TIM1_TIM1_SMCR_TS_1                              \ TS[4:3]
$01000000 constant TIM1_TIM1_SMCR_SMSPE                             \ SMS preload enable This bit selects whether the SMS[3:0] bitfield is preloaded
$02000000 constant TIM1_TIM1_SMCR_SMSPS                             \ SMS preload source This bit selects whether the events that triggers the SMS[3:0] bitfield transfer from preload to active
...
$00000020 constant TIM1_TIM1_SR_COMIF                               \ COM interrupt flag This flag is set by hardware on COM event (when capture/compare Control bits - CCxE, CCxNE, OCxM - have been updated). It is cleared by software.
...
$00100000 constant TIM1_TIM1_SR_IDXF                                \ Index interrupt flag This flag is set by hardware when an index event is detected. It is cleared by software by writing it to '0'.
$00200000 constant TIM1_TIM1_SR_DIRF                                \ Direction change interrupt flag This flag is set by hardware when the direction changes in encoder mode (DIR bit value in TIMx_CR is changing). It is cleared by software by writing it to '0'.
$00400000 constant TIM1_TIM1_SR_IERRF                               \ Index error interrupt flag This flag is set by hardware when an index error is detected. It is cleared by software by writing it to '0'.
$00800000 constant TIM1_TIM1_SR_TERRF                               \ Transition error interrupt flag This flag is set by hardware when a transition error is detected in encoder mode. It is cleared by software by writing it to '0'.
...
$00000003 constant TIM1_TIM1_CCMR1_CC1S                             \ Capture/compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = '0' in TIMx_CCER).
$0000000c constant TIM1_TIM1_CCMR1_IC1PSC                           \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E='0' (TIMx_CCER register).
$000000f0 constant TIM1_TIM1_CCMR1_IC1F                             \ Input capture 1 filter This bit-field defines the frequency used to sample tim_ti1 input and the length of the digital filter applied to tim_ti1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
$00000300 constant TIM1_TIM1_CCMR1_CC2S                             \ Capture/compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = '0' in TIMx_CCER).
$00000c00 constant TIM1_TIM1_CCMR1_IC2PSC                           \ Input capture 2 prescaler
$0000f000 constant TIM1_TIM1_CCMR1_IC2F                             \ Input capture 2 filter
...
$00000003 constant TIM1_TIM1_CCMR1_ALTERNATE1_CC1S                  \ Capture/compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = '0' in TIMx_CCER).
$00000004 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC1FE                 \ Output compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
$00000008 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC1PE                 \ Output compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S='00' (the channel is configured in output).
$00000070 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC1M                  \ OC1M[2:0]: Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 and tim_oc1n are derived. tim_oc1ref is active high whereas tim_oc1 and tim_oc1n active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S='00' (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode. Note: On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated.
$00000080 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC1CE                 \ Output compare 1 clear enable
$00000300 constant TIM1_TIM1_CCMR1_ALTERNATE1_CC2S                  \ Capture/compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = '0' in TIMx_CCER).
$00000400 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2FE                 \ Output compare 2 fast enable
$00000800 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2PE                 \ Output compare 2 preload enable
$00007000 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2M                  \ OC2M[2:0]: Output compare 2 mode
$00008000 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2CE                 \ Output compare 2 clear enable
$00010000 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC1M_1                \ OC1M[3]
$01000000 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2M_1                \ OC2M[3]
...
$00000003 constant TIM1_TIM1_CCMR2_CC3S                             \ Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0' in TIMx_CCER).
$0000000c constant TIM1_TIM1_CCMR2_IC3PSC                           \ Input capture 3 prescaler
$000000f0 constant TIM1_TIM1_CCMR2_IC3F                             \ Input capture 3 filter
$00000300 constant TIM1_TIM1_CCMR2_CC4S                             \ Capture/compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0' in TIMx_CCER).
$00000c00 constant TIM1_TIM1_CCMR2_IC4PSC                           \ Input capture 4 prescaler
$0000f000 constant TIM1_TIM1_CCMR2_IC4F                             \ Input capture 4 filter
...
$00000003 constant TIM1_TIM1_CCMR2_ALTERNATE1_CC3S                  \ Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = '0' in TIMx_CCER).
$00000004 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3FE                 \ Output compare 3 fast enable
$00000008 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3PE                 \ Output compare 3 preload enable
$00000070 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3M                  \ OC3M[2:0]: Output compare 3 mode These bits define the behavior of the output reference signal tim_oc3ref from which tim_oc3 and tim_oc3n are derived. tim_oc3ref is active high whereas tim_oc3 and tim_oc3n active level depends on CC3P and CC3NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S='00' (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode. On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC3M active bits take the new value from the preloaded bits only when a COM event is generated.
$00000080 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3CE                 \ Output compare 3 clear enable
$00000300 constant TIM1_TIM1_CCMR2_ALTERNATE1_CC4S                  \ Capture/compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = '0' in TIMx_CCER).
$00000400 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4FE                 \ Output compare 4 fast enable
$00000800 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4PE                 \ Output compare 4 preload enable
$00007000 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4M                  \ OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] bit description
$00008000 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4CE                 \ Output compare 4 clear enable
$00010000 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3M_1                \ OC3M[3]
$01000000 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4M_1                \ OC4M[3]
...
$00004000 constant TIM1_TIM1_CCER_CC4NE                             \ Capture/compare 4 complementary output enable Refer to CC1NE description
...
$0000ffff constant TIM1_TIM1_CNT_CNT                                \ Counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register only holds the non-dithered part in CNT[15:0]. The fractional part is not available.
...
$00008000 constant TIM1_TIM1_BDTR_MOE                               \ Main output enable This bit is cleared asynchronously by hardware as soon as one of the break inputs is active (tim_brk or tim_brk2). It is set by software or automatically depending on the AOE bit. It is acting only on the channels which are configured in output. In response to a break event or if MOE is written to 0: OC and OCN outputs are disabled or forced to idle state depending on the OSSI bit. See OC/OCN enable description for more details (Section 28.6.11: TIM1 capture/compare enable register (TIM1_CCER)).
...
$000fffff constant TIM1_TIM1_CCR6_CCR6                              \ Capture/compare 6 value CCR6 is the value to be loaded in the actual capture/compare 6 register (preload value). It is loaded permanently if the preload feature is not selected in the TIMx_CCMR3 register (bit OC6PE). Else the preload value is copied in the active capture/compare 6 register when an update event occurs. The active capture/compare register contains the value to be compared to the counter TIMx_CNT and signaled on tim_oc6 output. Non-dithering mode (DITHEN = 0) The register holds the compare value in CCR6[15:0]. The CCR6[19:16] bits are reset. Dithering mode (DITHEN = 1) The register holds the integer part in CCR6[19:4]. The CCR6[3:0] bitfield contains the dithered part.
...
$00000001 constant TIM1_TIM1_ECR_IE                                 \ Index enable This bit indicates if the Index event resets the counter.
$00000006 constant TIM1_TIM1_ECR_IDIR                               \ Index direction This bit indicates in which direction the Index event resets the counter. Note: The IDR[1:0] bitfield must be written when IE bit is reset (index disabled).
$00000018 constant TIM1_TIM1_ECR_IBLK                               \ Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 or tim_ti4 input
$00000020 constant TIM1_TIM1_ECR_FIDX                               \ First index This bit indicates if the first index only is taken into account
$000000c0 constant TIM1_TIM1_ECR_IPOS                               \ Index positioning In quadrature encoder mode (SMS[3:0] = 0001, 0010, 0011, 1110, 1111), this bit indicates in which AB input configuration the Index event resets the counter. In directional clock mode or clock plus direction mode (SMS[3:0] = 1010, 1011, 1100, 1101), these bits indicates on which level the Index event resets the counter. In bidirectional clock mode, this applies for both clock inputs. x0: Index resets the counter when clock is 0 x1: Index resets the counter when clock is 1 Note: IPOS[1] bit is not significant
$00ff0000 constant TIM1_TIM1_ECR_PW                                 \ Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW[7:0] x tsubPWG/sub
$07000000 constant TIM1_TIM1_ECR_PWPRSC                             \ Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC[2:0])/sup) x tsubtim_ker_ck/sub
...
$0000000f constant TIM1_TIM1_TISEL_TI1SEL                           \ Selects tim_ti1[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
$00000f00 constant TIM1_TIM1_TISEL_TI2SEL                           \ Selects tim_ti2[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
$000f0000 constant TIM1_TIM1_TISEL_TI3SEL                           \ Selects tim_ti3[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
$0f000000 constant TIM1_TIM1_TISEL_TI4SEL                           \ Selects tim_ti4[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
...
$00000001 constant TIM1_TIM1_AF1_BKINE                              \ TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timer's tim_brk input. TIMx_BKIN input is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM1_TIM1_AF1_BKCMP1E                            \ tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timer's tim_brk input. tim_brk_cmp1 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF1_BKCMP2E                            \ tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timer's tim_brk input. tim_brk_cmp2 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000008 constant TIM1_TIM1_AF1_BKCMP3E                            \ tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timer's tim_brk input. tim_brk_cmp3 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000010 constant TIM1_TIM1_AF1_BKCMP4E                            \ tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timer's tim_brk input. tim_brk_cmp4 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000020 constant TIM1_TIM1_AF1_BKCMP5E                            \ tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timer's tim_brk input. tim_brk_cmp5 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000040 constant TIM1_TIM1_AF1_BKCMP6E                            \ tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timer's tim_brk input. tim_brk_cmp6 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000080 constant TIM1_TIM1_AF1_BKCMP7E                            \ tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timer's tim_brk input. tim_brk_cmp7 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF1_BKCMP8E                            \ tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timer's tim_brk input. tim_brk_cmp8 output is 'ORed' with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000200 constant TIM1_TIM1_AF1_BKINP                              \ TIMx_BKIN input polarity This bit selects the TIMx_BKIN alternate function input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000400 constant TIM1_TIM1_AF1_BKCMP1P                            \ tim_brk_cmp1 input polarity This bit selects the tim_brk_cmp1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000800 constant TIM1_TIM1_AF1_BKCMP2P                            \ tim_brk_cmp2 input polarity This bit selects the tim_brk_cmp2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00001000 constant TIM1_TIM1_AF1_BKCMP3P                            \ tim_brk_cmp3 input polarity This bit selects the tim_brk_cmp3 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00002000 constant TIM1_TIM1_AF1_BKCMP4P                            \ tim_brk_cmp4 input polarity This bit selects the tim_brk_cmp4 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$0003c000 constant TIM1_TIM1_AF1_ETRSEL                             \ etr_in source selection These bits select the etr_in input source. ... Refer to Section 28.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000001 constant TIM1_TIM1_AF2_BK2INE                             \ TIMx_BKIN2 input enable This bit enables the TIMx_BKIN2 alternate function input for the timer's tim_brk2 input. TIMx_BKIN2 input is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM1_TIM1_AF2_BK2CMP1E                           \ tim_brk2_cmp1 enable This bit enables the tim_brk2_cmp1 for the timer's tim_brk2 input. tim_brk2_cmp1 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF2_BK2CMP2E                           \ tim_brk2_cmp2 enable This bit enables the tim_brk2_cmp2 for the timer's tim_brk2 input. tim_brk2_cmp2 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000008 constant TIM1_TIM1_AF2_BK2CMP3E                           \ tim_brk2_cmp3 enable This bit enables the tim_brk2_cmp3 for the timer's tim_brk2 input. tim_brk2_cmp3 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000010 constant TIM1_TIM1_AF2_BK2CMP4E                           \ tim_brk2_cmp4 enable This bit enables the tim_brk2_cmp4 for the timer's tim_brk2 input. tim_brk2_cmp4 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000020 constant TIM1_TIM1_AF2_BK2CMP5E                           \ tim_brk2_cmp5 enable This bit enables the tim_brk2_cmp5 for the timer's tim_brk2 input. tim_brk2_cmp5 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000040 constant TIM1_TIM1_AF2_BK2CMP6E                           \ tim_brk2_cmp6 enable This bit enables the tim_brk2_cmp6 for the timer's tim_brk2 input. tim_brk2_cmp6 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000080 constant TIM1_TIM1_AF2_BK2CMP7E                           \ tim_brk2_cmp7 enable This bit enables the tim_brk2_cmp7 for the timer's tim_brk2 input. tim_brk2_cmp7 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF2_BK2CMP8E                           \ tim_brk2_cmp8 enable This bit enables the tim_brk2_cmp8 for the timer's tim_brk2 input. tim_brk2_cmp8 output is 'ORed' with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000200 constant TIM1_TIM1_AF2_BK2INP                             \ TIMx_BKIN2 input polarity This bit selects the TIMx_BKIN2 alternate function input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000400 constant TIM1_TIM1_AF2_BK2CMP1P                           \ tim_brk2_cmp1 input polarity This bit selects the tim_brk2_cmp1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000800 constant TIM1_TIM1_AF2_BK2CMP2P                           \ tim_brk2_cmp2 input polarity This bit selects the tim_brk2_cmp2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00001000 constant TIM1_TIM1_AF2_BK2CMP3P                           \ tim_brk2_cmp3 input polarity This bit selects the tim_brk2_cmp3 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00002000 constant TIM1_TIM1_AF2_BK2CMP4P                           \ tim_brk2_cmp4 input polarity This bit selects the tim_brk2_cmp4 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00070000 constant TIM1_TIM1_AF2_OCRSEL                             \ ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 28.3.2: TIM1 pins and internal signals for product specific information. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$000f0000 constant TIM1_TIM1_DCR_DBSS                               \ DMA burst source selection This bitfield defines the interrupt source that triggers the DMA burst transfers (the timer recognizes a burst transfer when a read or a write access is done to the TIMx_DMAR address). Others: reserved
...
\ @brief TIM1 address block description
\
$40012c00 constant TIM1_TIM1_CR1  \ offset: 0x00 : TIM1 control register 1
$40012c04 constant TIM1_TIM1_CR2  \ offset: 0x04 : TIM1 control register 2
$40012c08 constant TIM1_TIM1_SMCR  \ offset: 0x08 : TIM1 slave mode control register
$40012c0c constant TIM1_TIM1_DIER  \ offset: 0x0C : TIM1 DMA/interrupt enable register
$40012c10 constant TIM1_TIM1_SR   \ offset: 0x10 : TIM1 status register
$40012c14 constant TIM1_TIM1_EGR  \ offset: 0x14 : TIM1 event generation register
$40012c18 constant TIM1_TIM1_CCMR1  \ offset: 0x18 : TIM1 capture/compare mode register 1 [alternate]
$40012c18 constant TIM1_TIM1_CCMR1_ALTERNATE1  \ offset: 0x18 : TIM1 capture/compare mode register 1 [alternate]
$40012c1c constant TIM1_TIM1_CCMR2  \ offset: 0x1C : TIM1 capture/compare mode register 2 [alternate]
$40012c1c constant TIM1_TIM1_CCMR2_ALTERNATE1  \ offset: 0x1C : TIM1 capture/compare mode register 2 [alternate]
$40012c20 constant TIM1_TIM1_CCER  \ offset: 0x20 : TIM1 capture/compare enable register
$40012c24 constant TIM1_TIM1_CNT  \ offset: 0x24 : TIM1 counter
$40012c28 constant TIM1_TIM1_PSC  \ offset: 0x28 : TIM1 prescaler
$40012c2c constant TIM1_TIM1_ARR  \ offset: 0x2C : TIM1 auto-reload register
$40012c30 constant TIM1_TIM1_RCR  \ offset: 0x30 : TIM1 repetition counter register
$40012c34 constant TIM1_TIM1_CCR1  \ offset: 0x34 : TIM1 capture/compare register 1
$40012c38 constant TIM1_TIM1_CCR2  \ offset: 0x38 : TIM1 capture/compare register 2
$40012c3c constant TIM1_TIM1_CCR3  \ offset: 0x3C : TIM1 capture/compare register 3
$40012c40 constant TIM1_TIM1_CCR4  \ offset: 0x40 : TIM1 capture/compare register 4
$40012c44 constant TIM1_TIM1_BDTR  \ offset: 0x44 : TIM1 break and dead-time register
$40012c48 constant TIM1_TIM1_CCR5  \ offset: 0x48 : TIM1 capture/compare register 5
$40012c4c constant TIM1_TIM1_CCR6  \ offset: 0x4C : TIM1 capture/compare register 6
$40012c50 constant TIM1_TIM1_CCMR3  \ offset: 0x50 : TIM1 capture/compare mode register 3
$40012c54 constant TIM1_TIM1_DTR2  \ offset: 0x54 : TIM1 timer deadtime register 2
$40012c58 constant TIM1_TIM1_ECR  \ offset: 0x58 : TIM1 timer encoder control register
$40012c5c constant TIM1_TIM1_TISEL  \ offset: 0x5C : TIM1 timer input selection register
$40012c60 constant TIM1_TIM1_AF1  \ offset: 0x60 : TIM1 alternate function option register 1
$40012c64 constant TIM1_TIM1_AF2  \ offset: 0x64 : TIM1 alternate function register 2
$40012fdc constant TIM1_TIM1_DCR  \ offset: 0x3DC : TIM1 DMA control register
$40012fe0 constant TIM1_TIM1_DMAR  \ offset: 0x3E0 : TIM1 DMA address for full transfer
