...
[ifndef] ADC1_DEF
  ...
  [ifdef] ADC1_CFGR_DEF
    ...
    $05 constant ADC1_EXTSEL                    \ [0x05 : 5] External trigger selection for regular group
    ...
    $0f constant ADC1_ALIGN                     \ [0x0f] ALIGN
  ...
  [ifdef] ADC1_CFGR2_DEF
    \
    \ @brief configuration register
    \ Address offset: 0x10
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_ROVSE                     \ [0x00] DMAEN
    $01 constant ADC1_JOVSE                     \ [0x01] DMACFG
    $02 constant ADC1_OVSR                      \ [0x02 : 3] RES
    $05 constant ADC1_OVSS                      \ [0x05 : 4] ALIGN
    $09 constant ADC1_TROVS                     \ [0x09] Triggered Regular Oversampling
    $0a constant ADC1_ROVSM                     \ [0x0a] EXTEN
    $10 constant ADC1_GCOMP                     \ [0x10] GCOMP
    $19 constant ADC1_SWTRIG                    \ [0x19] SWTRIG
    $1a constant ADC1_BULB                      \ [0x1a] BULB
    $1b constant ADC1_SMPTRIG                   \ [0x1b] SMPTRIG
  [then]
  ...
  [ifdef] ADC1_TR1_DEF
    ...
    $0c constant ADC1_AWDFILT                   \ [0x0c : 3] AWDFILT
  ...
  [ifdef] ADC1_OFR1_DEF
    ...
    $18 constant ADC1_OFFSETPOS                 \ [0x18] OFFSETPOS
    $19 constant ADC1_SATEN                     \ [0x19] SATEN
  ...
  [ifdef] ADC1_AWD2CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_AWD2CH                    \ [0x00 : 19] AWD2CH
  [then]
  ...
  [ifdef] ADC1_AWD3CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_AWD3CH                    \ [0x00 : 19] AWD3CH
  [then]
  ...
  [ifdef] ADC1_DIFSEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_DIFSEL_0                  \ [0x00] Differential mode for channels 0
    $01 constant ADC1_DIFSEL_1_18               \ [0x01 : 18] Differential mode for channels 15 to 1
  [then]
  ...
  $10 constant ADC1_CFGR2               \ configuration register
  ...
  $C0 constant ADC1_GCOMP               \ Gain compensation Register
