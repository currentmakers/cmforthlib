...
[ifndef] TIM17_DEF
  ...
  [ifdef] TIM17_CR1_DEF
    ...
    \
    $00 constant TIM17_CEN                      \ [0x00] CEN: Counter enable 0: Counter disabled 1: Counter enabled Note: External clock and gated mode can work only if the CEN bit has been previously set by software. However trigger mode can set the CEN bit automatically by hardware.
    $01 constant TIM17_UDIS                     \ [0x01] UDIS: Update disable This bit is set and cleared by software to enable/disable UEV event generation. 0: UEV enabled. The Update (UEV) event is generated by one of the following events: - Counter overflow/underflow - Setting the UG bit - Update generation through the slave mode controller Buffered registers are then loaded with their preload values. 1: UEV disabled. The Update event is not generated, shadow registers keep their value (ARR, PSC, CCRx). However the counter and the prescaler are reinitialized if the UG bit is set or if a hardware reset is received from the slave mode controller.
    $02 constant TIM17_URS                      \ [0x02] URS: Update request source This bit is set and cleared by software to select the UEV event sources. 0: Any of the following events generate an update interrupt or DMA request if enabled. These events can be: - Counter overflow/underflow - Setting the UG bit - Update generation through the slave mode controller 1: Only counter overflow/underflow generates an update interrupt or DMA request if enabled.
    $03 constant TIM17_OPM                      \ [0x03] OPM: One pulse mode 0: Counter is not stopped at update event. 1: Counter stops counting at the next update event (clearing the bit CEN)
    $07 constant TIM17_ARPE                     \ [0x07] ARPE: Auto-reload preload enable 0: TIMx_ARR register is not buffered 1: TIMx_ARR register is buffered
    $08 constant TIM17_CKD                      \ [0x08 : 2] CKD[1:0]: Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (TIx), 00: tDTS=tCK_INT 01: tDTS=2*tCK_INT 10: tDTS=4*tCK_INT 11: Reserved, do not program this value
    $0b constant TIM17_UIF_REMAP                \ [0x0b] UIFREMAP: UIF status bit remapping 0: No remapping. UIF status bit is not copied to TIMx_CNT register bit 31. 1: Remapping enabled. UIF status bit is copied to TIMx_CNT register bit 31.
  [then]
  ...
  [ifdef] TIM17_CR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_CCPC                     \ [0x00] CCPC: Capture/compare preloaded control 0: CCxE, CCxNE and OCxM bits are not preloaded 1: CCxE, CCxNE and OCxM bits are preloaded, after having been written, they are updated only when COM bit is set. Note: This bit acts only on channels that have a complementary output.
    $02 constant TIM17_CCUS                     \ [0x02] CCUS: Capture/compare control update selection 0: When capture/compare control bits are preloaded (CCPC=1), they are updated by setting the COMG bit only. 1: When capture/compare control bits are preloaded (CCPC=1), they are updated by setting the COMG bit or when an rising edge occurs on TRGI. Note: This bit acts only on channels that have a complementary output.
    $03 constant TIM17_CCDS                     \ [0x03] CCDS: Capture/compare DMA selection 0: CCx DMA request sent when CCx event occurs 1: CCx DMA requests sent when update event occurs
    $08 constant TIM17_OIS1                     \ [0x08] OIS1: Output Idle state 1 (OC1 output) 0: OC1=0 (after a dead-time if OC1N is implemented) when MOE=0 1: OC1=1 (after a dead-time if OC1N is implemented) when MOE=0 Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BKR register).
    $09 constant TIM17_OIS1N                    \ [0x09] OIS1N: Output Idle state 1 (OC1N output) 0: OC1N=0 after a dead-time when MOE=0 1: OC1N=1 after a dead-time when MOE=0 Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BKR register).
  [then]
  ...
  [ifdef] TIM17_DIER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_UIE                      \ [0x00] UIE: Update interrupt enable 0: Update interrupt disabled 1: Update interrupt enabled
    $01 constant TIM17_CC1IE                    \ [0x01] CC1IE: Capture/Compare 1 interrupt enable 0: CC1 interrupt disabled. 1: CC1 interrupt enabled
    $05 constant TIM17_COMIE                    \ [0x05] COMIE: COM interrupt enable 0: COM interrupt disabled 1: COM interrupt enabled
    $07 constant TIM17_BIE                      \ [0x07] BIE: Break interrupt enable 0: Break interrupt disabled 1: Break interrupt enabled
    $08 constant TIM17_UDE                      \ [0x08] UDE: Update DMA request enable 0: Update DMA request disabled 1: Update DMA request enabled
    $09 constant TIM17_CC1DE                    \ [0x09] CC1DE: Capture/Compare 1 DMA request enable 0: CC1 DMA request disabled 1: CC1 DMA request enabled
    $0d constant TIM17_CCUDE                    \ [0x0d] CCUDE: CC-Update DMA request Enable. Not used in Blue51. Not available in IUM 0: CC-Update DMA request disabled. 1: CC-Update DMA request enabled.
    $0f constant TIM17_BDE                      \ [0x0f] BDE: Break DMA request Enable. Not used in Blue51. Not available in IUM 0: Break DMA request disabled. 1: Break DMA request enabled.
  [then]
  ...
  [ifdef] TIM17_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_CNT                      \ [0x00 : 16] CNT[15:0]: Counter value
    $1f constant TIM17_UIF_CPY                  \ [0x1f] UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register. If the UIFREMAP bit in TIMx_CR1 is reset, bit 31 is reserved and read as 0.
  [then]
  ...
  [ifdef] TIM17_PSC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_PSC                      \ [0x00 : 16] PSC[15:0]: Prescaler value The counter clock frequency (CK_CNT) is equal to fCK_PSC / (PSC[15:0] + 1). PSC contains the value to be loaded in the active prescaler register at each update event (including when the counter is cleared through UG bit of TIMx_EGR register or through trigger controller when configured in 'reset mode').
  [then]
  ...
  [ifdef] TIM17_ARR_DEF
    ...
    \
    $00 constant TIM17_ARR                      \ [0x00 : 16] ARR[15:0]: Prescaler value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 22.3.1: Time-base unit on page 418 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM17_DMAR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_DMAB                     \ [0x00 : 16] DMAB[15:0]: DMA register for burst accesses A read or write operation to the DMAR register accesses the register located at the address (TIMx_CR1 address) + (DBA + DMA index) x 4 where TIMx_CR1 address is the address of the control register 1, DBA is the DMA base address configured in TIMx_DCR register, DMA index is automatically controlled by the DMA transfer, and ranges from 0 to DBL (DBL configured in TIMx_DCR).
  [then]
  ...
  [ifdef] TIM17_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_TI1_RMP                  \ [0x00 : 2] TI1_RMP[1:0]: Timer 17 input 1 connection This bit is set and cleared by software. 00: TIM17 TI1 is connected to GPIO 01: TIM17 TI1 is connected to LCO 1x: TIM17 TI1 is connected to MCO
  [then]
  ...
  [ifdef] TIM17_AF1_DEF
    ...
    \
    $00 constant TIM17_BKINE                    \ [0x00] BKINE: BRK BKIN enable. This bit enables the BKIN alternate function input for the timer's BRK input. BKIN input is ORed with the other enabled BRK sources. 0: BKIN input disabled. 1: BKIN input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $01 constant TIM17_BKCMP1E                  \ [0x01] BKCMP1E: BRK COMP1 enable. This bit enables the COMP1 for the timer's BRK input. COMP1 output is ORed with the other enabled BRK sources. 0: COMP1 input disabled. 1: COMP1 input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $02 constant TIM17_BKCMP2E                  \ [0x02] BKCMP1E: BRK COMP1 enable. This bit enables the COMP1 for the timer's BRK input. COMP1 output is ORed with the other enabled BRK sources. 0: COMP1 input disabled. 1: COMP1 input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $03 constant TIM17_AF1_8_3                  \ [0x03 : 6] AF1[13:12] Not used in Blue51. Not available in IUM
    $09 constant TIM17_BKINP                    \ [0x09] BKINP: BRK BKIN input polarity. This bit selects the BKIN alternate function input sensitivity. It must be programmed together with the BKP polarity bit. 0: BKIN input is active low. 1: BKIN input is active high. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $0a constant TIM17_BKCMP1P                  \ [0x0a] BKCMP1P: BRK COMP1 input polarity. This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. 0: COMP1 input is active low. 1: COMP1 input is active high. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $0b constant TIM17_BKCMP2P                  \ [0x0b] BKCMP2P: BRK COMP2 input polarity. This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. 0: COMP2 input is active low. 1: COMP2 input is active high. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $0c constant TIM17_AF1_13_12                \ [0x0c : 2] AF1[13:12] Not used in Blue51. Not available in IUM
  [then]

  \
  \ @brief TIM16 interrupt
  \
  $00 constant TIM17_CR1                \ CR1 register
  $04 constant TIM17_CR2                \ CR2 register
  $0C constant TIM17_DIER               \ DIER register
  $10 constant TIM17_SR                 \ SR register
  $14 constant TIM17_EGR                \ EGR register
  $18 constant TIM17_CCMR1              \ CCMR1 register
  $18 constant TIM17_CCMR1_IN           \ CC1S: Capture/Compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. 00: CC1 channel is configured as output 01: CC1 channel is configured as input, IC1 is mapped on TI1 1x: Reserved Note: CC1S bits are writable only when the channel is OFF (CC1E = '0' in TIMx_CCER).
  $20 constant TIM17_CCER               \ CCER register
  $24 constant TIM17_CNT                \ CNT register
  $28 constant TIM17_PSC                \ PSC register
  $2C constant TIM17_ARR                \ ARR register
  $30 constant TIM17_RCR                \ RCR register
  $34 constant TIM17_CCR1               \ CCR1 register
  $44 constant TIM17_BDTR               \ BDTR register
  $48 constant TIM17_DCR                \ DCR register
  $4C constant TIM17_DMAR               \ DMAR register
  $50 constant TIM17_OR1                \ OR1 register
  $60 constant TIM17_AF1                \ AF1 register
