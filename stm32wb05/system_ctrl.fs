...
$00000004 constant SYSTEM_CTRL_BLERXTX_ISCR_TX_ISEDGE               \ TX_ISEDGE: interrupt edge status on TX_SEQUENCE signal: 0: falling edge on TX_SEQUENCE detected. 1: rising edge on TX_SEQUENCE detected.
$00000008 constant SYSTEM_CTRL_BLERXTX_ISCR_RX_ISEDGE               \ RX_ISEDGE: interrupt edge status on RX_SEQUENCE signal: 0: falling edge on RX_SEQUENCE detected. 1: rising edge on RX_SEQUENCE detected.
