...
[ifndef] GPIOB_DEF
  ...
  [ifdef] GPIOB_PUPDR_DEF
    ...
    $02 constant GPIOB_PUPD1                    \ [0x02 : 2] PUPD1: Port B configuration bits These bits are written by software to configure the I/O pull-up or pull-down -00: No pull-up, pull-down -01: Pull-up -10: Pull-down -11: Reserved
    $04 constant GPIOB_PUPD2                    \ [0x04 : 2] PUPD2: Port B configuration bits These bits are written by software to configure the I/O pull-up or pull-down -00: No pull-up, pull-down -01: Pull-up -10: Pull-down -11: Reserved
