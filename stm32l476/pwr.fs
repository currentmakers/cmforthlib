...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_CR3_DEF
    ...
    $0f constant PWR_EWF                        \ [0x0f] Enable internal wakeup line
  [then]
  ...
  [ifdef] PWR_SR1_DEF
    ...
    $08 constant PWR_CSBF                       \ [0x08] Standby flag
  ...
  [ifdef] PWR_SCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_WUF1                       \ [0x00] Clear wakeup flag 1
    $01 constant PWR_WUF2                       \ [0x01] Clear wakeup flag 2
    $02 constant PWR_WUF3                       \ [0x02] Clear wakeup flag 3
    $03 constant PWR_WUF4                       \ [0x03] Clear wakeup flag 4
    $04 constant PWR_WUF5                       \ [0x04] Clear wakeup flag 5
    $08 constant PWR_SBF                        \ [0x08] Clear standby flag
  [then]
