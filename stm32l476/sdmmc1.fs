...
\ @brief Secure digital input/output interface
\
$40012800 constant SDMMC1_POWER   \ offset: 0x00 : power control register
$40012804 constant SDMMC1_CLKCR   \ offset: 0x04 : SDI clock control register
$40012808 constant SDMMC1_ARG     \ offset: 0x08 : argument register
$4001280c constant SDMMC1_CMD     \ offset: 0x0C : command register
$40012810 constant SDMMC1_RESPCMD  \ offset: 0x10 : command response register
$40012814 constant SDMMC1_RESP1   \ offset: 0x14 : response 1..4 register
$40012818 constant SDMMC1_RESP2   \ offset: 0x18 : response 1..4 register
$4001281c constant SDMMC1_RESP3   \ offset: 0x1C : response 1..4 register
$40012820 constant SDMMC1_RESP4   \ offset: 0x20 : response 1..4 register
$40012824 constant SDMMC1_DTIMER  \ offset: 0x24 : data timer register
$40012828 constant SDMMC1_DLEN    \ offset: 0x28 : data length register
$4001282c constant SDMMC1_DCTRL   \ offset: 0x2C : data control register
$40012830 constant SDMMC1_DCOUNT  \ offset: 0x30 : data counter register
$40012834 constant SDMMC1_STA     \ offset: 0x34 : status register
$40012838 constant SDMMC1_ICR     \ offset: 0x38 : interrupt clear register
$4001283c constant SDMMC1_MASK    \ offset: 0x3C : mask register
$40012848 constant SDMMC1_FIFOCNT  \ offset: 0x48 : FIFO counter register
$40012880 constant SDMMC1_FIFO    \ offset: 0x80 : data FIFO register
