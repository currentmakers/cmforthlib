...
$00000080 constant PWR_PWR_CR2_DC2RAMPDS                            \ DCACHE2 SRAM power-down in Stop modes (Stop 0, 1, 2, 3) Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585.
...
$00001000 constant PWR_PWR_CR2_PKARAMPDS                            \ PKA32 SRAM power-down in Stop modes (Stop 0, 1, 2, 3)
...
$01000000 constant PWR_PWR_CR2_GPRAMPDS                             \ Graphic peripherals (LTDC, GFXMMU) SRAM power-down in Stop modes (Stop 0, 1, 2, 3) Note: LTDC SRAM content is always lost in Stop 2 and Stop 3 modes. It can be retained only in Stop 0 and Stop 1 modes. This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585.
$02000000 constant PWR_PWR_CR2_DSIRAMPDS                            \ DSI SRAM power-down in Stop modes (Stop 0, 1) DSI SRAM content is always lost in Stop 2 and Stop 3 modes. Note: This bit is only available in STM32U59x/5Ax. It is reserved in STM32U575/585.
...
$10000000 constant PWR_PWR_SVMCR_USV                                \ VDDUSB independent USB supply valid This bit is used to validate the VDDUSB supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the USB OTG peripheral. If VDDUSB is not always present in the application, the VDDUSB voltage monitor can be used to determine whether this supply is ready or not.
...
$00000400 constant PWR_PWR_CR4_SRAM3PDS9                        
$00000800 constant PWR_PWR_CR4_SRAM3PDS10                       
$00001000 constant PWR_PWR_CR4_SRAM3PDS11                       
$00002000 constant PWR_PWR_CR4_SRAM3PDS12                       
$00004000 constant PWR_PWR_CR4_SRAM3PDS13                       
