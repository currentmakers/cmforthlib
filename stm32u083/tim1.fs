...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_TIM1_ARR_DEF
    ...
    \
    $00 constant TIM1_ARR                       \ [0x00 : 16] Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section122.3.1: Time-base unit on page1497 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM1_TIM1_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_OCREF_CLR                 \ [0x00 : 2] Ocref_clr source selection This bit selects the ocref_clr input source. Others: Reserved Note: COMP3 is available on STM32G0B1xx and STM32G0C1xx salestypes only.
  [then]
  ...
  [ifdef] TIM1_TIM1_CCMR3_DEF
    ...
    $04 constant TIM1_OC5M                      \ [0x04 : 3] OC5M[0]: Output compare 5 mode Refer to OC1M description.
    ...
    $0c constant TIM1_OC6M                      \ [0x0c : 3] OC6M[0]: Output compare 6 mode Refer to OC1M description.
  ...
  [ifdef] TIM1_TIM1_AF1_DEF
    ...
    \
    $00 constant TIM1_BKINE                     \ [0x00] BRK BKIN input enable This bit enables the BKIN alternate function input for the timers BRK input. BKIN input is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM1_BKCMP1E                   \ [0x01] BRK COMP1 enable This bit enables the COMP1 for the timers BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM1_BKCMP2E                   \ [0x02] BRK COMP2 enable This bit enables the COMP2 for the timers BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  [ifdef] TIM1_TIM1_AF2_DEF
    ...
    \ Reset value: 0x00000001
    \
    $00 constant TIM1_BK2INE                    \ [0x00] BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timers BRK2 input. BKIN2 input is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM1_BK2CMP1E                  \ [0x01] BRK2 COMP1 enable This bit enables the COMP1 for the timers BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM1_BK2CMP2E                  \ [0x02] BRK2 COMP2 enable This bit enables the COMP2 for the timers BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  $1C constant TIM1_TIM1_CCMR2_OUTPUT   \ TIM1 capture/compare mode register 1
  ...
  $50 constant TIM1_TIM1_OR1            \ TIM1 option register 1
