...
$0000000c constant TIM1_TIM1_CCMR1_INPUT_IC1PSC                     \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E=0 (TIMx_CCER register).
...
$00007000 constant TIM1_TIM1_CCMR1_OUTPUT_OC2M                      \ OC2M[2:0]: Output Compare 2 mode Refer to OC1M[3:0] description.
...
$00000070 constant TIM1_TIM1_CCMR2_OUTPUT_OC3M                      \ OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description.
...
$00007000 constant TIM1_TIM1_CCMR2_OUTPUT_OC4M                      \ OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description.
...
$0000ffff constant TIM1_TIM1_ARR_ARR                                \ Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section122.3.1: Time-base unit on page1497 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$00000003 constant TIM1_TIM1_OR1_OCREF_CLR                          \ Ocref_clr source selection This bit selects the ocref_clr input source. Others: Reserved Note: COMP3 is available on STM32G0B1xx and STM32G0C1xx salestypes only.
...
$00000001 constant TIM1_TIM1_AF1_BKINE                              \ BRK BKIN input enable This bit enables the BKIN alternate function input for the timers BRK input. BKIN input is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM1_TIM1_AF1_BKCMP1E                            \ BRK COMP1 enable This bit enables the COMP1 for the timers BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF1_BKCMP2E                            \ BRK COMP2 enable This bit enables the COMP2 for the timers BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000001 constant TIM1_TIM1_AF2_BK2INE                             \ BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timers BRK2 input. BKIN2 input is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM1_TIM1_AF2_BK2CMP1E                           \ BRK2 COMP1 enable This bit enables the COMP1 for the timers BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF2_BK2CMP2E                           \ BRK2 COMP2 enable This bit enables the COMP2 for the timers BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$40012c18 constant TIM1_TIM1_CCMR1_INPUT  \ offset: 0x18 : TIM1 capture/compare mode register 1
$40012c18 constant TIM1_TIM1_CCMR1_OUTPUT  \ offset: 0x18 : TIM1 capture/compare mode register 1
$40012c1c constant TIM1_TIM1_CCMR2_INPUT  \ offset: 0x1C : TIM1 capture/compare mode register 2
$40012c1c constant TIM1_TIM1_CCMR2_OUTPUT  \ offset: 0x1C : TIM1 capture/compare mode register 1
...
$40012c50 constant TIM1_TIM1_OR1  \ offset: 0x50 : TIM1 option register 1
