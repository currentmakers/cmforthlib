...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_TIM2_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_OCREF_CLR                 \ [0x00 : 2] Ocref_clr source selection
  [then]
  ...
  $24 constant TIM2_TIM2_CNT_ALTERNATE1 \ TIM2 counter
  ...
  $50 constant TIM2_TIM2_OR1            \ TIM2 option register 1
