...
[ifndef] DMAMUX_DEF
  ...
  [ifdef] DMAMUX_DMAMUX_C0CR_DEF
    ...
    \
    $00 constant DMAMUX_DMAREQ_ID               \ [0x00 : 7] DMA request identification Selects the input DMA request. See the DMAMUX table about assignments of multiplexer inputs to resources.
    ...
    $18 constant DMAMUX_SYNC_ID                 \ [0x18 : 5] Synchronization identification Selects the synchronization input (see Table137: DMAMUX: assignment of synchronization inputs to resources).
  [then]
  ...
  $14 constant DMAMUX_DMAMUX_C5CR       \ DMAMUX request line multiplexer channel 5 configuration register
  $18 constant DMAMUX_DMAMUX_C6CR       \ DMAMUX request line multiplexer channel 6 configuration register
  $1C constant DMAMUX_DMAMUX_C7CR       \ DMAMUX request line multiplexer channel 7 configuration register
  $20 constant DMAMUX_DMAMUX_C8CR       \ DMAMUX request line multiplexer channel 8 configuration register
  $24 constant DMAMUX_DMAMUX_C9CR       \ DMAMUX request line multiplexer channel 9 configuration register
  $28 constant DMAMUX_DMAMUX_C10CR      \ DMAMUX request line multiplexer channel 10 configuration register
  $2C constant DMAMUX_DMAMUX_C11CR      \ DMAMUX request line multiplexer channel 11 configuration register
