...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_RCC_AHBRSTR_DEF
    ...
    $10 constant RCC_AESRST                     \ [0x10] AES hardware accelerator reset Set and cleared by software.
  ...
  [ifdef] RCC_RCC_AHBENR_DEF
    ...
    $10 constant RCC_AESEN                      \ [0x10] AES hardware accelerator Set and cleared by software.
  ...
  [ifdef] RCC_RCC_AHBSMENR_DEF
    ...
    $10 constant RCC_AESSMEN                    \ [0x10] AES hardware accelerator clock enable during Sleep mode Set and cleared by software.
