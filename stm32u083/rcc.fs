...
$00010000 constant RCC_RCC_AHBRSTR_AESRST                           \ AES hardware accelerator reset Set and cleared by software.
...
$00001000 constant RCC_RCC_APBRSTR1_LPUART3RST                      \ LPUART3 reset<sup>(1)</sup> Set and cleared by software.
...
$00008000 constant RCC_RCC_APBRSTR1_SPI3RST                         \ SPI3 reset<sup>(1)</sup> Set and cleared by software.
$00010000 constant RCC_RCC_APBRSTR1_CRSRST                          \ CRS reset<sup>(1)</sup> Set and cleared by software.
...
$02000000 constant RCC_RCC_APBRSTR1_I2C4RST                         \ I2C4 reset<sup>(1)</sup> Set and cleared by software.
$04000000 constant RCC_RCC_APBRSTR1_LPTIM3RST                       \ LPTIM3 reset Set and cleared by software.
...
$00010000 constant RCC_RCC_AHBENR_AESEN                             \ AES hardware accelerator Set and cleared by software.
...
$00001000 constant RCC_RCC_APBENR1_LPUART3EN                        \ LPUART3 clock enable Set and cleared by software.
...
$00008000 constant RCC_RCC_APBENR1_SPI3EN                           \ SPI3 clock enable<sup>(1)</sup> Set and cleared by software.
$00010000 constant RCC_RCC_APBENR1_CRSEN                            \ CRS clock enable<sup>(1)</sup> Set and cleared by software.
...
$02000000 constant RCC_RCC_APBENR1_I2C4EN                           \ I2C4EN clock enable<sup>(1)</sup> Set and cleared by software.
$04000000 constant RCC_RCC_APBENR1_LPTIM3EN                         \ LPTIM3 clock enable Set and cleared by software.
...
$00010000 constant RCC_RCC_AHBSMENR_AESSMEN                         \ AES hardware accelerator clock enable during Sleep mode Set and cleared by software.
...
$00001000 constant RCC_RCC_APBSMENR1_LPUART3SMEN                    \ LPUART3 clock enable during Sleep and Stop modes Set and cleared by software.
...
$00008000 constant RCC_RCC_APBSMENR1_SPI3SMEN                       \ SPI3 clock enable during Sleep mode<sup>(1)</sup> Set and cleared by software.
$00010000 constant RCC_RCC_APBSMENR1_CRSSMEN                        \ CRS clock enable during Sleep and Stop modes<sup>(1)</sup> Set and cleared by software.
...
$02000000 constant RCC_RCC_APBSMENR1_I2C4SMEN                       \ I2C4 clock enable during Sleep mode<sup>(1)</sup> Set and cleared by software.
$04000000 constant RCC_RCC_APBSMENR1_LPTIM3SMEN                     \ Low power timer 3 clock enable during Sleep mode Set and cleared by software.
...
$000000c0 constant RCC_RCC_CCIPR_LPUART3SEL                         \ LPUART3 clock source selection<sup>(1)</sup> This bitfield is controlled by software to select LPUART3 clock source as follows:
...
$00c00000 constant RCC_RCC_CCIPR_LPTIM3SEL                          \ LPTIM3 clock source selection This bitfield is controlled by software to select LPTIM3 clock source as follows:
