...
[ifndef] IPCC_DEF
  ...
  [ifdef] IPCC_HWCFGR_DEF
    ...
    \
    $00 constant IPCC_CHANNELS                  \ [0x00 : 8] Number of channels per CPU supported by the IP, range 1 to 16
  [then]
  ...
  [ifdef] IPCC_VERR_DEF
    ...
    \
    $00 constant IPCC_MINREV                    \ [0x00 : 4] Minor Revision
    $04 constant IPCC_MAJREV                    \ [0x04 : 4] Major Revision
  [then]
  ...
  [ifdef] IPCC_IPIDR_DEF
    ...
    \
    $00 constant IPCC_IPID                      \ [0x00 : 32] Identification Code
  [then]
  ...
  [ifdef] IPCC_SIDR_DEF
    ...
    \
    $00 constant IPCC_SID                       \ [0x00 : 32] Size Identification Code
  [then]
  ...
  $3F4 constant IPCC_VERR               \ IPCC version register
  $3F8 constant IPCC_IPIDR              \ IPCC indentification register
  $3FC constant IPCC_SIDR               \ IPCC size indentification register
