...
[ifndef] LPTIM3_DEF
  ...
  [ifdef] LPTIM3_CFGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LPTIM3_CKSEL                   \ [0x00] CKSEL
    $01 constant LPTIM3_CKPOL                   \ [0x01 : 2] CKPOL
    $03 constant LPTIM3_CKFLT                   \ [0x03 : 2] CKFLT
    $06 constant LPTIM3_TRGFLT                  \ [0x06 : 2] TRGFLT
    $09 constant LPTIM3_PRESC                   \ [0x09 : 3] PRESC
    $0d constant LPTIM3_TRIGSEL                 \ [0x0d : 3] TRIGSEL
    $11 constant LPTIM3_TRIGEN                  \ [0x11 : 2] TRIGEN
    $13 constant LPTIM3_TIMOUT                  \ [0x13] TIMOUT
    $14 constant LPTIM3_WAVE                    \ [0x14] WAVE
    $15 constant LPTIM3_WAVPOL                  \ [0x15] WAVPOL
    $16 constant LPTIM3_PRELOAD                 \ [0x16] PRELOAD
    $17 constant LPTIM3_COUNTMODE               \ [0x17] COUNTMODE
    $18 constant LPTIM3_ENC                     \ [0x18] ENC
  [then]
  ...
  [ifdef] LPTIM3_CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LPTIM3_ENABLE                  \ [0x00] ENABLE
    $01 constant LPTIM3_SNGSTRT                 \ [0x01] SNGSTRT
    $02 constant LPTIM3_CNTSTRT                 \ [0x02] CNTSTRT
    $03 constant LPTIM3_COUNTRST                \ [0x03] COUNTRST
    $04 constant LPTIM3_RSTARE                  \ [0x04] RSTARE
  [then]
  ...
  [ifdef] LPTIM3_CMP_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LPTIM3_CMP                     \ [0x00 : 16] CMP
  [then]
  ...
  [ifdef] LPTIM3_LPTIM3_OR_DEF
    \
    \ @brief option register
    \ Address offset: 0x20
    \ Reset value: 0x00000000
    \
    $00 constant LPTIM3_OR_0                    \ [0x00] Option register bit 0
    $01 constant LPTIM3_OR_1                    \ [0x01] Option register bit 1
  [then]


  [ifdef] LPTIM3_RCR_DEF
    \
  ...
  $20 constant LPTIM3_LPTIM3_OR         \ option register
  $28 constant LPTIM3_RCR               \ repetition register
