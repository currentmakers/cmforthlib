...
[ifndef] SYSCFG_DEF
  ...
  [ifdef] SYSCFG_IMR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_RTCSTAMPTAMPLSECSSIM    \ [0x00] RTCSTAMPTAMPLSECSSIM
    $02 constant SYSCFG_RTCSSRUIM               \ [0x02] RTCSSRUIM
    $15 constant SYSCFG_EXTI5IM                 \ [0x15] EXTI5IM
    $16 constant SYSCFG_EXTI6IM                 \ [0x16] EXTI6IM
    $17 constant SYSCFG_EXTI7IM                 \ [0x17] EXTI7IM
    $18 constant SYSCFG_EXTI8IM                 \ [0x18] EXTI8IM
    $19 constant SYSCFG_EXTI9IM                 \ [0x19] EXTI9IM
    $1a constant SYSCFG_EXTI10IM                \ [0x1a] EXTI10IM
    $1b constant SYSCFG_EXTI11IM                \ [0x1b] EXTI11IM
    $1c constant SYSCFG_EXTI12IM                \ [0x1c] EXTI12IM
    $1d constant SYSCFG_EXTI13IM                \ [0x1d] EXTI13IM
    $1e constant SYSCFG_EXTI14IM                \ [0x1e] EXTI14IM
    $1f constant SYSCFG_EXTI15IM                \ [0x1f] EXTI15IM
  [then]
  ...
  [ifdef] SYSCFG_IMR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $12 constant SYSCFG_PVM3IM                  \ [0x12] PVM3IM
    $14 constant SYSCFG_PVDIM                   \ [0x14] PVDIM
  [then]
  ...
  [ifdef] SYSCFG_C2IMR1_DEF
    ...
    \
    $00 constant SYSCFG_RTCSTAMPTAMPLSECSSIM    \ [0x00] RTCSTAMPTAMPLSECSSIM
    $01 constant SYSCFG_RTCALARMIM              \ [0x01] RTCALARMIM
    $02 constant SYSCFG_RTCSSRUIM               \ [0x02] RTCSSRUIM
    $03 constant SYSCFG_RTCWKUPIM               \ [0x03] RTCWKUPIM
    $05 constant SYSCFG_RCCIM                   \ [0x05] RCCIM
    $06 constant SYSCFG_FLASHIM                 \ [0x06] FLASHIM
    $08 constant SYSCFG_PKAIM                   \ [0x08] PKAIM
    $0a constant SYSCFG_AESIM                   \ [0x0a] AESIM
    $0b constant SYSCFG_COMPIM                  \ [0x0b] COMPIM
    $0c constant SYSCFG_ADCIM                   \ [0x0c] ADCIM
    $0d constant SYSCFG_DACIM                   \ [0x0d] DACIM
    $10 constant SYSCFG_EXTI0IM                 \ [0x10] EXTI0IM
    $11 constant SYSCFG_EXTI1IM                 \ [0x11] EXTI1IM
    $12 constant SYSCFG_EXTI2IM                 \ [0x12] EXTI2IM
    $13 constant SYSCFG_EXTI3IM                 \ [0x13] EXTI3IM
    $14 constant SYSCFG_EXTI4IM                 \ [0x14] EXTI4IM
    $15 constant SYSCFG_EXTI5IM                 \ [0x15] EXTI5IM
    $16 constant SYSCFG_EXTI6IM                 \ [0x16] EXTI6IM
    $17 constant SYSCFG_EXTI7IM                 \ [0x17] EXTI7IM
    $18 constant SYSCFG_EXTI8IM                 \ [0x18] EXTI8IM
  ...
  [ifdef] SYSCFG_C2IMR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_DMA1CH1IM               \ [0x00] DMA1CH1IM
    $01 constant SYSCFG_DMA1CH2IM               \ [0x01] DMA1CH2IM
    $02 constant SYSCFG_DMA1CH3IM               \ [0x02] DMA1CH3IM
    $03 constant SYSCFG_DMA1CH4IM               \ [0x03] DMA1CH4IM
    $04 constant SYSCFG_DMA1CH5IM               \ [0x04] DMA1CH5IM
    $05 constant SYSCFG_DMA1CH6IM               \ [0x05] DMA1CH6IM
    $06 constant SYSCFG_DMA1CH7IM               \ [0x06] DMA1CH7IM
    $08 constant SYSCFG_DMA2CH1IM               \ [0x08] DMA2CH1IM
    $09 constant SYSCFG_DMA2CH2IM               \ [0x09] DMA2CH2IM
    $0a constant SYSCFG_DMA2CH3IM               \ [0x0a] DMA2CH3IM
    $0b constant SYSCFG_DMA2CH4IM               \ [0x0b] DMA2CH4IM
    $0c constant SYSCFG_DMA2CH5IM               \ [0x0c] DMA2CH5IM
    $0d constant SYSCFG_DMA2CH6IM               \ [0x0d] DMA2CH6IM
    $0e constant SYSCFG_DMA2CH7IM               \ [0x0e] DMA2CH7IM
    $0f constant SYSCFG_DMAMUX1IM               \ [0x0f] DMAMUX1IM
    $12 constant SYSCFG_PVM3IM                  \ [0x12] PVM3IM
    $14 constant SYSCFG_PVDIM                   \ [0x14] PVDIM
  [then]
  ...
  $100 constant SYSCFG_IMR1             \ SYSCFG CPU1 interrupt mask register 1
  $104 constant SYSCFG_IMR2             \ SYSCFG CPU1 interrupt mask register 2
  $108 constant SYSCFG_C2IMR1           \ SYSCFG CPU2 interrupt mask register 1
  $10C constant SYSCFG_C2IMR2           \ SYSCFG CPU2 interrupt mask register 2
