...
$00100000 constant RCC_AHB3RSTR_IPCCRST                             \ IPCCRST
...
$20000000 constant RCC_APB1RSTR1_DACRST                             \ DAC1 reset
...
$20000000 constant RCC_APB1SMENR1_DACSMEN                           \ DAC1 clock enable during CPU1 CSleep mode.
...
$000000f0 constant RCC_EXTCFGR_C2HPRE                               \ [dual core device only] HCLK2 prescaler (CPU2)
$00010000 constant RCC_EXTCFGR_SHDHPREF                             \ HCLK3 shared prescaler flag (AHB3, Flash, and SRAM2)
$00020000 constant RCC_EXTCFGR_C2HPREF                              \ CLK2 prescaler flag (CPU2)
...
$00000004 constant RCC_C2AHB1ENR_DMAMUX1EN                          \ CPU2 DMAMUX1 clock enable
...
\
\ @brief CPU2 AHB3 peripheral clock enable register [dual core device only]
\ Address offset: 0x150
\ Reset value: 0x02080000
\

$00010000 constant RCC_C2AHB3ENR_PKAEN                              \ CPU2 PKA accelerator clock enable
$00020000 constant RCC_C2AHB3ENR_AESEN                              \ CPU2 AES accelerator clock enable
$00040000 constant RCC_C2AHB3ENR_RNGEN                              \ CPU2 True RNG clocks enable
$00080000 constant RCC_C2AHB3ENR_HSEMEN                             \ CPU2 HSEM clock enable
$00100000 constant RCC_C2AHB3ENR_IPCCEN                             \ CPU2 IPCC interface clock enable
$02000000 constant RCC_C2AHB3ENR_FLASHEN                            \ CPU2 Flash interface clock enable


\
\ @brief CPU2 APB1 peripheral clock enable register 1 [dual core device only]
...
$00004000 constant RCC_C2APB1ENR1_SPI2S2EN                          \ CPU2 SPI2S2 clock enable
$00020000 constant RCC_C2APB1ENR1_USART2EN                          \ CPU2 USART2 clock enable
$00200000 constant RCC_C2APB1ENR1_I2C1EN                            \ CPU2 I2C1 clocks enable
$00400000 constant RCC_C2APB1ENR1_I2C2EN                            \ CPU2 I2C2 clocks enable
$00800000 constant RCC_C2APB1ENR1_I2C3EN                            \ CPU2 I2C3 clocks enable
$20000000 constant RCC_C2APB1ENR1_DAC1EN                            \ CPU2 DAC1 clock enable
$80000000 constant RCC_C2APB1ENR1_LPTIM1EN                          \ CPU2 Low power timer 1 clocks enable


\
\ @brief CPU2 APB1 peripheral clock enable register 2 [dual core device only]
\ Address offset: 0x15C
\ Reset value: 0x00000000
\

$00000001 constant RCC_C2APB1ENR2_LPUART1EN                         \ CPU2 Low power UART 1 clocks enable
$00000020 constant RCC_C2APB1ENR2_LPTIM2EN                          \ CPU2 Low power timer 2 clocks enable
$00000040 constant RCC_C2APB1ENR2_LPTIM3EN                          \ CPU2 Low power timer 3 clocks enable


\
\ @brief CPU2 APB2 peripheral clock enable register [dual core device only]
\ Address offset: 0x160
\ Reset value: 0x00000000
\

$00000200 constant RCC_C2APB2ENR_ADCEN                              \ ADC clocks enable
...
$00004000 constant RCC_C2APB2ENR_USART1EN                           \ CPU2 USART1clocks enable
...
\
\ @brief CPU2 APB3 peripheral clock enable register [dual core device only]
\ Address offset: 0x164
\ Reset value: 0x00000000
\

$00000001 constant RCC_C2APB3ENR_SUBGHZSPIEN                        \ CPU2 sub-GHz radio SPI clock enable


\
\ @brief CPU2 AHB1 peripheral clocks enable in Sleep modes register [dual core device only]
\ Address offset: 0x168
\ Reset value: 0x00001007
\

$00000001 constant RCC_C2AHB1SMENR_DMA1SMEN                         \ DMA1 clock enable during CPU2 CSleep mode.
$00000002 constant RCC_C2AHB1SMENR_DMA2SMEN                         \ DMA2 clock enable during CPU2 CSleep mode.
$00000004 constant RCC_C2AHB1SMENR_DMAMUX1SMEN                      \ DMAMUX1 clock enable during CPU2 CSleep mode.
$00001000 constant RCC_C2AHB1SMENR_CRCSMEN                          \ CRC clock enable during CPU2 CSleep mode.


\
\ @brief CPU2 AHB2 peripheral clocks enable in Sleep modes register [dual core device only]
\ Address offset: 0x16C
\ Reset value: 0x00000087
\

$00000001 constant RCC_C2AHB2SMENR_GPIOASMEN                        \ IO port A clock enable during CPU2 CSleep mode.
$00000002 constant RCC_C2AHB2SMENR_GPIOBSMEN                        \ IO port B clock enable during CPU2 CSleep mode.
$00000004 constant RCC_C2AHB2SMENR_GPIOCSMEN                        \ IO port C clock enable during CPU2 CSleep mode.
$00000080 constant RCC_C2AHB2SMENR_GPIOHSMEN                        \ IO port H clock enable during CPU2 CSleep mode.


\
\ @brief CPU2 AHB3 peripheral clocks enable in Sleep mode register [dual core device only]
\ Address offset: 0x170
\ Reset value: 0x03870000
\

$00010000 constant RCC_C2AHB3SMENR_PKASMEN                          \ PKA accelerator clock enable during CPU2 CSleep mode.
$00020000 constant RCC_C2AHB3SMENR_AESSMEN                          \ AES accelerator clock enable during CPU2 CSleep mode.
$00040000 constant RCC_C2AHB3SMENR_RNGSMEN                          \ True RNG clock enable during CPU2 CSleep and CStop mode.
$00800000 constant RCC_C2AHB3SMENR_SRAM1SMEN                        \ SRAM1 interface clock enable during CPU2 CSleep mode.
$01000000 constant RCC_C2AHB3SMENR_SRAM2SMEN                        \ SRAM2 memory interface clock enable during CPU2 CSleep mode.
$02000000 constant RCC_C2AHB3SMENR_FLASHSMEN                        \ Flash interface clock enable during CPU2 CSleep mode.


\
\ @brief CPU2 APB1 peripheral clocks enable in Sleep mode register 1 [dual core device only]
\ Address offset: 0x178
\ Reset value: 0xA0E24401
\

$00000001 constant RCC_C2APB1SMENR1_TIM2SMEN                        \ TIM2 timer clock enable during CPU2 CSleep mode.
$00000400 constant RCC_C2APB1SMENR1_RTCAPBSMEN                      \ RTC bus clock enable during CPU2 CSleep mode.
$00004000 constant RCC_C2APB1SMENR1_SPI2S2SMEN                      \ SPI2S2 clock enable during CPU2 CSleep mode.
$00020000 constant RCC_C2APB1SMENR1_USART2SMEN                      \ USART2 clock enable during CPU2 CSleep mode.
$00200000 constant RCC_C2APB1SMENR1_I2C1SMEN                        \ I2C1 clock enable during CPU2 CSleep and CStop modes
$00400000 constant RCC_C2APB1SMENR1_I2C2SMEN                        \ I2C2 clock enable during CPU2 CSleep and CStop modes
$00800000 constant RCC_C2APB1SMENR1_I2C3SMEN                        \ I2C3 clock enable during CPU2 CSleep and CStop modes
$20000000 constant RCC_C2APB1SMENR1_DAC1SMEN                        \ DAC1 clock enable during CPU2 CSleep mode.
$80000000 constant RCC_C2APB1SMENR1_LPTIM1SMEN                      \ Low power timer 1 clock enable during CPU2 CSleep and CStop mode


\
\ @brief CPU2 APB1 peripheral clocks enable in Sleep mode register 2 [dual core device only]
\ Address offset: 0x17C
\ Reset value: 0x00000061
\

$00000001 constant RCC_C2APB1SMENR2_LPUART1SMEN                     \ Low power UART 1 clock enable during CPU2 CSleep and CStop mode
$00000020 constant RCC_C2APB1SMENR2_LPTIM2SMEN                      \ Low power timer 2 clocks enable during CPU2 CSleep and CStop modes.
$00000040 constant RCC_C2APB1SMENR2_LPTIM3SMEN                      \ Low power timer 3 clocks enable during CPU2 CSleep and CStop modes.


\
\ @brief CPU2 APB2 peripheral clocks enable in Sleep mode register [dual core device only]
\ Address offset: 0x180
\ Reset value: 0x00065A00
\

$00000200 constant RCC_C2APB2SMENR_ADCSMEN                          \ ADC clocks enable during CPU2 Csleep and CStop modes
$00000800 constant RCC_C2APB2SMENR_TIM1SMEN                         \ TIM1 timer clock enable during CPU2 CSleep mode
$00001000 constant RCC_C2APB2SMENR_SPI1SMEN                         \ SPI1 clock enable during CPU2 CSleep mode
$00004000 constant RCC_C2APB2SMENR_USART1SMEN                       \ USART1clock enable during CPU2 CSleep and CStop mode
$00020000 constant RCC_C2APB2SMENR_TIM16SMEN                        \ TIM16 timer clock enable during CPU2 CSleep mode
$00040000 constant RCC_C2APB2SMENR_TIM17SMEN                        \ TIM17 timer clock enable during CPU2 CSleep mode


\
\ @brief CPU2 APB3 peripheral clock enable in Sleep mode register [dual core device only]
\ Address offset: 0x184
\ Reset value: 0x00000001
\

$00000001 constant RCC_C2APB3SMENR_SUBGHZSPISMEN                    \ sub-GHz radio SPI clock enable during CPU2 CSleep and CStop modes
...
$58000150 constant RCC_C2AHB3ENR  \ offset: 0x150 : CPU2 AHB3 peripheral clock enable register [dual core device only]
$58000158 constant RCC_C2APB1ENR1  \ offset: 0x158 : CPU2 APB1 peripheral clock enable register 1 [dual core device only]
$5800015c constant RCC_C2APB1ENR2  \ offset: 0x15C : CPU2 APB1 peripheral clock enable register 2 [dual core device only]
$58000160 constant RCC_C2APB2ENR  \ offset: 0x160 : CPU2 APB2 peripheral clock enable register [dual core device only]
$58000164 constant RCC_C2APB3ENR  \ offset: 0x164 : CPU2 APB3 peripheral clock enable register [dual core device only]
$58000168 constant RCC_C2AHB1SMENR  \ offset: 0x168 : CPU2 AHB1 peripheral clocks enable in Sleep modes register [dual core device only]
$5800016c constant RCC_C2AHB2SMENR  \ offset: 0x16C : CPU2 AHB2 peripheral clocks enable in Sleep modes register [dual core device only]
$58000170 constant RCC_C2AHB3SMENR  \ offset: 0x170 : CPU2 AHB3 peripheral clocks enable in Sleep mode register [dual core device only]
$58000178 constant RCC_C2APB1SMENR1  \ offset: 0x178 : CPU2 APB1 peripheral clocks enable in Sleep mode register 1 [dual core device only]
$5800017c constant RCC_C2APB1SMENR2  \ offset: 0x17C : CPU2 APB1 peripheral clocks enable in Sleep mode register 2 [dual core device only]
$58000180 constant RCC_C2APB2SMENR  \ offset: 0x180 : CPU2 APB2 peripheral clocks enable in Sleep mode register [dual core device only]
$58000184 constant RCC_C2APB3SMENR  \ offset: 0x184 : CPU2 APB3 peripheral clock enable in Sleep mode register [dual core device only]
