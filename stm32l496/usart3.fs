...
[ifndef] USART3_DEF
  ...
  [ifdef] USART3_CR3_DEF
    ...
    $18 constant USART3_TCBGTIE_                \ [0x18] Transmission complete before guard time interrupt enable
  [then]
  ...
  [ifdef] USART3_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART3_DIV_Fraction            \ [0x00 : 4] DIV_Fraction
    $04 constant USART3_DIV_Mantissa            \ [0x04 : 12] DIV_Mantissa
  [then]
