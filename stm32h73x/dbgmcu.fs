...
[ifndef] DBGMCU_DEF
  ...
  [ifdef] DBGMCU_CR_DEF
    ...
    \
    $00 constant DBGMCU_DBGSLPD1                \ [0x00] Allow D1 domain debug in Sleep mode
    $01 constant DBGMCU_DBGSTPD1                \ [0x01] Allow D1 domain debug in Stop mode
    $02 constant DBGMCU_DBGSTBD1                \ [0x02] Allow D1 domain debug in Standby mode
    $03 constant DBGMCU_DBGSLPD2                \ [0x03] Allow D2 domain debug in Sleep mode
    $04 constant DBGMCU_DBGSTPD2                \ [0x04] Allow D2 domain debug in Stop mode
    $05 constant DBGMCU_DBGSTBD2                \ [0x05] Allow D2 domain debug in Standby mode
    $07 constant DBGMCU_DBGSTPD3                \ [0x07] Allow debug in D3 Stop mode
    $08 constant DBGMCU_DBGSTBD3                \ [0x08] Allow debug in D3 Standby mode
  ...
  [ifdef] DBGMCU_APB1LFZ1_DEF
    ...
    $0b constant DBGMCU_DBG_WWDG2               \ [0x0b] WWDG2 stop in debug
  ...
  [ifdef] DBGMCU_APB1LFZ2_DEF
    ...
    $03 constant DBGMCU_DBG_TIM5                \ [0x03] TIM5 stop in debug
    $04 constant DBGMCU_DBG_TIM6                \ [0x04] TIM6 stop in debug
    $05 constant DBGMCU_DBG_TIM7                \ [0x05] TIM4 stop in debug
    $06 constant DBGMCU_DBG_TIM12               \ [0x06] TIM12 stop in debug
    $07 constant DBGMCU_DBG_TIM13               \ [0x07] TIM13 stop in debug
    $08 constant DBGMCU_DBG_TIM14               \ [0x08] TIM14 stop in debug
    $09 constant DBGMCU_DBG_LPTIM1              \ [0x09] LPTIM1 stop in debug
  ...
  [ifdef] DBGMCU_APB4FZ1_DEF
    ...
    $13 constant DBGMCU_DBG_WDGLSD2             \ [0x13] Independent watchdog for D2 stop in debug
  [then]


  [ifdef] DBGMCU_APB4FZ2_DEF
    \
    ...
    $0c constant DBGMCU_DBG_LPTIM5              \ [0x0c] LPTIM5 stop in debug
    $10 constant DBGMCU_DBG_RTC                 \ [0x10] RTC stop in debug
    $12 constant DBGMCU_DBG_WDGLSD1             \ [0x12] LS watchdog for D1 stop in debug
    $13 constant DBGMCU_DBG_WDGLSD2             \ [0x13] LS watchdog for D2 stop in debug
  [then]
  ...
  $34 constant DBGMCU_APB3FZ1           \ DBGMCU APB3 peripheral freeze register CPU1
  $38 constant DBGMCU_APB3FZ2           \ DBGMCU APB3 peripheral freeze register CPU2
  $3C constant DBGMCU_APB1LFZ1          \ DBGMCU APB1L peripheral freeze register
  $40 constant DBGMCU_APB1LFZ2          \ DBGMCU APB1L peripheral freeze register CPU2
  $4C constant DBGMCU_APB2FZ1           \ DBGMCU APB2 peripheral freeze register
  $50 constant DBGMCU_APB2FZ2           \ DBGMCU APB2 peripheral freeze register CPU2
  $54 constant DBGMCU_APB4FZ1           \ DBGMCU APB4 peripheral freeze register
  $58 constant DBGMCU_APB4FZ2           \ DBGMCU APB4 peripheral freeze register CPU2
