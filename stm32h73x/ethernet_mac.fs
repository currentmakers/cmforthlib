...
[ifndef] ETHERNET_MAC_DEF
  ...
  [ifdef] ETHERNET_MAC_MACRWKPFR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_WKUPFRMFTR        \ [0x00 : 32] WKUPFRMFTR
  [then]
  ...
  [ifdef] ETHERNET_MAC_MACLCSR_DEF
    ...
    $15 constant ETHERNET_MAC_LPITCSE           \ [0x15] LPITCSE
  [then]
  ...
  [ifdef] ETHERNET_MAC_MTLOMR_DEF
    \
    \ @brief Operating mode Register
    \ Address offset: 0xC00
    \ Reset value: 0x00000000
    \
    $01 constant ETHERNET_MAC_DTXSTS            \ [0x01] DTXSTS
    $08 constant ETHERNET_MAC_CNTPRST           \ [0x08] CNTPRST
    $09 constant ETHERNET_MAC_CNTCLR            \ [0x09] CNTCLR
  [then]


  [ifdef] ETHERNET_MAC_MTLISR_DEF
    \
    \ @brief Interrupt status Register
    \ Address offset: 0xC20
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_Q0IS              \ [0x00] Queue interrupt status
  [then]


  [ifdef] ETHERNET_MAC_MTLTxQOMR_DEF
    \
    \ @brief Tx queue operating mode Register
    \ Address offset: 0xD00
    \ Reset value: 0x00070008
    \
    $00 constant ETHERNET_MAC_FTQ               \ [0x00] Flush Transmit Queue
    $01 constant ETHERNET_MAC_TSF               \ [0x01] Transmit Store and Forward
    $02 constant ETHERNET_MAC_TXQEN             \ [0x02 : 2] Transmit Queue Enable
    $04 constant ETHERNET_MAC_TTC               \ [0x04 : 3] Transmit Threshold Control
    $10 constant ETHERNET_MAC_TQS               \ [0x10 : 9] Transmit Queue Size
  [then]


  [ifdef] ETHERNET_MAC_MTLTxQUR_DEF
    \
    \ @brief Tx queue underflow register
    \ Address offset: 0xD04
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_UFFRMCNT          \ [0x00 : 11] Underflow Packet Counter
    $0b constant ETHERNET_MAC_UFCNTOVF          \ [0x0b] UFCNTOVF
  [then]


  [ifdef] ETHERNET_MAC_MTLTxQDR_DEF
    \
    \ @brief Tx queue debug Register
    \ Address offset: 0xD08
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_TXQPAUSED         \ [0x00] TXQPAUSED
    $01 constant ETHERNET_MAC_TRCSTS            \ [0x01 : 2] TRCSTS
    $03 constant ETHERNET_MAC_TWCSTS            \ [0x03] TWCSTS
    $04 constant ETHERNET_MAC_TXQSTS            \ [0x04] TXQSTS
    $05 constant ETHERNET_MAC_TXSTSFSTS         \ [0x05] TXSTSFSTS
    $10 constant ETHERNET_MAC_PTXQ              \ [0x10 : 3] PTXQ
    $14 constant ETHERNET_MAC_STXSTSF           \ [0x14 : 3] STXSTSF
  [then]


  [ifdef] ETHERNET_MAC_MTLQICSR_DEF
    \
    \ @brief Queue interrupt control status Register
    \ Address offset: 0xD2C
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_TXUNFIS           \ [0x00] TXUNFIS
    $08 constant ETHERNET_MAC_TXUIE             \ [0x08] TXUIE
    $10 constant ETHERNET_MAC_RXOVFIS           \ [0x10] RXOVFIS
    $18 constant ETHERNET_MAC_RXOIE             \ [0x18] RXOIE
  [then]


  [ifdef] ETHERNET_MAC_MTLRxQOMR_DEF
    \
    \ @brief Rx queue operating mode register
    \ Address offset: 0xD30
    \ Reset value: 0x00700000
    \
    $00 constant ETHERNET_MAC_RTC               \ [0x00 : 2] RTC
    $03 constant ETHERNET_MAC_FUP               \ [0x03] FUP
    $04 constant ETHERNET_MAC_FEP               \ [0x04] FEP
    $05 constant ETHERNET_MAC_RSF               \ [0x05] RSF
    $06 constant ETHERNET_MAC_DIS_TCP_EF        \ [0x06] DIS_TCP_EF
    $07 constant ETHERNET_MAC_EHFC              \ [0x07] EHFC
    $08 constant ETHERNET_MAC_RFA               \ [0x08 : 3] RFA
    $0e constant ETHERNET_MAC_RFD               \ [0x0e : 3] RFD
    $14 constant ETHERNET_MAC_RQS               \ [0x14 : 3] RQS
  [then]


  [ifdef] ETHERNET_MAC_MTLRxQMPOCR_DEF
    \
    \ @brief Rx queue missed packet and overflow counter register
    \ Address offset: 0xD34
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_OVFPKTCNT         \ [0x00 : 11] OVFPKTCNT
    $0b constant ETHERNET_MAC_OVFCNTOVF         \ [0x0b] OVFCNTOVF
    $10 constant ETHERNET_MAC_MISPKTCNT         \ [0x10 : 11] MISPKTCNT
    $1b constant ETHERNET_MAC_MISCNTOVF         \ [0x1b] MISCNTOVF
  [then]


  [ifdef] ETHERNET_MAC_MTLRxQDR_DEF
    \
    \ @brief Rx queue debug register
    \ Address offset: 0xD38
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_RWCSTS            \ [0x00] RWCSTS
    $01 constant ETHERNET_MAC_RRCSTS            \ [0x01 : 2] RRCSTS
    $04 constant ETHERNET_MAC_RXQSTS            \ [0x04 : 2] RXQSTS
    $10 constant ETHERNET_MAC_PRXQ              \ [0x10 : 14] PRXQ
  [then]


  [ifdef] ETHERNET_MAC_DMAMR_DEF
    \
    \ @brief DMA mode register
    \ Address offset: 0x1000
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_SWR               \ [0x00] Software Reset
    $01 constant ETHERNET_MAC_DA                \ [0x01] DMA Tx or Rx Arbitration Scheme
    $0b constant ETHERNET_MAC_TXPR              \ [0x0b] Transmit priority
    $0c constant ETHERNET_MAC_PR                \ [0x0c : 3] Priority ratio
    $10 constant ETHERNET_MAC_INTM              \ [0x10] Interrupt Mode
  [then]


  [ifdef] ETHERNET_MAC_DMASBMR_DEF
    \
    \ @brief System bus mode register
    \ Address offset: 0x1004
    \ Reset value: 0x01010000
    \
    $00 constant ETHERNET_MAC_FB                \ [0x00] Fixed Burst Length
    $0c constant ETHERNET_MAC_AAL               \ [0x0c] Address-Aligned Beats
    $0e constant ETHERNET_MAC_MB                \ [0x0e] Mixed Burst
    $0f constant ETHERNET_MAC_RB                \ [0x0f] Rebuild INCRx Burst
  [then]


  [ifdef] ETHERNET_MAC_DMAISR_DEF
    \
    \ @brief Interrupt status register
    \ Address offset: 0x1008
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_DC0IS             \ [0x00] DMA Channel Interrupt Status
    $10 constant ETHERNET_MAC_MTLIS             \ [0x10] MTL Interrupt Status
    $11 constant ETHERNET_MAC_MACIS             \ [0x11] MAC Interrupt Status
  [then]


  [ifdef] ETHERNET_MAC_DMADSR_DEF
    \
    \ @brief Debug status register
    \ Address offset: 0x100C
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_AXWHSTS           \ [0x00] AHB Master Write Channel
    $08 constant ETHERNET_MAC_RPS0              \ [0x08 : 4] DMA Channel Receive Process State
    $0c constant ETHERNET_MAC_TPS0              \ [0x0c : 4] DMA Channel Transmit Process State
  [then]


  [ifdef] ETHERNET_MAC_DMACCR_DEF
    \
    \ @brief Channel control register
    \ Address offset: 0x1100
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_MSS               \ [0x00 : 14] Maximum Segment Size
    $10 constant ETHERNET_MAC_PBLX8             \ [0x10] 8xPBL mode
    $12 constant ETHERNET_MAC_DSL               \ [0x12 : 3] Descriptor Skip Length
  [then]


  [ifdef] ETHERNET_MAC_DMACTxCR_DEF
    \
    \ @brief Channel transmit control register
    \ Address offset: 0x1104
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_ST                \ [0x00] Start or Stop Transmission Command
    $04 constant ETHERNET_MAC_OSF               \ [0x04] Operate on Second Packet
    $0c constant ETHERNET_MAC_TSE               \ [0x0c] TCP Segmentation Enabled
    $10 constant ETHERNET_MAC_TXPBL             \ [0x10 : 6] Transmit Programmable Burst Length
  [then]


  [ifdef] ETHERNET_MAC_DMACRxCR_DEF
    \
    \ @brief Channel receive control register
    \ Address offset: 0x1108
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_SR                \ [0x00] Start or Stop Receive Command
    $01 constant ETHERNET_MAC_RBSZ              \ [0x01 : 14] Receive Buffer size
    $10 constant ETHERNET_MAC_RXPBL             \ [0x10 : 6] RXPBL
    $1f constant ETHERNET_MAC_RPF               \ [0x1f] DMA Rx Channel Packet Flush
  [then]


  [ifdef] ETHERNET_MAC_DMACTxDLAR_DEF
    \
    \ @brief Channel Tx descriptor list address register
    \ Address offset: 0x1114
    \ Reset value: 0x00000000
    \
    $02 constant ETHERNET_MAC_TDESLA            \ [0x02 : 30] Start of Transmit List
  [then]


  [ifdef] ETHERNET_MAC_DMACRxDLAR_DEF
    \
    \ @brief Channel Rx descriptor list address register
    \ Address offset: 0x111C
    \ Reset value: 0x00000000
    \
    $02 constant ETHERNET_MAC_RDESLA            \ [0x02 : 30] Start of Receive List
  [then]


  [ifdef] ETHERNET_MAC_DMACTxDTPR_DEF
    \
    \ @brief Channel Tx descriptor tail pointer register
    \ Address offset: 0x1120
    \ Reset value: 0x00000000
    \
    $02 constant ETHERNET_MAC_TDT               \ [0x02 : 30] Transmit Descriptor Tail Pointer
  [then]


  [ifdef] ETHERNET_MAC_DMACRxDTPR_DEF
    \
    \ @brief Channel Rx descriptor tail pointer register
    \ Address offset: 0x1128
    \ Reset value: 0x00000000
    \
    $02 constant ETHERNET_MAC_RDT               \ [0x02 : 30] Receive Descriptor Tail Pointer
  [then]


  [ifdef] ETHERNET_MAC_DMACTxRLR_DEF
    \
    \ @brief Channel Tx descriptor ring length register
    \ Address offset: 0x112C
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_TDRL              \ [0x00 : 10] Transmit Descriptor Ring Length
  [then]


  [ifdef] ETHERNET_MAC_DMACRxRLR_DEF
    \
    \ @brief Channel Rx descriptor ring length register
    \ Address offset: 0x1130
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_RDRL              \ [0x00 : 10] Receive Descriptor Ring Length
  [then]


  [ifdef] ETHERNET_MAC_DMACIER_DEF
    \
    \ @brief Channel interrupt enable register
    \ Address offset: 0x1134
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_TIE               \ [0x00] Transmit Interrupt Enable
    $01 constant ETHERNET_MAC_TXSE              \ [0x01] Transmit Stopped Enable
    $02 constant ETHERNET_MAC_TBUE              \ [0x02] Transmit Buffer Unavailable Enable
    $06 constant ETHERNET_MAC_RIE               \ [0x06] Receive Interrupt Enable
    $07 constant ETHERNET_MAC_RBUE              \ [0x07] Receive Buffer Unavailable Enable
    $08 constant ETHERNET_MAC_RSE               \ [0x08] Receive Stopped Enable
    $09 constant ETHERNET_MAC_RWTE              \ [0x09] Receive Watchdog Timeout Enable
    $0a constant ETHERNET_MAC_ETIE              \ [0x0a] Early Transmit Interrupt Enable
    $0b constant ETHERNET_MAC_ERIE              \ [0x0b] Early Receive Interrupt Enable
    $0c constant ETHERNET_MAC_FBEE              \ [0x0c] Fatal Bus Error Enable
    $0d constant ETHERNET_MAC_CDEE              \ [0x0d] Context Descriptor Error Enable
    $0e constant ETHERNET_MAC_AIE               \ [0x0e] Abnormal Interrupt Summary Enable
    $0f constant ETHERNET_MAC_NIE               \ [0x0f] Normal Interrupt Summary Enable
  [then]


  [ifdef] ETHERNET_MAC_DMACRxIWTR_DEF
    \
    \ @brief Channel Rx interrupt watchdog timer register
    \ Address offset: 0x1138
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_RWT               \ [0x00 : 8] Receive Interrupt Watchdog Timer Count
  [then]


  [ifdef] ETHERNET_MAC_DMACCATxDR_DEF
    \
    \ @brief Channel current application transmit descriptor register
    \ Address offset: 0x1144
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_CURTDESAPTR       \ [0x00 : 32] Application Transmit Descriptor Address Pointer
  [then]


  [ifdef] ETHERNET_MAC_DMACCARxDR_DEF
    \
    \ @brief Channel current application receive descriptor register
    \ Address offset: 0x114C
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_CURRDESAPTR       \ [0x00 : 32] Application Receive Descriptor Address Pointer
  [then]


  [ifdef] ETHERNET_MAC_DMACCATxBR_DEF
    \
    \ @brief Channel current application transmit buffer register
    \ Address offset: 0x1154
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_CURTBUFAPTR       \ [0x00 : 32] Application Transmit Buffer Address Pointer
  [then]


  [ifdef] ETHERNET_MAC_DMACCARxBR_DEF
    \
    \ @brief Channel current application receive buffer register
    \ Address offset: 0x115C
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_CURRBUFAPTR       \ [0x00 : 32] Application Receive Buffer Address Pointer
  [then]


  [ifdef] ETHERNET_MAC_DMACSR_DEF
    \
    \ @brief Channel status register
    \ Address offset: 0x1160
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_TI                \ [0x00] Transmit Interrupt
    $01 constant ETHERNET_MAC_TPS               \ [0x01] Transmit Process Stopped
    $02 constant ETHERNET_MAC_TBU               \ [0x02] Transmit Buffer Unavailable
    $06 constant ETHERNET_MAC_RI                \ [0x06] Receive Interrupt
    $07 constant ETHERNET_MAC_RBU               \ [0x07] Receive Buffer Unavailable
    $08 constant ETHERNET_MAC_RPS               \ [0x08] Receive Process Stopped
    $09 constant ETHERNET_MAC_RWT               \ [0x09] Receive Watchdog Timeout
    $0a constant ETHERNET_MAC_ET                \ [0x0a] Early Transmit Interrupt
    $0b constant ETHERNET_MAC_ER                \ [0x0b] Early Receive Interrupt
    $0c constant ETHERNET_MAC_FBE               \ [0x0c] Fatal Bus Error
    $0d constant ETHERNET_MAC_CDE               \ [0x0d] Context Descriptor Error
    $0e constant ETHERNET_MAC_AIS               \ [0x0e] Abnormal Interrupt Summary
    $0f constant ETHERNET_MAC_NIS               \ [0x0f] Normal Interrupt Summary
    $10 constant ETHERNET_MAC_TEB               \ [0x10 : 3] Tx DMA Error Bits
    $13 constant ETHERNET_MAC_REB               \ [0x13 : 3] Rx DMA Error Bits
  [then]


  [ifdef] ETHERNET_MAC_DMACMFCR_DEF
    \
    \ @brief Channel missed frame count register
    \ Address offset: 0x116C
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_MFC               \ [0x00 : 11] Dropped Packet Counters
    $0f constant ETHERNET_MAC_MFCO              \ [0x0f] Overflow status of the MFC Counter
  [then]
  ...
  $C00 constant ETHERNET_MAC_MTLOMR     \ Operating mode Register
  $C20 constant ETHERNET_MAC_MTLISR     \ Interrupt status Register
  $D00 constant ETHERNET_MAC_MTLTXQOMR  \ Tx queue operating mode Register
  $D04 constant ETHERNET_MAC_MTLTXQUR   \ Tx queue underflow register
  $D08 constant ETHERNET_MAC_MTLTXQDR   \ Tx queue debug Register
  $D2C constant ETHERNET_MAC_MTLQICSR   \ Queue interrupt control status Register
  $D30 constant ETHERNET_MAC_MTLRXQOMR  \ Rx queue operating mode register
  $D34 constant ETHERNET_MAC_MTLRXQMPOCR    \ Rx queue missed packet and overflow counter register
  $D38 constant ETHERNET_MAC_MTLRXQDR   \ Rx queue debug register
  $1000 constant ETHERNET_MAC_DMAMR     \ DMA mode register
  $1004 constant ETHERNET_MAC_DMASBMR   \ System bus mode register
  $1008 constant ETHERNET_MAC_DMAISR    \ Interrupt status register
  $100C constant ETHERNET_MAC_DMADSR    \ Debug status register
  $1100 constant ETHERNET_MAC_DMACCR    \ Channel control register
  $1104 constant ETHERNET_MAC_DMACTXCR  \ Channel transmit control register
  $1108 constant ETHERNET_MAC_DMACRXCR  \ Channel receive control register
  $1114 constant ETHERNET_MAC_DMACTXDLAR    \ Channel Tx descriptor list address register
  $111C constant ETHERNET_MAC_DMACRXDLAR    \ Channel Rx descriptor list address register
  $1120 constant ETHERNET_MAC_DMACTXDTPR    \ Channel Tx descriptor tail pointer register
  $1128 constant ETHERNET_MAC_DMACRXDTPR    \ Channel Rx descriptor tail pointer register
  $112C constant ETHERNET_MAC_DMACTXRLR \ Channel Tx descriptor ring length register
  $1130 constant ETHERNET_MAC_DMACRXRLR \ Channel Rx descriptor ring length register
  $1134 constant ETHERNET_MAC_DMACIER   \ Channel interrupt enable register
  $1138 constant ETHERNET_MAC_DMACRXIWTR    \ Channel Rx interrupt watchdog timer register
  $1144 constant ETHERNET_MAC_DMACCATXDR    \ Channel current application transmit descriptor register
  $114C constant ETHERNET_MAC_DMACCARXDR    \ Channel current application receive descriptor register
  $1154 constant ETHERNET_MAC_DMACCATXBR    \ Channel current application transmit buffer register
  $115C constant ETHERNET_MAC_DMACCARXBR    \ Channel current application receive buffer register
  $1160 constant ETHERNET_MAC_DMACSR    \ Channel status register
  $116C constant ETHERNET_MAC_DMACMFCR  \ Channel missed frame count register
