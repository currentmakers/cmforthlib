...
[ifndef] ADC_DEF
  ...
  [ifdef] ADC_CFGR1_DEF
    ...
    $1a constant ADC_AWDCH                      \ [0x1a : 5] AWD1CH
  [then]
  ...
  [ifdef] ADC_CFGR2_DEF
    ...
    $02 constant ADC_OVSR                       \ [0x02 : 3] OVSR
  ...
  [ifdef] ADC_SMPR_DEF
    ...
    $08 constant ADC_SMPSEL                     \ [0x08 : 19] SMPSEL
  [then]
  ...
  [ifdef] ADC_CHSELR0_DEF
    \
    \ @brief channel selection register
    \ Address offset: 0x28
    \ Reset value: 0x00000000
    \
    $00 constant ADC_CHSEL                      \ [0x00 : 19] CHSEL
  [then]


  [ifdef] ADC_CHSELR1_DEF
    \
    \ @brief channel selection register
    \ Address offset: 0x28
    \ Reset value: 0x00000000
  ...
  [ifdef] ADC_AWD2CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_AWD2CH                     \ [0x00 : 19] AWD2CH
  [then]
  ...
  [ifdef] ADC_AWD3CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_AWD3CH                     \ [0x00 : 19] AWD3CH
  [then]
  ...
  [ifdef] ADC_CCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $12 constant ADC_PRESC                      \ [0x12 : 4] PRESC
  ...
  $0C constant ADC_CFGR1                \ ADC configuration register 1
  $10 constant ADC_CFGR2                \ ADC configuration register 2
  $14 constant ADC_SMPR                 \ ADC sampling time register
  $20 constant ADC_AWD1TR               \ ADC watchdog threshold register
  $24 constant ADC_AWD2TR               \ ADC watchdog threshold register
  $28 constant ADC_CHSELR0              \ channel selection register
  $28 constant ADC_CHSELR1              \ channel selection register
  $2C constant ADC_AWD3TR               \ ADC watchdog threshold register
  $40 constant ADC_DR                   \ ADC data register
  ...
  $B4 constant ADC_CALFACT              \ ADC Calibration factor
  $308 constant ADC_CCR                 \ ADC common configuration register
