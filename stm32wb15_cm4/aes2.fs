...
[ifndef] AES2_DEF
  ...
  [ifdef] AES2_DOUTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_AES_DOUT                  \ [0x00 : 32] Data output register
  [then]
  ...
  [ifdef] AES2_KEYR0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] Data Output Register (LSB key [31:0])
  [then]
  ...
  [ifdef] AES2_KEYR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (key [63:32])
  [then]
  ...
  [ifdef] AES2_KEYR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (key [95:64])
  [then]
  ...
  [ifdef] AES2_KEYR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (MSB key [127:96])
  [then]
  ...
  [ifdef] AES2_IVR0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_IVI                       \ [0x00 : 32] initialization vector register (LSB IVR [31:0])
  [then]
  ...
  [ifdef] AES2_IVR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_IVI                       \ [0x00 : 32] Initialization Vector Register (IVR [63:32])
  [then]
  ...
  [ifdef] AES2_IVR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_IVI                       \ [0x00 : 32] Initialization Vector Register (IVR [95:64])
  [then]
  ...
  [ifdef] AES2_IVR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_IVI                       \ [0x00 : 32] Initialization Vector Register (MSB IVR [127:96])
  [then]
  ...
  [ifdef] AES2_KEYR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (MSB key [159:128])
  [then]
  ...
  [ifdef] AES2_KEYR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (MSB key [191:160])
  [then]
  ...
  [ifdef] AES2_KEYR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (MSB key [223:192])
  [then]
  ...
  [ifdef] AES2_KEYR7_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_KEY                       \ [0x00 : 32] AES key register (MSB key [255:224])
  [then]
  ...
  [ifdef] AES2_SUSP0R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP0                     \ [0x00 : 32] AES suspend register 0
  [then]
  ...
  [ifdef] AES2_SUSP1R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP1                     \ [0x00 : 32] AES suspend register 1
  [then]
  ...
  [ifdef] AES2_SUSP2R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP2                     \ [0x00 : 32] AES suspend register 2
  [then]
  ...
  [ifdef] AES2_SUSP3R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP3                     \ [0x00 : 32] AES suspend register 3
  [then]
  ...
  [ifdef] AES2_SUSP4R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP4                     \ [0x00 : 32] AES suspend register 4
  [then]
  ...
  [ifdef] AES2_SUSP5R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP5                     \ [0x00 : 32] AES suspend register 5
  [then]
  ...
  [ifdef] AES2_SUSP6R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP6                     \ [0x00 : 32] AES suspend register 6
  [then]
  ...
  [ifdef] AES2_SUSP7R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES2_SUSP7                     \ [0x00 : 32] AES suspend register 7
  [then]
