...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_CR3_DEF
    ...
    $0b constant PWR_ECRPE                      \ [0x0b] Enable critical radio phase end of activity interrupt for CPU1
    $0c constant PWR_EBLEA                      \ [0x0c] Enable BLE end of activity interrupt for CPU1
  ...
  [ifdef] PWR_SR1_DEF
    ...
    $07 constant PWR_SMPSFBF                    \ [0x07] Step Down converter forced in Bypass interrupt flag
  ...
  [ifdef] PWR_SR2_DEF
    ...
    \
    $00 constant PWR_SMPSBF                     \ [0x00] Step Down converter Bypass mode flag
    $01 constant PWR_SMPSF                      \ [0x01] Step Down converter SMPS mode flag
  ...
  [ifdef] PWR_CR5_DEF
    ...
    \
    $00 constant PWR_SMPSVOS                    \ [0x00 : 4] Step Down converter voltage output scaling
    $04 constant PWR_SMPSSC                     \ [0x04 : 3] Step Down converter supplt startup current selection
    $08 constant PWR_BORHC                      \ [0x08] BORH configuration selection
    $0f constant PWR_SMPSEN                     \ [0x0f] Enable Step Down converter SMPS mode enabled
  [then]
