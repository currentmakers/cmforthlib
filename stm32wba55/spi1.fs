...
$00000200 constant SPI1_SPI_CFG1_UDRCFG                             \ behavior of slave transmitter at underrun condition For more details see Figure977: Optional configurations of slave detecting underrun condition.
...
$70000000 constant SPI1_SPI_CFG1_MBR                                \ master baud rate prescaler setting Note: MBR setting is considered at slave working at TI mode, too (see Section80.5.1: TI mode).
...
$00800000 constant SPI1_SPI_CFG2_LSBFRST                            \ data frame format Note: 1: LSB transmitted first
...
$00000200 constant SPI1_SPI_SR_MODF                                 \ mode fault This bit is cleared by writing 1 to MODFC bit of SPI_IFCR exclusively.
...
$ffff0000 constant SPI1_SPI_SR_CTSIZE                               \ number of data frames remaining in current TSIZE session The value is not quite reliable when traffic is ongoing on bus or during autonomous operation in low-power mode. Note: CTSIZE[15:0] bits are not available in instances with limited set of features.
...
$000f0000 constant SPI1_SPI_AUTOCR_TRIGSEL                          \ trigger selection (refer Section: Description of SPI interconnections). ... Note: these bits can be written only when SPE=0.
$00100000 constant SPI1_SPI_AUTOCR_TRIGPOL                          \ trigger polarity Note: This bit can be written only when SPE=0.
$00200000 constant SPI1_SPI_AUTOCR_TRIGEN                           \ HW control of CSTART triggering enable Note: if user cannot prevent trigger event during write, the TRIGEN must be changed when SPI is disabled
...
$40013010 constant SPI1_SPI_IER   \ offset: 0x10 : SPI interrupt enable register
$40013014 constant SPI1_SPI_SR    \ offset: 0x14 : SPI status register
$40013018 constant SPI1_SPI_IFCR  \ offset: 0x18 : SPI interrupt/status flags clear register
$4001301c constant SPI1_SPI_AUTOCR  \ offset: 0x1C : SPI autonomous mode control register
$40013020 constant SPI1_SPI_TXDR  \ offset: 0x20 : SPI transmit data register
$40013030 constant SPI1_SPI_RXDR  \ offset: 0x30 : SPI receive data register
$40013040 constant SPI1_SPI_CRCPOLY  \ offset: 0x40 : SPI polynomial register
$40013044 constant SPI1_SPI_TXCRC  \ offset: 0x44 : SPI transmitter CRC register
$40013048 constant SPI1_SPI_RXCRC  \ offset: 0x48 : SPI receiver CRC register
