...
$000000ff constant ICACHE_ICACHE_CRR0_BASEADDR                      \ base address for region x This alias address is replaced by REMAPADDR field. The only useful bits are [28:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
$00000e00 constant ICACHE_ICACHE_CRR0_RSIZE                         \ size for region x
$00008000 constant ICACHE_ICACHE_CRR0_REN                           \ enable for region x
$07ff0000 constant ICACHE_ICACHE_CRR0_REMAPADDR                     \ remapped address for region x This field replaces the alias address defined by BASEADDR field. The only useful bits are [31:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
...
$000000ff constant ICACHE_ICACHE_CRR1_BASEADDR                      \ base address for region x This alias address is replaced by REMAPADDR field. The only useful bits are [28:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
...
$000000ff constant ICACHE_ICACHE_CRR2_BASEADDR                      \ base address for region x This alias address is replaced by REMAPADDR field. The only useful bits are [28:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
$00000e00 constant ICACHE_ICACHE_CRR2_RSIZE                         \ size for region x
$00008000 constant ICACHE_ICACHE_CRR2_REN                           \ enable for region x
$07ff0000 constant ICACHE_ICACHE_CRR2_REMAPADDR                     \ remapped address for region x This field replaces the alias address defined by BASEADDR field. The only useful bits are [31:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
...
$000000ff constant ICACHE_ICACHE_CRR3_BASEADDR                      \ base address for region x This alias address is replaced by REMAPADDR field. The only useful bits are [28:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
$00000e00 constant ICACHE_ICACHE_CRR3_RSIZE                         \ size for region x
$00008000 constant ICACHE_ICACHE_CRR3_REN                           \ enable for region x
$07ff0000 constant ICACHE_ICACHE_CRR3_REMAPADDR                     \ remapped address for region x This field replaces the alias address defined by BASEADDR field. The only useful bits are [31:RI], where 21 less than or equal RI less than or equal 27 is the number of bits of RSIZE (see Section 18.4.7). If the programmed value has more LSBs, the useless bits are ignored.
