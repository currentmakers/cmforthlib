...
$00000100 constant IWDG_IWDG_SR_ONF                                 \ Watchdog enable status bit Set to '1' by hardware as soon as the IWDG is started, remains to '1' until the IWDG is reset.
