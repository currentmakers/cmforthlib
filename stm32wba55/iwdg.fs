...
[ifndef] IWDG_DEF
  ...
  [ifdef] IWDG_IWDG_SR_DEF
    ...
    $08 constant IWDG_ONF                       \ [0x08] Watchdog enable status bit Set to '1' by hardware as soon as the IWDG is started, remains to '1' until the IWDG is reset.
