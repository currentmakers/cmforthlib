...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_TIM1_CR1_DEF
    ...
    $08 constant TIM1_CKD                       \ [0x08 : 2] Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (tsubDTS/sub)used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),
  ...
  [ifdef] TIM1_TIM1_ECR_DEF
    ...
    $10 constant TIM1_PW                        \ [0x10 : 8] Pulse width This bitfield defines the pulse duration, as following: tsubPW/sub = PW[7:0] x tsubPWG/sub
    $18 constant TIM1_PWPRSC                    \ [0x18 : 3] Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tsubPWG/sub = (2sup(PWPRSC[2:0])/sup) x tsubtim_ker_ck/sub
  [then]
  ...
  [ifdef] TIM1_TIM1_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_TI1SEL                    \ [0x00 : 4] Selects tim_ti1[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    $08 constant TIM1_TI2SEL                    \ [0x08 : 4] Selects tim_ti2[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    $10 constant TIM1_TI3SEL                    \ [0x10 : 4] Selects tim_ti3[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
    $18 constant TIM1_TI4SEL                    \ [0x18 : 4] Selects tim_ti4[15:0] input ... Refer to Section 28.3.2: TIM1 pins and internal signals for interconnects list.
  [then]
  ...
  [ifdef] TIM1_TIM1_AF1_DEF
    ...
    $0e constant TIM1_ETRSEL                    \ [0x0e : 4] etr_in source selection These bits select the etr_in input source. ... Refer to Section 28.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]
  ...
  $18 constant TIM1_TIM1_CCMR1          \ TIM1 capture/compare mode register 1 [alternate]
  $18 constant TIM1_TIM1_CCMR1_ALTERNATE1    \ TIM1 capture/compare mode register 1 [alternate]
  $1C constant TIM1_TIM1_CCMR2          \ TIM1 capture/compare mode register 2 [alternate]
  $1C constant TIM1_TIM1_CCMR2_ALTERNATE1    \ TIM1 capture/compare mode register 2 [alternate]
