...
$00000020 constant LPTIM1_LPTIM_ICR_OUTPUT_UPCF                     \ Direction change to UP clear flag Writing 1 to this bit clear the UP flag in the LPTIM_ISR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
$00000040 constant LPTIM1_LPTIM_ICR_OUTPUT_DOWNCF                   \ Direction change to down clear flag Writing 1 to this bit clear the DOWN flag in the LPTIM_ISR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
...
$00000200 constant LPTIM1_LPTIM_ICR_OUTPUT_CC2CF                    \ Capture/compare 2 clear flag Writing 1 to this bit clears the CC2IF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
$00080000 constant LPTIM1_LPTIM_ICR_OUTPUT_CMP2OKCF                 \ Compare register 2 update OK clear flag Writing 1 to this bit clears the CMP2OK flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
...
$00000020 constant LPTIM1_LPTIM_ICR_INTPUT_UPCF                     \ Direction change to UP clear flag Writing 1 to this bit clear the UP flag in the LPTIM_ISR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
$00000040 constant LPTIM1_LPTIM_ICR_INTPUT_DOWNCF                   \ Direction change to down clear flag Writing 1 to this bit clear the DOWN flag in the LPTIM_ISR register. Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
...
$00000200 constant LPTIM1_LPTIM_ICR_INTPUT_CC2CF                    \ Capture/compare 2 clear flag Writing 1 to this bit clears the CC2IF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
$00001000 constant LPTIM1_LPTIM_ICR_INTPUT_CC1OCF                   \ Capture/compare 1 over-capture clear flag Writing 1 to this bit clears the CC1OF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section69.3.
$00002000 constant LPTIM1_LPTIM_ICR_INTPUT_CC2OCF                   \ Capture/compare 2 over-capture clear flag Writing 1 to this bit clears the CC2OF flag in the LPTIM_ISR register. Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
...
$00000020 constant LPTIM1_LPTIM_DIER_OUTPUT_UPIE                    \ Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
$00000040 constant LPTIM1_LPTIM_DIER_OUTPUT_DOWNIE                  \ Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
...
$00000200 constant LPTIM1_LPTIM_DIER_OUTPUT_CC2IE                   \ Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
$00080000 constant LPTIM1_LPTIM_DIER_OUTPUT_CMP2OKIE                \ Compare register 2 update OK interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
$00800000 constant LPTIM1_LPTIM_DIER_OUTPUT_UEDE                    \ Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section69.3.
...
$00000020 constant LPTIM1_LPTIM_DIER_INTPUT_UPIE                    \ Direction change to UP Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
$00000040 constant LPTIM1_LPTIM_DIER_INTPUT_DOWNIE                  \ Direction change to down Interrupt Enable Note: If the LPTIM does not support encoder mode feature, this bit is reserved. Refer to Section69.3.
...
$00000200 constant LPTIM1_LPTIM_DIER_INTPUT_CC2IE                   \ Capture/compare 2 interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
$00001000 constant LPTIM1_LPTIM_DIER_INTPUT_CC1OIE                  \ Capture/compare 1 over-capture interrupt enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section69.3.
$00002000 constant LPTIM1_LPTIM_DIER_INTPUT_CC2OIE                  \ Capture/compare 2 over-capture interrupt enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.
$00010000 constant LPTIM1_LPTIM_DIER_INTPUT_CC1DE                   \ Capture/compare 1 DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section69.3.
$00800000 constant LPTIM1_LPTIM_DIER_INTPUT_UEDE                    \ Update event DMA request enable Note: If LPTIM does not implement at least 1 channel this bit is reserved. Refer to Section69.3.
$02000000 constant LPTIM1_LPTIM_DIER_INTPUT_CC2DE                   \ Capture/compare 2 DMA request enable Note: If LPTIM does not implement at least 2 channels this bit is reserved. Refer to Section69.3.


\
\ @brief Low power timer
\
$46004400 constant LPTIM1_LPTIM_ISR_OUTPUT  \ offset: 0x00 : LPTIM interrupt and status register [alternate]
$46004400 constant LPTIM1_LPTIM_ISR_INTPUT  \ offset: 0x00 : Interrupt and Status Register (intput mode)
$46004404 constant LPTIM1_LPTIM_ICR_OUTPUT  \ offset: 0x04 : LPTIM interrupt clear register [alternate]
$46004404 constant LPTIM1_LPTIM_ICR_INTPUT  \ offset: 0x04 : Interrupt Clear Register (intput mode)
$46004408 constant LPTIM1_LPTIM_DIER_OUTPUT  \ offset: 0x08 : LPTIM interrupt enable register [alternate]
$46004408 constant LPTIM1_LPTIM_DIER_INTPUT  \ offset: 0x08 : LPTIM interrupt Enable Register (intput mode)
