...
[ifndef] ADC12_COMMON_DEF
  ...
  [ifdef] ADC12_COMMON_CSR_DEF
    ...
    \
    $00 constant ADC12_COMMON_ADDRDY_MST        \ [0x00] ADDRDY_MST
    $01 constant ADC12_COMMON_EOSMP_MST         \ [0x01] EOSMP_MST
    $02 constant ADC12_COMMON_EOC_MST           \ [0x02] EOC_MST
    $03 constant ADC12_COMMON_EOS_MST           \ [0x03] EOS_MST
    $04 constant ADC12_COMMON_OVR_MST           \ [0x04] OVR_MST
    $05 constant ADC12_COMMON_JEOC_MST          \ [0x05] JEOC_MST
    $06 constant ADC12_COMMON_JEOS_MST          \ [0x06] JEOS_MST
    $07 constant ADC12_COMMON_AWD1_MST          \ [0x07] AWD1_MST
    $08 constant ADC12_COMMON_AWD2_MST          \ [0x08] AWD2_MST
    $09 constant ADC12_COMMON_AWD3_MST          \ [0x09] AWD3_MST
    $0a constant ADC12_COMMON_JQOVF_MST         \ [0x0a] JQOVF_MST
    $10 constant ADC12_COMMON_ADRDY_SLV         \ [0x10] ADRDY_SLV
    $11 constant ADC12_COMMON_EOSMP_SLV         \ [0x11] EOSMP_SLV
  ...
  [ifdef] ADC12_COMMON_CCR_DEF
    ...
    $0d constant ADC12_COMMON_DMACFG            \ [0x0d] DMA configuration (for multi-ADC mode)
    $0e constant ADC12_COMMON_MDMA              \ [0x0e : 2] Direct memory access mode for multi ADC mode
    ...
    $17 constant ADC12_COMMON_VSENSESEL         \ [0x17] VTS selection
    $18 constant ADC12_COMMON_VBATSEL           \ [0x18] VBAT selection
  [then]
