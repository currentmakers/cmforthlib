...
[ifndef] DMAMUX_DEF
  ...
  [ifdef] DMAMUX_C0CR_DEF
    ...
    \
    $00 constant DMAMUX_DMAREQ_ID               \ [0x00 : 7] Input DMA request line selected
  ...
  [ifdef] DMAMUX_CSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DMAMUX_SOF                     \ [0x00 : 16] Synchronization overrun event flag
  [then]
  ...
  [ifdef] DMAMUX_CFR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DMAMUX_CSOF                    \ [0x00 : 16] Clear synchronization overrun event flag
  [then]
  ...
  $1C constant DMAMUX_C7CR              \ DMAMux - DMA request line multiplexer channel x control register
  $20 constant DMAMUX_C8CR              \ DMAMux - DMA request line multiplexer channel x control register
  $24 constant DMAMUX_C9CR              \ DMAMux - DMA request line multiplexer channel x control register
  $28 constant DMAMUX_C10CR             \ DMAMux - DMA request line multiplexer channel x control register
  $2C constant DMAMUX_C11CR             \ DMAMux - DMA request line multiplexer channel x control register
  $30 constant DMAMUX_C12CR             \ DMAMux - DMA request line multiplexer channel x control register
  $34 constant DMAMUX_C13CR             \ DMAMux - DMA request line multiplexer channel x control register
  $38 constant DMAMUX_C14CR             \ DMAMux - DMA request line multiplexer channel x control register
  $3C constant DMAMUX_C15CR             \ DMAMux - DMA request line multiplexer channel x control register
  $80 constant DMAMUX_CSR               \ DMAMUX request line multiplexer interrupt channel status register
  $84 constant DMAMUX_CFR               \ DMAMUX request line multiplexer interrupt clear flag register
