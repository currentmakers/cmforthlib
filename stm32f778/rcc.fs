...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    $01 constant RCC_QSPIRST                    \ [0x01] Quad SPI memory controller reset
  [then]
  ...
  [ifdef] RCC_APB1RSTR_DEF
    ...
    $09 constant RCC_LPTIM1RST                  \ [0x09] Low power timer 1 reset
    $0b constant RCC_WWDGRST                    \ [0x0b] Window watchdog reset
    $0d constant RCC_CAN3RST                    \ [0x0d] CAN 3 reset
    $0e constant RCC_SPI2RST                    \ [0x0e] SPI 2 reset
    $0f constant RCC_SPI3RST                    \ [0x0f] SPI 3 reset
    $10 constant RCC_SPDIFRXRST                 \ [0x10] SPDIF-RX reset
    ...
    $18 constant RCC_I2C4RST                    \ [0x18] I2C 4 reset
    $19 constant RCC_CAN1RST                    \ [0x19] CAN1 reset
    $1a constant RCC_CAN2RST                    \ [0x1a] CAN2 reset
    $1b constant RCC_CECRST                     \ [0x1b] HDMI-CEC reset
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $0b constant RCC_SDMMC1RST                  \ [0x0b] SDMMC1 reset
  ...
  [ifdef] RCC_AHB3ENR_DEF
    ...
    $01 constant RCC_QSPIEN                     \ [0x01] Quad SPI memory controller clock enable
  [then]
  ...
  [ifdef] RCC_APB1ENR_DEF
    ...
    $09 constant RCC_LPTMI1EN                   \ [0x09] Low power timer 1 clock enable
    $0a constant RCC_RTCAPBEN                   \ [0x0a] RTC register interface clock enable
    $0b constant RCC_WWDGEN                     \ [0x0b] Window watchdog clock enable
    $0d constant RCC_CAN3EN                     \ [0x0d] CAN 3 clock enable
    $0e constant RCC_SPI2EN                     \ [0x0e] SPI2 clock enable
    $0f constant RCC_SPI3EN                     \ [0x0f] SPI3 clock enable
    $10 constant RCC_SPDIFRXEN                  \ [0x10] SPDIF-RX clock enable
    ...
    $18 constant RCC_I2C4EN                     \ [0x18] I2C4 clock enable
    $19 constant RCC_CAN1EN                     \ [0x19] CAN 1 clock enable
    $1a constant RCC_CAN2EN                     \ [0x1a] CAN 2 clock enable
    $1b constant RCC_CECEN                      \ [0x1b] HDMI-CEN clock enable
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $0b constant RCC_SDMMC1EN                   \ [0x0b] SDMMC1 clock enable
  ...
  [ifdef] RCC_AHB3LPENR_DEF
    ...
    $01 constant RCC_QSPILPEN                   \ [0x01] Quand SPI memory controller clock enable during Sleep mode
  [then]
  ...
  [ifdef] RCC_APB1LPENR_DEF
    ...
    $09 constant RCC_LPTIM1LPEN                 \ [0x09] low power timer 1 clock enable during Sleep mode
    ...
    $10 constant RCC_SPDIFRXLPEN                \ [0x10] SPDIF-RX clock enable during sleep mode
    ...
    $18 constant RCC_I2C4LPEN                   \ [0x18] I2C4 clock enable during Sleep mode
    ...
    $1b constant RCC_CECLPEN                    \ [0x1b] HDMI-CEN clock enable during Sleep mode
  ...
  [ifdef] RCC_APB2LPENR_DEF
    ...
    $0b constant RCC_SDMMC1LPEN                 \ [0x0b] SDMMC1 clock enable during Sleep mode
    ...
    $16 constant RCC_SAI1LPEN                   \ [0x16] SAI1 clock enable during sleep mode
    $17 constant RCC_SAI2LPEN                   \ [0x17] SAI2 clock enable during sleep mode
    $1a constant RCC_LTDCLPEN                   \ [0x1a] LTDC clock enable during sleep mode
  [then]
  ...
  [ifdef] RCC_PLLSAICFGR_DEF
    ...
    $10 constant RCC_PLLSAIP                    \ [0x10 : 2] PLLSAI division factor for 48MHz clock
    $18 constant RCC_PLLSAIQ                    \ [0x18 : 4] PLLSAI division factor for SAI clock
    $1c constant RCC_PLLSAIR                    \ [0x1c : 3] PLLSAI division factor for LCD clock
  [then]


  [ifdef] RCC_DKCFGR1_DEF
    \
    \ @brief dedicated clocks configuration register
    \ Address offset: 0x8C
    \ Reset value: 0x20003000
    \
    $00 constant RCC_PLLI2SDIV                  \ [0x00 : 5] PLLI2S division factor for SAI1 clock
    $08 constant RCC_PLLSAIDIVQ                 \ [0x08 : 5] PLLSAI division factor for SAI1 clock
    $10 constant RCC_PLLSAIDIVR                 \ [0x10 : 2] division factor for LCD_CLK
    $14 constant RCC_SAI1SEL                    \ [0x14 : 2] SAI1 clock source selection
    $16 constant RCC_SAI2SEL                    \ [0x16 : 2] SAI2 clock source selection
    $18 constant RCC_TIMPRE                     \ [0x18] Timers clocks prescalers selection
  [then]


  [ifdef] RCC_DKCFGR2_DEF
    \
    \ @brief dedicated clocks configuration register
    \ Address offset: 0x90
    \ Reset value: 0x20003000
    \
    $00 constant RCC_USART1SEL                  \ [0x00 : 2] USART 1 clock source selection
    $02 constant RCC_USART2SEL                  \ [0x02 : 2] USART 2 clock source selection
    $04 constant RCC_USART3SEL                  \ [0x04 : 2] USART 3 clock source selection
    $06 constant RCC_UART4SEL                   \ [0x06 : 2] UART 4 clock source selection
    $08 constant RCC_UART5SEL                   \ [0x08 : 2] UART 5 clock source selection
    $0a constant RCC_USART6SEL                  \ [0x0a : 2] USART 6 clock source selection
    $0c constant RCC_UART7SEL                   \ [0x0c : 2] UART 7 clock source selection
    $0e constant RCC_UART8SEL                   \ [0x0e : 2] UART 8 clock source selection
    $10 constant RCC_I2C1SEL                    \ [0x10 : 2] I2C1 clock source selection
    $12 constant RCC_I2C2SEL                    \ [0x12 : 2] I2C2 clock source selection
    $14 constant RCC_I2C3SEL                    \ [0x14 : 2] I2C3 clock source selection
    $16 constant RCC_I2C4SEL                    \ [0x16 : 2] I2C4 clock source selection
    $18 constant RCC_LPTIM1SEL                  \ [0x18 : 2] Low power timer 1 clock source selection
    $1a constant RCC_CECSEL                     \ [0x1a] HDMI-CEC clock source selection
    $1b constant RCC_CK48MSEL                   \ [0x1b] 48MHz clock source selection
    $1c constant RCC_SDMMC1SEL                  \ [0x1c] SDMMC1 clock source selection
    $1d constant RCC_SDMMC2SEL                  \ [0x1d] SDMMC2 clock source selection
    $1e constant RCC_DSISEL                     \ [0x1e] DSI clock source selection
  [then]
  ...
  $8C constant RCC_DKCFGR1              \ dedicated clocks configuration register
  $90 constant RCC_DKCFGR2              \ dedicated clocks configuration register
