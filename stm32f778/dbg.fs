...
[ifndef] DBG_DEF
  ...
  [ifdef] DBG_DBGMCU_CR_DEF
    ...
    $05 constant DBG_TRACE_CLKINEN              \ [0x05] TRACE_CLKINEN
  ...
  [ifdef] DBG_DBGMCU_APB1_FZ_DEF
    ...
    $09 constant DBG_DBG_LPTIM1_STOP            \ [0x09] DBG_LPTIM1_STOP
    ...
    $0d constant DBG_DBG_CAN3_STOP              \ [0x0d] DBG_CAN3_STOP
    ...
    $18 constant DBG_DBG_I2C4_SMBUS_TIMEOUT     \ [0x18] DBG_I2C4_SMBUS_TIMEOUT
