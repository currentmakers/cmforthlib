...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_CR1_DEF
    ...
    $0b constant TIM2_UIFREMAP                  \ [0x0b : 2] UIF status bit remapping
  [then]
  ...
  [ifdef] TIM2_CNT_DEF
    ...
    $1f constant TIM2_CNT_or_UIFCPY             \ [0x1f] CNT_or_UIFCPY
  [then]
  ...
  [ifdef] TIM2_CCR1_DEF
    ...
    $10 constant TIM2_CCR1H                     \ [0x10 : 16] High Capture/Compare 1 value
  [then]
  ...
  [ifdef] TIM2_CCR2_DEF
    ...
    $10 constant TIM2_CCR2H                     \ [0x10 : 16] High Capture/Compare 2 value
  [then]
  ...
  [ifdef] TIM2_CCR3_DEF
    ...
    $10 constant TIM2_CCR3H                     \ [0x10 : 16] High Capture/Compare value
  [then]
  ...
  [ifdef] TIM2_CCR4_DEF
    ...
    $10 constant TIM2_CCR4H                     \ [0x10 : 16] High Capture/Compare value
  [then]
