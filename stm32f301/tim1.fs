...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_CCMR1_Output_DEF
    ...
    $10 constant TIM1_OC1M_3                    \ [0x10] Output Compare 1 mode -bit3
    $18 constant TIM1_OC2M_3                    \ [0x18] Output Compare 2 mode -bit3
  [then]
  ...
  [ifdef] TIM1_CCMR2_Output_DEF
    ...
    $10 constant TIM1_OC3M_3                    \ [0x10] Output Compare 3 mode -bit3
    $18 constant TIM1_OC4M_3                    \ [0x18] Output Compare 4 mode -bit3
  [then]
  ...
  [ifdef] TIM1_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_IM1_ETR_ADC1_RMP          \ [0x00 : 2] TIM1_ETR_ADC1 remapping capability
  [then]
  ...
  $50 constant TIM1_OR                  \ Option registers
