...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_CCMR1_Output_DEF
    ...
    $10 constant TIM16_OC1M_3                   \ [0x10] Output Compare 1 mode -bit3
  [then]
  ...
  [ifdef] TIM16_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1_RMP                  \ [0x00 : 2] Timer 16 input 1 connection
  [then]
  ...
  $50 constant TIM16_OR                 \ Option registers
