...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CFGR_DEF
    ...
    $1f constant RCC_PLLNODIV                   \ [0x1f] Do not divide PLL to MCO
  [then]
  ...
  [ifdef] RCC_AHBENR_DEF
    ...
    $1c constant RCC_ADC1EN                     \ [0x1c] ADC 1
  [then]
  ...
  [ifdef] RCC_AHBRSTR_DEF
    ...
    $1c constant RCC_ADC1RST                    \ [0x1c] ADC1 reset
  [then]
  ...
  [ifdef] RCC_CFGR2_DEF
    ...
    $04 constant RCC_ADC1PRES                   \ [0x04 : 4] ADC1 prescaler
  [then]
  ...
  [ifdef] RCC_CFGR3_DEF
    ...
    $0a constant RCC_TIM15SW                    \ [0x0a] Timer15 clock source selection
    $0b constant RCC_TIM16SW                    \ [0x0b] Timer16 clock source selection
    $0d constant RCC_TIM17SW                    \ [0x0d : 2] Timer17 clock source selection
  [then]
