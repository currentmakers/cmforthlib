...
[ifndef] I2C_DEF
  ...
  [ifdef] I2C_CR1_DEF
    ...
    $0d constant I2C_SWRST                      \ [0x0d] Software reset
  ...
  [ifdef] I2C_CR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant I2C_SADD0                      \ [0x00] Slave address bit 0 (master mode)
    $01 constant I2C_SADD1                      \ [0x01 : 7] Slave address bit 7:1 (master mode)
    $08 constant I2C_SADD8                      \ [0x08 : 2] Slave address bit 9:8 (master mode)
  ...
  [ifdef] I2C_OAR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant I2C_OA1_0                      \ [0x00] Interface address
    $01 constant I2C_OA1_1                      \ [0x01 : 7] Interface address
    $08 constant I2C_OA1_8                      \ [0x08 : 2] Interface address
