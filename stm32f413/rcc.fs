...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_AHB2RSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $04 constant RCC_CRYPRST                    \ [0x04] CRYP module reset
  ...
  [ifdef] RCC_APB1RSTR_DEF
    ...
    $09 constant RCC_LPTIMER1RST                \ [0x09] LPTimer1 reset
    ...
    $1b constant RCC_CAN3RST                    \ [0x1b] CAN 3 reset
    $1c constant RCC_PWRRST                     \ [0x1c] Power interface reset
    $1d constant RCC_DACRST                     \ [0x1d] DAC reset
    $1e constant RCC_UART7RST                   \ [0x1e] UART 7 reset
    $1f constant RCC_UART8RST                   \ [0x1f] UART 8 reset
  [then]
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $06 constant RCC_USART9RST                  \ [0x06] USART9 reset
    $07 constant RCC_SART10RST                  \ [0x07] USART10 reset
    ...
    $19 constant RCC_DFSDM2RST                  \ [0x19] DFSDM2 reset
  [then]
  ...
  [ifdef] RCC_AHB2ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $04 constant RCC_CRYPEN                     \ [0x04] CRYP clock enable
  ...
  [ifdef] RCC_APB1ENR_DEF
    ...
    $09 constant RCC_LPTIMER1EN                 \ [0x09] LPTimer 1 clock enable
    ...
    $1b constant RCC_CAN3EN                     \ [0x1b] CAN 3 clock enable
    $1c constant RCC_PWREN                      \ [0x1c] Power interface clock enable
    $1d constant RCC_DACEN                      \ [0x1d] DAC clock enable
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $16 constant RCC_SAI1EN                     \ [0x16] SAI 1 clock enable
    $18 constant RCC_DFSDMEN                    \ [0x18] DFSDMEN
    $19 constant RCC_DFSDM2EN                   \ [0x19] DFSDM2 clock enable
  [then]
  ...
  [ifdef] RCC_AHB1LPENR_DEF
    ...
    $11 constant RCC_SRAM2LPEN                  \ [0x11] SRAM2interface clock enable during Sleep mode
  ...
  [ifdef] RCC_APB1LPENR_DEF
    ...
    $09 constant RCC_LPTIMER1LPEN               \ [0x09] TIM14 clock enable during Sleep mode
    $0a constant RCC_RTCAPBEN                   \ [0x0a] RTC APB clock enable during Sleep mode
    ...
    $13 constant RCC_USART4LPEN                 \ [0x13] USART4 clock enable during Sleep mode
    $14 constant RCC_USART5LPEN                 \ [0x14] USART5 clock enable during Sleep mode
    ...
    $1b constant RCC_CAN3LPEN                   \ [0x1b] CAN3 clock enable during Sleep mode
    $1c constant RCC_PWRLPEN                    \ [0x1c] Power interface clock enable during Sleep mode
    $1d constant RCC_DACLPEN                    \ [0x1d] DAC clock enable during Sleep mode
  ...
  [ifdef] RCC_APB2LPENR_DEF
    ...
    $06 constant RCC_USART9LPEN                 \ [0x06] USART9 clock enable during Sleep mode
    $07 constant RCC_USART10LPEN                \ [0x07] USART10 clock enable during Sleep mode
    ...
    $19 constant RCC_DFSDM2LPEN                 \ [0x19] DFSDM2 clock enable during Sleep mode
  [then]
  ...
  [ifdef] RCC_DCKCFGR_DEF
    ...
    $1e constant RCC_LPTIMER1SEL                \ [0x1e : 2] LPTIMER1 kernel clock selection.
  [then]
  ...
  [ifdef] RCC_DCKCFGR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $16 constant RCC_I2CFMP1SEL                 \ [0x16] I2CFMP1 kernel clock source selection
  ...
  $18 constant RCC_AHB3RSTR             \ peripheral reset register
  ...
  $90 constant RCC_CKGATENR             \ RCC clocks gated enable register
