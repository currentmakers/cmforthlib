...
[ifndef] OTG_FS_GLOBAL_DEF
  ...
  [ifdef] OTG_FS_GLOBAL_FS_GCCFG_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OTG_FS_GLOBAL_DCDET            \ [0x00] DCDET
    $01 constant OTG_FS_GLOBAL_PDET             \ [0x01] PDET
    $02 constant OTG_FS_GLOBAL_SDET             \ [0x02] SDET
    $03 constant OTG_FS_GLOBAL_PS2DET           \ [0x03] PS2DET
    $10 constant OTG_FS_GLOBAL_PWRDWN           \ [0x10] PWRDWN
    $11 constant OTG_FS_GLOBAL_BCDEN            \ [0x11] BCDEN
    $12 constant OTG_FS_GLOBAL_DCDEN            \ [0x12] DCDEN
    $13 constant OTG_FS_GLOBAL_PDEN             \ [0x13] PDEN
    $14 constant OTG_FS_GLOBAL_SDEN             \ [0x14] SDEN
    $15 constant OTG_FS_GLOBAL_VBDEN            \ [0x15] VBDEN
  [then]
  ...
  $1C constant OTG_FS_GLOBAL_FS_GRXSTSR_HOST    \ OTG_FS Receive status debug read(Host mode)
