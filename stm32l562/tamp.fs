...
[ifndef] TAMP_DEF
  ...
  [ifdef] TAMP_CR1_DEF
    ...
    $17 constant TAMP_ITAMP8E                   \ [0x17] ITAMP5E
  [then]
  ...
  [ifdef] TAMP_ATCR1_DEF
    ...
    $10 constant TAMP_ATCKSEL                   \ [0x10 : 2] ATCKSEL
    $18 constant TAMP_ATPER                     \ [0x18 : 2] ATPER
  ...
  [ifdef] TAMP_ATCR2_DEF
    ...
    $11 constant TAMP_ATOSEL4                   \ [0x11 : 3] ATOSEL4
  ...
  [ifdef] TAMP_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TAMP_BKPRWDPROT                \ [0x00 : 8] Backup registers read/write protection offset
    $10 constant TAMP_BKPWDPROT                 \ [0x10 : 8] Backup registers write protection offset
    $1f constant TAMP_TAMPDPROT                 \ [0x1f] Tamper protection
  [then]
  ...
  [ifdef] TAMP_PRIVCR_DEF
    ...
    $1f constant TAMP_TAMPPRIV                  \ [0x1f] Tamper privilege protection
  [then]
  ...
  [ifdef] TAMP_SCR_DEF
    ...
    $06 constant TAMP_CTAMP7F                   \ [0x06] CTAMP7F
    $07 constant TAMP_CTAMP8F                   \ [0x07] CTAMP8F
  ...
  [ifdef] TAMP_CFGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $01 constant TAMP_TMONEN                    \ [0x01] TMONEN
    $02 constant TAMP_VMONEN                    \ [0x02] VMONEN
    $03 constant TAMP_WUTMONEN                  \ [0x03] WUTMONEN
  [then]
  ...
  $10 constant TAMP_ATCR1               \ TAMP active tamper control register 1
  ...
  $20 constant TAMP_SMCR                \ TAMP secure mode register
  ...
  $40 constant TAMP_COUNTR              \ TAMP monotonic counter register
  $50 constant TAMP_CFGR                \ TAMP configuration register
