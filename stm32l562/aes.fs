...
$00000060 constant AES_CR_CHMOD                                     \ AES chaining mode selection Bit1 Bit0
...
$00000000 constant AES_DINR_DIN                                     \ Data Input Register
...
$00000000 constant AES_DOUTR_DOUT                                   \ Data output register
...
$00000000 constant AES_KEYR2_KEY                                    \ Cryptographic key, bits [95:64])
...
$00000000 constant AES_KEYR3_KEY                                    \ Cryptographic key, bits [127:96])
...
$00000000 constant AES_IVR0_IVI                                     \ initialization vector register (LSB IVR [31:0])
...
$00000000 constant AES_IVR1_IVI                                     \ Initialization Vector Register (IVR [63:32])
...
$00000000 constant AES_IVR2_IVI                                     \ Initialization Vector Register (IVR [95:64])
...
$00000000 constant AES_IVR3_IVI                                     \ Initialization Vector Register (MSB IVR [127:96])
...
$420c0040 constant AES_SUSP0R     \ offset: 0x40 : AES suspend register 0
$420c0044 constant AES_SUSP1R     \ offset: 0x44 : AES suspend register 1
$420c0048 constant AES_SUSP2R     \ offset: 0x48 : AES suspend register 2
$420c004c constant AES_SUSP3R     \ offset: 0x4C : AES suspend register 3
$420c0050 constant AES_SUSP4R     \ offset: 0x50 : AES suspend register 4
$420c0054 constant AES_SUSP5R     \ offset: 0x54 : AES suspend register 5
$420c0058 constant AES_SUSP6R     \ offset: 0x58 : AES suspend register 6
$420c005c constant AES_SUSP7R     \ offset: 0x5C : AES suspend register 7
