...
[ifndef] AES_DEF
  ...
  [ifdef] AES_CR_DEF
    ...
    $05 constant AES_CHMOD                      \ [0x05 : 2] AES chaining mode selection Bit1 Bit0
  ...
  [ifdef] AES_DINR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_DIN                        \ [0x00 : 32] Data Input Register
  [then]
  ...
  [ifdef] AES_DOUTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_DOUT                       \ [0x00 : 32] Data output register
  [then]
  ...
  [ifdef] AES_IVR0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_IVI                        \ [0x00 : 32] initialization vector register (LSB IVR [31:0])
  [then]
  ...
  [ifdef] AES_IVR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_IVI                        \ [0x00 : 32] Initialization Vector Register (IVR [63:32])
  [then]
  ...
  [ifdef] AES_IVR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_IVI                        \ [0x00 : 32] Initialization Vector Register (IVR [95:64])
  [then]
  ...
  [ifdef] AES_IVR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_IVI                        \ [0x00 : 32] Initialization Vector Register (MSB IVR [127:96])
  [then]
