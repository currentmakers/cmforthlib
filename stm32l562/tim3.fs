...
[ifndef] TIM3_DEF
  ...
  [ifdef] TIM3_SMCR_DEF
    ...
    $10 constant TIM3_SMS_bit3                  \ [0x10] Slave mode selection - bit 3
  [then]
  ...
  [ifdef] TIM3_CCMR1_Output_DEF
    ...
    $04 constant TIM3_OC1M                      \ [0x04 : 3] Output compare 1 mode
    ...
    $10 constant TIM3_OC1M_bit3                 \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM3_OC2M_bit3                 \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM3_CCMR2_Output_DEF
    ...
    $10 constant TIM3_OC3M_bit3                 \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM3_OC4M_bit3                 \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM3_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CNT_L                     \ [0x00 : 16] Least significant part of counter value
    $10 constant TIM3_CNT_H                     \ [0x10 : 15] Most significant part counter value (on TIM2 and TIM5)
    $1f constant TIM3_CNT_bit31                 \ [0x1f] Most significant bit of counter value (on TIM2 and TIM5)
  [then]
  ...
  [ifdef] TIM3_ARR_DEF
    ...
    $10 constant TIM3_ARR_H                     \ [0x10 : 16] High Auto-reload value (TIM2 only)
  [then]
  ...
  [ifdef] TIM3_CCR1_DEF
    ...
    $10 constant TIM3_CCR1_H                    \ [0x10 : 16] High Capture/Compare 1 value (TIM2 only)
  [then]
  ...
  [ifdef] TIM3_CCR2_DEF
    ...
    $10 constant TIM3_CCR2_H                    \ [0x10 : 16] High Capture/Compare 2 value (TIM2 only)
  [then]
  ...
  [ifdef] TIM3_CCR3_DEF
    ...
    $10 constant TIM3_CCR3_H                    \ [0x10 : 16] High Capture/Compare value (TIM2 only)
  [then]
  ...
  [ifdef] TIM3_CCR4_DEF
    ...
    $10 constant TIM3_CCR4_H                    \ [0x10 : 16] High Capture/Compare value (TIM2 only)
  [then]
  ...
  [ifdef] TIM3_DMAR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_DMAB                      \ [0x00 : 16] Low Capture/Compare 2 value
  [then]
  ...
  [ifdef] TIM3_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_ITR1_RMP                  \ [0x00] Internal trigger 1 remap
  [then]
  ...
  [ifdef] TIM3_OR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0e constant TIM3_ETRSEL                    \ [0x0e : 3] ETR source selection
  [then]
  ...
  $50 constant TIM3_OR1                 \ TIM2 option register
  $60 constant TIM3_OR2                 \ TIM3 option register 2
