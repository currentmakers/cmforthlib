...
$00000300 constant PWR_CR3_RRS                                      \ SRAM2 retention in Standby mode
$00000400 constant PWR_CR3_APC                                      \ Apply pull-up and pull-down configuration
$00000800 constant PWR_CR3_ULPMEN                                   \ ULPMEN
$00002000 constant PWR_CR3_UCPD_STDBY                               \ UCPD_STDBY
$00004000 constant PWR_CR3_UCPD_DBDIS                               \ UCPD_DBDIS
...
$00000001 constant PWR_CR4_WUPP1                                    \ Wakeup pin WKUP1 polarity
$00000002 constant PWR_CR4_WUPP2                                    \ Wakeup pin WKUP2 polarity
$00000004 constant PWR_CR4_WUPP3                                    \ Wakeup pin WKUP3 polarity
$00000008 constant PWR_CR4_WUPP4                                    \ Wakeup pin WKUP4 polarity
$00000010 constant PWR_CR4_WUPP5                                    \ Wakeup pin WKUP5 polarity
...
$00001000 constant PWR_CR4_SMPSBYP                                  \ SMPSBYP
$00002000 constant PWR_CR4_EXTSMPSEN                                \ EXTSMPSEN
$00004000 constant PWR_CR4_SMPSFSTEN                                \ SMPSFSTEN
$00008000 constant PWR_CR4_SMPSLPEN                                 \ SMPSLPEN
...
$00000010 constant PWR_SR1_WUF5                                     \ Wakeup flag 5
$00000100 constant PWR_SR1_SBF                                      \ Standby flag
$00001000 constant PWR_SR1_SMPSBYPRDY                               \ SMPSBYPRDY
$00002000 constant PWR_SR1_EXTSMPSRDY                               \ EXTSMPSRDY
$00008000 constant PWR_SR1_SMPSHPRDY                                \ SMPSHPRDY
...
$00000100 constant PWR_SCR_CSBF                                     \ Clear standby flag
...
$00000001 constant PWR_PUCRH_PU0                                    \ Port G pull-up bit y (y=0..15)
$00000002 constant PWR_PUCRH_PU1                                    \ Port G pull-up bit y (y=0..15)
$00000004 constant PWR_PUCRH_PU2                                    \ Port G pull-up bit y (y=0..15)
$00000008 constant PWR_PUCRH_PU3                                    \ Port G pull-up bit y (y=0..15)
$00000010 constant PWR_PUCRH_PU4                                    \ Port G pull-up bit y (y=0..15)
$00000020 constant PWR_PUCRH_PU5                                    \ Port G pull-up bit y (y=0..15)
$00000040 constant PWR_PUCRH_PU6                                    \ Port G pull-up bit y (y=0..15)
$00000080 constant PWR_PUCRH_PU7                                    \ Port G pull-up bit y (y=0..15)
$00000100 constant PWR_PUCRH_PU8                                    \ Port G pull-up bit y (y=0..15)
$00000200 constant PWR_PUCRH_PU9                                    \ Port G pull-up bit y (y=0..15)
$00000400 constant PWR_PUCRH_PU10                                   \ Port G pull-up bit y (y=0..15)
$00000800 constant PWR_PUCRH_PU11                                   \ Port G pull-up bit y (y=0..15)
$00001000 constant PWR_PUCRH_PU12                                   \ Port G pull-up bit y (y=0..15)
$00002000 constant PWR_PUCRH_PU13                                   \ Port G pull-up bit y (y=0..15)
$00004000 constant PWR_PUCRH_PU14                                   \ Port G pull-up bit y (y=0..15)
$00008000 constant PWR_PUCRH_PU15                                   \ Port G pull-up bit y (y=0..15)
...
$00000001 constant PWR_PDCRH_PD0                                    \ Port G pull-down bit y (y=0..15)
$00000002 constant PWR_PDCRH_PD1                                    \ Port G pull-down bit y (y=0..15)
$00000004 constant PWR_PDCRH_PD2                                    \ Port G pull-down bit y (y=0..15)
$00000008 constant PWR_PDCRH_PD3                                    \ Port G pull-down bit y (y=0..15)
$00000010 constant PWR_PDCRH_PD4                                    \ Port G pull-down bit y (y=0..15)
$00000020 constant PWR_PDCRH_PD5                                    \ Port G pull-down bit y (y=0..15)
$00000040 constant PWR_PDCRH_PD6                                    \ Port G pull-down bit y (y=0..15)
$00000080 constant PWR_PDCRH_PD7                                    \ Port G pull-down bit y (y=0..15)
$00000100 constant PWR_PDCRH_PD8                                    \ Port G pull-down bit y (y=0..15)
$00000200 constant PWR_PDCRH_PD9                                    \ Port G pull-down bit y (y=0..15)
$00000400 constant PWR_PDCRH_PD10                                   \ Port G pull-down bit y (y=0..15)
$00000800 constant PWR_PDCRH_PD11                                   \ Port G pull-down bit y (y=0..15)
$00001000 constant PWR_PDCRH_PD12                                   \ Port G pull-down bit y (y=0..15)
$00002000 constant PWR_PDCRH_PD13                                   \ Port G pull-down bit y (y=0..15)
$00004000 constant PWR_PDCRH_PD14                                   \ Port G pull-down bit y (y=0..15)
$00008000 constant PWR_PDCRH_PD15                                   \ Port G pull-down bit y (y=0..15)
...
$00000001 constant PWR_SECCFGR_WUP1SEC                              \ WKUP1 pin security
$00000002 constant PWR_SECCFGR_WUP2SEC                              \ WKUP2 pin security
$00000004 constant PWR_SECCFGR_WUP3SEC                              \ WKUP3 pin security
$00000008 constant PWR_SECCFGR_WUP4SEC                              \ WKUP4 pin security
$00000010 constant PWR_SECCFGR_WUP5SEC                              \ WKUP5 pin security
$00000100 constant PWR_SECCFGR_LPMSEC                               \ LPMSEC
$00000200 constant PWR_SECCFGR_VDMSEC                               \ VDMSEC
$00000400 constant PWR_SECCFGR_VBSEC                                \ VBSEC
$00000800 constant PWR_SECCFGR_APCSEC                               \ APCSEC
...
$00000001 constant PWR_PRIVCFGR_PRIV                                \ PRIV
...
$40007078 constant PWR_SECCFGR    \ offset: 0x78 : Power secure configuration register
$40007080 constant PWR_PRIVCFGR   \ offset: 0x80 : Power privilege configuration register
