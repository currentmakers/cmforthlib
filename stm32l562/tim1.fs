...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_CR2_DEF
    ...
    $0f constant TIM1_OIS5                      \ [0x0f] Output Idle state 5 (OC5 output)
    $10 constant TIM1_OIS6                      \ [0x10] Output Idle state 6
  ...
  [ifdef] TIM1_SMCR_DEF
    ...
    $10 constant TIM1_SMS_bit3                  \ [0x10] Slave mode selection - bit 3
  [then]
  ...
  [ifdef] TIM1_OR2_DEF
    ...
    $08 constant TIM1_BKDFBK0E                  \ [0x08] BRK DFSDM_BREAK0 enable
  ...
  $50 constant TIM1_OR1                 \ DMA address for full transfer
  ...
  $60 constant TIM1_OR2                 \ DMA address for full transfer
  $64 constant TIM1_OR3                 \ DMA address for full transfer
