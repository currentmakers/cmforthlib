...
$00000f00 constant GPIOH_AFRL_AFSEL2                                \ Alternate function selection for port x bit y (y = 0..7)
$0000f000 constant GPIOH_AFRL_AFSEL3                                \ Alternate function selection for port x bit y (y = 0..7)
$000f0000 constant GPIOH_AFRL_AFSEL4                                \ Alternate function selection for port x bit y (y = 0..7)
$00f00000 constant GPIOH_AFRL_AFSEL5                                \ Alternate function selection for port x bit y (y = 0..7)
$0f000000 constant GPIOH_AFRL_AFSEL6                                \ Alternate function selection for port x bit y (y = 0..7)
$f0000000 constant GPIOH_AFRL_AFSEL7                                \ Alternate function selection for port x bit y (y = 0..7)
...
$00000001 constant GPIOH_BRR_BR0                                    \ Port x reset IO pin y
$00000002 constant GPIOH_BRR_BR1                                    \ Port x reset IO pin y
$00000004 constant GPIOH_BRR_BR2                                    \ Port x reset IO pin y
$00000008 constant GPIOH_BRR_BR3                                    \ Port x reset IO pin y
$00000010 constant GPIOH_BRR_BR4                                    \ Port x reset IO pin y
$00000020 constant GPIOH_BRR_BR5                                    \ Port x reset IO pin y
$00000040 constant GPIOH_BRR_BR6                                    \ Port x reset IO pin y
$00000080 constant GPIOH_BRR_BR7                                    \ Port x reset IO pin y
$00000100 constant GPIOH_BRR_BR8                                    \ Port x reset IO pin y
$00000200 constant GPIOH_BRR_BR9                                    \ Port x reset IO pin y
$00000400 constant GPIOH_BRR_BR10                                   \ Port x reset IO pin y
$00000800 constant GPIOH_BRR_BR11                                   \ Port x reset IO pin y
$00001000 constant GPIOH_BRR_BR12                                   \ Port x reset IO pin y
$00002000 constant GPIOH_BRR_BR13                                   \ Port x reset IO pin y
$00004000 constant GPIOH_BRR_BR14                                   \ Port x reset IO pin y
$00008000 constant GPIOH_BRR_BR15                                   \ Port x reset IO pin y
...
$00000001 constant GPIOH_SECCFGR_SEC0                               \ I/O pin of Port x secure bit enable
$00000002 constant GPIOH_SECCFGR_SEC1                               \ I/O pin of Port x secure bit enable
$00000004 constant GPIOH_SECCFGR_SEC2                               \ I/O pin of Port x secure bit enable
$00000008 constant GPIOH_SECCFGR_SEC3                               \ I/O pin of Port x secure bit enable
$00000010 constant GPIOH_SECCFGR_SEC4                               \ I/O pin of Port x secure bit enable
$00000020 constant GPIOH_SECCFGR_SEC5                               \ I/O pin of Port x secure bit enable
$00000040 constant GPIOH_SECCFGR_SEC6                               \ I/O pin of Port x secure bit enable
$00000080 constant GPIOH_SECCFGR_SEC7                               \ I/O pin of Port x secure bit enable
$00000100 constant GPIOH_SECCFGR_SEC8                               \ I/O pin of Port x secure bit enable
$00000200 constant GPIOH_SECCFGR_SEC9                               \ I/O pin of Port x secure bit enable
$00000400 constant GPIOH_SECCFGR_SEC10                              \ I/O pin of Port x secure bit enable
$00000800 constant GPIOH_SECCFGR_SEC11                              \ I/O pin of Port x secure bit enable
$00001000 constant GPIOH_SECCFGR_SEC12                              \ I/O pin of Port x secure bit enable
$00002000 constant GPIOH_SECCFGR_SEC13                              \ I/O pin of Port x secure bit enable
$00004000 constant GPIOH_SECCFGR_SEC14                              \ I/O pin of Port x secure bit enable
$00008000 constant GPIOH_SECCFGR_SEC15                              \ I/O pin of Port x secure bit enable


\
\ @brief General-purpose I/Os
\
$42021c00 constant GPIOH_MODER    \ offset: 0x00 : GPIO port mode register
$42021c04 constant GPIOH_OTYPER   \ offset: 0x04 : GPIO port output type register
$42021c08 constant GPIOH_OSPEEDR  \ offset: 0x08 : GPIO port output speed register
$42021c0c constant GPIOH_PUPDR    \ offset: 0x0C : GPIO port pull-up/pull-down register
$42021c10 constant GPIOH_IDR      \ offset: 0x10 : GPIO port input data register
$42021c14 constant GPIOH_ODR      \ offset: 0x14 : GPIO port output data register
$42021c18 constant GPIOH_BSRR     \ offset: 0x18 : GPIO port bit set/reset register
$42021c1c constant GPIOH_LCKR     \ offset: 0x1C : GPIO port configuration lock register
$42021c20 constant GPIOH_AFRL     \ offset: 0x20 : GPIO alternate function low register
$42021c24 constant GPIOH_AFRH     \ offset: 0x24 : GPIO alternate function high register
$42021c28 constant GPIOH_BRR      \ offset: 0x28 : GPIO port bit reset register
$42021c30 constant GPIOH_SECCFGR  \ offset: 0x30 : GPIO secure configuration register
