...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CR_DEF
    ...
    $1f constant RCC_PRIV                       \ [0x1f] PRIV
  [then]
  ...
  [ifdef] RCC_PLLCFGR_DEF
    ...
    $04 constant RCC_PLLM                       \ [0x04 : 4] Division factor for the main PLL and audio PLL (PLLSAI1 and PLLSAI2) input clock
  ...
  [ifdef] RCC_PLLSAI1CFGR_DEF
    ...
    \ Reset value: 0x00001000
    \
    $00 constant RCC_PLLSAI1SRC                 \ [0x00 : 2] PLLSAI1SRC
    $04 constant RCC_PLLSAI1M                   \ [0x04 : 4] Division factor for PLLSAI1 input clock
  ...
  [ifdef] RCC_PLLSAI2CFGR_DEF
    ...
    \ Reset value: 0x00001000
    \
    $00 constant RCC_PLLSAI2SRC                 \ [0x00 : 2] PLLSAI2SRC
    $04 constant RCC_PLLSAI2M                   \ [0x04 : 4] Division factor for PLLSAI2 input clock
  ...
  [ifdef] RCC_AHB1RSTR_DEF
    ...
    $02 constant RCC_DMAMUX1RST                 \ [0x02] DMAMUXRST
    ...
    $16 constant RCC_GTZCRST                    \ [0x16] GTZC reset
  [then]
  ...
  [ifdef] RCC_AHB2RSTR_DEF
    ...
    $11 constant RCC_HASHRST                    \ [0x11] Hash reset
    $12 constant RCC_RNGRST                     \ [0x12] Random number generator reset
    $13 constant RCC_PKARST                     \ [0x13] PKARST
    $15 constant RCC_OTFDEC1RST                 \ [0x15] OTFDEC1RST
    $16 constant RCC_SDMMC1RST                  \ [0x16] SDMMC1 reset
  [then]
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    $08 constant RCC_OSPI1RST                   \ [0x08] OSPI1RST
  [then]
  ...
  [ifdef] RCC_APB1RSTR2_DEF
    ...
    $06 constant RCC_LPTIM3RST                  \ [0x06] LPTIM3RST
    $09 constant RCC_FDCAN1RST                  \ [0x09] FDCAN1RST
    $15 constant RCC_USBFSRST                   \ [0x15] USBFSRST
    $17 constant RCC_UCPD1RST                   \ [0x17] UCPD1RST
  [then]
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $18 constant RCC_DFSDM1RST                  \ [0x18] Digital filters for sigma-delata modulators (DFSDM) reset
  [then]
  ...
  [ifdef] RCC_AHB1ENR_DEF
    ...
    $02 constant RCC_DMAMUX1EN                  \ [0x02] DMAMUX clock enable
    ...
    $16 constant RCC_GTZCEN                     \ [0x16] GTZCEN
  [then]
  ...
  [ifdef] RCC_AHB2ENR_DEF
    ...
    $13 constant RCC_PKAEN                      \ [0x13] PKAEN
    $15 constant RCC_OTFDEC1EN                  \ [0x15] OTFDEC1EN
    $16 constant RCC_SDMMC1EN                   \ [0x16] SDMMC1 clock enable
  [then]
  ...
  [ifdef] RCC_AHB3ENR_DEF
    ...
    $08 constant RCC_OSPI1EN                    \ [0x08] OSPI1EN
  [then]
  ...
  [ifdef] RCC_APB1ENR2_DEF
    ...
    $06 constant RCC_LPTIM3EN                   \ [0x06] LPTIM3EN
    $09 constant RCC_FDCAN1EN                   \ [0x09] FDCAN1EN
    $15 constant RCC_USBFSEN                    \ [0x15] USBFSEN
    $17 constant RCC_UCPD1EN                    \ [0x17] UCPD1EN
  [then]
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $18 constant RCC_DFSDM1EN                   \ [0x18] DFSDM timer clock enable
  [then]
  ...
  [ifdef] RCC_AHB1SMENR_DEF
    ...
    $02 constant RCC_DMAMUX1SMEN                \ [0x02] DMAMUX clock enable during Sleep and Stop modes
    ...
    $16 constant RCC_GTZCSMEN                   \ [0x16] GTZCSMEN
    $17 constant RCC_ICACHESMEN                 \ [0x17] ICACHESMEN
  [then]
  ...
  [ifdef] RCC_AHB2SMENR_DEF
    ...
    $11 constant RCC_HASHSMEN                   \ [0x11] HASH clock enable during Sleep and Stop modes
    $12 constant RCC_RNGSMEN                    \ [0x12] Random Number Generator clocks enable during Sleep and Stop modes
    $13 constant RCC_PKASMEN                    \ [0x13] PKASMEN
    $15 constant RCC_OTFDEC1SMEN                \ [0x15] OTFDEC1SMEN
    $16 constant RCC_SDMMC1SMEN                 \ [0x16] SDMMC1 clocks enable during Sleep and Stop modes
  [then]
  ...
  [ifdef] RCC_AHB3SMENR_DEF
    ...
    $08 constant RCC_OSPI1SMEN                  \ [0x08] OSPI1SMEN
  [then]
  ...
  [ifdef] RCC_APB1SMENR1_DEF
    ...
    $18 constant RCC_CRSSMEN                    \ [0x18] CRS clock enable during Sleep and Stop modes
  ...
  [ifdef] RCC_APB1SMENR2_DEF
    ...
    $06 constant RCC_LPTIM3SMEN                 \ [0x06] LPTIM3SMEN
    $09 constant RCC_FDCAN1SMEN                 \ [0x09] FDCAN1SMEN
    $15 constant RCC_USBFSSMEN                  \ [0x15] USBFSSMEN
    $17 constant RCC_UCPD1SMEN                  \ [0x17] UCPD1SMEN
  [then]
  ...
  [ifdef] RCC_APB2SMENR_DEF
    ...
    $18 constant RCC_DFSDM1SMEN                 \ [0x18] DFSDM timer clocks enable during Sleep and Stop modes
  [then]


  [ifdef] RCC_CCIPR1_DEF
    \
    \ @brief CCIPR1
    \ Address offset: 0x88
    \ Reset value: 0x00000000
    ...
    $18 constant RCC_FDCANSEL                   \ [0x18 : 2] FDCAN clock source selection
    $1a constant RCC_CLK48MSEL                  \ [0x1a : 2] 48 MHz clock source selection
  ...
  [ifdef] RCC_BDCR_DEF
    ...
    $07 constant RCC_LSESYSEN                   \ [0x07] LSESYSEN
    $08 constant RCC_RTCSEL                     \ [0x08 : 2] RTC clock source selection
    $0b constant RCC_LSESYSRDY                  \ [0x0b] LSESYSRDY
  ...
  [ifdef] RCC_CSR_DEF
    ...
    $04 constant RCC_LSIPREDIV                  \ [0x04] LSIPREDIV
    ...
    $1d constant RCC_IWWDGRSTF                  \ [0x1d] Independent window watchdog reset flag
  ...
  [ifdef] RCC_CRRCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_HSI48ON                    \ [0x00] HSI48 clock enable
    $01 constant RCC_HSI48RDY                   \ [0x01] HSI48 clock ready flag
  ...
  [ifdef] RCC_CCIPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_I2C4SEL                    \ [0x00 : 2] I2C4 clock source selection
    $02 constant RCC_DFSDMSEL                   \ [0x02] Digital filter for sigma delta modulator kernel clock source selection
    $03 constant RCC_ADFSDMSEL                  \ [0x03 : 2] Digital filter for sigma delta modulator audio clock source selection
    $05 constant RCC_SAI1SEL                    \ [0x05 : 3] SAI1 clock source selection
    $08 constant RCC_SAI2SEL                    \ [0x08 : 3] SAI2 clock source selection
    $0e constant RCC_SDMMCSEL                   \ [0x0e] SDMMC clock selection
    $14 constant RCC_OSPISEL                    \ [0x14 : 2] Octospi clock source selection
  [then]


  [ifdef] RCC_SECCFGR_DEF
    \
    \ @brief RCC secure configuration register
    \ Address offset: 0xB8
    \ Reset value: 0x00000000
    \
    $00 constant RCC_HSISEC                     \ [0x00] HSISEC
    $01 constant RCC_HSESEC                     \ [0x01] HSESEC
    $02 constant RCC_MSISEC                     \ [0x02] MSISEC
    $03 constant RCC_LSISEC                     \ [0x03] LSISEC
    $04 constant RCC_LSESEC                     \ [0x04] LSESEC
    $05 constant RCC_SYSCLKSEC                  \ [0x05] SYSCLKSEC
    $06 constant RCC_PRESCSEC                   \ [0x06] PRESCSEC
    $07 constant RCC_PLLSEC                     \ [0x07] PLLSEC
    $08 constant RCC_PLLSAI1SEC                 \ [0x08] PLLSAI1SEC
    $09 constant RCC_PLLSAI2SEC                 \ [0x09] PLLSAI2SEC
    $0a constant RCC_CLK48MSEC                  \ [0x0a] CLK48MSEC
    $0b constant RCC_HSI48SEC                   \ [0x0b] HSI48SEC
    $0c constant RCC_RMVFSEC                    \ [0x0c] RMVFSEC
  [then]
  ...
  [ifdef] RCC_SECSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_HSISECF                    \ [0x00] HSISECF
    $01 constant RCC_HSESECF                    \ [0x01] HSESECF
    $02 constant RCC_MSISECF                    \ [0x02] MSISECF
    $03 constant RCC_LSISECF                    \ [0x03] LSISECF
    $04 constant RCC_LSESECF                    \ [0x04] LSESECF
    $05 constant RCC_SYSCLKSECF                 \ [0x05] SYSCLKSECF
    $06 constant RCC_PRESCSECF                  \ [0x06] PRESCSECF
    $07 constant RCC_PLLSECF                    \ [0x07] PLLSECF
    $08 constant RCC_PLLSAI1SECF                \ [0x08] PLLSAI1SECF
    $09 constant RCC_PLLSAI2SECF                \ [0x09] PLLSAI2SECF
    $0a constant RCC_CLK48MSECF                 \ [0x0a] CLK48MSECF
    $0b constant RCC_HSI48SECF                  \ [0x0b] HSI48SECF
    $0c constant RCC_RMVFSECF                   \ [0x0c] RMVFSECF
  [then]


  [ifdef] RCC_AHB1SECSR_DEF
    \
    \ @brief RCC AHB1 security status register
    \ Address offset: 0xE8
    \ Reset value: 0x00400300
    \
    $00 constant RCC_DMA1SECF                   \ [0x00] DMA1SECF
    $01 constant RCC_DMA2SECF                   \ [0x01] DMA2SECF
    $02 constant RCC_DMAMUX1SECF                \ [0x02] DMAMUX1SECF
    $08 constant RCC_FLASHSECF                  \ [0x08] FLASHSECF
    $09 constant RCC_SRAM1SECF                  \ [0x09] SRAM1SECF
    $0c constant RCC_CRCSECF                    \ [0x0c] CRCSECF
    $10 constant RCC_TSCSECF                    \ [0x10] TSCSECF
    $16 constant RCC_GTZCSECF                   \ [0x16] GTZCSECF
    $17 constant RCC_ICACHESECF                 \ [0x17] ICACHESECF
  [then]


  [ifdef] RCC_AHB2SECSR_DEF
    \
    \ @brief RCC AHB2 security status register
    \ Address offset: 0xEC
    \ Reset value: 0x002002FF
    \
    $00 constant RCC_GPIOASECF                  \ [0x00] GPIOASECF
    $01 constant RCC_GPIOBSECF                  \ [0x01] GPIOBSECF
    $02 constant RCC_GPIOCSECF                  \ [0x02] GPIOCSECF
    $03 constant RCC_GPIODSECF                  \ [0x03] GPIODSECF
    $04 constant RCC_GPIOESECF                  \ [0x04] GPIOESECF
    $05 constant RCC_GPIOFSECF                  \ [0x05] GPIOFSECF
    $06 constant RCC_GPIOGSECF                  \ [0x06] GPIOGSECF
    $07 constant RCC_GPIOHSECF                  \ [0x07] GPIOHSECF
    $09 constant RCC_SRAM2SECF                  \ [0x09] SRAM2SECF
    $15 constant RCC_OTFDEC1SECF                \ [0x15] OTFDEC1SECF
    $16 constant RCC_SDMMC1SECF                 \ [0x16] SDMMC1SECF
  [then]


  [ifdef] RCC_AHB3SECSR_DEF
    \
    \ @brief RCC AHB3 security status register
    \ Address offset: 0xF0
    \ Reset value: 0x00000000
    \
    $00 constant RCC_FSMCSECF                   \ [0x00] FSMCSECF
    $08 constant RCC_OSPI1SECF                  \ [0x08] OSPI1SECF
  [then]


  [ifdef] RCC_APB1SECSR1_DEF
    \
    \ @brief RCC APB1 security status register 1
    \ Address offset: 0xF8
    \ Reset value: 0x00000400
    \
    $00 constant RCC_TIM2SECF                   \ [0x00] TIM2SECF
    $01 constant RCC_TIM3SECF                   \ [0x01] TIM3SECF
    $02 constant RCC_TIM4SECF                   \ [0x02] TIM4SECF
    $03 constant RCC_TIM5SECF                   \ [0x03] TIM5SECF
    $04 constant RCC_TIM6SECF                   \ [0x04] TIM6SECF
    $05 constant RCC_TIM7SECF                   \ [0x05] TIM7SECF
    $0a constant RCC_RTCAPBSECF                 \ [0x0a] RTCAPBSECF
    $0b constant RCC_WWDGSECF                   \ [0x0b] WWDGSECF
    $0e constant RCC_SPI2SECF                   \ [0x0e] SPI2SECF
    $0f constant RCC_SPI3SECF                   \ [0x0f] SPI3SECF
    $11 constant RCC_UART2SECF                  \ [0x11] UART2SECF
    $12 constant RCC_UART3SECF                  \ [0x12] UART3SECF
    $13 constant RCC_UART4SECF                  \ [0x13] UART4SECF
    $14 constant RCC_UART5SECF                  \ [0x14] UART5SECF
    $15 constant RCC_I2C1SECF                   \ [0x15] I2C1SECF
    $16 constant RCC_I2C2SECF                   \ [0x16] I2C2SECF
    $17 constant RCC_I2C3SECF                   \ [0x17] I2C3SECF
    $18 constant RCC_CRSSECF                    \ [0x18] CRSSECF
    $1c constant RCC_PWRSECF                    \ [0x1c] PWRSECF
    $1d constant RCC_DACSECF                    \ [0x1d] DACSECF
    $1e constant RCC_OPAMPSECF                  \ [0x1e] OPAMPSECF
    $1f constant RCC_LPTIM1SECF                 \ [0x1f] LPTIM1SECF
  [then]


  [ifdef] RCC_APB1SECSR2_DEF
    \
    \ @brief RCC APB1 security status register 2
    \ Address offset: 0xFC
    \ Reset value: 0x00000000
    \
    $00 constant RCC_LPUART1SECF                \ [0x00] LPUART1SECF
    $01 constant RCC_I2C4SECF                   \ [0x01] I2C4SECF
    $05 constant RCC_LPTIM2SECF                 \ [0x05] LPTIM2SECF
    $06 constant RCC_LPTIM3SECF                 \ [0x06] LPTIM3SECF
    $09 constant RCC_FDCAN1SECF                 \ [0x09] FDCAN1SECF
    $15 constant RCC_USBFSSECF                  \ [0x15] USBFSSECF
    $17 constant RCC_UCPD1SECF                  \ [0x17] UCPD1SECF
  [then]


  [ifdef] RCC_APB2SECSR_DEF
    \
    \ @brief RCC APB2 security status register
    \ Address offset: 0x100
    \ Reset value: 0x00000000
    \
    $00 constant RCC_SYSCFGSECF                 \ [0x00] SYSCFGSECF
    $0b constant RCC_TIM1SECF                   \ [0x0b] TIM1SECF
    $0c constant RCC_SPI1SECF                   \ [0x0c] SPI1SECF
    $0d constant RCC_TIM8SECF                   \ [0x0d] TIM8SECF
    $0e constant RCC_USART1SECF                 \ [0x0e] USART1SECF
    $10 constant RCC_TIM15SECF                  \ [0x10] TIM15SECF
    $11 constant RCC_TIM16SECF                  \ [0x11] TIM16SECF
    $12 constant RCC_TIM17SECF                  \ [0x12] TIM17SECF
    $15 constant RCC_SAI1SECF                   \ [0x15] SAI1SECF
    $16 constant RCC_SAI2SECF                   \ [0x16] SAI2SECF
    $18 constant RCC_DFSDM1SECF                 \ [0x18] DFSDM1SECF
  [then]
  ...
  $88 constant RCC_CCIPR1               \ CCIPR1
  $90 constant RCC_BDCR                 \ BDCR
  $94 constant RCC_CSR                  \ CSR
  $98 constant RCC_CRRCR                \ Clock recovery RC register
  $9C constant RCC_CCIPR2               \ Peripherals independent clock configuration register
  $B8 constant RCC_SECCFGR              \ RCC secure configuration register
  $BC constant RCC_SECSR                \ RCC secure status register
  $E8 constant RCC_AHB1SECSR            \ RCC AHB1 security status register
  $EC constant RCC_AHB2SECSR            \ RCC AHB2 security status register
  $F0 constant RCC_AHB3SECSR            \ RCC AHB3 security status register
  $F8 constant RCC_APB1SECSR1           \ RCC APB1 security status register 1
  $FC constant RCC_APB1SECSR2           \ RCC APB1 security status register 2
  $100 constant RCC_APB2SECSR           \ RCC APB2 security status register
