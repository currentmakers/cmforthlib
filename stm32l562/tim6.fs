...
[ifndef] TIM6_DEF
  ...
  [ifdef] TIM6_CR1_DEF
    ...
    $0b constant TIM6_UIFREMA                   \ [0x0b] UIF status bit remapping
  [then]
  ...
  [ifdef] TIM6_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM6_CNT_bit0                  \ [0x00 : 16] CNT
    $1f constant TIM6_UIFCPY                    \ [0x1f] UIFCPY or Res
  [then]
  ...
  [ifdef] TIM6_ARR_DEF
    ...
    \
    $00 constant TIM6_ARR_bit0                  \ [0x00 : 16] ARR_bit0
  [then]
