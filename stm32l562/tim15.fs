...
[ifndef] TIM15_DEF
  ...
  [ifdef] TIM15_SMCR_DEF
    ...
    $10 constant TIM15_SMS_bit3                 \ [0x10] Slave mode selection - bit 3
  [then]
  ...
  [ifdef] TIM15_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM15_TI1_RMP                  \ [0x00] Input capture 1 remap
    $01 constant TIM15_ENCODER_MODE             \ [0x01 : 2] Encoder mode
  [then]
  ...
  [ifdef] TIM15_OR2_DEF
    ...
    $08 constant TIM15_BKDF1BK0E                \ [0x08] BRK dfsdm1_break[0] enable
  ...
  $08 constant TIM15_SMCR               \ TIM15 slave mode control register
  ...
  $28 constant TIM15_CCR2               \ TIM15 capture/compare register 2
  ...
  $50 constant TIM15_OR1                \ TIM15 option register 1
  $60 constant TIM15_OR2                \ TIM15 option register 2
