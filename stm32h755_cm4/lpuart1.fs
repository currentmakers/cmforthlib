...
[ifndef] LPUART1_DEF
  ...
  [ifdef] LPUART1_CR1_DEF
    ...
    $10 constant LPUART1_DEDT                   \ [0x10 : 5] Driver Enable deassertion time
    $15 constant LPUART1_DEAT                   \ [0x15 : 5] Driver Enable assertion time
  ...
  [ifdef] LPUART1_CR2_DEF
    ...
    $18 constant LPUART1_ADD                    \ [0x18 : 8] Address of the USART node
  [then]
  ...
  [ifdef] LPUART1_CR3_DEF
    ...
    $17 constant LPUART1_TXFTIE                 \ [0x17] TXFIFO threshold interrupt enable
