...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_PWR_CR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_VCOREMONEN                 \ [0x00] Vless thansub>DDCOREless than/sub> monitoring enable
    $04 constant PWR_VCORELLS                   \ [0x04] Vless thansub>DDCOREless than/sub> voltage detector low-level selection
    $08 constant PWR_VCOREL                     \ [0x08] Monitored Vless thansub>DDCOREless than/sub> level above low threshold
    $09 constant PWR_VCOREH                     \ [0x09] Monitored Vless thansub>DDCOREless than/sub> level above high threshold
  [then]
  ...
  [ifdef] PWR_PWR_VOSCR_DEF
    ...
    $01 constant PWR_VOSRDY                     \ [0x01] VOS ready bit for Vless thansub>COREless than/sub> voltage scaling output selection
    $10 constant PWR_ACTVOS                     \ [0x10] VOS currently applied for Vless thansub>COREless than/sub> voltage scaling selection
  ...
  [ifdef] PWR_PWR_BDCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_MONEN                      \ [0x00] Vless thansub>BATless than/sub> and temperature monitoring enable
    $10 constant PWR_VBATL                      \ [0x10] Vless thansub>BATless than/sub> level monitoring versus low threshold
    $11 constant PWR_VBATH                      \ [0x11] Vless thansub>BATless than/sub> level monitoring versus high threshold
  ...
  [ifdef] PWR_PWR_BDCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_BKPRBSEN                   \ [0x00] Backup RAM backup supply enable (used to maintain BKPRAM content in Standby and Vless thansub>BATless than/sub> modes).
  [then]
  ...
  [ifdef] PWR_PWR_SVMCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_VDDIO4VMEN                 \ [0x00] Vless thansub>DDIO4 less than/sub>independent I/O voltage monitor enable
    $08 constant PWR_VDDIO4SV                   \ [0x08] Vless thansub>DDIO4 less than/sub>independent I/O supply valid.
    $10 constant PWR_VDDIO4RDY                  \ [0x10] Vless thansub>DDIO4 less than/sub>ready
    $18 constant PWR_VDDIO4VRSEL                \ [0x18] Vless thansub>DDIO4less than/sub> I/O voltage range selection
    $19 constant PWR_VDDIO4VRSTBY               \ [0x19] Vless thansub>DDIO4less than/sub> I/O voltage range Standby mode
  [then]
  ...
  [ifdef] PWR_PWR_SVMCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_VDDIO5VMEN                 \ [0x00] Vless thansub>DDIO5 less than/sub>independent voltage monitor enable
    $08 constant PWR_VDDIO5SV                   \ [0x08] Vless thansub>DDIO5 less than/sub>independent supply valid
    $10 constant PWR_VDDIO5RDY                  \ [0x10] Vless thansub>DDIO5 less than/sub>ready
    $18 constant PWR_VDDIO5VRSEL                \ [0x18] Vless thansub>DDIO5less than/sub> I/O voltage range selection
    $19 constant PWR_VDDIO5VRSTBY               \ [0x19] Vless thansub>DDIO5less than/sub> I/O voltage range Standby mode
  [then]
  ...
  [ifdef] PWR_PWR_SVMCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_VDDIO2VMEN                 \ [0x00] Vless thansub>DDIO2 less than/sub>independent voltage monitor enable
    $01 constant PWR_VDDIO3VMEN                 \ [0x01] Vless thansub>DDIO3 less than/sub>independent voltage monitor enable
    $02 constant PWR_USB33VMEN                  \ [0x02] Vless thansub>DD33USB less than/sub>independent USB 33 voltage monitor enable.
    $04 constant PWR_AVMEN                      \ [0x04] Vless thansub>DDA18ADC less than/sub>independent ADC voltage monitor enable
    $08 constant PWR_VDDIO2SV                   \ [0x08] Vless thansub>DDIO2 less than/sub>independent supply valid.
    $09 constant PWR_VDDIO3SV                   \ [0x09] Vless thansub>DDIO3 less than/sub>independent supply valid
    $0a constant PWR_USB33SV                    \ [0x0a] Vless thansub>DD33USB less than/sub>independent supply valid
    $0c constant PWR_ASV                        \ [0x0c] Vless thansub>DDA18ADC less than/sub>independent supply valid
    $10 constant PWR_VDDIO2RDY                  \ [0x10] Vless thansub>DDIO2 less than/sub>ready
    $11 constant PWR_VDDIO3RDY                  \ [0x11] Vless thansub>DDIO3 less than/sub>ready
    $12 constant PWR_USB33RDY                   \ [0x12] Vless thansub>DD33USB less than/sub>ready
    $14 constant PWR_ARDY                       \ [0x14] Vless thansub>DDA18ADC less than/sub>ready
    $18 constant PWR_VDDIOVRSEL                 \ [0x18] Vless thansub>DDless than/sub> I/O voltage range selection
    $19 constant PWR_VDDIO2VRSEL                \ [0x19] Vless thansub>DDIO2less than/sub> I/O voltage range selection
    $1a constant PWR_VDDIO3VRSEL                \ [0x1a] Vless thansub>DDIO3less than/sub> I/O voltage range selection
  [then]
  ...
  [ifdef] PWR_PWR_SECCFGR_DEF
    ...
    $02 constant PWR_SEC2                       \ [0x02] Vless thansub>DDCOREless than/sub> monitor secure protection
  ...
  [ifdef] PWR_PWR_PRIVCFGR_DEF
    ...
    $02 constant PWR_PRIV2                      \ [0x02] Vless thansub>DDCOREless than/sub> monitor privileged protection
