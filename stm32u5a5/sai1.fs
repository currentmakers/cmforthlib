...
[ifndef] SAI1_DEF
  ...
  [ifdef] SAI1_GCR_DEF
    ...
    \
    $00 constant SAI1_SYNCIN                    \ [0x00 : 2] Synchronization inputs
    $04 constant SAI1_SYNCOUT                   \ [0x04 : 2] Synchronization outputs
  [then]
  ...
  [ifdef] SAI1_ACR1_DEF
    ...
    $1a constant SAI1_OSR                       \ [0x1a] OSR
    $1b constant SAI1_MCKEN                     \ [0x1b] MCKEN
  [then]
  ...
  [ifdef] SAI1_AIM_DEF
    ...
    $01 constant SAI1_MUTEDETIE                 \ [0x01] Mute detection interrupt enable
    $02 constant SAI1_WCKCFGIE                  \ [0x02] Wrong clock configuration interrupt enable
  ...
  [ifdef] SAI1_PDMCR_DEF
    ...
    $04 constant SAI1_MICNBR                    \ [0x04 : 2] MICNBR
    $08 constant SAI1_CKEN1                     \ [0x08] Clock enable of bitstream clock number 1
    $09 constant SAI1_CKEN2                     \ [0x09] CKEN2
    $0a constant SAI1_CKEN3                     \ [0x0a] CKEN3
    $0b constant SAI1_CKEN4                     \ [0x0b] CKEN4
  [then]
  ...
  [ifdef] SAI1_PDMDLY_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SAI1_DLYM1L                    \ [0x00 : 3] Delay line adjust for first microphone of pair 1
    $04 constant SAI1_DLYM1R                    \ [0x04 : 3] Delay line adjust for second microphone of pair 1
    ...
    $10 constant SAI1_DLYM3L                    \ [0x10 : 3] DLYM3L
    $14 constant SAI1_DLYM3R                    \ [0x14 : 3] DLYM3R
    $18 constant SAI1_DLYM4L                    \ [0x18 : 3] DLYM4L
    $1c constant SAI1_DLYM4R                    \ [0x1c : 3] DLYM4R
  [then]

  \
  \ @brief Serial audio interface
  \
  $00 constant SAI1_GCR                 \ Global configuration register
  $04 constant SAI1_ACR1                \ A Configuration register 1
  $08 constant SAI1_ACR2                \ A Configuration register 2
  $0C constant SAI1_AFRCR               \ A frame configuration register
  $10 constant SAI1_ASLOTR              \ A Slot register
  $14 constant SAI1_AIM                 \ A Interrupt mask register
  $18 constant SAI1_ASR                 \ A Status register
  $1C constant SAI1_ACLRFR              \ A Clear flag register
  $20 constant SAI1_ADR                 \ A Data register
  $24 constant SAI1_BCR1                \ B Configuration register 1
  $28 constant SAI1_BCR2                \ B Configuration register 2
  $2C constant SAI1_BFRCR               \ B frame configuration register
  $30 constant SAI1_BSLOTR              \ B Slot register
  $34 constant SAI1_BIM                 \ B Interrupt mask register
  $38 constant SAI1_BSR                 \ B Status register
  $3C constant SAI1_BCLRFR              \ B Clear flag register
  $40 constant SAI1_BDR                 \ B Data register
