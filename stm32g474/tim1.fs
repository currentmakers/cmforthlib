...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_CR2_DEF
    ...
    $0f constant TIM1_OIS4N                     \ [0x0f] Output Idle state 4 (OC4N output)
    ...
    $19 constant TIM1_MMS_3                     \ [0x19] Master mode selection - bit 3
  [then]
  ...
  [ifdef] TIM1_SMCR_DEF
    ...
    $10 constant TIM1_SMS_3                     \ [0x10] Slave mode selection - bit 3
    $14 constant TIM1_TS_4_3                    \ [0x14 : 2] Trigger selection - bit 4:3
  ...
  [ifdef] TIM1_BDTR_DEF
    ...
    $1d constant TIM1_BK2ID                     \ [0x1d] BK2ID
  [then]
  ...
  [ifdef] TIM1_CCR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_CCR5                      \ [0x00 : 16] Capture/Compare value
  ...
  [ifdef] TIM1_CCMR3_Output_DEF
    ...
    $10 constant TIM1_OC5M_bit3                 \ [0x10 : 3] Output Compare 5 mode bit 3
  ...
  [ifdef] TIM1_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_TI1SEL                    \ [0x00 : 4] TI1[0] to TI1[15] input selection
    $08 constant TIM1_TI2SEL                    \ [0x08 : 4] TI2[0] to TI2[15] input selection
    $10 constant TIM1_TI3SEL                    \ [0x10 : 4] TI3[0] to TI3[15] input selection
    $18 constant TIM1_TI4SEL                    \ [0x18 : 4] TI4[0] to TI4[15] input selection
  [then]
  ...
  [ifdef] TIM1_AF1_DEF
    ...
    $03 constant TIM1_BKCMP3E                   \ [0x03] BRK COMP3 enable
    $04 constant TIM1_BKCMP4E                   \ [0x04] BRK COMP4 enable
    $05 constant TIM1_BKCMP5E                   \ [0x05] BRK COMP5 enable
    $06 constant TIM1_BKCMP6E                   \ [0x06] BRK COMP6 enable
    $07 constant TIM1_BKCMP7E                   \ [0x07] BRK COMP7 enable
    ...
    $0c constant TIM1_BKCMP3P                   \ [0x0c] BRK COMP3 input polarity
    $0d constant TIM1_BKCMP4P                   \ [0x0d] BRK COMP4 input polarity
  ...
  [ifdef] TIM1_AF2_DEF
    ...
    $03 constant TIM1_BK2CMP3E                  \ [0x03] BRK2 COMP3 enable
    $04 constant TIM1_BK2CMP4E                  \ [0x04] BRK2 COMP4 enable
    $05 constant TIM1_BK2CMP5E                  \ [0x05] BRK2 COMP5 enable
    $06 constant TIM1_BK2CMP6E                  \ [0x06] BRK2 COMP6 enable
    $07 constant TIM1_BK2CMP7E                  \ [0x07] BRK2 COMP7 enable
    $09 constant TIM1_BK2INP                    \ [0x09] BRK2 BKIN input polarity
    $0a constant TIM1_BK2CMP1P                  \ [0x0a] BRK2 COMP1 input polarity
    $0b constant TIM1_BK2CMP2P                  \ [0x0b] BRK2 COMP2 input polarity
    $0c constant TIM1_BK2CMP3P                  \ [0x0c] BRK2 COMP3 input polarity
    $0d constant TIM1_BK2CMP4P                  \ [0x0d] BRK2 COMP4 input polarity
  ...
  $48 constant TIM1_CCR5                \ capture/compare register 4
  $4C constant TIM1_CCR6                \ capture/compare register 4
  $50 constant TIM1_CCMR3_OUTPUT        \ capture/compare mode register 2 (output mode)
  $54 constant TIM1_DTR2                \ timer Deadtime Register 2
  $58 constant TIM1_ECR                 \ DMA control register
  $5C constant TIM1_TISEL               \ TIM timer input selection register
  $60 constant TIM1_AF1                 \ TIM alternate function option register 1
  $64 constant TIM1_AF2                 \ TIM alternate function option register 2
  $3DC constant TIM1_DCR                \ control register
