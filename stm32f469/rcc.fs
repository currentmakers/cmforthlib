...
$0000003f constant RCC_PLLCFGR_PLLM                                 \ Division factor for the main PLL (PLL) and audio PLL (PLLI2S) input clock
$00007fc0 constant RCC_PLLCFGR_PLLN                                 \ Main PLL (PLL) multiplication factor for VCO
$00030000 constant RCC_PLLCFGR_PLLP                                 \ Main PLL (PLL) division factor for main system clock
$00400000 constant RCC_PLLCFGR_PLLSRC                               \ Main PLL(PLL) and audio PLL (PLLI2S) entry clock source
$0f000000 constant RCC_PLLCFGR_PLLQ                                 \ Main PLL (PLL) division factor for USB OTG FS, SDIO and random number generator clocks
$70000000 constant RCC_PLLCFGR_PLLR                                 \ Main PLL division factor for DSI clock
...
$00000002 constant RCC_AHB3RSTR_QSPIRST                             \ QUADSPI memory controller reset
...
$08000000 constant RCC_APB2RSTR_DSIRST                              \ DSI host reset
...
$08000000 constant RCC_APB2ENR_DSIEN                                \ DSI clocks enable
...
$04000000 constant RCC_APB2LPENR_LTDCLPEN                           \ LTDC clock enable
$08000000 constant RCC_APB2LPENR_DSILPEN                            \ DSI clocks enable during Sleep mode
...
$0f000000 constant RCC_PLLSAICFGR_PLLSAIQ                           \ PLLSAI division factor for SAI1 clock
...
$0000001f constant RCC_DCKCFGR_PLLIS2DIVQ                           \ PLLI2S division factor for SAIs clock
$00001f00 constant RCC_DCKCFGR_PLLSAIDIVQ                           \ PLLSAI division factor for SAIs clock
$00030000 constant RCC_DCKCFGR_PLLSAIDIVR                           \ PLLSAIDIVR
$00300000 constant RCC_DCKCFGR_SAI1ASRC                             \ SAI1 clock source selection
$00c00000 constant RCC_DCKCFGR_SAI1BSRC                             \ SAI1-B clock source selection
$01000000 constant RCC_DCKCFGR_TIMPRE                               \ Timers clocks prescalers selection
$08000000 constant RCC_DCKCFGR_MSEL                                 \ 48 MHz clock source selection
$10000000 constant RCC_DCKCFGR_SDMMCSEL                             \ SDIO clock source selection
$20000000 constant RCC_DCKCFGR_DSISEL                               \ DSI clock source selection
