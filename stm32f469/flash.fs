...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_SR_DEF
    ...
    $08 constant FLASH_RDERR                    \ [0x08] Proprietary readout protection (PCROP) error
  ...
  [ifdef] FLASH_OPTCR_DEF
    ...
    $04 constant FLASH_BFB2                     \ [0x04] Dual-bank Boot option byte
    ...
    $1e constant FLASH_DB1M                     \ [0x1e] Dual-bank on 1 Mbyte Flash memory devices
    $1f constant FLASH_SPRMOD                   \ [0x1f] Selection of protection mode for nWPRi bits
  [then]
