...
[ifndef] IWDG_DEF
  ...
  \ @brief Independent watchdog
  \
  $00 constant IWDG_KR                  \ Key register (IWDG_KR)
  $04 constant IWDG_PR                  \ Prescaler register (IWDG_PR)
  $08 constant IWDG_RLR                 \ Reload register (IWDG_RLR)
  $0C constant IWDG_SR                  \ Status register (IWDG_SR)
