...
$80000000 constant ETHERNET_MMC_MMCCR_MCF                           \ MMC counter freeze
...
$00000000 constant ETHERNET_MMC_MMCTGFSCCR_TGFSCC                   \ Transmitted good frames after a single collision counter
...
$00000000 constant ETHERNET_MMC_MMCTGFMSCCR_TGFMSCC                 \ Transmitted good frames after more than a single collision counter
...
$00000000 constant ETHERNET_MMC_MMCRFCECR_RFCFC                     \ Received frames with CRC error counter
...
$00000000 constant ETHERNET_MMC_MMCRFAECR_RFAEC                     \ Received frames with alignment error counter
...
\ @brief Ethernet: MAC management counters
\
$40028100 constant ETHERNET_MMC_MMCCR  \ offset: 0x00 : Ethernet MMC control register (ETH_MMCCR)
$40028104 constant ETHERNET_MMC_MMCRIR  \ offset: 0x04 : Ethernet MMC receive interrupt register (ETH_MMCRIR)
$40028108 constant ETHERNET_MMC_MMCTIR  \ offset: 0x08 : Ethernet MMC transmit interrupt register (ETH_MMCTIR)
$4002810c constant ETHERNET_MMC_MMCRIMR  \ offset: 0x0C : Ethernet MMC receive interrupt mask register (ETH_MMCRIMR)
$40028110 constant ETHERNET_MMC_MMCTIMR  \ offset: 0x10 : Ethernet MMC transmit interrupt mask register (ETH_MMCTIMR)
