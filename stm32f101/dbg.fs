...
[ifndef] DBG_DEF
  ...
  [ifdef] DBG_CR_DEF
    ...
    $16 constant DBG_DBG_TIM15_STOP             \ [0x16] TIM15 counter stopped when core is halted
    $17 constant DBG_DBG_TIM16_STOP             \ [0x17] TIM16 counter stopped when core is halted
    $18 constant DBG_DBG_TIM17_STOP             \ [0x18] TIM17 counter stopped when core is halted
    $19 constant DBG_DBG_TIM12_STOP             \ [0x19] TIM12 counter stopped when core is halted
    $1a constant DBG_DBG_TIM13_STOP             \ [0x1a] TIM13 counter stopped when core is halted
    $1b constant DBG_DBG_TIM14_STOP             \ [0x1b] TIM14 counter stopped when core is halted
  [then]
