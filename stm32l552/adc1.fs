...
[ifndef] ADC1_DEF
  ...
  [ifdef] ADC1_CFGR_DEF
    ...
    $1f constant ADC1_JQDIS                     \ [0x1f] JQDIS
  [then]
  ...
  [ifdef] ADC1_CFGR2_DEF
    ...
    $09 constant ADC1_TOVS                      \ [0x09] EXTSEL
  ...
  [ifdef] ADC1_DR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_RDATA                     \ [0x00 : 16] regularDATA
  [then]
  ...
  [ifdef] ADC1_JDR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JDATA                     \ [0x00 : 16] JDATA1
  [then]
  ...
  [ifdef] ADC1_JDR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JDATA                     \ [0x00 : 16] JDATA2
  [then]
  ...
  [ifdef] ADC1_JDR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JDATA                     \ [0x00 : 16] JDATA3
  [then]
  ...
  [ifdef] ADC1_JDR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JDATA                     \ [0x00 : 16] JDATA4
  [then]
  ...
  [ifdef] ADC1_DIFSEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_DIFSEL_0                  \ [0x00] Differential mode for channel 0
