...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1_RMP                  \ [0x00 : 2] Input capture 1 remap
  [then]
  ...
  [ifdef] TIM16_OR2_DEF
    ...
    $08 constant TIM16_BKDF1BK1E                \ [0x08] BRK dfsdm1_break[1] enable
  ...
  $50 constant TIM16_OR1                \ TIM16 option register 1
  $60 constant TIM16_OR2                \ TIM17 option register 1
