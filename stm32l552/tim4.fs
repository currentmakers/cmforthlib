...
[ifndef] TIM4_DEF
  ...
  [ifdef] TIM4_SMCR_DEF
    ...
    $10 constant TIM4_SMS_bit3                  \ [0x10] Slave mode selection - bit 3
  [then]
  ...
  [ifdef] TIM4_CCMR1_Output_DEF
    ...
    $04 constant TIM4_OC1M                      \ [0x04 : 3] Output compare 1 mode
    ...
    $0c constant TIM4_OC2M                      \ [0x0c : 3] Output compare 2 mode
    $0f constant TIM4_OC2CE                     \ [0x0f] Output compare 2 clear enable
    $10 constant TIM4_OC1M_bit3                 \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM4_OC2M_bit3                 \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM4_CCMR2_Output_DEF
    ...
    $04 constant TIM4_OC3M                      \ [0x04 : 3] Output compare 3 mode
    ...
    $0c constant TIM4_OC4M                      \ [0x0c : 3] Output compare 4 mode
    $0f constant TIM4_OC4CE                     \ [0x0f] Output compare 4 clear enable
    $10 constant TIM4_OC3M_bit3                 \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM4_OC4M_bit3                 \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM4_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CNT_L                     \ [0x00 : 16] Least significant part of counter value
    $10 constant TIM4_CNT_H                     \ [0x10 : 15] Most significant part counter value (on TIM2 and TIM5)
    $1f constant TIM4_CNT_bit31                 \ [0x1f] Most significant bit of counter value (on TIM2 and TIM5)
  [then]
  ...
  [ifdef] TIM4_ARR_DEF
    ...
    $10 constant TIM4_ARR_H                     \ [0x10 : 16] High Auto-reload value (TIM2 only)
  [then]
  ...
  [ifdef] TIM4_CCR1_DEF
    ...
    $10 constant TIM4_CCR1_H                    \ [0x10 : 16] High Capture/Compare 1 value (TIM2 only)
  [then]
  ...
  [ifdef] TIM4_CCR2_DEF
    ...
    $10 constant TIM4_CCR2_H                    \ [0x10 : 16] High Capture/Compare 2 value (TIM2 only)
  [then]
  ...
  [ifdef] TIM4_CCR3_DEF
    ...
    $10 constant TIM4_CCR3_H                    \ [0x10 : 16] High Capture/Compare value (TIM2 only)
  [then]
  ...
  [ifdef] TIM4_CCR4_DEF
    ...
    $10 constant TIM4_CCR4_H                    \ [0x10 : 16] High Capture/Compare value (TIM2 only)
  [then]
  ...
  [ifdef] TIM4_DMAR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_DMAB                      \ [0x00 : 16] Low Capture/Compare 2 value
  [then]
