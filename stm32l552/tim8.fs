...
[ifndef] TIM8_DEF
  ...
  [ifdef] TIM8_CR2_DEF
    ...
    $0f constant TIM8_OIS5                      \ [0x0f] Output Idle state 5 (OC5 output)
    $10 constant TIM8_OIS6                      \ [0x10] Output Idle state 6
  ...
  [ifdef] TIM8_SMCR_DEF
    ...
    $10 constant TIM8_SMS_bit3                  \ [0x10] Slave mode selection - bit 3
  [then]
  ...
  [ifdef] TIM8_OR2_DEF
    ...
    $08 constant TIM8_BKDF1BK2E                 \ [0x08] BRK dfsdm1_break[2] enable
  ...
  [ifdef] TIM8_OR3_DEF
    ...
    $08 constant TIM8_BK2DFBK3E                 \ [0x08] BRK2 DFSDM_BREAK0 enable
