...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_CR_DEF
    ...
    $10 constant PWR_LPDS                       \ [0x10] Regulator in Low-power deepsleep mode This bit allows switching the regulator to low-power mode when the CPU enters Stop mode. Its behavior depends on LPSDSR bit
  [then]
