...
$00000020 constant RCC_APB2RSTR_TIM22RST                            \ TIM22 timer reset
...
$00020000 constant RCC_APB1RSTR_USART2RST                           \ USART2 reset
...
$08000000 constant RCC_APB1RSTR_CRCRST                              \ CRC reset
$10000000 constant RCC_APB1RSTR_PWRRST                              \ Power interface reset
$40000000 constant RCC_APB1RSTR_I2C3                                \ I2C3 reset
...
$00000010 constant RCC_IOPENR_IOPEEN                                \ IO port E clock enable bit
...
$00000080 constant RCC_APB2ENR_FWEN                                 \ Firewall clock enable bit
...
$00000004 constant RCC_APB1ENR_TIM3EN                               \ Timer 3 clock enbale bit
...
$00000001 constant RCC_IOPSMEN_IOPASMEN                             \ Port A clock enable during Sleep mode bit
$00000002 constant RCC_IOPSMEN_IOPBSMEN                             \ Port B clock enable during Sleep mode bit
$00000004 constant RCC_IOPSMEN_IOPCSMEN                             \ Port C clock enable during Sleep mode bit
$00000008 constant RCC_IOPSMEN_IOPDSMEN                             \ Port D clock enable during Sleep mode bit
$00000010 constant RCC_IOPSMEN_IOPESMEN                             \ Port E clock enable during Sleep mode bit
$00000080 constant RCC_IOPSMEN_IOPHSMEN                             \ Port H clock enable during Sleep mode bit
...
$01000000 constant RCC_AHBSMENR_CRYPTSMEN                           \ Crypto clock enable during sleep mode bit
...
$00000002 constant RCC_APB1SMENR_TIM3SMEN                           \ Timer 3 clock enable during sleep mode bit
...
$00080000 constant RCC_APB1SMENR_USART4SMEN                         \ USART4 clock enabe during sleep mode bit
...
$40000000 constant RCC_APB1SMENR_I2C3SMEN                           \ I2C3 clock enable during sleep mode bit
...
$00010000 constant RCC_CCIPR_I2C3SEL0                               \ I2C3 clock source selection bits
$00020000 constant RCC_CCIPR_I2C3SEL1                               \ I2C3 clock source selection bits
...
$00000004 constant RCC_CSR_LSIIWDGLP                                \ LSI clock input to IWDG in Ultra-low-power mode (Stop and Standby) enable bit
