...
[ifndef] DBG_DEF
  ...
  [ifdef] DBG_DBG_APB_FZ1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DBG_DBG_TIM2_STOP              \ [0x00] Clocking of TIM2 counter when the core is halted This bit enables/disables the clock to the counter of TIM2 when the core is halted:
    ...
    $1e constant DBG_DBG_LPTIM2_STOP            \ [0x1e] Clocking of LPTIMER2 counter when the core is halted This bit enables/disables the clock to the counter of LPTIMER2 when the core is halted:
    $1f constant DBG_DBG_LPTIM1_STOP            \ [0x1f] Clocking of LPTIMER1 counter when the core is halted This bit enables/disables the clock to the counter of LPTIMER1 when the core is halted:
  [then]
