...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_CR1_DEF
    ...
    $03 constant PWR_FPD_STOP                   \ [0x03] Flash memory powered down during Stop mode
    $04 constant PWR_FPD_LPRUN                  \ [0x04] Flash memory powered down during Low-power run mode
    $05 constant PWR_FPD_LPSLP                  \ [0x05] Flash memory powered down during Low-power sleep mode
  ...
  [ifdef] PWR_CR2_DEF
    ...
    $01 constant PWR_PVDFT                      \ [0x01 : 3] Power voltage detector falling threshold selection
    $04 constant PWR_PVDRT                      \ [0x04 : 3] Power voltage detector rising threshold selection
    $07 constant PWR_PVMENDAC                   \ [0x07] PVMENDAC
    $08 constant PWR_PVMENUSB                   \ [0x08] PVMENUSB
    $09 constant PWR_IOSV                       \ [0x09] IOSV
    $0a constant PWR_USV                        \ [0x0a] USV
  [then]
  ...
  [ifdef] PWR_CR3_DEF
    ...
    $04 constant PWR_EWUP5                      \ [0x04] Enable WKUP5 wakeup pin
    $05 constant PWR_EWUP6                      \ [0x05] Enable WKUP6 wakeup pin
    $08 constant PWR_RRS                        \ [0x08] SRAM retention in Standby mode
    $09 constant PWR_ENB_ULP                    \ [0x09] Ultra-low-power enable
  ...
  [ifdef] PWR_CR4_DEF
    ...
    $05 constant PWR_WP6                        \ [0x05] WKUP6 wakeup pin polarity
  ...
  [ifdef] PWR_SR1_DEF
    ...
    $05 constant PWR_WUF6                       \ [0x05] Wakeup flag 6
  ...
  [ifdef] PWR_SR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $07 constant PWR_FLASH_RDY                  \ [0x07] Flash ready flag
    ...
    $0c constant PWR_PVMOUSB                    \ [0x0c] USB supply voltage monitoring output flag
    $0f constant PWR_PVMODAC                    \ [0x0f] VDDA monitoring output flag
  [then]
  ...
  [ifdef] PWR_SCR_DEF
    ...
    $05 constant PWR_CWUF6                      \ [0x05] Clear wakeup flag 6
