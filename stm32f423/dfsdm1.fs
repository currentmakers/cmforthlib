\
\ @file dfsdm1.fs
\ @brief SD filter0 global interrupt
\
...
$400160c4 constant DFSDM1_CH6CFGR2  \ offset: 0xC4 : CHCFG6R2
...
$400161a0 constant DFSDM1_FLT1AWHTR  \ offset: 0x1A0 : analog watchdog high threshold register
