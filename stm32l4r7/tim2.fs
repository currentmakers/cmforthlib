...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_TIM2_CCMR1_DEF
    ...
    $02 constant TIM2_IC1PSC                    \ [0x02 : 2] Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E=0 (TIMx_CCER register).
    $04 constant TIM2_IC1F                      \ [0x04 : 4] Input capture 1 filter This bit-field defines the frequency used to sample TI1 input and the length of the digital filter applied to TI1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
  ...
  [ifdef] TIM2_TIM2_CCMR1_ALTERNATE_DEF
    \
    \ @brief TIM2 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM2_TIM2_CCMR2_ALTERNATE_DEF
    \
    \ @brief TIM2 capture/compare mode register 2
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM2_TIM2_CNT_ALTERNATE_DEF
    \
    \ @brief TIM2 counter
    \ Address offset: 0x24
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM2_TIM2_ARR_DEF
    ...
    \
    $00 constant TIM2_ARR                       \ [0x00 : 32] Low Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 25.3.1: Time-base unit on page 786 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM2_TIM2_TISEL_DEF
    ...
    $10 constant TIM2_TI3SEL                    \ [0x10 : 4] TI3[0] to TI3[15] input selection These bits select the TI3[0] to TI3[15] input source. Others: Reserved
    $18 constant TIM2_TI4SEL                    \ [0x18 : 4] TI4[0] to TI4[15] input selection These bits select the TI4[0] to TI4[15] input source. Others: Reserved
  [then]
  ...
  $18 constant TIM2_TIM2_CCMR1_ALTERNATE    \ TIM2 capture/compare mode register 1
  $1C constant TIM2_TIM2_CCMR2          \ TIM2 capture/compare mode register 2
  $1C constant TIM2_TIM2_CCMR2_ALTERNATE    \ TIM2 capture/compare mode register 2
  $20 constant TIM2_TIM2_CCER           \ TIM2 capture/compare enable register
  $24 constant TIM2_TIM2_CNT            \ TIM2 counter
  $24 constant TIM2_TIM2_CNT_ALTERNATE  \ TIM2 counter
