...
[ifndef] CAN1_DEF
  ...
  [ifdef] CAN1_FMR_DEF
    ...
    \
    $00 constant CAN1_FINIT                     \ [0x00] Filter initialization mode
    $08 constant CAN1_CANSB                     \ [0x08 : 6] CAN start bank
  [then]
  ...
  [ifdef] CAN1_FFA1R_DEF
    ...
    $0e constant CAN1_FFA14                     \ [0x0e] Filter FIFO assignment for filter
    $0f constant CAN1_FFA15                     \ [0x0f] Filter FIFO assignment for filter
    $10 constant CAN1_FFA16                     \ [0x10] Filter FIFO assignment for filter
    $11 constant CAN1_FFA17                     \ [0x11] Filter FIFO assignment for filter
    $12 constant CAN1_FFA18                     \ [0x12] Filter FIFO assignment for filter
    $13 constant CAN1_FFA19                     \ [0x13] Filter FIFO assignment for filter
    $14 constant CAN1_FFA20                     \ [0x14] Filter FIFO assignment for filter
    $15 constant CAN1_FFA21                     \ [0x15] Filter FIFO assignment for filter
    $16 constant CAN1_FFA22                     \ [0x16] Filter FIFO assignment for filter
    $17 constant CAN1_FFA23                     \ [0x17] Filter FIFO assignment for filter
    $18 constant CAN1_FFA24                     \ [0x18] Filter FIFO assignment for filter
    $19 constant CAN1_FFA25                     \ [0x19] Filter FIFO assignment for filter
    $1a constant CAN1_FFA26                     \ [0x1a] Filter FIFO assignment for filter
    $1b constant CAN1_FFA27                     \ [0x1b] Filter FIFO assignment for filter
  [then]
