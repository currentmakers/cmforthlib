...
[ifndef] OTG_HS_HOST_DEF
  ...
  [ifdef] OTG_HS_HOST_OTG_HS_HCCHAR0_DEF
    ...
    $14 constant OTG_HS_HOST_MC                 \ [0x14 : 2] Multi Count (MC) / Error Count (EC)
  ...
  [ifdef] OTG_HS_HOST_OTG_HS_HCINTMSK12_DEF
    ...
    $05 constant OTG_HS_HOST_ACKM               \ [0x05] ACK response received/transmitted interrupt mask
    $06 constant OTG_HS_HOST_NYET               \ [0x06] Response received interrupt
    $07 constant OTG_HS_HOST_TXERRM             \ [0x07] Transaction error
    $08 constant OTG_HS_HOST_BBERRM             \ [0x08] Babble error
    $09 constant OTG_HS_HOST_FRMORM             \ [0x09] Frame overrun mask
    $0a constant OTG_HS_HOST_DTERRM             \ [0x0a] Data toggle error mask
  [then]
  ...
  [ifdef] OTG_HS_HOST_OTG_HS_HCINTMSK13_DEF
    ...
    $01 constant OTG_HS_HOST_CHHM               \ [0x01] Channel halted mask
    $02 constant OTG_HS_HOST_AHBERR             \ [0x02] AHB error
    $03 constant OTG_HS_HOST_STALLM             \ [0x03] STALLM response received interrupt mask
    $04 constant OTG_HS_HOST_NAKM               \ [0x04] NAK response received interrupt mask
    $05 constant OTG_HS_HOST_ACKM               \ [0x05] ACK response received/transmitted interrupt mask
    $06 constant OTG_HS_HOST_NYET               \ [0x06] Response received interrupt
    $07 constant OTG_HS_HOST_TXERRM             \ [0x07] Transaction error
  ...
  [ifdef] OTG_HS_HOST_OTG_HS_HCINTMSK14_DEF
    ...
    $02 constant OTG_HS_HOST_AHBERR             \ [0x02] AHB error
    $03 constant OTG_HS_HOST_STALLM             \ [0x03] STALL response received interrupt mask
    $04 constant OTG_HS_HOST_NAKM               \ [0x04] NAKM response received interrupt mask
    $05 constant OTG_HS_HOST_ACKM               \ [0x05] ACKM response received/transmitted interrupt mask
    $06 constant OTG_HS_HOST_NYET               \ [0x06] Response received interrupt
    $07 constant OTG_HS_HOST_TXERRM             \ [0x07] Transaction error
    $08 constant OTG_HS_HOST_BBERRM             \ [0x08] Babble error
    $09 constant OTG_HS_HOST_FRMORM             \ [0x09] Frame overrun mask
  ...
  [ifdef] OTG_HS_HOST_OTG_HS_HCINTMSK15_DEF
    ...
    $01 constant OTG_HS_HOST_CHHM               \ [0x01] Channel halted mask
    $02 constant OTG_HS_HOST_AHBERR             \ [0x02] AHB error
    $03 constant OTG_HS_HOST_STALL              \ [0x03] STALL response received interrupt mask
    $04 constant OTG_HS_HOST_NAKM               \ [0x04] NAK response received interrupt mask
    $05 constant OTG_HS_HOST_ACKM               \ [0x05] ACK response received/transmitted interrupt mask
    $06 constant OTG_HS_HOST_NYET               \ [0x06] Response received interrupt
    $07 constant OTG_HS_HOST_TXERRM             \ [0x07] Transaction error
  ...
  $278 constant OTG_HS_HOST_OTG_HS_HCCHAR12    \ OTG_HS host channel-12 characteristics register
  $27C constant OTG_HS_HOST_OTG_HS_HCSPLT12    \ OTG_HS host channel-12 split control register
  $280 constant OTG_HS_HOST_OTG_HS_HCINT12    \ OTG_HS host channel-12 interrupt register
  $284 constant OTG_HS_HOST_OTG_HS_HCINTMSK12    \ OTG_HS host channel-12 interrupt mask register
  $288 constant OTG_HS_HOST_OTG_HS_HCTSIZ12    \ OTG_HS host channel-12 transfer size register
  $28C constant OTG_HS_HOST_OTG_HS_HCDMA12    \ OTG_HS host channel-12 DMA address register
  $290 constant OTG_HS_HOST_OTG_HS_HCCHAR13    \ OTG_HS host channel-13 characteristics register
  $294 constant OTG_HS_HOST_OTG_HS_HCSPLT13    \ OTG_HS host channel-13 split control register
  $298 constant OTG_HS_HOST_OTG_HS_HCINT13    \ OTG_HS host channel-13 interrupt register
  $29C constant OTG_HS_HOST_OTG_HS_HCINTMSK13    \ OTG_HS host channel-13 interrupt mask register
  $2A0 constant OTG_HS_HOST_OTG_HS_HCTSIZ13    \ OTG_HS host channel-13 transfer size register
  $2A4 constant OTG_HS_HOST_OTG_HS_HCDMA13    \ OTG_HS host channel-13 DMA address register
  $2A8 constant OTG_HS_HOST_OTG_HS_HCCHAR14    \ OTG_HS host channel-14 characteristics register
  $2AC constant OTG_HS_HOST_OTG_HS_HCSPLT14    \ OTG_HS host channel-14 split control register
  $2B0 constant OTG_HS_HOST_OTG_HS_HCINT14    \ OTG_HS host channel-14 interrupt register
  $2B4 constant OTG_HS_HOST_OTG_HS_HCINTMSK14    \ OTG_HS host channel-14 interrupt mask register
  $2B8 constant OTG_HS_HOST_OTG_HS_HCTSIZ14    \ OTG_HS host channel-14 transfer size register
  $2BC constant OTG_HS_HOST_OTG_HS_HCDMA14    \ OTG_HS host channel-14 DMA address register
  $2C0 constant OTG_HS_HOST_OTG_HS_HCCHAR15    \ OTG_HS host channel-15 characteristics register
  $2C4 constant OTG_HS_HOST_OTG_HS_HCSPLT15    \ OTG_HS host channel-15 split control register
  $2C8 constant OTG_HS_HOST_OTG_HS_HCINT15    \ OTG_HS host channel-15 interrupt register
  $2CC constant OTG_HS_HOST_OTG_HS_HCINTMSK15    \ OTG_HS host channel-15 interrupt mask register
  $2D0 constant OTG_HS_HOST_OTG_HS_HCTSIZ15    \ OTG_HS host channel-15 transfer size register
  $2D4 constant OTG_HS_HOST_OTG_HS_HCDMA15    \ OTG_HS host channel-15 DMA address register
