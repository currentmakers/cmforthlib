...
[ifndef] GPIO_DEF
  ...
  [ifdef] GPIO_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIO_BR0                       \ [0x00] Port D Reset bit 0
    $01 constant GPIO_BR1                       \ [0x01] Port D Reset bit 1
    $02 constant GPIO_BR2                       \ [0x02] Port D Reset bit 2
    $03 constant GPIO_BR3                       \ [0x03] Port D Reset bit 3
    $04 constant GPIO_BR4                       \ [0x04] Port D Reset bit 4
    $05 constant GPIO_BR5                       \ [0x05] Port D Reset bit 5
    $06 constant GPIO_BR6                       \ [0x06] Port D Reset bit 6
    $07 constant GPIO_BR7                       \ [0x07] Port D Reset bit 7
    $08 constant GPIO_BR8                       \ [0x08] Port D Reset bit 8
    $09 constant GPIO_BR9                       \ [0x09] Port D Reset bit 9
    $0a constant GPIO_BR10                      \ [0x0a] Port D Reset bit 10
    $0b constant GPIO_BR11                      \ [0x0b] Port D Reset bit 11
    $0c constant GPIO_BR12                      \ [0x0c] Port D Reset bit 12
    $0d constant GPIO_BR13                      \ [0x0d] Port D Reset bit 13
    $0e constant GPIO_BR14                      \ [0x0e] Port D Reset bit 14
    $0f constant GPIO_BR15                      \ [0x0f] Port D Reset bit 15
  [then]
  ...
  $20 constant GPIO_AFRL                \ GPIO alternate function lowregister
