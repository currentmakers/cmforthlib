...
[ifndef] COMP1_DEF
  ...
  \ @brief COMP1
  \
  $00 constant COMP1_COMP1_SR           \ Comparator status register
  $04 constant COMP1_COMP1_ICFR         \ Comparator interrupt clear flag register
  $08 constant COMP1_COMP1_OR           \ Comparator option register
  $0C constant COMP1_COMP1_CFGR1        \ Comparator configuration register 1
  $10 constant COMP1_COMP1_CFGR2        \ Comparator configuration register 2
