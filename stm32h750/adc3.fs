...
[ifndef] ADC3_DEF
  ...
  [ifdef] ADC3_CCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $10 constant ADC3_CKMODE                    \ [0x10 : 2] ADC clock mode
    $12 constant ADC3_PRESC                     \ [0x12 : 4] ADC prescaler
    $16 constant ADC3_VREFEN                    \ [0x16] VREFINT enable
    $17 constant ADC3_VSENSEEN                  \ [0x17] Temperature sensor enable
    $18 constant ADC3_VBATEN                    \ [0x18] VBAT enable
  [then]
  ...
  [ifdef] ADC3_CFGR_DEF
    ...
    $02 constant ADC3_RES                       \ [0x02 : 2] ADC data resolution
  ...
  $08 constant ADC3_CCR                 \ ADC common control register
