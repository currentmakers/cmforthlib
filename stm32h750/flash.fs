...
$00000000 constant FLASH_KEYR1_KEY1R                                \ Bank 1 access configuration unlock key
...
$02000000 constant FLASH_CR1_SNECCERR1                              \ Bank 1 ECC single correction error interrupt enable bit
...
$10000000 constant FLASH_CR1_CRCRDERRIE1                            \ Bank 1 CRC read error interrupt enable bit When CRCRDERRIE1 bit is set to 1, an interrupt is generated when a protected area (PCROP or secure-only) has been detected during the last CRC computation on bank 1. CRCRDERRIE1 can be programmed only when LOCK1 is cleared to 0.
...
$02000000 constant FLASH_SR1_SNECCERR                               \ Bank 1 single correction error flag
...
$10000000 constant FLASH_SR1_CRCRDERR1                              \ Bank 1 CRC read error flag CRCRDERR1 flag is raised when a word is found read protected during a CRC operation on bank 1. An interrupt is generated if CRCRDIE1 and CRCEND1 are set to 1. Writing 1 to CLR_CRCRDERR1 bit in FLASH_CCR1 register clears CRCRDERR1. Note: This flag is valid only when CRCEND1 bit is set to 1
...
$10000000 constant FLASH_CCR1_CLR_CRCRDERR1                         \ Bank 1 CRCRDERR1 flag clear bit Setting this bit to 1 resets to 0 CRCRDERR1 flag in FLASH_SR1 register.
...
$000ffffc constant FLASH_CRCSADD1R_CRC_START_ADDR                   \ CRC start address on bank 1
...
$000ffffc constant FLASH_CRCEADD1R_CRC_END_ADDR                     \ CRC end address on bank 1
...
$0000000f constant FLASH_ACR__LATENCY                               \ Read latency
...
$00004000 constant FLASH_CR2_SPSS2                                  \ Bank 2 special sector selection bit
...
$10000000 constant FLASH_CR2_CRCRDERRIE2                            \ Bank 2 CRC read error interrupt enable bit
...
$00000010 constant FLASH_OPTSR_CUR__IWDG1_SW                        \ IWDG1 control option status bit
...
$00020000 constant FLASH_OPTSR_CUR__IWDG_FZ_STOP                    \ IWDG Stop mode freeze option status bit
$00040000 constant FLASH_OPTSR_CUR__IWDG_FZ_SDBY                    \ IWDG Standby mode freeze option status bit
...
$00000010 constant FLASH_OPTSR_PRG__IWDG1_SW                        \ IWDG1 option configuration bit
$00000040 constant FLASH_OPTSR_PRG__NRST_STOP                       \ Option byte erase after D1 DStop option configuration bit
$00000080 constant FLASH_OPTSR_PRG__NRST_STDY                       \ Option byte erase after D1 DStandby option configuration bit
...
$0000ffff constant FLASH_BOOT_CURR__BOOT_ADD0                       \ Boot address 0
$ffff0000 constant FLASH_BOOT_CURR__BOOT_ADD1                       \ Boot address 1
...
$0000ffff constant FLASH_BOOT_PRGR__BOOT_ADD0                       \ Boot address 0
$ffff0000 constant FLASH_BOOT_PRGR__BOOT_ADD1                       \ Boot address 1
...
$000ffffc constant FLASH_CRCSADD2R_CRC_START_ADDR                   \ CRC start address on bank 2
...
$000ffffc constant FLASH_CRCEADD2R_CRC_END_ADDR                     \ CRC end address on bank 2
...
$00000000 constant FLASH_CRCDATAR__CRC_DATA                         \ CRC result
...
$5200212c constant FLASH_PRAR_PRG2  \ offset: 0x12C : FLASH protection address for bank 2
...
$52002140 constant FLASH_BOOT_CURR_  \ offset: 0x140 : FLASH register with boot address
$52002144 constant FLASH_BOOT_PRGR_  \ offset: 0x144 : FLASH register with boot address
...
$5200215c constant FLASH_CRCDATAR_  \ offset: 0x15C : FLASH CRC data register
