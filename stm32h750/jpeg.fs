...
[ifndef] JPEG_DEF
  ...
  $10 constant JPEG_JPEG_CONFRN1        \ JPEG codec configuration register 4-7
  $14 constant JPEG_JPEG_CONFRN2        \ JPEG codec configuration register 4-7
  $18 constant JPEG_JPEG_CONFRN3        \ JPEG codec configuration register 4-7
  $1C constant JPEG_JPEG_CONFRN4        \ JPEG codec configuration register 4-7
