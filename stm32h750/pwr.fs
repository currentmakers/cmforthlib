...
$00100000 constant PWR_PWR_CR2_VBATL                                \ VBAT level monitoring versus low threshold
$00200000 constant PWR_PWR_CR2_VBATH                                \ VBAT level monitoring versus high threshold
...
$00000004 constant PWR_PWR_CR3_SDEN                                 \ SD converter Enable
...
$00000001 constant PWR_PWR_CPUCR_PDDS_D1                            \ D1 domain Power Down Deepsleep selection. This bit allows CPU1 to define the Deepsleep mode for D1 domain.
$00000002 constant PWR_PWR_CPUCR_PDDS_D2                            \ D2 domain Power Down Deepsleep. This bit allows CPU1 to define the Deepsleep mode for D2 domain.
$00000004 constant PWR_PWR_CPUCR_PDDS_D3                            \ System D3 domain Power Down Deepsleep. This bit allows CPU1 to define the Deepsleep mode for System D3 domain.
...
$00000080 constant PWR_PWR_CPUCR_SBF_D1                             \ D1 domain DStandby flag This bit is set by hardware and cleared by any system reset or by setting the CPU1 CSSF bit. Once set, this bit can be cleared only when the D1 domain is no longer in DStandby mode.
$00000100 constant PWR_PWR_CPUCR_SBF_D2                             \ D2 domain DStandby flag This bit is set by hardware and cleared by any system reset or by setting the CPU1 CSSF bit. Once set, this bit can be cleared only when the D2 domain is no longer in DStandby mode.
...
$00000800 constant PWR_PWR_CPUCR_RUN_D3                             \ Keep system D3 domain in Run mode regardless of the CPU sub-systems modes
...
$00002000 constant PWR_PWR_D3CR_VOSRDY                              \ VOS Ready bit for VCORE voltage scaling output selection. This bit is set to 1 by hardware when Bypass mode is selected in PWR control register 3 (PWR_CR3).
$0000c000 constant PWR_PWR_D3CR_VOS                                 \ Voltage scaling selection according to performance These bits control the VCORE voltage level and allow to obtains the best trade-off between power consumption and performance: When increasing the performance, the voltage scaling shall be changed before increasing the system frequency. When decreasing performance, the system frequency shall first be decreased before changing the voltage scaling.
...
$0000003f constant PWR_PWR_WKUPCR_WKUPC                             \ Clear Wakeup pin flag for WKUP. These bits are always read as 0.
...
$58024818 constant PWR_PWR_D3CR   \ offset: 0x18 : This register allows controlling D3 domain power.Following reset VOSRDY will be read 1 by software
