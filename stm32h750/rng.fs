...
\ @brief RNG
\
$48021800 constant RNG_RNG_CR     \ offset: 0x00 : RNG control register
$48021804 constant RNG_RNG_SR     \ offset: 0x04 : RNG status register
$48021808 constant RNG_RNG_DR     \ offset: 0x08 : The RNG_DR register is a read-only register that delivers a 32-bit random value when read. The content of this register is valid when DRDY= 1, even if RNGEN=0.
