...
[ifndef] DBGMCU_DEF
  ...
  [ifdef] DBGMCU_APB1L_FZ_DEF
    ...
    $1e constant DBGMCU_DBG_I2C3_STOP           \ [0x1e] I2C3 SMBUS timeout mode stopped when core is halted
    $1f constant DBGMCU_DBG_LPTIMER_STOP        \ [0x1f] LPTIM1 counter stopped when core is halted
  [then]


  [ifdef] DBGMCU_APB1H_FZ_DEF
    \
    \ @brief APB Low Freeze Register 2
    \ Address offset: 0x0C
    \ Reset value: 0x00000000
    \
    $01 constant DBGMCU_DBG_I2C4_STOP           \ [0x01] DBG_I2C4_STOP
  [then]
  ...
  [ifdef] DBGMCU_APB2_FZ_DEF
    ...
    $14 constant DBGMCU_DBG_TIM20_STOP          \ [0x14] TIM20counter stopped when core is halted
    $1a constant DBGMCU_DBG_HRTIM0_STOP         \ [0x1a] DBG_HRTIM0_STOP
    $1b constant DBGMCU_DBG_HRTIM1_STOP         \ [0x1b] DBG_HRTIM0_STOP
    $1c constant DBGMCU_DBG_HRTIM2_STOP         \ [0x1c] DBG_HRTIM0_STOP
    $1d constant DBGMCU_DBG_HRTIM3_STOP         \ [0x1d] DBG_HRTIM0_STOP
  [then]
  ...
  $08 constant DBGMCU_APB1L_FZ          \ APB Low Freeze Register 1
  $0C constant DBGMCU_APB1H_FZ          \ APB Low Freeze Register 2
  $10 constant DBGMCU_APB2_FZ           \ APB High Freeze Register
