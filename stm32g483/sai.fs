...
[ifndef] SAI_DEF
  ...
  [ifdef] SAI_ACR1_DEF
    ...
    $0d constant SAI_OutDri                     \ [0x0d] Output drive
    $10 constant SAI_SAIAEN                     \ [0x10] Audio block A enable
    $11 constant SAI_DMAEN                      \ [0x11] DMA enable
    $13 constant SAI_NODIV                      \ [0x13] No divider
    $14 constant SAI_MCJDIV                     \ [0x14 : 6] Master clock divider
  ...
  [ifdef] SAI_AIM_DEF
    ...
    $01 constant SAI_MUTEDET                    \ [0x01] Mute detection interrupt enable
    $02 constant SAI_WCKCFG                     \ [0x02] Wrong clock configuration interrupt enable
    ...
    $06 constant SAI_LFSDET                     \ [0x06] Late frame synchronization detection interrupt enable
  [then]
  ...
  [ifdef] SAI_ACLRFR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SAI_OVRUDR                     \ [0x00] Clear overrun / underrun
    $01 constant SAI_MUTEDET                    \ [0x01] Mute detection flag
    $02 constant SAI_WCKCFG                     \ [0x02] Clear wrong clock configuration flag
    $04 constant SAI_CNRDY                      \ [0x04] Clear codec not ready flag
    $05 constant SAI_CAFSDET                    \ [0x05] Clear anticipated frame synchronization detection flag
    $06 constant SAI_LFSDET                     \ [0x06] Clear late frame synchronization detection flag
  [then]
  ...
  [ifdef] SAI_BCR1_DEF
    ...
    $0c constant SAI_MONO                       \ [0x0c] Mono mode
    $0d constant SAI_OutDri                     \ [0x0d] Output drive
    $10 constant SAI_SAIBEN                     \ [0x10] Audio block B enable
    $11 constant SAI_DMAEN                      \ [0x11] DMA enable
    $13 constant SAI_NODIV                      \ [0x13] No divider
    $14 constant SAI_MCJDIV                     \ [0x14 : 6] Master clock divider
    $1a constant SAI_OSR                        \ [0x1a] OSR
  ...
  $44 constant SAI_PDMCR                \ PDM control register
  $48 constant SAI_PDMDLY               \ PDM delay register
