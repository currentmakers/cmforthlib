...
[ifndef] TIM15_DEF
  ...
  [ifdef] TIM15_SMCR_DEF
    ...
    $14 constant TIM15_TS_4_3                   \ [0x14 : 2] Trigger selection - bit 4:3
  [then]
  ...
  [ifdef] TIM15_CCMR1_Output_DEF
    ...
    $07 constant TIM15_OC1CE                    \ [0x07] OC1CE
    $08 constant TIM15_CC2S                     \ [0x08 : 2] CC2S
    $0a constant TIM15_OC2FE                    \ [0x0a] OC2FE
    $0b constant TIM15_OC2PE                    \ [0x0b] OC2PE
    $0c constant TIM15_OC2M                     \ [0x0c : 3] OC2M
    $10 constant TIM15_OC1M_3                   \ [0x10] Output Compare 1 mode
  ...
  [ifdef] TIM15_CCMR1_Input_DEF
    ...
    $08 constant TIM15_CC2S                     \ [0x08 : 2] CC2S
    $0a constant TIM15_IC2PSC                   \ [0x0a : 2] IC2PSC
    $0c constant TIM15_IC2F                     \ [0x0c : 4] IC2F
  [then]
  ...
  [ifdef] TIM15_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM15_CCR2                     \ [0x00 : 16] Capture/Compare 1 value
  [then]
  ...
  [ifdef] TIM15_DTR2_DEF
    \
    \ @brief timer Deadtime Register 2
    \ Address offset: 0x54
    \ Reset value: 0x00000000
    \
    $00 constant TIM15_DTGF                     \ [0x00 : 8] Dead-time generator setup
  ...
  [ifdef] TIM15_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM15_TI1SEL                   \ [0x00 : 4] TI1[0] to TI1[15] input selection
    $08 constant TIM15_TI2SEL                   \ [0x08 : 4] TI2[0] to TI2[15] input selection
  [then]
  ...
  [ifdef] TIM15_AF1_DEF
    ...
    $03 constant TIM15_BKCMP3E                  \ [0x03] BRK COMP3 enable
    $04 constant TIM15_BKCMP4E                  \ [0x04] BRK COMP4 enable
    $05 constant TIM15_BKCMP5E                  \ [0x05] BRK COMP5 enable
    $06 constant TIM15_BKCMP6E                  \ [0x06] BRK COMP6 enable
    $07 constant TIM15_BKCMP7E                  \ [0x07] BRK COMP7 enable
    ...
    $0c constant TIM15_BKCMP3P                  \ [0x0c] BRK COMP3 input polarity
    $0d constant TIM15_BKCMP4P                  \ [0x0d] BRK COMP4 input polarity
  [then]
  ...
  $54 constant TIM15_DTR2               \ timer Deadtime Register 2
  $5C constant TIM15_TISEL              \ TIM timer input selection register
  $60 constant TIM15_AF1                \ TIM alternate function option register 1
  $64 constant TIM15_AF2                \ TIM alternate function option register 2
  $3DC constant TIM15_DCR               \ DMA control register
  $3E0 constant TIM15_DMAR              \ DMA address for full transfer
