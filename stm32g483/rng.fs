...
\ @brief Random number generator
\
$50060800 constant RNG_CR         \ offset: 0x00 : control register
$50060804 constant RNG_SR         \ offset: 0x04 : status register
$50060808 constant RNG_DR         \ offset: 0x08 : data register
