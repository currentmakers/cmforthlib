...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_SMCR_DEF
    ...
    $04 constant TIM1_TS_4                      \ [0x04 : 3] Trigger selection
    ...
    $14 constant TIM1_TS                        \ [0x14 : 2] Trigger selection
  [then]
  ...
  [ifdef] TIM1_BDTR_DEF
    ...
    $1d constant TIM1_BK2ID                     \ [0x1d] Break2 bidirectional
  [then]
  ...
  [ifdef] TIM1_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_OCREF_CLR                 \ [0x00] Ocref_clr source selection
  [then]
  ...
  [ifdef] TIM1_AF1_DEF
    ...
    $0e constant TIM1_ETRSEL                    \ [0x0e : 3] ETR source selection
  [then]
  ...
  [ifdef] TIM1_AF2_DEF
    ...
    $08 constant TIM1_BK2DFBK0E                 \ [0x08] BRK2 DFSDM_BREAK0 enable
  ...
  [ifdef] TIM1_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_TI1SEL3_0                 \ [0x00 : 4] selects TI1[0] to TI1[15] input
    $08 constant TIM1_TI2SEL3_0                 \ [0x08 : 4] selects TI2[0] to TI2[15] input
    $10 constant TIM1_TI3SEL3_0                 \ [0x10 : 4] selects TI3[0] to TI3[15] input
    $18 constant TIM1_TI4SEL3_0                 \ [0x18 : 4] selects TI4[0] to TI4[15] input
  [then]
  ...
  $58 constant TIM1_CCR5                \ capture/compare register 4
  $5C constant TIM1_CCR6                \ capture/compare register 4
  $60 constant TIM1_AF1                 \ DMA address for full transfer
  $64 constant TIM1_AF2                 \ DMA address for full transfer
  $68 constant TIM1_TISEL               \ TIM1 timer input selection register
