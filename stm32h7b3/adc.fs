...
[ifndef] ADC_DEF
  ...
  [ifdef] ADC_CR_DEF
    ...
    $08 constant ADC_BOOST                      \ [0x08] Boost mode control
    $10 constant ADC_ADCALLIN                   \ [0x10] Linearity calibration
    $16 constant ADC_LINCALRDYW1                \ [0x16] Linearity calibration ready Word 1
    $17 constant ADC_LINCALRDYW2                \ [0x17] Linearity calibration ready Word 2
    $18 constant ADC_LINCALRDYW3                \ [0x18] Linearity calibration ready Word 3
    $19 constant ADC_LINCALRDYW4                \ [0x19] Linearity calibration ready Word 4
    $1a constant ADC_LINCALRDYW5                \ [0x1a] Linearity calibration ready Word 5
    $1b constant ADC_LINCALRDYW6                \ [0x1b] Linearity calibration ready Word 6
  ...
  [ifdef] ADC_CFGR_DEF
    ...
    \
    $00 constant ADC_DMNGT                      \ [0x00 : 2] ADC DMA transfer enable
    $02 constant ADC_RES                        \ [0x02 : 2] ADC data resolution
    $05 constant ADC_EXTSEL                     \ [0x05 : 5] ADC group regular external trigger source
  ...
  [ifdef] ADC_CFGR2_DEF
    ...
    $09 constant ADC_TROVS                      \ [0x09] ADC oversampling discontinuous mode (triggered mode) for ADC group regular
    $0a constant ADC_ROVSM                      \ [0x0a] Regular Oversampling mode
    $0b constant ADC_RSHIFT1                    \ [0x0b] Right-shift data after Offset 1 correction
    $0c constant ADC_RSHIFT2                    \ [0x0c] Right-shift data after Offset 2 correction
    $0d constant ADC_RSHIFT3                    \ [0x0d] Right-shift data after Offset 3 correction
    $0e constant ADC_RSHIFT4                    \ [0x0e] Right-shift data after Offset 4 correction
  ...
  [ifdef] ADC_SMPR2_DEF
    ...
    $1b constant ADC_SMP19                      \ [0x1b : 3] ADC channel 18 sampling time selection
  [then]
  ...
  [ifdef] ADC_PCSEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_PCSEL                      \ [0x00 : 20] Channel x (VINP[i]) pre selection
  [then]
  ...
  [ifdef] ADC_LTR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_LTR1                       \ [0x00 : 26] ADC analog watchdog 1 threshold low
  [then]
  ...
  [ifdef] ADC_LHTR1_DEF
    ...
    \
    $00 constant ADC_LHTR1                      \ [0x00 : 26] ADC analog watchdog 2 threshold low
  [then]
  ...
  [ifdef] ADC_DR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_RDATA                      \ [0x00 : 16] ADC group regular conversion data
  [then]
  ...
  [ifdef] ADC_JSQR_DEF
    ...
    $02 constant ADC_JEXTSEL                    \ [0x02 : 5] ADC group injected external trigger source
    $07 constant ADC_JEXTEN                     \ [0x07 : 2] ADC group injected external trigger polarity
    $09 constant ADC_JSQ1                       \ [0x09 : 5] ADC group injected sequencer rank 1
    $0f constant ADC_JSQ2                       \ [0x0f : 5] ADC group injected sequencer rank 2
    $15 constant ADC_JSQ3                       \ [0x15 : 5] ADC group injected sequencer rank 3
    $1b constant ADC_JSQ4                       \ [0x1b : 5] ADC group injected sequencer rank 4
  [then]
  ...
  [ifdef] ADC_OFR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_OFFSET1                    \ [0x00 : 26] ADC offset number 1 offset level
    $1a constant ADC_OFFSET1_CH                 \ [0x1a : 5] ADC offset number 1 channel selection
    $1f constant ADC_SSATE                      \ [0x1f] ADC offset number 1 enable
  [then]
  ...
  [ifdef] ADC_JDR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_JDATA1                     \ [0x00 : 32] ADC group injected sequencer rank 1 conversion data
  [then]
  ...
  [ifdef] ADC_JDR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_JDATA2                     \ [0x00 : 32] ADC group injected sequencer rank 2 conversion data
  [then]
  ...
  [ifdef] ADC_JDR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_JDATA3                     \ [0x00 : 32] ADC group injected sequencer rank 3 conversion data
  [then]
  ...
  [ifdef] ADC_JDR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_JDATA4                     \ [0x00 : 32] ADC group injected sequencer rank 4 conversion data
  [then]
  ...
  [ifdef] ADC_AWD2CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_AWD2CH                     \ [0x00 : 20] ADC analog watchdog 2 monitored channel selection
  [then]
  ...
  [ifdef] ADC_AWD3CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $01 constant ADC_AWD3CH                     \ [0x01 : 20] ADC analog watchdog 3 monitored channel selection
  [then]
  ...
  [ifdef] ADC_LTR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_LTR2                       \ [0x00 : 26] Analog watchdog 2 lower threshold
  [then]
  ...
  [ifdef] ADC_HTR2_DEF
    ...
    \ Reset value: 0x03FFFFFF
    \
    $00 constant ADC_HTR2                       \ [0x00 : 26] Analog watchdog 2 higher threshold
  [then]
  ...
  [ifdef] ADC_LTR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_LTR3                       \ [0x00 : 26] Analog watchdog 3 lower threshold
  [then]
  ...
  [ifdef] ADC_HTR3_DEF
    ...
    \ Reset value: 0x03FFFFFF
    \
    $00 constant ADC_HTR3                       \ [0x00 : 26] Analog watchdog 3 higher threshold
  [then]
  ...
  [ifdef] ADC_DIFSEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_DIFSEL                     \ [0x00 : 20] ADC channel differential or single-ended mode for channel
  [then]
  ...
  [ifdef] ADC_CALFACT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_CALFACT_S                  \ [0x00 : 11] ADC calibration factor in single-ended mode
    $10 constant ADC_CALFACT_D                  \ [0x10 : 11] ADC calibration factor in differential mode
  [then]


  [ifdef] ADC_CALFACT2_DEF
    \
    \ @brief ADC Calibration Factor register 2
    \ Address offset: 0xC8
    \ Reset value: 0x00000000
    \
    $00 constant ADC_LINCALFACT                 \ [0x00 : 30] Linearity Calibration Factor
  [then]
  ...
  $1C constant ADC_PCSEL                \ ADC pre channel selection register
  $20 constant ADC_LTR1                 \ ADC analog watchdog 1 threshold register
  $24 constant ADC_LHTR1                \ ADC analog watchdog 2 threshold register
  ...
  $B0 constant ADC_LTR2                 \ ADC watchdog lower threshold register 2
  $B4 constant ADC_HTR2                 \ ADC watchdog higher threshold register 2
  $B8 constant ADC_LTR3                 \ ADC watchdog lower threshold register 3
  $BC constant ADC_HTR3                 \ ADC watchdog higher threshold register 3
  $C0 constant ADC_DIFSEL               \ ADC channel differential or single-ended mode selection register
  $C4 constant ADC_CALFACT              \ ADC calibration factors register
  $C8 constant ADC_CALFACT2             \ ADC Calibration Factor register 2
