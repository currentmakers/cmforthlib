...
[ifndef] TIM8_DEF
  ...
  [ifdef] TIM8_CR2_DEF
    ...
    $10 constant TIM8_OIS5                      \ [0x10] Output Idle state 5
    $12 constant TIM8_OIS6                      \ [0x12] Output Idle state 6
  ...
  [ifdef] TIM8_SMCR_DEF
    ...
    $10 constant TIM8_SMS_3                     \ [0x10] Slave mode selection - bit 3
    $14 constant TIM8_TS_4_3                    \ [0x14 : 2] Trigger selection - bit 4:3
  [then]
  ...
  [ifdef] TIM8_CCMR1_Output_DEF
    ...
    $10 constant TIM8_OC1M_3                    \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM8_OC2M_3                    \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM8_CCMR2_Output_DEF
    ...
    $10 constant TIM8_OC3M_3                    \ [0x10] Output Compare 3 mode - bit 3
    $18 constant TIM8_OC4M_4                    \ [0x18] Output Compare 4 mode - bit 3
  [then]
  ...
  [ifdef] TIM8_CCMR3_Output_DEF
    ...
    $10 constant TIM8_OC5M3                     \ [0x10] Output Compare 5 mode
    $18 constant TIM8_OC6M3                     \ [0x18] Output Compare 6 mode
  [then]
  ...
  [ifdef] TIM8_CCR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_CCR5                      \ [0x00 : 16] Capture/Compare 5 value
  ...
  [ifdef] TIM8_CRR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_CCR6                      \ [0x00 : 16] Capture/Compare 6 value
  [then]
  ...
  [ifdef] TIM8_AF1_DEF
    ...
    $08 constant TIM8_BKDF1BK0E                 \ [0x08] BRK dfsdm1_break[0] enable
    ...
    $0e constant TIM8_ETRSEL                    \ [0x0e : 4] ETR source selection
  [then]
  ...
  [ifdef] TIM8_AF2_DEF
    ...
    $08 constant TIM8_BK2DF1BK1E                \ [0x08] BRK2 dfsdm1_break[1] enable
    $09 constant TIM8_BK2INP                    \ [0x09] BRK2 BKIN2 input polarity
    $0a constant TIM8_BK2CMP1P                  \ [0x0a] BRK2 COMP1 input polarit
    $0b constant TIM8_BK2CMP2P                  \ [0x0b] BRK2 COMP2 input polarity
  [then]


  [ifdef] TIM8_TISEL_DEF
    \
    \ @brief TIM1 timer input selection register
    \ Address offset: 0x68
    \ Reset value: 0x00000000
    \
    $00 constant TIM8_TI1SEL                    \ [0x00 : 4] selects TI1[0] to TI1[15] input
    $08 constant TIM8_TI2SEL                    \ [0x08 : 4] selects TI2[0] to TI2[15] input
    $10 constant TIM8_TI3SEL                    \ [0x10 : 4] selects TI3[0] to TI3[15] input
    $18 constant TIM8_TI4SEL                    \ [0x18 : 4] selects TI4[0] to TI4[15] input
  [then]
  ...
  $54 constant TIM8_CCMR3_OUTPUT        \ capture/compare mode register 3 (output mode)
  $58 constant TIM8_CCR5                \ capture/compare register 5
  $5C constant TIM8_CRR6                \ capture/compare register 6
  $60 constant TIM8_AF1                 \ TIM1 alternate function option register 1
  $64 constant TIM8_AF2                 \ TIM1 Alternate function odfsdm1_breakster 2
  $68 constant TIM8_TISEL               \ TIM1 timer input selection register
