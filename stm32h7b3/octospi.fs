...
[ifndef] OCTOSPI_DEF
  ...
  [ifdef] OCTOSPI_DCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_REFRESH                \ [0x00 : 16] Refresh rate
  [then]
  ...
  [ifdef] OCTOSPI_WCCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant OCTOSPI_IMODE                  \ [0x00 : 2] Instruction mode
    $02 constant OCTOSPI_IDTR                   \ [0x02] Instruction double transfer rate
    $03 constant OCTOSPI_ISIZE                  \ [0x03] Instruction size
    $08 constant OCTOSPI_ADMODE                 \ [0x08 : 3] Address mode
    $0b constant OCTOSPI_ADDTR                  \ [0x0b] Address double transfer rate
    $0c constant OCTOSPI_ADSIZE                 \ [0x0c : 2] Address size
    $10 constant OCTOSPI_ABMODE                 \ [0x10 : 3] Alternate-byte mode
  ...
  $190 constant OCTOSPI_WIR             \ instruction register
