...
$00000070 constant TIM8_TIM8_SMCR_TS                                \ TS[0]: Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See Table 167: TIMxTIM1 internal trigger connection on page 777 for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00003000 constant TIM8_TIM8_SMCR_ETPS                              \ External trigger prescaler External trigger signal ETRP frequency must be at most 1/4 of f<sub>CK_INT</sub> frequency. A prescaler can be enabled to reduce ETRP frequency. It is useful when inputting fast external clocks.
...
$00000003 constant TIM8_TIM8_CCMR1_CC1S                             \ Capture/Compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
$0000000c constant TIM8_TIM8_CCMR1_IC1PSC                           \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E= 0 (TIMx_CCER register).
$000000f0 constant TIM8_TIM8_CCMR1_IC1F                             \ Input capture 1 filter This bit-field defines the frequency used to sample TI1 input and the length of the digital filter applied to TI1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
$00000300 constant TIM8_TIM8_CCMR1_CC2S                             \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
$00000c00 constant TIM8_TIM8_CCMR1_IC2PSC                           \ Input capture 2 prescaler Refer to IC1PSC[1:0] description.
$0000f000 constant TIM8_TIM8_CCMR1_IC2F                             \ Input capture 2 filter Refer to IC1F[3:0] description.
...
$00000003 constant TIM8_TIM8_CCMR1_ALTERNATE_CC1S                   \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
$00000004 constant TIM8_TIM8_CCMR1_ALTERNATE_OC1FE                  \ Output Compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
$00000008 constant TIM8_TIM8_CCMR1_ALTERNATE_OC1PE                  \ Output Compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S= 00 (the channel is configured in output).
$00000070 constant TIM8_TIM8_CCMR1_ALTERNATE_OC1M                   \ OC1M[2:0]: Output Compare 1 mode These bits define the behavior of the output reference signal OC1REF from which OC1 and OC1N are derived. OC1REF is active high whereas OC1 and OC1N active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIMx_BDTR register) and CC1S= 00 (the channel is configured in output). Note: In PWM mode, the OCREF level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode. Note: On channels having a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIMx_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated. Note: The OC1M[3] bit is not contiguous, located in bit 16.
$00000080 constant TIM8_TIM8_CCMR1_ALTERNATE_OC1CE                  \ Output Compare 1 clear enable
$00000300 constant TIM8_TIM8_CCMR1_ALTERNATE_CC2S                   \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
$00000400 constant TIM8_TIM8_CCMR1_ALTERNATE_OC2FE                  \ Output Compare 2 fast enable Refer to OC1FE description.
$00000800 constant TIM8_TIM8_CCMR1_ALTERNATE_OC2PE                  \ Output Compare 2 preload enable Refer to OC1PE description.
$00007000 constant TIM8_TIM8_CCMR1_ALTERNATE_OC2M                   \ OC2M[2:0]: Output Compare 2 mode Refer to OC1M[3:0] description.
$00008000 constant TIM8_TIM8_CCMR1_ALTERNATE_OC2CE                  \ Output Compare 2 clear enable Refer to OC1CE description.
$00010000 constant TIM8_TIM8_CCMR1_ALTERNATE_OC1M_1                 \ OC1M[3]
$01000000 constant TIM8_TIM8_CCMR1_ALTERNATE_OC2M_1                 \ OC2M[3]
...
$00000003 constant TIM8_TIM8_CCMR2_CC3S                             \ Capture/compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
$0000000c constant TIM8_TIM8_CCMR2_IC3PSC                           \ Input capture 3 prescaler Refer to IC1PSC[1:0] description.
$000000f0 constant TIM8_TIM8_CCMR2_IC3F                             \ Input capture 3 filter Refer to IC1F[3:0] description.
$00000300 constant TIM8_TIM8_CCMR2_CC4S                             \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
$00000c00 constant TIM8_TIM8_CCMR2_IC4PSC                           \ Input capture 4 prescaler Refer to IC1PSC[1:0] description.
$0000f000 constant TIM8_TIM8_CCMR2_IC4F                             \ Input capture 4 filter Refer to IC1F[3:0] description.
...
$00000003 constant TIM8_TIM8_CCMR2_ALTERNATE_CC3S                   \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
$00000004 constant TIM8_TIM8_CCMR2_ALTERNATE_OC3FE                  \ Output compare 3 fast enable Refer to OC1FE description.
$00000008 constant TIM8_TIM8_CCMR2_ALTERNATE_OC3PE                  \ Output compare 3 preload enable Refer to OC1PE description.
$00000070 constant TIM8_TIM8_CCMR2_ALTERNATE_OC3M                   \ OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description.
$00000080 constant TIM8_TIM8_CCMR2_ALTERNATE_OC3CE                  \ Output compare 3 clear enable Refer to OC1CE description.
$00000300 constant TIM8_TIM8_CCMR2_ALTERNATE_CC4S                   \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
$00000400 constant TIM8_TIM8_CCMR2_ALTERNATE_OC4FE                  \ Output compare 4 fast enable Refer to OC1FE description.
$00000800 constant TIM8_TIM8_CCMR2_ALTERNATE_OC4PE                  \ Output compare 4 preload enable Refer to OC1PE description.
$00007000 constant TIM8_TIM8_CCMR2_ALTERNATE_OC4M                   \ OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description.
$00008000 constant TIM8_TIM8_CCMR2_ALTERNATE_OC4CE                  \ Output compare 4 clear enable Refer to OC1CE description.
$00010000 constant TIM8_TIM8_CCMR2_ALTERNATE_OC3M_1                 \ OC3M[3]
$01000000 constant TIM8_TIM8_CCMR2_ALTERNATE_OC4M_1                 \ OC4M[3]
...
$0000ffff constant TIM8_TIM8_ARR_ARR                                \ Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 24.3.1: Time-base unit on page 691 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$00000070 constant TIM8_TIM8_CCMR3_OC5M                             \ OC5M[0]: Output compare 5 mode Refer to OC1M description.
...
$00007000 constant TIM8_TIM8_CCMR3_OC6M                             \ OC6M[0]: Output compare 6 mode Refer to OC1M description.
...
$00000001 constant TIM8_TIM8_AF1_BKINE                              \ BRK BKIN input enable This bit enables the BKIN alternate function input for the timer s BRK input. BKIN input is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM8_TIM8_AF1_BKCMP1E                            \ BRK COMP1 enable This bit enables the COMP1 for the timer s BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM8_TIM8_AF1_BKCMP2E                            \ BRK COMP2 enable This bit enables the COMP2 for the timer s BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM8_TIM8_AF1_BKDF1BK2E                          \ BRK dfsdm1_break[2] enable This bit enables the dfsdm1_break[2] for the timer s BRK input. dfsdm1_break[2] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000400 constant TIM8_TIM8_AF1_BKCMP1P                            \ BRK COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000800 constant TIM8_TIM8_AF1_BKCMP2P                            \ BRK COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000001 constant TIM8_TIM8_AF2_BK2INE                             \ BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timer s BRK2 input. BKIN2 input is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM8_TIM8_AF2_BK2CMP1E                           \ BRK2 COMP1 enable This bit enables the COMP1 for the timer s BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM8_TIM8_AF2_BK2CMP2E                           \ BRK2 COMP2 enable This bit enables the COMP2 for the timer s BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM8_TIM8_AF2_BK2DF1BK3E                         \ BRK2 dfsdm1_break[3] enable This bit enables the dfsdm1_break[3] for the timer s BRK2 input. dfsdm1_break[3] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000400 constant TIM8_TIM8_AF2_BK2CMP1P                           \ BRK2 COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000800 constant TIM8_TIM8_AF2_BK2CMP2P                           \ BRK2 COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$40013418 constant TIM8_TIM8_CCMR1  \ offset: 0x18 : TIM8 capture/compare mode register 1
$40013418 constant TIM8_TIM8_CCMR1_ALTERNATE  \ offset: 0x18 : TIM8 capture/compare mode register 1
$4001341c constant TIM8_TIM8_CCMR2  \ offset: 0x1C : TIM8 capture/compare mode register 2
$4001341c constant TIM8_TIM8_CCMR2_ALTERNATE  \ offset: 0x1C : TIM8 capture/compare mode register 2
...
$40013448 constant TIM8_TIM8_DCR  \ offset: 0x48 : TIM8 DMA control register
$4001344c constant TIM8_TIM8_DMAR  \ offset: 0x4C : TIM8 DMA address for full transfer
$40013454 constant TIM8_TIM8_CCMR3  \ offset: 0x54 : TIM8 capture/compare mode register 3
$40013458 constant TIM8_TIM8_CCR5  \ offset: 0x58 : TIM8 capture/compare register 5
$4001345c constant TIM8_TIM8_CCR6  \ offset: 0x5C : TIM8 capture/compare register 6
$40013460 constant TIM8_TIM8_AF1  \ offset: 0x60 : TIM8 Alternate function option register 1
$40013464 constant TIM8_TIM8_AF2  \ offset: 0x64 : TIM8 Alternate function option register 2
$40013468 constant TIM8_TIM8_TISEL  \ offset: 0x68 : TIM8 timer input selection register
