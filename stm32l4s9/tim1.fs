...
$00003000 constant TIM1_TIM1_SMCR_ETPS                              \ External trigger prescaler External trigger signal ETRP frequency must be at most 1/4 of f<sub>CK_INT</sub> frequency. A prescaler can be enabled to reduce ETRP frequency. It is useful when inputting fast external clocks.
...
$0000000c constant TIM1_TIM1_CCMR1_IC1PSC                           \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E= 0 (TIMx_CCER register).
...
$00000c00 constant TIM1_TIM1_CCMR1_IC2PSC                           \ Input capture 2 prescaler Refer to IC1PSC[1:0] description.
$0000f000 constant TIM1_TIM1_CCMR1_IC2F                             \ Input capture 2 filter Refer to IC1F[3:0] description.
...
$00000400 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2FE                 \ Output Compare 2 fast enable Refer to OC1FE description.
$00000800 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2PE                 \ Output Compare 2 preload enable Refer to OC1PE description.
$00007000 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2M                  \ OC2M[2:0]: Output Compare 2 mode Refer to OC1M[3:0] description.
$00008000 constant TIM1_TIM1_CCMR1_ALTERNATE1_OC2CE                 \ Output Compare 2 clear enable Refer to OC1CE description.
...
$0000000c constant TIM1_TIM1_CCMR2_IC3PSC                           \ Input capture 3 prescaler Refer to IC1PSC[1:0] description.
$000000f0 constant TIM1_TIM1_CCMR2_IC3F                             \ Input capture 3 filter Refer to IC1F[3:0] description.
...
$00000c00 constant TIM1_TIM1_CCMR2_IC4PSC                           \ Input capture 4 prescaler Refer to IC1PSC[1:0] description.
$0000f000 constant TIM1_TIM1_CCMR2_IC4F                             \ Input capture 4 filter Refer to IC1F[3:0] description.
...
$00000003 constant TIM1_TIM1_CCMR2_ALTERNATE_CC3S                   \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
$00000004 constant TIM1_TIM1_CCMR2_ALTERNATE_OC3FE                  \ Output compare 3 fast enable Refer to OC1FE description.
$00000008 constant TIM1_TIM1_CCMR2_ALTERNATE_OC3PE                  \ Output compare 3 preload enable Refer to OC1PE description.
$00000070 constant TIM1_TIM1_CCMR2_ALTERNATE_OC3M                   \ OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description.
$00000080 constant TIM1_TIM1_CCMR2_ALTERNATE_OC3CE                  \ Output compare 3 clear enable Refer to OC1CE description.
$00000300 constant TIM1_TIM1_CCMR2_ALTERNATE_CC4S                   \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
$00000400 constant TIM1_TIM1_CCMR2_ALTERNATE_OC4FE                  \ Output compare 4 fast enable Refer to OC1FE description.
$00000800 constant TIM1_TIM1_CCMR2_ALTERNATE_OC4PE                  \ Output compare 4 preload enable Refer to OC1PE description.
$00007000 constant TIM1_TIM1_CCMR2_ALTERNATE_OC4M                   \ OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description.
$00008000 constant TIM1_TIM1_CCMR2_ALTERNATE_OC4CE                  \ Output compare 4 clear enable Refer to OC1CE description.
$00010000 constant TIM1_TIM1_CCMR2_ALTERNATE_OC3M_1                 \ OC3M[3]
$01000000 constant TIM1_TIM1_CCMR2_ALTERNATE_OC4M_1                 \ OC4M[3]
...
$0000ffff constant TIM1_TIM1_ARR_ARR                                \ Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 24.3.1: Time-base unit on page 691 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$00000070 constant TIM1_TIM1_CCMR3_OC5M                             \ OC5M[0]: Output compare 5 mode Refer to OC1M description.
...
$00007000 constant TIM1_TIM1_CCMR3_OC6M                             \ OC6M[0]: Output compare 6 mode Refer to OC1M description.
...
$00000002 constant TIM1_TIM1_AF1_BKCMP1E                            \ BRK COMP1 enable This bit enables the COMP1 for the timer s BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF1_BKCMP2E                            \ BRK COMP2 enable This bit enables the COMP2 for the timer s BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF1_BKDF1BK0E                          \ BRK dfsdm1_break[0] enable This bit enables the dfsdm1_break[0] for the timer s BRK input. dfsdm1_break[0] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000400 constant TIM1_TIM1_AF1_BKCMP1P                            \ BRK COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000800 constant TIM1_TIM1_AF1_BKCMP2P                            \ BRK COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000002 constant TIM1_TIM1_AF2_BK2CMP1E                           \ BRK2 COMP1 enable This bit enables the COMP1 for the timer s BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM1_TIM1_AF2_BK2CMP2E                           \ BRK2 COMP2 enable This bit enables the COMP2 for the timer s BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM1_TIM1_AF2_BK2DF1BK1E                         \ BRK2 dfsdm1_break[1] enable This bit enables the dfsdm1_break[1] for the timer s BRK2 input. dfsdm1_break[1] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00000400 constant TIM1_TIM1_AF2_BK2CMP1P                           \ BRK2 COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000800 constant TIM1_TIM1_AF2_BK2CMP2P                           \ BRK2 COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$40012c18 constant TIM1_TIM1_CCMR1  \ offset: 0x18 : TIM1 capture/compare mode register 1
$40012c18 constant TIM1_TIM1_CCMR1_ALTERNATE1  \ offset: 0x18 : TIM1 capture/compare mode register 1
$40012c1c constant TIM1_TIM1_CCMR2  \ offset: 0x1C : TIM1 capture/compare mode register 2
$40012c1c constant TIM1_TIM1_CCMR2_ALTERNATE  \ offset: 0x1C : TIM1 capture/compare mode register 2
...
$40012c48 constant TIM1_TIM1_DCR  \ offset: 0x48 : TIM1 DMA control register
$40012c4c constant TIM1_TIM1_DMAR  \ offset: 0x4C : TIM1 DMA address for full transfer
$40012c54 constant TIM1_TIM1_CCMR3  \ offset: 0x54 : TIM1 capture/compare mode register 3
$40012c58 constant TIM1_TIM1_CCR5  \ offset: 0x58 : TIM1 capture/compare register 5
$40012c5c constant TIM1_TIM1_CCR6  \ offset: 0x5C : TIM1 capture/compare register 6
