...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_TIM1_CCMR2_ALTERNATE_DEF
    \
    \ @brief TIM1 capture/compare mode register 2
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM1_TIM1_ARR_DEF
    ...
    \
    $00 constant TIM1_ARR                       \ [0x00 : 16] Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 24.3.1: Time-base unit on page 691 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM1_TIM1_AF1_DEF
    ...
    $08 constant TIM1_BKDF1BK0E                 \ [0x08] BRK dfsdm1_break[0] enable This bit enables the dfsdm1_break[0] for the timer s BRK input. dfsdm1_break[0] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  [ifdef] TIM1_TIM1_AF2_DEF
    ...
    $08 constant TIM1_BK2DF1BK1E                \ [0x08] BRK2 dfsdm1_break[1] enable This bit enables the dfsdm1_break[1] for the timer s BRK2 input. dfsdm1_break[1] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  $1C constant TIM1_TIM1_CCMR2_ALTERNATE    \ TIM1 capture/compare mode register 2
