...
[ifndef] TIM3_DEF
  ...
  [ifdef] TIM3_TIM3_CCMR1_ALTERNATE_DEF
    \
    \ @brief TIM3 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM3_TIM3_CCMR2_ALTERNATE_DEF
    \
    \ @brief TIM3 capture/compare mode register 2
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM3_TIM3_ARR_DEF
    ...
    \
    $00 constant TIM3_ARR                       \ [0x00 : 32] Low Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 25.3.1: Time-base unit on page 786 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM3_TIM3_TISEL_DEF
    ...
    $18 constant TIM3_TI4SEL                    \ [0x18 : 4] TI4[0] to TI4[15] input selection These bits select the TI4[0] to TI4[15] input source. Others: Reserved
  [then]
  ...
  $18 constant TIM3_TIM3_CCMR1_ALTERNATE    \ TIM3 capture/compare mode register 1
  $1C constant TIM3_TIM3_CCMR2          \ TIM3 capture/compare mode register 2
  $1C constant TIM3_TIM3_CCMR2_ALTERNATE    \ TIM3 capture/compare mode register 2
  $20 constant TIM3_TIM3_CCER           \ TIM3 capture/compare enable register
  $24 constant TIM3_TIM3_CNT            \ TIM3 counter
  $24 constant TIM3_TIM3_CNT_ALTERNATE  \ TIM3 counter
