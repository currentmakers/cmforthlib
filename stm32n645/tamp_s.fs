...
$00000002 constant TAMP_S_TAMP_CR1_TAMP2E                           \ Tamper detection on TAMP_IN2 enable less than sup>(1) less than /sup>
$00000004 constant TAMP_S_TAMP_CR1_TAMP3E                           \ Tamper detection on TAMP_IN3 enable less than sup>(1) less than /sup>
$00000008 constant TAMP_S_TAMP_CR1_TAMP4E                           \ Tamper detection on TAMP_IN4 enable less than sup>(1) less than /sup>
$00000010 constant TAMP_S_TAMP_CR1_TAMP5E                           \ Tamper detection on TAMP_IN5 enable less than sup>(1) less than /sup>
$00000020 constant TAMP_S_TAMP_CR1_TAMP6E                           \ Tamper detection on TAMP_IN6 enable less than sup>(1) less than /sup>
$00000040 constant TAMP_S_TAMP_CR1_TAMP7E                           \ Tamper detection on TAMP_IN7 enable less than sup>(1) less than /sup>
...
$00400000 constant TAMP_S_TAMP_CR2_BKBLOCK                          \ Backup registers and device secrets less than sup>(1) less than /sup> access blocked
$00800000 constant TAMP_S_TAMP_CR2_BKERASE                          \ Backup registers and device secrets less than sup>(1) less than /sup> erase
...
$00000001 constant TAMP_S_TAMP_OR_VCOREMEN                          \ V less than sub>CORE less than /sub> monitoring
