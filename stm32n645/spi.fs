...
[ifndef] SPI_DEF
  ...
  [ifdef] SPI_SPI_I2SCFGR_DEF
    ...
    $04 constant SPI_I2SSTD                     \ [0x04 : 2] I less than sup>2 less than /sup>S standard selection
    ...
    $10 constant SPI_I2SDIV                     \ [0x10 : 8] I less than sup>2 less than /sup>S linear prescaler
