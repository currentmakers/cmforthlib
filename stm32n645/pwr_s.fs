...
$00000001 constant PWR_S_PWR_CR3_VCOREMONEN                         \ V less than sub>DDCORE less than /sub> monitoring enable
$00000010 constant PWR_S_PWR_CR3_VCORELLS                           \ V less than sub>DDCORE less than /sub> voltage detector low-level selection
$00000100 constant PWR_S_PWR_CR3_VCOREL                             \ Monitored V less than sub>DDCORE less than /sub> level above low threshold
$00000200 constant PWR_S_PWR_CR3_VCOREH                             \ Monitored V less than sub>DDCORE less than /sub> level above high threshold
...
$00000002 constant PWR_S_PWR_VOSCR_VOSRDY                           \ VOS ready bit for V less than sub>CORE less than /sub> voltage scaling output selection
$00010000 constant PWR_S_PWR_VOSCR_ACTVOS                           \ VOS currently applied for V less than sub>CORE less than /sub> voltage scaling selection
...
$00000001 constant PWR_S_PWR_BDCR1_MONEN                            \ V less than sub>BAT less than /sub> and temperature monitoring enable
$00010000 constant PWR_S_PWR_BDCR1_VBATL                            \ V less than sub>BAT less than /sub> level monitoring versus low threshold
$00020000 constant PWR_S_PWR_BDCR1_VBATH                            \ V less than sub>BAT less than /sub> level monitoring versus high threshold
...
$00000001 constant PWR_S_PWR_BDCR2_BKPRBSEN                         \ Backup RAM backup supply enable (used to maintain BKPRAM content in Standby and V less than sub>BAT less than /sub> modes).
...
$00000001 constant PWR_S_PWR_SVMCR1_VDDIO4VMEN                      \ V less than sub>DDIO4 less than /sub>independent I/O voltage monitor enable
$00000100 constant PWR_S_PWR_SVMCR1_VDDIO4SV                        \ V less than sub>DDIO4 less than /sub>independent I/O supply valid.
$00010000 constant PWR_S_PWR_SVMCR1_VDDIO4RDY                       \ V less than sub>DDIO4 less than /sub>ready
$01000000 constant PWR_S_PWR_SVMCR1_VDDIO4VRSEL                     \ V less than sub>DDIO4 less than /sub> I/O voltage range selection
$02000000 constant PWR_S_PWR_SVMCR1_VDDIO4VRSTBY                    \ V less than sub>DDIO4 less than /sub> I/O voltage range Standby mode
...
$00000001 constant PWR_S_PWR_SVMCR2_VDDIO5VMEN                      \ V less than sub>DDIO5 less than /sub>independent voltage monitor enable
$00000100 constant PWR_S_PWR_SVMCR2_VDDIO5SV                        \ V less than sub>DDIO5 less than /sub>independent supply valid
$00010000 constant PWR_S_PWR_SVMCR2_VDDIO5RDY                       \ V less than sub>DDIO5 less than /sub>ready
$01000000 constant PWR_S_PWR_SVMCR2_VDDIO5VRSEL                     \ V less than sub>DDIO5 less than /sub> I/O voltage range selection
$02000000 constant PWR_S_PWR_SVMCR2_VDDIO5VRSTBY                    \ V less than sub>DDIO5 less than /sub> I/O voltage range Standby mode
...
$00000001 constant PWR_S_PWR_SVMCR3_VDDIO2VMEN                      \ V less than sub>DDIO2 less than /sub>independent voltage monitor enable
$00000002 constant PWR_S_PWR_SVMCR3_VDDIO3VMEN                      \ V less than sub>DDIO3 less than /sub>independent voltage monitor enable
$00000004 constant PWR_S_PWR_SVMCR3_USB33VMEN                       \ V less than sub>DD33USB less than /sub>independent USB 33 voltage monitor enable.
$00000010 constant PWR_S_PWR_SVMCR3_AVMEN                           \ V less than sub>DDA18ADC less than /sub>independent ADC voltage monitor enable
$00000100 constant PWR_S_PWR_SVMCR3_VDDIO2SV                        \ V less than sub>DDIO2 less than /sub>independent supply valid.
$00000200 constant PWR_S_PWR_SVMCR3_VDDIO3SV                        \ V less than sub>DDIO3 less than /sub>independent supply valid
$00000400 constant PWR_S_PWR_SVMCR3_USB33SV                         \ V less than sub>DD33USB less than /sub>independent supply valid
$00001000 constant PWR_S_PWR_SVMCR3_ASV                             \ V less than sub>DDA18ADC less than /sub>independent supply valid
$00010000 constant PWR_S_PWR_SVMCR3_VDDIO2RDY                       \ V less than sub>DDIO2 less than /sub>ready
$00020000 constant PWR_S_PWR_SVMCR3_VDDIO3RDY                       \ V less than sub>DDIO3 less than /sub>ready
$00040000 constant PWR_S_PWR_SVMCR3_USB33RDY                        \ V less than sub>DD33USB less than /sub>ready
$00100000 constant PWR_S_PWR_SVMCR3_ARDY                            \ V less than sub>DDA18ADC less than /sub>ready
$01000000 constant PWR_S_PWR_SVMCR3_VDDIOVRSEL                      \ V less than sub>DD less than /sub> I/O voltage range selection
$02000000 constant PWR_S_PWR_SVMCR3_VDDIO2VRSEL                     \ V less than sub>DDIO2 less than /sub> I/O voltage range selection
$04000000 constant PWR_S_PWR_SVMCR3_VDDIO3VRSEL                     \ V less than sub>DDIO3 less than /sub> I/O voltage range selection
...
$00000004 constant PWR_S_PWR_SECCFGR_SEC2                           \ V less than sub>DDCORE less than /sub> monitor secure protection
...
$00000004 constant PWR_S_PWR_PRIVCFGR_PRIV2                         \ V less than sub>DDCORE less than /sub> monitor privileged protection
