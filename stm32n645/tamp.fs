...
[ifndef] TAMP_DEF
  ...
  [ifdef] TAMP_TAMP_CR1_DEF
    ...
    $01 constant TAMP_TAMP2E                    \ [0x01] Tamper detection on TAMP_IN2 enable less than sup>(1) less than /sup>
    $02 constant TAMP_TAMP3E                    \ [0x02] Tamper detection on TAMP_IN3 enable less than sup>(1) less than /sup>
    $03 constant TAMP_TAMP4E                    \ [0x03] Tamper detection on TAMP_IN4 enable less than sup>(1) less than /sup>
    $04 constant TAMP_TAMP5E                    \ [0x04] Tamper detection on TAMP_IN5 enable less than sup>(1) less than /sup>
    $05 constant TAMP_TAMP6E                    \ [0x05] Tamper detection on TAMP_IN6 enable less than sup>(1) less than /sup>
    $06 constant TAMP_TAMP7E                    \ [0x06] Tamper detection on TAMP_IN7 enable less than sup>(1) less than /sup>
  ...
  [ifdef] TAMP_TAMP_CR2_DEF
    ...
    $16 constant TAMP_BKBLOCK                   \ [0x16] Backup registers and device secrets less than sup>(1) less than /sup> access blocked
    $17 constant TAMP_BKERASE                   \ [0x17] Backup registers and device secrets less than sup>(1) less than /sup> erase
  ...
  [ifdef] TAMP_TAMP_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TAMP_VCOREMEN                  \ [0x00] V less than sub>CORE less than /sub> monitoring
