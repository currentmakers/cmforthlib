...
\ @brief Voltage reference buffer
\
$56003c00 constant VREFBUF_S_VREFBUF_CSR  \ offset: 0x00 : VREFBUF control and status register
$56003c04 constant VREFBUF_S_VREFBUF_CCR  \ offset: 0x04 : VREFBUF calibration control register
