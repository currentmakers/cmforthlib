...
[ifndef] LTDC_DEF
  ...
  [ifdef] LTDC_BPCR_DEF
    ...
    $10 constant LTDC_AHBP                      \ [0x10 : 10] Accumulated Horizontal back porch (in units of pixel clock period)
  [then]
  ...
  [ifdef] LTDC_AWCR_DEF
    ...
    $10 constant LTDC_AAV                       \ [0x10 : 10] AAV
  [then]
  ...
  [ifdef] LTDC_TWCR_DEF
    ...
    $10 constant LTDC_TOTALW                    \ [0x10 : 10] Total Width (in units of pixel clock period)
  [then]
  ...
  [ifdef] LTDC_BCCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LTDC_BC                        \ [0x00 : 24] Background Color Red value
  [then]
  ...
  [ifdef] LTDC_L2CKCR_DEF
    ...
    \
    $00 constant LTDC_CKBLUE                    \ [0x00 : 8] Color Key Blue value
    $08 constant LTDC_CKGREEN                   \ [0x08 : 7] Color Key Green value
    $0f constant LTDC_CKRED                     \ [0x0f : 9] Color Key Red value
  [then]
