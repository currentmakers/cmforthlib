...
[ifndef] BDMA_DEF
  ...
  $08 constant BDMA_CCR1                \ DMA channel x configuration register
  $0C constant BDMA_CNDTR1              \ DMA channel x number of data register
  $10 constant BDMA_CPAR1               \ This register must not be written when the channel is enabled.
  $14 constant BDMA_CMAR1               \ This register must not be written when the channel is enabled.
  $1C constant BDMA_CCR2                \ DMA channel x configuration register
  $20 constant BDMA_CNDTR2              \ DMA channel x number of data register
  $24 constant BDMA_CPAR2               \ This register must not be written when the channel is enabled.
  $28 constant BDMA_CMAR2               \ This register must not be written when the channel is enabled.
  $30 constant BDMA_CCR3                \ DMA channel x configuration register
  $34 constant BDMA_CNDTR3              \ DMA channel x number of data register
  $38 constant BDMA_CPAR3               \ This register must not be written when the channel is enabled.
  $3C constant BDMA_CMAR3               \ This register must not be written when the channel is enabled.
  $44 constant BDMA_CCR4                \ DMA channel x configuration register
  $48 constant BDMA_CNDTR4              \ DMA channel x number of data register
  $4C constant BDMA_CPAR4               \ This register must not be written when the channel is enabled.
  $50 constant BDMA_CMAR4               \ This register must not be written when the channel is enabled.
  $58 constant BDMA_CCR5                \ DMA channel x configuration register
  $5C constant BDMA_CNDTR5              \ DMA channel x number of data register
  $60 constant BDMA_CPAR5               \ This register must not be written when the channel is enabled.
  $64 constant BDMA_CMAR5               \ This register must not be written when the channel is enabled.
  $6C constant BDMA_CCR6                \ DMA channel x configuration register
  $70 constant BDMA_CNDTR6              \ DMA channel x number of data register
  $74 constant BDMA_CPAR6               \ This register must not be written when the channel is enabled.
  $78 constant BDMA_CMAR6               \ This register must not be written when the channel is enabled.
  $80 constant BDMA_CCR7                \ DMA channel x configuration register
  $84 constant BDMA_CNDTR7              \ DMA channel x number of data register
  $88 constant BDMA_CPAR7               \ This register must not be written when the channel is enabled.
  $8C constant BDMA_CMAR7               \ This register must not be written when the channel is enabled.
  $94 constant BDMA_CCR8                \ DMA channel x configuration register
  $98 constant BDMA_CNDTR8              \ DMA channel x number of data register
  $9C constant BDMA_CPAR8               \ This register must not be written when the channel is enabled.
  $A0 constant BDMA_CMAR8               \ This register must not be written when the channel is enabled.
