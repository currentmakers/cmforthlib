...
[ifndef] HRTIM_COMMON_DEF
  ...
  [ifdef] HRTIM_COMMON_BMCMPR6_DEF
    \
    \ @brief BMCMPR6
    \ Address offset: 0x28
    \ Reset value: 0x00000000
  ...
  [ifdef] HRTIM_COMMON_BDTxUPR_DEF
    \
  ...
  $18 constant HRTIM_COMMON_DISR        \ DISR
  ...
  $28 constant HRTIM_COMMON_BMCMPR6     \ BMCMPR6
  ...
  $5C constant HRTIM_COMMON_BDTXUPR     \ Burst DMA Timerx update Register
  $60 constant HRTIM_COMMON_BDMADR      \ Burst DMA Data Register
