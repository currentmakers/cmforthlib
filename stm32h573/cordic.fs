...
[ifndef] CORDIC_DEF
  ...
  [ifdef] CORDIC_CORDIC_CSR_DEF
    ...
    \
    $00 constant CORDIC_FUNC                    \ [0x00 : 4] Function 2: Phase 3: Modulus 4: Arctangent 5: Hyperbolic cosine 6: Hyperbolic sine 7: Arctanh 8: Natural logarithm 9: Square Root
