...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_RCC_AHB2RSTR_DEF
    ...
    $10 constant RCC_AESRST                     \ [0x10] AES block reset Set and reset by software.
    ...
    $13 constant RCC_PKARST                     \ [0x13] PKA block reset Set and reset by software.
    $14 constant RCC_SAESRST                    \ [0x14] SAES block reset Set and reset by software.
  [then]
  ...
  [ifdef] RCC_RCC_AHB4RSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $07 constant RCC_OTFDEC1RST                 \ [0x07] OTFDEC1 block reset Set and reset by software.
  ...
  [ifdef] RCC_RCC_AHB2ENR_DEF
    ...
    $10 constant RCC_AESEN                      \ [0x10] AES clock enable Set and reset by software.
    ...
    $13 constant RCC_PKAEN                      \ [0x13] PKA clock enable Set and reset by software.
    $14 constant RCC_SAESEN                     \ [0x14] SAES clock enable Set and reset by software.
  ...
  [ifdef] RCC_RCC_AHB4ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $07 constant RCC_OTFDEC1EN                  \ [0x07] OTFDEC1 clock enable Set and reset by software.
  ...
  [ifdef] RCC_RCC_AHB2LPENR_DEF
    ...
    $10 constant RCC_AESLPEN                    \ [0x10] AES clock enable during sleep mode Set and reset by software.
    ...
    $13 constant RCC_PKALPEN                    \ [0x13] PKA clock enable during sleep mode Set and reset by software.
    $14 constant RCC_SAESLPEN                   \ [0x14] SAES clock enable during sleep mode Set and reset by software.
  ...
  [ifdef] RCC_RCC_AHB4LPENR_DEF
    ...
    \
    $07 constant RCC_OTFDEC1LPEN                \ [0x07] OTFDEC1 clock enable during sleep mode Set and reset by software.
