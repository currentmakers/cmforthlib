...
$00ff0000 constant TAMP_TAMP_SECCFGR_BKPWSEC                        \ Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC greater than or equal BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC less than or equal BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode.
...
$80000000 constant TAMP_TAMP_PRIVCFGR_TAMPPRIV                      \ Tamper privilege protection (excluding backup registers) Note: Refer to for details on the read protection.
...
$00080000 constant TAMP_TAMP_MISR_ITAMP4MF                          \ Internal tamper 4 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 4 non-secure interrupt is raised.
...
$40000000 constant TAMP_TAMP_MISR_ITAMP15MF                         \ internal tamper 15 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 15 non-secure interrupt is raised.
...
$00080000 constant TAMP_TAMP_SMISR_ITAMP4MF                         \ Internal tamper 4 secure interrupt masked flag This flag is set by hardware when the internal tamper 4 secure interrupt is raised.
...
$40000000 constant TAMP_TAMP_SMISR_ITAMP15MF                        \ internal tamper 15 secure interrupt masked flag This flag is set by hardware when the internal tamper 15 secure interrupt is raised.
...
$00000006 constant TAMP_TAMP_OR_OUT3_RMP                            \ TAMP_OUT3 mapping
$00000008 constant TAMP_TAMP_OR_OUT5_RMP                            \ TAMP_OUT5 mapping
$00000100 constant TAMP_TAMP_OR_IN2_RMP                             \ TAMP_IN2 mapping
$00000200 constant TAMP_TAMP_OR_IN3_RMP                             \ TAMP_IN3 mapping
$00000400 constant TAMP_TAMP_OR_IN4_RMP                             \ TAMP_IN4 mapping
...
$44007c20 constant TAMP_TAMP_SECCFGR  \ offset: 0x20 : TAMP secure mode register
$44007c24 constant TAMP_TAMP_PRIVCFGR  \ offset: 0x24 : TAMP privilege mode control register
...
$44007c34 constant TAMP_TAMP_MISR  \ offset: 0x34 : TAMP non-secure masked interrupt status register
$44007c38 constant TAMP_TAMP_SMISR  \ offset: 0x38 : TAMP secure masked interrupt status register
...
$44007c50 constant TAMP_TAMP_OR   \ offset: 0x50 : TAMP option register
