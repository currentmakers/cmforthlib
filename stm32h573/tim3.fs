...
$00000300 constant TIM3_TIM3_CR1_CKD                                \ Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and sampling clock used by the digital filters (tim_etr_in, tim_tix),
$00000800 constant TIM3_TIM3_CR1_UIFREMAP                           \ UIF status bit remapping
$00001000 constant TIM3_TIM3_CR1_DITHEN                             \ Dithering Enable Note: The DITHEN bit can only be modified when CEN bit is reset.
...
$00000070 constant TIM3_TIM3_CR2_MMS1                               \ Master mode selection These bits allow to select the information to be sent in master mode to slave timers for synchronization (tim_trgo). The combination is as follows: tim_trgo, except if the master/slave mode is selected (see the MSM bit description in TIMx_SMCR register). Others: Reserved Note: The clock of the slave timer or ADC must be enabled prior to receive events from the master timer, and must not be changed on-the-fly while triggers are received from the master timer.
$00000080 constant TIM3_TIM3_CR2_TI1S                               \ tim_ti1 selection
$02000000 constant TIM3_TIM3_CR2_MMS2                               \ Master mode selection These bits allow to select the information to be sent in master mode to slave timers for synchronization (tim_trgo). The combination is as follows: tim_trgo, except if the master/slave mode is selected (see the MSM bit description in TIMx_SMCR register). Others: Reserved Note: The clock of the slave timer or ADC must be enabled prior to receive events from the master timer, and must not be changed on-the-fly while triggers are received from the master timer.
...
$00000008 constant TIM3_TIM3_SMCR_OCCS                              \ OCREF clear selection This bit is used to select the OCREF clear source Note: If the OCREF clear selection feature is not supported, this bit is reserved and forced by hardware to '0'. .
$00000070 constant TIM3_TIM3_SMCR_TS                                \ Trigger selection (see bits 21:20 for TS[4:3]) This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00003000 constant TIM3_TIM3_SMCR_ETPS                              \ External trigger prescaler External trigger signal tim_etrp frequency must be at most 1/4 of tim_ker_ck frequency. A prescaler can be enabled to reduce tim_etrp frequency. It is useful when inputting fast external clocks on tim_etr_in.
...
$00008000 constant TIM3_TIM3_SMCR_ETP                               \ External trigger polarity This bit selects whether tim_etr_in or tim_etr_in is used for trigger operations
$00010000 constant TIM3_TIM3_SMCR_SMS_2                             \ Slave mode selection When external signals are selected the active edge of the trigger signal (tim_trgi) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Note: The gated mode must not be used if tim_ti1f_ed is selected as the trigger input (TS=00100). Indeed, tim_ti1f_ed outputs 1 pulse for each transition on tim_ti1f, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the tim_trgo signal must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$00300000 constant TIM3_TIM3_SMCR_TS_2                              \ Trigger selection (see bits 21:20 for TS[4:3]) This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See for product specific implementation details. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
$01000000 constant TIM3_TIM3_SMCR_SMSPE                             \ SMS preload enable This bit selects whether the SMS[3:0] bitfield is preloaded
$02000000 constant TIM3_TIM3_SMCR_SMSPS                             \ SMS preload source This bit selects whether the events that triggers the SMS[3:0] bitfield transfer from preload to active
...
$00100000 constant TIM3_TIM3_DIER_IDXIE                             \ Index interrupt enable
$00200000 constant TIM3_TIM3_DIER_DIRIE                             \ Direction change interrupt enable
$00400000 constant TIM3_TIM3_DIER_IERRIE                            \ Index error interrupt enable
$00800000 constant TIM3_TIM3_DIER_TERRIE                            \ Transition error interrupt enable
...
$00100000 constant TIM3_TIM3_SR_IDXF                                \ Index interrupt flag This flag is set by hardware when an index event is detected. It is cleared by software by writing it to '0'.
$00200000 constant TIM3_TIM3_SR_DIRF                                \ Direction change interrupt flag This flag is set by hardware when the direction changes in encoder mode (DIR bit value in TIMx_CR is changing). It is cleared by software by writing it to '0'.
$00400000 constant TIM3_TIM3_SR_IERRF                               \ Index error interrupt flag This flag is set by hardware when an index error is detected. It is cleared by software by writing it to '0'.
$00800000 constant TIM3_TIM3_SR_TERRF                               \ Transition error interrupt flag This flag is set by hardware when a transition error is detected in encoder mode. It is cleared by software by writing it to '0'.
...
$00000003 constant TIM3_TIM3_CCMR1_INPUT_CC1S                       \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
$0000000c constant TIM3_TIM3_CCMR1_INPUT_IC1PSC                     \ Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (tim_ic1). The prescaler is reset as soon as CC1E=0 (TIMx_CCER register).
$000000f0 constant TIM3_TIM3_CCMR1_INPUT_IC1F                       \ Input capture 1 filter This bit-field defines the frequency used to sample tim_ti1 input and the length of the digital filter applied to tim_ti1. The digital filter is made of an event counter in which N consecutive events are needed to validate a transition on the output:
$00000300 constant TIM3_TIM3_CCMR1_INPUT_CC2S                       \ Capture/compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
$00000c00 constant TIM3_TIM3_CCMR1_INPUT_IC2PSC                     \ Input capture 2 prescaler
$0000f000 constant TIM3_TIM3_CCMR1_INPUT_IC2F                       \ Input capture 2 filter
...
$00000003 constant TIM3_TIM3_CCMR1_OUTPUT_CC1S                      \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIMx_CCER).
$00000004 constant TIM3_TIM3_CCMR1_OUTPUT_OC1FE                     \ Output compare 1 fast enable This bit decreases the latency between a trigger event and a transition on the timer output. It must be used in one-pulse mode (OPM bit set in TIMx_CR1 register), to have the output pulse starting as soon as possible after the starting trigger.
$00000008 constant TIM3_TIM3_CCMR1_OUTPUT_OC1PE                     \ Output compare 1 preload enable Note: The PWM mode can be used without validating the preload register only in one-pulse mode (OPM bit set in TIMx_CR1 register). Else the behavior is not guaranteed.
$00000070 constant TIM3_TIM3_CCMR1_OUTPUT_OC1M1                     \ Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 is derived. tim_oc1ref is active high whereas tim_oc1 active level depends on CC1P bit. Note: In PWM mode, the tim_ocref_clr level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode.
$00000080 constant TIM3_TIM3_CCMR1_OUTPUT_OC1CE                     \ Output compare 1 clear enable
$00000300 constant TIM3_TIM3_CCMR1_OUTPUT_CC2S                      \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIMx_CCER).
$00000400 constant TIM3_TIM3_CCMR1_OUTPUT_OC2FE                     \ Output compare 2 fast enable
$00000800 constant TIM3_TIM3_CCMR1_OUTPUT_OC2PE                     \ Output compare 2 preload enable
$00007000 constant TIM3_TIM3_CCMR1_OUTPUT_OC2M1                     \ Output compare 2 mode refer to OC1M description on bits 6:4
$00008000 constant TIM3_TIM3_CCMR1_OUTPUT_OC2CE                     \ Output compare 2 clear enable
$00010000 constant TIM3_TIM3_CCMR1_OUTPUT_OC1M2                     \ Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 is derived. tim_oc1ref is active high whereas tim_oc1 active level depends on CC1P bit. Note: In PWM mode, the tim_ocref_clr level changes only when the result of the comparison changes or when the output compare mode switches from 'frozen' mode to 'PWM' mode.
$01000000 constant TIM3_TIM3_CCMR1_OUTPUT_OC2M2                     \ Output compare 2 mode refer to OC1M description on bits 6:4
...
$00000003 constant TIM3_TIM3_CCMR2_INPUT_CC3S                       \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
$0000000c constant TIM3_TIM3_CCMR2_INPUT_IC3PSC                     \ Input capture 3 prescaler
$000000f0 constant TIM3_TIM3_CCMR2_INPUT_IC3F                       \ Input capture 3 filter
$00000300 constant TIM3_TIM3_CCMR2_INPUT_CC4S                       \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
$00000c00 constant TIM3_TIM3_CCMR2_INPUT_IC4PSC                     \ Input capture 4 prescaler
$0000f000 constant TIM3_TIM3_CCMR2_INPUT_IC4F                       \ Input capture 4 filter
...
$00000003 constant TIM3_TIM3_CCMR2_OUTPUT_CC3S                      \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
$00000004 constant TIM3_TIM3_CCMR2_OUTPUT_OC3FE                     \ Output compare 3 fast enable
$00000008 constant TIM3_TIM3_CCMR2_OUTPUT_OC3PE                     \ Output compare 3 preload enable
$00000070 constant TIM3_TIM3_CCMR2_OUTPUT_OC3M1                     \ Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
$00000080 constant TIM3_TIM3_CCMR2_OUTPUT_OC3CE                     \ Output compare 3 clear enable
$00000300 constant TIM3_TIM3_CCMR2_OUTPUT_CC4S                      \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
$00000400 constant TIM3_TIM3_CCMR2_OUTPUT_OC4FE                     \ Output compare 4 fast enable
$00000800 constant TIM3_TIM3_CCMR2_OUTPUT_OC4PE                     \ Output compare 4 preload enable
$00007000 constant TIM3_TIM3_CCMR2_OUTPUT_OC4M1                     \ Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
$00008000 constant TIM3_TIM3_CCMR2_OUTPUT_OC4CE                     \ Output compare 4 clear enable
$00010000 constant TIM3_TIM3_CCMR2_OUTPUT_OC3M2                     \ Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
$01000000 constant TIM3_TIM3_CCMR2_OUTPUT_OC4M2                     \ Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
$00000008 constant TIM3_TIM3_CCER_CC1NP                             \ Capture/Compare 1 output Polarity. CC1 channel configured as output: CC1NP must be kept cleared in this case. CC1 channel configured as input: This bit is used in conjunction with CC1P to define tim_ti1fp1/tim_ti2fp1 polarity. refer to CC1P description.
...
$0000ffff constant TIM3_TIM3_CNT_CNT                                \ Counter value' Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register holds the non-dithered part in CNT[15:0]. The fractional part is not available.
$80000000 constant TIM3_TIM3_CNT_UIFCPY                             \ Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 Reserved If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register
...
$00000001 constant TIM3_TIM3_ECR_IE                                 \ Index enable This bit indicates if the Index event resets the counter.
$00000006 constant TIM3_TIM3_ECR_IDIR                               \ Index direction This bit indicates in which direction the Index event resets the counter. Note: The IDR[1:0] bitfield must be written when IE bit is reset (index disabled).
$00000018 constant TIM3_TIM3_ECR_IBLK                               \ Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 input
$00000020 constant TIM3_TIM3_ECR_FIDX                               \ First index This bit indicates if the first index only is taken into account
$000000c0 constant TIM3_TIM3_ECR_IPOS                               \ Index positioning In quadrature encoder mode (SMS[3:0] = 0001, 0010, 0011, 1110, 1111), this bit indicates in which AB input configuration the Index event resets the counter. In directional clock mode or clock plus direction mode (SMS[3:0] = 1010, 1011, 1100, 1101), these bits indicates on which level the Index event resets the counter. In bidirectional clock mode, this applies for both clock inputs. x0: Index resets the counter when clock is 0 x1: Index resets the counter when clock is 1 Note: IPOS[1] bit is not significant
$00ff0000 constant TIM3_TIM3_ECR_PW                                 \ Pulse width This bitfield defines the pulse duration, as following: tPW = PW[7:0] x tPWG
$07000000 constant TIM3_TIM3_ECR_PWPRSC                             \ Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: tPWG = (2(PWPRSC[2:0])) x ttim_ker_ck
...
$0000000f constant TIM3_TIM3_TISEL_TI1SEL                           \ Selects tim_ti1[0..15] input ... Refer to for product specific implementation.
$00000f00 constant TIM3_TIM3_TISEL_TI2SEL                           \ Selects tim_ti2[0..15] input ... Refer to for product specific implementation.
$000f0000 constant TIM3_TIM3_TISEL_TI3SEL                           \ Selects tim_ti3[0..15] input ... Refer to for product specific implementation.
$0f000000 constant TIM3_TIM3_TISEL_TI4SEL                           \ Selects tim_ti4[0..15] input ... Refer to for product specific implementation.
...
$0003c000 constant TIM3_TIM3_AF1_ETRSEL                             \ etr_in source selection These bits select the etr_in input source. ... Refer to for product specific implementation.
...
$00070000 constant TIM3_TIM3_AF2_OCRSEL                             \ ocref_clr source selection These bits select the ocref_clr input source. ... Refer to for product specific implementation.
...
$00000000 constant TIM3_TIM3_DMAR_DMAB                              \ DMA register for burst accesses A read or write operation to the DMAR register accesses the register located at the address (TIMx_CR1 address) + (DBA + DMA index) x 4 where TIMx_CR1 address is the address of the control register 1, DBA is the DMA base address configured in TIMx_DCR register, DMA index is automatically controlled by the DMA transfer, and ranges from 0 to DBL (DBL configured in TIMx_DCR).
...
$40000418 constant TIM3_TIM3_CCMR1_INPUT  \ offset: 0x18 : TIM3 capture/compare mode register 1 [alternate]
$40000418 constant TIM3_TIM3_CCMR1_OUTPUT  \ offset: 0x18 : TIM3 capture/compare mode register 1 [alternate]
$4000041c constant TIM3_TIM3_CCMR2_INPUT  \ offset: 0x1C : TIM3 capture/compare mode register 2 [alternate]
$4000041c constant TIM3_TIM3_CCMR2_OUTPUT  \ offset: 0x1C : TIM3 capture/compare mode register 2 [alternate]
...
$40000458 constant TIM3_TIM3_ECR  \ offset: 0x58 : TIM3 timer encoder control register
$4000045c constant TIM3_TIM3_TISEL  \ offset: 0x5C : TIM3 timer input selection register
$40000460 constant TIM3_TIM3_AF1  \ offset: 0x60 : TIM3 alternate function register 1
$40000464 constant TIM3_TIM3_AF2  \ offset: 0x64 : TIM3 alternate function register 2
$400007dc constant TIM3_TIM3_DCR  \ offset: 0x3DC : TIM3 DMA control register
$400007e0 constant TIM3_TIM3_DMAR  \ offset: 0x3E0 : TIM3 DMA address for full transfer
