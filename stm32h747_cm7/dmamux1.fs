...
[ifndef] DMAMUX1_DEF
  ...
  \ @brief DMAMUX
  \
  $00 constant DMAMUX1_C0CR             \ DMAMux - DMA request line multiplexer channel x control register
  $04 constant DMAMUX1_C1CR             \ DMAMux - DMA request line multiplexer channel x control register
  $08 constant DMAMUX1_C2CR             \ DMAMux - DMA request line multiplexer channel x control register
  $0C constant DMAMUX1_C3CR             \ DMAMux - DMA request line multiplexer channel x control register
  $10 constant DMAMUX1_C4CR             \ DMAMux - DMA request line multiplexer channel x control register
  $14 constant DMAMUX1_C5CR             \ DMAMux - DMA request line multiplexer channel x control register
  $18 constant DMAMUX1_C6CR             \ DMAMux - DMA request line multiplexer channel x control register
  $1C constant DMAMUX1_C7CR             \ DMAMux - DMA request line multiplexer channel x control register
  $20 constant DMAMUX1_C8CR             \ DMAMux - DMA request line multiplexer channel x control register
  $24 constant DMAMUX1_C9CR             \ DMAMux - DMA request line multiplexer channel x control register
  $28 constant DMAMUX1_C10CR            \ DMAMux - DMA request line multiplexer channel x control register
  $2C constant DMAMUX1_C11CR            \ DMAMux - DMA request line multiplexer channel x control register
  $30 constant DMAMUX1_C12CR            \ DMAMux - DMA request line multiplexer channel x control register
  $34 constant DMAMUX1_C13CR            \ DMAMux - DMA request line multiplexer channel x control register
  $38 constant DMAMUX1_C14CR            \ DMAMux - DMA request line multiplexer channel x control register
  $3C constant DMAMUX1_C15CR            \ DMAMux - DMA request line multiplexer channel x control register
  $80 constant DMAMUX1_CSR              \ DMAMUX request line multiplexer interrupt channel status register
  $84 constant DMAMUX1_CFR              \ DMAMUX request line multiplexer interrupt clear flag register
  $100 constant DMAMUX1_RG0CR           \ DMAMux - DMA request generator channel x control register
  $104 constant DMAMUX1_RG1CR           \ DMAMux - DMA request generator channel x control register
  $108 constant DMAMUX1_RG2CR           \ DMAMux - DMA request generator channel x control register
  $10C constant DMAMUX1_RG3CR           \ DMAMux - DMA request generator channel x control register
  $110 constant DMAMUX1_RG4CR           \ DMAMux - DMA request generator channel x control register
  $114 constant DMAMUX1_RG5CR           \ DMAMux - DMA request generator channel x control register
  $118 constant DMAMUX1_RG6CR           \ DMAMux - DMA request generator channel x control register
  $11C constant DMAMUX1_RG7CR           \ DMAMux - DMA request generator channel x control register
  $140 constant DMAMUX1_RGSR            \ DMAMux - DMA request generator status register
  $144 constant DMAMUX1_RGCFR           \ DMAMux - DMA request generator clear flag register
