...
$07000000 constant TAMP_TAMP_ATCR1_ATPER                            \ Active tamper output change period The tamper output is changed every CK_ATPER = (2supATPER /supx CK_ATPRE) cycles. Refer to Table713: Minimum ATPER value.
$40000000 constant TAMP_TAMP_ATCR1_ATOSHARE                         \ Active tamper output sharing TAMP_IN1 is compared with TAMPOUTSEL1 TAMP_IN2 is compared with TAMPOUTSEL2 TAMP_IN3 is compared with TAMPOUTSEL3 TAMP_IN4 is compared with TAMPOUTSEL4 TAMP_IN5 is compared with TAMPOUTSEL5 TAMP_IN6 is compared with TAMPOUTSEL6
...
$80000000 constant TAMP_TAMP_SECCFGR_TAMPSEC                        \ Tamper protection (excluding monotonic counters and backup registers) Note: Refer to Section75.3.5: TAMP secure protection modes for details on the read protection.
...
$80000000 constant TAMP_TAMP_PRIVCFGR_TAMPPRIV                      \ Tamper privilege protection (excluding backup registers) Note: Refer to Section75.3.7: TAMP privilege protection modes for details on the read protection.
...
$00400000 constant TAMP_TAMP_MISR_ITAMP7MF                          \ Internal tamper 7 tamper non-secure interrupt masked flag This flag is set by hardware when the internal tamper 7 non-secure interrupt is raised.
...
$00400000 constant TAMP_TAMP_SMISR_ITAMP7MF                         \ Internal tamper 7 secure interrupt masked flag This flag is set by hardware when the internal tamper 7 secure interrupt is raised.
...
$00000002 constant TAMP_TAMP_ERCFGR_ERCFG1                          \ Configurable device secrets configuration
$00000004 constant TAMP_TAMP_ERCFGR_ERCFG2                          \ Configurable device secrets configuration
$00000008 constant TAMP_TAMP_ERCFGR_ERCFG3                          \ Configurable device secrets configuration
$00000010 constant TAMP_TAMP_ERCFGR_ERCFG4                          \ Configurable device secrets configuration
$00000020 constant TAMP_TAMP_ERCFGR_ERCFG5                          \ Configurable device secrets configuration
...
$46007c20 constant TAMP_TAMP_SECCFGR  \ offset: 0x20 : TAMP secure configuration register
$46007c24 constant TAMP_TAMP_PRIVCFGR  \ offset: 0x24 : TAMP privilege configuration register
