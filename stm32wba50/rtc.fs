...
$00000300 constant RTC_RTC_ICSR_BIN                                 \ Binary mode
$00001c00 constant RTC_RTC_ICSR_BCDU                                \ BCD update (BIN = 10 or 11) In mixed mode when both BCD calendar and binary extended counter are used (BIN = 10 or 11), the calendar second is incremented using the SSR Least Significant Bits.
$00010000 constant RTC_RTC_ICSR_RECALPF                             \ Recalibration pending Flag The RECALPF status flag is automatically set to 1 when software writes to the RTC_CALR register, indicating that the RTC_CALR register is blocked. When the new calibration settings are taken into account, this bit returns to 0. Refer to Re-calibration on-the-fly.
...
$00000010 constant RTC_RTC_CR_REFCKON                               \ RTC_REFIN reference clock detection enable (50 or 60Hz) Note: BIN must be 0x00 and PREDIV_S must be 0x00FF.
...
$00000080 constant RTC_RTC_CR_SSRUIE                                \ SSR underflow interrupt enable
...
$00080000 constant RTC_RTC_CR_COSEL                                 \ Calibration output selection When COE = 1, this bit selects which signal is output on CALIB. These frequencies are valid for RTCCLK at 32.768kHz and prescalers at their default values (PREDIV_A = 127 and PREDIV_S = 255). Refer to Section74.3.18: Calibration clock output.
...
$02000000 constant RTC_RTC_CR_TAMPTS                                \ Activate timestamp on tamper detection event TAMPTS is valid even if TSE = 0 in the RTC_CR register. Timestamp flag is set up to 3 ck_apre cycles after the tamper flags.
$04000000 constant RTC_RTC_CR_TAMPOE                                \ Tamper detection output enable on TAMPALRM
$08000000 constant RTC_RTC_CR_ALRAFCLR                              \ Alarm A flag automatic clear
$10000000 constant RTC_RTC_CR_ALRBFCLR                              \ Alarm B flag automatic clear
...
$80000000 constant RTC_RTC_CR_OUT2EN                                \ RTC_OUT2 output enable With this bit set, the RTC outputs can be remapped on RTC_OUT2 as follows: OUT2EN=0: RTC output 2 disable If OSEL different 00 or TAMPOE = 1: TAMPALRM is output on RTC_OUT1 If OSEL=00 and TAMPOE=0 and COE=1: CALIB is output on RTC_OUT1 OUT2EN = 1: RTC output 2 enable If (OSEL different 00 or TAMPOE = 1) and COE = 0: TAMPALRM is output on RTC_OUT2 If OSEL=00 and TAMPOE=0 and COE=1: CALIB is output on RTC_OUT2 If (OSEL different 00 or TAMPOE = 1) and COE = 1: CALIB is output on RTC_OUT2 and TAMPALRM is output on RTC_OUT1.
...
$00000001 constant RTC_RTC_PRIVCFGR_ALRAPRIV                        \ Alarm A and SSR underflow privilege protection
$00000002 constant RTC_RTC_PRIVCFGR_ALRBPRIV                        \ Alarm B privilege protection
$00000004 constant RTC_RTC_PRIVCFGR_WUTPRIV                         \ Wakeup timer privilege protection
$00000008 constant RTC_RTC_PRIVCFGR_TSPRIV                          \ Timestamp privilege protection
$00002000 constant RTC_RTC_PRIVCFGR_CALPRIV                         \ Shift register, Delight saving, calibration and reference clock privilege protection
$00004000 constant RTC_RTC_PRIVCFGR_INITPRIV                        \ Initialization privilege protection
$00008000 constant RTC_RTC_PRIVCFGR_PRIV                            \ RTC privilege protection
...
$00000001 constant RTC_RTC_SECCFGR_ALRASEC                          \ Alarm A and SSR underflow protection
$00000002 constant RTC_RTC_SECCFGR_ALRBSEC                          \ Alarm B protection
$00000004 constant RTC_RTC_SECCFGR_WUTSEC                           \ Wakeup timer protection
$00000008 constant RTC_RTC_SECCFGR_TSSEC                            \ Timestamp protection
$00002000 constant RTC_RTC_SECCFGR_CALSEC                           \ Shift register, daylight saving, calibration and reference clock protection
$00004000 constant RTC_RTC_SECCFGR_INITSEC                          \ Initialization protection
$00008000 constant RTC_RTC_SECCFGR_SEC                              \ RTC global protection
...
$000001ff constant RTC_RTC_CALR_CALM                                \ Calibration minus The frequency of the calendar is reduced by masking CALM out of 2sup20/sup RTCCLK pulses (32seconds if the input frequency is 32768Hz). This decreases the frequency of the calendar with a resolution of 0.9537ppm. To increase the frequency of the calendar, this feature should be used in conjunction with CALP. See Section74.3.16: RTC smooth digital calibration on page4278.
$00001000 constant RTC_RTC_CALR_LPCAL                               \ RTC low-power mode
$00002000 constant RTC_RTC_CALR_CALW16                              \ Use a 16-second calibration cycle period When CALW16 is set to 1, the 16-second calibration cycle period is selected. This bit must not be set to 1 if CALW8 = 1. Note: CALM[0] is stuck at 0 when CALW16 = 1. Refer to Section74.3.16: RTC smooth digital calibration.
$00004000 constant RTC_RTC_CALR_CALW8                               \ Use an 8-second calibration cycle period When CALW8 is set to 1, the 8-second calibration cycle period is selected. Note: CALM[1:0] are stuck at 00 when CALW8 = 1. Refer to Section74.3.16: RTC smooth digital calibration.
$00008000 constant RTC_RTC_CALR_CALP                                \ Increase frequency of RTC by 488.5ppm. This feature is intended to be used in conjunction with CALM, which lowers the frequency of the calendar with a fine resolution. if the input frequency is 32768 Hz, the number of RTCCLK pulses added during a 32 second window is calculated as follows: (512 * CALP) CALM. Refer to Section74.3.16: RTC smooth digital calibration.
...
$00000000 constant RTC_RTC_TSSSR_SS                                 \ Subsecond value/synchronous binary counter values SS[31:0] is the value of the synchronous prescaler counter when the timestamp event occurred.
...
$00007fff constant RTC_RTC_ALRMASSR_SS                              \ Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm A is to be activated. Only bits 0 up MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRMABINR, and so can also be read or written through RTC_ALRMABINR.
$3f000000 constant RTC_RTC_ALRMASSR_MASKSS                          \ Mask the most-significant bits starting at this bit ... From 32 to 63: All 32 SS bits are compared and must match to activate alarm. Note: In BCD mode (BIN=00) the overflow bits of the synchronous counter (bits 31:15) are never compared. These bits can be different from 0 only after a shift operation.
$80000000 constant RTC_RTC_ALRMASSR_SSCLR                           \ Clear synchronous counter on alarm (Binary mode only) Note: SSCLR must be kept to 0 when BCD or mixed mode is used (BIN = 00, 10 or 11).
...
$00007fff constant RTC_RTC_ALRMBSSR_SS                              \ Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRMBBINR, and so can also be read or written through RTC_ALRMBBINR.
$3f000000 constant RTC_RTC_ALRMBSSR_MASKSS                          \ Mask the most-significant bits starting at this bit ... From 32 to 63: All 32 SS bits are compared and must match to activate alarm. Note: In BCD mode (BIN=00)The overflow bits of the synchronous counter (bits 15) is never compared. This bit can be different from 0 only after a shift operation.
$80000000 constant RTC_RTC_ALRMBSSR_SSCLR                           \ Clear synchronous counter on alarm (Binary mode only) Note: SSCLR must be kept to 0 when BCD or mixed mode is used (BIN = 00, 10 or 11).
...
$00000040 constant RTC_RTC_SR_SSRUF                                 \ SSR underflow flag This flag is set by hardware when the SSR rolls under 0. SSRUF is not set when SSCLR=1.
...
$00000001 constant RTC_RTC_MISR_ALRAMF                              \ Alarm A masked flag This flag is set by hardware when the alarm A non-secure interrupt occurs.
$00000002 constant RTC_RTC_MISR_ALRBMF                              \ Alarm B non-secure masked flag This flag is set by hardware when the alarm B non-secure interrupt occurs.
$00000004 constant RTC_RTC_MISR_WUTMF                               \ Wakeup timer non-secure masked flag This flag is set by hardware when the wakeup timer non-secure interrupt occurs. This flag must be cleared by software at least 1.5 RTCCLK periods before WUTF is set to 1 again.
$00000008 constant RTC_RTC_MISR_TSMF                                \ Timestamp non-secure masked flag This flag is set by hardware when a timestamp non-secure interrupt occurs.
$00000010 constant RTC_RTC_MISR_TSOVMF                              \ Timestamp overflow non-secure masked flag This flag is set by hardware when a timestamp interrupt occurs while TSMF is already set. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared.
$00000040 constant RTC_RTC_MISR_SSRUMF                              \ SSR underflow non-secure masked flag This flag is set by hardware when the SSR underflow non-secure interrupt occurs.
...
$00000001 constant RTC_RTC_SMISR_ALRAMF                             \ Alarm A interrupt secure masked flag This flag is set by hardware when the alarm A secure interrupt occurs.
$00000002 constant RTC_RTC_SMISR_ALRBMF                             \ Alarm B interrupt secure masked flag This flag is set by hardware when the alarm B secure interrupt occurs.
$00000004 constant RTC_RTC_SMISR_WUTMF                              \ Wakeup timer interrupt secure masked flag This flag is set by hardware when the wakeup timer secure interrupt occurs. This flag must be cleared by software at least 1.5 RTCCLK periods before WUTF is set to 1 again.
$00000008 constant RTC_RTC_SMISR_TSMF                               \ Timestamp interrupt secure masked flag This flag is set by hardware when a timestamp secure interrupt occurs.
$00000010 constant RTC_RTC_SMISR_TSOVMF                             \ Timestamp overflow interrupt secure masked flag This flag is set by hardware when a timestamp secure interrupt occurs while TSMF is already set. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared.
$00000040 constant RTC_RTC_SMISR_SSRUMF                             \ SSR underflow secure masked flag This flag is set by hardware when the SSR underflow secure interrupt occurs.
...
$00000001 constant RTC_RTC_SCR_CALRAF                               \ Clear alarm A flag Writing 1 in this bit clears the ALRAF bit in the RTC_SR register.
...
$00000008 constant RTC_RTC_SCR_CTSF                                 \ Clear timestamp flag Writing 1 in this bit clears the TSF bit in the RTC_SR register.
...
$00000040 constant RTC_RTC_SCR_CSSRUF                               \ Clear SSR underflow flag Writing '1' in this bit clears the SSRUF in the RTC_SR register.
...
$00000000 constant RTC_RTC_ALRABINR_SS                              \ Synchronous counter alarm value in Binary mode This value is compared with the contents of the synchronous counter to determine if Alarm A is to be activated. Only bits 0 up MASKSS-1 are compared. SS[14:0] is the mirror of SS[14:0] in the RTC_ALRMASSRR, and so can also be read or written through RTC_ALRMASSR.
...
$00000000 constant RTC_RTC_ALRBBINR_SS                              \ Synchronous counter alarm value in Binary mode This value is compared with the contents of the synchronous counter to determine if Alarm Bis to be activated. Only bits 0 up MASKSS-1 are compared. SS[14:0] is the mirror of SS[14:0] in the RTC_ALRMBSSRR, and so can also be read or written through RTC_ALRMBSSR.


\
\ @brief Real-time clock
\
$46007800 constant RTC_RTC_TR     \ offset: 0x00 : RTC time register
$46007804 constant RTC_RTC_DR     \ offset: 0x04 : RTC date register
$46007808 constant RTC_RTC_SSR    \ offset: 0x08 : RTC subsecond register
$4600780c constant RTC_RTC_ICSR   \ offset: 0x0C : RTC initialization control and status register
$46007810 constant RTC_RTC_PRER   \ offset: 0x10 : RTC prescaler register
$46007814 constant RTC_RTC_WUTR   \ offset: 0x14 : RTC wakeup timer register
$46007818 constant RTC_RTC_CR     \ offset: 0x18 : RTC control register
$4600781c constant RTC_RTC_PRIVCFGR  \ offset: 0x1C : RTC privilege mode control register
$46007820 constant RTC_RTC_SECCFGR  \ offset: 0x20 : RTC secure configuration register
$46007824 constant RTC_RTC_WPR    \ offset: 0x24 : RTC write protection register
$46007828 constant RTC_RTC_CALR   \ offset: 0x28 : RTC calibration register
$4600782c constant RTC_RTC_SHIFTR  \ offset: 0x2C : RTC shift control register
$46007830 constant RTC_RTC_TSTR   \ offset: 0x30 : RTC timestamp time register
$46007834 constant RTC_RTC_TSDR   \ offset: 0x34 : RTC timestamp date register
$46007838 constant RTC_RTC_TSSSR  \ offset: 0x38 : RTC timestamp subsecond register
$46007840 constant RTC_RTC_ALRMAR  \ offset: 0x40 : RTC alarm A register
$46007844 constant RTC_RTC_ALRMASSR  \ offset: 0x44 : RTC alarm A subsecond register
$46007848 constant RTC_RTC_ALRMBR  \ offset: 0x48 : RTC alarm B register
$4600784c constant RTC_RTC_ALRMBSSR  \ offset: 0x4C : RTC alarm B subsecond register
$46007850 constant RTC_RTC_SR     \ offset: 0x50 : RTC status register
$46007854 constant RTC_RTC_MISR   \ offset: 0x54 : RTC non-secure masked interrupt status register
$46007858 constant RTC_RTC_SMISR  \ offset: 0x58 : RTC secure masked interrupt status register
$4600785c constant RTC_RTC_SCR    \ offset: 0x5C : RTC status clear register
$46007870 constant RTC_RTC_ALRABINR  \ offset: 0x70 : RTC alarm A binary mode register
$46007874 constant RTC_RTC_ALRBBINR  \ offset: 0x74 : RTC alarm B binary mode register
