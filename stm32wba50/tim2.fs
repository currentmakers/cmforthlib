...
[ifndef] TIM2_DEF
  ...
  $18 constant TIM2_TIM2_CCMR1          \ TIM2 capture/compare mode register 1 [alternate]
  $18 constant TIM2_TIM2_CCMR1_ALTERNATE    \ TIM2 capture/compare mode register 1 [alternate]
  $1C constant TIM2_TIM2_CCMR2          \ TIM2 capture/compare mode register 2 [alternate]
  $1C constant TIM2_TIM2_CCMR2_ALTERNATE    \ TIM2 capture/compare mode register 2 [alternate]
