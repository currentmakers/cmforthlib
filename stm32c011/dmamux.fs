...
$1f000000 constant DMAMUX_DMAMUX_C0CR_SYNC_ID                       \ Synchronization identification Selects the synchronization input (see inputs to resources).
...
$1f000000 constant DMAMUX_DMAMUX_C1CR_SYNC_ID                       \ Synchronization identification Selects the synchronization input (see inputs to resources).
...
$1f000000 constant DMAMUX_DMAMUX_C2CR_SYNC_ID                       \ Synchronization identification Selects the synchronization input (see inputs to resources).
