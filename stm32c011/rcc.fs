...
$0000001c constant RCC_RCC_CR_SYSDIV                                \ System clock division factor This bitfield controlled by software sets the division factor of the system clock divider to produce SYSCLK clock:
...
$00f00000 constant RCC_RCC_CFGR_MCO2PRE                             \ Microcontroller clock output 2 prescaler This bitfield is controlled by software. It sets the division factor of the clock sent to the MCO2 output as follows: ... It is highly recommended to set this field before the MCO2 output is enabled.
...
$f0000000 constant RCC_RCC_CFGR_MCOPRE                              \ Microcontroller clock output prescaler This bitfield is controlled by software. It sets the division factor of the clock sent to the MCO output as follows: ... It is highly recommended to set this field before the MCO output is enabled.
...
$0000c000 constant RCC_RCC_CCIPR_I2S1SEL                            \ I2S1 clock source selection This bitfield is controlled by software to select I2S1 clock source as follows:
$c0000000 constant RCC_RCC_CCIPR_ADCSEL                             \ ADCs clock source selection This bitfield is controlled by software to select the clock source for ADC:
...
$00000018 constant RCC_RCC_CSR1_LSEDRV                              \ LSE oscillator drive capability Set by software to select the LSE oscillator drive capability as follows: Applicable when the LSE oscillator is in Xtal mode, as opposed to bypass mode.
...
$40021054 constant RCC_RCC_CCIPR  \ offset: 0x54 : RCC peripherals independent clock configuration register
