...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_FLASH_CR_DEF
    ...
    $03 constant FLASH_PNB                      \ [0x03 : 4] Page number selection These bits select the page to erase: ... Note: Values corresponding to addresses outside the Main memory are not allowed. See Table 6 and Table 7.
  ...
  [ifdef] FLASH_FLASH_OPTR_DEF
    ...
    $09 constant FLASH_BORR_LEV                 \ [0x09 : 2] BOR threshold at falling VDD supply Falling VDD crossings this threshold activates the reset signal.
    $0b constant FLASH_BORF_LEV                 \ [0x0b : 2] BOR threshold at falling VDD supply Falling VDD crossings this threshold activates the reset signal.
    ...
    $19 constant FLASH_NBOOT1                   \ [0x19] Boot configuration Together with the BOOT0 pin or option bit nBOOT0 (depending on nBOOT_SEL option bit configuration), this bit selects boot mode from the Main flash memory, SRAM or the System memory. Refer to Section 3: Boot configuration.
  ...
  [ifdef] FLASH_FLASH_PCROP1ASR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PCROP1A_STRT             \ [0x00 : 6] PCROP1A area start offset Contains the offset of the first subpage of the PCROP1A area. Note: The number of effective bits depends on the size of the flash memory in the device.
  [then]
  ...
  [ifdef] FLASH_FLASH_PCROP1AER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PCROP1A_END              \ [0x00 : 6] PCROP1A area end offset Contains the offset of the last subpage of the PCROP1A area. Note: The number of effective bits depends on the size of the flash memory in the device.
  ...
  [ifdef] FLASH_FLASH_WRP1AR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_WRP1A_STRT               \ [0x00 : 4] WRP area A start offset This bitfield contains the offset of the first page of the WRP area A. Note: The number of effective bits depends on the size of the flash memory in the device.
    $10 constant FLASH_WRP1A_END                \ [0x10 : 4] WRP area A end offset This bitfield contains the offset of the last page of the WRP area A. Note: The number of effective bits depends on the size of the flash memory in the device.
  [then]
  ...
  [ifdef] FLASH_FLASH_WRP1BR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_WRP1B_STRT               \ [0x00 : 4] WRP area B start offset This bitfield contains the offset of the first page of the WRP area B. Note: The number of effective bits depends on the size of the flash memory in the device.
    $10 constant FLASH_WRP1B_END                \ [0x10 : 4] WRP area B end offset This bitfield contains the offset of the last page of the WRP area B. Note: The number of effective bits depends on the size of the flash memory in the device.
  [then]
  ...
  [ifdef] FLASH_FLASH_PCROP1BSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PCROP1B_STRT             \ [0x00 : 6] PCROP1B area start offset Contains the offset of the first subpage of the PCROP1B area. Note: The number of effective bits depends on the size of the flash memory in the device.
  [then]
  ...
  [ifdef] FLASH_FLASH_PCROP1BER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PCROP1B_END              \ [0x00 : 6] PCROP1B area end offset Contains the offset of the last subpage of the PCROP1B area. Note: The number of effective bits depends on the size of the flash memory in the device.
  [then]
  ...
  [ifdef] FLASH_FLASH_SECR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_SEC_SIZE                 \ [0x00 : 5] Securable memory area size Contains the number of securable flash memory pages. Note: The number of effective bits depends on the size of the flash memory in the device.
