...
$00000070 constant TIM2_SMCR_TS_2_0                                 \ TS[4:0]: Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. 00000: Internal Trigger 0 (ITR0) 00001: Internal Trigger 1 (ITR1) 00010: Internal Trigger 2 (ITR2) 00011: Internal Trigger 3 (ITR3) 00100: TI1 Edge Detector (TI1F_ED) 00101: Filtered Timer Input 1 (TI1FP1) 00110: Filtered Timer Input 2 (TI2FP2) 00111: External Trigger input (ETRF) Others: Reserved See Table Note:: TIM2 internal trigger connection on page 395 for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
$00000080 constant TIM2_SMCR_MSM                                    \ MSM: Master/Slave mode 0: No action 1: The effect of an event on the trigger input (TRGI) is delayed to allow a perfect synchronization between the current timer and its slaves (through TRGO). It is useful if we want to synchronize several timers on a single external event.
...
$00300000 constant TIM2_SMCR_TS_4_3                                 \ Trigger selection. See TS_2_0_ description
...
$00004000 constant TIM2_DIER_TDE                                    \ TDE: Trigger DMA request enable 0: Trigger DMA request disabled 1: Trigger DMA request enabled
...
$0001c000 constant TIM2_AF1_ETR_SEL                                 \ ETRSEL[2:0]: External trigger source selection 000: TIMx External trigger legacy mode 001: TIMx External trigger source select COMP1_OUT Other: Reserved Note: These bits can't be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$00020000 constant TIM2_AF1_ETR_SEL_3                               \ ETRSEL[2:0]: External trigger source selection This field is not used in Blue51. Not available in IUM
...
$0000000f constant TIM2_TISEL_TI1SEL                                \ TI1SEL[3:0]: selects TI1[0] to TI1[15] input 0000: TIMx_CH1 input Others: Reserved
$00000f00 constant TIM2_TISEL_TI2SEL                                \ TI2SEL[3:0]: selects TI2[0] to TI2[15] input 0000: TIMx_CH2 input Others: Reserved
$000f0000 constant TIM2_TISEL_TI3SEL                                \ TI3SEL[3:0]: selects TI3[0] to TI3[15] input 0000: TIMx_CH3 input Others: Reserved
$0f000000 constant TIM2_TISEL_TI4SEL                                \ TI4SEL[3:0]: selects TI4[0] to TI4[15] input 0000: TIMx_CH4 input Others: Reserved
...
$40002018 constant TIM2_CCMR1_IN  \ offset: 0x18 : CCMR1_in register
$4000201c constant TIM2_CCMR2     \ offset: 0x1C : CCMR2 register
$4000201c constant TIM2_CCMR2_IN  \ offset: 0x1C : CCMR2_in register
...
$40002050 constant TIM2_OR1       \ offset: 0x50 : OR1 register
$40002060 constant TIM2_AF1       \ offset: 0x60 : AF1 register
