...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_SMCR_DEF
    ...
    $04 constant TIM2_TS_2_0                    \ [0x04 : 3] TS[4:0]: Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. 00000: Internal Trigger 0 (ITR0) 00001: Internal Trigger 1 (ITR1) 00010: Internal Trigger 2 (ITR2) 00011: Internal Trigger 3 (ITR3) 00100: TI1 Edge Detector (TI1F_ED) 00101: Filtered Timer Input 1 (TI1FP1) 00110: Filtered Timer Input 2 (TI2FP2) 00111: External Trigger input (ETRF) Others: Reserved See Table Note:: TIM2 internal trigger connection on page 395 for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
    $07 constant TIM2_MSM                       \ [0x07] MSM: Master/Slave mode 0: No action 1: The effect of an event on the trigger input (TRGI) is delayed to allow a perfect synchronization between the current timer and its slaves (through TRGO). It is useful if we want to synchronize several timers on a single external event.
    ...
    $14 constant TIM2_TS_4_3                    \ [0x14 : 2] Trigger selection. See TS_2_0_ description
  [then]
  ...
  [ifdef] TIM2_DIER_DEF
    ...
    $0e constant TIM2_TDE                       \ [0x0e] TDE: Trigger DMA request enable 0: Trigger DMA request disabled 1: Trigger DMA request enabled
  [then]
  ...
  [ifdef] TIM2_AF1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0e constant TIM2_ETR_SEL                   \ [0x0e : 3] ETRSEL[2:0]: External trigger source selection 000: TIMx External trigger legacy mode 001: TIMx External trigger source select COMP1_OUT Other: Reserved Note: These bits can't be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $11 constant TIM2_ETR_SEL_3                 \ [0x11] ETRSEL[2:0]: External trigger source selection This field is not used in Blue51. Not available in IUM
  [then]
  ...
  [ifdef] TIM2_TISEL_DEF
    ...
    \ Reset value: 0x    NULL
    \
    $00 constant TIM2_TI1SEL                    \ [0x00 : 4] TI1SEL[3:0]: selects TI1[0] to TI1[15] input 0000: TIMx_CH1 input Others: Reserved
    $08 constant TIM2_TI2SEL                    \ [0x08 : 4] TI2SEL[3:0]: selects TI2[0] to TI2[15] input 0000: TIMx_CH2 input Others: Reserved
    $10 constant TIM2_TI3SEL                    \ [0x10 : 4] TI3SEL[3:0]: selects TI3[0] to TI3[15] input 0000: TIMx_CH3 input Others: Reserved
    $18 constant TIM2_TI4SEL                    \ [0x18 : 4] TI4SEL[3:0]: selects TI4[0] to TI4[15] input 0000: TIMx_CH4 input Others: Reserved
  [then]
  ...
  $18 constant TIM2_CCMR1_IN            \ CCMR1_in register
  $1C constant TIM2_CCMR2               \ CCMR2 register
  $1C constant TIM2_CCMR2_IN            \ CCMR2_in register
  ...
  $50 constant TIM2_OR1                 \ OR1 register
  $60 constant TIM2_AF1                 \ AF1 register
