...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_RTC_CR_DEF
    ...
    $03 constant RTC_TSEDGE                     \ [0x03] Time-stamp event active edge 0: RTC_TS input rising edge generates a time-stamp event 1: RTC_TS input falling edge generates a time-stamp event TSE must be reset when TSEDGE is changed to avoid unwanted TSF setting.
    ...
    $0b constant RTC_TSE                        \ [0x0b] Timestamp enable 0: Timestamp disable 1: Timestamp enable
    ...
    $18 constant RTC_ITSE                       \ [0x18] Timestamp on internal event enable 0: Internal event timestamp disable 1: Internal event timestamp enable
  [then]
  ...
  [ifdef] RTC_RTC_ISR_DEF
    ...
    $0b constant RTC_TSF                        \ [0x0b] This flag is set by hardware when a time-stamp event occurs. This flag is cleared by software by writing 0. If ITSF flag is set, TSF must be cleared together with ITSF by writing 0 in both bits.
    $0c constant RTC_TSOVF                      \ [0x0c] This flag is set by hardware when a time-stamp event occurs while TSF is already set. This flag is cleared by software by writing 0. It is recommended to check and then clear TSOVF only after clearing the TSF bit. Otherwise, an overflow might not be noticed if a timestamp event occurs immediately before the TSF bit is cleared.
    ...
    $11 constant RTC_ITSF                       \ [0x11] Internal time-stamp flag This flag is set by hardware when a time-stamp on the internal event occurs. This flag is cleared by software by writing 0, and must be cleared together with TSF bit by writing 0 in both bits.
  [then]
  ...
  [ifdef] RTC_RTC_ALRMAR_DEF
    ...
    $00 constant RTC_SU                         \ [0x00 : 4] Second units in BCD format.
    $04 constant RTC_ST                         \ [0x04 : 3] Second tens in BCD format.
    $07 constant RTC_MSK1                       \ [0x07] Alarm A seconds mask 0: Alarm A set if the seconds match 1: Seconds dont care in Alarm A comparison
    $08 constant RTC_MNU                        \ [0x08 : 4] Minute units in BCD format.
    $0c constant RTC_MNT                        \ [0x0c : 3] Minute tens in BCD format.
    $0f constant RTC_MSK2                       \ [0x0f] Alarm A minutes mask 0: Alarm A set if the minutes match 1: Minutes dont care in Alarm A comparison
    $10 constant RTC_HU                         \ [0x10 : 4] Hour units in BCD format.
    $14 constant RTC_HT                         \ [0x14 : 2] Hour tens in BCD format.
    $16 constant RTC_PM                         \ [0x16] AM/PM notation 0: AM or 24-hour format 1: PM
    $17 constant RTC_MSK3                       \ [0x17] Alarm A hours mask 0: Alarm A set if the hours match 1: Hours dont care in Alarm A comparison
    $18 constant RTC_DU                         \ [0x18 : 4] Date units or day in BCD format.
    $1c constant RTC_DT                         \ [0x1c : 2] Date tens in BCD format.
    $1e constant RTC_WDSEL                      \ [0x1e] Week day selection 0: DU[3:0] represents the date units 1: DU[3:0] represents the week day. DT[1:0] is dont care.
    $1f constant RTC_MSK4                       \ [0x1f] Alarm A date mask 0: Alarm A set if the date/day match 1: Date/day dont care in Alarm A comparison
  [then]
  ...
  [ifdef] RTC_RTC_SSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_SS                         \ [0x00 : 16] Sub second value SS[15:0] is the value in the synchronous prescalers counter. The fraction of a second is given by the formula below: Second fraction = ( PREDIV_S - SS ) / ( PREDIV_S + 1 )
  [then]
  ...
  [ifdef] RTC_RTC_TSSSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_SS                         \ [0x00 : 16] Sub second value SS[15:0] is the value of the synchronous prescalers counter when the timestamp event occurred.
  [then]
  ...
  [ifdef] RTC_RTC_TAMPCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_TAMP1E                     \ [0x00] RTC_TAMP1 input detection enable 0: RTC_TAMP1 detection disabled 1: RTC_TAMP1 detection enabled.
    $01 constant RTC_TAMP1TRG                   \ [0x01] Active level for RTC_TAMP1 input If TAMPFLT != 00 0: RTC_TAMP1 input staying low triggers a tamper detection event. 1: RTC_TAMP1 input staying high triggers a tamper detection event. if TAMPFLT = 00: 0: RTC_TAMP1 input rising edge triggers a tamper detection event. 1: RTC_TAMP1 input falling edge triggers a tamper detection event.
    $02 constant RTC_TAMPIE                     \ [0x02] Tamper interrupt enable 0: Tamper interrupt disabled 1: Tamper interrupt enabled.
    $07 constant RTC_TAMPTS                     \ [0x07] Activate timestamp on tamper detection event 0: Tamper detection event does not cause a timestamp to be saved 1: Save timestamp on tamper detection event TAMPTS is valid even if TSE=0 in the RTC_CR register.
    $08 constant RTC_TAMPFREQ                   \ [0x08 : 3] Tamper sampling frequency Determines the frequency at which each of the RTC_TAMPx inputs are sampled. 0x0: RTCCLK / 32768 (1 Hz when RTCCLK = 32768 Hz) 0x1: RTCCLK / 16384 (2 Hz when RTCCLK = 32768 Hz) 0x2: RTCCLK / 8192 (4 Hz when RTCCLK = 32768 Hz) 0x3: RTCCLK / 4096 (8 Hz when RTCCLK = 32768 Hz) 0x4: RTCCLK / 2048 (16 Hz when RTCCLK = 32768 Hz) 0x5: RTCCLK / 1024 (32 Hz when RTCCLK = 32768 Hz) 0x6: RTCCLK / 512 (64 Hz when RTCCLK = 32768 Hz) 0x7: RTCCLK / 256 (128 Hz when RTCCLK = 32768 Hz)
    $0b constant RTC_TAMPFLT                    \ [0x0b : 2] RTC_TAMPx filter count These bits determines the number of consecutive samples at the specified level (TAMP*TRG) needed to activate a Tamper event. TAMPFLT is valid for each of the RTC_TAMPx inputs. 0x0: Tamper event is activated on edge of RTC_TAMPx input transitions to the active level (no internal pull-up on RTC_TAMPx input). 0x1: Tamper event is activated after 2 consecutive samples at the active level. 0x2: Tamper event is activated after 4 consecutive samples at the active level. 0x3: Tamper event is activated after 8 consecutive samples at the active level.
    $0d constant RTC_TAMPPRCH                   \ [0x0d : 2] RTC_TAMPx precharge duration These bit determines the duration of time during which the pull-up/is activated before each sample. TAMPPRCH is valid for each of the RTC_TAMPx inputs. 0x0: 1 RTCCLK cycle 0x1: 2 RTCCLK cycles 0x2: 4 RTCCLK cycles 0x3: 8 RTCCLK cycles
    $0f constant RTC_TAMPPUDIS                  \ [0x0f] RTC_TAMPx pull-up disable This bit determines if each of the RTC_TAMPx pins are pre-charged before each sample. 0: Precharge RTC_TAMPx pins before sampling (enable internal pull-up) 1: Disable precharge of RTC_TAMPx pins.
    $10 constant RTC_TAMP1IE                    \ [0x10] Tamper 1 interrupt enable 0: Tamper 1 interrupt is disabled if TAMPIE = 0. 1: Tamper 1 interrupt enabled.
    $11 constant RTC_TAMP1NOERASE               \ [0x11] Tamper 1 no erase 0: Tamper 1 event erases the backup registers. 1: Tamper 1 event does not erase the backup registers.
    $12 constant RTC_TAMP1MF                    \ [0x12] Tamper 1 mask flag 0: Tamper 1 event generates a trigger event and TAMP1F must be cleared by software to allow next tamper event detection. 1: Tamper 1 event generates a trigger event. TAMP1F is masked and internally cleared by hardware.The backup registers are not erased.
  [then]
  ...
  $30 constant RTC_RTC_TSTR             \ RTC_TSTR register
  $34 constant RTC_RTC_TSDR             \ RTC_TSDR register
  $38 constant RTC_RTC_TSSSR            \ RTC_TSSSR register
  $3C constant RTC_RTC_CALR             \ RTC_CALR register
  $40 constant RTC_RTC_TAMPCR           \ RTC_TAMPCR register
  $44 constant RTC_RTC_ALRMASSR         \ RTC_ALRMASSR register
  $4C constant RTC_RTC_OR               \ RTC_OR register
  $50 constant RTC_RTC_BKP0R            \ RTC_BKPxR register
  $54 constant RTC_RTC_BKP1R            \ RTC_BKPxR register
