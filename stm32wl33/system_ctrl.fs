...
$00000010 constant SYSTEM_CTRL_I2C_FMP_CTRL_I2C1_PB10_FMP           \ I2C1_PB10_FMP: I2C1 Fast-Mode Plus driving capability for I2C1_SDA on PB10 I/O. 0: PB10 pin operated in standard mode. 1: FM+ mode is enabled on PB10 pin, and speed control is bypassed.
$00000020 constant SYSTEM_CTRL_I2C_FMP_CTRL_I2C1_PB11_FMP           \ I2C1_PB11_FMP: I2C1 Fast-Mode Plus driving capability for I2C1_SCL on PB11 I/O. 0: PB11 pin operated in standard mode. 1: FM+ mode is enabled on PB11 pin, and speed control is bypassed
$00000040 constant SYSTEM_CTRL_I2C_FMP_CTRL_I2C2_PA6_FMP            \ I2C2_PA6_FMP: I2C2 Fast-Mode Plus driving capability for I2C2_SCL on PA6 I/O. 0: PA6 pin operated in standard mode. 1: FM+ mode is enabled on PA6 pin, and speed control is bypassed.
$00000080 constant SYSTEM_CTRL_I2C_FMP_CTRL_I2C2_PA7_FMP            \ I2C2_PA7_FMP: I2C2 Fast-Mode Plus driving capability for I2C2_SDA on PA7 I/O. 0: PA7 pin operated in standard mode. 1: FM+ mode is enabled on PA7 pin, and speed control is bypassed
$00000100 constant SYSTEM_CTRL_I2C_FMP_CTRL_I2C2_PA13_FMP           \ I2C2_PA13_FMP: I2C2 Fast-Mode Plus driving capability for I2C2_SCL on PA13 I/O. 0: PA13 pin operated in standard mode. 1: FM+ mode is enabled on PA13 pin, and speed control is bypassed.
$00000200 constant SYSTEM_CTRL_I2C_FMP_CTRL_I2C2_PA14_FMP           \ I2C2_PA14_FMP: I2C2 Fast-Mode Plus driving capability for I2C2_SDA on PA14 I/O. 0: PA14 pin operated in standard mode. 1: FM+ mode is enabled on PA14 pin, and speed control is bypassed.
...
$00000010 constant SYSTEM_CTRL_IO_DTR_PA4_DT                        \ PA4_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
$00000020 constant SYSTEM_CTRL_IO_DTR_PA5_DT                        \ PA5_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
$00000040 constant SYSTEM_CTRL_IO_DTR_PA6_DT                        \ PA6_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
$00000080 constant SYSTEM_CTRL_IO_DTR_PA7_DT                        \ PA7_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
...
$00001000 constant SYSTEM_CTRL_IO_DTR_PA12_DT                       \ PA12_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
$00002000 constant SYSTEM_CTRL_IO_DTR_PA13_DT                       \ PA13_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
$00004000 constant SYSTEM_CTRL_IO_DTR_PA14_DT                       \ PA14_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
$00008000 constant SYSTEM_CTRL_IO_DTR_PA15_DT                       \ PA15_DT: Interrupt Detection Type for port A I/Os. 0: edge detection. 1: level detection.
...
$01000000 constant SYSTEM_CTRL_IO_DTR_PB8_DT                        \ PB8_DT: Interrupt Detection Type for port B I/Os. 0: edge detection. 1: level detection.
$02000000 constant SYSTEM_CTRL_IO_DTR_PB9_DT                        \ PB9_DT: Interrupt Detection Type for port B I/Os. 0: edge detection. 1: level detection.
$04000000 constant SYSTEM_CTRL_IO_DTR_PB10_DT                       \ PB10_DT: Interrupt Detection Type for port B I/Os. 0: edge detection. 1: level detection.
$08000000 constant SYSTEM_CTRL_IO_DTR_PB11_DT                       \ PB11_DT: Interrupt Detection Type for port B I/Os. 0: edge detection. 1: level detection.
...
$00000010 constant SYSTEM_CTRL_IO_IBER_PA4_IBE                      \ PA4_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00000020 constant SYSTEM_CTRL_IO_IBER_PA5_IBE                      \ PA5_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00000040 constant SYSTEM_CTRL_IO_IBER_PA6_IBE                      \ PA6_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00000080 constant SYSTEM_CTRL_IO_IBER_PA7_IBE                      \ PA7_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
...
$00001000 constant SYSTEM_CTRL_IO_IBER_PA12_IBE                     \ PA12_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00002000 constant SYSTEM_CTRL_IO_IBER_PA13_IBE                     \ PA13_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00004000 constant SYSTEM_CTRL_IO_IBER_PA14_IBE                     \ PA14_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00008000 constant SYSTEM_CTRL_IO_IBER_PA15_IBE                     \ PA15_IBE: Interrupt edge selection for Port A I/Os. 0: single edge detection. 1: both edges detection
$00010000 constant SYSTEM_CTRL_IO_IBER_PB0_IBE                      \ PB0_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00020000 constant SYSTEM_CTRL_IO_IBER_PB1_IBE                      \ PB1_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00040000 constant SYSTEM_CTRL_IO_IBER_PB2_IBE                      \ PB2_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00080000 constant SYSTEM_CTRL_IO_IBER_PB3_IBE                      \ PB3_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00100000 constant SYSTEM_CTRL_IO_IBER_PB4_IBE                      \ PB4_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00200000 constant SYSTEM_CTRL_IO_IBER_PB5_IBE                      \ PB5_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00400000 constant SYSTEM_CTRL_IO_IBER_PB6_IBE                      \ PB6_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$00800000 constant SYSTEM_CTRL_IO_IBER_PB7_IBE                      \ PB7_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$01000000 constant SYSTEM_CTRL_IO_IBER_PB8_IBE                      \ PB8_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$02000000 constant SYSTEM_CTRL_IO_IBER_PB9_IBE                      \ PB9_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$04000000 constant SYSTEM_CTRL_IO_IBER_PB10_IBE                     \ PB10_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
$08000000 constant SYSTEM_CTRL_IO_IBER_PB11_IBE                     \ PB11_IBE: Interrupt edge selection for port B I/Os. 0: single edge detection. 1: both edges detection.
...
$00000010 constant SYSTEM_CTRL_IO_IEVR_PA4_IEV                      \ PA4_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
$00000020 constant SYSTEM_CTRL_IO_IEVR_PA5_IEV                      \ PA5_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
$00000040 constant SYSTEM_CTRL_IO_IEVR_PA6_IEV                      \ PA6_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
$00000080 constant SYSTEM_CTRL_IO_IEVR_PA7_IEV                      \ PA7_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
...
$00001000 constant SYSTEM_CTRL_IO_IEVR_PA12_IEV                     \ PA12_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
$00002000 constant SYSTEM_CTRL_IO_IEVR_PA13_IEV                     \ PA13_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
$00004000 constant SYSTEM_CTRL_IO_IEVR_PA14_IEV                     \ PA14_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
$00008000 constant SYSTEM_CTRL_IO_IEVR_PA15_IEV                     \ PA15_IEV : Interrupt polarity event for Port A I/Os. 0: falling edge / low level. 1: rising edge / high level.
...
$01000000 constant SYSTEM_CTRL_IO_IEVR_PB8_IEV                      \ PB8_IEV : Interrupt polarity event for Port B I/Os. 0: falling edge / low level. 1: rising edge / high level.
$02000000 constant SYSTEM_CTRL_IO_IEVR_PB9_IEV                      \ PB9_IEV : Interrupt polarity event for Port B I/Os. 0: falling edge / low level. 1: rising edge / high level.
$04000000 constant SYSTEM_CTRL_IO_IEVR_PB10_IEV                     \ PB10_IEV : Interrupt polarity event for Port B I/Os. 0: falling edge / low level. 1: rising edge / high level.
$08000000 constant SYSTEM_CTRL_IO_IEVR_PB11_IEV                     \ PB11_IEV : Interrupt polarity event for Port B I/Os. 0: falling edge / low level. 1: rising edge / high level.
...
$00000010 constant SYSTEM_CTRL_IO_IER_PA4_IE                        \ PA4_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$00000020 constant SYSTEM_CTRL_IO_IER_PA5_IE                        \ PA5_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$00000040 constant SYSTEM_CTRL_IO_IER_PA6_IE                        \ PA6_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$00000080 constant SYSTEM_CTRL_IO_IER_PA7_IE                        \ PA7_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
...
$00001000 constant SYSTEM_CTRL_IO_IER_PA12_IE                       \ PA12_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$00002000 constant SYSTEM_CTRL_IO_IER_PA13_IE                       \ PA13_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$00004000 constant SYSTEM_CTRL_IO_IER_PA14_IE                       \ PA14_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$00008000 constant SYSTEM_CTRL_IO_IER_PA15_IE                       \ PA15_IE: Interrupt enable for port A I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
...
$01000000 constant SYSTEM_CTRL_IO_IER_PB8_IE                        \ PB8_IE: Interrupt enable for port B I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$02000000 constant SYSTEM_CTRL_IO_IER_PB9_IE                        \ PB9_IE: Interrupt enable for port B I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$04000000 constant SYSTEM_CTRL_IO_IER_PB10_IE                       \ PB10_IE: Interrupt enable for port B I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
$08000000 constant SYSTEM_CTRL_IO_IER_PB11_IE                       \ PB11_IE: Interrupt enable for port B I/Os. 0: interrupt is disabled. 1: interrupt is enabled.
...
$00000010 constant SYSTEM_CTRL_IO_ISCR_PA4_ISC                      \ PA4_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$00000020 constant SYSTEM_CTRL_IO_ISCR_PA5_ISC                      \ PA5_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$00000040 constant SYSTEM_CTRL_IO_ISCR_PA6_ISC                      \ PA6_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$00000080 constant SYSTEM_CTRL_IO_ISCR_PA7_ISC                      \ PA7_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
...
$00001000 constant SYSTEM_CTRL_IO_ISCR_PA12_ISC                     \ PA12_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$00002000 constant SYSTEM_CTRL_IO_ISCR_PA13_ISC                     \ PA13_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$00004000 constant SYSTEM_CTRL_IO_ISCR_PA14_ISC                     \ PA14_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$00008000 constant SYSTEM_CTRL_IO_ISCR_PA15_ISC                     \ PA15_ISC: Interrupt status (before mask) for port a I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
...
$01000000 constant SYSTEM_CTRL_IO_ISCR_PB8_ISC                      \ PB8_ISC: Interrupt status (before mask) for port B I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$02000000 constant SYSTEM_CTRL_IO_ISCR_PB9_ISC                      \ PB9_ISC: Interrupt status (before mask) for port B I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$04000000 constant SYSTEM_CTRL_IO_ISCR_PB10_ISC                     \ PB10_ISC: Interrupt status (before mask) for port B I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
$08000000 constant SYSTEM_CTRL_IO_ISCR_PB11_ISC                     \ PB11_ISC: Interrupt status (before mask) for port B I/Os. 0: no pending interrupt. 1: event occurred on corresponding I/O / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
...
$00000001 constant SYSTEM_CTRL_PWRC_IER_BORH_IE                     \ BORH_IE: BORH interrupt enable. 0: BORH interrupt is disabled. 1: BORH interrupt is enabled.
...
$00000001 constant SYSTEM_CTRL_PWRC_ISCR_BORH_ISC                   \ BORH_ISC: BORH interrupt status. 0: no pending interrupt. 1: voltage went under BORH threshold / interrupt occurred (if enabled). Cleared by writing 1 in the bit.
...
$00000001 constant SYSTEM_CTRL_GPIO_SWA_CTRL_ATB1_NPVD              \ ATB1_nPVD: select the analog feature on PB14 between ATB1 and PVD when the PB14 I/O is programmed in analog mode (in the associated GPIO_MODER register): 0: PVD external voltage feature is selected (default). 1: ATB1 feature is selected
...
$00000001 constant SYSTEM_CTRL_INTAI_DTR_TX_DT                      \ TX_DT: detection type on TX_SEQUENCE signal: 0: detection on edge (default). 1: detection on level
$00000002 constant SYSTEM_CTRL_INTAI_DTR_RX_DT                      \ RX_DT: detection type on RX_SEQUENCE signal: 0: detection on edge (default). 1: detection on level
$00000010 constant SYSTEM_CTRL_INTAI_DTR_COMP_DT                    \ COMP_DT: detection type on COMP_OUT (after COMP_POL selection) signal: 0: detection on edge (default). 1: detection on level
$00000020 constant SYSTEM_CTRL_INTAI_DTR_RFIP_BUSY_STATUS_DT        \ RFIP_BUSY_STATUS_DT: detection type on RFIP_BUSY_STATUS signal: 0: detection on edge (default). 1: detection on level
...
$00000001 constant SYSTEM_CTRL_INTAI_IBER_TX_IBE                    \ TX_IBE: interrupt edge register on TX_SEQUENCE signal: 0: detection on single edge (default). 1: detection on both edges
$00000002 constant SYSTEM_CTRL_INTAI_IBER_RX_IBE                    \ RX_IBE: interrupt edge register on RX_SEQUENCE signal: 0: detection on single edge (default). 1: detection on both edges
$00000010 constant SYSTEM_CTRL_INTAI_IBER_COMP_IBE                  \ COMP_IBE: interrupt edge register on COMP_OUT signal: 0: detection on single edge (default). 1: detection on both edges
$00000020 constant SYSTEM_CTRL_INTAI_IBER_RFIP_BUSY_STATUS_IBE      \ RFIP_BUSY_STATUS_IBE: interrupt edge register on RFIP_BUSY_STATUS signal: 0: detection on single edge (default). 1: detection on both edges
...
$00000001 constant SYSTEM_CTRL_INTAI_IEVR_TX_IEV                    \ TX_IEV: interrupt polarity event on TX_SEQUENCE signal: 0: detection on falling edge / low level (default). 1: detection on rising edge / high level
$00000002 constant SYSTEM_CTRL_INTAI_IEVR_RX_IEV                    \ RX_IEV: interrupt polarity event on RX_SEQUENCE signal: 0: detection on falling edge / low level (default). 1: detection on rising edge / high level
$00000010 constant SYSTEM_CTRL_INTAI_IEVR_COMP_IEV                  \ COMP_IEV: interrupt polarity event on COMP_OUT signal: 0: detection on falling edge / low level (default). 1: detection on rising edge / high level
$00000020 constant SYSTEM_CTRL_INTAI_IEVR_RFIP_BUSY_STATUS_IEV      \ RFIP_BUSY_STATUS_IEV: interrupt polarity event on RFIP_BUSY_STATUS signal: 0: detection on falling edge / low level (default). 1: detection on rising edge / high level
...
$00000001 constant SYSTEM_CTRL_INTAI_IER_TX_IE                      \ TX_IE: interrupt enable on TX_SEQUENCE signal: 0: TX_SEQUENCE interrupt is disabled (default). 1: TX_SEQUENCE interrupt is enabled
$00000002 constant SYSTEM_CTRL_INTAI_IER_RX_IE                      \ RX_IE: interrupt enable on RX_SEQUENCE signal: 0: RX_SEQUENCE interrupt is disabled (default). 1: RX_SEQUENCE interrupt is enabled
$00000010 constant SYSTEM_CTRL_INTAI_IER_COMP_IE                    \ COMP_IE: interrupt enable on COMP_OUT signal: 0: COMP_OUT interrupt is disabled (default). 1: COMP_OUT interrupt is enabled
$00000020 constant SYSTEM_CTRL_INTAI_IER_RFIP_BUSY_STATUS_IE        \ RFIP_BUSY_STATUS_IE: interrupt enable on RFIP_BUSY_STATUS signal: 0: RFIP_BUSY_STATUS interrupt is disabled (default). 1: RFIP_BUSY_STATUS interrupt is enabled
...
$00000001 constant SYSTEM_CTRL_INTAI_ISCR_TX_ISC                    \ TX_ISC:interrupt status on TX_SEQUENCE signal (can be a rising or a falling edge depending on BLERXTX_IEVR and BLERXTX_IBER): 0: no activity on TX_SEQUENCE detected. 1: activity on TX_SEQUENCE occurred
$00000002 constant SYSTEM_CTRL_INTAI_ISCR_RX_ISC                    \ RX_ISC: interrupt status on RX_SEQUENCE signal (can be a rising or a falling edge depending on BLERXTX_IEVR and BLERXTX_IBER): 0: no activity on RX_SEQUENCE detected. 1: activity on RX_SEQUENCE occurred
$00000004 constant SYSTEM_CTRL_INTAI_ISCR_TX_ISEDGE                 \ TX_ISEDGE: interrupt edge status on TX_SEQUENCE signal: 0: falling edge on TX_SEQUENCE detected. 1: rising edge on TX_SEQUENCE detected.
$00000008 constant SYSTEM_CTRL_INTAI_ISCR_RX_ISEDGE                 \ RX_ISEDGE: interrupt edge status on RX_SEQUENCE signal: 0: falling edge on RX_SEQUENCE detected. 1: rising edge on RX_SEQUENCE detected.
$00000010 constant SYSTEM_CTRL_INTAI_ISCR_COMP_ISC                  \ COMP_ISC: interrupt status on COMP_OUT (can be a rising or a falling edge depending on INTAI_IEVR and INTAI_IBER): 0: no activity on COMP_OUT detected. 1: activity on COMP_OUT occurred
$00000020 constant SYSTEM_CTRL_INTAI_ISCR_RFIP_BUSY_STATUS_ISC      \ RFIP_BUSY_STATUS_ISC: interrupt status on RFIP_BUSY_STATUS (can be a rising or a falling edge depending on INTAI_IEVR and INTAI_IBER): 0: no activity on RFIP_BUSY_STATUS detected. 1: activity on RFIP_BUSY_STATUS occurred
...
$00000020 constant SYSTEM_CTRL_SYSCFG_SR1_RFIP_BUSY_STATUS          \ RFIP_BUSY_STATUS: MR_SUBG BUSY status: Software should check that MR_SUBG IP is not busy (or relay on the related interrupt) before to initiate any system clock frequency switch to operate the switching in a safe way. 0: MR_SUBG is not busy. 1: MR_SUBG is busy
...
$00000003 constant SYSTEM_CTRL_RF_DTB_CONFIG_RF_DTB_CONFIG          \ Controlling AF7 extended mode: - 00 : MR_SUBG DTB default configuration - 01 : MR_SUBG DTB shuffled configuration - 10 : BUBBLE_DTB configuration - 11 : MR_SUBG DTB default configuration (as per 00)
...
$40000028 constant SYSTEM_CTRL_GPIO_SWA_CTRL  \ offset: 0x28 : GPIO_SWA_CTRL register
$4000002c constant SYSTEM_CTRL_INTAI_DTR  \ offset: 0x2C : INTAI_DTR register
$40000030 constant SYSTEM_CTRL_INTAI_IBER  \ offset: 0x30 : INTAI_IBER register
$40000034 constant SYSTEM_CTRL_INTAI_IEVR  \ offset: 0x34 : INTAI_IEVR register
$40000038 constant SYSTEM_CTRL_INTAI_IER  \ offset: 0x38 : INTAI_IER register
$4000003c constant SYSTEM_CTRL_INTAI_ISCR  \ offset: 0x3C : INTAI_ISCR register
$40000040 constant SYSTEM_CTRL_SYSCFG_SR1  \ offset: 0x40 : SYSCFG_SR1 register
$40000044 constant SYSTEM_CTRL_RF_DTB_CONFIG  \ offset: 0x44 : RF_DTB_CONFIG register
