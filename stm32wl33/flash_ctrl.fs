...
$00000040 constant FLASH_CTRL_CONFIG_SLEEP_SM                       \ Flash memory power-down mode enable in SLEEP mode This bit allows to have the Flash memory in power-down mode or in idle mode when the device is in Sleep mode. - 0: When the device is in Sleep mode, the NVM is in Idle mode. - 1: When the device is in Sleep mode, the NVM is in power-down mode.
...
$0001ffff constant FLASH_CTRL_SIZE_FLASH_SIZE                       \ Maximum valid address for flash memory: - 00 : 0x03FFF (64kb) - 01 : 0x07FFF (128kb) - 10 : 0x0BFFF (192kb) - 11 : 0x0FFFF (256kb)
...
$00000000 constant FLASH_CTRL_UNLOCK012_UNLOCK012                   \ (NOT TO BE DOCUMENTED) Remove read-write protection from IFR0, IFR1, IFR2 sectors
...
$00000000 constant FLASH_CTRL_UNLOCK3_UNLOCK3                       \ (NOT TO BE DOCUMENTED) Remove read-write protection from IFR3 sector
...
$40001050 constant FLASH_CTRL_UNLOCK012  \ offset: 0x50 : UNLOCK012 register
$40001054 constant FLASH_CTRL_UNLOCK3  \ offset: 0x54 : UNLOCK3 register
