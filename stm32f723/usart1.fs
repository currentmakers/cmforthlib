...
[ifndef] USART1_DEF
  ...
  [ifdef] USART1_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART1_BRR                     \ [0x00 : 16] USARTDIV
  [then]
  ...
  [ifdef] USART1_ISR_DEF
    ...
    $19 constant USART1_TCBGT                   \ [0x19] Transmission complete before guard time completion
  [then]
  ...
  [ifdef] USART1_ICR_DEF
    ...
    $07 constant USART1_TCBGTCF                 \ [0x07] Transmission completed before guard time clear flag
