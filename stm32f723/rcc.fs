...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_AHB2RSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $04 constant RCC_AESRST                     \ [0x04] AES module reset
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $1f constant RCC_USBPHYCRST                 \ [0x1f] USB OTG HS PHY controller reset
  [then]
  ...
  [ifdef] RCC_AHB1ENR_DEF
    ...
    $14 constant RCC_DTCMRAMEN                  \ [0x14] CCM data RAM clock enable
  ...
  [ifdef] RCC_AHB2ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $04 constant RCC_AESEN                      \ [0x04] AES module clock enable
  ...
  [ifdef] RCC_APB1ENR_DEF
    ...
    $09 constant RCC_LPTIM1EN                   \ [0x09] Low power timer 1 clock enable
    $0a constant RCC_RTCAPBEN                   \ [0x0a] RTCAPB clock enable
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $07 constant RCC_SDMMC2EN                   \ [0x07] SDMMC2 clock enable
    ...
    $1f constant RCC_USBPHYCEN                  \ [0x1f] USB OTG HS PHY controller clock enable
  [then]
  ...
  [ifdef] RCC_AHB1LPENR_DEF
    ...
    $0d constant RCC_AXILPEN                    \ [0x0d] AXI to AHB bridge clock enable during Sleep mode
    ...
    $14 constant RCC_DTCMLPEN                   \ [0x14] DTCM RAM interface clock enable during Sleep mode
  ...
  [ifdef] RCC_AHB2LPENR_DEF
    ...
    \
    $04 constant RCC_AESLPEN                    \ [0x04] AES module clock enable during Sleep mode
  ...
  [ifdef] RCC_APB2LPENR_DEF
    ...
    $07 constant RCC_SDMMC2LPEN                 \ [0x07] SDMMC2 clock enable during Sleep mode
  ...
  [ifdef] RCC_DCKCFGR2_DEF
    ...
    \ Reset value: 0x20003000
    \
    $00 constant RCC_UART1SEL                   \ [0x00 : 2] USART 1 clock source selection
    $02 constant RCC_UART2SEL                   \ [0x02 : 2] USART 2 clock source selection
    $04 constant RCC_UART3SEL                   \ [0x04 : 2] USART 3 clock source selection
    ...
    $0a constant RCC_UART6SEL                   \ [0x0a : 2] USART 6 clock source selection
  ...
  $8C constant RCC_DCKCFGR1             \ dedicated clocks configuration register
  $90 constant RCC_DCKCFGR2             \ dedicated clocks configuration register
