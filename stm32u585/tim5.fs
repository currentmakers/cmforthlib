...
$02000000 constant TIM5_CR2_MMS_3                                   \ Master mode selection
...
$00000070 constant TIM5_SMCR_TS_2_0                                 \ Trigger selection
...
$00010000 constant TIM5_SMCR_SMS_BIT3                               \ Slave mode selection - bit 3
$00300000 constant TIM5_SMCR_TS_4_3                                 \ Trigger selection
...
$00010000 constant TIM5_CCMR1_OUTPUT_OC1M_BIT3                      \ Output Compare 1 mode - bit 3
$01000000 constant TIM5_CCMR1_OUTPUT_OC2M_BIT3                      \ Output Compare 2 mode - bit 3
...
$00010000 constant TIM5_CCMR2_OUTPUT_OC3M_BIT3                      \ Output Compare 1 mode - bit 3
$01000000 constant TIM5_CCMR2_OUTPUT_OC4M_BIT3                      \ Output Compare 2 mode - bit 3
...
$0000ffff constant TIM5_CNT_CNT_L                                   \ Least significant part of counter value
$7fff0000 constant TIM5_CNT_CNT_H                                   \ Most significant part counter value (on TIM2 and TIM5)
$80000000 constant TIM5_CNT_CNT_BIT31                               \ Most significant bit of counter value (on TIM2 and TIM5)
...
$ffff0000 constant TIM5_ARR_ARR_H                                   \ High Auto-reload value (TIM2 only)
...
$ffff0000 constant TIM5_CCR1_CCR1_H                                 \ High Capture/Compare 1 value (TIM2 only)
...
$ffff0000 constant TIM5_CCR2_CCR2_H                                 \ High Capture/Compare 2 value (TIM2 only)
...
$ffff0000 constant TIM5_CCR3_CCR3_H                                 \ High Capture/Compare value (TIM2 only)
...
$ffff0000 constant TIM5_CCR4_CCR4_H                                 \ High Capture/Compare value (TIM2 only)
...
$00000018 constant TIM5_ECR_IBLK                                    \ Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 input
...
$0000000f constant TIM5_TISEL_TI1SEL                                \ Selects tim_ti1[0..15] input
$00000f00 constant TIM5_TISEL_TI2SEL                                \ Selects tim_ti2[0..15] input
$000f0000 constant TIM5_TISEL_TI3SEL                                \ Selects tim_ti3[0..15] input
$0f000000 constant TIM5_TISEL_TI4SEL                                \ Selects tim_ti4[0..15] input
...
$0003c000 constant TIM5_AF1_ETRSEL                                  \ etr_in source selection
...
$000f0000 constant TIM5_DCR_DBSS                                    \ DMA burst source selection
...
$00000000 constant TIM5_DMAR_ETRSEL                                 \ DMA register for burst accesses
...
$40000c58 constant TIM5_ECR       \ offset: 0x58 : encoder control register
$40000c5c constant TIM5_TISEL     \ offset: 0x5C : timer input selection register
$40000c60 constant TIM5_AF1       \ offset: 0x60 : alternate function register 1
$40000c64 constant TIM5_AF2       \ offset: 0x64 : alternate function register 2
$40000fdc constant TIM5_DCR       \ offset: 0x3DC : DMA control register
