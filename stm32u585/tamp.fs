...
$00000008 constant TAMP_TAMP_CR1_TAMP4E                             \ Tamper detection on TAMP_IN4 enable
$00000010 constant TAMP_TAMP_CR1_TAMP5E                             \ Tamper detection on TAMP_IN5 enable
$00000020 constant TAMP_TAMP_CR1_TAMP6E                             \ Tamper detection on TAMP_IN6 enable
$00000040 constant TAMP_TAMP_CR1_TAMP7E                             \ Tamper detection on TAMP_IN7 enable
$00000080 constant TAMP_TAMP_CR1_TAMP8E                             \ Tamper detection on TAMP_IN8 enable
...
$00400000 constant TAMP_TAMP_CR2_BKBLOCK                            \ Backup registers and device secrets access blocked
$00800000 constant TAMP_TAMP_CR2_BKERASE                            \ Backup registers and device secrets erase Writing '1 to this bit reset the backup registers and device secrets(1). Writing 0 has no effect. This bit is always read as 0.
$01000000 constant TAMP_TAMP_CR2_TAMP1TRG                           \ Active level for tamper 1 input If TAMPFLT = 00 Tamper 1 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 1 input falling edge and low level triggers a tamper detection event.
$02000000 constant TAMP_TAMP_CR2_TAMP2TRG                           \ Active level for tamper 2 input If TAMPFLT = 00 Tamper 2 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 2 input falling edge and low level triggers a tamper detection event.
$04000000 constant TAMP_TAMP_CR2_TAMP3TRG                           \ Active level for tamper 3 input If TAMPFLT = 00 Tamper 3 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 3 input falling edge and low level triggers a tamper detection event.
$08000000 constant TAMP_TAMP_CR2_TAMP4TRG                           \ Active level for tamper 4 input (active mode disabled) If TAMPFLT = 00 Tamper 4 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 4 input falling edge and low level triggers a tamper detection event.
$10000000 constant TAMP_TAMP_CR2_TAMP5TRG                           \ Active level for tamper 5 input (active mode disabled) If TAMPFLT = 00 Tamper 5 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 5 input falling edge and low level triggers a tamper detection event.
$20000000 constant TAMP_TAMP_CR2_TAMP6TRG                           \ Active level for tamper 6 input (active mode disabled) If TAMPFLT = 00 Tamper 6 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 6 input falling edge and low level triggers a tamper detection event.
$40000000 constant TAMP_TAMP_CR2_TAMP7TRG                           \ Active level for tamper 7 input (active mode disabled) If TAMPFLT = 00 Tamper 7 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 7 input falling edge and low level triggers a tamper detection event.
$80000000 constant TAMP_TAMP_CR2_TAMP8TRG                           \ Active level for tamper 8 input (active mode disabled) If TAMPFLT = 00 Tamper 8 input rising edge and high level triggers a tamper detection event. If TAMPFLT  = 00 Tamper 8 input falling edge and low level triggers a tamper detection event.
...
$000000ff constant TAMP_TAMP_SECCFGR_BKPRWSEC                       \ Backup registers read/write protection offset Protection zone 1 is defined for backup registers from TAMP_BKP0R to TAMP_BKPxR (x = BKPRWSEC-1, from 0 to 128). if TZEN=1, these backup registers can be read and written only with secure access. If TZEN=0: the protection zone 1 can be read and written with non-secure access. If BKPRWSEC = 0: there is no protection zone 1. If BKPRWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode.
$00008000 constant TAMP_TAMP_SECCFGR_CNT1SEC                        \ Monotonic counter 1 secure protection
$00ff0000 constant TAMP_TAMP_SECCFGR_BKPWSEC                        \ Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC ¥ BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC ¤ BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode.
$40000000 constant TAMP_TAMP_SECCFGR_BHKLOCK                        \ Boot hardware key lock This bit can be read and can only be written to 1 by software. It is cleared by hardware together with the backup registers following a tamper detection event or when the readout protection (RDP) is disabled.
$80000000 constant TAMP_TAMP_SECCFGR_TAMPSEC                        \ Tamper protection (excluding monotonic counters and backup registers) Note: Refer to for details on the read protection.
...
$00008000 constant TAMP_TAMP_PRIVCR_CNT1PRIV                        \ Monotonic counter 1 privilege protection
$20000000 constant TAMP_TAMP_PRIVCR_BKPRWPRIV                       \ Backup registers zone 1 privilege protection
$40000000 constant TAMP_TAMP_PRIVCR_BKPWPRIV                        \ Backup registers zone 2 privilege protection
$80000000 constant TAMP_TAMP_PRIVCR_TAMPPRIV                        \ Tamper privilege protection (excluding backup registers) Note: Refer to for details on the read protection.
...
$00000001 constant TAMP_TAMP_MISR_TAMP1MF                           \ TAMP1 non-secure interrupt masked flag This flag is set by hardware when the tamper 1 non-secure interrupt is raised.
$00000002 constant TAMP_TAMP_MISR_TAMP2MF                           \ TAMP2 non-secure interrupt masked flag This flag is set by hardware when the tamper 2 non-secure interrupt is raised.
$00000004 constant TAMP_TAMP_MISR_TAMP3MF                           \ TAMP3 non-secure interrupt masked flag This flag is set by hardware when the tamper 3 non-secure interrupt is raised.
$00000008 constant TAMP_TAMP_MISR_TAMP4MF                           \ TAMP4 non-secure interrupt masked flag This flag is set by hardware when the tamper 4 non-secure interrupt is raised.
$00000010 constant TAMP_TAMP_MISR_TAMP5MF                           \ TAMP5 non-secure interrupt masked flag This flag is set by hardware when the tamper 5 non-secure interrupt is raised.
$00000020 constant TAMP_TAMP_MISR_TAMP6MF                           \ TAMP6 non-secure interrupt masked flag This flag is set by hardware when the tamper 6 non-secure interrupt is raised.
$00000040 constant TAMP_TAMP_MISR_TAMP7MF                           \ TAMP7 non-secure interrupt masked flag This flag is set by hardware when the tamper 7 non-secure interrupt is raised.
$00000080 constant TAMP_TAMP_MISR_TAMP8MF                           \ TAMP8 non-secure interrupt masked flag This flag is set by hardware when the tamper 8 non-secure interrupt is raised.
$00010000 constant TAMP_TAMP_MISR_ITAMP1MF                          \ Internal tamper 1 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 1 non-secure interrupt is raised.
$00020000 constant TAMP_TAMP_MISR_ITAMP2MF                          \ Internal tamper 2 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 2 non-secure interrupt is raised.
$00040000 constant TAMP_TAMP_MISR_ITAMP3MF                          \ Internal tamper 3 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 3 non-secure interrupt is raised.
$00100000 constant TAMP_TAMP_MISR_ITAMP5MF                          \ Internal tamper 5 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 5 non-secure interrupt is raised.
$00200000 constant TAMP_TAMP_MISR_ITAMP6MF                          \ Internal tamper 6 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 6 non-secure interrupt is raised.
$00400000 constant TAMP_TAMP_MISR_ITAMP7MF                          \ VCORE monitoring tamper non-secure interrupt masked flag This flag is set by hardware when the internal tamper 7 non-secure interrupt is raised.
$00800000 constant TAMP_TAMP_MISR_ITAMP8MF                          \ Internal tamper 8 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 8 non-secure interrupt is raised.
$01000000 constant TAMP_TAMP_MISR_ITAMP9MF                          \ internal tamper 9 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 9 non-secure interrupt is raised.
$04000000 constant TAMP_TAMP_MISR_ITAMP11MF                         \ internal tamper 11 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 11 non-secure interrupt is raised.
$08000000 constant TAMP_TAMP_MISR_ITAMP12MF                         \ internal tamper 12 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 12 non-secure interrupt is raised.
$10000000 constant TAMP_TAMP_MISR_ITAMP13MF                         \ internal tamper 13 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 13 non-secure interrupt is raised.
...
$00000001 constant TAMP_TAMP_SMISR_TAMP1MF                          \ TAMP1 secure interrupt masked flag This flag is set by hardware when the tamper 1 secure interrupt is raised.
$00000002 constant TAMP_TAMP_SMISR_TAMP2MF                          \ TAMP2 secure interrupt masked flag This flag is set by hardware when the tamper 2 secure interrupt is raised.
$00000004 constant TAMP_TAMP_SMISR_TAMP3MF                          \ TAMP3 secure interrupt masked flag This flag is set by hardware when the tamper 3 secure interrupt is raised.
$00000008 constant TAMP_TAMP_SMISR_TAMP4MF                          \ TAMP4 secure interrupt masked flag This flag is set by hardware when the tamper 4 secure interrupt is raised.
$00000010 constant TAMP_TAMP_SMISR_TAMP5MF                          \ TAMP5 secure interrupt masked flag This flag is set by hardware when the tamper 5 secure interrupt is raised.
$00000020 constant TAMP_TAMP_SMISR_TAMP6MF                          \ TAMP6 secure interrupt masked flag This flag is set by hardware when the tamper 6 secure interrupt is raised.
$00000040 constant TAMP_TAMP_SMISR_TAMP7MF                          \ TAMP7 secure interrupt masked flag This flag is set by hardware when the tamper 7 secure interrupt is raised.
$00000080 constant TAMP_TAMP_SMISR_TAMP8MF                          \ TAMP8 secure interrupt masked flag This flag is set by hardware when the tamper 8 secure interrupt is raised.
$00010000 constant TAMP_TAMP_SMISR_ITAMP1MF                         \ Internal tamper 1 secure interrupt masked flag This flag is set by hardware when the internal tamper 1 secure interrupt is raised.
$00020000 constant TAMP_TAMP_SMISR_ITAMP2MF                         \ Internal tamper 2 secure interrupt masked flag This flag is set by hardware when the internal tamper 2 secure interrupt is raised.
$00040000 constant TAMP_TAMP_SMISR_ITAMP3MF                         \ Internal tamper 3 secure interrupt masked flag This flag is set by hardware when the internal tamper 3 secure interrupt is raised.
$00100000 constant TAMP_TAMP_SMISR_ITAMP5MF                         \ Internal tamper 5 secure interrupt masked flag This flag is set by hardware when the internal tamper 5 secure interrupt is raised.
$00200000 constant TAMP_TAMP_SMISR_ITAMP6MF                         \ Internal tamper 6 secure interrupt masked flag This flag is set by hardware when the internal tamper 6 secure interrupt is raised.
$00400000 constant TAMP_TAMP_SMISR_ITAMP7MF                         \ VCORE monitoring tamper secure interrupt masked flag This flag is set by hardware when the internal tamper 7 secure interrupt is raised.
$00800000 constant TAMP_TAMP_SMISR_ITAMP8MF                         \ Internal tamper 8 secure interrupt masked flag This flag is set by hardware when the internal tamper 8 secure interrupt is raised.
$01000000 constant TAMP_TAMP_SMISR_ITAMP9MF                         \ internal tamper 9 secure interrupt masked flag This flag is set by hardware when the internal tamper 9 secure interrupt is raised.
$04000000 constant TAMP_TAMP_SMISR_ITAMP11MF                        \ internal tamper 11 secure interrupt masked flag This flag is set by hardware when the internal tamper 11 secure interrupt is raised.
$08000000 constant TAMP_TAMP_SMISR_ITAMP12MF                        \ internal tamper 12 secure interrupt masked flag This flag is set by hardware when the internal tamper 12 secure interrupt is raised.
$10000000 constant TAMP_TAMP_SMISR_ITAMP13MF                        \ internal tamper 13 secure interrupt masked flag This flag is set by hardware when the internal tamper 13 secure interrupt is raised.
...
\ @brief Tamper and backup registers
\
$46007c00 constant TAMP_TAMP_CR1  \ offset: 0x00 : TAMP control register 1
$46007c04 constant TAMP_TAMP_CR2  \ offset: 0x04 : TAMP control register 2
$46007c08 constant TAMP_TAMP_CR3  \ offset: 0x08 : TAMP control register 3
$46007c0c constant TAMP_TAMP_FLTCR  \ offset: 0x0C : TAMP filter control register
$46007c10 constant TAMP_TAMP_ATCR1  \ offset: 0x10 : TAMP active tamper control register 1
$46007c14 constant TAMP_TAMP_ATSEEDR  \ offset: 0x14 : TAMP active tamper seed register
$46007c18 constant TAMP_TAMP_ATOR  \ offset: 0x18 : TAMP active tamper output register
$46007c1c constant TAMP_TAMP_ATCR2  \ offset: 0x1C : TAMP active tamper control register 2
$46007c20 constant TAMP_TAMP_SECCFGR  \ offset: 0x20 : TAMP secure mode register
$46007c24 constant TAMP_TAMP_PRIVCR  \ offset: 0x24 : TAMP privilege mode control register
$46007c2c constant TAMP_TAMP_IER  \ offset: 0x2C : TAMP interrupt enable register
$46007c30 constant TAMP_TAMP_SR   \ offset: 0x30 : TAMP status register
$46007c34 constant TAMP_TAMP_MISR  \ offset: 0x34 : TAMP non-secure masked interrupt status register
$46007c38 constant TAMP_TAMP_SMISR  \ offset: 0x38 : TAMP secure masked interrupt status register
$46007c3c constant TAMP_TAMP_SCR  \ offset: 0x3C : TAMP status clear register
$46007c40 constant TAMP_TAMP_COUNT1R  \ offset: 0x40 : TAMP monotonic counter 1 register
$46007c54 constant TAMP_TAMP_ERCFGR  \ offset: 0x54 : TAMP erase configuration register
$46007d00 constant TAMP_TAMP_BKP0R  \ offset: 0x100 : TAMP backup 0 register
$46007d04 constant TAMP_TAMP_BKP1R  \ offset: 0x104 : TAMP backup 1 register
$46007d08 constant TAMP_TAMP_BKP2R  \ offset: 0x108 : TAMP backup 2 register
$46007d0c constant TAMP_TAMP_BKP3R  \ offset: 0x10C : TAMP backup 3 register
$46007d10 constant TAMP_TAMP_BKP4R  \ offset: 0x110 : TAMP backup 4 register
$46007d14 constant TAMP_TAMP_BKP5R  \ offset: 0x114 : TAMP backup 5 register
$46007d18 constant TAMP_TAMP_BKP6R  \ offset: 0x118 : TAMP backup 6 register
$46007d1c constant TAMP_TAMP_BKP7R  \ offset: 0x11C : TAMP backup 7 register
$46007d20 constant TAMP_TAMP_BKP8R  \ offset: 0x120 : TAMP backup 8 register
$46007d24 constant TAMP_TAMP_BKP9R  \ offset: 0x124 : TAMP backup 9 register
$46007d28 constant TAMP_TAMP_BKP10R  \ offset: 0x128 : TAMP backup 10 register
$46007d2c constant TAMP_TAMP_BKP11R  \ offset: 0x12C : TAMP backup 11 register
$46007d30 constant TAMP_TAMP_BKP12R  \ offset: 0x130 : TAMP backup 12 register
$46007d34 constant TAMP_TAMP_BKP13R  \ offset: 0x134 : TAMP backup 13 register
$46007d38 constant TAMP_TAMP_BKP14R  \ offset: 0x138 : TAMP backup 14 register
$46007d3c constant TAMP_TAMP_BKP15R  \ offset: 0x13C : TAMP backup 15 register
$46007d40 constant TAMP_TAMP_BKP16R  \ offset: 0x140 : TAMP backup 16 register
$46007d44 constant TAMP_TAMP_BKP17R  \ offset: 0x144 : TAMP backup 17 register
$46007d48 constant TAMP_TAMP_BKP18R  \ offset: 0x148 : TAMP backup 18 register
$46007d4c constant TAMP_TAMP_BKP19R  \ offset: 0x14C : TAMP backup 19 register
$46007d50 constant TAMP_TAMP_BKP20R  \ offset: 0x150 : TAMP backup 20 register
$46007d54 constant TAMP_TAMP_BKP21R  \ offset: 0x154 : TAMP backup 21 register
$46007d58 constant TAMP_TAMP_BKP22R  \ offset: 0x158 : TAMP backup 22 register
$46007d5c constant TAMP_TAMP_BKP23R  \ offset: 0x15C : TAMP backup 23 register
$46007d60 constant TAMP_TAMP_BKP24R  \ offset: 0x160 : TAMP backup 24 register
$46007d64 constant TAMP_TAMP_BKP25R  \ offset: 0x164 : TAMP backup 25 register
$46007d68 constant TAMP_TAMP_BKP26R  \ offset: 0x168 : TAMP backup 26 register
$46007d6c constant TAMP_TAMP_BKP27R  \ offset: 0x16C : TAMP backup 27 register
$46007d70 constant TAMP_TAMP_BKP28R  \ offset: 0x170 : TAMP backup 28 register
$46007d74 constant TAMP_TAMP_BKP29R  \ offset: 0x174 : TAMP backup 29 register
$46007d78 constant TAMP_TAMP_BKP30R  \ offset: 0x178 : TAMP backup 30 register
$46007d7c constant TAMP_TAMP_BKP31R  \ offset: 0x17C : TAMP backup 31 register
