...
$01000000 constant SEC_TAMP_TAMP_CR2_TAMP1TRG                       \ Active level for tamper 1 input If TAMPFLT = 00 Tamper 1 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 1 input falling edge and low level triggers a tamper detection event.
$02000000 constant SEC_TAMP_TAMP_CR2_TAMP2TRG                       \ Active level for tamper 2 input If TAMPFLT = 00 Tamper 2 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 2 input falling edge and low level triggers a tamper detection event.
$04000000 constant SEC_TAMP_TAMP_CR2_TAMP3TRG                       \ Active level for tamper 3 input If TAMPFLT = 00 Tamper 3 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 3 input falling edge and low level triggers a tamper detection event.
$08000000 constant SEC_TAMP_TAMP_CR2_TAMP4TRG                       \ Active level for tamper 4 input (active mode disabled) If TAMPFLT = 00 Tamper 4 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 4 input falling edge and low level triggers a tamper detection event.
$10000000 constant SEC_TAMP_TAMP_CR2_TAMP5TRG                       \ Active level for tamper 5 input (active mode disabled) If TAMPFLT = 00 Tamper 5 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 5 input falling edge and low level triggers a tamper detection event.
$20000000 constant SEC_TAMP_TAMP_CR2_TAMP6TRG                       \ Active level for tamper 6 input (active mode disabled) If TAMPFLT = 00 Tamper 6 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 6 input falling edge and low level triggers a tamper detection event.
$40000000 constant SEC_TAMP_TAMP_CR2_TAMP7TRG                       \ Active level for tamper 7 input (active mode disabled) If TAMPFLT = 00 Tamper 7 input rising edge and high level triggers a tamper detection event. If TAMPFLT = 00 Tamper 7 input falling edge and low level triggers a tamper detection event.
$80000000 constant SEC_TAMP_TAMP_CR2_TAMP8TRG                       \ Active level for tamper 8 input (active mode disabled) If TAMPFLT = 00 Tamper 8 input rising edge and high level triggers a tamper detection event. If TAMPFLT  = 00 Tamper 8 input falling edge and low level triggers a tamper detection event.
...
$00ff0000 constant SEC_TAMP_TAMP_SECCFGR_BKPWSEC                    \ Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC ¥ BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC ¤ BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode.
...
$00008000 constant SEC_TAMP_TAMP_PRIVCR_CNT1PRIV                    \ Monotonic counter 1 privilege protection
$20000000 constant SEC_TAMP_TAMP_PRIVCR_BKPRWPRIV                   \ Backup registers zone 1 privilege protection
$40000000 constant SEC_TAMP_TAMP_PRIVCR_BKPWPRIV                    \ Backup registers zone 2 privilege protection
$80000000 constant SEC_TAMP_TAMP_PRIVCR_TAMPPRIV                    \ Tamper privilege protection (excluding backup registers) Note: Refer to for details on the read protection.
...
$00400000 constant SEC_TAMP_TAMP_MISR_ITAMP7MF                      \ VCORE monitoring tamper non-secure interrupt masked flag This flag is set by hardware when the internal tamper 7 non-secure interrupt is raised.
...
$00400000 constant SEC_TAMP_TAMP_SMISR_ITAMP7MF                     \ VCORE monitoring tamper secure interrupt masked flag This flag is set by hardware when the internal tamper 7 secure interrupt is raised.
...
$56007c20 constant SEC_TAMP_TAMP_SECCFGR  \ offset: 0x20 : TAMP secure mode register
$56007c24 constant SEC_TAMP_TAMP_PRIVCR  \ offset: 0x24 : TAMP privilege mode control register
