...
[ifndef] TIM15_DEF
  ...
  [ifdef] TIM15_CR2_DEF
    ...
    $04 constant TIM15_MMS                      \ [0x04 : 2] Master mode selection
  ...
  [ifdef] TIM15_CCMR1_Output_DEF
    ...
    $10 constant TIM15_OC1M_bit3                \ [0x10] Output Compare 1 mode
    $18 constant TIM15_OC2M_bit3                \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM15_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM15_TI1SEL                   \ [0x00 : 4] selects tim_ti1_in[0..15] input
    $08 constant TIM15_TI2SEL                   \ [0x08 : 4] selects tim_ti2_in[0..15] input
  [then]
  ...
  $5C constant TIM15_TISEL              \ input selection register
  $60 constant TIM15_AF1                \ alternate function register 1
  $64 constant TIM15_AF2                \ alternate function register 2
