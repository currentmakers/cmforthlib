...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_FLASH_NSKEYR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_NSKEY                    \ [0x00 : 32] Flash memory non-secure key
  [then]
  ...
  [ifdef] FLASH_FLASH_SECKEYR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_SECKEY                   \ [0x00 : 32] Flash memory secure key
  [then]
  ...
  [ifdef] FLASH_FLASH_PDKEY1R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PDKEY1                   \ [0x00 : 32] Bank 1 power-down key
  [then]
  ...
  [ifdef] FLASH_FLASH_PDKEY2R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PDKEY2                   \ [0x00 : 32] Bank 2 power-down key
  [then]
  ...
  [ifdef] FLASH_FLASH_NSSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_EOP                      \ [0x00] Non-secure end of operation
    $01 constant FLASH_OPERR                    \ [0x01] Non-secure operation error
  ...
  [ifdef] FLASH_FLASH_NSCR_DEF
    ...
    $03 constant FLASH_PNB                      \ [0x03 : 7] Non-secure page number selection These bits select the page to erase. ...
  ...
  [ifdef] FLASH_FLASH_SECCR_DEF
    ...
    $03 constant FLASH_PNB                      \ [0x03 : 7] Secure page number selection These bits select the page to erase: ...
    ...
    $19 constant FLASH_ERRIE                    \ [0x19] Secure error interrupt enable
    $1a constant FLASH_RDERRIE                  \ [0x1a] Secure PCROP read error interrupt enable
  ...
  [ifdef] FLASH_FLASH_ECCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_ADDR_ECC                 \ [0x00 : 20] ECC fail address
    $15 constant FLASH_BK_ECC                   \ [0x15] ECC fail bank
  ...
  [ifdef] FLASH_FLASH_OPSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_ADDR_OP                  \ [0x00 : 20] Interrupted operation address This field indicates which address in the Flash memory was accessed when reset occurred. The address is given by bank from address 0x0 0000 to 0xF FFF0.
  ...
  [ifdef] FLASH_FLASH_OPTR_DEF
    ...
    $0f constant FLASH_SRAM1345_RST             \ [0x0f] SRAM1, SRAM3 and SRAM4 erase upon system reset
    ...
    $17 constant FLASH_SRAM3_ECC                \ [0x17] SRAM3 ECC detection and correction enable
  ...
  [ifdef] FLASH_FLASH_SECWM1R1_DEF
    ...
    \
    $00 constant FLASH_SECWM1_PSTRT             \ [0x00 : 7] Start page of first secure area This field contains the first page of the secure area in bank 1.
    $10 constant FLASH_SECWM1_PEND              \ [0x10 : 7] End page of first secure area This field contains the last page of the secure area in bank 1.
  [then]
  ...
  [ifdef] FLASH_FLASH_SECWM1R2_DEF
    ...
    \
    $10 constant FLASH_HDP1_PEND                \ [0x10 : 7] End page of first hide protection area This field contains the last page of the HDP area in bank 1.
  ...
  [ifdef] FLASH_FLASH_WRP1AR_DEF
    ...
    \
    $00 constant FLASH_WRP1A_PSTRT              \ [0x00 : 7] bank 1 WPR first area A start page This field contains the first page of the first WPR area for bank 1.
    $10 constant FLASH_WRP1A_PEND               \ [0x10 : 7] Bank 1 WPR first area A end page This field contains the last page of the first WPR area in bank 1.
  ...
  [ifdef] FLASH_FLASH_WRP1BR_DEF
    ...
    \ Reset value: 0x0F00FF00
    \
    $00 constant FLASH_WRP1B_PSTRT              \ [0x00 : 7] Bank 1 WRP second area B start page This field contains the first page of the second WRP area for bank 1.
    $10 constant FLASH_WRP1B_PEND               \ [0x10 : 7] Bank 1 WRP second area B end page This field contains the last page of the second WRP area in bank 1.
  ...
  [ifdef] FLASH_FLASH_SECWM2R1_DEF
    ...
    \ Reset value: 0xFF00FF00
    \
    $00 constant FLASH_SECWM2_PSTRT             \ [0x00 : 7] Start page of second secure area This field contains the first page of the secure area in bank 2.
    $10 constant FLASH_SECWM2_PEND              \ [0x10 : 7] End page of second secure area This field contains the last page of the secure area in bank 2.
  [then]
  ...
  [ifdef] FLASH_FLASH_SECWM2R2_DEF
    ...
    \ Reset value: 0x0F00FFFF
    \
    $10 constant FLASH_HDP2_PEND                \ [0x10 : 7] End page of hide protection second area HDP2_PEND contains the last page of the HDP area in bank 2.
  ...
  [ifdef] FLASH_FLASH_WRP2AR_DEF
    ...
    \ Reset value: 0x0F00FF00
    \
    $00 constant FLASH_WRP2A_PSTRT              \ [0x00 : 7] Bank 2 WPR first area A start page This field contains the first page of the first WRP area for bank 2.
    $10 constant FLASH_WRP2A_PEND               \ [0x10 : 7] Bank 2 WPR first area A end page This field contains the last page of the first WRP area in bank 2.
  ...
  [ifdef] FLASH_FLASH_WRP2BR_DEF
    ...
    \ Reset value: 0x0F00FF00
    \
    $00 constant FLASH_WRP2B_PSTRT              \ [0x00 : 7] Bank 2 WPR second area B start page This field contains the first page of the second WRP area for bank 2.
    $10 constant FLASH_WRP2B_PEND               \ [0x10 : 7] Bank 2 WPR second area B end page This field contains the last page of the second WRP area in bank 2.
  ...
  [ifdef] FLASH_FLASH_SEC1BBR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_SEC1BB0                  \ [0x00] page secure/non-secure attribution
    $01 constant FLASH_SEC1BB1                  \ [0x01] page secure/non-secure attribution
    $02 constant FLASH_SEC1BB2                  \ [0x02] page secure/non-secure attribution
    $03 constant FLASH_SEC1BB3                  \ [0x03] page secure/non-secure attribution
    $04 constant FLASH_SEC1BB4                  \ [0x04] page secure/non-secure attribution
    $05 constant FLASH_SEC1BB5                  \ [0x05] page secure/non-secure attribution
    $06 constant FLASH_SEC1BB6                  \ [0x06] page secure/non-secure attribution
    $07 constant FLASH_SEC1BB7                  \ [0x07] page secure/non-secure attribution
    $08 constant FLASH_SEC1BB8                  \ [0x08] page secure/non-secure attribution
    $09 constant FLASH_SEC1BB9                  \ [0x09] page secure/non-secure attribution
    $0a constant FLASH_SEC1BB10                 \ [0x0a] page secure/non-secure attribution
    $0b constant FLASH_SEC1BB11                 \ [0x0b] page secure/non-secure attribution
    $0c constant FLASH_SEC1BB12                 \ [0x0c] page secure/non-secure attribution
    $0d constant FLASH_SEC1BB13                 \ [0x0d] page secure/non-secure attribution
    $0e constant FLASH_SEC1BB14                 \ [0x0e] page secure/non-secure attribution
    $0f constant FLASH_SEC1BB15                 \ [0x0f] page secure/non-secure attribution
    $10 constant FLASH_SEC1BB16                 \ [0x10] page secure/non-secure attribution
    $11 constant FLASH_SEC1BB17                 \ [0x11] page secure/non-secure attribution
    $12 constant FLASH_SEC1BB18                 \ [0x12] page secure/non-secure attribution
    $13 constant FLASH_SEC1BB19                 \ [0x13] page secure/non-secure attribution
    $14 constant FLASH_SEC1BB20                 \ [0x14] page secure/non-secure attribution
    $15 constant FLASH_SEC1BB21                 \ [0x15] page secure/non-secure attribution
    $16 constant FLASH_SEC1BB22                 \ [0x16] page secure/non-secure attribution
    $17 constant FLASH_SEC1BB23                 \ [0x17] page secure/non-secure attribution
    $18 constant FLASH_SEC1BB24                 \ [0x18] page secure/non-secure attribution
    $19 constant FLASH_SEC1BB25                 \ [0x19] page secure/non-secure attribution
    $1a constant FLASH_SEC1BB26                 \ [0x1a] page secure/non-secure attribution
    $1b constant FLASH_SEC1BB27                 \ [0x1b] page secure/non-secure attribution
    $1c constant FLASH_SEC1BB28                 \ [0x1c] page secure/non-secure attribution
    $1d constant FLASH_SEC1BB29                 \ [0x1d] page secure/non-secure attribution
    $1e constant FLASH_SEC1BB30                 \ [0x1e] page secure/non-secure attribution
    $1f constant FLASH_SEC1BB31                 \ [0x1f] page secure/non-secure attribution
  [then]
  ...
  [ifdef] FLASH_FLASH_SEC2BBR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_SEC2BB0                  \ [0x00] page secure/non-secure attribution
    $01 constant FLASH_SEC2BB1                  \ [0x01] page secure/non-secure attribution
    $02 constant FLASH_SEC2BB2                  \ [0x02] page secure/non-secure attribution
    $03 constant FLASH_SEC2BB3                  \ [0x03] page secure/non-secure attribution
    $04 constant FLASH_SEC2BB4                  \ [0x04] page secure/non-secure attribution
    $05 constant FLASH_SEC2BB5                  \ [0x05] page secure/non-secure attribution
    $06 constant FLASH_SEC2BB6                  \ [0x06] page secure/non-secure attribution
    $07 constant FLASH_SEC2BB7                  \ [0x07] page secure/non-secure attribution
    $08 constant FLASH_SEC2BB8                  \ [0x08] page secure/non-secure attribution
    $09 constant FLASH_SEC2BB9                  \ [0x09] page secure/non-secure attribution
    $0a constant FLASH_SEC2BB10                 \ [0x0a] page secure/non-secure attribution
    $0b constant FLASH_SEC2BB11                 \ [0x0b] page secure/non-secure attribution
    $0c constant FLASH_SEC2BB12                 \ [0x0c] page secure/non-secure attribution
    $0d constant FLASH_SEC2BB13                 \ [0x0d] page secure/non-secure attribution
    $0e constant FLASH_SEC2BB14                 \ [0x0e] page secure/non-secure attribution
    $0f constant FLASH_SEC2BB15                 \ [0x0f] page secure/non-secure attribution
    $10 constant FLASH_SEC2BB16                 \ [0x10] page secure/non-secure attribution
    $11 constant FLASH_SEC2BB17                 \ [0x11] page secure/non-secure attribution
    $12 constant FLASH_SEC2BB18                 \ [0x12] page secure/non-secure attribution
    $13 constant FLASH_SEC2BB19                 \ [0x13] page secure/non-secure attribution
    $14 constant FLASH_SEC2BB20                 \ [0x14] page secure/non-secure attribution
    $15 constant FLASH_SEC2BB21                 \ [0x15] page secure/non-secure attribution
    $16 constant FLASH_SEC2BB22                 \ [0x16] page secure/non-secure attribution
    $17 constant FLASH_SEC2BB23                 \ [0x17] page secure/non-secure attribution
    $18 constant FLASH_SEC2BB24                 \ [0x18] page secure/non-secure attribution
    $19 constant FLASH_SEC2BB25                 \ [0x19] page secure/non-secure attribution
    $1a constant FLASH_SEC2BB26                 \ [0x1a] page secure/non-secure attribution
    $1b constant FLASH_SEC2BB27                 \ [0x1b] page secure/non-secure attribution
    $1c constant FLASH_SEC2BB28                 \ [0x1c] page secure/non-secure attribution
    $1d constant FLASH_SEC2BB29                 \ [0x1d] page secure/non-secure attribution
    $1e constant FLASH_SEC2BB30                 \ [0x1e] page secure/non-secure attribution
    $1f constant FLASH_SEC2BB31                 \ [0x1f] page secure/non-secure attribution
  [then]
  ...
  [ifdef] FLASH_FLASH_PRIVCFGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_SPRIV                    \ [0x00] Privileged protection for secure registers This bit can be accessed only when TrustZone is enabled (TZEN = 1). This bit can be read by both privileged or unprivileged, secure and non-secure access. The SPRIV bit can be written only by a secure privileged access. A non-secure write access on SPRIV bit is ignored. A secure unprivileged write access on SPRIV bit is ignored.
    $01 constant FLASH_NSPRIV                   \ [0x01] Privileged protection for non-secure registers This bit can be read by both privileged or unprivileged, secure and non-secure access. The NSPRIV bit can be written by a secure or non-secure privileged access. A secure or non-secure unprivileged write access on NSPRIV bit is ignored.
  [then]
  ...
  [ifdef] FLASH_FLASH_PRIV1BBR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PRIV1BB0                 \ [0x00] page privileged/unprivileged attribution
    $01 constant FLASH_PRIV1BB1                 \ [0x01] page privileged/unprivileged attribution
    $02 constant FLASH_PRIV1BB2                 \ [0x02] page privileged/unprivileged attribution
    $03 constant FLASH_PRIV1BB3                 \ [0x03] page privileged/unprivileged attribution
    $04 constant FLASH_PRIV1BB4                 \ [0x04] page privileged/unprivileged attribution
    $05 constant FLASH_PRIV1BB5                 \ [0x05] page privileged/unprivileged attribution
    $06 constant FLASH_PRIV1BB6                 \ [0x06] page privileged/unprivileged attribution
    $07 constant FLASH_PRIV1BB7                 \ [0x07] page privileged/unprivileged attribution
    $08 constant FLASH_PRIV1BB8                 \ [0x08] page privileged/unprivileged attribution
    $09 constant FLASH_PRIV1BB9                 \ [0x09] page privileged/unprivileged attribution
    $0a constant FLASH_PRIV1BB10                \ [0x0a] page privileged/unprivileged attribution
    $0b constant FLASH_PRIV1BB11                \ [0x0b] page privileged/unprivileged attribution
    $0c constant FLASH_PRIV1BB12                \ [0x0c] page privileged/unprivileged attribution
    $0d constant FLASH_PRIV1BB13                \ [0x0d] page privileged/unprivileged attribution
    $0e constant FLASH_PRIV1BB14                \ [0x0e] page privileged/unprivileged attribution
    $0f constant FLASH_PRIV1BB15                \ [0x0f] page privileged/unprivileged attribution
    $10 constant FLASH_PRIV1BB16                \ [0x10] page privileged/unprivileged attribution
    $11 constant FLASH_PRIV1BB17                \ [0x11] page privileged/unprivileged attribution
    $12 constant FLASH_PRIV1BB18                \ [0x12] page privileged/unprivileged attribution
    $13 constant FLASH_PRIV1BB19                \ [0x13] page privileged/unprivileged attribution
    $14 constant FLASH_PRIV1BB20                \ [0x14] page privileged/unprivileged attribution
    $15 constant FLASH_PRIV1BB21                \ [0x15] page privileged/unprivileged attribution
    $16 constant FLASH_PRIV1BB22                \ [0x16] page privileged/unprivileged attribution
    $17 constant FLASH_PRIV1BB23                \ [0x17] page privileged/unprivileged attribution
    $18 constant FLASH_PRIV1BB24                \ [0x18] page privileged/unprivileged attribution
    $19 constant FLASH_PRIV1BB25                \ [0x19] page privileged/unprivileged attribution
    $1a constant FLASH_PRIV1BB26                \ [0x1a] page privileged/unprivileged attribution
    $1b constant FLASH_PRIV1BB27                \ [0x1b] page privileged/unprivileged attribution
    $1c constant FLASH_PRIV1BB28                \ [0x1c] page privileged/unprivileged attribution
    $1d constant FLASH_PRIV1BB29                \ [0x1d] page privileged/unprivileged attribution
    $1e constant FLASH_PRIV1BB30                \ [0x1e] page privileged/unprivileged attribution
    $1f constant FLASH_PRIV1BB31                \ [0x1f] page privileged/unprivileged attribution
  [then]
  ...
  [ifdef] FLASH_FLASH_PRIV2BBR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_PRIV2BB0                 \ [0x00] page privileged/unprivileged attribution
    $01 constant FLASH_PRIV2BB1                 \ [0x01] page privileged/unprivileged attribution
    $02 constant FLASH_PRIV2BB2                 \ [0x02] page privileged/unprivileged attribution
    $03 constant FLASH_PRIV2BB3                 \ [0x03] page privileged/unprivileged attribution
    $04 constant FLASH_PRIV2BB4                 \ [0x04] page privileged/unprivileged attribution
    $05 constant FLASH_PRIV2BB5                 \ [0x05] page privileged/unprivileged attribution
    $06 constant FLASH_PRIV2BB6                 \ [0x06] page privileged/unprivileged attribution
    $07 constant FLASH_PRIV2BB7                 \ [0x07] page privileged/unprivileged attribution
    $08 constant FLASH_PRIV2BB8                 \ [0x08] page privileged/unprivileged attribution
    $09 constant FLASH_PRIV2BB9                 \ [0x09] page privileged/unprivileged attribution
    $0a constant FLASH_PRIV2BB10                \ [0x0a] page privileged/unprivileged attribution
    $0b constant FLASH_PRIV2BB11                \ [0x0b] page privileged/unprivileged attribution
    $0c constant FLASH_PRIV2BB12                \ [0x0c] page privileged/unprivileged attribution
    $0d constant FLASH_PRIV2BB13                \ [0x0d] page privileged/unprivileged attribution
    $0e constant FLASH_PRIV2BB14                \ [0x0e] page privileged/unprivileged attribution
    $0f constant FLASH_PRIV2BB15                \ [0x0f] page privileged/unprivileged attribution
    $10 constant FLASH_PRIV2BB16                \ [0x10] page privileged/unprivileged attribution
    $11 constant FLASH_PRIV2BB17                \ [0x11] page privileged/unprivileged attribution
    $12 constant FLASH_PRIV2BB18                \ [0x12] page privileged/unprivileged attribution
    $13 constant FLASH_PRIV2BB19                \ [0x13] page privileged/unprivileged attribution
    $14 constant FLASH_PRIV2BB20                \ [0x14] page privileged/unprivileged attribution
    $15 constant FLASH_PRIV2BB21                \ [0x15] page privileged/unprivileged attribution
    $16 constant FLASH_PRIV2BB22                \ [0x16] page privileged/unprivileged attribution
    $17 constant FLASH_PRIV2BB23                \ [0x17] page privileged/unprivileged attribution
    $18 constant FLASH_PRIV2BB24                \ [0x18] page privileged/unprivileged attribution
    $19 constant FLASH_PRIV2BB25                \ [0x19] page privileged/unprivileged attribution
    $1a constant FLASH_PRIV2BB26                \ [0x1a] page privileged/unprivileged attribution
    $1b constant FLASH_PRIV2BB27                \ [0x1b] page privileged/unprivileged attribution
    $1c constant FLASH_PRIV2BB28                \ [0x1c] page privileged/unprivileged attribution
    $1d constant FLASH_PRIV2BB29                \ [0x1d] page privileged/unprivileged attribution
    $1e constant FLASH_PRIV2BB30                \ [0x1e] page privileged/unprivileged attribution
    $1f constant FLASH_PRIV2BB31                \ [0x1f] page privileged/unprivileged attribution
  [then]
