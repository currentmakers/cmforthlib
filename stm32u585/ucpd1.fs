...
$00001e00 constant UCPD1_UCPD_CFGR3_TRIM1_NG_CC3A0                  \ SW trim value for Iref on the CC1 line
$000f0000 constant UCPD1_UCPD_CFGR3_TRIM2_NG_CCRPD                  \ SW trim value for RPD resistors on the CC2 line
$1e000000 constant UCPD1_UCPD_CFGR3_TRIM2_NG_CC3A0                  \ SW trim value for Iref on the CC2 line
...
$00000003 constant UCPD1_UCPD_CR_TXMODE                             \ Type of Tx packet Writing the bitfield triggers the action as follows, depending on the value: Others: invalid From V1.1 of the USB PD specification, there is a counter defined for the duration of the BIST Carrier Mode 2. To quit this mode correctly (after the "tBISTContMode" delay), disable the peripheral (UCPDEN = 0).
...
$00000200 constant UCPD1_UCPD_CR_ANAMODE                            \ Analog PHY operating mode The use of CC1 and CC2 depends on CCENABLE. Refer to ANAMODE, ANASUBMODE and link with TYPEC_VSTATE_CCx for the effect of this bitfield in conjunction with ANASUBMODE[1:0].
...
$000fffff constant UCPD1_UCPD_TX_ORDSETR_TXORDSET                   \ Ordered set to transmit The bitfield determines a full 20-bit sequence to transmit, consisting of four K-codes, each of five bits, defining the packet to transmit. The bit 0 (bit 0 of K-code1) is the first, the bit 19 (bit 4 of K‑code4) the last.
...
$00000008 constant UCPD1_UCPD_RX_ORDSETR_RXSOP3OF4                  \ The bit indicates the number of correct K‑codes. For debug purposes only.
...
$000fffff constant UCPD1_UCPD_RX_ORDEXTR1_RXSOPX1                   \ Ordered set 1 received The bitfield contains a full 20-bit sequence received, consisting of four K‑codes, each of five bits. The bit 0 (bit 0 of K‑code1) is receive first, the bit 19 (bit 4 of K‑code4) last.
...
$000fffff constant UCPD1_UCPD_RX_ORDEXTR2_RXSOPX2                   \ Ordered set 2 received The bitfield contains a full 20-bit sequence received, consisting of four K‑codes, each of five bits. The bit 0 (bit 0 of K‑code1) is receive first, the bit 19 (bit 4 of K‑code4) last.


\
\ @brief USB Power Delivery interface
\
$4000dc00 constant UCPD1_UCPD_CFGR1  \ offset: 0x00 : UCPD configuration register 1
$4000dc04 constant UCPD1_UCPD_CFGR2  \ offset: 0x04 : UCPD configuration register 2
$4000dc08 constant UCPD1_UCPD_CFGR3  \ offset: 0x08 : UCPD configuration register 3
$4000dc0c constant UCPD1_UCPD_CR  \ offset: 0x0C : UCPD control register
$4000dc10 constant UCPD1_UCPD_IMR  \ offset: 0x10 : UCPD interrupt mask register
$4000dc14 constant UCPD1_UCPD_SR  \ offset: 0x14 : UCPD status register
$4000dc18 constant UCPD1_UCPD_ICR  \ offset: 0x18 : UCPD interrupt clear register
$4000dc1c constant UCPD1_UCPD_TX_ORDSETR  \ offset: 0x1C : UCPD Tx ordered set type register
$4000dc20 constant UCPD1_UCPD_TX_PAYSZR  \ offset: 0x20 : UCPD Tx payload size register
$4000dc24 constant UCPD1_UCPD_TXDR  \ offset: 0x24 : UCPD Tx data register
$4000dc28 constant UCPD1_UCPD_RX_ORDSETR  \ offset: 0x28 : Rx ordered set code detected
$4000dc2c constant UCPD1_UCPD_RX_PAYSZR  \ offset: 0x2C : Rx payload size received This bitfield contains the number of bytes of a payload (including header but excluding CRC) received: each time a new data byte is received in the UCPD_RXDR register, the bitfield value increments and the RXMSGEND flag is set (and an interrupt generated if enabled). The bitfield may return a spurious value when a byte reception is ongoing (the RXMSGEND flag is low).
$4000dc30 constant UCPD1_UCPD_RXDR  \ offset: 0x30 : Data byte received
$4000dc34 constant UCPD1_UCPD_RX_ORDEXTR1  \ offset: 0x34 : UCPD Rx ordered set extension register 1
$4000dc38 constant UCPD1_UCPD_RX_ORDEXTR2  \ offset: 0x38 : UCPD Rx ordered set extension register 2
