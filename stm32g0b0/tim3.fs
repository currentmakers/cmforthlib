...
[ifndef] TIM3_DEF
  ...
  [ifdef] TIM3_CCMR1_Output_DEF
    ...
    $0c constant TIM3_OC2M                      \ [0x0c : 3] Output compare 2 mode
  ...
  [ifdef] TIM3_CCMR2_Output_DEF
    ...
    $04 constant TIM3_OC3M                      \ [0x04 : 3] Output compare 3 mode
    ...
    $0c constant TIM3_OC4M                      \ [0x0c : 3] Output compare 4 mode
    $0f constant TIM3_OC4CE                     \ [0x0f] Output compare 4 clear enable
    $10 constant TIM3_OC3M_3                    \ [0x10] Output Compare 3 mode - bit 3
    $18 constant TIM3_OC4M_3                    \ [0x18] Output Compare 4 mode - bit 3
  [then]
  ...
  [ifdef] TIM3_CNT_DEF
    ...
    $10 constant TIM3_CNT_H                     \ [0x10 : 16] High counter value (TIM2 only)
  [then]


  [ifdef] TIM3_CNT_ALTERNATE5_DEF
    \
    \ @brief counter
    \ Address offset: 0x24
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CNT                       \ [0x00 : 31] Most significant part counter value (TIM2) nullLeast significant part of counter value
  ...
  [ifdef] TIM3_ARR_DEF
    ...
    \
    $00 constant TIM3_ARR                       \ [0x00 : 32] High auto-reload value (TIM2) nullLow Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM3_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_OCREF_CLR                 \ [0x00] Ocref_clr source selection This bit selects the ocref_clr input source.
  [then]
  ...
  $24 constant TIM3_CNT_ALTERNATE5      \ counter
  ...
  $50 constant TIM3_OR1                 \ TIM option register
  $60 constant TIM3_AF1                 \ TIM alternate function option register 1
  $68 constant TIM3_TISEL               \ TIM alternate function option register 1
