...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_TIM1_OR1_DEF
    \
    \ @brief option register 1
    \ Address offset: 0x50
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_OCREF_CLR                 \ [0x00] Ocref_clr source selection This bit selects the ocref_clr input source.
  [then]


  [ifdef] TIM1_CCMR3_Output_DEF
    \
    \ @brief capture/compare mode register 2 (output mode)
    \ Address offset: 0x54
    \ Reset value: 0x00000000
    ...
    $04 constant TIM1_OC5M                      \ [0x04 : 3] Output compare 5 mode
    ...
    $0c constant TIM1_OC6M                      \ [0x0c : 3] Output compare 6 mode
    $0f constant TIM1_OC6CE                     \ [0x0f] Output compare 6 clear enable
    $10 constant TIM1_OC5M_bit3                 \ [0x10] Output Compare 5 mode bit 3
    $18 constant TIM1_OC6M_bit3                 \ [0x18] Output Compare 6 mode bit 3
  [then]
  ...
  [ifdef] TIM1_TIM1_CCR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_CCR6                      \ [0x00 : 16] Capture/Compare value
  [then]
  ...
  [ifdef] TIM1_TIM1_AF1_DEF
    ...
    $01 constant TIM1_BKCMP1E                   \ [0x01] BRK COMP1 enable This bit enables the COMP1 for the timer's BRK input. COMP1 output is 'ORed' with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM1_BKCMP2E                   \ [0x02] BRK COMP2 enable This bit enables the COMP2 for the timer's BRK input. COMP2 output is 'ORed' with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    ...
    $0a constant TIM1_BKCMP1P                   \ [0x0a] BRK COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $0b constant TIM1_BKCMP2P                   \ [0x0b] BRK COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  [ifdef] TIM1_TIM1_AF2_DEF
    ...
    $01 constant TIM1_BK2CMP1E                  \ [0x01] BRK2 COMP1 enable This bit enables the COMP1 for the timer's BRK2 input. COMP1 output is 'ORed' with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM1_BK2CMP2E                  \ [0x02] BRK2 COMP2 enable This bit enables the COMP2 for the timer's BRK2 input. COMP2 output is 'ORed' with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    ...
    $0a constant TIM1_BK2CMP1P                  \ [0x0a] BRK2 COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $0b constant TIM1_BK2CMP2P                  \ [0x0b] BRK2 COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]
  ...
  \ @brief Advanced-timers
  \
  $00 constant TIM1_TIM1_CR1            \ control register 1
  $04 constant TIM1_TIM1_CR2            \ control register 2
  $08 constant TIM1_TIM1_SMCR           \ slave mode control register
  $0C constant TIM1_TIM1_DIER           \ DMA/Interrupt enable register
  $10 constant TIM1_TIM1_SR             \ status register
  $14 constant TIM1_TIM1_EGR            \ event generation register
  $18 constant TIM1_CCMR1_OUTPUT        \ capture/compare mode register 1 (output mode)
  $18 constant TIM1_CCMR1_INPUT         \ capture/compare mode register 1 (output mode)
  $1C constant TIM1_CCMR2_OUTPUT        \ capture/compare mode register 2 (output mode)
  $1C constant TIM1_CCMR2_INPUT         \ capture/compare mode register 2 (output mode)
  $20 constant TIM1_TIM1_CCER           \ capture/compare enable register
  $24 constant TIM1_TIM1_CNT            \ counter
  $28 constant TIM1_TIM1_PSC            \ prescaler
  $2C constant TIM1_TIM1_ARR            \ auto-reload register
  $30 constant TIM1_TIM1_RCR            \ repetition counter register
  $34 constant TIM1_TIM1_CCR1           \ capture/compare register 1
  $38 constant TIM1_TIM1_CCR2           \ capture/compare register 2
  $3C constant TIM1_TIM1_CCR3           \ capture/compare register 3
  $40 constant TIM1_TIM1_CCR4           \ capture/compare register 4
  $44 constant TIM1_TIM1_BDTR           \ break and dead-time register
  $48 constant TIM1_TIM1_DCR            \ DMA control register
  $4C constant TIM1_TIM1_DMAR           \ DMA address for full transfer
  $50 constant TIM1_TIM1_OR1            \ option register 1
  $54 constant TIM1_CCMR3_OUTPUT        \ capture/compare mode register 2 (output mode)
  $58 constant TIM1_TIM1_CCR5           \ capture/compare register 4
  $5C constant TIM1_TIM1_CCR6           \ capture/compare register 4
  $60 constant TIM1_TIM1_AF1            \ DMA address for full transfer
  $64 constant TIM1_TIM1_AF2            \ DMA address for full transfer
