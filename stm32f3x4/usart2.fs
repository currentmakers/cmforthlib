\
\ @file usart2.fs
\ @brief USART2 global interrupt and EXTI Line 26         interrupt
\
...
$00000002 constant USART2_CR1_UESM                                  \ USART enable in Stop mode
...
$00001000 constant USART2_CR1_M                                     \ Word length
...
$001f0000 constant USART2_CR1_DEDT                                  \ Driver Enable deassertion time
$03e00000 constant USART2_CR1_DEAT                                  \ Driver Enable assertion time
...
$0f000000 constant USART2_CR2_ADD0                                  \ Address of the USART node
$f0000000 constant USART2_CR2_ADD4                                  \ Address of the USART node
...
$00000002 constant USART2_CR3_IREN                                  \ IrDA mode enable
$00000004 constant USART2_CR3_IRLP                                  \ IrDA low-power
...
$0000000f constant USART2_BRR_DIV_FRACTION                          \ fraction of USARTDIV
$0000fff0 constant USART2_BRR_DIV_MANTISSA                          \ mantissa of USARTDIV
...
$00000001 constant USART2_ISR_PE                                    \ Parity error
$00000002 constant USART2_ISR_FE                                    \ Framing error
$00000004 constant USART2_ISR_NF                                    \ Noise detected flag
$00000008 constant USART2_ISR_ORE                                   \ Overrun error
$00000010 constant USART2_ISR_IDLE                                  \ Idle line detected
$00000020 constant USART2_ISR_RXNE                                  \ Read data register not empty
$00000040 constant USART2_ISR_TC                                    \ Transmission complete
$00000080 constant USART2_ISR_TXE                                   \ Transmit data register empty
$00000100 constant USART2_ISR_LBDF                                  \ LIN break detection flag
$00000200 constant USART2_ISR_CTSIF                                 \ CTS interrupt flag
$00000400 constant USART2_ISR_CTS                                   \ CTS flag
$00000800 constant USART2_ISR_RTOF                                  \ Receiver timeout
$00001000 constant USART2_ISR_EOBF                                  \ End of block flag
$00004000 constant USART2_ISR_ABRE                                  \ Auto baud rate error
$00008000 constant USART2_ISR_ABRF                                  \ Auto baud rate flag
$00010000 constant USART2_ISR_BUSY                                  \ Busy flag
$00020000 constant USART2_ISR_CMF                                   \ character match flag
$00040000 constant USART2_ISR_SBKF                                  \ Send break flag
$00080000 constant USART2_ISR_RWU                                   \ Receiver wakeup from Mute mode
$00100000 constant USART2_ISR_WUF                                   \ Wakeup from Stop mode flag
$00200000 constant USART2_ISR_TEACK                                 \ Transmit enable acknowledge flag
$00400000 constant USART2_ISR_REACK                                 \ Receive enable acknowledge flag
...
$00001000 constant USART2_ICR_EOBCF                                 \ End of timeout clear flag
