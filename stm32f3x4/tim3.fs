...
[ifndef] TIM3_DEF
  ...
  [ifdef] TIM3_CCER_DEF
    ...
    $0f constant TIM3_CC4NP                     \ [0x0f] Capture/Compare 3 output Polarity
  [then]
  ...
  [ifdef] TIM3_ARR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_ARR                       \ [0x00 : 16] Auto-reload value
  [then]
  ...
  [ifdef] TIM3_CCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CCR1                      \ [0x00 : 16] Capture/Compare 1 value
  [then]
  ...
  [ifdef] TIM3_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CCR2                      \ [0x00 : 16] Capture/Compare 2 value
  [then]
