...
[ifndef] SYSCFG_COMP_OPAMP_DEF
  ...
  [ifdef] SYSCFG_COMP_OPAMP_COMP2_CSR_DEF
    ...
    $04 constant SYSCFG_COMP_OPAMP_COMP2INMSEL  \ [0x04 : 3] Comparator 2 inverting input selection
    $0a constant SYSCFG_COMP_OPAMP_COMP2OUTSEL  \ [0x0a : 4] Comparator 2 output selection
    ...
    $16 constant SYSCFG_COMP_OPAMP_COMP2INMSEL_22     \ [0x16] Comparator 2 inverting input selection. It is used with Bits [6..4] to configure the Comp inverting input
  ...
  [ifdef] SYSCFG_COMP_OPAMP_COMP4_CSR_DEF
    ...
    $04 constant SYSCFG_COMP_OPAMP_COMP4INMSEL  \ [0x04 : 3] Comparator 4 inverting input selection
    $0a constant SYSCFG_COMP_OPAMP_COMP4OUTSEL  \ [0x0a : 4] Comparator 4 output selection
    ...
    $16 constant SYSCFG_COMP_OPAMP_COMP4INMSEL_22     \ [0x16] Comparator 4 inverting input selection. It is used with Bits [6..4] to configure the Comp inverting input
  ...
  [ifdef] SYSCFG_COMP_OPAMP_COMP6_CSR_DEF
    ...
    $04 constant SYSCFG_COMP_OPAMP_COMP6INMSEL  \ [0x04 : 3] Comparator 6 inverting input selection
    $0a constant SYSCFG_COMP_OPAMP_COMP6OUTSEL  \ [0x0a : 4] Comparator 6 output selection
    ...
    $16 constant SYSCFG_COMP_OPAMP_COMP6INMSEL_22     \ [0x16] Comparator 6 inverting input selection. It is used with Bits [6..4] to configure the Comp inverting input
