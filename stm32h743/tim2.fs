...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_SMCR_DEF
    ...
    $10 constant TIM2_SMS_3                     \ [0x10] Slave mode selection - bit 3
  ...
  [ifdef] TIM2_CCMR1_Output_DEF
    ...
    $02 constant TIM2_OC1FE                     \ [0x02] OC1FE
    $03 constant TIM2_OC1PE                     \ [0x03] OC1PE
    $04 constant TIM2_OC1M                      \ [0x04 : 3] OC1M
    $07 constant TIM2_OC1CE                     \ [0x07] OC1CE
    $08 constant TIM2_CC2S                      \ [0x08 : 2] CC2S
    $0a constant TIM2_OC2FE                     \ [0x0a] OC2FE
    $0b constant TIM2_OC2PE                     \ [0x0b] OC2PE
    $0c constant TIM2_OC2M                      \ [0x0c : 3] OC2M
    $0f constant TIM2_OC2CE                     \ [0x0f] OC2CE
  ...
  [ifdef] TIM2_CCMR1_Input_DEF
    ...
    $02 constant TIM2_ICPCS                     \ [0x02 : 2] Input capture 1 prescaler
    $04 constant TIM2_IC1F                      \ [0x04 : 4] Input capture 1 filter
    $08 constant TIM2_CC2S                      \ [0x08 : 2] Capture/Compare 2 selection
    $0a constant TIM2_IC2PCS                    \ [0x0a : 2] Input capture 2 prescaler
  ...
  [ifdef] TIM2_CCMR2_Output_DEF
    ...
    $02 constant TIM2_OC3FE                     \ [0x02] OC3FE
    $03 constant TIM2_OC3PE                     \ [0x03] OC3PE
    $04 constant TIM2_OC3M                      \ [0x04 : 3] OC3M
    $07 constant TIM2_OC3CE                     \ [0x07] OC3CE
    $08 constant TIM2_CC4S                      \ [0x08 : 2] CC4S
    $0a constant TIM2_OC4FE                     \ [0x0a] OC4FE
    $0b constant TIM2_OC4PE                     \ [0x0b] OC4PE
    $0c constant TIM2_OC4M                      \ [0x0c : 3] OC4M
    $0f constant TIM2_O24CE                     \ [0x0f] O24CE
    $10 constant TIM2_OC3M_3                    \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM2_OC4M_3                    \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM2_CNT_DEF
    ...
    $10 constant TIM2_CNT_H                     \ [0x10 : 16] High counter value
  [then]
  ...
  [ifdef] TIM2_ARR_DEF
    ...
    $10 constant TIM2_ARR_H                     \ [0x10 : 16] High Auto-reload value
  [then]
  ...
  [ifdef] TIM2_CCR1_DEF
    ...
    $10 constant TIM2_CCR1_H                    \ [0x10 : 16] High Capture/Compare 1 value
  [then]
  ...
  [ifdef] TIM2_CCR2_DEF
    ...
    $10 constant TIM2_CCR2_H                    \ [0x10 : 16] High Capture/Compare 2 value
  [then]
  ...
  [ifdef] TIM2_CCR3_DEF
    ...
    $10 constant TIM2_CCR3_H                    \ [0x10 : 16] High Capture/Compare value
  [then]
  ...
  [ifdef] TIM2_CCR4_DEF
    ...
    $10 constant TIM2_CCR4_H                    \ [0x10 : 16] High Capture/Compare value
  [then]
  ...
  [ifdef] TIM2_TISEL_DEF
    ...
    $18 constant TIM2_TI4SEL                    \ [0x18 : 4] TI4[0] to TI4[15] input selection
  [then]
  ...
  $68 constant TIM2_TISEL               \ TIM timer input selection register
