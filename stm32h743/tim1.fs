...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_CCMR2_Output_DEF
    ...
    $18 constant TIM1_OC4M_4                    \ [0x18] Output Compare 4 mode - bit 3
  [then]
  ...
  [ifdef] TIM1_CCMR3_Output_DEF
    ...
    $10 constant TIM1_OC5M3                     \ [0x10] Output Compare 5 mode
    $18 constant TIM1_OC6M3                     \ [0x18] Output Compare 6 mode
  [then]
  ...
  [ifdef] TIM1_AF1_DEF
    ...
    $08 constant TIM1_BKDF1BK0E                 \ [0x08] BRK dfsdm1_break[0] enable
  ...
  [ifdef] TIM1_AF2_DEF
    ...
    $08 constant TIM1_BK2DF1BK1E                \ [0x08] BRK2 dfsdm1_break[1] enable
    $09 constant TIM1_BK2INP                    \ [0x09] BRK2 BKIN2 input polarity
    $0a constant TIM1_BK2CMP1P                  \ [0x0a] BRK2 COMP1 input polarit
  ...
  $54 constant TIM1_CCMR3_OUTPUT        \ capture/compare mode register 3 (output mode)
  $58 constant TIM1_CCR5                \ capture/compare register 5
  $5C constant TIM1_CCR6                \ capture/compare register 6
  $60 constant TIM1_AF1                 \ TIM1 alternate function option register 1
  $64 constant TIM1_AF2                 \ TIM1 Alternate function odfsdm1_breakster 2
