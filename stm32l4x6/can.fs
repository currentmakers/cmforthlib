...
[ifndef] CAN_DEF
  ...
  [ifdef] CAN_FMR_DEF
    ...
    \
    $00 constant CAN_FINIT                      \ [0x00] Filter initialization mode
    $08 constant CAN_CANSB                      \ [0x08 : 6] CAN start bank
  [then]
  ...
  [ifdef] CAN_FFA1R_DEF
    ...
    $0e constant CAN_FFA14                      \ [0x0e] Filter FIFO assignment for filter
    $0f constant CAN_FFA15                      \ [0x0f] Filter FIFO assignment for filter
    $10 constant CAN_FFA16                      \ [0x10] Filter FIFO assignment for filter
    $11 constant CAN_FFA17                      \ [0x11] Filter FIFO assignment for filter
    $12 constant CAN_FFA18                      \ [0x12] Filter FIFO assignment for filter
    $13 constant CAN_FFA19                      \ [0x13] Filter FIFO assignment for filter
    $14 constant CAN_FFA20                      \ [0x14] Filter FIFO assignment for filter
    $15 constant CAN_FFA21                      \ [0x15] Filter FIFO assignment for filter
    $16 constant CAN_FFA22                      \ [0x16] Filter FIFO assignment for filter
    $17 constant CAN_FFA23                      \ [0x17] Filter FIFO assignment for filter
    $18 constant CAN_FFA24                      \ [0x18] Filter FIFO assignment for filter
    $19 constant CAN_FFA25                      \ [0x19] Filter FIFO assignment for filter
    $1a constant CAN_FFA26                      \ [0x1a] Filter FIFO assignment for filter
    $1b constant CAN_FFA27                      \ [0x1b] Filter FIFO assignment for filter
  [then]
  ...
  $18 constant CAN_ESR                  \ interrupt enable register
  ...
  $190 constant CAN_TI1R                \ mailbox identifier register
  ...
  $1A0 constant CAN_TI2R                \ mailbox identifier register
  ...
  $1B4 constant CAN_RDT0R               \ mailbox data high register
  $1B8 constant CAN_RDL0R               \ mailbox data high register
  $1BC constant CAN_RDH0R               \ receive FIFO mailbox data high register
  $1C0 constant CAN_RI1R                \ mailbox data high register
  $1C4 constant CAN_RDT1R               \ mailbox data high register
  $1C8 constant CAN_RDL1R               \ mailbox data high register
  $1CC constant CAN_RDH1R               \ mailbox data high register
  ...
  $21C constant CAN_FA1R                \ filter activation register
