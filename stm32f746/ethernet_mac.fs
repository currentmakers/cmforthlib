...
[ifndef] ETHERNET_MAC_DEF
  ...
  [ifdef] ETHERNET_MAC_MACFFR_DEF
    ...
    $04 constant ETHERNET_MAC_PAM               \ [0x04] PAM
  ...
  [ifdef] ETHERNET_MAC_MACDBGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MAC_MMRPEA            \ [0x00] MMRPEA
    $01 constant ETHERNET_MAC_MSFRWCS           \ [0x01 : 2] MSFRWCS
    $04 constant ETHERNET_MAC_RFWRA             \ [0x04] RFWRA
    $05 constant ETHERNET_MAC_RFRCS             \ [0x05 : 2] RFRCS
    $08 constant ETHERNET_MAC_RFFL              \ [0x08 : 2] RFFL
    $10 constant ETHERNET_MAC_MMTEA             \ [0x10] MMTEA
    $11 constant ETHERNET_MAC_MTFCS             \ [0x11 : 2] MTFCS
    $13 constant ETHERNET_MAC_MTP               \ [0x13] MTP
    $14 constant ETHERNET_MAC_TFRS              \ [0x14 : 2] TFRS
    $16 constant ETHERNET_MAC_TFWA              \ [0x16] TFWA
    $18 constant ETHERNET_MAC_TFNE              \ [0x18] TFNE
    $19 constant ETHERNET_MAC_TFF               \ [0x19] TFF
  [then]
  ...
  [ifdef] ETHERNET_MAC_MACSR_DEF
    ...
    $04 constant ETHERNET_MAC_MMCS              \ [0x04] MMCS
  ...
  [ifdef] ETHERNET_MAC_MACA1LR_DEF
    ...
    \ Reset value: 0xFFFFFFFF
    \
    $00 constant ETHERNET_MAC_MACA1L            \ [0x00 : 32] MACA1L
  [then]
  ...
  [ifdef] ETHERNET_MAC_MACA3LR_DEF
    ...
    \ Reset value: 0xFFFFFFFF
    \
    $00 constant ETHERNET_MAC_MACA3L            \ [0x00 : 32] MACA3L
  [then]
