...
[ifndef] HASH_DEF
  ...
  [ifdef] HASH_CR_DEF
    ...
    $12 constant HASH_ALGO1                     \ [0x12] ALGO
  [then]
  ...
  $314 constant HASH_HASH_HR1           \ read-only
  $318 constant HASH_HASH_HR2           \ read-only
  $31C constant HASH_HASH_HR3           \ read-only
  $320 constant HASH_HASH_HR4           \ read-only
  $324 constant HASH_HASH_HR5           \ read-only
  $328 constant HASH_HASH_HR6           \ read-only
  $32C constant HASH_HASH_HR7           \ read-only
