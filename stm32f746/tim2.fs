...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_SMCR_DEF
    ...
    $10 constant TIM2_SMS_3                     \ [0x10] Slave model selection - bit[3]
  [then]
  ...
  [ifdef] TIM2_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_ITR1_RMP                  \ [0x00] Internal trigger 1 remap
    $01 constant TIM2_ETR1_RMP                  \ [0x01] External trigger remap
    $02 constant TIM2_TI4_RMP                   \ [0x02 : 2] Input Capture 4 remap
  [then]
  ...
  [ifdef] TIM2_OR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $0e constant TIM2_ETRSEL                    \ [0x0e : 3] ETR source selection
  [then]
  ...
  $50 constant TIM2_OR1                 \ TIM2 option register 1
  $60 constant TIM2_OR2                 \ TIM2 option register 2
