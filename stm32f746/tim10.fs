...
[ifndef] TIM10_DEF
  ...
  [ifdef] TIM10_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM10_SMS                      \ [0x00 : 3] Slave mode selection
    $04 constant TIM10_TS                       \ [0x04 : 3] Trigger selection
    $07 constant TIM10_MSM                      \ [0x07] Master/slave mode
    ...
    $10 constant TIM10_SMS3                     \ [0x10] Slave mode selection
  [then]
  ...
  [ifdef] TIM10_CCMR1_Input_DEF
    ...
    \
    $00 constant TIM10_CC1S                     \ [0x00 : 2] Capture/Compare 1 selection
    $02 constant TIM10_ICPCS                    \ [0x02 : 2] Input capture 1 prescaler
  ...
  [ifdef] TIM10_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM10_TI1_RMP                  \ [0x00 : 2] TIM11 Input 1 remapping capability
  [then]
  ...
  $08 constant TIM10_SMCR               \ slave mode control register
  ...
  $18 constant TIM10_CCMR1_OUTPUT       \ capture/compare mode register 1 (output mode)
