...
[ifndef] TIM11_DEF
  ...
  [ifdef] TIM11_CCMR1_Input_DEF
    \
    \ @brief capture/compare mode register 1 (inputmode)
    \ Address offset: 0x18
    \ Reset value: 0x00000000
    \
    $00 constant TIM11_CC1S                     \ [0x00 : 2] Capture/Compare 1 selection
  ...
  [ifdef] TIM11_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM11_RMP                      \ [0x00 : 2] Input 1 remapping capability
  [then]
  ...
  $18 constant TIM11_CCMR1_OUTPUT       \ capture/compare mode register 1 (output mode)
  $18 constant TIM11_CCMR1_INPUT        \ capture/compare mode register 1 (inputmode)
