...
[ifndef] I2C_DEF
  ...
  [ifdef] I2C_OAR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant I2C_ADD0                       \ [0x00] Interface address
    $01 constant I2C_ADD7                       \ [0x01 : 7] Interface address
    $08 constant I2C_ADD10                      \ [0x08 : 2] Interface address
    $0f constant I2C_ADDMODE                    \ [0x0f] Addressing mode (slave mode)
  [then]
  ...
  [ifdef] I2C_DR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant I2C_DR                         \ [0x00 : 8] 8-bit data register
  [then]
  ...
  [ifdef] I2C_FLTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant I2C_DNF                        \ [0x00 : 4] Digital noise filter
    $04 constant I2C_ANOFF                      \ [0x04] Analog noise filter OFF
  [then]
  ...
  $10 constant I2C_DR                   \ Data register
  $14 constant I2C_SR1                  \ Status register 1
  $18 constant I2C_SR2                  \ Status register 2
  $1C constant I2C_CCR                  \ Clock control register
  $20 constant I2C_TRISE                \ TRISE register
  $24 constant I2C_FLTR                 \ I2C FLTR register
