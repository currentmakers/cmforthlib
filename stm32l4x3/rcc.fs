...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_AHB1ENR_DEF
    ...
    $0b constant RCC_CRCEN                      \ [0x0b] CRC clock enable
  ...
  [ifdef] RCC_AHB1SMENR_DEF
    ...
    $0b constant RCC_CRCSMEN                    \ [0x0b] CRCSMEN
  ...
  [ifdef] RCC_CRRCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_HSI48ON                    \ [0x00] HSI48ON
    $01 constant RCC_HSI48RDY                   \ [0x01] HSI48RDY
    $07 constant RCC_HSI48CAL                   \ [0x07 : 9] HSI48CAL
  [then]
  ...
  [ifdef] RCC_CCIPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_I2C4SEL                    \ [0x00 : 2] I2C4SEL
  [then]
