...
[ifndef] ADC_DEF
  ...
  [ifdef] ADC_SMPR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_SMP10                      \ [0x00 : 3] Channel 10 sample time selection
    $03 constant ADC_SMP11                      \ [0x03 : 3] Channel 11 sample time selection
    $06 constant ADC_SMP12                      \ [0x06 : 3] Channel 12 sample time selection
    $09 constant ADC_SMP13                      \ [0x09 : 3] Channel 13 sample time selection
    $0c constant ADC_SMP14                      \ [0x0c : 3] Channel 14 sample time selection
    $0f constant ADC_SMP15                      \ [0x0f : 3] Channel 15 sample time selection
    $12 constant ADC_SMP16                      \ [0x12 : 3] Channel 16 sample time selection
    $15 constant ADC_SMP17                      \ [0x15 : 3] Channel 17 sample time selection
  [then]
  ...
  [ifdef] ADC_SMPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC_SMP0                       \ [0x00 : 3] Channel 0 sample time selection
    $03 constant ADC_SMP1                       \ [0x03 : 3] Channel 1 sample time selection
    $06 constant ADC_SMP2                       \ [0x06 : 3] Channel 2 sample time selection
    $09 constant ADC_SMP3                       \ [0x09 : 3] Channel 3 sample time selection
    $0c constant ADC_SMP4                       \ [0x0c : 3] Channel 4 sample time selection
    $0f constant ADC_SMP5                       \ [0x0f : 3] Channel 5 sample time selection
    $12 constant ADC_SMP6                       \ [0x12 : 3] Channel 6 sample time selection
    $15 constant ADC_SMP7                       \ [0x15 : 3] Channel 7 sample time selection
    $18 constant ADC_SMP8                       \ [0x18 : 3] Channel 8 sample time selection
    $1b constant ADC_SMP9                       \ [0x1b : 3] Channel 9 sample time selection
  [then]
