...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $0f constant RCC_ADC3RST                    \ [0x0f] ADC 3 interface reset
  ...
  [ifdef] RCC_AHBENR_DEF
    ...
    $0a constant RCC_SDIOEN                     \ [0x0a] SDIO clock enable
  [then]
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $0f constant RCC_ADC3EN                     \ [0x0f] ADC3 interface clock enable
