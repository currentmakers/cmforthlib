...
[ifndef] AFIO_DEF
  ...
  [ifdef] AFIO_MAPR_DEF
    ...
    $0d constant AFIO_CAN_REMAP                 \ [0x0d : 2] CAN1 remapping
    ...
    $11 constant AFIO_ADC1_ETRGINJ_REMAP        \ [0x11] ADC 1 External trigger injected conversion remapping
    $12 constant AFIO_ADC1_ETRGREG_REMAP        \ [0x12] ADC 1 external trigger regular conversion remapping
    $13 constant AFIO_ADC2_ETRGINJ_REMAP        \ [0x13] ADC 2 external trigger injected conversion remapping
    $14 constant AFIO_ADC2_ETRGREG_REMAP        \ [0x14] ADC 2 external trigger regular conversion remapping
