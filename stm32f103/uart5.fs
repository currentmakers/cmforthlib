...
[ifndef] UART5_DEF
  ...
  \ @brief Universal asynchronous receiver transmitter
  \
  $00 constant UART5_SR                 \ UART4_SR
  $04 constant UART5_DR                 \ UART4_DR
  $08 constant UART5_BRR                \ UART4_BRR
  $0C constant UART5_CR1                \ UART4_CR1
  $10 constant UART5_CR2                \ UART4_CR2
  $14 constant UART5_CR3                \ UART4_CR3
