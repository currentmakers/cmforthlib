...
[ifndef] CRC_DEF
  ...
  [ifdef] CRC_CRC_IDR_DEF
    ...
    \
    $00 constant CRC_GPDR                       \ [0x00 : 32] General-purpose 32-bit data register bits These bits can be used as a temporary storage location for four bytes. This register is not affected by CRC resets generated by the RESET bit in the CRC_CR register
  [then]
