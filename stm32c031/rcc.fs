...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_RCC_CR_DEF
    ...
    \
    $02 constant RCC_SYSDIV                     \ [0x02 : 3] System clock division factor This bitfield controlled by software sets the division factor of the system clock divider to produce SYSCLK clock:
  ...
  [ifdef] RCC_RCC_CFGR_DEF
    ...
    $14 constant RCC_MCO2PRE                    \ [0x14 : 4] Microcontroller clock output 2 prescaler This bitfield is controlled by software. It sets the division factor of the clock sent to the MCO2 output as follows: ... It is highly recommended to set this field before the MCO2 output is enabled.
    ...
    $1c constant RCC_MCOPRE                     \ [0x1c : 4] Microcontroller clock output prescaler This bitfield is controlled by software. It sets the division factor of the clock sent to the MCO output as follows: ... It is highly recommended to set this field before the MCO output is enabled.
  [then]
  ...
  [ifdef] RCC_RCC_CCIPR_DEF
    ...
    $1e constant RCC_ADCSEL                     \ [0x1e : 2] ADCs clock source selection This bitfield is controlled by software to select the clock source for ADC:
  [then]
  ...
  $54 constant RCC_RCC_CCIPR            \ RCC peripherals independent clock configuration register
