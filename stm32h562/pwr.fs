...
$01000000 constant PWR_PWR_USBSCR_USB33DEN                          \ V DDUSB voltage level detector enable
$02000000 constant PWR_PWR_USBSCR_USB33SV                           \ independent USB supply valid This bit is used to validate the V DDUSB supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the USBFS peripheral. If V DDUSB is not always present in the application, the V DDUSB voltage monitor can be used to determine whether this supply is ready or not.
...
$01000000 constant PWR_PWR_VMSR_USB33RDY                            \ V DDUSB ready
