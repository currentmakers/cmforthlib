...
$00000300 constant TIM1_TIM1_CR1_CKD                                \ Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t DTS )used by the dead-time generators and the digital filters (tim_etr_in, tim_tix),
...
$00ff0000 constant TIM1_TIM1_ECR_PW                                 \ Pulse width This bitfield defines the pulse duration, as following: t PW = PW[7:0] x t PWG
$07000000 constant TIM1_TIM1_ECR_PWPRSC                             \ Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t PWG = (2sup (PWPRSC[2:0])/sup ) x t tim_ker_ck
