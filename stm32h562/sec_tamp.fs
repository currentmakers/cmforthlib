...
$00000040 constant SEC_TAMP_TAMP_CR1_TAMP7E                         \ Tamper detection on TAMP_IN7 enable
$00000080 constant SEC_TAMP_TAMP_CR1_TAMP8E                         \ Tamper detection on TAMP_IN8 enable
$00010000 constant SEC_TAMP_TAMP_CR1_ITAMP1E                        \ Internal tamper 1 enable
$00020000 constant SEC_TAMP_TAMP_CR1_ITAMP2E                        \ Internal tamper 2 enable
$00040000 constant SEC_TAMP_TAMP_CR1_ITAMP3E                        \ Internal tamper 3 enable
$00080000 constant SEC_TAMP_TAMP_CR1_ITAMP4E                        \ Internal tamper 4 enable
...
$40000000 constant SEC_TAMP_TAMP_CR1_ITAMP15E                       \ Internal tamper 15 enable
...
$00000040 constant SEC_TAMP_TAMP_CR2_TAMP7NOER                      \ Tamper 7 no erase
$00000080 constant SEC_TAMP_TAMP_CR2_TAMP8NOER                      \ Tamper 8 no erase
...
$00400000 constant SEC_TAMP_TAMP_CR2_BKBLOCK                        \ Backup registers and device secrets access blocked
$00800000 constant SEC_TAMP_TAMP_CR2_BKERASE                        \ Backup registers and device secrets erase Writing '1' to this bit reset the backup registers and device secrets(1). Writing 0 has no effect. This bit is always read as 0.
...
$40000000 constant SEC_TAMP_TAMP_CR2_TAMP7TRG                       \ Active level for tamper 7 input (active mode disabled) If TAMPFLT = 00 Tamper 7 input rising edge triggers a tamper detection event. If TAMPFLT = 00 Tamper 7 input falling edge triggers a tamper detection event.
$80000000 constant SEC_TAMP_TAMP_CR2_TAMP8TRG                       \ Active level for tamper 8 input (active mode disabled) If TAMPFLT = 00 Tamper 8 input rising edge triggers a tamper detection event. If TAMPFLT = 00 Tamper 8 input falling edge triggers a tamper detection event.
...
$00000001 constant SEC_TAMP_TAMP_CR3_ITAMP1NOER                     \ Internal Tamper 1 no erase
$00000002 constant SEC_TAMP_TAMP_CR3_ITAMP2NOER                     \ Internal Tamper 2 no erase
$00000004 constant SEC_TAMP_TAMP_CR3_ITAMP3NOER                     \ Internal Tamper 3 no erase
$00000008 constant SEC_TAMP_TAMP_CR3_ITAMP4NOER                     \ Internal Tamper 4 no erase
...
$00004000 constant SEC_TAMP_TAMP_CR3_ITAMP15NOER                    \ Internal Tamper 15 no erase
...
$00000040 constant SEC_TAMP_TAMP_ATCR1_TAMP7AM                      \ Tamper 7 active mode
$00000080 constant SEC_TAMP_TAMP_ATCR1_TAMP8AM                      \ Tamper 8 active mode
...
$07000000 constant SEC_TAMP_TAMP_ATCR1_ATPER                        \ Active tamper output change period The tamper output is changed every CK_ATPER = (2ATPER x CK_ATPRE) cycles. Refer to .
$40000000 constant SEC_TAMP_TAMP_ATCR1_ATOSHARE                     \ Active tamper output sharing TAMP_IN1 is compared with TAMPOUTSEL1 TAMP_IN2 is compared with TAMPOUTSEL2 TAMP_IN3 is compared with TAMPOUTSEL3 TAMP_IN4 is compared with TAMPOUTSEL4 TAMP_IN5 is compared with TAMPOUTSEL5 TAMP_IN6 is compared with TAMPOUTSEL6 TAMP_IN7 is compared with TAMPOUTSEL7 TAMP_IN8 is compared with TAMPOUTSEL8
...
$1c000000 constant SEC_TAMP_TAMP_ATCR2_ATOSEL7                      \ Active tamper shared output 7 selection The selected output must be available in the package pinout.
$e0000000 constant SEC_TAMP_TAMP_ATCR2_ATOSEL8                      \ Active tamper shared output 8 selection The selected output must be available in the package pinout.
...
$000000ff constant SEC_TAMP_TAMP_SECCFGR_BKPRWSEC                   \ Backup registers read/write protection offset Protection zone 1 is defined for backup registers from TAMP_BKP0R to TAMP_BKPxR (x = BKPRWSEC-1, from 0 to 128). if TZEN=1, these backup registers can be read and written only with secure access. If TZEN=0: the protection zone 1 can be read and written with non-secure access. If BKPRWSEC = 0: there is no protection zone 1. If BKPRWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode.
$00008000 constant SEC_TAMP_TAMP_SECCFGR_CNT1SEC                    \ Monotonic counter 1 secure protection
$00ff0000 constant SEC_TAMP_TAMP_SECCFGR_BKPWSEC                    \ Backup registers write protection offset Protection zone 2 is defined for backup registers from TAMP_BKPyR (y = BKPRWSEC, from 0 to 128) to TAMP_BKPzR (z = BKPWSEC-1, from 0 to 128, BKPWSEC greater than or equal BKPRWSEC): if TZEN=1, these backup registers can be written only with secure access. They can be read with secure or non-secure access. Protection zone 3 defined for backup registers from TAMP_BKPtR (t = BKPWSEC, from 0 to 127). They can be read or written with secure or non-secure access. If TZEN=0: the protection zone 2 can be read and written with non-secure access. If BKPWSEC = 0 or if BKPWSEC less than or equal BKPRWSEC: there is no protection zone 2. If BKPWPRIV is set, BKPRWSEC[7:0] can be written only in privileged mode.
...
$80000000 constant SEC_TAMP_TAMP_SECCFGR_TAMPSEC                    \ Tamper protection (excluding monotonic counters and backup registers) Note: Refer to for details on the read protection.
...
$80000000 constant SEC_TAMP_TAMP_PRIVCFGR_TAMPPRIV                  \ Tamper privilege protection (excluding backup registers) Note: Refer to for details on the read protection.
...
$00000040 constant SEC_TAMP_TAMP_IER_TAMP7IE                        \ Tamper 7interrupt enable
$00000080 constant SEC_TAMP_TAMP_IER_TAMP8IE                        \ Tamper 8 interrupt enable
$00010000 constant SEC_TAMP_TAMP_IER_ITAMP1IE                       \ Internal tamper 1 interrupt enable
$00020000 constant SEC_TAMP_TAMP_IER_ITAMP2IE                       \ Internal tamper 2 interrupt enable
$00040000 constant SEC_TAMP_TAMP_IER_ITAMP3IE                       \ Internal tamper 3 interrupt enable
$00080000 constant SEC_TAMP_TAMP_IER_ITAMP4IE                       \ Internal tamper 4 interrupt enable
...
$40000000 constant SEC_TAMP_TAMP_IER_ITAMP15IE                      \ Internal tamper 15 interrupt enable
...
$00000040 constant SEC_TAMP_TAMP_SR_TAMP7F                          \ TAMP7 detection flag This flag is set by hardware when a tamper detection event is detected on the TAMP7 input.
$00000080 constant SEC_TAMP_TAMP_SR_TAMP8F                          \ TAMP8 detection flag This flag is set by hardware when a tamper detection event is detected on the TAMP8 input
$00010000 constant SEC_TAMP_TAMP_SR_ITAMP1F                         \ Internal tamper 1 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 1.
$00020000 constant SEC_TAMP_TAMP_SR_ITAMP2F                         \ Internal tamper 2 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 2.
...
$00080000 constant SEC_TAMP_TAMP_SR_ITAMP4F                         \ Internal tamper 4 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 4.
...
$40000000 constant SEC_TAMP_TAMP_SR_ITAMP15F                        \ Internal tamper 15 flag This flag is set by hardware when a tamper detection event is detected on the internal tamper 15.
...
$00000040 constant SEC_TAMP_TAMP_MISR_TAMP7MF                       \ TAMP7 non-secure interrupt masked flag This flag is set by hardware when the tamper 7 non-secure interrupt is raised.
$00000080 constant SEC_TAMP_TAMP_MISR_TAMP8MF                       \ TAMP8 non-secure interrupt masked flag This flag is set by hardware when the tamper 8 non-secure interrupt is raised.
$00010000 constant SEC_TAMP_TAMP_MISR_ITAMP1MF                      \ Internal tamper 1 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 1 non-secure interrupt is raised.
$00020000 constant SEC_TAMP_TAMP_MISR_ITAMP2MF                      \ Internal tamper 2 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 2 non-secure interrupt is raised.
...
$00080000 constant SEC_TAMP_TAMP_MISR_ITAMP4MF                      \ Internal tamper 4 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 4 non-secure interrupt is raised.
...
$40000000 constant SEC_TAMP_TAMP_MISR_ITAMP15MF                     \ internal tamper 15 non-secure interrupt masked flag This flag is set by hardware when the internal tamper 15 non-secure interrupt is raised.
...
$00000040 constant SEC_TAMP_TAMP_SMISR_TAMP7MF                      \ TAMP7 secure interrupt masked flag This flag is set by hardware when the tamper 7 secure interrupt is raised.
$00000080 constant SEC_TAMP_TAMP_SMISR_TAMP8MF                      \ TAMP8 secure interrupt masked flag This flag is set by hardware when the tamper 8 secure interrupt is raised.
$00010000 constant SEC_TAMP_TAMP_SMISR_ITAMP1MF                     \ Internal tamper 1 secure interrupt masked flag This flag is set by hardware when the internal tamper 1 secure interrupt is raised.
$00020000 constant SEC_TAMP_TAMP_SMISR_ITAMP2MF                     \ Internal tamper 2 secure interrupt masked flag This flag is set by hardware when the internal tamper 2 secure interrupt is raised.
...
$00080000 constant SEC_TAMP_TAMP_SMISR_ITAMP4MF                     \ Internal tamper 4 secure interrupt masked flag This flag is set by hardware when the internal tamper 4 secure interrupt is raised.
...
$40000000 constant SEC_TAMP_TAMP_SMISR_ITAMP15MF                    \ internal tamper 15 secure interrupt masked flag This flag is set by hardware when the internal tamper 15 secure interrupt is raised.
...
$00000040 constant SEC_TAMP_TAMP_SCR_CTAMP7F                        \ Clear TAMP7 detection flag Writing 1 in this bit clears the TAMP7F bit in the TAMP_SR register.
$00000080 constant SEC_TAMP_TAMP_SCR_CTAMP8F                        \ Clear TAMP8 detection flag Writing 1 in this bit clears the TAMP8F bit in the TAMP_SR register.
$00010000 constant SEC_TAMP_TAMP_SCR_CITAMP1F                       \ Clear ITAMP1 detection flag Writing 1 in this bit clears the ITAMP1F bit in the TAMP_SR register.
$00020000 constant SEC_TAMP_TAMP_SCR_CITAMP2F                       \ Clear ITAMP2 detection flag Writing 1 in this bit clears the ITAMP2F bit in the TAMP_SR register.
...
$00080000 constant SEC_TAMP_TAMP_SCR_CITAMP4F                       \ Clear ITAMP4 detection flag Writing 1 in this bit clears the ITAMP4F bit in the TAMP_SR register.
...
$40000000 constant SEC_TAMP_TAMP_SCR_CITAMP15F                      \ Clear ITAMP15 detection flag Writing 1 in this bit clears the ITAMP15F bit in the TAMP_SR register.
...
$00000006 constant SEC_TAMP_TAMP_OR_OUT3_RMP                        \ TAMP_OUT3 mapping
$00000008 constant SEC_TAMP_TAMP_OR_OUT5_RMP                        \ TAMP_OUT5 mapping
$00000100 constant SEC_TAMP_TAMP_OR_IN2_RMP                         \ TAMP_IN2 mapping
$00000200 constant SEC_TAMP_TAMP_OR_IN3_RMP                         \ TAMP_IN3 mapping
$00000400 constant SEC_TAMP_TAMP_OR_IN4_RMP                         \ TAMP_IN4 mapping
...
$00000001 constant SEC_TAMP_TAMP_ERCFGR_ERCFG0                      \ Configurable device secrets configuration
...
\ @brief Tamper and backup
\
$54007c00 constant SEC_TAMP_TAMP_CR1  \ offset: 0x00 : TAMP control register 1
$54007c04 constant SEC_TAMP_TAMP_CR2  \ offset: 0x04 : TAMP control register 2
$54007c08 constant SEC_TAMP_TAMP_CR3  \ offset: 0x08 : TAMP control register 3
$54007c0c constant SEC_TAMP_TAMP_FLTCR  \ offset: 0x0C : TAMP filter control register
$54007c10 constant SEC_TAMP_TAMP_ATCR1  \ offset: 0x10 : TAMP active tamper control register 1
$54007c14 constant SEC_TAMP_TAMP_ATSEEDR  \ offset: 0x14 : TAMP active tamper seed register
$54007c18 constant SEC_TAMP_TAMP_ATOR  \ offset: 0x18 : TAMP active tamper output register
$54007c1c constant SEC_TAMP_TAMP_ATCR2  \ offset: 0x1C : TAMP active tamper control register 2
$54007c20 constant SEC_TAMP_TAMP_SECCFGR  \ offset: 0x20 : TAMP secure mode register
$54007c24 constant SEC_TAMP_TAMP_PRIVCFGR  \ offset: 0x24 : TAMP privilege mode control register
$54007c2c constant SEC_TAMP_TAMP_IER  \ offset: 0x2C : TAMP interrupt enable register
$54007c30 constant SEC_TAMP_TAMP_SR  \ offset: 0x30 : TAMP status register
$54007c34 constant SEC_TAMP_TAMP_MISR  \ offset: 0x34 : TAMP non-secure masked interrupt status register
$54007c38 constant SEC_TAMP_TAMP_SMISR  \ offset: 0x38 : TAMP secure masked interrupt status register
$54007c3c constant SEC_TAMP_TAMP_SCR  \ offset: 0x3C : TAMP status clear register
$54007c40 constant SEC_TAMP_TAMP_COUNT1R  \ offset: 0x40 : TAMP monotonic counter 1 register
$54007c50 constant SEC_TAMP_TAMP_OR  \ offset: 0x50 : TAMP option register
$54007c54 constant SEC_TAMP_TAMP_ERCFGR  \ offset: 0x54 : TAMP erase configuration register
$54007d00 constant SEC_TAMP_TAMP_BKP0R  \ offset: 0x100 : TAMP backup 0 register
$54007d04 constant SEC_TAMP_TAMP_BKP1R  \ offset: 0x104 : TAMP backup 1 register
$54007d08 constant SEC_TAMP_TAMP_BKP2R  \ offset: 0x108 : TAMP backup 2 register
$54007d0c constant SEC_TAMP_TAMP_BKP3R  \ offset: 0x10C : TAMP backup 3 register
$54007d10 constant SEC_TAMP_TAMP_BKP4R  \ offset: 0x110 : TAMP backup 4 register
$54007d14 constant SEC_TAMP_TAMP_BKP5R  \ offset: 0x114 : TAMP backup 5 register
$54007d18 constant SEC_TAMP_TAMP_BKP6R  \ offset: 0x118 : TAMP backup 6 register
$54007d1c constant SEC_TAMP_TAMP_BKP7R  \ offset: 0x11C : TAMP backup 7 register
$54007d20 constant SEC_TAMP_TAMP_BKP8R  \ offset: 0x120 : TAMP backup 8 register
$54007d24 constant SEC_TAMP_TAMP_BKP9R  \ offset: 0x124 : TAMP backup 9 register
$54007d28 constant SEC_TAMP_TAMP_BKP10R  \ offset: 0x128 : TAMP backup 10 register
$54007d2c constant SEC_TAMP_TAMP_BKP11R  \ offset: 0x12C : TAMP backup 11 register
$54007d30 constant SEC_TAMP_TAMP_BKP12R  \ offset: 0x130 : TAMP backup 12 register
$54007d34 constant SEC_TAMP_TAMP_BKP13R  \ offset: 0x134 : TAMP backup 13 register
$54007d38 constant SEC_TAMP_TAMP_BKP14R  \ offset: 0x138 : TAMP backup 14 register
$54007d3c constant SEC_TAMP_TAMP_BKP15R  \ offset: 0x13C : TAMP backup 15 register
$54007d40 constant SEC_TAMP_TAMP_BKP16R  \ offset: 0x140 : TAMP backup 16 register
$54007d44 constant SEC_TAMP_TAMP_BKP17R  \ offset: 0x144 : TAMP backup 17 register
$54007d48 constant SEC_TAMP_TAMP_BKP18R  \ offset: 0x148 : TAMP backup 18 register
$54007d4c constant SEC_TAMP_TAMP_BKP19R  \ offset: 0x14C : TAMP backup 19 register
$54007d50 constant SEC_TAMP_TAMP_BKP20R  \ offset: 0x150 : TAMP backup 20 register
$54007d54 constant SEC_TAMP_TAMP_BKP21R  \ offset: 0x154 : TAMP backup 21 register
$54007d58 constant SEC_TAMP_TAMP_BKP22R  \ offset: 0x158 : TAMP backup 22 register
$54007d5c constant SEC_TAMP_TAMP_BKP23R  \ offset: 0x15C : TAMP backup 23 register
$54007d60 constant SEC_TAMP_TAMP_BKP24R  \ offset: 0x160 : TAMP backup 24 register
$54007d64 constant SEC_TAMP_TAMP_BKP25R  \ offset: 0x164 : TAMP backup 25 register
$54007d68 constant SEC_TAMP_TAMP_BKP26R  \ offset: 0x168 : TAMP backup 26 register
$54007d6c constant SEC_TAMP_TAMP_BKP27R  \ offset: 0x16C : TAMP backup 27 register
$54007d70 constant SEC_TAMP_TAMP_BKP28R  \ offset: 0x170 : TAMP backup 28 register
$54007d74 constant SEC_TAMP_TAMP_BKP29R  \ offset: 0x174 : TAMP backup 29 register
$54007d78 constant SEC_TAMP_TAMP_BKP30R  \ offset: 0x178 : TAMP backup 30 register
$54007d7c constant SEC_TAMP_TAMP_BKP31R  \ offset: 0x17C : TAMP backup 31 register
