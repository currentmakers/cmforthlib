...
[ifndef] RAMCFG_DEF
  ...
  [ifdef] RAMCFG_RAMCFG_M1ISR_DEF
    ...
    $08 constant RAMCFG_SRAMBUSY                \ [0x08] SRAM busy with erase operation Note: Depending on the SRAM, the erase operation can be performed due to software request, system reset if the option bit is enabled, tamper detection or readout protection regression. Refer to Table 18: Internal SRAMs features.
  [then]
  ...
  [ifdef] RAMCFG_RAMCFG_M2WPR1_DEF
    ...
    $10 constant RAMCFG_P16WP                   \ [0x10] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $11 constant RAMCFG_P17WP                   \ [0x11] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $12 constant RAMCFG_P18WP                   \ [0x12] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $13 constant RAMCFG_P19WP                   \ [0x13] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $14 constant RAMCFG_P20WP                   \ [0x14] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $15 constant RAMCFG_P21WP                   \ [0x15] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $16 constant RAMCFG_P22WP                   \ [0x16] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $17 constant RAMCFG_P23WP                   \ [0x17] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $18 constant RAMCFG_P24WP                   \ [0x18] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $19 constant RAMCFG_P25WP                   \ [0x19] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1a constant RAMCFG_P26WP                   \ [0x1a] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1b constant RAMCFG_P27WP                   \ [0x1b] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1c constant RAMCFG_P28WP                   \ [0x1c] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1d constant RAMCFG_P29WP                   \ [0x1d] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1e constant RAMCFG_P30WP                   \ [0x1e] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1f constant RAMCFG_P31WP                   \ [0x1f] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
  [then]
  ...
  [ifdef] RAMCFG_RAMCFG_M2WPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RAMCFG_P32WP                   \ [0x00] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $01 constant RAMCFG_P33WP                   \ [0x01] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $02 constant RAMCFG_P34WP                   \ [0x02] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $03 constant RAMCFG_P35WP                   \ [0x03] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $04 constant RAMCFG_P36WP                   \ [0x04] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $05 constant RAMCFG_P37WP                   \ [0x05] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $06 constant RAMCFG_P38WP                   \ [0x06] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $07 constant RAMCFG_P39WP                   \ [0x07] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $08 constant RAMCFG_P40WP                   \ [0x08] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $09 constant RAMCFG_P41WP                   \ [0x09] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $0a constant RAMCFG_P42WP                   \ [0x0a] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $0b constant RAMCFG_P43WP                   \ [0x0b] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $0c constant RAMCFG_P44WP                   \ [0x0c] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $0d constant RAMCFG_P45WP                   \ [0x0d] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $0e constant RAMCFG_P46WP                   \ [0x0e] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $0f constant RAMCFG_P47WP                   \ [0x0f] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $10 constant RAMCFG_P48WP                   \ [0x10] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $11 constant RAMCFG_P49WP                   \ [0x11] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $12 constant RAMCFG_P50WP                   \ [0x12] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $13 constant RAMCFG_P51WP                   \ [0x13] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $14 constant RAMCFG_P52WP                   \ [0x14] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $15 constant RAMCFG_P53WP                   \ [0x15] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $16 constant RAMCFG_P54WP                   \ [0x16] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $17 constant RAMCFG_P55WP                   \ [0x17] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $18 constant RAMCFG_P56WP                   \ [0x18] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $19 constant RAMCFG_P57WP                   \ [0x19] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1a constant RAMCFG_P58WP                   \ [0x1a] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1b constant RAMCFG_P59WP                   \ [0x1b] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1c constant RAMCFG_P60WP                   \ [0x1c] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1d constant RAMCFG_P61WP                   \ [0x1d] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1e constant RAMCFG_P62WP                   \ [0x1e] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
    $1f constant RAMCFG_P63WP                   \ [0x1f] SRAM2 1-Kbyte page y write protection These bits are set by software and cleared only by a global RAMCFG reset.
  [then]
