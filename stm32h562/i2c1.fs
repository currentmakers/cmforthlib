...
[ifndef] I2C1_DEF
  ...
  [ifdef] I2C1_I2C_CR1_DEF
    ...
    $18 constant I2C1_FMP                       \ [0x18] Fast-mode Plus 20 mA drive enable
    $1e constant I2C1_ADDRACLR                  \ [0x1e] Address match flag (ADDR) automatic clear
    $1f constant I2C1_STOPFACLR                 \ [0x1f] STOP detection flag (STOPF) automatic clear
  [then]
  ...
  [ifdef] I2C1_I2C_TIMINGR_DEF
    ...
    $1c constant I2C1_PRESC                     \ [0x1c : 4] Timing prescaler This field is used to prescale i2c_ker_ck in order to generate the clock period tPRESC used for data setup and hold counters (refer to ) and for SCL high and low level counters (refer to ). tPRESC = (PRESC+1) x tI2CCLK
  [then]
