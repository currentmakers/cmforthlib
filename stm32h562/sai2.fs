...
$00000003 constant SAI2_SAI_ACR1_MODE                               \ SAIx audio block mode These bits are set and cleared by software. They must be configured when SAIx audio block is disabled. Note: When the audio block is configured in SPDIF mode, the master transmitter mode is forced (MODE[1:0] = 00).
...
$00000c00 constant SAI2_SAI_ACR1_SYNCEN                             \ Synchronization enable These bits are set and cleared by software. They must be configured when the audio subblock is disabled. Note: The audio subblock should be configured as asynchronous when SPDIF mode is enabled.
...
$00080000 constant SAI2_SAI_ACR1_NODIV                              \ No divider This bit is set and cleared by software.
$03f00000 constant SAI2_SAI_ACR1_MCKDIV                             \ Master clock divider These bits are set and cleared by software. Otherwise, The master clock frequency is calculated according to the formula given in . These bits have no meaning when the audio block is slave. They have to be configured when the audio block is disabled.
$04000000 constant SAI2_SAI_ACR1_OSR                                \ Oversampling ratio for master clock This bit is meaningful only when NODIV bit is set to 0.
$08000000 constant SAI2_SAI_ACR1_MCKEN                              \ Master clock generation enable
...
$00001f80 constant SAI2_SAI_ACR2_MUTECNT                            \ Mute counter. These bits are set and cleared by software. They are used only in reception mode. The value set in these bits is compared to the number of consecutive mute frames detected in reception. When the number of mute frames is equal to this value, the flag MUTEDET is set and an interrupt is generated if bit MUTEDETIE is set. Refer to for more details.
...
$000000ff constant SAI2_SAI_AFRCR_FRL                               \ Frame length. These bits are set and cleared by software. They define the audio frame length expressed in number of SCK clock cycles: the number of bits in the frame is equal to FRL[7:0] + 1. The minimum number of bits to transfer in an audio frame must be equal to 8, otherwise the audio block behaves in an unexpected way. This is the case when the data size is 8 bits and only one slot 0 is defined in NBSLOT[4:0] of SAI_xSLOTR register (NBSLOT[3:0] = 0000). In master mode, if the master clock (available on MCLK_x pin) is used, the frame length should be aligned with a number equal to a power of 2, ranging from 8 to 256. When the master clock is not used (NODIV = 1), it is recommended to program the frame length to an value ranging from 8 to 256. These bits are meaningless and are not used in AC'97 or SPDIF audio block configuration. They must be configured when the audio block is disabled.
...
$00040000 constant SAI2_SAI_AFRCR_FSOFF                             \ Frame synchronization offset. This bit is set and cleared by software. It is meaningless and is not used in AC'97 or SPDIF audio block configuration. This bit must be configured when the audio block is disabled.
...
$ffff0000 constant SAI2_SAI_ASLOTR_SLOTEN                           \ Slot enable. These bits are set and cleared by software. Each SLOTEN bit corresponds to a slot position from 0 to 15 (maximum 16 slots). The slot must be enabled when the audio block is disabled. They are ignored in AC'97 or SPDIF mode.
...
$00000010 constant SAI2_SAI_ASR_CNRDY                               \ Codec not ready. This bit is read only. This bit is used only when the AC'97 audio protocol is selected in the SAI_xCR1 register and configured in receiver mode. It can generate an interrupt if CNRDYIE bit is set in SAI_xIM register. This flag is cleared when the software sets CCNRDY bit in SAI_xCLRFR register.
...
$00070000 constant SAI2_SAI_ASR_FLVL                                \ FIFO level threshold. This bit is read only. The FIFO level threshold flag is managed only by hardware and its setting depends on SAI block configuration (transmitter or receiver mode). Others: Reserved
...
$00000010 constant SAI2_SAI_ACLRFR_CCNRDY                           \ Clear Codec not ready flag. This bit is write only. Programming this bit to 1 clears the CNRDY flag in the SAI_xSR register. This bit is used only when the AC'97 audio protocol is selected in the SAI_xCR1 register. Reading this bit always returns the value 0.
$00000020 constant SAI2_SAI_ACLRFR_CAFSDET                          \ Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC'97 or SPDIF mode. Reading this bit always returns the value 0.
$00000040 constant SAI2_SAI_ACLRFR_CLFSDET                          \ Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC'97 or SPDIF mode Reading this bit always returns the value 0.
...
$00000c00 constant SAI2_SAI_BCR1_SYNCEN                             \ Synchronization enable These bits are set and cleared by software. They must be configured when the audio subblock is disabled. Note: The audio subblock should be configured as asynchronous when SPDIF mode is enabled.
...
$00010000 constant SAI2_SAI_BCR1_SAIEN                              \ Audio block enable This bit is set by software. To switch off the audio block, the application software must program this bit to 0 and poll the bit till it reads back 0, meaning that the block is completely disabled. Before setting this bit to 1, check that it is set to 0, otherwise the enable command is not taken into account. This bit allows controlling the state of the SAI audio block. If it is disabled when an audio frame transfer is ongoing, the ongoing transfer completes and the cell is fully disabled at the end of this audio frame transfer. Note: When the SAI block (A or B) is configured in master mode, the clock must be present on the SAI block input before setting SAIEN bit.
...
$00080000 constant SAI2_SAI_BCR1_NODIV                              \ No divider This bit is set and cleared by software.
$03f00000 constant SAI2_SAI_BCR1_MCKDIV                             \ Master clock divider These bits are set and cleared by software. Otherwise, The master clock frequency is calculated according to the formula given in . These bits have no meaning when the audio block is slave. They have to be configured when the audio block is disabled.
$04000000 constant SAI2_SAI_BCR1_OSR                                \ Oversampling ratio for master clock This bit is meaningful only when NODIV bit is set to 0.
$08000000 constant SAI2_SAI_BCR1_MCKEN                              \ Master clock generation enable
...
$00000020 constant SAI2_SAI_BCR2_MUTE                               \ Mute. This bit is set and cleared by software. It is meaningful only when the audio block operates as a transmitter. The MUTE value is linked to value of MUTEVAL if the number of slots is lower or equal to 2, or equal to 0 if it is greater than 2. Refer to for more details. Note: This bit is meaningless and should not be used for SPDIF audio blocks.
$00000040 constant SAI2_SAI_BCR2_MUTEVAL                            \ Mute value. This bit is set and cleared by software.It must be written before enabling the audio block: SAIEN. This bit is meaningful only when the audio block operates as a transmitter, the number of slots is lower or equal to 2 and the MUTE bit is set. If more slots are declared, the bit value sent during the transmission in mute mode is equal to 0, whatever the value of MUTEVAL. if the number of slot is lower or equal to 2 and MUTEVAL = 1, the MUTE value transmitted for each slot is the one sent during the previous frame. Refer to for more details. Note: This bit is meaningless and should not be used for SPDIF audio blocks.
$00001f80 constant SAI2_SAI_BCR2_MUTECNT                            \ Mute counter. These bits are set and cleared by software. They are used only in reception mode. The value set in these bits is compared to the number of consecutive mute frames detected in reception. When the number of mute frames is equal to this value, the flag MUTEDET is set and an interrupt is generated if bit MUTEDETIE is set. Refer to for more details.
...
$00040000 constant SAI2_SAI_BFRCR_FSOFF                             \ Frame synchronization offset. This bit is set and cleared by software. It is meaningless and is not used in AC'97 or SPDIF audio block configuration. This bit must be configured when the audio block is disabled.
...
$ffff0000 constant SAI2_SAI_BSLOTR_SLOTEN                           \ Slot enable. These bits are set and cleared by software. Each SLOTEN bit corresponds to a slot position from 0 to 15 (maximum 16 slots). The slot must be enabled when the audio block is disabled. They are ignored in AC'97 or SPDIF mode.
...
$00000010 constant SAI2_SAI_BSR_CNRDY                               \ Codec not ready. This bit is read only. This bit is used only when the AC'97 audio protocol is selected in the SAI_xCR1 register and configured in receiver mode. It can generate an interrupt if CNRDYIE bit is set in SAI_xIM register. This flag is cleared when the software sets CCNRDY bit in SAI_xCLRFR register.
...
$00070000 constant SAI2_SAI_BSR_FLVL                                \ FIFO level threshold. This bit is read only. The FIFO level threshold flag is managed only by hardware and its setting depends on SAI block configuration (transmitter or receiver mode). Others: Reserved
...
$00000010 constant SAI2_SAI_BCLRFR_CCNRDY                           \ Clear Codec not ready flag. This bit is write only. Programming this bit to 1 clears the CNRDY flag in the SAI_xSR register. This bit is used only when the AC'97 audio protocol is selected in the SAI_xCR1 register. Reading this bit always returns the value 0.
$00000020 constant SAI2_SAI_BCLRFR_CAFSDET                          \ Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC'97or SPDIF mode. Reading this bit always returns the value 0.
$00000040 constant SAI2_SAI_BCLRFR_CLFSDET                          \ Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC'97or SPDIF mode Reading this bit always returns the value 0.
...
$00000001 constant SAI2_SAI_PDMCR_PDMEN                             \ PDM enable This bit is set and cleared by software. This bit allows to control the state of the PDM interface block. Make sure that the SAI in already operating in TDM master mode before enabling the PDM interface.
$00000030 constant SAI2_SAI_PDMCR_MICNBR                            \ Number of microphones This bit is set and cleared by software. Note: It is not recommended to configure this field when PDMEN = 1.* The complete set of data lines might not be available for all SAI instances. Refer to for details.
$00000100 constant SAI2_SAI_PDMCR_CKEN1                             \ Clock enable of bitstream clock number 1 This bit is set and cleared by software. Note: It is not recommended to configure this bit when PDMEN = 1. SAI_CK1 might not be available for all SAI instances. Refer to implementation for details.
$00000200 constant SAI2_SAI_PDMCR_CKEN2                             \ Clock enable of bitstream clock number 2 This bit is set and cleared by software. Note: It is not recommended to configure this bit when PDMEN = 1. SAI_CK2 might not be available for all SAI instances. Refer to implementation for details.
...
$00000007 constant SAI2_SAI_PDMDLY_DLYM1L                           \ Delay line adjust for first microphone of pair 1 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D1 line is available.Refer to to check if it is available.
$00000070 constant SAI2_SAI_PDMDLY_DLYM1R                           \ Delay line adjust for second microphone of pair 1 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D1 line is available.Refer to to check if it is available.
$00000700 constant SAI2_SAI_PDMDLY_DLYM2L                           \ Delay line for first microphone of pair 2 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D2 line is available.Refer to to check if it is available.
$00007000 constant SAI2_SAI_PDMDLY_DLYM2R                           \ Delay line for second microphone of pair 2 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D2 line is available.Refer to to check if it is available.
$00070000 constant SAI2_SAI_PDMDLY_DLYM3L                           \ Delay line for first microphone of pair 3 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D3 line is available.Refer to to check if it is available.
$00700000 constant SAI2_SAI_PDMDLY_DLYM3R                           \ Delay line for second microphone of pair 3 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D3 line is available.Refer to to check if it is available.
$07000000 constant SAI2_SAI_PDMDLY_DLYM4L                           \ Delay line for first microphone of pair 4 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D4 line is available.Refer to to check if it is available.
$70000000 constant SAI2_SAI_PDMDLY_DLYM4R                           \ Delay line for second microphone of pair 4 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D4 line is available.Refer to to check if it is available.


\
\ @brief SAI2 global interrupt
\
$40015800 constant SAI2_SAI_GCR   \ offset: 0x00 : SAI global configuration register
$40015804 constant SAI2_SAI_ACR1  \ offset: 0x04 : SAI configuration register 1
$40015808 constant SAI2_SAI_ACR2  \ offset: 0x08 : SAI configuration register 2
$4001580c constant SAI2_SAI_AFRCR  \ offset: 0x0C : SAI frame configuration register
$40015810 constant SAI2_SAI_ASLOTR  \ offset: 0x10 : SAI slot register
$40015814 constant SAI2_SAI_AIM   \ offset: 0x14 : SAI interrupt mask register
$40015818 constant SAI2_SAI_ASR   \ offset: 0x18 : SAI status register
$4001581c constant SAI2_SAI_ACLRFR  \ offset: 0x1C : SAI clear flag register
$40015820 constant SAI2_SAI_ADR   \ offset: 0x20 : SAI data register
$40015824 constant SAI2_SAI_BCR1  \ offset: 0x24 : SAI configuration register 1
$40015828 constant SAI2_SAI_BCR2  \ offset: 0x28 : SAI configuration register 2
$4001582c constant SAI2_SAI_BFRCR  \ offset: 0x2C : SAI frame configuration register
$40015830 constant SAI2_SAI_BSLOTR  \ offset: 0x30 : SAI slot register
$40015834 constant SAI2_SAI_BIM   \ offset: 0x34 : SAI interrupt mask register
$40015838 constant SAI2_SAI_BSR   \ offset: 0x38 : SAI status register
$4001583c constant SAI2_SAI_BCLRFR  \ offset: 0x3C : SAI clear flag register
$40015840 constant SAI2_SAI_BDR   \ offset: 0x40 : SAI data register
$40015844 constant SAI2_SAI_PDMCR  \ offset: 0x44 : SAI PDM control register
$40015848 constant SAI2_SAI_PDMDLY  \ offset: 0x48 : SAI PDM delay register
