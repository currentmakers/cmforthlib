...
$000f0000 constant SEC_FDCAN1_FDCAN_TSCC_TCP                        \ Timestamp counter prescaler Configures the timestamp and timeout counters time unit in multiples of CAN bit times.
