...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_FLASH_OPTSR_CUR_DEF
    ...
    $10 constant FLASH_IO_VDD_HSLV              \ [0x10] High-speed IO at low V DD voltage configuration bit. This bit can be set only with V DD below 2.7V.
    $11 constant FLASH_IO_VDDIO2_HSLV           \ [0x11] High-speed IO at low V DDIO2 voltage configuration bit. This bit can be set only with V DDIO2 below 2.7V.
