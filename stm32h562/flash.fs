...
$00010000 constant FLASH_FLASH_OPTSR_CUR_IO_VDD_HSLV                \ High-speed IO at low V DD voltage configuration bit. This bit can be set only with V DD below 2.7V.
$00020000 constant FLASH_FLASH_OPTSR_CUR_IO_VDDIO2_HSLV             \ High-speed IO at low V DDIO2 voltage configuration bit. This bit can be set only with V DDIO2 below 2.7V.
