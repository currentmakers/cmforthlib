...
[ifndef] FMAC_DEF
  ...
  [ifdef] FMAC_FMAC_X1BUFCFG_DEF
    ...
    $08 constant FMAC_X1_BUF_SIZE               \ [0x08 : 8] Allocated size of X1 buffer in 16-bit words The minimum buffer size is the number of feed-forward taps in the filter (+ the watermark threshold 1).
