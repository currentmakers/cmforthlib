...
[ifndef] SYSCFG_ITLINE_DEF
  ...
  [ifdef] SYSCFG_ITLINE_ITLINE31_DEF
    \
    \ @brief interrupt line 31 status register
    \ Address offset: 0xFC
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_ITLINE_RNG              \ [0x00] RNG
    $01 constant SYSCFG_ITLINE_AES              \ [0x01] AES
  [then]
  ...
  $FC constant SYSCFG_ITLINE_ITLINE31   \ interrupt line 31 status register
