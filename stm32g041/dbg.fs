...
[ifndef] DBG_DEF
  ...
  [ifdef] DBG_APB_FZ1_DEF
    ...
    $1e constant DBG_DBG_LPTIM2_STOP            \ [0x1e] LPTIM2 counter stopped when core is halted
    $1f constant DBG_DBG_LPTIM1_STOP            \ [0x1f] LPTIM1 counter stopped when core is halted
  [then]
