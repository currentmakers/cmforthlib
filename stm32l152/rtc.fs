...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_CR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_WCKSEL                     \ [0x00 : 3] WCKSEL
    $03 constant RTC_TSEDGE                     \ [0x03] Time-stamp event active edge
    $04 constant RTC_REFCKON                    \ [0x04] Reference clock detection enable
    $05 constant RTC_BYPSHAD                    \ [0x05] Bypass the shadow registers
    $06 constant RTC_FMT                        \ [0x06] Hour format
    $07 constant RTC_DCE                        \ [0x07] Coarse digital calibration enable
    ...
    $10 constant RTC_ADD1H                      \ [0x10] Add 1 hour
    $11 constant RTC_SUB1H                      \ [0x11] Subtract 1 hour
  ...
  [ifdef] RTC_ISR_DEF
    ...
    $0b constant RTC_TSF                        \ [0x0b] Timestamp flag
    $0c constant RTC_TSOVF                      \ [0x0c] Timestamp overflow flag
    $0d constant RTC_TAMP1F                     \ [0x0d] Tamper detection flag
    $0e constant RTC_TAMP2F                     \ [0x0e] TAMPER2 detection flag
    $0f constant RTC_TAMP3F                     \ [0x0f] TAMPER3 detection flag
  ...
  [ifdef] RTC_CALIBR_DEF
    \
    \ @brief calibration register
    \ Address offset: 0x18
    \ Reset value: 0x00000000
    \
    $00 constant RTC_DC                         \ [0x00 : 5] Digital calibration
    $07 constant RTC_DCS                        \ [0x07] Digital calibration sign
  [then]
  ...
  [ifdef] RTC_TSSSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_SS                         \ [0x00 : 16] RTC timestamp subsecond field
  [then]
  ...
  [ifdef] RTC_TAFCR_DEF
    ...
    $01 constant RTC_TAMP1ETRG                  \ [0x01] Active level for tamper 1
    ...
    $05 constant RTC_TAMP3E                     \ [0x05] TIMESTAMP mapping
    $06 constant RTC_TAMP3TRG                   \ [0x06] TAMPER1 mapping
    ...
    $12 constant RTC_ALARMOUTTYPE               \ [0x12] AFO_ALARM output type
  [then]
  ...
  $18 constant RTC_CALIBR               \ calibration register
  ...
  $40 constant RTC_TAFCR                \ tamper and alternate function configuration register
