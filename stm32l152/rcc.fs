...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CIR_DEF
    ...
    $0e constant RCC_LSECSSIE                   \ [0x0e] LSE CSS interrupt enable
    ...
    $16 constant RCC_LSECSSC                    \ [0x16] LSE CSS interrupt clear
  ...
  [ifdef] RCC_CSR_DEF
    ...
    $0b constant RCC_LSECSSON                   \ [0x0b] CSS on LSE enable
    $0c constant RCC_LSECSSD                    \ [0x0c] CSS on LSE failure Detection
    ...
    $19 constant RCC_OBLRSTF                    \ [0x19] Options bytes loading reset flag
