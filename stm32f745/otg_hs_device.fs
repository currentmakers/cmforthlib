...
[ifndef] OTG_HS_DEVICE_DEF
  ...
  $1A0 constant OTG_HS_DEVICE_OTG_HS_DIEPTSIZ6    \ OTG_HS device endpoint transfer size register
  $1A4 constant OTG_HS_DEVICE_OTG_HS_DTXFSTS6    \ OTG_HS device IN endpoint transmit FIFO status register
  $1A8 constant OTG_HS_DEVICE_OTG_HS_DIEPINT5    \ OTG device endpoint-5 interrupt register
  $1A8 constant OTG_HS_DEVICE_OTG_HS_DIEPTSIZ7    \ OTG_HS device endpoint transfer size register
  $1AC constant OTG_HS_DEVICE_OTG_HS_DTXFSTS7    \ OTG_HS device IN endpoint transmit FIFO status register
