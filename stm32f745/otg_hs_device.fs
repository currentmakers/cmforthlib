...
$400409a0 constant OTG_HS_DEVICE_OTG_HS_DIEPTSIZ6  \ offset: 0x1A0 : OTG_HS device endpoint transfer size register
$400409a4 constant OTG_HS_DEVICE_OTG_HS_DTXFSTS6  \ offset: 0x1A4 : OTG_HS device IN endpoint transmit FIFO status register
$400409a8 constant OTG_HS_DEVICE_OTG_HS_DIEPINT5  \ offset: 0x1A8 : OTG device endpoint-5 interrupt register
$400409a8 constant OTG_HS_DEVICE_OTG_HS_DIEPTSIZ7  \ offset: 0x1A8 : OTG_HS device endpoint transfer size register
$400409ac constant OTG_HS_DEVICE_OTG_HS_DTXFSTS7  \ offset: 0x1AC : OTG_HS device IN endpoint transmit FIFO status register
