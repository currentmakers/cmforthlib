...
[ifndef] FMC_DEF
  ...
  $80 constant FMC_PCR                  \ PC Card/NAND Flash control register
  $84 constant FMC_SR                   \ FIFO status and interrupt register
  $88 constant FMC_PMEM                 \ Common memory space timing register
  $8C constant FMC_PATT                 \ Attribute memory space timing register
  $94 constant FMC_ECCR                 \ ECC result register
