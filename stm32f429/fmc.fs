...
$00000400 constant FMC_BCR1_WRAPMOD                                 \ WRAPMOD
...
$00000c00 constant FMC_SDCR2_CLK                                    \ SDRAM clock configuration
...
$a0000060 constant FMC_PCR2       \ offset: 0x60 : PC Card/NAND Flash control register 2
$a0000064 constant FMC_SR2        \ offset: 0x64 : FIFO status and interrupt register 2
$a0000068 constant FMC_PMEM2      \ offset: 0x68 : Common memory space timing register 2
$a000006c constant FMC_PATT2      \ offset: 0x6C : Attribute memory space timing register 2
$a0000074 constant FMC_ECCR2      \ offset: 0x74 : ECC result register 2
$a0000080 constant FMC_PCR3       \ offset: 0x80 : PC Card/NAND Flash control register 3
$a0000084 constant FMC_SR3        \ offset: 0x84 : FIFO status and interrupt register 3
$a0000088 constant FMC_PMEM3      \ offset: 0x88 : Common memory space timing register 3
$a000008c constant FMC_PATT3      \ offset: 0x8C : Attribute memory space timing register 3
$a0000094 constant FMC_ECCR3      \ offset: 0x94 : ECC result register 3
$a00000a0 constant FMC_PCR4       \ offset: 0xA0 : PC Card/NAND Flash control register 4
$a00000a4 constant FMC_SR4        \ offset: 0xA4 : FIFO status and interrupt register 4
$a00000a8 constant FMC_PMEM4      \ offset: 0xA8 : Common memory space timing register 4
$a00000ac constant FMC_PATT4      \ offset: 0xAC : Attribute memory space timing register 4
$a00000b0 constant FMC_PIO4       \ offset: 0xB0 : I/O space timing register 4
$a0000104 constant FMC_BWTR1      \ offset: 0x104 : SRAM/NOR-Flash write timing registers 1
$a0000104 constant FMC_BWTR3      \ offset: 0x104 : SRAM/NOR-Flash write timing registers 3
$a000010c constant FMC_BWTR2      \ offset: 0x10C : SRAM/NOR-Flash write timing registers 2
$a000010c constant FMC_BWTR4      \ offset: 0x10C : SRAM/NOR-Flash write timing registers 4
