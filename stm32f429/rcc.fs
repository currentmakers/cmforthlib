...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_FMCRST                     \ [0x00] Flexible static memory controller module reset
  [then]
  ...
  [ifdef] RCC_AHB3ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_FMCEN                      \ [0x00] Flexible static memory controller module clock enable
  [then]
  ...
  [ifdef] RCC_AHB3LPENR_DEF
    ...
    \
    $00 constant RCC_FMCLPEN                    \ [0x00] Flexible static memory controller module clock enable during Sleep mode
  [then]
  ...
  [ifdef] RCC_PLLI2SCFGR_DEF
    ...
    \
    $06 constant RCC_PLLI2SNx                   \ [0x06 : 9] PLLI2S multiplication factor for VCO
    $1c constant RCC_PLLI2SRx                   \ [0x1c : 3] PLLI2S division factor for I2S clocks
  [then]
  ...
  [ifdef] RCC_DCKCFGR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_PLLI2SDIVQ                 \ [0x00 : 5] PLLI2S division factor for SAI1 clock
    ...
    $14 constant RCC_SAI1ASRC                   \ [0x14 : 2] SAI1-A clock source selection
  ...
  $88 constant RCC_PLLSAICFGR           \ RCC PLL configuration register
  $8C constant RCC_DCKCFGR              \ RCC Dedicated Clock Configuration Register
