...
[ifndef] ADC12_COMMON_DEF
  ...
  [ifdef] ADC12_COMMON_CDR2_DEF
    \
    \ @brief ADC x common regular data register for 32-bit dual mode
    \ Address offset: 0x10
    \ Reset value: 0x00000000
    \
    $00 constant ADC12_COMMON_RDATA_ALT         \ [0x00 : 32] Regular data of the master/slave alternated ADCs
  [then]
  ...
  $10 constant ADC12_COMMON_CDR2        \ ADC x common regular data register for 32-bit dual mode
