...
[ifndef] DFSDM_DEF
  ...
  [ifdef] DFSDM_CH0DLYR_DEF
    \
    \ @brief channel y delay register
    \ Address offset: 0x14
    \ Reset value: 0x00000000
    \
    $00 constant DFSDM_PLSSKP                   \ [0x00 : 6] PLSSKP
  [then]
  ...
  [ifdef] DFSDM_DFSDM_FLT1CHGR_DEF
    \
    \ @brief injected channel group selection register
  ...
  $14 constant DFSDM_CH0DLYR            \ channel y delay register
  $20 constant DFSDM_CH1CFGR1           \ CH1CFGR1
  $24 constant DFSDM_CH1CFGR2           \ CH1CFGR2
  $28 constant DFSDM_CH1AWSCDR          \ CH1AWSCDR
  $2C constant DFSDM_CH1WDATR           \ CH1WDATR
  $30 constant DFSDM_CH1DATINR          \ CH1DATINR
  $34 constant DFSDM_CH1DLYR            \ channel y delay register
  $40 constant DFSDM_CH2CFGR1           \ CH2CFGR1
  $44 constant DFSDM_CH2CFGR2           \ CH2CFGR2
  $48 constant DFSDM_CH2AWSCDR          \ CH2AWSCDR
  $4C constant DFSDM_CH2WDATR           \ CH2WDATR
  $50 constant DFSDM_CH2DATINR          \ CH2DATINR
  $54 constant DFSDM_CH2DLYR            \ channel y delay register
  $60 constant DFSDM_CH3CFGR1           \ CH3CFGR1
  $64 constant DFSDM_CH3CFGR2           \ CH3CFGR2
  $68 constant DFSDM_CH3AWSCDR          \ CH3AWSCDR
  $6C constant DFSDM_CH3WDATR           \ CH3WDATR
  $70 constant DFSDM_CH3DATINR          \ CH3DATINR
  $74 constant DFSDM_CH3DLYR            \ channel y delay register
  $80 constant DFSDM_CH4CFGR1           \ CH4CFGR1
  $84 constant DFSDM_CH4CFGR2           \ CH4CFGR2
  $88 constant DFSDM_CH4AWSCDR          \ CH4AWSCDR
  $8C constant DFSDM_CH4WDATR           \ CH4WDATR
  $90 constant DFSDM_CH4DATINR          \ CH4DATINR
  $94 constant DFSDM_CH4DLYR            \ channel y delay register
  $A0 constant DFSDM_CH5CFGR1           \ CH5CFGR1
  $A4 constant DFSDM_CH5CFGR2           \ CH5CFGR2
  $A8 constant DFSDM_CH5AWSCDR          \ CH5AWSCDR
  $AC constant DFSDM_CH5WDATR           \ CH5WDATR
  $B0 constant DFSDM_CH5DATINR          \ CH5DATINR
  $B4 constant DFSDM_CH5DLYR            \ channel y delay register
  $C0 constant DFSDM_CH6CFGR1           \ CH6CFGR1
  $C4 constant DFSDM_CH6CFGR2           \ CH6CFGR2
  $C8 constant DFSDM_CH6AWSCDR          \ CH6AWSCDR
  $CC constant DFSDM_CH6WDATR           \ CH6WDATR
  $D0 constant DFSDM_CH6DATINR          \ CH6DATINR
  $D4 constant DFSDM_CH6DLYR            \ channel y delay register
  $E0 constant DFSDM_CH7CFGR1           \ CH7CFGR1
  $E4 constant DFSDM_CH7CFGR2           \ CH7CFGR2
  $E8 constant DFSDM_CH7AWSCDR          \ CH7AWSCDR
  $EC constant DFSDM_CH7WDATR           \ CH7WDATR
  $F0 constant DFSDM_CH7DATINR          \ CH7DATINR
  $F4 constant DFSDM_CH7DLYR            \ channel y delay register
  $100 constant DFSDM_DFSDM_FLT0CR1     \ control register 1
  $104 constant DFSDM_DFSDM_FLT0CR2     \ control register 2
  $108 constant DFSDM_DFSDM_FLT0ISR     \ interrupt and status register
  $10C constant DFSDM_DFSDM_FLT0ICR     \ interrupt flag clear register
  $110 constant DFSDM_DFSDM_FLT0JCHGR   \ injected channel group selection register
  $114 constant DFSDM_DFSDM_FLT0FCR     \ filter control register
  $118 constant DFSDM_DFSDM_FLT0JDATAR  \ data register for injected group
  $11C constant DFSDM_DFSDM_FLT0RDATAR  \ data register for the regular channel
  $120 constant DFSDM_DFSDM_FLT0AWHTR   \ analog watchdog high threshold register
  $124 constant DFSDM_DFSDM_FLT0AWLTR   \ analog watchdog low threshold register
  $128 constant DFSDM_DFSDM_FLT0AWSR    \ analog watchdog status register
  $12C constant DFSDM_DFSDM_FLT0AWCFR   \ analog watchdog clear flag register
  $130 constant DFSDM_DFSDM_FLT0EXMAX   \ Extremes detector maximum register
  $134 constant DFSDM_DFSDM_FLT0EXMIN   \ Extremes detector minimum register
  $138 constant DFSDM_DFSDM_FLT0CNVTIMR \ conversion timer register
  $180 constant DFSDM_DFSDM_FLT1CR1     \ control register 1
  $184 constant DFSDM_DFSDM_FLT1CR2     \ control register 2
  $188 constant DFSDM_DFSDM_FLT1ISR     \ interrupt and status register
  $18C constant DFSDM_DFSDM_FLT1ICR     \ interrupt flag clear register
  $190 constant DFSDM_DFSDM_FLT1CHGR    \ injected channel group selection register
  $194 constant DFSDM_DFSDM_FLT1FCR     \ filter control register
  $198 constant DFSDM_DFSDM_FLT1JDATAR  \ data register for injected group
  $19C constant DFSDM_DFSDM_FLT1RDATAR  \ data register for the regular channel
  $1A0 constant DFSDM_DFSDM_FLT1AWHTR   \ analog watchdog high threshold register
  $1A4 constant DFSDM_DFSDM_FLT1AWLTR   \ analog watchdog low threshold register
  $1A8 constant DFSDM_DFSDM_FLT1AWSR    \ analog watchdog status register
  $1AC constant DFSDM_DFSDM_FLT1AWCFR   \ analog watchdog clear flag register
  $1B0 constant DFSDM_DFSDM_FLT1EXMAX   \ Extremes detector maximum register
  $1B4 constant DFSDM_DFSDM_FLT1EXMIN   \ Extremes detector minimum register
  $1B8 constant DFSDM_DFSDM_FLT1CNVTIMR \ conversion timer register
  $200 constant DFSDM_DFSDM_FLT2CR1     \ control register 1
  $204 constant DFSDM_DFSDM_FLT2CR2     \ control register 2
  $208 constant DFSDM_DFSDM_FLT2ISR     \ interrupt and status register
  $20C constant DFSDM_DFSDM_FLT2ICR     \ interrupt flag clear register
  $210 constant DFSDM_DFSDM_FLT2JCHGR   \ injected channel group selection register
  $214 constant DFSDM_DFSDM_FLT2FCR     \ filter control register
  $218 constant DFSDM_DFSDM_FLT2JDATAR  \ data register for injected group
  $21C constant DFSDM_DFSDM_FLT2RDATAR  \ data register for the regular channel
  $220 constant DFSDM_DFSDM_FLT2AWHTR   \ analog watchdog high threshold register
  $224 constant DFSDM_DFSDM_FLT2AWLTR   \ analog watchdog low threshold register
  $228 constant DFSDM_DFSDM_FLT2AWSR    \ analog watchdog status register
  $22C constant DFSDM_DFSDM_FLT2AWCFR   \ analog watchdog clear flag register
  $230 constant DFSDM_DFSDM_FLT2EXMAX   \ Extremes detector maximum register
  $234 constant DFSDM_DFSDM_FLT2EXMIN   \ Extremes detector minimum register
  $238 constant DFSDM_DFSDM_FLT2CNVTIMR \ conversion timer register
  $280 constant DFSDM_DFSDM_FLT3CR1     \ control register 1
  $284 constant DFSDM_DFSDM_FLT3CR2     \ control register 2
  $288 constant DFSDM_DFSDM_FLT3ISR     \ interrupt and status register
  $28C constant DFSDM_DFSDM_FLT3ICR     \ interrupt flag clear register
  $290 constant DFSDM_DFSDM_FLT3JCHGR   \ injected channel group selection register
  $294 constant DFSDM_DFSDM_FLT3FCR     \ filter control register
  $298 constant DFSDM_DFSDM_FLT3JDATAR  \ data register for injected group
  $29C constant DFSDM_DFSDM_FLT3RDATAR  \ data register for the regular channel
  $2A0 constant DFSDM_DFSDM_FLT3AWHTR   \ analog watchdog high threshold register
  $2A4 constant DFSDM_DFSDM_FLT3AWLTR   \ analog watchdog low threshold register
  $2A8 constant DFSDM_DFSDM_FLT3AWSR    \ analog watchdog status register
  $2AC constant DFSDM_DFSDM_FLT3AWCFR   \ analog watchdog clear flag register
  $2B0 constant DFSDM_DFSDM_FLT3EXMAX   \ Extremes detector maximum register
  $2B4 constant DFSDM_DFSDM_FLT3EXMIN   \ Extremes detector minimum register
  $2B8 constant DFSDM_DFSDM_FLT3CNVTIMR \ conversion timer register
