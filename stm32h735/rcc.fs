...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CSICFGR_DEF
    \
    \ @brief RCC CSI calibration register
    \ Address offset: 0x0C
    \ Reset value: 0x20000000
    \
    $00 constant RCC_CSICAL                     \ [0x00 : 10] CSI clock calibration Set by hardware by option byte loading during system reset nreset. Adjusted by software through trimming bits CSITRIM. This field represents the sum of engineering option byte calibration value and CSITRIM bits value.
  ...
  [ifdef] RCC_CFGR_DEF
    ...
    $16 constant RCC_MCO1                       \ [0x16 : 3] Micro-controller clock output 1
    $19 constant RCC_MCO2PRE                    \ [0x19 : 4] MCO2 prescaler
    $1d constant RCC_MCO2                       \ [0x1d : 3] Micro-controller clock output 2
  [then]
  ...
  [ifdef] RCC_D1CCIPR_DEF
    ...
    $04 constant RCC_OCTOSPISEL                 \ [0x04 : 2] QUADSPI kernel clock source selection
  ...
  [ifdef] RCC_D2CCIP1R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_SAI1SEL                    \ [0x00 : 3] SAI1 and DFSDM1 kernel Aclk clock source selection
    $0c constant RCC_SPI123SEL                  \ [0x0c : 3] SPI/I2S1,2 and 3 kernel clock source selection
    $10 constant RCC_SPI45SEL                   \ [0x10 : 3] SPI4 and 5 kernel clock source selection
    $14 constant RCC_SPDIFRXSEL                 \ [0x14 : 2] SPDIFRX kernel clock source selection
    $18 constant RCC_DFSDM1SEL                  \ [0x18] DFSDM1 kernel Clk clock source selection
    $1c constant RCC_FDCANSEL                   \ [0x1c : 2] FDCAN kernel clock source selection
    $1f constant RCC_SWPMISEL                   \ [0x1f] SWPMI kernel clock source selection
  [then]
  ...
  [ifdef] RCC_D2CCIP2R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_USART234578SEL             \ [0x00 : 3] USART2/3, UART4,5, 7/8 (APB1) kernel clock source selection
    $03 constant RCC_USART16910SEL              \ [0x03 : 3] USART1 and 6 kernel clock source selection
    $08 constant RCC_RNGSEL                     \ [0x08 : 2] RNG kernel clock source selection
    $0c constant RCC_I2C123SEL                  \ [0x0c : 2] I2C1,2,3 kernel clock source selection
    $14 constant RCC_USBSEL                     \ [0x14 : 2] USBOTG 1 and 2 kernel clock source selection
    $16 constant RCC_CECSEL                     \ [0x16 : 2] HDMI-CEC kernel clock source selection
    $1c constant RCC_LPTIM1SEL                  \ [0x1c : 3] LPTIM1 kernel clock source selection
  [then]
  ...
  [ifdef] RCC_D3CCIPR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_LPUART1SEL                 \ [0x00 : 3] LPUART1 kernel clock source selection
    $08 constant RCC_I2C4SEL                    \ [0x08 : 2] I2C4 kernel clock source selection
    $0a constant RCC_LPTIM2SEL                  \ [0x0a : 3] LPTIM2 kernel clock source selection
    $0d constant RCC_LPTIM345SEL                \ [0x0d : 3] LPTIM3,4,5 kernel clock source selection
    $10 constant RCC_ADCSEL                     \ [0x10 : 2] SAR ADC kernel clock source selection
    $15 constant RCC_SAI4ASEL                   \ [0x15 : 3] Sub-Block A of SAI4 kernel clock source selection
    $18 constant RCC_SAI4BSEL                   \ [0x18 : 3] Sub-Block B of SAI4 kernel clock source selection
    $1c constant RCC_SPI6SEL                    \ [0x1c : 3] SPI6 kernel clock source selection
  [then]
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    $0e constant RCC_OCTOSPI1RST                \ [0x0e] QUADSPI and QUADSPI delay block reset
    ...
    $15 constant RCC_IOMNGRRST                  \ [0x15] OCTOSPIM reset Set and reset by software
  ...
  [ifdef] RCC_AHB2RSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_DCMI_PSSIRST               \ [0x00] DCMI_PSSIRST
    ...
    $10 constant RCC_FMACRST                    \ [0x10] FMAC reset
    $11 constant RCC_CORDICRST                  \ [0x11] CORDIC coprocessor block reset
  [then]
  ...
  [ifdef] RCC_APB1LRSTR_DEF
    ...
    $19 constant RCC_I2C5RST                    \ [0x19] I2C5 block reset
  ...
  [ifdef] RCC_APB1HRSTR_DEF
    ...
    $02 constant RCC_SWPMIRST                   \ [0x02] SWPMI block reset
    ...
    $18 constant RCC_TIM23RST                   \ [0x18] TIM23 block reset
    $19 constant RCC_TIM24RST                   \ [0x19] TIM24 block resett
  [then]
  ...
  [ifdef] RCC_D3AMR_DEF
    ...
    $1c constant RCC_BKPSRAMAMEN                \ [0x1c] Backup RAM Autonomous mode enable
  ...
  [ifdef] RCC_AHB3ENR_DEF
    ...
    $0e constant RCC_OCTOSPI1EN                 \ [0x0e] OCTOSPI1 and OCTOSPI1 delay clock enable
    ...
    $15 constant RCC_IOMNGREN                   \ [0x15] OCTOSPIM clock enable Set and reset by software.
  ...
  [ifdef] RCC_AHB1ENR_DEF
    ...
    $19 constant RCC_USB1OTGHSEN                \ [0x19] USB1OTG Peripheral Clocks Enable
    $1a constant RCC_USB1OTGHSULPIEN            \ [0x1a] USB_PHY1 Clocks Enable
  [then]
  ...
  [ifdef] RCC_AHB2ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_DCMI_PSSIEN                \ [0x00] CAMITF peripheral clock enable
    ...
    $10 constant RCC_FMACEN                     \ [0x10] FMAC clock enable
    $11 constant RCC_CORDICEN                   \ [0x11] CORDIC clock enable
  ...
  [ifdef] RCC_APB1LENR_DEF
    ...
    $19 constant RCC_I2C5EN                     \ [0x19] I2C5 Peripheral Clocks Enable
    $1b constant RCC_CECEN                      \ [0x1b] HDMI-CEC peripheral clock enable
    $1d constant RCC_DAC12EN                    \ [0x1d] DAC1 and 2 peripheral clock enable
    $1e constant RCC_UART7EN                    \ [0x1e] UART7 Peripheral Clocks Enable
    $1f constant RCC_UART8EN                    \ [0x1f] UART8 Peripheral Clocks Enable
  [then]
  ...
  [ifdef] RCC_APB1HENR_DEF
    ...
    $02 constant RCC_SWPMIEN                    \ [0x02] SWPMI Peripheral Clocks Enable
    ...
    $18 constant RCC_TIM23EN                    \ [0x18] TIM23 Peripheral Clocks Enable
    $19 constant RCC_TIM24EN                    \ [0x19] TIM24 Peripheral Clocks Enable
  [then]
  ...
  [ifdef] RCC_AHB3LPENR_DEF
    ...
    $08 constant RCC_FLASHLPEN                  \ [0x08] Flash interface Clock Enable During CSleep Mode
    $0c constant RCC_FMCLPEN                    \ [0x0c] FMC Peripheral Clocks Enable During CSleep Mode
    $0e constant RCC_OCTO1LPEN                  \ [0x0e] QUADSPI and QUADSPI Delay Clock Enable During CSleep Mode
    $10 constant RCC_SDMMC1LPEN                 \ [0x10] SDMMC1 and SDMMC1 Delay Clock Enable During CSleep Mode
    $13 constant RCC_OCTO2LPEN                  \ [0x13] OCTOSPI2 and OCTOSPI2 delay clock enable during CSleep mode Set and reset by software.
    $15 constant RCC_IOMNGRLPEN                 \ [0x15] OCTOSPIM block clock enable during CSleep mode Set and reset by software.
    ...
    $1c constant RCC_DTCM1LPEN                  \ [0x1c] D1DTCM1 Block Clock Enable During CSleep mode
  ...
  [ifdef] RCC_AHB2LPENR_DEF
    ...
    \
    $00 constant RCC_DCMI_PSSILPEN              \ [0x00] DCMI_PSSILPEN
    ...
    $10 constant RCC_FMACLPEN                   \ [0x10] FMAC peripheral clock enable during CSleep mode
    $11 constant RCC_CORDICLPEN                 \ [0x11] CORDIC peripheral clock enable during CSleep mode
  ...
  [ifdef] RCC_APB1LLPENR_DEF
    ...
    $19 constant RCC_I2C5LPEN                   \ [0x19] I2C5 Peripheral Clocks Enable During CSleep Mode
    $1b constant RCC_CECLPEN                    \ [0x1b] CEC Peripheral Clocks Enable During CSleep Mode
  ...
  [ifdef] RCC_APB1HLPENR_DEF
    ...
    $02 constant RCC_SWPMILPEN                  \ [0x02] SWPMI Peripheral Clocks Enable During CSleep Mode
    ...
    $18 constant RCC_TIM23LPEN                  \ [0x18] TIM23 Peripheral Clocks Enable During CSleep Mode
    $19 constant RCC_TIM24LPEN                  \ [0x19] TIM24 Peripheral Clocks Enable During CSleep Mode
  [then]
  ...
  [ifdef] RCC_APB4LPENR_DEF
    ...
    $1a constant RCC_DTSLPEN                    \ [0x1a] Digital temperature sensor peripheral clock enable during CSleep mode
  [then]
  ...
  $04 constant RCC_HSICFGR              \ RCC HSI calibration register
  $08 constant RCC_CRRCR                \ RCC clock recovery RC register
  $0C constant RCC_CSICFGR              \ RCC CSI calibration register
