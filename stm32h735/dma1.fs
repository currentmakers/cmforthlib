...
\ @brief DMA controller
\
$40020000 constant DMA1_LISR      \ offset: 0x00 : low interrupt status register
$40020004 constant DMA1_HISR      \ offset: 0x04 : high interrupt status register
$40020008 constant DMA1_LIFCR     \ offset: 0x08 : low interrupt flag clear register
$4002000c constant DMA1_HIFCR     \ offset: 0x0C : high interrupt flag clear register
$40020010 constant DMA1_S0CR      \ offset: 0x10 : stream x configuration register
$40020014 constant DMA1_S0NDTR    \ offset: 0x14 : stream x number of data register
$40020018 constant DMA1_S0PAR     \ offset: 0x18 : stream x peripheral address register
$4002001c constant DMA1_S0M0AR    \ offset: 0x1C : stream x memory 0 address register
$40020020 constant DMA1_S0M1AR    \ offset: 0x20 : stream x memory 1 address register
$40020024 constant DMA1_S0FCR     \ offset: 0x24 : stream x FIFO control register
$40020028 constant DMA1_S1CR      \ offset: 0x28 : stream x configuration register
$4002002c constant DMA1_S1NDTR    \ offset: 0x2C : stream x number of data register
$40020030 constant DMA1_S1PAR     \ offset: 0x30 : stream x peripheral address register
$40020034 constant DMA1_S1M0AR    \ offset: 0x34 : stream x memory 0 address register
$40020038 constant DMA1_S1M1AR    \ offset: 0x38 : stream x memory 1 address register
$4002003c constant DMA1_S1FCR     \ offset: 0x3C : stream x FIFO control register
$40020040 constant DMA1_S2CR      \ offset: 0x40 : stream x configuration register
$40020044 constant DMA1_S2NDTR    \ offset: 0x44 : stream x number of data register
$40020048 constant DMA1_S2PAR     \ offset: 0x48 : stream x peripheral address register
$4002004c constant DMA1_S2M0AR    \ offset: 0x4C : stream x memory 0 address register
$40020050 constant DMA1_S2M1AR    \ offset: 0x50 : stream x memory 1 address register
$40020054 constant DMA1_S2FCR     \ offset: 0x54 : stream x FIFO control register
$40020058 constant DMA1_S3CR      \ offset: 0x58 : stream x configuration register
$4002005c constant DMA1_S3NDTR    \ offset: 0x5C : stream x number of data register
$40020060 constant DMA1_S3PAR     \ offset: 0x60 : stream x peripheral address register
$40020064 constant DMA1_S3M0AR    \ offset: 0x64 : stream x memory 0 address register
$40020068 constant DMA1_S3M1AR    \ offset: 0x68 : stream x memory 1 address register
$4002006c constant DMA1_S3FCR     \ offset: 0x6C : stream x FIFO control register
$40020070 constant DMA1_S4CR      \ offset: 0x70 : stream x configuration register
$40020074 constant DMA1_S4NDTR    \ offset: 0x74 : stream x number of data register
$40020078 constant DMA1_S4PAR     \ offset: 0x78 : stream x peripheral address register
$4002007c constant DMA1_S4M0AR    \ offset: 0x7C : stream x memory 0 address register
$40020080 constant DMA1_S4M1AR    \ offset: 0x80 : stream x memory 1 address register
$40020084 constant DMA1_S4FCR     \ offset: 0x84 : stream x FIFO control register
$40020088 constant DMA1_S5CR      \ offset: 0x88 : stream x configuration register
$4002008c constant DMA1_S5NDTR    \ offset: 0x8C : stream x number of data register
$40020090 constant DMA1_S5PAR     \ offset: 0x90 : stream x peripheral address register
$40020094 constant DMA1_S5M0AR    \ offset: 0x94 : stream x memory 0 address register
$40020098 constant DMA1_S5M1AR    \ offset: 0x98 : stream x memory 1 address register
$4002009c constant DMA1_S5FCR     \ offset: 0x9C : stream x FIFO control register
$400200a0 constant DMA1_S6CR      \ offset: 0xA0 : stream x configuration register
$400200a4 constant DMA1_S6NDTR    \ offset: 0xA4 : stream x number of data register
$400200a8 constant DMA1_S6PAR     \ offset: 0xA8 : stream x peripheral address register
$400200ac constant DMA1_S6M0AR    \ offset: 0xAC : stream x memory 0 address register
$400200b0 constant DMA1_S6M1AR    \ offset: 0xB0 : stream x memory 1 address register
$400200b4 constant DMA1_S6FCR     \ offset: 0xB4 : stream x FIFO control register
$400200b8 constant DMA1_S7CR      \ offset: 0xB8 : stream x configuration register
$400200bc constant DMA1_S7NDTR    \ offset: 0xBC : stream x number of data register
$400200c0 constant DMA1_S7PAR     \ offset: 0xC0 : stream x peripheral address register
$400200c4 constant DMA1_S7M0AR    \ offset: 0xC4 : stream x memory 0 address register
$400200c8 constant DMA1_S7M1AR    \ offset: 0xC8 : stream x memory 1 address register
$400200cc constant DMA1_S7FCR     \ offset: 0xCC : stream x FIFO control register
