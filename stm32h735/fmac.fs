...
$0000ff00 constant FMAC_FMAC_X1BUFCFG_X1_BUF_SIZE                   \ Allocated size of X1 buffer in 16-bit words The minimum buffer size is the number of feed-forward taps in the filter (+ the watermark threshold - 1).
...
\ @brief FMAC register block
\
$48024000 constant FMAC_FMAC_X1BUFCFG  \ offset: 0x00 : FMAC X1 buffer configuration register
$48024004 constant FMAC_FMAC_X2BUFCFG  \ offset: 0x04 : FMAC X2 buffer configuration register
$48024008 constant FMAC_FMAC_YBUFCFG  \ offset: 0x08 : FMAC Y buffer configuration register
$4802400c constant FMAC_FMAC_PARAM  \ offset: 0x0C : FMAC parameter register
$48024010 constant FMAC_FMAC_CR   \ offset: 0x10 : FMAC control register
$48024014 constant FMAC_FMAC_SR   \ offset: 0x14 : FMAC status register
$48024018 constant FMAC_FMAC_WDATA  \ offset: 0x18 : FMAC write data register
$4802401c constant FMAC_FMAC_RDATA  \ offset: 0x1C : FMAC read data register
