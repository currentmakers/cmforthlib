...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_TAFCR_DEF
    ...
    $06 constant RTC_TAMP3TRG                   \ [0x06] Active level for RTC_TAMP3 input
    ...
    $0d constant RTC_TAMP_PRCH                  \ [0x0d : 2] RTC_TAMPx precharge duration
    $0f constant RTC_TAMP_PUDIS                 \ [0x0f] RTC_TAMPx pull-up disable
    $12 constant RTC_PC13VALUE                  \ [0x12] RTC_ALARM output type/PC13 value
    $13 constant RTC_PC13MODE                   \ [0x13] PC13 mode
    $14 constant RTC_PC14VALUE                  \ [0x14] PC14 value
    $15 constant RTC_PC14MODE                   \ [0x15] PC14 mode
    $16 constant RTC_PC15VALUE                  \ [0x16] PC15 value
    $17 constant RTC_PC15MODE                   \ [0x17] PC15 mode
  [then]
  ...
  $30 constant RTC_TSTR                 \ timestamp time register
  $34 constant RTC_TSDR                 \ timestamp date register
  $38 constant RTC_TSSSR                \ time-stamp sub second register
