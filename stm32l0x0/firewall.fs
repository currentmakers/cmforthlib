...
[ifndef] FIREWALL_DEF
  ...
  [ifdef] FIREWALL_FIREWALL_CSSA_DEF
    \
  ...
  [ifdef] FIREWALL_FIREWALL_CSL_DEF
    \
  ...
  [ifdef] FIREWALL_FIREWALL_NVDSSA_DEF
    \
  ...
  [ifdef] FIREWALL_FIREWALL_NVDSL_DEF
    \
  ...
  [ifdef] FIREWALL_FIREWALL_VDSSA_DEF
    \
  ...
  [ifdef] FIREWALL_FIREWALL_VDSL_DEF
    \
  ...
  [ifdef] FIREWALL_FIREWALL_CR_DEF
    \
  ...
  \ @brief Firewall
  \
  $00 constant FIREWALL_FIREWALL_CSSA   \ Code segment start address
  $04 constant FIREWALL_FIREWALL_CSL    \ Code segment length
  $08 constant FIREWALL_FIREWALL_NVDSSA \ Non-volatile data segment start address
  $0C constant FIREWALL_FIREWALL_NVDSL  \ Non-volatile data segment length
  $10 constant FIREWALL_FIREWALL_VDSSA  \ Volatile data segment start address
  $14 constant FIREWALL_FIREWALL_VDSL   \ Volatile data segment length
  $20 constant FIREWALL_FIREWALL_CR     \ Configuration register
