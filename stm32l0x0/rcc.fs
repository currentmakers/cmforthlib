...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $05 constant RCC_TIM22RST                   \ [0x05] TIM22 timer reset
  ...
  [ifdef] RCC_APB1RSTR_DEF
    ...
    $1b constant RCC_CRCRST                     \ [0x1b] CRC reset
    $1c constant RCC_PWRRST                     \ [0x1c] Power interface reset
    $1e constant RCC_I2C3                       \ [0x1e] I2C3 reset
  ...
  [ifdef] RCC_IOPENR_DEF
    ...
    $04 constant RCC_IOPEEN                     \ [0x04] IO port E clock enable bit
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $07 constant RCC_FWEN                       \ [0x07] Firewall clock enable bit
  ...
  [ifdef] RCC_APB1ENR_DEF
    ...
    $02 constant RCC_TIM3EN                     \ [0x02] Timer 3 clock enbale bit
  ...
  [ifdef] RCC_IOPSMEN_DEF
    ...
    \
    $00 constant RCC_IOPASMEN                   \ [0x00] Port A clock enable during Sleep mode bit
    $01 constant RCC_IOPBSMEN                   \ [0x01] Port B clock enable during Sleep mode bit
    $02 constant RCC_IOPCSMEN                   \ [0x02] Port C clock enable during Sleep mode bit
    $03 constant RCC_IOPDSMEN                   \ [0x03] Port D clock enable during Sleep mode bit
    $04 constant RCC_IOPESMEN                   \ [0x04] Port E clock enable during Sleep mode bit
    $07 constant RCC_IOPHSMEN                   \ [0x07] Port H clock enable during Sleep mode bit
  [then]
  ...
  [ifdef] RCC_AHBSMENR_DEF
    ...
    $18 constant RCC_CRYPTSMEN                  \ [0x18] Crypto clock enable during sleep mode bit
  [then]
  ...
  [ifdef] RCC_APB1SMENR_DEF
    ...
    $01 constant RCC_TIM3SMEN                   \ [0x01] Timer 3 clock enable during sleep mode bit
    ...
    $13 constant RCC_USART4SMEN                 \ [0x13] USART4 clock enabe during sleep mode bit
    ...
    $1e constant RCC_I2C3SMEN                   \ [0x1e] I2C3 clock enable during sleep mode bit
  ...
  [ifdef] RCC_CCIPR_DEF
    ...
    $10 constant RCC_I2C3SEL0                   \ [0x10] I2C3 clock source selection bits
    $11 constant RCC_I2C3SEL1                   \ [0x11] I2C3 clock source selection bits
  ...
  [ifdef] RCC_CSR_DEF
    ...
    $02 constant RCC_LSIIWDGLP                  \ [0x02] LSI clock input to IWDG in Ultra-low-power mode (Stop and Standby) enable bit
