...
[ifndef] OTG_DEF
  ...
  [ifdef] OTG_OTG_GOTGCTL_DEF
    ...
    \
    $02 constant OTG_VBVALOEN                   \ [0x02] Vless thansub>BUSless than/sub> valid override enable.
    $03 constant OTG_VBVALOVAL                  \ [0x03] Vless thansub>BUSless than/sub> valid override value.
