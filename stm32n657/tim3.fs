...
[ifndef] TIM3_DEF
  ...
  [ifdef] TIM3_TIM3_CR2_DEF
    ...
    $1c constant TIM3_ADSYNC                    \ [0x1c] ADC synchronization
  [then]
  ...
  [ifdef] TIM3_TIM3_SMCR_DEF
    ...
    $04 constant TIM3_TS                        \ [0x04 : 3] TS[0]: Trigger selection
  ...
  [ifdef] TIM3_TIM3_CNT_DEF
    ...
    $1f constant TIM3_UIFCPY_CNT                \ [0x1f] Value depends on IUFREMAP in TIMx_CR1.
  [then]
  ...
  [ifdef] TIM3_TIM3_ARR_DEF
    ...
    \
    $00 constant TIM3_ARR                       \ [0x00 : 32] Auto-reload value
  [then]
  ...
  [ifdef] TIM3_TIM3_CCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CCR1                      \ [0x00 : 32] Capture/compare 1 value
  [then]
  ...
  [ifdef] TIM3_TIM3_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CCR2                      \ [0x00 : 32] Capture/compare 2 value
  [then]
  ...
  [ifdef] TIM3_TIM3_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CCR3                      \ [0x00 : 32] Capture/compare 3 value
  [then]
  ...
  [ifdef] TIM3_TIM3_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_CCR4                      \ [0x00 : 32] Capture/compare 4 value
  [then]
  ...
  $1C constant TIM3_TIM3_CCMR2_OUTPUT   \ TIM3 capture/compare mode register 2
