...
$00000003 constant SPDIFRX_SPDIFRX_CR_SPDIFRXEN                     \ Peripheral block enableless thansup>(1)less than/sup>
$00000004 constant SPDIFRX_SPDIFRX_CR_RXDMAEN                       \ Receiver DMA enable for data flowless thansup>(1)less than/sup>
$00000008 constant SPDIFRX_SPDIFRX_CR_RXSTEO                        \ Stereo modeless thansup>(1)less than/sup>
$00000030 constant SPDIFRX_SPDIFRX_CR_DRFMT                         \ RX data formatless thansup>(1)less than/sup>
$00000040 constant SPDIFRX_SPDIFRX_CR_PMSK                          \ Mask parity error bitless thansup>(1)less than/sup>
$00000080 constant SPDIFRX_SPDIFRX_CR_VMSK                          \ Mask of validity bitless thansup>(1)less than/sup>
$00000100 constant SPDIFRX_SPDIFRX_CR_CUMSK                         \ Mask of channel status and user bitsless thansup>(1)less than/sup>
$00000200 constant SPDIFRX_SPDIFRX_CR_PTMSK                         \ Mask of preamble type bitsless thansup>(1)less than/sup>
$00000400 constant SPDIFRX_SPDIFRX_CR_CBDMAEN                       \ Control buffer DMA enable for control flowless thansup>(1)less than/sup>
$00000800 constant SPDIFRX_SPDIFRX_CR_CHSEL                         \ Channel selectionless thansup>(1)less than/sup>
$00003000 constant SPDIFRX_SPDIFRX_CR_NBTR                          \ Maximum allowed re-tries during synchronization phaseless thansup>(1)less than/sup>
$00004000 constant SPDIFRX_SPDIFRX_CR_WFA                           \ Wait for activityless thansup>(1)less than/sup>
...
$00001fff constant SPDIFRX_SPDIFRX_DIR_THI                          \ threshold HIGH (THI = 2.5 x UI / Tless thansub>spdifrx_ker_ckless than/sub>)
$1fff0000 constant SPDIFRX_SPDIFRX_DIR_TLO                          \ threshold LOW (TLO = 1.5 x UI / Tless thansub>spdifrx_ker_ckless than/sub>)
