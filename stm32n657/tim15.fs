...
[ifndef] TIM15_DEF
  ...
  [ifdef] TIM15_TIM15_CR2_DEF
    ...
    $1c constant TIM15_ADSYNC                   \ [0x1c] ADC synchronization
  [then]
  ...
  [ifdef] TIM15_TIM15_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM15_SMS                      \ [0x00 : 3] SMS[0]: Slave mode selection
    $04 constant TIM15_TS                       \ [0x04 : 3] TS[0]: Trigger selection
  ...
  $18 constant TIM15_TIM15_CCMR1_INPUT  \ TIM15 capture/compare mode register 1
  $18 constant TIM15_TIM15_CCMR1_OUTPUT \ TIM15 capture/compare mode register 1
