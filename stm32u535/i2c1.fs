...
[ifndef] I2C1_DEF
  ...
  [ifdef] I2C1_I2C_AUTOCR_DEF
    \
    \ @brief I2C Autonomous mode control register
    \ Address offset: 0x2C
    \ Reset value: 0x00000000
    \
    $06 constant I2C1_TCDMAEN                   \ [0x06] DMA request enable on Transfer Complete event
    $07 constant I2C1_TCRDMAEN                  \ [0x07] DMA request enable on Transfer Complete Reload event
    $10 constant I2C1_TRIGSEL                   \ [0x10 : 4] Trigger selection
    $14 constant I2C1_TRIGPOL                   \ [0x14] Trigger polarity
    $15 constant I2C1_TRIGEN                    \ [0x15] Trigger enable
  [then]
  ...
  $2C constant I2C1_I2C_AUTOCR          \ I2C Autonomous mode control register
