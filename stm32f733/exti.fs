...
[ifndef] EXTI_DEF
  ...
  [ifdef] EXTI_IMR_DEF
    ...
    $09 constant EXTI_MI9                       \ [0x09] Interrupt Mask on line 9
  ...
  [ifdef] EXTI_RTSR_DEF
    ...
    $17 constant EXTI_TR23                      \ [0x17] Rising trigger event configuration of line 23
  [then]
  ...
  [ifdef] EXTI_FTSR_DEF
    ...
    $17 constant EXTI_TR23                      \ [0x17] Falling trigger event configuration of line 23
  [then]
  ...
  [ifdef] EXTI_SWIER_DEF
    ...
    $17 constant EXTI_SWIER23                   \ [0x17] Software Interrupt on line 22
  [then]
  ...
  [ifdef] EXTI_PR_DEF
    ...
    $17 constant EXTI_PR23                      \ [0x17] Pending bit 23
  [then]
