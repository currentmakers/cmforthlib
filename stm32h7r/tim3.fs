...
$00000070 constant TIM3_TIM3_CR2_MMS                                \ MMS[0]: Master mode selection
$00000080 constant TIM3_TIM3_CR2_TI1S                               \ tim_ti1 selection
$02000000 constant TIM3_TIM3_CR2_MMS_1                              \ MMS[3]
...
$00000007 constant TIM3_TIM3_SMCR_SMS                               \ SMS[0]: Slave mode selection
$00000008 constant TIM3_TIM3_SMCR_OCCS                              \ OCREF clear selection This bit is used to select the OCREF clear source Note: If the OCREF clear selection feature is not supported, this bit is reserved and forced by hardware to 0. Section 65.3: TIM2/TIM3/TIM4/TIM5 implementation.
...
$00000070 constant TIM3_TIM3_CCMR1_OUTPUT_OC1M                      \ OC1M[2:0]: Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 is derived. tim_oc1ref is active high whereas tim_oc1 active level depends on CC1P bit. Note: In PWM mode, the tim_ocref_clr level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode.
...
$00007000 constant TIM3_TIM3_CCMR1_OUTPUT_OC2M                      \ OC2M[2:0]: Output compare 2 mode refer to OC1M description on bits 6:4
$00008000 constant TIM3_TIM3_CCMR1_OUTPUT_OC2CE                     \ Output compare 2 clear enable
$00010000 constant TIM3_TIM3_CCMR1_OUTPUT_OC1M_1                    \ OC1M[3]
$01000000 constant TIM3_TIM3_CCMR1_OUTPUT_OC2M_1                    \ OC2M[3]
...
$00000003 constant TIM3_TIM2_CCMR3_OUTPUT_CC3S                      \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
$00000004 constant TIM3_TIM2_CCMR3_OUTPUT_OC3FE                     \ Output compare 3 fast enable
$00000008 constant TIM3_TIM2_CCMR3_OUTPUT_OC3PE                     \ Output compare 3 preload enable
$00000070 constant TIM3_TIM2_CCMR3_OUTPUT_OC3M                      \ OC3M[2:0]: Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
$00000080 constant TIM3_TIM2_CCMR3_OUTPUT_OC3CE                     \ Output compare 3 clear enable
$00000300 constant TIM3_TIM2_CCMR3_OUTPUT_CC4S                      \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
$00000400 constant TIM3_TIM2_CCMR3_OUTPUT_OC4FE                     \ Output compare 4 fast enable
$00000800 constant TIM3_TIM2_CCMR3_OUTPUT_OC4PE                     \ Output compare 4 preload enable
$00007000 constant TIM3_TIM2_CCMR3_OUTPUT_OC4M                      \ OC4M[2:0]: Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
$00008000 constant TIM3_TIM2_CCMR3_OUTPUT_OC4CE                     \ Output compare 4 clear enable
$00010000 constant TIM3_TIM2_CCMR3_OUTPUT_OC3M_1                    \ OC3M[3]
$01000000 constant TIM3_TIM2_CCMR3_OUTPUT_OC4M_1                    \ OC4M[3]
...
$7fffffff constant TIM3_TIM3_CNT_CNT                                \ Least significant part of counter value Non-dithering mode (DITHEN = 0) The register holds the counter value. Dithering mode (DITHEN = 1) The register holds the non-dithered part in CNT[30:0]. The fractional part is not available.
$80000000 constant TIM3_TIM3_CNT_UIFCPY_CNT                         \ Value depends on IUFREMAP in TIMx_CR1. If UIFREMAP = 0 CNT[31]: Most significant bit of counter value If UIFREMAP = 1 UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register
...
$000000c0 constant TIM3_TIM3_ECR_IPOS                               \ Index positioning
$00ff0000 constant TIM3_TIM3_ECR_PW                                 \ Pulse width This bitfield defines the pulse duration, as following: t<sub>PW</sub> = PW[7:0] x t<sub>PWG</sub>
$07000000 constant TIM3_TIM3_ECR_PWPRSC                             \ Pulse width prescaler This bitfield sets the clock prescaler for the pulse generator, as following: t<sub>PWG</sub> = (2<sup>(PWPRSC[2:0])</sup>) x t<sub>tim_ker_ck</sub>
...
$0000000f constant TIM3_TIM3_TISEL_TI1SEL                           \ Selects tim_ti1[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
$00000f00 constant TIM3_TIM3_TISEL_TI2SEL                           \ Selects tim_ti2[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
$000f0000 constant TIM3_TIM3_TISEL_TI3SEL                           \ Selects tim_ti3[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
$0f000000 constant TIM3_TIM3_TISEL_TI4SEL                           \ Selects tim_ti4[15:0] input ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
...
$0003c000 constant TIM3_TIM3_AF1_ETRSEL                             \ etr_in source selection These bits select the etr_in input source. ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
...
$00070000 constant TIM3_TIM3_AF2_OCRSEL                             \ ocref_clr source selection These bits select the ocref_clr input source. ... Refer to Section 65.4.2: TIM2/TIM3/TIM4/TIM5 pins and internal signals for product specific implementation.
...
$40000418 constant TIM3_TIM3_CCMR1_INPUT  \ offset: 0x18 : TIM3 capture/compare mode register 1
$40000418 constant TIM3_TIM3_CCMR1_OUTPUT  \ offset: 0x18 : TIM3 capture/compare mode register 1
$4000041c constant TIM3_TIM3_CCMR2_INPUT  \ offset: 0x1C : TIM3 capture/compare mode register 2
$4000041c constant TIM3_TIM2_CCMR3_OUTPUT  \ offset: 0x1C : TIM3 capture/compare mode register 2
