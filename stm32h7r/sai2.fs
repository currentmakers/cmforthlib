...
$00000003 constant SAI2_SAI_GCR_SYNCIN                              \ Synchronization inputs These bits are set and cleared by software. Refer to Table 418: External synchronization selection (TinyShark, Beluga and STM32U5_Cobra2M and 4M, Viper, Mustang, Python) for information on how to program this field. These bits must be set when both audio blocks (A and B) are disabled. They are meaningful if one of the two audio blocks is defined to operate in synchronous mode with an external SAI (SYNCEN[1:0] = 10 in SAI_ACR1 or in SAI_BCR1 registers).
...
$03f00000 constant SAI2_SAI_ACR1_MCKDIV                             \ Master clock divider These bits are set and cleared by software. Otherwise, The master clock frequency is calculated according to the formula given in Section 55.4.8: SAI clock generator. These bits have no meaning when the audio block is slave. They have to be configured when the audio block is disabled.
...
$00001f80 constant SAI2_SAI_ACR2_MUTECNT                            \ Mute counter. These bits are set and cleared by software. They are used only in reception mode. The value set in these bits is compared to the number of consecutive mute frames detected in reception. When the number of mute frames is equal to this value, the flag MUTEDET is set and an interrupt is generated if bit MUTEDETIE is set. Refer to Section : Mute mode for more details.
...
$00000020 constant SAI2_SAI_ACLRFR_CAFSDET                          \ Clear anticipated frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the AFSDET flag in the SAI_xSR register. It is not used in AC97 or SPDIF mode. Reading this bit always returns the value 0.
$00000040 constant SAI2_SAI_ACLRFR_CLFSDET                          \ Clear late frame synchronization detection flag. This bit is write only. Programming this bit to 1 clears the LFSDET flag in the SAI_xSR register. This bit is not used in AC97 or SPDIF mode Reading this bit always returns the value 0.
...
$03f00000 constant SAI2_SAI_BCR1_MCKDIV                             \ Master clock divider These bits are set and cleared by software. Otherwise, The master clock frequency is calculated according to the formula given in Section 55.4.8: SAI clock generator. These bits have no meaning when the audio block is slave. They have to be configured when the audio block is disabled.
...
$00001f80 constant SAI2_SAI_BCR2_MUTECNT                            \ Mute counter. These bits are set and cleared by software. They are used only in reception mode. The value set in these bits is compared to the number of consecutive mute frames detected in reception. When the number of mute frames is equal to this value, the flag MUTEDET is set and an interrupt is generated if bit MUTEDETIE is set. Refer to Section : Mute mode for more details.
...
$00000001 constant SAI2_SAI_PDMCR_PDMEN                             \ PDM enable This bit is set and cleared by software. This bit enables to control the state of the PDM interface block. Make sure that the SAI in already operating in TDM master mode before enabling the PDM interface.
$00000030 constant SAI2_SAI_PDMCR_MICNBR                            \ Number of microphones This bit is set and cleared by software. Note: It is not recommended to configure this field when PDMEN = 1.* Note: The complete set of data lines might not be available for all SAI instances. Refer to Section 55.3: SAI implementation for details.
$00000100 constant SAI2_SAI_PDMCR_CKEN1                             \ Clock enable of bitstream clock number 1 This bit is set and cleared by software. Note: It is not recommended to configure this bit when PDMEN = 1. Note: SAI_CK1 might not be available for all SAI instances. Refer to Section 55.3: SAI implementation for details.
$00000200 constant SAI2_SAI_PDMCR_CKEN2                             \ Clock enable of bitstream clock number 2 This bit is set and cleared by software. Note: It is not recommended to configure this bit when PDMEN = 1. Note: SAI_CK2 might not be available for all SAI instances. Refer to Section 55.3: SAI implementation for details.
...
$00000007 constant SAI2_SAI_PDMDLY_DLYM1L                           \ Delay line adjust for first microphone of pair 1 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D1 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$00000070 constant SAI2_SAI_PDMDLY_DLYM1R                           \ Delay line adjust for second microphone of pair 1 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D1 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$00000700 constant SAI2_SAI_PDMDLY_DLYM2L                           \ Delay line for first microphone of pair 2 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D2 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$00007000 constant SAI2_SAI_PDMDLY_DLYM2R                           \ Delay line for second microphone of pair 2 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D2 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$00070000 constant SAI2_SAI_PDMDLY_DLYM3L                           \ Delay line for first microphone of pair 3 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D3 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$00700000 constant SAI2_SAI_PDMDLY_DLYM3R                           \ Delay line for second microphone of pair 3 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D3 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$07000000 constant SAI2_SAI_PDMDLY_DLYM4L                           \ Delay line for first microphone of pair 4 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D4 line is available.Refer to Section 55.3: SAI implementation to check if it is available.
$70000000 constant SAI2_SAI_PDMDLY_DLYM4R                           \ Delay line for second microphone of pair 4 This bit is set and cleared by software. ... This field can be changed on-the-fly. Note: This field can be used only if D4 line is available.Refer to Section 55.3: SAI implementation to check if it is available.


\
\ @brief SAI2 global interrupt A
\
$42005800 constant SAI2_SAI_GCR   \ offset: 0x00 : SAI global configuration register
$42005804 constant SAI2_SAI_ACR1  \ offset: 0x04 : SAI configuration register 1
$42005808 constant SAI2_SAI_ACR2  \ offset: 0x08 : SAI configuration register 2
$4200580c constant SAI2_SAI_AFRCR  \ offset: 0x0C : SAI frame configuration register
$42005810 constant SAI2_SAI_ASLOTR  \ offset: 0x10 : SAI slot register
$42005814 constant SAI2_SAI_AIM   \ offset: 0x14 : SAI interrupt mask register
$42005818 constant SAI2_SAI_ASR   \ offset: 0x18 : SAI status register
$4200581c constant SAI2_SAI_ACLRFR  \ offset: 0x1C : SAI clear flag register
$42005820 constant SAI2_SAI_ADR   \ offset: 0x20 : SAI data register
$42005824 constant SAI2_SAI_BCR1  \ offset: 0x24 : SAI configuration register 1
$42005828 constant SAI2_SAI_BCR2  \ offset: 0x28 : SAI configuration register 2
$4200582c constant SAI2_SAI_BFRCR  \ offset: 0x2C : SAI frame configuration register
$42005830 constant SAI2_SAI_BSLOTR  \ offset: 0x30 : SAI slot register
$42005834 constant SAI2_SAI_BIM   \ offset: 0x34 : SAI interrupt mask register
$42005838 constant SAI2_SAI_BSR   \ offset: 0x38 : SAI status register
$4200583c constant SAI2_SAI_BCLRFR  \ offset: 0x3C : SAI clear flag register
$42005840 constant SAI2_SAI_BDR   \ offset: 0x40 : SAI data register
$42005844 constant SAI2_SAI_PDMCR  \ offset: 0x44 : SAI PDM control register
$42005848 constant SAI2_SAI_PDMDLY  \ offset: 0x48 : SAI PDM delay register
