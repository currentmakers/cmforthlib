...
$00000300 constant TIM16_TIM16_CR1_CKD                              \ Clock division This bit-field indicates the division ratio between the timer clock (tim_ker_ck) frequency and the dead-time and sampling clock (t<sub>DTS</sub>)used by the dead-time generators and the digital filters (tim_tix),
...
$00000003 constant TIM16_TIM16_CCMR1_OUTPUT_CC1S                    \ Capture/Compare 1 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC1S bits are writable only when the channel is OFF (CC1E = 0 in TIM15_CCER).
...
$00000008 constant TIM16_TIM16_CCMR1_OUTPUT_OC1PE                   \ Output Compare 1 preload enable Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S=00 (the channel is configured in output).
$00000070 constant TIM16_TIM16_CCMR1_OUTPUT_OC1M                    \ OC1M[2:0]: Output compare 1 mode These bits define the behavior of the output reference signal tim_oc1ref from which tim_oc1 and tim_oc1n are derived. tim_oc1ref is active high whereas tim_oc1 and tim_oc1n active level depends on CC1P and CC1NP bits. Note: These bits can not be modified as long as LOCK level 3 has been programmed (LOCK bits in TIM15_BDTR register) and CC1S=00 (the channel is configured in output). Note: In PWM mode, the tim_ocxref level changes only when the result of the comparison changes or when the output compare mode switches from frozen mode to PWM mode. Note: On channels that have a complementary output, this bit field is preloaded. If the CCPC bit is set in the TIM15_CR2 register then the OC1M active bits take the new value from the preloaded bits only when a COM event is generated.
$00000080 constant TIM16_TIM16_CCMR1_OUTPUT_OC1CE                   \ Output compare 1 clear enable
$00000300 constant TIM16_TIM16_CCMR1_OUTPUT_CC2S                    \ Capture/Compare 2 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC2S bits are writable only when the channel is OFF (CC2E = 0 in TIM15_CCER).
$00000400 constant TIM16_TIM16_CCMR1_OUTPUT_OC2FE                   \ Output compare 2 fast enable
$00000800 constant TIM16_TIM16_CCMR1_OUTPUT_OC2PE                   \ Output compare 2 preload enable
$00007000 constant TIM16_TIM16_CCMR1_OUTPUT_OC2M                    \ OC2M[2:0]: Output compare 2 mode
$00008000 constant TIM16_TIM16_CCMR1_OUTPUT_OC2CE                   \ Output compare 2 clear enable
$00010000 constant TIM16_TIM16_CCMR1_OUTPUT_OC1M_1                  \ OC1M[3]
$01000000 constant TIM16_TIM16_CCMR1_OUTPUT_OC2M_1                  \ OC2M[3]
...
$00000001 constant TIM16_TIM16_CCER_CC1E                            \ Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 680 for details.
...
$00001000 constant TIM16_TIM16_BDTR_BKE                             \ Break enable 1; Break inputs (tim_brk and tim_sys_brk event) enabled Note: This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
...
$0000000f constant TIM16_TIM16_TISEL_TI1SEL                         \ selects tim_ti1_in[15:0] input ... Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for interconnects list.
...
$00000001 constant TIM16_TIM16_AF1_BKINE                            \ TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timers tim_brk input. TIMx_BKIN input is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000002 constant TIM16_TIM16_AF1_BKCMP1E                          \ tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timers tim_brk input. tim_brk_cmp1 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000004 constant TIM16_TIM16_AF1_BKCMP2E                          \ tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timers tim_brk input. tim_brk_cmp2 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000008 constant TIM16_TIM16_AF1_BKCMP3E                          \ tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timers tim_brk input. tim_brk_cmp3 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000010 constant TIM16_TIM16_AF1_BKCMP4E                          \ tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timers tim_brk input. tim_brk_cmp4 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000020 constant TIM16_TIM16_AF1_BKCMP5E                          \ tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timers tim_brk input. tim_brk_cmp5 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000040 constant TIM16_TIM16_AF1_BKCMP6E                          \ tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timers tim_brk input. tim_brk_cmp6 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000080 constant TIM16_TIM16_AF1_BKCMP7E                          \ tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timers tim_brk input. tim_brk_cmp7 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
$00000100 constant TIM16_TIM16_AF1_BKCMP8E                          \ tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. mdf_brkx output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
$00070000 constant TIM16_TIM16_AF2_OCRSEL                           \ tim_ocref_clr source selection These bits select the tim_ocref_clr input source. Refer to Section 68.4.2: TIM15/TIM16/TIM17 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
...
\ @brief General purpose timers
\
$42004400 constant TIM16_TIM16_CR1  \ offset: 0x00 : TIM16 control register 1
$42004404 constant TIM16_TIM16_CR2  \ offset: 0x04 : TIM16 control register 2
$4200440c constant TIM16_TIM16_DIER  \ offset: 0x0C : TIM16 DMA/interrupt enable register
$42004410 constant TIM16_TIM16_SR  \ offset: 0x10 : TIM16 status register
$42004414 constant TIM16_TIM16_EGR  \ offset: 0x14 : TIM16 event generation register
$42004418 constant TIM16_TIM16_CCMR1_INPUT  \ offset: 0x18 : TIM16 capture/compare mode register 1
$42004418 constant TIM16_TIM16_CCMR1_OUTPUT  \ offset: 0x18 : TIM16 capture/compare mode register 1 [alternate]
$42004420 constant TIM16_TIM16_CCER  \ offset: 0x20 : TIM16 capture/compare enable register
$42004424 constant TIM16_TIM16_CNT  \ offset: 0x24 : TIM16 counter
$42004428 constant TIM16_TIM16_PSC  \ offset: 0x28 : TIM16 prescaler
$4200442c constant TIM16_TIM16_ARR  \ offset: 0x2C : TIM16 auto-reload register
$42004430 constant TIM16_TIM16_RCR  \ offset: 0x30 : TIM16 repetition counter register
$42004434 constant TIM16_TIM16_CCR1  \ offset: 0x34 : TIM16 capture/compare register 1
$42004444 constant TIM16_TIM16_BDTR  \ offset: 0x44 : TIM16 break and dead-time register
$42004454 constant TIM16_TIM16_DTR2  \ offset: 0x54 : TIM16 timer deadtime register 2
$4200445c constant TIM16_TIM16_TISEL  \ offset: 0x5C : TIM16 input selection register
$42004460 constant TIM16_TIM16_AF1  \ offset: 0x60 : TIM16 alternate function register 1
$42004464 constant TIM16_TIM16_AF2  \ offset: 0x64 : TIM16 alternate function register 2
$420047dc constant TIM16_TIM16_DCR  \ offset: 0x3DC : TIM16 DMA control register
$420047e0 constant TIM16_TIM16_DMAR  \ offset: 0x3E0 : TIM16/TIM17 DMA address for full transfer
