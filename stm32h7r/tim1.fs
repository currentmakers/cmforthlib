...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_TIM1_ECR_DEF
    ...
    $03 constant TIM1_IBLK                      \ [0x03 : 2] Index blanking This bit indicates if the Index event is conditioned by the tim_ti3 or tim_ti4 input
  ...
  [ifdef] TIM1_TIM1_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_TI1SEL                    \ [0x00 : 4] Selects tim_ti1[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list.
    $08 constant TIM1_TI2SEL                    \ [0x08 : 4] Selects tim_ti2[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list.
    $10 constant TIM1_TI3SEL                    \ [0x10 : 4] Selects tim_ti3[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list.
    $18 constant TIM1_TI4SEL                    \ [0x18 : 4] Selects tim_ti4[15:0] input ... Refer to Section 64.3.2: TIM1 pins and internal signals for interconnects list.
  [then]
  ...
  [ifdef] TIM1_TIM1_AF1_DEF
    ...
    \
    $00 constant TIM1_BKINE                     \ [0x00] TIMx_BKIN input enable This bit enables the TIMx_BKIN alternate function input for the timers tim_brk input. TIMx_BKIN input is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM1_BKCMP1E                   \ [0x01] tim_brk_cmp1 enable This bit enables the tim_brk_cmp1 for the timers tim_brk input. tim_brk_cmp1 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM1_BKCMP2E                   \ [0x02] tim_brk_cmp2 enable This bit enables the tim_brk_cmp2 for the timers tim_brk input. tim_brk_cmp2 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $03 constant TIM1_BKCMP3E                   \ [0x03] tim_brk_cmp3 enable This bit enables the tim_brk_cmp3 for the timers tim_brk input. tim_brk_cmp3 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $04 constant TIM1_BKCMP4E                   \ [0x04] tim_brk_cmp4 enable This bit enables the tim_brk_cmp4 for the timers tim_brk input. tim_brk_cmp4 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $05 constant TIM1_BKCMP5E                   \ [0x05] tim_brk_cmp5 enable This bit enables the tim_brk_cmp5 for the timers tim_brk input. tim_brk_cmp5 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $06 constant TIM1_BKCMP6E                   \ [0x06] tim_brk_cmp6 enable This bit enables the tim_brk_cmp6 for the timers tim_brk input. tim_brk_cmp6 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $07 constant TIM1_BKCMP7E                   \ [0x07] tim_brk_cmp7 enable This bit enables the tim_brk_cmp7 for the timers tim_brk input. tim_brk_cmp7 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $08 constant TIM1_BKCMP8E                   \ [0x08] tim_brk_cmp8 enable This bit enables the tim_brk_cmp8 for the timers tim_brk input. tim_brk_cmp8 output is ORed with the other tim_brk sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    ...
    $0e constant TIM1_ETRSEL                    \ [0x0e : 4] etr_in source selection These bits select the etr_in input source. ... Refer to Section 64.3.2: TIM1 pins and internal signals for product specific implementation. Note: These bits can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]
  ...
  [ifdef] TIM1_TIM1_AF2_DEF
    ...
    \ Reset value: 0x00000001
    \
    $00 constant TIM1_BK2INE                    \ [0x00] TIMx_BKIN2 input enable This bit enables the TIMx_BKIN2 alternate function input for the timers tim_brk2 input. TIMx_BKIN2 input is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM1_BK2CMP1E                  \ [0x01] tim_brk2_cmp1 enable This bit enables the tim_brk2_cmp1 for the timers tim_brk2 input. tim_brk2_cmp1 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM1_BK2CMP2E                  \ [0x02] tim_brk2_cmp2 enable This bit enables the tim_brk2_cmp2 for the timers tim_brk2 input. tim_brk2_cmp2 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $03 constant TIM1_BK2CMP3E                  \ [0x03] tim_brk2_cmp3 enable This bit enables the tim_brk2_cmp3 for the timers tim_brk2 input. tim_brk2_cmp3 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $04 constant TIM1_BK2CMP4E                  \ [0x04] tim_brk2_cmp4 enable This bit enables the tim_brk2_cmp4 for the timers tim_brk2 input. tim_brk2_cmp4 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $05 constant TIM1_BK2CMP5E                  \ [0x05] tim_brk2_cmp5 enable This bit enables the tim_brk2_cmp5 for the timers tim_brk2 input. tim_brk2_cmp5 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $06 constant TIM1_BK2CMP6E                  \ [0x06] tim_brk2_cmp6 enable This bit enables the tim_brk2_cmp6 for the timers tim_brk2 input. tim_brk2_cmp6 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $07 constant TIM1_BK2CMP7E                  \ [0x07] tim_brk2_cmp7 enable This bit enables the tim_brk2_cmp7 for the timers tim_brk2 input. tim_brk2_cmp7 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $08 constant TIM1_BK2CMP8E                  \ [0x08] tim_brk2_cmp8 enable This bit enables the tim_brk2_cmp8 for the timers tim_brk2 input. tim_brk2_cmp8 output is ORed with the other tim_brk2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  $18 constant TIM1_TIM1_CCMR1_INPUT    \ TIM1 capture/compare mode register 1
  $18 constant TIM1_TIM1_CCMR1_OUTPUT   \ TIM1 capture/compare mode register 1
  $1C constant TIM1_TIM1_CCMR2_INPUT    \ TIM1 capture/compare mode register 2
  $1C constant TIM1_TIM1_CCMR2_OUTPUT   \ TIM1 capture/compare mode register 2
