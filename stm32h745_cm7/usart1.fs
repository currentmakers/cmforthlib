...
[ifndef] USART1_DEF
  ...
  [ifdef] USART1_CR2_DEF
    ...
    $03 constant USART1_DIS_NSS                 \ [0x03] When the DSI_NSS bit is set, the NSS pin input is ignored
  ...
  [ifdef] USART1_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART1_BRR_0_3                 \ [0x00 : 4] DIV_Fraction
    $04 constant USART1_BRR_4_15                \ [0x04 : 12] DIV_Mantissa
  [then]
  ...
  [ifdef] USART1_ICR_DEF
    ...
    $07 constant USART1_TCBGTC                  \ [0x07] Transmission complete before Guard time clear flag
