...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_PLLSAI2CFGR_DEF
    ...
    $14 constant RCC_PLLSAI2QEN                 \ [0x14] PLLSAI2 division factor for PLLDISCLK
    $15 constant RCC_PLLSAI2Q                   \ [0x15 : 2] SAI2PLL PLLSAI2CLK output enable
  ...
  [ifdef] RCC_AHB1RSTR_DEF
    ...
    $12 constant RCC_GFXMMURST                  \ [0x12] GFXMMU reset
  [then]
  ...
  [ifdef] RCC_AHB2RSTR_DEF
    ...
    $14 constant RCC_OSPIMRST                   \ [0x14] OCTOSPI IO manager reset
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    $09 constant RCC_OSPI2RST                   \ [0x09] OctOSPI2 memory interface reset
  [then]
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $1a constant RCC_LTDCRST                    \ [0x1a] LCD-TFT reset
    $1b constant RCC_DSIRST                     \ [0x1b] DSI reset
  [then]
  ...
  [ifdef] RCC_AHB1ENR_DEF
    ...
    $12 constant RCC_GFXMMUEN                   \ [0x12] Graphic MMU clock enable
  [then]
  ...
  [ifdef] RCC_AHB2ENR_DEF
    ...
    $14 constant RCC_OSPIMEN                    \ [0x14] OctoSPI IO manager clock enable
  ...
  [ifdef] RCC_AHB3ENR_DEF
    ...
    $09 constant RCC_OSPI2EN                    \ [0x09] OSPI2EN memory interface clock enable
  [then]
  ...
  [ifdef] RCC_APB2ENR_DEF
    ...
    $07 constant RCC_FWEN                       \ [0x07] Firewall clock enable
    ...
    $1a constant RCC_LTDCEN                     \ [0x1a] LCD-TFT clock enable
    $1b constant RCC_DSIEN                      \ [0x1b] DSI clock enable
  [then]
  ...
  [ifdef] RCC_AHB1SMENR_DEF
    ...
    $12 constant RCC_GFXMMUSMEN                 \ [0x12] GFXMMU clock enable during Sleep and Stop modes
  [then]
  ...
  [ifdef] RCC_AHB2SMENR_DEF
    ...
    $0a constant RCC_SRAM3SMEN                  \ [0x0a] SRAM2 interface clocks enable during Sleep and Stop modes
    ...
    $14 constant RCC_OSPIMSMEN                  \ [0x14] OctoSPI IO manager clocks enable during Sleep and Stop modes
  ...
  [ifdef] RCC_AHB3SMENR_DEF
    ...
    $09 constant RCC_OCTOSPI2                   \ [0x09] OctoSPI2 memory interface clocks enable during Sleep and Stop modes
  [then]
  ...
  [ifdef] RCC_APB2SMENR_DEF
    ...
    $1a constant RCC_LTDCSMEN                   \ [0x1a] LCD-TFT timer clocks enable during Sleep and Stop modes
    $1b constant RCC_DSISMEN                    \ [0x1b] DSI clocks enable during Sleep and Stop modes
  [then]
  ...
  [ifdef] RCC_CCIPR2_DEF
    ...
    $0c constant RCC_DSISEL                     \ [0x0c] clock selection
    $0e constant RCC_SDMMCSEL                   \ [0x0e] SDMMC clock selection
    $10 constant RCC_PLLSAI2DIVR                \ [0x10 : 2] division factor for LTDC clock
