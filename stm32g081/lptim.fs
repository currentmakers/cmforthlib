...
[ifndef] LPTIM_DEF
  ...
  [ifdef] LPTIM_CR_DEF
    ...
    $03 constant LPTIM_COUNTRST                 \ [0x03] Counter reset
    $04 constant LPTIM_RSTARE                   \ [0x04] Reset after read enable
  [then]
  ...
  [ifdef] LPTIM_CFGR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LPTIM_IN1SEL                   \ [0x00 : 2] LPTIMx Input 1 selection
    $04 constant LPTIM_IN2SEL                   \ [0x04 : 2] LPTIM1 Input 2 selection
  [then]
  ...
  $24 constant LPTIM_CFGR2              \ LPTIM configuration register 2
