...
[ifndef] AES_DEF
  ...
  [ifdef] AES_CR_DEF
    ...
    $05 constant AES_CHMOD10                    \ [0x05 : 2] AES chaining mode Bit1 Bit0
    ...
    $0d constant AES_GCMPH                      \ [0x0d : 2] Used only for GCM, CCM and GMAC algorithms and has no effect when other algorithms are selected
    $10 constant AES_CHMOD2                     \ [0x10] AES chaining mode Bit2
    $12 constant AES_KEYSIZE                    \ [0x12] Key size selection
    $14 constant AES_NPBLB                      \ [0x14 : 4] Number of padding bytes in last block of payload
  [then]
  ...
  [ifdef] AES_SR_DEF
    ...
    $03 constant AES_BUSY                       \ [0x03] Busy flag
  [then]
  ...
  [ifdef] AES_KEYR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_KEYR4                  \ [0x00 : 32] AES key register (MSB key [159:128])
  [then]
  ...
  [ifdef] AES_KEYR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_KEYR5                  \ [0x00 : 32] AES key register (MSB key [191:160])
  [then]
  ...
  [ifdef] AES_KEYR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_KEYR6                  \ [0x00 : 32] AES key register (MSB key [223:192])
  [then]
  ...
  [ifdef] AES_KEYR7_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_KEYR7                  \ [0x00 : 32] AES key register (MSB key [255:224])
  [then]
  ...
  [ifdef] AES_SUSP0R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP0R                 \ [0x00 : 32] AES suspend register 0
  [then]
  ...
  [ifdef] AES_SUSP1R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP1R                 \ [0x00 : 32] AES suspend register 1
  [then]
  ...
  [ifdef] AES_SUSP2R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP2R                 \ [0x00 : 32] AES suspend register 2
  [then]
  ...
  [ifdef] AES_SUSP3R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP3R                 \ [0x00 : 32] AES suspend register 3
  [then]
  ...
  [ifdef] AES_SUSP4R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP4R                 \ [0x00 : 32] AES suspend register 4
  [then]
  ...
  [ifdef] AES_SUSP5R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP5R                 \ [0x00 : 32] AES suspend register 5
  [then]
  ...
  [ifdef] AES_SUSP6R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP6R                 \ [0x00 : 32] AES suspend register 6
  [then]
  ...
  [ifdef] AES_SUSP7R_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant AES_AES_SUSP7R                 \ [0x00 : 32] AES suspend register 7
  [then]
  ...
  [ifdef] AES_HWCFR_DEF
    ...
    \
    $00 constant AES_CFG1                       \ [0x00 : 4] HW Generic 1
    $04 constant AES_CFG2                       \ [0x04 : 4] HW Generic 2
    $08 constant AES_CFG3                       \ [0x08 : 4] HW Generic 3
    $0c constant AES_CFG4                       \ [0x0c : 4] HW Generic 4
  [then]
  ...
  [ifdef] AES_VERR_DEF
    ...
    \
    $00 constant AES_MINREV                     \ [0x00 : 4] Minor revision
    $04 constant AES_MAJREV                     \ [0x04 : 4] Major revision
  [then]
  ...
  [ifdef] AES_IPIDR_DEF
    ...
    \
    $00 constant AES_ID                         \ [0x00 : 32] Identification code
  [then]
  ...
  [ifdef] AES_SIDR_DEF
    ...
    \ Reset value: 0x00170023
    \
    $00 constant AES_ID                         \ [0x00 : 32] Size Identification code
  [then]
  ...
  $40 constant AES_SUSP0R               \ AES suspend register 0
  $44 constant AES_SUSP1R               \ AES suspend register 1
  $48 constant AES_SUSP2R               \ AES suspend register 2
  $4C constant AES_SUSP3R               \ AES suspend register 3
  $50 constant AES_SUSP4R               \ AES suspend register 4
  $54 constant AES_SUSP5R               \ AES suspend register 5
  $58 constant AES_SUSP6R               \ AES suspend register 6
  $5C constant AES_SUSP7R               \ AES suspend register 7
  $3F0 constant AES_HWCFR               \ AES hardware configuration register
  $3F4 constant AES_VERR                \ AES version register
  $3F8 constant AES_IPIDR               \ AES identification register
  $3FC constant AES_SIDR                \ AES size ID register
