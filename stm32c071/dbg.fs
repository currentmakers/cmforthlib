...
$00000fff constant DBG_DBG_IDCODE_DEV_ID                            \ Device identifier This field indicates the device ID. Refer to Table 152.
$ffff0000 constant DBG_DBG_IDCODE_REV_ID                            \ Revision identifier This field indicates the revision of the device. Refer to Table 152.
...
$00000001 constant DBG_DBG_APB_FZ1_DBG_TIM2_STOP                    \ Clocking of TIM2 counter when the core is halted This bit enables/disables the clock to the counter of TIM2 when the core is halted: This bit is only available on STM32C071xx. On the other devices, it is reserved.
