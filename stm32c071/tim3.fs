...
$00000007 constant TIM3_TIM3_SMCR_SMS                               \ SMS[2:0]: Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. reinitializes the counter, generates an update of the registers and starts the counter. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=00100). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$00000008 constant TIM3_TIM3_SMCR_OCCS                              \ OCREF clear selection This bit is used to select the OCREF clear source
$00000070 constant TIM3_TIM3_SMCR_TS                                \ TS[2:0]: Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See Table 77: TIM3 internal trigger connection on page 478 for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00007000 constant TIM3_TIM3_CCMR1_ALTERNATE1_OC2M                  \ OC2M[2:0]: Output compare 2 mode refer to OC1M description on bits 6:4
...
$00000003 constant TIM3_TIM3_CCMR2_ALTERNATE1_CC3S                  \ Capture/Compare 3 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC3S bits are writable only when the channel is OFF (CC3E = 0 in TIMx_CCER).
...
$00000070 constant TIM3_TIM3_CCMR2_ALTERNATE1_OC3M                  \ OC3M[2:0]: Output compare 3 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
$00000080 constant TIM3_TIM3_CCMR2_ALTERNATE1_OC3CE                 \ Output compare 3 clear enable
$00000300 constant TIM3_TIM3_CCMR2_ALTERNATE1_CC4S                  \ Capture/Compare 4 selection This bit-field defines the direction of the channel (input/output) as well as the used input. Note: CC4S bits are writable only when the channel is OFF (CC4E = 0 in TIMx_CCER).
...
$00007000 constant TIM3_TIM3_CCMR2_ALTERNATE1_OC4M                  \ OC4M[2:0]: Output compare 4 mode Refer to OC1M description (bits 6:4 in TIMx_CCMR1 register)
...
$00000000 constant TIM3_TIM3_CNT_CNT                                \ counter value
...
$7fffffff constant TIM3_TIM3_CNT_ALTERNATE1_CNT                     \ counter value
$80000000 constant TIM3_TIM3_CNT_ALTERNATE1_UIFCPY                  \ UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register
...
$00000000 constant TIM3_TIM3_ARR_ARR                                \ Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 18.3.1: Time-base unit on page 429 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
