...
$00000040 constant I2C1_I2C_CR1_TCIE                                \ Transfer complete interrupt enable Note: Any of these events generates an interrupt: Note: Transfer complete (TC) Note: Transfer complete reload (TCR)
$00000080 constant I2C1_I2C_CR1_ERRIE                               \ Error interrupts enable Note: Any of these errors generates an interrupt: Note: Arbitration loss (ARLO) Note: Bus error detection (BERR) Note: Overrun/underrun (OVR) Note: Timeout detection (TIMEOUT) Note: PEC error detection (PECERR) Note: Alert pin event detection (ALERT)
...
$00040000 constant I2C1_I2C_CR1_WUPEN                               \ Wake-up from Stop mode enable Note: If the wake-up from Stop mode feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3. Note: WUPEN can be set only when DNF = 0000.
$00080000 constant I2C1_I2C_CR1_GCEN                                \ General call enable
$00100000 constant I2C1_I2C_CR1_SMBHEN                              \ SMBus host address enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
$00200000 constant I2C1_I2C_CR1_SMBDEN                              \ SMBus device default address enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
$00400000 constant I2C1_I2C_CR1_ALERTEN                             \ SMBus alert enable Note: When ALERTEN = 0, the SMBA pin can be used as a standard GPIO. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
$00800000 constant I2C1_I2C_CR1_PECEN                               \ PEC enable Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
...
$00000800 constant I2C1_I2C_ICR_PECCF                               \ PEC error flag clear Writing 1 to this bit clears the PECERR flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
$00001000 constant I2C1_I2C_ICR_TIMOUTCF                            \ Timeout detection flag clear Writing 1 to this bit clears the TIMEOUT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
$00002000 constant I2C1_I2C_ICR_ALERTCF                             \ Alert flag clear Note: Writing 1 to this bit clears the ALERT flag in the I2C_ISR register. Note: If the SMBus feature is not supported, this bit is reserved and forced by hardware to 0. Refer to Section 25.3.
