...
$00000007 constant TIM1_TIM1_SMCR_SMS                               \ SMS[2:0]: Slave mode selection When external signals are selected the active edge of the trigger signal (TRGI) is linked to the polarity selected on the external input (see Input Control register and Control Register description. Codes above 1000: Reserved. Note: The gated mode must not be used if TI1F_ED is selected as the trigger input (TS=00100). Indeed, TI1F_ED outputs 1 pulse for each transition on TI1F, whereas the gated mode checks the level of the trigger signal. Note: The clock of the slave peripherals (timer, ADC, ...) receiving the TRGO or the TRGO2 signals must be enabled prior to receive events from the master timer, and the clock frequency (prescaler) must not be changed on-the-fly while triggers are received from the master timer.
$00000008 constant TIM1_TIM1_SMCR_OCCS                              \ OCREF clear selection This bit is used to select the OCREF clear source.
$00000070 constant TIM1_TIM1_SMCR_TS                                \ TS[2:0]: Trigger selection This bit-field selects the trigger input to be used to synchronize the counter. Others: Reserved See Table 73: TIM1 internal trigger connection on page 395 for more details on ITRx meaning for each Timer. Note: These bits must be changed only when they are not used (e.g. when SMS=000) to avoid wrong edge detections at the transition.
...
$00000004 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3FE                 \ Output compare 3 fast enable Refer to OC1FE description.
$00000008 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3PE                 \ Output compare 3 preload enable Refer to OC1PE description.
$00000070 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3M                  \ OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description.
$00000080 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC3CE                 \ Output compare 3 clear enable Refer to OC1CE description.
...
$00000400 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4FE                 \ Output compare 4 fast enable Refer to OC1FE description.
$00000800 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4PE                 \ Output compare 4 preload enable Refer to OC1PE description.
$00007000 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4M                  \ OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description.
$00008000 constant TIM1_TIM1_CCMR2_ALTERNATE1_OC4CE                 \ Output compare 4 clear enable Refer to OC1CE description.
...
$0000ffff constant TIM1_TIM1_ARR_ARR                                \ Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 17.3.1: Time-base unit on page 331 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$00000070 constant TIM1_TIM1_CCMR3_OC5M                             \ OC5M[2:0]: Output compare 5 mode Refer to OC1M description.
...
$00007000 constant TIM1_TIM1_CCMR3_OC6M                             \ OC6M[2:0]: Output compare 6 mode Refer to OC1M description.
...
$40012c1c constant TIM1_TIM1_CCMR2_ALTERNATE1  \ offset: 0x1C : TIM1 capture/compare mode register 2
