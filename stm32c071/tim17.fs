...
[ifndef] TIM17_DEF
  ...
  [ifdef] TIM17_TIM17_CCMR1_ALTERNATE1_DEF
    \
    \ @brief TIM17 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM17_TIM17_CCER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM17_CC1E                     \ [0x00] Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 83 for details.
  ...
  [ifdef] TIM17_TIM17_ARR_DEF
    ...
    \
    $00 constant TIM17_ARR                      \ [0x00 : 16] Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 20.3.1: Time-base unit on page 526 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  $18 constant TIM17_TIM17_CCMR1_ALTERNATE1    \ TIM17 capture/compare mode register 1
