...
[ifndef] TIM14_DEF
  ...
  [ifdef] TIM14_TIM14_CCMR1_ALTERNATE1_DEF
    \
    \ @brief TIM14 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM14_TIM14_ARR_DEF
    ...
    \
    $00 constant TIM14_ARR                      \ [0x00 : 16] Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to Section 19.3.1: Time-base unit on page 517 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  $18 constant TIM14_TIM14_CCMR1        \ TIM14 capture/compare mode register 1
  $18 constant TIM14_TIM14_CCMR1_ALTERNATE1    \ TIM14 capture/compare mode register 1
