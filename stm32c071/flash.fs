...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_FLASH_CR_DEF
    ...
    $03 constant FLASH_PNB                      \ [0x03 : 6] Page number selection These bits select the page to erase: ... Note: Values corresponding to addresses outside the Main memory are not allowed. See Table 6 and Table 7.
  ...
  [ifdef] FLASH_FLASH_SECR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_SEC_SIZE                 \ [0x00 : 6] Securable memory area size Contains the number of securable flash memory pages. Note: The number of effective bits depends on the size of the flash memory in the device.
