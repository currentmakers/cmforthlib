...
[ifndef] UART4_DEF
  ...
  [ifdef] UART4_SR_DEF
    ...
    $02 constant UART4_NF                       \ [0x02] Noise detected flag
  ...
  [ifdef] UART4_DR_DEF
    ...
    \
    $00 constant UART4_DR                       \ [0x00 : 9] Data value
  [then]
  ...
  [ifdef] UART4_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant UART4_DIV_Fraction             \ [0x00 : 4] fraction of USARTDIV
    $04 constant UART4_DIV_Mantissa             \ [0x04 : 12] mantissa of USARTDIV
  [then]
  ...
  \ @brief Universal synchronous asynchronous receiver transmitter
  \
  $00 constant UART4_SR                 \ Status register
  $04 constant UART4_DR                 \ Data register
  $08 constant UART4_BRR                \ Baud rate register
  $0C constant UART4_CR1                \ Control register 1
  $10 constant UART4_CR2                \ Control register 2
  $14 constant UART4_CR3                \ Control register 3
