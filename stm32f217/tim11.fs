...
$00000003 constant TIM11_OR_RMP                                     \ Input 1 remapping capability
...
$40014818 constant TIM11_CCMR1_OUTPUT  \ offset: 0x18 : capture/compare mode register (output mode)
$40014818 constant TIM11_CCMR1_INPUT  \ offset: 0x18 : capture/compare mode register (input mode)
