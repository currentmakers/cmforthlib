...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CFGR_DEF
    ...
    $04 constant RCC_HPRE0                      \ [0x04] AHB prescaler
    $05 constant RCC_HPRE1                      \ [0x05] AHB prescaler
    $06 constant RCC_HPRE2                      \ [0x06] AHB prescaler
    $07 constant RCC_HPRE3                      \ [0x07] AHB prescaler
    $0a constant RCC_PPRE10                     \ [0x0a] APB Low speed prescaler (APB1)
    $0b constant RCC_PPRE11                     \ [0x0b] APB Low speed prescaler (APB1)
    $0c constant RCC_PPRE12                     \ [0x0c] APB Low speed prescaler (APB1)
    $0d constant RCC_PPRE20                     \ [0x0d] APB high-speed prescaler (APB2)
    $0e constant RCC_PPRE21                     \ [0x0e] APB high-speed prescaler (APB2)
    $0f constant RCC_PPRE22                     \ [0x0f] APB high-speed prescaler (APB2)
    $10 constant RCC_RTCPRE0                    \ [0x10] HSE division factor for RTC clock
    $11 constant RCC_RTCPRE1                    \ [0x11] HSE division factor for RTC clock
    $12 constant RCC_RTCPRE2                    \ [0x12] HSE division factor for RTC clock
    $13 constant RCC_RTCPRE3                    \ [0x13] HSE division factor for RTC clock
    $14 constant RCC_RTCPRE4                    \ [0x14] HSE division factor for RTC clock
    $15 constant RCC_MCO10                      \ [0x15] Microcontroller clock output 1
    $16 constant RCC_MCO11                      \ [0x16] Microcontroller clock output 1
    $17 constant RCC_I2SSRC                     \ [0x17] I2S clock selection
    $18 constant RCC_MCO1PRE0                   \ [0x18] MCO1 prescaler
    $19 constant RCC_MCO1PRE1                   \ [0x19] MCO1 prescaler
    $1a constant RCC_MCO1PRE2                   \ [0x1a] MCO1 prescaler
    $1b constant RCC_MCO2PRE0                   \ [0x1b] MCO2 prescaler
    $1c constant RCC_MCO2PRE1                   \ [0x1c] MCO2 prescaler
    $1d constant RCC_MCO2PRE2                   \ [0x1d] MCO2 prescaler
    $1e constant RCC_MCO20                      \ [0x1e] Microcontroller clock output 2
    $1f constant RCC_MCO21                      \ [0x1f] Microcontroller clock output 2
  [then]
  ...
  [ifdef] RCC_AHB3RSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_FSMCRST                    \ [0x00] Flexible static memory controller module reset
  [then]
  ...
  [ifdef] RCC_AHB3ENR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_FSMCEN                     \ [0x00] Flexible static memory controller module clock enable
  [then]
  ...
  [ifdef] RCC_AHB3LPENR_DEF
    ...
    \
    $00 constant RCC_FSMCLPEN                   \ [0x00] Flexible static memory controller module clock enable during Sleep mode
  [then]
  ...
  [ifdef] RCC_PLLI2SCFGR_DEF
    ...
    \
    $06 constant RCC_PLLI2SN0                   \ [0x06] PLLI2S multiplication factor for VCO
    $07 constant RCC_PLLI2SN1                   \ [0x07] PLLI2S multiplication factor for VCO
    $08 constant RCC_PLLI2SN2                   \ [0x08] PLLI2S multiplication factor for VCO
    $09 constant RCC_PLLI2SN3                   \ [0x09] PLLI2S multiplication factor for VCO
    $0a constant RCC_PLLI2SN4                   \ [0x0a] PLLI2S multiplication factor for VCO
    $0b constant RCC_PLLI2SN5                   \ [0x0b] PLLI2S multiplication factor for VCO
    $0c constant RCC_PLLI2SN6                   \ [0x0c] PLLI2S multiplication factor for VCO
    $0d constant RCC_PLLI2SN7                   \ [0x0d] PLLI2S multiplication factor for VCO
    $0e constant RCC_PLLI2SN8                   \ [0x0e] PLLI2S multiplication factor for VCO
    $1c constant RCC_PLLI2SR0                   \ [0x1c] PLLI2S division factor for I2S clocks
    $1d constant RCC_PLLI2SR1                   \ [0x1d] PLLI2S division factor for I2S clocks
    $1e constant RCC_PLLI2SR2                   \ [0x1e] PLLI2S division factor for I2S clocks
  [then]
