...
[ifndef] ETHERNET_MMC_DEF
  ...
  [ifdef] ETHERNET_MMC_MMCCR_DEF
    ...
    $03 constant ETHERNET_MMC_MCF               \ [0x03] MMC counter freeze
    $04 constant ETHERNET_MMC_MCP               \ [0x04] MMC counter preset
    $05 constant ETHERNET_MMC_MCFHP             \ [0x05] MMC counter Full-Half preset
  [then]
  ...
  [ifdef] ETHERNET_MMC_MMCTGFSCCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MMC_TGFSCC            \ [0x00 : 32] Transmitted good frames single collision counter
  [then]
  ...
  [ifdef] ETHERNET_MMC_MMCTGFMSCCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MMC_TGFMSCC           \ [0x00 : 32] Transmitted good frames more single collision counter
  [then]
  ...
  [ifdef] ETHERNET_MMC_MMCRFCECR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MMC_RFCFC             \ [0x00 : 32] Received frames CRC error counter
  [then]
  ...
  [ifdef] ETHERNET_MMC_MMCRFAECR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ETHERNET_MMC_RFAEC             \ [0x00 : 32] Received frames alignment error counter
  [then]
