...
[ifndef] USART_DEF
  ...
  [ifdef] USART_CR1_DEF
    ...
    $14 constant USART_DEDT4                    \ [0x14] Driver Enable de-assertion time
    ...
    $1c constant USART_M1                       \ [0x1c] M1
    $1d constant USART_FIFOEN                   \ [0x1d] FIFOEN
    $1e constant USART_TXFEIE                   \ [0x1e] TXFEIE
    $1f constant USART_RXFFIE                   \ [0x1f] RXFFIE
  [then]
  ...
  [ifdef] USART_CR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART_SLVEN                    \ [0x00] SLVEN
  ...
  [ifdef] USART_CR3_DEF
    ...
    $17 constant USART_TXFTIE                   \ [0x17] TXFTIE
    $18 constant USART_TCBGTIE                  \ [0x18] TCBGTIE
    $19 constant USART_RXFTCFG                  \ [0x19 : 3] RXFTCFG
    $1c constant USART_RXFTIE                   \ [0x1c] RXFTIE
    $1d constant USART_TXFTCFG                  \ [0x1d : 3] TXFTCFG
  [then]
  ...
  [ifdef] USART_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART_DIV_Fraction             \ [0x00 : 4] DIV_Fraction
    $04 constant USART_DIV_Mantissa             \ [0x04 : 12] DIV_Mantissa
  [then]
  ...
  [ifdef] USART_ICR_DEF
    ...
    $05 constant USART_TXFECF                   \ [0x05] TXFECF
    $06 constant USART_TCCF                     \ [0x06] Transmission complete clear flag
    $07 constant USART_TCBGTCF                  \ [0x07] TCBGTCF
    ...
    $0d constant USART_UDRCF                    \ [0x0d] UDRCF
  ...
  [ifdef] USART_PRESC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART_PRESCALER                \ [0x00 : 4] PRESCALER
  [then]
  ...
  $2C constant USART_PRESC              \ USART prescaler register
