...
[ifndef] DMA_DEF
  ...
  $70 constant DMA_DMA_CNDTR6           \ DMA channel 6 number of data to transfer register
  $74 constant DMA_DMA_CPAR6            \ DMA channel 6 peripheral address register
  $78 constant DMA_DMA_CMAR6            \ DMA channel 6 memory address register
  $80 constant DMA_DMA_CCR7             \ DMA channel 7 configuration register
  $84 constant DMA_DMA_CNDTR7           \ DMA channel 7 number of data to transfer register
  $88 constant DMA_DMA_CPAR7            \ DMA channel 7 peripheral address register
  $8C constant DMA_DMA_CMAR7            \ DMA channel 7 memory address register
