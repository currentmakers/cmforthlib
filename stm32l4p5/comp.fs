...
[ifndef] COMP_DEF
  ...
  [ifdef] COMP_COMP1_CSR_DEF
    ...
    $07 constant COMP_COMP1_INPSEL              \ [0x07] Comparator1 input plus selection bit
  ...
  [ifdef] COMP_COMP2_CSR_DEF
    ...
    $07 constant COMP_COMP2_INPSEL              \ [0x07] Comparator 2 Input Plus connection configuration bit
