...
$00000010 constant PWR_PWR_CR1_RRSTP                                \ SRAM3 retention in Stop 2 mode
...
$00000001 constant PWR_PWR_CR2_PVDE                                 \ Power voltage detector enable Note: This bit is write-protected when the bit PVDL (PVD Lock) is set in the SYSCFG_CBR register. Note: This bit is reset only by a system reset.
$0000000e constant PWR_PWR_CR2_PLS                                  \ Power voltage detector level selection. These bits select the voltage threshold detected by the power voltage detector: Note: These bits are write-protected when the bit PVDL (PVD Lock) is set in the SYSCFG_CBR register. Note: These bits are reset only by a system reset.
$00000010 constant PWR_PWR_CR2_PVME1                                \ Peripheral voltage monitoring 1 enable: V<sub>DDUSB</sub> vs. 1.2V
$00000020 constant PWR_PWR_CR2_PVME2                                \ Peripheral voltage monitoring 2 enable: V<sub>DDIO2</sub> vs. 0.9V
$00000040 constant PWR_PWR_CR2_PVME3                                \ Peripheral voltage monitoring 3 enable: V<sub>DDA</sub> vs. 1.62V
$00000080 constant PWR_PWR_CR2_PVME4                                \ Peripheral voltage monitoring 4 enable: V<sub>DDA</sub> vs. 2.2V
$00000200 constant PWR_PWR_CR2_IOSV                                 \ V<sub>DDIO2</sub> Independent I/Os supply valid This bit is used to validate the V<sub>DDIO2</sub> supply for electrical and logical isolation purpose. Setting this bit is mandatory to use PG[15:2]. If V<sub>DDIO2</sub> is not always present in the application, the PVM can be used to determine whether this supply is ready or not.
$00000400 constant PWR_PWR_CR2_USV                                  \ V<sub>DDUSB</sub> USB supply valid This bit is used to validate the V<sub>DDUSB</sub> supply for electrical and logical isolation purpose. Setting this bit is mandatory to use the USB OTG_FS peripheral. If V<sub>DDUSB</sub> is not always present in the application, the PVM can be used to determine whether this supply is ready or not.
...
$00000300 constant PWR_PWR_CR3_RRS                                  \ SRAM2 retention in Standby mode For STM32L4Rxxx and STM32L4Sxxx devices bit 9 is reserved For STM32L4P5xx and STM32L4Q5xx devices:
...
$00001000 constant PWR_PWR_CR3_DSIPDEN                              \ Enable Pull-down activation on DSI pins
...
$00002000 constant PWR_PWR_CR4_EXT_SMPS_ON                          \ external SMPS on. This bit informs the internal regulator about external SMPS switch status to decrease regulator output to 0.95 V in Range 2, allowing the external SMPS output down to 1.00 V. Note: This bit is only available on STM32L4P5xx and STM32L4Q5xx devices.
...
$00002000 constant PWR_PWR_SR1_EXT_SMPS_RDY                         \ External SMPS ready This bit informs the state of regulator transition from Range 1 to Range 2 Note: This bit is only available on STM32L4P5xx and STM32L4Q5xx devices.
...
$00000800 constant PWR_PWR_SR2_PVDO                                 \ Power voltage detector output
$00001000 constant PWR_PWR_SR2_PVMO1                                \ Peripheral voltage monitoring output: V<sub>DDUSB</sub> vs. 1.2 V Note: PVMO1 is cleared when PVM1 is disabled (PVME1 = 0). After enabling PVM1, the PVM1 output is valid after the PVM1 wakeup time.
$00002000 constant PWR_PWR_SR2_PVMO2                                \ Peripheral voltage monitoring output: V<sub>DDIO2</sub> vs. 0.9 V Note: PVMO2 is cleared when PVM2 is disabled (PVME2 = 0). After enabling PVM2, the PVM2 output is valid after the PVM2 wakeup time.
$00004000 constant PWR_PWR_SR2_PVMO3                                \ Peripheral voltage monitoring output: V<sub>DDA</sub> vs. 1.62 V Note: PVMO3 is cleared when PVM3 is disabled (PVME3 = 0). After enabling PVM3, the PVM3 output is valid after the PVM3 wakeup time.
$00008000 constant PWR_PWR_SR2_PVMO4                                \ Peripheral voltage monitoring output: V<sub>DDA</sub> vs. 2.2 V Note: PVMO4 is cleared when PVM4 is disabled (PVME4 = 0). After enabling PVM4, the PVM4 output is valid after the PVM4 wakeup time.
...
$00008000 constant PWR_PWR_PUCRA_PU15                               \ Port A pull-up bit 15 When set, this bit activates the pull-up on PA[15] when APC bit is set in PWR_CR3 register. If the corresponding PD15 bit is also set, the pull-up is not activated and the pull-down is activated instead with highest priority.
...
$00000001 constant PWR_PWR_PUCRG_PU0                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000002 constant PWR_PWR_PUCRG_PU1                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000004 constant PWR_PWR_PUCRG_PU2                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000008 constant PWR_PWR_PUCRG_PU3                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000010 constant PWR_PWR_PUCRG_PU4                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000020 constant PWR_PWR_PUCRG_PU5                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000040 constant PWR_PWR_PUCRG_PU6                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000080 constant PWR_PWR_PUCRG_PU7                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000100 constant PWR_PWR_PUCRG_PU8                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000200 constant PWR_PWR_PUCRG_PU9                                \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000400 constant PWR_PWR_PUCRG_PU10                               \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000800 constant PWR_PWR_PUCRG_PU11                               \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00001000 constant PWR_PWR_PUCRG_PU12                               \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00002000 constant PWR_PWR_PUCRG_PU13                               \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00004000 constant PWR_PWR_PUCRG_PU14                               \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00008000 constant PWR_PWR_PUCRG_PU15                               \ Port G pull-up bit y (y=0..15) When set, this bit activates the pull-up on PG[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
...
$00000001 constant PWR_PWR_PDCRG_PD0                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000002 constant PWR_PWR_PDCRG_PD1                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000004 constant PWR_PWR_PDCRG_PD2                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000008 constant PWR_PWR_PDCRG_PD3                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000010 constant PWR_PWR_PDCRG_PD4                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000020 constant PWR_PWR_PDCRG_PD5                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000040 constant PWR_PWR_PDCRG_PD6                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000080 constant PWR_PWR_PDCRG_PD7                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000100 constant PWR_PWR_PDCRG_PD8                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000200 constant PWR_PWR_PDCRG_PD9                                \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000400 constant PWR_PWR_PDCRG_PD10                               \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00000800 constant PWR_PWR_PDCRG_PD11                               \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00001000 constant PWR_PWR_PDCRG_PD12                               \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00002000 constant PWR_PWR_PDCRG_PD13                               \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00004000 constant PWR_PWR_PDCRG_PD14                               \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
$00008000 constant PWR_PWR_PDCRG_PD15                               \ Port G pull-down bit y (y=0..15) When set, this bit activates the pull-down on PG[y] when APC bit is set in PWR_CR3 register.
...
$00000001 constant PWR_PWR_PUCRH_PU0                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000002 constant PWR_PWR_PUCRH_PU1                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000004 constant PWR_PWR_PUCRH_PU2                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000008 constant PWR_PWR_PUCRH_PU3                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000010 constant PWR_PWR_PUCRH_PU4                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000020 constant PWR_PWR_PUCRH_PU5                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000040 constant PWR_PWR_PUCRH_PU6                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000080 constant PWR_PWR_PUCRH_PU7                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000100 constant PWR_PWR_PUCRH_PU8                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000200 constant PWR_PWR_PUCRH_PU9                                \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000400 constant PWR_PWR_PUCRH_PU10                               \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000800 constant PWR_PWR_PUCRH_PU11                               \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00001000 constant PWR_PWR_PUCRH_PU12                               \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00002000 constant PWR_PWR_PUCRH_PU13                               \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00004000 constant PWR_PWR_PUCRH_PU14                               \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00008000 constant PWR_PWR_PUCRH_PU15                               \ Port H pull-up bit y (y=0..15) When set, this bit activates the pull-up on PH[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
...
$00000001 constant PWR_PWR_PDCRH_PD0                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000002 constant PWR_PWR_PDCRH_PD1                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000004 constant PWR_PWR_PDCRH_PD2                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000008 constant PWR_PWR_PDCRH_PD3                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000010 constant PWR_PWR_PDCRH_PD4                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000020 constant PWR_PWR_PDCRH_PD5                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000040 constant PWR_PWR_PDCRH_PD6                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000080 constant PWR_PWR_PDCRH_PD7                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000100 constant PWR_PWR_PDCRH_PD8                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000200 constant PWR_PWR_PDCRH_PD9                                \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000400 constant PWR_PWR_PDCRH_PD10                               \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00000800 constant PWR_PWR_PDCRH_PD11                               \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00001000 constant PWR_PWR_PDCRH_PD12                               \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00002000 constant PWR_PWR_PDCRH_PD13                               \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00004000 constant PWR_PWR_PDCRH_PD14                               \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
$00008000 constant PWR_PWR_PDCRH_PD15                               \ Port H pull-down bit x (y =15...0) When set, this bit activates the pull-down on PH[y] when APC bit is set in PWR_CR3 register.
...
$00000001 constant PWR_PWR_PUCRI_PU0                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000002 constant PWR_PWR_PUCRI_PU1                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000004 constant PWR_PWR_PUCRI_PU2                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000008 constant PWR_PWR_PUCRI_PU3                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000010 constant PWR_PWR_PUCRI_PU4                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000020 constant PWR_PWR_PUCRI_PU5                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000040 constant PWR_PWR_PUCRI_PU6                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000080 constant PWR_PWR_PUCRI_PU7                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000100 constant PWR_PWR_PUCRI_PU8                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000200 constant PWR_PWR_PUCRI_PU9                                \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000400 constant PWR_PWR_PUCRI_PU10                               \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
$00000800 constant PWR_PWR_PUCRI_PU11                               \ Port I pull-up bit y (y=0..11) When set, this bit activates the pull-up on PI[y] when APC bit is set in PWR_CR3 register. The pull-up is not activated if the corresponding PDy bit is also set.
...
$00000001 constant PWR_PWR_PDCRI_PD0                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000002 constant PWR_PWR_PDCRI_PD1                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000004 constant PWR_PWR_PDCRI_PD2                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000008 constant PWR_PWR_PDCRI_PD3                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000010 constant PWR_PWR_PDCRI_PD4                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000020 constant PWR_PWR_PDCRI_PD5                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000040 constant PWR_PWR_PDCRI_PD6                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000080 constant PWR_PWR_PDCRI_PD7                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000100 constant PWR_PWR_PDCRI_PD8                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000200 constant PWR_PWR_PDCRI_PD9                                \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000400 constant PWR_PWR_PDCRI_PD10                               \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
$00000800 constant PWR_PWR_PDCRI_PD11                               \ Port I pull-down bit y (y=0..11) When set, this bit activates the pull-down on PI[y] when APC bit is set in PWR_CR3 register.
...
$00000100 constant PWR_PWR_CR5_R1MODE                               \ Main regulator Range 1 mode This bit is only valid for the main regulator in Range 1 and has no effect on Range 2. It is recommended to reset this bit when the system frequency is greater than 80 MHz. Refer to Table 28: Range 1 boost mode configuration.
...
$40007058 constant PWR_PWR_PUCRH  \ offset: 0x58 : Power Port H pull-up control register
$4000705c constant PWR_PWR_PDCRH  \ offset: 0x5C : Power Port H pull-down control register
$40007060 constant PWR_PWR_PUCRI  \ offset: 0x60 : Power Port I pull-up control register
$40007064 constant PWR_PWR_PDCRI  \ offset: 0x64 : Power Port I pull-down control register
$40007080 constant PWR_PWR_CR5    \ offset: 0x80 : PWR control register
