...
[ifndef] MDIOS_DEF
  ...
  \ @brief Management data input/output slave
  \
  $00 constant MDIOS_CR                 \ MDIOS configuration register
  $04 constant MDIOS_WRFR               \ MDIOS write flag register
  $08 constant MDIOS_CWRFR              \ MDIOS clear write flag register
  $0C constant MDIOS_RDFR               \ MDIOS read flag register
  $10 constant MDIOS_CRDFR              \ MDIOS clear read flag register
  $14 constant MDIOS_SR                 \ MDIOS status register
  $18 constant MDIOS_CLRFR              \ MDIOS clear flag register
  $1C constant MDIOS_DINR0              \ MDIOS input data register 0
  $20 constant MDIOS_DINR1              \ MDIOS input data register 1
  $24 constant MDIOS_DINR2              \ MDIOS input data register 2
  $28 constant MDIOS_DINR3              \ MDIOS input data register 3
  $2C constant MDIOS_DINR4              \ MDIOS input data register 4
  $30 constant MDIOS_DINR5              \ MDIOS input data register 5
  $34 constant MDIOS_DINR6              \ MDIOS input data register 6
  $38 constant MDIOS_DINR7              \ MDIOS input data register 7
  $3C constant MDIOS_DINR8              \ MDIOS input data register 8
  $40 constant MDIOS_DINR9              \ MDIOS input data register 9
  $44 constant MDIOS_DINR10             \ MDIOS input data register 10
  $48 constant MDIOS_DINR11             \ MDIOS input data register 11
  $4C constant MDIOS_DINR12             \ MDIOS input data register 12
  $50 constant MDIOS_DINR13             \ MDIOS input data register 13
  $54 constant MDIOS_DINR14             \ MDIOS input data register 14
  $58 constant MDIOS_DINR15             \ MDIOS input data register 15
  $5C constant MDIOS_DINR16             \ MDIOS input data register 16
  $60 constant MDIOS_DINR17             \ MDIOS input data register 17
  $64 constant MDIOS_DINR18             \ MDIOS input data register 18
  $68 constant MDIOS_DINR19             \ MDIOS input data register 19
  $6C constant MDIOS_DINR20             \ MDIOS input data register 20
  $70 constant MDIOS_DINR21             \ MDIOS input data register 21
  $74 constant MDIOS_DINR22             \ MDIOS input data register 22
  $78 constant MDIOS_DINR23             \ MDIOS input data register 23
  $7C constant MDIOS_DINR24             \ MDIOS input data register 24
  $80 constant MDIOS_DINR25             \ MDIOS input data register 25
  $84 constant MDIOS_DINR26             \ MDIOS input data register 26
  $88 constant MDIOS_DINR27             \ MDIOS input data register 27
  $8C constant MDIOS_DINR28             \ MDIOS input data register 28
  $90 constant MDIOS_DINR29             \ MDIOS input data register 29
  $94 constant MDIOS_DINR30             \ MDIOS input data register 30
  $98 constant MDIOS_DINR31             \ MDIOS input data register 31
  $9C constant MDIOS_DOUTR0             \ MDIOS output data register 0
  $A0 constant MDIOS_DOUTR1             \ MDIOS output data register 1
  $A4 constant MDIOS_DOUTR2             \ MDIOS output data register 2
  $A8 constant MDIOS_DOUTR3             \ MDIOS output data register 3
  $AC constant MDIOS_DOUTR4             \ MDIOS output data register 4
  $B0 constant MDIOS_DOUTR5             \ MDIOS output data register 5
  $B4 constant MDIOS_DOUTR6             \ MDIOS output data register 6
  $B8 constant MDIOS_DOUTR7             \ MDIOS output data register 7
  $BC constant MDIOS_DOUTR8             \ MDIOS output data register 8
  $C0 constant MDIOS_DOUTR9             \ MDIOS output data register 9
  $C4 constant MDIOS_DOUTR10            \ MDIOS output data register 10
  $C8 constant MDIOS_DOUTR11            \ MDIOS output data register 11
  $CC constant MDIOS_DOUTR12            \ MDIOS output data register 12
  $D0 constant MDIOS_DOUTR13            \ MDIOS output data register 13
  $D4 constant MDIOS_DOUTR14            \ MDIOS output data register 14
  $D8 constant MDIOS_DOUTR15            \ MDIOS output data register 15
  $DC constant MDIOS_DOUTR16            \ MDIOS output data register 16
  $E0 constant MDIOS_DOUTR17            \ MDIOS output data register 17
  $E4 constant MDIOS_DOUTR18            \ MDIOS output data register 18
  $E8 constant MDIOS_DOUTR19            \ MDIOS output data register 19
  $EC constant MDIOS_DOUTR20            \ MDIOS output data register 20
  $F0 constant MDIOS_DOUTR21            \ MDIOS output data register 21
  $F4 constant MDIOS_DOUTR22            \ MDIOS output data register 22
  $F8 constant MDIOS_DOUTR23            \ MDIOS output data register 23
  $FC constant MDIOS_DOUTR24            \ MDIOS output data register 24
  $100 constant MDIOS_DOUTR25           \ MDIOS output data register 25
  $104 constant MDIOS_DOUTR26           \ MDIOS output data register 26
  $108 constant MDIOS_DOUTR27           \ MDIOS output data register 27
  $10C constant MDIOS_DOUTR28           \ MDIOS output data register 28
  $110 constant MDIOS_DOUTR29           \ MDIOS output data register 29
  $114 constant MDIOS_DOUTR30           \ MDIOS output data register 30
  $118 constant MDIOS_DOUTR31           \ MDIOS output data register 31
