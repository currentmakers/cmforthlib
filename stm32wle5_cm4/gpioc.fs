...
[ifndef] GPIOC_DEF
  ...
  [ifdef] GPIOC_OTYPER_DEF
    ...
    \
    $00 constant GPIOC_OT0                      \ [0x00] Port x configuration bits (y = 0..15)
    $01 constant GPIOC_OT1                      \ [0x01] Port x configuration bits (y = 0..15)
    $02 constant GPIOC_OT2                      \ [0x02] Port x configuration bits (y = 0..15)
    $03 constant GPIOC_OT3                      \ [0x03] Port x configuration bits (y = 0..15)
    $04 constant GPIOC_OT4                      \ [0x04] Port x configuration bits (y = 0..15)
    $05 constant GPIOC_OT5                      \ [0x05] Port x configuration bits (y = 0..15)
    $06 constant GPIOC_OT6                      \ [0x06] Port x configuration bits (y = 0..15)
    $0d constant GPIOC_OT13                     \ [0x0d] Port x configuration bits (y = 0..15)
    $0e constant GPIOC_OT14                     \ [0x0e] Port x configuration bits (y = 0..15)
    $0f constant GPIOC_OT15                     \ [0x0f] Port x configuration bits (y = 0..15)
  [then]
  ...
  [ifdef] GPIOC_LCKR_DEF
    \
    \ @brief GPIO port configuration lock register
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
    \
    $00 constant GPIOC_LCK0                     \ [0x00] Port x lock bit y (y= 0..15)
    $01 constant GPIOC_LCK1                     \ [0x01] Port x lock bit y (y= 0..15)
    $02 constant GPIOC_LCK2                     \ [0x02] Port x lock bit y (y= 0..15)
    $03 constant GPIOC_LCK3                     \ [0x03] Port x lock bit y (y= 0..15)
    $04 constant GPIOC_LCK4                     \ [0x04] Port x lock bit y (y= 0..15)
    $05 constant GPIOC_LCK5                     \ [0x05] Port x lock bit y (y= 0..15)
    $06 constant GPIOC_LCK6                     \ [0x06] Port x lock bit y (y= 0..15)
    $0d constant GPIOC_LCK13                    \ [0x0d] Port x lock bit y (y= 0..15)
    $0e constant GPIOC_LCK14                    \ [0x0e] Port x lock bit y (y= 0..15)
    $0f constant GPIOC_LCK15                    \ [0x0f] Port x lock bit y (y= 0..15)
    $10 constant GPIOC_LCKK                     \ [0x10] Port x lock bit y (y= 0..15)
  [then]
  ...
  [ifdef] GPIOC_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIOC_BR0                      \ [0x00] Port Reset bit
    $01 constant GPIOC_BR1                      \ [0x01] Port Reset bit
    $02 constant GPIOC_BR2                      \ [0x02] Port Reset bit
    $03 constant GPIOC_BR3                      \ [0x03] Port Reset bit
    $04 constant GPIOC_BR4                      \ [0x04] Port Reset bit
    $05 constant GPIOC_BR5                      \ [0x05] Port Reset bit
    $06 constant GPIOC_BR6                      \ [0x06] Port Reset bit
    $0d constant GPIOC_BR13                     \ [0x0d] Port Reset bit
    $0e constant GPIOC_BR14                     \ [0x0e] Port Reset bit
    $0f constant GPIOC_BR15                     \ [0x0f] Port Reset bit
  [then]
