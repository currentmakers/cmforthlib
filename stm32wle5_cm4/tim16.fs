...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_CCMR1_Output_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_CC1S                     \ [0x00 : 2] CC1S
    $02 constant TIM16_OC1FE                    \ [0x02] OC1FE
    $03 constant TIM16_OC1PE                    \ [0x03] OC1PE
    $04 constant TIM16_OC1M                     \ [0x04 : 3] OC1M
    $10 constant TIM16_OC1M_3                   \ [0x10] OC1M
  [then]
  ...
  [ifdef] TIM16_CCMR1_Input_DEF
    ...
    \
    $00 constant TIM16_CC1S                     \ [0x00 : 2] CC1S
    $02 constant TIM16_IC1PSC                   \ [0x02 : 2] IC1PSC
    $04 constant TIM16_IC1F                     \ [0x04 : 4] IC1F
  [then]
  ...
  [ifdef] TIM16_CNT_DEF
    ...
    $1f constant TIM16_UIFCPYorRes              \ [0x1f] UIF Copy
  [then]
  ...
  [ifdef] TIM16_BDTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_DT                       \ [0x00 : 8] Dead-time generator setup
  ...
  [ifdef] TIM16_TIM16_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1_RMP                  \ [0x00 : 2] Timer 17 input 1 connection
  [then]
  ...
  [ifdef] TIM16_TIM16_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TISEL                    \ [0x00 : 4] TISEL
  [then]

  \
  \ @brief General-purpose timers
  \
  $00 constant TIM16_CR1                \ TIM16/TIM17 control register 1
  $04 constant TIM16_CR2                \ TIM16/TIM17 control register 2
  $0C constant TIM16_DIER               \ TIM16/TIM17 DMA/interrupt enable register
  $10 constant TIM16_SR                 \ TIM16/TIM17 status register
  $14 constant TIM16_EGR                \ TIM16/TIM17 event generation register
  $18 constant TIM16_CCMR1_OUTPUT       \ TIM16/TIM17 capture/compare mode register 1
  $18 constant TIM16_CCMR1_INPUT        \ TIM16/TIM17 capture/compare mode register 1
  $20 constant TIM16_CCER               \ TIM16/TIM17 capture/compare enable register
  $24 constant TIM16_CNT                \ TIM16/TIM17 counter
  $28 constant TIM16_PSC                \ TIM16/TIM17 prescaler
  $2C constant TIM16_ARR                \ TIM16/TIM17 auto-reload register
  $30 constant TIM16_RCR                \ TIM16/TIM17 repetition counter register
  $34 constant TIM16_CCR1               \ TIM16/TIM17 capture/compare register 1
  $44 constant TIM16_BDTR               \ TIM16/TIM17 break and dead-time register
  $48 constant TIM16_DCR                \ TIM16/TIM17 DMA control register
  $4C constant TIM16_DMAR               \ TIM16/TIM17 DMA address for full transfer
  $50 constant TIM16_TIM16_OR1          \ TIM16 option register 1
