...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_ALRMASSR_DEF
    ...
    $1f constant RTC_SSCLR                      \ [0x1f] Clear synchronous counter on alarm
  [then]
  ...
  [ifdef] RTC_MISR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_ALRMF                      \ [0x00] ALRMF
  ...
  $0C constant RTC_ICSR                 \ initialization control and status register
  ...
  $70 constant RTC_ALRABINR             \ alarm A binary mode register
  $74 constant RTC_ALRBBINR             \ alarm B binary mode register
