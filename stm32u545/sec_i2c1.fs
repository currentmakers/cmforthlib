...
$01000000 constant SEC_I2C1_CR1_FMP                                 \ Fast-mode Plus 20 mA drive enable
$40000000 constant SEC_I2C1_CR1_ADDRACLR                            \ Address match flag (ADDR) automatic clear
$80000000 constant SEC_I2C1_CR1_STOPFACLR                           \ STOP detection flag (STOPF) automatic clear
...
$000f0000 constant SEC_I2C1_I2C_AUTOCR_TRIGSEL                      \ Trigger selection
$00100000 constant SEC_I2C1_I2C_AUTOCR_TRIGPOL                      \ Trigger polarity
$00200000 constant SEC_I2C1_I2C_AUTOCR_TRIGEN                       \ Trigger enable
