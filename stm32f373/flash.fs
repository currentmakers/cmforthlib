...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_OBR_DEF
    ...
    $01 constant FLASH_LEVEL1_PROT              \ [0x01] Level 1 protection status
    $02 constant FLASH_LEVEL2_PROT              \ [0x02] Level 2 protection status
    ...
    $0c constant FLASH_BOOT1                    \ [0x0c] BOOT1
    $0d constant FLASH_VDDA_MONITOR             \ [0x0d] VDDA_MONITOR
    $0e constant FLASH_SRAM_PARITY_CHECK        \ [0x0e] SRAM_PARITY_CHECK
    $0f constant FLASH_SDADC12_VDD_MONITOR      \ [0x0f] SDADC12_VDD_MONITOR
