...
$0000000f constant CEC_CFGR_OAR                                     \ Own Address
$00000010 constant CEC_CFGR_LSTN                                    \ Listen mode
$000000e0 constant CEC_CFGR_SFT                                     \ Signal Free Time
$00000100 constant CEC_CFGR_RXTOL                                   \ Rx-Tolerance
$00000200 constant CEC_CFGR_BRESTP                                  \ Rx-stop on bit rising error
$00000400 constant CEC_CFGR_BREGEN                                  \ Generate error-bit on bit rising error
$00000800 constant CEC_CFGR_LBPEGEN                                 \ Generate Error-Bit on Long Bit Period Error
...
\ @brief HDMI-CEC controller
\
$40007800 constant CEC_CR         \ offset: 0x00 : control register
$40007804 constant CEC_CFGR       \ offset: 0x04 : configuration register
$40007808 constant CEC_TXDR       \ offset: 0x08 : Tx data register
$4000780c constant CEC_RXDR       \ offset: 0x0C : Rx Data Register
$40007810 constant CEC_ISR        \ offset: 0x10 : Interrupt and Status Register
$40007814 constant CEC_IER        \ offset: 0x14 : interrupt enable register
