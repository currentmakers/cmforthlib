...
\
\ @brief OTG_FS power and clock gating control register
\ Address offset: 0x00
...
\ @brief USB on the go full speed
\
$50000e00 constant OTG_FS_PWRCLK_FS_PCGCCTL  \ offset: 0x00 : OTG_FS power and clock gating control register
