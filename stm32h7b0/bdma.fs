...
[ifndef] BDMA_DEF
  ...
  \ @brief BDMA
  \
  $00 constant BDMA_BDMA_ISR            \ DMA interrupt status register
  $04 constant BDMA_BDMA_IFCR           \ DMA interrupt flag clear register
  $08 constant BDMA_BDMA_CCR0           \ DMA channel x configuration register
  $0C constant BDMA_BDMA_CNDTR0         \ DMA channel x number of data register
  $10 constant BDMA_BDMA_CPAR0          \ This register must not be written when the channel is enabled.
  $14 constant BDMA_BDMA_CM0AR0         \ This register must not be written when the channel is enabled.
  $18 constant BDMA_BDMA_CM1AR0         \ This register must not be written when the channel is enabled
  $1C constant BDMA_BDMA_CCR1           \ DMA channel x configuration register
  $20 constant BDMA_BDMA_CNDTR1         \ DMA channel x number of data register
  $24 constant BDMA_BDMA_CPAR1          \ This register must not be written when the channel is enabled.
  $28 constant BDMA_BDMA_CM0AR1         \ This register must not be written when the channel is enabled.
  $2C constant BDMA_BDMA_CM1AR1         \ BDMA_CMAR1
  $30 constant BDMA_BDMA_CCR2           \ DMA channel x configuration register
  $34 constant BDMA_BDMA_CNDTR2         \ DMA channel x number of data register
  $38 constant BDMA_BDMA_CPAR2          \ This register must not be written when the channel is enabled.
  $3C constant BDMA_BDMA_CM0AR2         \ This register must not be written when the channel is enabled.
  $40 constant BDMA_BDMA_CM1AR2         \ BDMA_CM1AR2
  $44 constant BDMA_BDMA_CCR3           \ DMA channel x configuration register
  $48 constant BDMA_BDMA_CNDTR3         \ DMA channel x number of data register
  $4C constant BDMA_BDMA_CPAR3          \ This register must not be written when the channel is enabled.
  $50 constant BDMA_BDMA_CM0AR3         \ This register must not be written when the channel is enabled.
  $54 constant BDMA_BDMA_CM1AR3         \ BDMA_CMAR3
  $58 constant BDMA_BDMA_CCR4           \ DMA channel x configuration register
  $5C constant BDMA_BDMA_CNDTR4         \ DMA channel x number of data register
  $60 constant BDMA_BDMA_CPAR4          \ This register must not be written when the channel is enabled.
  $64 constant BDMA_BDMA_CM0AR4         \ This register must not be written when the channel is enabled.
  $68 constant BDMA_BDMA_CM1AR4         \ BDMA_CM1AR4
  $6C constant BDMA_BDMA_CCR5           \ DMA channel x configuration register
  $70 constant BDMA_BDMA_CNDTR5         \ DMA channel x number of data register
  $74 constant BDMA_BDMA_CPAR5          \ This register must not be written when the channel is enabled.
  $78 constant BDMA_BDMA_CM0AR5         \ This register must not be written when the channel is enabled.
  $7C constant BDMA_BDMA_CM1AR5         \ This register must not be written when the channel is enabled.
  $80 constant BDMA_BDMA_CCR6           \ DMA channel x configuration register
  $84 constant BDMA_BDMA_CNDTR6         \ DMA channel x number of data register
  $88 constant BDMA_BDMA_CPAR6          \ This register must not be written when the channel is enabled.
  $8C constant BDMA_BDMA_CM0AR6         \ This register must not be written when the channel is enabled.
  $90 constant BDMA_BDMA_CM1AR6         \ This register must not be written when the channel is enabled.
  $94 constant BDMA_BDMA_CCR7           \ DMA channel x configuration register
  $98 constant BDMA_BDMA_CNDTR7         \ DMA channel x number of data register
  $9C constant BDMA_BDMA_CPAR7          \ This register must not be written when the channel is enabled.
  $A0 constant BDMA_BDMA_CM0AR7         \ This register must not be written when the channel is enabled.
  $A4 constant BDMA_BDMA_CM1AR7         \ This register must not be written when the channel is enabled.
