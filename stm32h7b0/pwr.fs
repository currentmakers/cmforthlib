...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_PWR_CR1_DEF
    ...
    $0c constant PWR_BOOSTE                     \ [0x0c] BOOSTE
    $0d constant PWR_AVD_READY                  \ [0x0d] AVD_READY
    ...
    $13 constant PWR_AXIRAM1SO                  \ [0x13] AXIRAM1SO
    $14 constant PWR_AXIRAM2SO                  \ [0x14] AXIRAM2SO
    $15 constant PWR_AXIRAM3SO                  \ [0x15] AXIRAM3SO
    $16 constant PWR_AHBRAM1SO                  \ [0x16] AHBRAM1SO
    $17 constant PWR_AHBRAM2SO                  \ [0x17] AHBRAM2SO
    $18 constant PWR_ITCMSO                     \ [0x18] ITCMSO
    $19 constant PWR_GFXSO                      \ [0x19] GFXSO
    $1a constant PWR_HSITFSO                    \ [0x1a] HSITFSO
    $1b constant PWR_SRDRAMSO                   \ [0x1b] SRDRAMSO
  [then]
  ...
  [ifdef] PWR_PWR_CSR1_DEF
    ...
    $11 constant PWR_MMCVDO                     \ [0x11] MMCVDO
  [then]
  ...
  [ifdef] PWR_PWR_CR3_DEF
    ...
    $02 constant PWR_SMPSEN                     \ [0x02] SMPSEN
    $03 constant PWR_SMPSEXTHP                  \ [0x03] SMPSEXTHP
    $04 constant PWR_SMPSLEVEL                  \ [0x04 : 2] SMPSLEVEL
    $08 constant PWR_VBE                        \ [0x08] VBAT charging enable
    $09 constant PWR_VBRS                       \ [0x09] VBAT charging resistor selection
    $10 constant PWR_SMPSEXTRDY                 \ [0x10] SMPSEXTRDY
  ...
  [ifdef] PWR_PWR_CPUCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_RETDS_CD                   \ [0x00] RETDS_CD
    $02 constant PWR_PDDS_SRD                   \ [0x02] PDDS_SRD
    ...
    $0b constant PWR_RUN_SRD                    \ [0x0b] RUN_SRD
  [then]


  [ifdef] PWR_PWR_SRDCR_DEF
    \
  ...
  [ifdef] PWR_PWR_WKUPCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant PWR_WKUPC1                     \ [0x00] Clear Wakeup pin flag for WKUP. These bits are always read as 0.
    $01 constant PWR_WKUPC2                     \ [0x01] Clear Wakeup pin flag for WKUP. These bits are always read as 0.
    $02 constant PWR_WKUPC3                     \ [0x02] Clear Wakeup pin flag for WKUP. These bits are always read as 0.
    $03 constant PWR_WKUPC4                     \ [0x03] Clear Wakeup pin flag for WKUP. These bits are always read as 0.
    $04 constant PWR_WKUPC5                     \ [0x04] Clear Wakeup pin flag for WKUP. These bits are always read as 0.
    $05 constant PWR_WKUPC6                     \ [0x05] Clear Wakeup pin flag for WKUP. These bits are always read as 0.
  [then]
  ...
  $18 constant PWR_PWR_SRDCR            \ This register allows controlling D3 domain power.Following reset VOSRDY will be read 1 by software
