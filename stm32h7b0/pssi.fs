...
\ @brief Parallel synchronous slave interface
\
$48020400 constant PSSI_PSSI_CR   \ offset: 0x00 : Parallel data clock polarity This bit configures the capture edge of the parallel clock or the edge used for driving outputs, depending on OUTEN.
$48020404 constant PSSI_PSSI_SR   \ offset: 0x04 : FIFO is ready to transfer four bytes
$48020408 constant PSSI_PSSI_RIS  \ offset: 0x08 : PSSI raw interrupt status register
$4802040c constant PSSI_PSSI_IER  \ offset: 0x0C : Data buffer overrun/underrun interrupt enable
$48020410 constant PSSI_PSSI_MIS  \ offset: 0x10 : PSSI masked interrupt status register
$48020414 constant PSSI_PSSI_ICR  \ offset: 0x14 : PSSI interrupt clear register
$48020428 constant PSSI_PSSI_DR   \ offset: 0x28 : PSSI data register
