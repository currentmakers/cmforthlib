...
[ifndef] TIM12_DEF
  ...
  [ifdef] TIM12_CCMR1_Input_DEF
    ...
    $0c constant TIM12_IC2F                     \ [0x0c : 3] Input capture 2 filter
  [then]
  ...
  $04 constant TIM12_CR2                \ control register 2
  ...
  $18 constant TIM12_CCMR1_OUTPUT       \ capture/compare mode register 1 (output mode)
