...
[ifndef] ADC1_DEF
  ...
  [ifdef] ADC1_CR2_DEF
    ...
    $02 constant ADC1_CAL                       \ [0x02] A/D calibration
    $03 constant ADC1_RSTCAL                    \ [0x03] Reset calibration
    $08 constant ADC1_DMA                       \ [0x08] Direct memory access mode
    $0b constant ADC1_ALIGN                     \ [0x0b] Data alignment
    $0c constant ADC1_JEXTSEL                   \ [0x0c : 3] External event select for injected group
    $0f constant ADC1_JEXTTRIG                  \ [0x0f] External trigger conversion mode for injected channels
    $11 constant ADC1_EXTSEL                    \ [0x11 : 3] External event select for regular group
    $14 constant ADC1_EXTTRIG                   \ [0x14] External trigger conversion mode for regular channels
    $15 constant ADC1_JSWSTART                  \ [0x15] Start conversion of injected channels
    $16 constant ADC1_SWSTART                   \ [0x16] Start conversion of regular channels
    $17 constant ADC1_TSVREFE                   \ [0x17] Temperature sensor and VREFINT enable
  [then]
  ...
  [ifdef] ADC1_SMPR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_SMP10                     \ [0x00 : 3] Channel 10 sample time selection
    $03 constant ADC1_SMP11                     \ [0x03 : 3] Channel 11 sample time selection
    $06 constant ADC1_SMP12                     \ [0x06 : 3] Channel 12 sample time selection
    $09 constant ADC1_SMP13                     \ [0x09 : 3] Channel 13 sample time selection
    $0c constant ADC1_SMP14                     \ [0x0c : 3] Channel 14 sample time selection
    $0f constant ADC1_SMP15                     \ [0x0f : 3] Channel 15 sample time selection
    $12 constant ADC1_SMP16                     \ [0x12 : 3] Channel 16 sample time selection
    $15 constant ADC1_SMP17                     \ [0x15 : 3] Channel 17 sample time selection
  [then]
  ...
  [ifdef] ADC1_SMPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_SMP0                      \ [0x00 : 3] Channel 0 sample time selection
    $03 constant ADC1_SMP1                      \ [0x03 : 3] Channel 1 sample time selection
    $06 constant ADC1_SMP2                      \ [0x06 : 3] Channel 2 sample time selection
    $09 constant ADC1_SMP3                      \ [0x09 : 3] Channel 3 sample time selection
    $0c constant ADC1_SMP4                      \ [0x0c : 3] Channel 4 sample time selection
    $0f constant ADC1_SMP5                      \ [0x0f : 3] Channel 5 sample time selection
    $12 constant ADC1_SMP6                      \ [0x12 : 3] Channel 6 sample time selection
    $15 constant ADC1_SMP7                      \ [0x15 : 3] Channel 7 sample time selection
    $18 constant ADC1_SMP8                      \ [0x18 : 3] Channel 8 sample time selection
    $1b constant ADC1_SMP9                      \ [0x1b : 3] Channel 9 sample time selection
  [then]
  ...
  [ifdef] ADC1_JOFR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JOFFSET1                  \ [0x00 : 12] Data offset for injected channel 1
  [then]
  ...
  [ifdef] ADC1_JOFR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JOFFSET2                  \ [0x00 : 12] Data offset for injected channel 2
  [then]
  ...
  [ifdef] ADC1_JOFR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JOFFSET3                  \ [0x00 : 12] Data offset for injected channel 3
  [then]
  ...
  [ifdef] ADC1_JOFR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant ADC1_JOFFSET4                  \ [0x00 : 12] Data offset for injected channel 4
  [then]
