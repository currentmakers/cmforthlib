...
[ifndef] SYSCFG_DEF
  ...
  [ifdef] SYSCFG_PMCR_DEF
    ...
    $09 constant SYSCFG_BOOSTVDDSEL             \ [0x09] Analog switch supply voltage selection
  ...
  [ifdef] SYSCFG_CFGR_DEF
    \
    \ @brief configuration register
    \ Address offset: 0x18
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_CM4L                    \ [0x00] CM4L
    $02 constant SYSCFG_PVDL                    \ [0x02] PVDL
    $03 constant SYSCFG_FLASHL                  \ [0x03] FLASHL
    $06 constant SYSCFG_CM7L                    \ [0x06] CM7L
    $07 constant SYSCFG_BKRAML                  \ [0x07] BKRAML
    $09 constant SYSCFG_SRAM4L                  \ [0x09] SRAM4L
    $0a constant SYSCFG_SRAM3L                  \ [0x0a] SRAM3L
    $0b constant SYSCFG_SRAM2L                  \ [0x0b] SRAM2L
    $0c constant SYSCFG_SRAM1L                  \ [0x0c] SRAM1L
    $0d constant SYSCFG_DTCML                   \ [0x0d] DTCML
    $0e constant SYSCFG_ITCML                   \ [0x0e] ITCML
    $0f constant SYSCFG_AXISRAML                \ [0x0f] AXISRAML
  [then]
  ...
  [ifdef] SYSCFG_PWRCR_DEF
    \
    \ @brief SYSCFG power control register
    \ Address offset: 0x2C
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_ODEN                    \ [0x00] Overdrive enable
  [then]
  ...
  [ifdef] SYSCFG_UR1_DEF
    \
    \ @brief SYSCFG user register 1
    \ Address offset: 0x304
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_BCM4                    \ [0x00] Boot Cortex-M4
    $10 constant SYSCFG_BCM7                    \ [0x10] Boot Cortex-M7
  [then]
  ...
  [ifdef] SYSCFG_UR2_DEF
    ...
    $10 constant SYSCFG_BCM7_ADD0               \ [0x10 : 16] Cortex-M7 Boot Address 0
  [then]
  ...
  [ifdef] SYSCFG_UR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_BCM4_ADD1               \ [0x00 : 16] Cortex-M4 Boot Address 0
    $10 constant SYSCFG_BCM7_ADD1               \ [0x10 : 16] Cortex-M7 Boot Address 1
  [then]
  ...
  [ifdef] SYSCFG_UR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_BCM4_ADD1               \ [0x00 : 16] Mass Erase Protected Area Disabled for bank 1
    $10 constant SYSCFG_MEPAD_1                 \ [0x10] Boot Cortex-M4 Address 1
  [then]
  ...
  [ifdef] SYSCFG_UR5_DEF
    ...
    $10 constant SYSCFG_WRPS_1                  \ [0x10 : 8] Write protection for flash bank 1
  [then]
  ...
  [ifdef] SYSCFG_UR9_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_WRPS_2                  \ [0x00 : 8] Write protection for flash bank 2
  ...
  [ifdef] SYSCFG_UR12_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_IWDG2M                  \ [0x00] Independent Watchdog 2 mode
  ...
  [ifdef] SYSCFG_UR14_DEF
    ...
    $10 constant SYSCFG_D2SBRST                 \ [0x10] D2 Standby Reset
  [then]
  ...
  [ifdef] SYSCFG_UR15_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_D2STPRST                \ [0x00] D2 Stop Reset
  ...
  $18 constant SYSCFG_CFGR              \ configuration register
  ...
  $2C constant SYSCFG_PWRCR             \ SYSCFG power control register
  $124 constant SYSCFG_PKGR             \ SYSCFG package register
  $300 constant SYSCFG_UR0              \ SYSCFG user register 0
  $304 constant SYSCFG_UR1              \ SYSCFG user register 1
