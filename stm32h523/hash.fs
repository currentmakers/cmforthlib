...
[ifndef] HASH_DEF
  ...
  [ifdef] HASH_HASH_CR_DEF
    ...
    $0d constant HASH_MDMAT                     \ [0x0d] Multiple DMA transfers
    $10 constant HASH_LKEY                      \ [0x10] Long key selection
    $11 constant HASH_ALGO                      \ [0x11 : 4] Algorithm selection
  [then]
  ...
  [ifdef] HASH_HASH_STR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_NBLW                      \ [0x00 : 5] Number of valid bits in the last word
  ...
  [ifdef] HASH_HASH_HRA0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H0                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HRA1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H1                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HRA2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H2                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HRA3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H3                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HRA4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H4                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_SR_DEF
    ...
    $09 constant HASH_NBWP                      \ [0x09 : 5] Number of words already pushed
    $0f constant HASH_DINNE                     \ [0x0f] DIN not empty
    $10 constant HASH_NBWE                      \ [0x10 : 5] Number of words expected
  [then]
  ...
  [ifdef] HASH_HASH_CSR0_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS0                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS1                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS2                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS3                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS4                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS5                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS6                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR7_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS7                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR8_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS8                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR9_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS9                       \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR10_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS10                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR11_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS11                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR12_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS12                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR13_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS13                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR14_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS14                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR15_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS15                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR16_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS16                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR17_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS17                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR18_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS18                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR19_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS19                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR20_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS20                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR21_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS21                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR22_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS22                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR23_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS23                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR24_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS24                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR25_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS25                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR26_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS26                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR27_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS27                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR28_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS28                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR29_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS29                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR30_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS30                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR31_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS31                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR32_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS32                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR33_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS33                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR34_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS34                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR35_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS35                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR36_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS36                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR37_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS37                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR38_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS38                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR39_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS39                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR40_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS40                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR41_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS41                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR42_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS42                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR43_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS43                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR44_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS44                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR45_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS45                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR46_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS46                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR47_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS47                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR48_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS48                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR49_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS49                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR50_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS50                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR51_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS51                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR52_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS52                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR53_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS53                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR54_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS54                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR55_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS55                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR56_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS56                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR57_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS57                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR58_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS58                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR59_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS59                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR60_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS60                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR61_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS61                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR62_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS62                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR63_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS63                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR64_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS64                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR65_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS65                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR66_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS66                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR67_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS67                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR68_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS68                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR69_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS69                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR70_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS70                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR71_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS71                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR72_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS72                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR73_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS73                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR74_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS74                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR75_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS75                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR76_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS76                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR77_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS77                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR78_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS78                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR79_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS79                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR80_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS80                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR81_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS81                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR82_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS82                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR83_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS83                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR84_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS84                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR85_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS85                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR86_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS86                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR87_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS87                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR88_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS88                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR89_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS89                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR90_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS90                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR91_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS91                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR92_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS92                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR93_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS93                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR94_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS94                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR95_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS95                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR96_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS96                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR97_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS97                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR98_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS98                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR99_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS99                      \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR100_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS100                     \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR101_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS101                     \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_CSR102_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_CS102                     \ [0x00 : 32] Context swap x
  [then]
  ...
  [ifdef] HASH_HASH_HR5_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H5                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR6_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H6                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR7_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H7                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR8_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H8                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR9_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H9                        \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR10_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H10                       \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR11_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H11                       \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR12_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H12                       \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR13_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H13                       \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR14_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H14                       \ [0x00 : 32] Hash data x
  [then]
  ...
  [ifdef] HASH_HASH_HR15_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HASH_H15                       \ [0x00 : 32] Hash data x
  [then]
