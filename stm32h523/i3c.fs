...
[ifndef] I3C_DEF
  ...
  [ifdef] I3C_I3C_CR_DEF
    ...
    $11 constant I3C_ADD                        \ [0x11 : 7] 7-bit I3C dynamic / Iless thansup>2less than/sup>C static target address (when I3C acts as controller)
  ...
  [ifdef] I3C_I3C_CR_ALTERNATE1_DEF
    \
    \ @brief I3C message control register
    \ Address offset: 0x00
    \ Reset value: 0x00000000
  ...
  [ifdef] I3C_I3C_IER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $02 constant I3C_CFNFIE                     \ [0x02] C-FIFO not full interrupt enable when the I3C acts as controller
    $03 constant I3C_SFNEIE                     \ [0x03] S-FIFO not empty interrupt enable when the I3C acts as controller
  ...
  [ifdef] I3C_I3C_TIMINGR0_DEF
    ...
    $10 constant I3C_SCLL_OD                    \ [0x10 : 8] SCL low duration in open-drain phases, used for legacy Iless thansup>2less than/sup>C messages and for I3C open-drain phases (address phase following a start, ACK phase during controller-initiated messages, and T bit phase during direct/private/IBI payload), in number of kernel clocks cycles:
    $18 constant I3C_SCLH_I2C                   \ [0x18 : 8] SCL high duration, used for legacy Iless thansup>2less than/sup>C messages, in number of kernel clocks cycles:
  [then]
  ...
  [ifdef] I3C_I3C_TIMINGR1_DEF
    ...
    $1c constant I3C_SDA_HD                     \ [0x1c] SDA hold time (when the I3C acts as controller), in number of kernel clocks cycles (refer to MIPI timing SDA hold time in push-pull tless thansub>HD_PPless than/sub>):
  [then]
  ...
  [ifdef] I3C_I3C_TIMINGR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant I3C_STALLT                     \ [0x00] Controller clock stall enable on T-bit phase of data (and on the ACK/NACK phase of data byte of a legacy Iless thansup>2less than/sup>C read)
  ...
  [ifdef] I3C_I3C_GETMXDSR_DEF
    ...
    $18 constant I3C_TSCO                       \ [0x18] clock-to-data turnaround time (tless thansub>SCOless than/sub>)
  [then]
  ...
  $00 constant I3C_I3C_CR_ALTERNATE1    \ I3C message control register
  ...
  $D0 constant I3C_I3C_GETMXDSR         \ I3C get max data speed register
