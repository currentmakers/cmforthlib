...
[ifndef] TIM5_DEF
  ...
  [ifdef] TIM5_TIM5_CR2_DEF
    ...
    $04 constant TIM5_MMS                       \ [0x04 : 3] MMS[2:0]: Master mode selection
  ...
  [ifdef] TIM5_TIM5_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM5_SMS                       \ [0x00 : 3] SMS[2:0]: Slave mode selection
    $03 constant TIM5_OCCS                      \ [0x03] OCREF clear selection
    $04 constant TIM5_TS                        \ [0x04 : 3] TS[2:0]: Trigger selection
  ...
  [ifdef] TIM5_TIM5_CCMR1_ALTERNATE1_DEF
    \
    \ @brief TIM5 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM5_TIM5_CCMR2_ALTERNATE1_DEF
    \
    \ @brief TIM5 capture/compare mode register 2
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
  ...
  $18 constant TIM5_TIM5_CCMR1_ALTERNATE1    \ TIM5 capture/compare mode register 1
  $1C constant TIM5_TIM5_CCMR2          \ TIM5 capture/compare mode register 2
  $1C constant TIM5_TIM5_CCMR2_ALTERNATE1    \ TIM5 capture/compare mode register 2
