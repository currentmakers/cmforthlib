...
$0000ffff constant I3C2_I3C_CR_ALTERNATE1_DCNT                      \ Count of related data to the CCC command to transfer as CCC defining bytes, or CCC sub-command bytes, or CCC data bytes, in bytes
$00ff0000 constant I3C2_I3C_CR_ALTERNATE1_CCC                       \ 8-bit CCC code (when I3C acts as controller)
$78000000 constant I3C2_I3C_CR_ALTERNATE1_MTYPE                     \ Message type (when I3C acts as controller)
$80000000 constant I3C2_I3C_CR_ALTERNATE1_MEND                      \ Message end type/last message of a frame (when I3C acts as controller)
...
$00000004 constant I3C2_I3C_IER_CFNFIE                              \ C-FIFO not full interrupt enable when the I3C acts as controller
$00000008 constant I3C2_I3C_IER_SFNEIE                              \ S-FIFO not empty interrupt enable when the I3C acts as controller
...
$44003000 constant I3C2_I3C_CR_ALTERNATE1  \ offset: 0x00 : I3C message control register
...
$440030d0 constant I3C2_I3C_GETMXDSR  \ offset: 0xD0 : I3C get max data speed register
