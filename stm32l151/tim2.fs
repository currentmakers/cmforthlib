...
[ifndef] TIM2_DEF
  ...
  [ifdef] TIM2_SR_DEF
    ...
    $0c constant TIM2_CC4OF                     \ [0x0c] Capture/compare 1 overcapture flag
  [then]
  ...
  [ifdef] TIM2_CCMR1_Output_DEF
    ...
    $08 constant TIM2_CC2S                      \ [0x08] Capture/Compare 2 selection
  ...
  [ifdef] TIM2_CCMR2_Output_DEF
    ...
    $08 constant TIM2_CC4S                      \ [0x08] Capture/Compare 4 selection
  ...
  [ifdef] TIM2_CCER_DEF
    ...
    $03 constant TIM2_CC1NP                     \ [0x03] Capture/Compare 1 complementary output Polarity
  ...
  [ifdef] TIM2_CNT_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CNT                       \ [0x00 : 16] TIM2 counter
  [then]
  ...
  [ifdef] TIM2_PSC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_PSC                       \ [0x00 : 16] TIM2 prescaler
  [then]
  ...
  [ifdef] TIM2_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM2_CCR4                      \ [0x00 : 16] Capture/Compare 4 value
  [then]
  ...
  $0C constant TIM2_DIER                \ Interrupt enable register
  $10 constant TIM2_SR                  \ status register
  $14 constant TIM2_EGR                 \ event generation register
  $18 constant TIM2_CCMR1_OUTPUT        \ capture/compare mode register 1
  $18 constant TIM2_CCMR1_INPUT         \ capture/compare mode register 1 (input mode)
  $1C constant TIM2_CCMR2_OUTPUT        \ capture/compare mode register 2
  ...
  $38 constant TIM2_CCR2                \ capture/compare register 1
  $3C constant TIM2_CCR3                \ capture/compare register 1
  $40 constant TIM2_CCR4                \ capture/compare register 1
