...
[ifndef] GPIO_DEF
  ...
  [ifdef] GPIO_OSPEEDER_DEF
    \
    \ @brief GPIO port output speed register
    \ Address offset: 0x08
    \ Reset value: 0x00000000
    \
    $00 constant GPIO_OSPEEDR0                  \ [0x00 : 2] OSPEEDR0
    $02 constant GPIO_OSPEEDR1                  \ [0x02 : 2] OSPEEDR1
    $04 constant GPIO_OSPEEDR2                  \ [0x04 : 2] OSPEEDR2
    $06 constant GPIO_OSPEEDR3                  \ [0x06 : 2] OSPEEDR3
    $08 constant GPIO_OSPEEDR4                  \ [0x08 : 2] OSPEEDR4
    $0a constant GPIO_OSPEEDR5                  \ [0x0a : 2] OSPEEDR5
    $0c constant GPIO_OSPEEDR6                  \ [0x0c : 2] OSPEEDR6
    $0e constant GPIO_OSPEEDR7                  \ [0x0e : 2] OSPEEDR7
    $10 constant GPIO_OSPEEDR8                  \ [0x10 : 2] OSPEEDR8
    $12 constant GPIO_OSPEEDR9                  \ [0x12 : 2] OSPEEDR9
    $14 constant GPIO_OSPEEDR10                 \ [0x14 : 2] OSPEEDR10
    $16 constant GPIO_OSPEEDR11                 \ [0x16 : 2] OSPEEDR11
    $18 constant GPIO_OSPEEDR12                 \ [0x18 : 2] OSPEEDR12
    $1a constant GPIO_OSPEEDR13                 \ [0x1a : 2] OSPEEDR13
    $1c constant GPIO_OSPEEDR14                 \ [0x1c : 2] OSPEEDR14
    $1e constant GPIO_OSPEEDR15                 \ [0x1e : 2] OSPEEDR15
  [then]
  ...
  $08 constant GPIO_OSPEEDER            \ GPIO port output speed register
