...
$00003000 constant DMA1_DMA_CCR1_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$0000ffff constant DMA1_DMA_CNDTR1_NDT                              \ number of data to transfer (0 to 216-1) This field is updated by hardware when the channel is enabled: It is decremented after each single DMA 'read followed by write transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC=0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC=1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$00003000 constant DMA1_DMA_CCR2_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$0000ffff constant DMA1_DMA_CNDTR2_NDT                              \ number of data to transfer (0 to 216-1) This field is updated by hardware when the channel is enabled: It is decremented after each single DMA 'read followed by write' transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC=0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC=1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$00003000 constant DMA1_DMA_CCR3_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$0000ffff constant DMA1_DMA_CNDTR3_NDT                              \ number of data to transfer (0 to 216-1) This field is updated by hardware when the channel is enabled: It is decremented after each single DMA 'read followed by write' transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC=0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC=1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$00003000 constant DMA1_DMA_CCR4_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$00003000 constant DMA1_DMA_CCR5_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$0000ffff constant DMA1_DMA_CNDTR5_NDT                              \ number of data to transfer (0 to 216-1) This field is updated by hardware when the channel is enabled: It is decremented after each single DMA 'read followed by write' transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC=0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC=1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$00003000 constant DMA1_DMA_CCR6_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$0000ffff constant DMA1_DMA_CNDTR6_NDT                              \ number of data to transfer (0 to 216-1) This field is updated by hardware when the channel is enabled: It is decremented after each single DMA 'read followed by write' transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC=0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC=1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$00003000 constant DMA1_DMA_CCR7_PL                                 \ priority level Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$0000ffff constant DMA1_DMA_CNDTR7_NDT                              \ number of data to transfer (0 to 216-1) This field is updated by hardware when the channel is enabled: It is decremented after each single DMA 'read followed by write' transfer, indicating the remaining amount of data items to transfer. It is kept at zero when the programmed amount of data to transfer is reached, if the channel is not in circular mode (CIRC=0 in the DMA_CCRx register). It is reloaded automatically by the previously programmed value, when the transfer is complete, if the channel is in circular mode (CIRC=1). If this field is zero, no transfer can be served whatever the channel status (enabled or not). Note: this field is set and cleared by software. It must not be written when the channel is enabled (EN = 1). It is read-only when the channel is enabled (EN=1).
...
$4002000c constant DMA1_DMA_CNDTR1  \ offset: 0x0C : DMA channel x number of data register
$40020010 constant DMA1_DMA_CPAR1  \ offset: 0x10 : DMA channel x peripheral address register
$40020014 constant DMA1_DMA_CMAR1  \ offset: 0x14 : DMA channel x memory address register
$4002001c constant DMA1_DMA_CCR2  \ offset: 0x1C : DMA channel 2 configuration register
$40020020 constant DMA1_DMA_CNDTR2  \ offset: 0x20 : DMA channel x number of data register
$40020024 constant DMA1_DMA_CPAR2  \ offset: 0x24 : DMA channel x peripheral address register
$40020028 constant DMA1_DMA_CMAR2  \ offset: 0x28 : DMA channel x memory address register
$40020030 constant DMA1_DMA_CCR3  \ offset: 0x30 : DMA channel 3 configuration register
$40020034 constant DMA1_DMA_CNDTR3  \ offset: 0x34 : DMA channel x configuration register
$40020038 constant DMA1_DMA_CPAR3  \ offset: 0x38 : DMA channel x peripheral address register
$4002003c constant DMA1_DMA_CMAR3  \ offset: 0x3C : DMA channel x memory address register
$40020044 constant DMA1_DMA_CCR4  \ offset: 0x44 : DMA channel 4 configuration register
$40020048 constant DMA1_DMA_CNDTR4  \ offset: 0x48 : DMA channel x configuration register
$4002004c constant DMA1_DMA_CPAR4  \ offset: 0x4C : DMA channel x peripheral address register
$40020050 constant DMA1_DMA_CMAR4  \ offset: 0x50 : DMA channel x memory address register
$40020058 constant DMA1_DMA_CCR5  \ offset: 0x58 : DMA channel 5 configuration register
$4002005c constant DMA1_DMA_CNDTR5  \ offset: 0x5C : DMA channel x configuration register
$40020060 constant DMA1_DMA_CPAR5  \ offset: 0x60 : DMA channel x peripheral address register
$40020064 constant DMA1_DMA_CMAR5  \ offset: 0x64 : DMA channel x memory address register
$4002006c constant DMA1_DMA_CCR6  \ offset: 0x6C : DMA channel 6 configuration register
$40020070 constant DMA1_DMA_CNDTR6  \ offset: 0x70 : DMA channel x configuration register
$40020074 constant DMA1_DMA_CPAR6  \ offset: 0x74 : DMA channel x peripheral address register
$40020078 constant DMA1_DMA_CMAR6  \ offset: 0x78 : DMA channel x memory address register
$40020080 constant DMA1_DMA_CCR7  \ offset: 0x80 : DMA channel 7 configuration register
$40020084 constant DMA1_DMA_CNDTR7  \ offset: 0x84 : DMA channel x configuration register
$40020088 constant DMA1_DMA_CPAR7  \ offset: 0x88 : DMA channel x peripheral address register
$4002008c constant DMA1_DMA_CMAR7  \ offset: 0x8C : DMA channel x memory address register
