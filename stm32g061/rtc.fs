...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_RTC_ICSR_DEF
    ...
    $04 constant RTC_INITS                      \ [0x04] Initialization status flag This bit is set by hardware when the calendar year field is different from 0 (RTC domain reset state).
  ...
  [ifdef] RTC_RTC_CR_DEF
    ...
    $1f constant RTC_OUT2EN                     \ [0x1f] RTC_OUT2 output enable Setting this bit allows to remap the RTC outputs on RTC_OUT2
  [then]
