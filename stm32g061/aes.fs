...
$00000008 constant AES_AES_SR_BUSY                                  \ Busy This flag indicates whether AES is idle or busy during GCM payload encryption phase
...
$40026004 constant AES_AES_SR     \ offset: 0x04 : AES control register
