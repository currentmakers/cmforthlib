...
[ifndef] DMA2D_DEF
  ...
  [ifdef] DMA2D_OPFCCR_DEF
    ...
    $09 constant DMA2D_SB                       \ [0x09] Swap Bytes
    $14 constant DMA2D_AI                       \ [0x14] Alpha Inverted
    $15 constant DMA2D_RBS                      \ [0x15] Red Blue Swap
  [then]


  [ifdef] DMA2D_OCOLR_RGB888_DEF
    \
  ...
  [ifdef] DMA2D_OCOLR_RGB565_DEF
    \
    \ @brief output color register
    \ Address offset: 0x38
    \ Reset value: 0x00000000
    \
    $00 constant DMA2D_BLUE                     \ [0x00 : 5] Blue value in RGB565 mode
    $05 constant DMA2D_GREEN                    \ [0x05 : 6] Green value in RGB565 mode
    $0b constant DMA2D_RED                      \ [0x0b : 5] Red value in RGB565 mode
  [then]


  [ifdef] DMA2D_OCOLR_ARGB1555_DEF
    \
    \ @brief output color register
    \ Address offset: 0x38
    \ Reset value: 0x00000000
    \
    $00 constant DMA2D_BLUE                     \ [0x00 : 5] Blue value in ARGB1555 mode
    $05 constant DMA2D_GREEN                    \ [0x05 : 5] Green value in ARGB1555 mode
    $0a constant DMA2D_RED                      \ [0x0a : 5] Red value in ARGB1555 mode
    $0f constant DMA2D_A                        \ [0x0f] Alpha channel value in ARGB1555 mode
  [then]


  [ifdef] DMA2D_OCOLR_ARGB4444_DEF
    \
    \ @brief output color register
    \ Address offset: 0x38
    \ Reset value: 0x00000000
    \
    $00 constant DMA2D_BLUE                     \ [0x00 : 4] Blue value in ARGB4444 mode
    $04 constant DMA2D_GREEN                    \ [0x04 : 4] Green value in ARGB4444 mode
    $08 constant DMA2D_RED                      \ [0x08 : 4] Red value in ARGB4444 mode
    $0c constant DMA2D_ALPHA                    \ [0x0c : 4] Alpha channel value in ARGB4444
  [then]
  ...
  $38 constant DMA2D_OCOLR_RGB888       \ output color register
  $38 constant DMA2D_OCOLR_RGB565       \ output color register
  $38 constant DMA2D_OCOLR_ARGB1555     \ output color register
  $38 constant DMA2D_OCOLR_ARGB4444     \ output color register
