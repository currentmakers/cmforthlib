...
[ifndef] GFXMMU_DEF
  ...
  [ifdef] GFXMMU_GFXMMU_CR_DEF
    ...
    $04 constant GFXMMU_AMEIE                   \ [0x04] AHB master error interrupt enable This bit enables the AHB master error interrupt.
    $06 constant GFXMMU_BM192                   \ [0x06] 192 Block mode This bit defines the number of blocks per line
    $07 constant GFXMMU_CE                      \ [0x07] Cache enable This bit enables the cache unit.
    $08 constant GFXMMU_CL                      \ [0x08] Cache lock This bit lock the cache onto the buffer defined in the CLB field.
    $09 constant GFXMMU_CLB                     \ [0x09 : 2] Cache lock buffer This field select the buffer on which the cache is locked.
    $0b constant GFXMMU_FC                      \ [0x0b] Force caching This bit force the caching into the cache regardless of the MPU attributes. The cache must be enable (CE bit set).
    $0c constant GFXMMU_PD                      \ [0x0c] Prefetch disable This bit disables the prefetch of the cache.
    $10 constant GFXMMU_OC                      \ [0x10] Outter cachability This bit configure the cachability of an access generated by the GFXMMU cache.
    $11 constant GFXMMU_OB                      \ [0x11] Outter bufferability This bit configure the bufferability of an access generated by the GFXMMU cache.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_SR_DEF
    ...
    $04 constant GFXMMU_AMEF                    \ [0x04] AHB master error flag This bit is set when an AHB error happens during a transaction. It is cleared by writing 1 to CAMEF.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_FCR_DEF
    ...
    $04 constant GFXMMU_CAMEF                   \ [0x04] Clear AHB master error flag Writing 1 clears the AHB master error flag in the GFXMMU_SR register.
  [then]


  [ifdef] GFXMMU_GFXMMU_CCR_DEF
    \
    \ @brief GFXMMU cache control register
    \ Address offset: 0x0C
    \ Reset value: 0x00000000
    \
    $00 constant GFXMMU_FF                      \ [0x00] Force flush When set, the cache entries are flushed. This bit is reset by hardware when the flushing is complete. Write 0 has no effect.
    $01 constant GFXMMU_FI                      \ [0x01] Force invalidate When set, the cache entries are invalidated. This bit is reset by hardware when the invalidation is complete. Write 0 has no effect.
  [then]
  ...
  [ifdef] GFXMMU_GFXMMU_LUT0H_DEF
    ...
    \ Reset value: 0x00000000
    \
    $04 constant GFXMMU_LO                      \ [0x04 : 18] Line offset Line offset of line number x (i.e. offset of block 0 of line x)
  [then]
  ...
  $0C constant GFXMMU_GFXMMU_CCR        \ GFXMMU cache control register
