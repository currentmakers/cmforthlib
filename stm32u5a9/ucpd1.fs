...
[ifndef] UCPD1_DEF
  ...
  \ @brief USB Power Delivery interface
  \
  $00 constant UCPD1_CFGR1              \ UCPD configuration register 1
  $04 constant UCPD1_CFGR2              \ UCPD configuration register 2
  $08 constant UCPD1_CFGR3              \ UCPD configuration register 3
  ...
  $20 constant UCPD1_TX_PAYSZ           \ UCPD Tx payload size Register
  $24 constant UCPD1_TXDR               \ UCPD Tx Data Register
  $28 constant UCPD1_RX_ORDSET          \ UCPD Rx Ordered Set Register
  $2C constant UCPD1_RX_PAYSZ           \ UCPD Rx payload size Register
  $30 constant UCPD1_RXDR               \ UCPD Receive Data Register
  $34 constant UCPD1_RX_ORDEXT1         \ UCPD Rx Ordered Set Extension Register 1
  $38 constant UCPD1_RX_ORDEXT2         \ UCPD Rx Ordered Set Extension Register 2
