...
[ifndef] CEC_DEF
  ...
  \ @brief CEC
  \
  $00 constant CEC_CR                   \ CEC control register
  $04 constant CEC_CFGR                 \ This register is used to configure the HDMI-CEC controller. It is mandatory to write CEC_CFGR only when CECEN=0.
  $08 constant CEC_TXDR                 \ CEC Tx data register
  $0C constant CEC_RXDR                 \ CEC Rx Data Register
  $10 constant CEC_ISR                  \ CEC Interrupt and Status Register
  $14 constant CEC_IER                  \ CEC interrupt enable register
