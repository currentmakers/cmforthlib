...
[ifndef] OTG_FS_HOST_DEF
  ...
  [ifdef] OTG_FS_HOST_FS_HCCHAR8_DEF
    \
    ...
    $11 constant OTG_FS_HOST_LSDEV              \ [0x11] Low-speed device
    $12 constant OTG_FS_HOST_EPTYP              \ [0x12 : 2] Endpoint type
    $14 constant OTG_FS_HOST_MCNT               \ [0x14 : 2] Multi Count (MC) / Error Count (EC)
    $16 constant OTG_FS_HOST_DAD                \ [0x16 : 7] Device address
    $1d constant OTG_FS_HOST_ODDFRM             \ [0x1d] Odd frame
    $1e constant OTG_FS_HOST_CHDIS              \ [0x1e] Channel disable
    $1f constant OTG_FS_HOST_CHENA              \ [0x1f] Channel enable
  ...
  [ifdef] OTG_FS_HOST_FS_HCINT8_DEF
    \
    ...
    $00 constant OTG_FS_HOST_XFRC               \ [0x00] Transfer completed
    $01 constant OTG_FS_HOST_CHH                \ [0x01] Channel halted
    $02 constant OTG_FS_HOST_AHBERR             \ [0x02] AHB error
    $03 constant OTG_FS_HOST_STALL              \ [0x03] STALL response received interrupt
    $04 constant OTG_FS_HOST_NAK                \ [0x04] NAK response received interrupt
    $05 constant OTG_FS_HOST_ACK                \ [0x05] ACK response received/transmitted interrupt
    $06 constant OTG_FS_HOST_NYET               \ [0x06] Response received interrupt
    $07 constant OTG_FS_HOST_TXERR              \ [0x07] Transaction error
    $08 constant OTG_FS_HOST_BBERR              \ [0x08] Babble error
    $09 constant OTG_FS_HOST_FRMOR              \ [0x09] Frame overrun
    $0a constant OTG_FS_HOST_DTERR              \ [0x0a] Data toggle error
  ...
  [ifdef] OTG_FS_HOST_FS_HCINTMSK8_DEF
    \
    ...
    $00 constant OTG_FS_HOST_XFRCM              \ [0x00] Transfer completed mask
    $01 constant OTG_FS_HOST_CHHM               \ [0x01] Channel halted mask
    $02 constant OTG_FS_HOST_AHBERRM            \ [0x02] AHB error
    $03 constant OTG_FS_HOST_STALLM             \ [0x03] STALL response received interrupt mask
    $04 constant OTG_FS_HOST_NAKM               \ [0x04] NAK response received interrupt mask
    $05 constant OTG_FS_HOST_ACKM               \ [0x05] ACK response received/transmitted interrupt mask
    $06 constant OTG_FS_HOST_NYET               \ [0x06] response received interrupt mask
  ...
  [ifdef] OTG_FS_HOST_FS_HCTSIZ8_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCCHAR9_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCINT9_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCINTMSK9_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCTSIZ9_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCCHAR10_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCINT10_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCINTMSK10_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCTSIZ10_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCCHAR11_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCINT11_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCINTMSK11_DEF
    \
  ...
  [ifdef] OTG_FS_HOST_FS_HCTSIZ11_DEF
    \
  ...
  $200 constant OTG_FS_HOST_FS_HCCHAR8  \ OTG_FS host channel-8 characteristics register
  $208 constant OTG_FS_HOST_FS_HCINT8   \ OTG_FS host channel-8 interrupt register
  $20C constant OTG_FS_HOST_FS_HCINTMSK8    \ OTG_FS host channel-8 interrupt mask register
  $210 constant OTG_FS_HOST_FS_HCTSIZ8  \ OTG_FS host channel-8 transfer size register
  $220 constant OTG_FS_HOST_FS_HCCHAR9  \ OTG_FS host channel-9 characteristics register
  $228 constant OTG_FS_HOST_FS_HCINT9   \ OTG_FS host channel-9 interrupt register
  $22C constant OTG_FS_HOST_FS_HCINTMSK9    \ OTG_FS host channel-9 interrupt mask register
  $230 constant OTG_FS_HOST_FS_HCTSIZ9  \ OTG_FS host channel-9 transfer size register
  $240 constant OTG_FS_HOST_FS_HCCHAR10 \ OTG_FS host channel-10 characteristics register
  $248 constant OTG_FS_HOST_FS_HCINT10  \ OTG_FS host channel-10 interrupt register
  $24C constant OTG_FS_HOST_FS_HCINTMSK10    \ OTG_FS host channel-10 interrupt mask register
  $250 constant OTG_FS_HOST_FS_HCTSIZ10 \ OTG_FS host channel-10 transfer size register
  $260 constant OTG_FS_HOST_FS_HCCHAR11 \ OTG_FS host channel-11 characteristics register
  $268 constant OTG_FS_HOST_FS_HCINT11  \ OTG_FS host channel-11 interrupt register
  $26C constant OTG_FS_HOST_FS_HCINTMSK11    \ OTG_FS host channel-11 interrupt mask register
  $270 constant OTG_FS_HOST_FS_HCTSIZ11 \ OTG_FS host channel-11 transfer size register
