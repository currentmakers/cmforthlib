...
[ifndef] UART_DEF
  ...
  [ifdef] UART_SR_DEF
    ...
    $02 constant UART_NF                        \ [0x02] Noise detected flag
  ...
  [ifdef] UART_DR_DEF
    ...
    \
    $00 constant UART_DR                        \ [0x00 : 9] Data value
  [then]
  ...
  [ifdef] UART_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant UART_DIV_Fraction              \ [0x00 : 4] fraction of USARTDIV
    $04 constant UART_DIV_Mantissa              \ [0x04 : 12] mantissa of USARTDIV
  [then]
