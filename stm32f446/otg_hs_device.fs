...
[ifndef] OTG_HS_DEVICE_DEF
  ...
  [ifdef] OTG_HS_DEVICE_OTG_HS_DCFG_DEF
    ...
    $0e constant OTG_HS_DEVICE_XCVRDLY          \ [0x0e] Transceiver delay
    $0f constant OTG_HS_DEVICE_ERRATIM          \ [0x0f] Erratic error interrupt mask
  ...
  $44 constant OTG_HS_DEVICE_OTG_HS_DIEPEACHMSK1    \ OTG_HS device each in endpoint-1 interrupt register
  $84 constant OTG_HS_DEVICE_OTG_HS_DOEPEACHMSK1    \ OTG_HS device each OUT endpoint-1 interrupt register
