...
[ifndef] USART1_DEF
  ...
  [ifdef] USART1_CR2_DEF
    ...
    $03 constant USART1_DIS_NSS                 \ [0x03] When the DSI_NSS bit is set, the NSS pin input will be ignored
  ...
  [ifdef] USART1_CR3_DEF
    ...
    $17 constant USART1_TXFTIE                  \ [0x17] threshold interrupt enable
    $18 constant USART1_TCBGTIE                 \ [0x18] Tr Complete before guard time, interrupt enable
  ...
  [ifdef] USART1_BRR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant USART1_BRR                     \ [0x00 : 16] BRR_4_15
  [then]
  ...
  $2C constant USART1_PRESC             \ Prescaler register
