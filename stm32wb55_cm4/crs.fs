...
[ifndef] CRS_DEF
  ...
  [ifdef] CRS_CR_DEF
    ...
    $07 constant CRS_SWSYNC                     \ [0x07] Automatic trimming enable
    $08 constant CRS_TRIM                       \ [0x08 : 6] HSI48 oscillator smooth trimming
  [then]
  ...
  [ifdef] CRS_CFGR_DEF
    ...
    $18 constant CRS_SYNCDIV                    \ [0x18 : 3] SYNCDIV
  ...
  [ifdef] CRS_ICR_DEF
    ...
    $01 constant CRS_SYNCWARNC                  \ [0x01] warning clear flag
  ...
  $04 constant CRS_CFGR                 \ CRS configuration register
