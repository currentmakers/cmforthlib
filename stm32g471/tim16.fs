...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_DTR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_DTGF                     \ [0x00 : 8] Dead-time generator setup
  ...
  [ifdef] TIM16_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1SEL                   \ [0x00 : 4] TI1[0] to TI1[15] input selection
  [then]
  ...
  [ifdef] TIM16_AF1_DEF
    ...
    $03 constant TIM16_BKCMP3E                  \ [0x03] BRK COMP3 enable
    $04 constant TIM16_BKCMP4E                  \ [0x04] BRK COMP4 enable
    $05 constant TIM16_BKCMP5E                  \ [0x05] BRK COMP5 enable
    $06 constant TIM16_BKCMP6E                  \ [0x06] BRK COMP6 enable
    $07 constant TIM16_BKCMP7E                  \ [0x07] BRK COMP7 enable
    ...
    $0c constant TIM16_BKCMP3P                  \ [0x0c] BRK COMP3 input polarity
    $0d constant TIM16_BKCMP4P                  \ [0x0d] BRK COMP4 input polarity
  [then]
  ...
  [ifdef] TIM16_AF2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $10 constant TIM16_OCRSEL                   \ [0x10 : 3] OCREF_CLR source selection
  [then]
  ...
  [ifdef] TIM16_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_HSE32EN                  \ [0x00] HSE Divided by 32 enable
  [then]
  ...
  $5C constant TIM16_TISEL              \ TIM timer input selection register
  $60 constant TIM16_AF1                \ TIM alternate function option register 1
  $64 constant TIM16_AF2                \ TIM alternate function option register 2
  $68 constant TIM16_OR1                \ TIM option register 1
  $3DC constant TIM16_DCR               \ DMA control register
  $3E0 constant TIM16_DMAR              \ DMA address for full transfer
