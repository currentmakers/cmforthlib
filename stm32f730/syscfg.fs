...
[ifndef] SYSCFG_DEF
  ...
  [ifdef] SYSCFG_MEMRMP_DEF
    ...
    \
    $00 constant SYSCFG_MEM_BOOT                \ [0x00] Memory boot mapping
    $0a constant SYSCFG_SWP_FMC                 \ [0x0a : 2] FMC memory mapping swap
  [then]
  ...
  [ifdef] SYSCFG_PMC_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SYSCFG_I2C1_FMP                \ [0x00] I2C1_FMP I2C1 Fast Mode + Enable
    $01 constant SYSCFG_I2C2_FMP                \ [0x01] I2C2_FMP I2C2 Fast Mode + Enable
    $02 constant SYSCFG_I2C3_FMP                \ [0x02] I2C3_FMP I2C3 Fast Mode + Enable
    $04 constant SYSCFG_PB6_FMP                 \ [0x04] PB6_FMP Fast Mode
    $05 constant SYSCFG_PB7_FMP                 \ [0x05] PB7_FMP Fast Mode + Enable
    $06 constant SYSCFG_PB8_FMP                 \ [0x06] PB8_FMP Fast Mode + Enable
    $07 constant SYSCFG_PB9_FMP                 \ [0x07] Fast Mode + Enable
    $10 constant SYSCFG_ADCDC2                  \ [0x10 : 3] ADC3DC2
  [then]
