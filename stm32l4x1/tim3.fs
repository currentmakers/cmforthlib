...
[ifndef] TIM3_DEF
  ...
  [ifdef] TIM3_SMCR_DEF
    ...
    $10 constant TIM3_SMS_3                     \ [0x10] Slave mode selection - bit 3
  [then]
  ...
  [ifdef] TIM3_CNT_DEF
    ...
    $10 constant TIM3_CNT_H                     \ [0x10 : 15] High counter value (TIM2 only)
  [then]
  ...
  [ifdef] TIM3_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM3_TI1_RMP                   \ [0x00 : 2] Input Capture 1 remap
  [then]
  ...
  $50 constant TIM3_OR1                 \ TIM3 option register 1
