...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_CCMR2_Output_DEF
    ...
    $10 constant TIM1_OC3M_bit3                 \ [0x10] Output Compare 3 mode - bit 3
  ...
  [ifdef] TIM1_OR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_ETR_ADC1_RMP              \ [0x00 : 2] External trigger remap on ADC1 analog watchdog
    $02 constant TIM1_ETR_ADC3_RMP              \ [0x02 : 2] External trigger remap on ADC3 analog watchdog
  ...
  [ifdef] TIM1_OR2_DEF
    ...
    $08 constant TIM1_BKDFBK0E                  \ [0x08] BRK DFSDM_BREAK[0] enable
  ...
  [ifdef] TIM1_OR3_DEF
    ...
    $08 constant TIM1_BK2DFBK1E                 \ [0x08] BRK2 DFSDM_BREAK[1] enable
  ...
  $18 constant TIM1_CCMR1_OUTPUT        \ capture/compare mode register 1
  ...
  $50 constant TIM1_OR1                 \ TIM1 option register 1
  ...
  $60 constant TIM1_OR2                 \ TIM1 option register 2
  $64 constant TIM1_OR3                 \ TIM1 option register 3
