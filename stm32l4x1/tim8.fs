...
[ifndef] TIM8_DEF
  ...
  [ifdef] TIM8_CCMR1_Output_DEF
    ...
    $10 constant TIM8_OC1M_bit3                 \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM8_OC2M_bit3                 \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM8_CCMR2_Output_DEF
    ...
    $10 constant TIM8_OC3M_bit3                 \ [0x10] Output Compare 3 mode - bit 3
    $18 constant TIM8_OC4M_bit3                 \ [0x18] Output Compare 4 mode - bit 3
  [then]
  ...
  [ifdef] TIM8_CCMR3_Output_DEF
    ...
    $10 constant TIM8_OC5M_bit3                 \ [0x10] Output Compare 5 mode bit 3
  ...
  [ifdef] TIM8_OR2_DEF
    ...
    $08 constant TIM8_BKDFBK2E                  \ [0x08] BRK DFSDM_BREAK[2] enable
  ...
  [ifdef] TIM8_OR3_DEF
    ...
    $08 constant TIM8_BK2DFBK3E                 \ [0x08] BRK2 DFSDM_BREAK[3] enable
  ...
  $18 constant TIM8_CCMR1_OUTPUT        \ capture/compare mode register 1
  ...
  $50 constant TIM8_OR1                 \ TIM8 option register 1
  ...
  $60 constant TIM8_OR2                 \ TIM8 option register 2
  $64 constant TIM8_OR3                 \ TIM8 option register 3
