...
[ifndef] DCMI_DEF
  ...
  [ifdef] DCMI_SR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DCMI_HSYNC                     \ [0x00] Horizontal synchronization
    $01 constant DCMI_VSYNC                     \ [0x01] Vertical synchronization
  ...
  [ifdef] DCMI_RIS_DEF
    ...
    $03 constant DCMI_VSYNC_RIS                 \ [0x03] DCMI_VSYNC raw interrupt status
  ...
  [ifdef] DCMI_IER_DEF
    ...
    $03 constant DCMI_VSYNC_IE                  \ [0x03] DCMI_VSYNC interrupt enable
  ...
  [ifdef] DCMI_ICR_DEF
    ...
    $03 constant DCMI_VSYNC_ISC                 \ [0x03] Vertical Synchronization interrupt status clear
  ...
  \ @brief Digital camera interface
  \
  $00 constant DCMI_CR                  \ control register
  ...
  $18 constant DCMI_ESCR                \ background offset register
