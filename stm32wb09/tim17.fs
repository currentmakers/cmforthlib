...
$00000008 constant TIM17_CR1_OPM                                    \ OPM: One pulse mode 0: Counter is not stopped at update event. 1: Counter stops counting at the next update event (clearing the bit CEN)
$00000080 constant TIM17_CR1_ARPE                                   \ ARPE: Auto-reload preload enable 0: TIMx_ARR register is not buffered 1: TIMx_ARR register is buffered
$00000300 constant TIM17_CR1_CKD                                    \ CKD[1:0]: Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (tDTS)used by the dead-time generators and the digital filters (TIx), 00: tDTS=tCK_INT 01: tDTS=2*tCK_INT 10: tDTS=4*tCK_INT 11: Reserved, do not program this value
$00000800 constant TIM17_CR1_UIF_REMAP                              \ UIFREMAP: UIF status bit remapping 0: No remapping. UIF status bit is not copied to TIMx_CNT register bit 31. 1: Remapping enabled. UIF status bit is copied to TIMx_CNT register bit 31.
...
$00000001 constant TIM17_CR2_CCPC                                   \ CCPC: Capture/compare preloaded control 0: CCxE, CCxNE and OCxM bits are not preloaded 1: CCxE, CCxNE and OCxM bits are preloaded, after having been written, they are updated only when COM bit is set. Note: This bit acts only on channels that have a complementary output.
$00000004 constant TIM17_CR2_CCUS                                   \ CCUS: Capture/compare control update selection 0: When capture/compare control bits are preloaded (CCPC=1), they are updated by setting the COMG bit only. 1: When capture/compare control bits are preloaded (CCPC=1), they are updated by setting the COMG bit or when an rising edge occurs on TRGI. Note: This bit acts only on channels that have a complementary output.
$00000008 constant TIM17_CR2_CCDS                                   \ CCDS: Capture/compare DMA selection 0: CCx DMA request sent when CCx event occurs 1: CCx DMA requests sent when update event occurs
$00000100 constant TIM17_CR2_OIS1                                   \ OIS1: Output Idle state 1 (OC1 output) 0: OC1=0 (after a dead-time if OC1N is implemented) when MOE=0 1: OC1=1 (after a dead-time if OC1N is implemented) when MOE=0 Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BKR register).
$00000200 constant TIM17_CR2_OIS1N                                  \ OIS1N: Output Idle state 1 (OC1N output) 0: OC1N=0 after a dead-time when MOE=0 1: OC1N=1 after a dead-time when MOE=0 Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BKR register).
...
$00000001 constant TIM17_DIER_UIE                                   \ UIE: Update interrupt enable 0: Update interrupt disabled 1: Update interrupt enabled
$00000002 constant TIM17_DIER_CC1IE                                 \ CC1IE: Capture/Compare 1 interrupt enable 0: CC1 interrupt disabled. 1: CC1 interrupt enabled
$00000020 constant TIM17_DIER_COMIE                                 \ COMIE: COM interrupt enable 0: COM interrupt disabled 1: COM interrupt enabled
$00000080 constant TIM17_DIER_BIE                                   \ BIE: Break interrupt enable 0: Break interrupt disabled 1: Break interrupt enabled
$00000100 constant TIM17_DIER_UDE                                   \ UDE: Update DMA request enable 0: Update DMA request disabled 1: Update DMA request enabled
$00000200 constant TIM17_DIER_CC1DE                                 \ CC1DE: Capture/Compare 1 DMA request enable 0: CC1 DMA request disabled 1: CC1 DMA request enabled
$00002000 constant TIM17_DIER_CCUDE                                 \ CCUDE: CC-Update DMA request Enable. Not used in Blue51. Not available in IUM 0: CC-Update DMA request disabled. 1: CC-Update DMA request enabled.
$00008000 constant TIM17_DIER_BDE                                   \ BDE: Break DMA request Enable. Not used in Blue51. Not available in IUM 0: Break DMA request disabled. 1: Break DMA request enabled.
...
$00000001 constant TIM17_EGR_UG                                     \ UG: Update generation This bit can be set by software, it is automatically cleared by hardware. 0: No action. 1: Reinitialize the counter and generates an update of the registers. Note that the prescaler counter is cleared too (anyway the prescaler ratio is not affected).
...
$00000020 constant TIM17_EGR_COMG                                   \ COMG: Capture/Compare control update generation This bit can be set by software, it is automatically cleared by hardware. 0: No action 1: When the CCPC bit is set, it is possible to update the CCxE, CCxNE and OCxM bits Note: This bit acts only on channels that have a complementary output.
$00000080 constant TIM17_EGR_BG                                     \ BG: Break generation This bit is set by software in order to generate an event, it is automatically cleared by hardware. 0: No action. 1: A break event is generated. MOE bit is cleared and BIF flag is set. Related interrupt or DMA transfer can occur if enabled.
...
$0000ffff constant TIM17_CNT_CNT                                    \ CNT[15:0]: Counter value
$80000000 constant TIM17_CNT_UIF_CPY                                \ UIFCPY: UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register. If the UIFREMAP bit in TIMx_CR1 is reset, bit 31 is reserved and read as 0.
...
$0000ffff constant TIM17_PSC_PSC                                    \ PSC[15:0]: Prescaler value The counter clock frequency (CK_CNT) is equal to fCK_PSC / (PSC[15:0] + 1). PSC contains the value to be loaded in the active prescaler register at each update event (including when the counter is cleared through UG bit of TIMx_EGR register or through trigger controller when configured in 'reset mode').
...
$0000ffff constant TIM17_ARR_ARR                                    \ ARR[15:0]: Prescaler value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 22.3.1: Time-base unit on page 418 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
...
$0000ffff constant TIM17_DMAR_DMAB                                  \ DMAB[15:0]: DMA register for burst accesses A read or write operation to the DMAR register accesses the register located at the address (TIMx_CR1 address) + (DBA + DMA index) x 4 where TIMx_CR1 address is the address of the control register 1, DBA is the DMA base address configured in TIMx_DCR register, DMA index is automatically controlled by the DMA transfer, and ranges from 0 to DBL (DBL configured in TIMx_DCR).
...
$00000003 constant TIM17_OR1_TI1_RMP                                \ TI1_RMP[1:0]: Timer 17 input 1 connection This bit is set and cleared by software. 00: TIM17 TI1 is connected to GPIO 01: TIM17 TI1 is connected to LCO 1x: TIM17 TI1 is connected to MCO
...
$00000001 constant TIM17_AF1_BKINE                                  \ BKINE: BRK BKIN enable. This bit enables the BKIN alternate function input for the timer's BRK input. BKIN input is ORed with the other enabled BRK sources. 0: BKIN input disabled. 1: BKIN input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$00000002 constant TIM17_AF1_BKCMP1E                                \ BKCMP1E: BRK COMP1 enable. This bit enables the COMP1 for the timer's BRK input. COMP1 output is ORed with the other enabled BRK sources. 0: COMP1 input disabled. 1: COMP1 input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$00000004 constant TIM17_AF1_BKCMP2E                                \ BKCMP1E: BRK COMP1 enable. This bit enables the COMP1 for the timer's BRK input. COMP1 output is ORed with the other enabled BRK sources. 0: COMP1 input disabled. 1: COMP1 input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$000001f8 constant TIM17_AF1_AF1_8_3                                \ AF1[13:12] Not used in Blue51. Not available in IUM
$00000200 constant TIM17_AF1_BKINP                                  \ BKINP: BRK BKIN input polarity. This bit selects the BKIN alternate function input sensitivity. It must be programmed together with the BKP polarity bit. 0: BKIN input is active low. 1: BKIN input is active high. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$00000400 constant TIM17_AF1_BKCMP1P                                \ BKCMP1P: BRK COMP1 input polarity. This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. 0: COMP1 input is active low. 1: COMP1 input is active high. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$00000800 constant TIM17_AF1_BKCMP2P                                \ BKCMP2P: BRK COMP2 input polarity. This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. 0: COMP2 input is active low. 1: COMP2 input is active high. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
$00003000 constant TIM17_AF1_AF1_13_12                              \ AF1[13:12] Not used in Blue51. Not available in IUM


\
\ @brief TIM16 interrupt
\
$40006000 constant TIM17_CR1      \ offset: 0x00 : CR1 register
$40006004 constant TIM17_CR2      \ offset: 0x04 : CR2 register
$4000600c constant TIM17_DIER     \ offset: 0x0C : DIER register
$40006010 constant TIM17_SR       \ offset: 0x10 : SR register
$40006014 constant TIM17_EGR      \ offset: 0x14 : EGR register
$40006018 constant TIM17_CCMR1    \ offset: 0x18 : CCMR1 register
$40006018 constant TIM17_CCMR1_IN  \ offset: 0x18 : CC1S: Capture/Compare 1 Selection This bit-field defines the direction of the channel (input/output) as well as the used input. 00: CC1 channel is configured as output 01: CC1 channel is configured as input, IC1 is mapped on TI1 1x: Reserved Note: CC1S bits are writable only when the channel is OFF (CC1E = '0' in TIMx_CCER).
$40006020 constant TIM17_CCER     \ offset: 0x20 : CCER register
$40006024 constant TIM17_CNT      \ offset: 0x24 : CNT register
$40006028 constant TIM17_PSC      \ offset: 0x28 : PSC register
$4000602c constant TIM17_ARR      \ offset: 0x2C : ARR register
$40006030 constant TIM17_RCR      \ offset: 0x30 : RCR register
$40006034 constant TIM17_CCR1     \ offset: 0x34 : CCR1 register
$40006044 constant TIM17_BDTR     \ offset: 0x44 : BDTR register
$40006048 constant TIM17_DCR      \ offset: 0x48 : DCR register
$4000604c constant TIM17_DMAR     \ offset: 0x4C : DMAR register
$40006050 constant TIM17_OR1      \ offset: 0x50 : OR1 register
$40006060 constant TIM17_AF1      \ offset: 0x60 : AF1 register
