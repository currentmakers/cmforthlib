...
$00000001 constant BLUE_STATUS2REG_IQSAMPLESREADY                   \ indicates if IQ samples have been received on the last reception.
$000000fe constant BLUE_STATUS2REG_IQSAMPLESNUMBER                  \ indicate the number of IQ samples stored in the RAM buffer addressed by StatMach.
$20000000 constant BLUE_STATUS2REG_IQSAMPLESMISSINGERROR            \ IQ sample internal buffer overflow error flag.
$40000000 constant BLUE_STATUS2REG_ANTENNASWITCHINGPATTERNACCESSERROR    \ timing error flag related to Antenna Pattern not read on-time.
$80000000 constant BLUE_STATUS2REG_ANTENNA_SWITCHING_PATTERN_ADDRESS_ERROR    \ AHB access error flag.
...
$6000007c constant BLUE_STATUS2REG  \ offset: 0x7C : STATUS2REG register
