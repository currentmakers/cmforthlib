...
$00400000 constant PKA_PKA_CR_FAULTFSMIE                            \ Fault FSM interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTFSMF (PKA_SR[22]) is set.
$00800000 constant PKA_PKA_CR_FAULTERRORCODEIE                      \ Fault error code interrupt enable 0: Interrupt is disabled. 1: An interrupt is generated when FAULTERRORCODEF (PKA_SR[23]) is set.
...
$00400000 constant PKA_PKA_SR_FAULTFSMF                             \ Fault fsm error flag 0: No fault has been detected 1: A fault on fsm has been detected
$00800000 constant PKA_PKA_SR_FAULTERRORCODEF                       \ Fault error code error flag 0: No fault has been detected 1: A fault has altered the execution of the operation and the internal fault check has been skipped
