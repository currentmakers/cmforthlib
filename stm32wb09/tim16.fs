...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_AF1_DEF
    ...
    $02 constant TIM16_BKCMP2E                  \ [0x02] BKCMP1E: BRK COMP1 enable. This bit enables the COMP1 for the timer's BRK input. COMP1 output is ORed with the other enabled BRK sources. 0: COMP1 input disabled. 1: COMP1 input enabled. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register)
    $03 constant TIM16_AF1_8_3                  \ [0x03 : 6] AF1[13:12] Not used in Blue51. Not available in IUM
