...
[ifndef] CAN_DEF
  ...
  [ifdef] CAN_FMR_DEF
    ...
    \
    $00 constant CAN_FINIT                      \ [0x00] Filter init mode
    $08 constant CAN_CAN2SB                     \ [0x08 : 6] CAN2 start bank
  [then]
  ...
  [ifdef] CAN_FM1R_DEF
    ...
    $0e constant CAN_FBM14                      \ [0x0e] Filter mode
    $0f constant CAN_FBM15                      \ [0x0f] Filter mode
    $10 constant CAN_FBM16                      \ [0x10] Filter mode
    $11 constant CAN_FBM17                      \ [0x11] Filter mode
    $12 constant CAN_FBM18                      \ [0x12] Filter mode
    $13 constant CAN_FBM19                      \ [0x13] Filter mode
    $14 constant CAN_FBM20                      \ [0x14] Filter mode
    $15 constant CAN_FBM21                      \ [0x15] Filter mode
    $16 constant CAN_FBM22                      \ [0x16] Filter mode
    $17 constant CAN_FBM23                      \ [0x17] Filter mode
    $18 constant CAN_FBM24                      \ [0x18] Filter mode
    $19 constant CAN_FBM25                      \ [0x19] Filter mode
    $1a constant CAN_FBM26                      \ [0x1a] Filter mode
    $1b constant CAN_FBM27                      \ [0x1b] Filter mode
  [then]
  ...
  [ifdef] CAN_FS1R_DEF
    ...
    $0e constant CAN_FSC14                      \ [0x0e] Filter scale configuration
    $0f constant CAN_FSC15                      \ [0x0f] Filter scale configuration
    $10 constant CAN_FSC16                      \ [0x10] Filter scale configuration
    $11 constant CAN_FSC17                      \ [0x11] Filter scale configuration
    $12 constant CAN_FSC18                      \ [0x12] Filter scale configuration
    $13 constant CAN_FSC19                      \ [0x13] Filter scale configuration
    $14 constant CAN_FSC20                      \ [0x14] Filter scale configuration
    $15 constant CAN_FSC21                      \ [0x15] Filter scale configuration
    $16 constant CAN_FSC22                      \ [0x16] Filter scale configuration
    $17 constant CAN_FSC23                      \ [0x17] Filter scale configuration
    $18 constant CAN_FSC24                      \ [0x18] Filter scale configuration
    $19 constant CAN_FSC25                      \ [0x19] Filter scale configuration
    $1a constant CAN_FSC26                      \ [0x1a] Filter scale configuration
    $1b constant CAN_FSC27                      \ [0x1b] Filter scale configuration
  [then]
  ...
  [ifdef] CAN_FFA1R_DEF
    ...
    $0e constant CAN_FFA14                      \ [0x0e] Filter FIFO assignment for filter 14
    $0f constant CAN_FFA15                      \ [0x0f] Filter FIFO assignment for filter 15
    $10 constant CAN_FFA16                      \ [0x10] Filter FIFO assignment for filter 16
    $11 constant CAN_FFA17                      \ [0x11] Filter FIFO assignment for filter 17
    $12 constant CAN_FFA18                      \ [0x12] Filter FIFO assignment for filter 18
    $13 constant CAN_FFA19                      \ [0x13] Filter FIFO assignment for filter 19
    $14 constant CAN_FFA20                      \ [0x14] Filter FIFO assignment for filter 20
    $15 constant CAN_FFA21                      \ [0x15] Filter FIFO assignment for filter 21
    $16 constant CAN_FFA22                      \ [0x16] Filter FIFO assignment for filter 22
    $17 constant CAN_FFA23                      \ [0x17] Filter FIFO assignment for filter 23
    $18 constant CAN_FFA24                      \ [0x18] Filter FIFO assignment for filter 24
    $19 constant CAN_FFA25                      \ [0x19] Filter FIFO assignment for filter 25
    $1a constant CAN_FFA26                      \ [0x1a] Filter FIFO assignment for filter 26
    $1b constant CAN_FFA27                      \ [0x1b] Filter FIFO assignment for filter 27
  [then]
  ...
  [ifdef] CAN_FA1R_DEF
    ...
    $0e constant CAN_FACT14                     \ [0x0e] Filter active
    $0f constant CAN_FACT15                     \ [0x0f] Filter active
    $10 constant CAN_FACT16                     \ [0x10] Filter active
    $11 constant CAN_FACT17                     \ [0x11] Filter active
    $12 constant CAN_FACT18                     \ [0x12] Filter active
    $13 constant CAN_FACT19                     \ [0x13] Filter active
    $14 constant CAN_FACT20                     \ [0x14] Filter active
    $15 constant CAN_FACT21                     \ [0x15] Filter active
    $16 constant CAN_FACT22                     \ [0x16] Filter active
    $17 constant CAN_FACT23                     \ [0x17] Filter active
    $18 constant CAN_FACT24                     \ [0x18] Filter active
    $19 constant CAN_FACT25                     \ [0x19] Filter active
    $1a constant CAN_FACT26                     \ [0x1a] Filter active
    $1b constant CAN_FACT27                     \ [0x1b] Filter active
  [then]
  ...
  \ @brief Controller area network
  \
  $00 constant CAN_MCR                  \ master control register
  $04 constant CAN_MSR                  \ master status register
  $08 constant CAN_TSR                  \ transmit status register
  $0C constant CAN_RF0R                 \ receive FIFO 0 register
  $10 constant CAN_RF1R                 \ receive FIFO 1 register
  $14 constant CAN_IER                  \ interrupt enable register
  $18 constant CAN_ESR                  \ error status register
  $1C constant CAN_BTR                  \ bit timing register
  $180 constant CAN_TI0R                \ TX mailbox identifier register
  $184 constant CAN_TDT0R               \ mailbox data length control and time stamp register
  $188 constant CAN_TDL0R               \ mailbox data low register
  $18C constant CAN_TDH0R               \ mailbox data high register
  $190 constant CAN_TI1R                \ TX mailbox identifier register
  $194 constant CAN_TDT1R               \ mailbox data length control and time stamp register
  $198 constant CAN_TDL1R               \ mailbox data low register
  $19C constant CAN_TDH1R               \ mailbox data high register
  $1A0 constant CAN_TI2R                \ TX mailbox identifier register
  $1A4 constant CAN_TDT2R               \ mailbox data length control and time stamp register
  $1A8 constant CAN_TDL2R               \ mailbox data low register
  $1AC constant CAN_TDH2R               \ mailbox data high register
  $1B0 constant CAN_RI0R                \ receive FIFO mailbox identifier register
  $1B4 constant CAN_RDT0R               \ receive FIFO mailbox data length control and time stamp register
  $1B8 constant CAN_RDL0R               \ receive FIFO mailbox data low register
  $1BC constant CAN_RDH0R               \ receive FIFO mailbox data high register
  $1C0 constant CAN_RI1R                \ receive FIFO mailbox identifier register
  $1C4 constant CAN_RDT1R               \ receive FIFO mailbox data length control and time stamp register
  $1C8 constant CAN_RDL1R               \ receive FIFO mailbox data low register
  $1CC constant CAN_RDH1R               \ receive FIFO mailbox data high register
  $200 constant CAN_FMR                 \ filter master register
  $204 constant CAN_FM1R                \ filter mode register
  $20C constant CAN_FS1R                \ filter scale register
  $214 constant CAN_FFA1R               \ filter FIFO assignment register
  $21C constant CAN_FA1R                \ CAN filter activation register
  ...
  $2B0 constant CAN_F14R1               \ Filter bank 14 register 1
  $2B4 constant CAN_F14R2               \ Filter bank 14 register 2
  $2B8 constant CAN_F15R1               \ Filter bank 15 register 1
  $2BC constant CAN_F15R2               \ Filter bank 15 register 2
  $2C0 constant CAN_F16R1               \ Filter bank 16 register 1
  $2C4 constant CAN_F16R2               \ Filter bank 16 register 2
  $2C8 constant CAN_F17R1               \ Filter bank 17 register 1
  $2CC constant CAN_F17R2               \ Filter bank 17 register 2
  $2D0 constant CAN_F18R1               \ Filter bank 18 register 1
  $2D4 constant CAN_F18R2               \ Filter bank 18 register 2
  $2D8 constant CAN_F19R1               \ Filter bank 19 register 1
  $2DC constant CAN_F19R2               \ Filter bank 19 register 2
  $2E0 constant CAN_F20R1               \ Filter bank 20 register 1
  $2E4 constant CAN_F20R2               \ Filter bank 20 register 2
  $2E8 constant CAN_F21R1               \ Filter bank 21 register 1
  $2EC constant CAN_F21R2               \ Filter bank 21 register 2
  $2F0 constant CAN_F22R1               \ Filter bank 22 register 1
  $2F4 constant CAN_F22R2               \ Filter bank 22 register 2
  $2F8 constant CAN_F23R1               \ Filter bank 23 register 1
  $2FC constant CAN_F23R2               \ Filter bank 23 register 2
  $300 constant CAN_F24R1               \ Filter bank 24 register 1
  $304 constant CAN_F24R2               \ Filter bank 24 register 2
  $308 constant CAN_F25R1               \ Filter bank 25 register 1
  $30C constant CAN_F25R2               \ Filter bank 25 register 2
  $310 constant CAN_F26R1               \ Filter bank 26 register 1
  $314 constant CAN_F26R2               \ Filter bank 26 register 2
  $318 constant CAN_F27R1               \ Filter bank 27 register 1
  $31C constant CAN_F27R2               \ Filter bank 27 register 2
