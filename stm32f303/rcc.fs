...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CFGR_DEF
    ...
    $0f constant RCC_PLLSRC                     \ [0x0f : 2] PLL entry clock source
    $11 constant RCC_PLLXTPRE                   \ [0x11] HSE divider for PLL entry
    $12 constant RCC_PLLMUL                     \ [0x12 : 4] PLL Multiplication Factor
    $16 constant RCC_USBPRES                    \ [0x16] USB prescaler
    $17 constant RCC_I2SSRC                     \ [0x17] I2S external clock source selection
    $18 constant RCC_MCO                        \ [0x18 : 3] Microcontroller clock output
    $1c constant RCC_MCOF                       \ [0x1c] Microcontroller Clock Output Flag
  [then]
  ...
  [ifdef] RCC_AHBENR_DEF
    ...
    $05 constant RCC_FMCEN                      \ [0x05] FMC clock enable
    $06 constant RCC_CRCEN                      \ [0x06] CRC clock enable
    $10 constant RCC_IOPHEN                     \ [0x10] IO port H clock enable
    ...
    $17 constant RCC_IOPGEN                     \ [0x17] I/O port G clock enable
    $18 constant RCC_TSCEN                      \ [0x18] Touch sensing controller clock enable
    $1c constant RCC_ADC12EN                    \ [0x1c] ADC1 and ADC2 clock enable
    $1d constant RCC_ADC34EN                    \ [0x1d] ADC3 and ADC4 clock enable
  [then]
  ...
  [ifdef] RCC_APB1ENR_DEF
    ...
    $13 constant RCC_USART4EN                   \ [0x13] USART 4 clock enable
    $14 constant RCC_USART5EN                   \ [0x14] USART 5 clock enable
  ...
  [ifdef] RCC_AHBRSTR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $05 constant RCC_FMCRST                     \ [0x05] FMC reset
    $10 constant RCC_IOPHRST                    \ [0x10] I/O port H reset
    ...
    $17 constant RCC_IOPGRST                    \ [0x17] Touch sensing controller reset
    $18 constant RCC_TSCRST                     \ [0x18] Touch sensing controller reset
    $1c constant RCC_ADC12RST                   \ [0x1c] ADC1 and ADC2 reset
    $1d constant RCC_ADC34RST                   \ [0x1d] ADC3 and ADC4 reset
  [then]
  ...
  [ifdef] RCC_CFGR2_DEF
    ...
    $04 constant RCC_ADC12PRES                  \ [0x04 : 5] ADC1 and ADC2 prescaler
    $09 constant RCC_ADC34PRES                  \ [0x09 : 5] ADC3 and ADC4 prescaler
  [then]
  ...
  [ifdef] RCC_CFGR3_DEF
    ...
    $06 constant RCC_I2C3SW                     \ [0x06] I2C3 clock source selection
    $08 constant RCC_TIM1SW                     \ [0x08] Timer1 clock source selection
    $09 constant RCC_TIM8SW                     \ [0x09] Timer8 clock source selection
    ...
    $14 constant RCC_UART4SW                    \ [0x14 : 2] UART4 clock source selection
    $16 constant RCC_UART5SW                    \ [0x16 : 2] UART5 clock source selection
  [then]
