...
[ifndef] EXTI_DEF
  ...
  [ifdef] EXTI_RTSR1_DEF
    ...
    $1d constant EXTI_TR29                      \ [0x1d] Rising trigger event configuration of line 29
    $1e constant EXTI_TR30                      \ [0x1e] Rising trigger event configuration of line 30
    $1f constant EXTI_TR31                      \ [0x1f] Rising trigger event configuration of line 31
  [then]
  ...
  [ifdef] EXTI_FTSR1_DEF
    ...
    $1d constant EXTI_TR29                      \ [0x1d] Falling trigger event configuration of line 29
    $1e constant EXTI_TR30                      \ [0x1e] Falling trigger event configuration of line 30.
    $1f constant EXTI_TR31                      \ [0x1f] Falling trigger event configuration of line 31
  [then]
  ...
  [ifdef] EXTI_SWIER1_DEF
    ...
    $1d constant EXTI_SWIER29                   \ [0x1d] Software Interrupt on line 29
    $1e constant EXTI_SWIER30                   \ [0x1e] Software Interrupt on line 309
    $1f constant EXTI_SWIER31                   \ [0x1f] Software Interrupt on line 319
  [then]
  ...
  [ifdef] EXTI_PR1_DEF
    ...
    $1d constant EXTI_PR29                      \ [0x1d] Pending bit 29
    $1e constant EXTI_PR30                      \ [0x1e] Pending bit 30
    $1f constant EXTI_PR31                      \ [0x1f] Pending bit 31
  [then]
  ...
  [ifdef] EXTI_RTSR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant EXTI_TR32                      \ [0x00] Rising trigger event configuration bit of line 32
    $01 constant EXTI_TR33                      \ [0x01] Rising trigger event configuration bit of line 33
  [then]
  ...
  [ifdef] EXTI_FTSR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant EXTI_TR32                      \ [0x00] Falling trigger event configuration bit of line 32
    $01 constant EXTI_TR33                      \ [0x01] Falling trigger event configuration bit of line 33
  [then]
  ...
  [ifdef] EXTI_SWIER2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant EXTI_SWIER32                   \ [0x00] Software interrupt on line 32
    $01 constant EXTI_SWIER33                   \ [0x01] Software interrupt on line 33
  [then]
  ...
  [ifdef] EXTI_PR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant EXTI_PR32                      \ [0x00] Pending bit on line 32
    $01 constant EXTI_PR33                      \ [0x01] Pending bit on line 33
  [then]
  ...
  $18 constant EXTI_IMR2                \ Interrupt mask register
  $1C constant EXTI_EMR2                \ Event mask register
