...
[ifndef] FLASH_DEF
  ...
  [ifdef] FLASH_SR_DEF
    ...
    $11 constant FLASH_PEMPTY                   \ [0x11] Program EMPTY
  [then]
  ...
  [ifdef] FLASH_ECCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_ADDR_ECC                 \ [0x00 : 21] ECC fail address
    $15 constant FLASH_BK_ECC                   \ [0x15] ECC fail bank
    $16 constant FLASH_SYSF_ECC                 \ [0x16] System Flash ECC fail
    $18 constant FLASH_ECCIE                    \ [0x18] ECC correction interrupt enable
    $1c constant FLASH_ECCC2                    \ [0x1c] ECC correction
    $1d constant FLASH_ECCD2                    \ [0x1d] ECC2 detection
  ...
  [ifdef] FLASH_OPTR_DEF
    ...
    $15 constant FLASH_DB1M                     \ [0x15] Dual-bank on 1 Mbyte Flash memory devices
  ...
  [ifdef] FLASH_PCROP1SR_DEF
    ...
    \
    $00 constant FLASH_PCROP1_STRT              \ [0x00 : 17] Bank 1 PCROP area start offset
  [then]
  ...
  [ifdef] FLASH_PCROP1ER_DEF
    ...
    \
    $00 constant FLASH_PCROP1_END               \ [0x00 : 17] Bank 1 PCROP area end offset
  ...
  [ifdef] FLASH_WRP2AR_DEF
    ...
    \ Reset value: 0xFF00FF00
    \
    $00 constant FLASH_WRP2A_STRT               \ [0x00 : 8] WRP first area A start offset
    $10 constant FLASH_WRP2A_END                \ [0x10 : 8] WRP first area A end offset
  [then]
  ...
  [ifdef] FLASH_PCROP2SR_DEF
    ...
    \ Reset value: 0xFFFFFFFF
    \
    $00 constant FLASH_PCROP2_STRT              \ [0x00 : 17] PCROP area start offset
  [then]
  ...
  [ifdef] FLASH_PCROP2ER_DEF
    ...
    \ Reset value: 0x0FF00000
    \
    $00 constant FLASH_PCROP2_END               \ [0x00 : 17] Bank 2 PCROP area end offset
  [then]
  ...
  [ifdef] FLASH_WRP1BR_DEF
    ...
    \ Reset value: 0xFF00FF00
    \
    $00 constant FLASH_WRP1B_STRT               \ [0x00 : 8] Bank 2 WRP first area A start offset
    $10 constant FLASH_WRP1B_END                \ [0x10 : 8] Bank 2 WRP first area A end offset
  [then]
  ...
  [ifdef] FLASH_CFGR_DEF
    \
    \ @brief Flash configuration register
    \ Address offset: 0x130
    \ Reset value: 0x00000000
    \
    $00 constant FLASH_LVEN                     \ [0x00] Low voltage enable
  [then]
  ...
  $30 constant FLASH_WRP2AR             \ Flash WRP2 area A address register
  $44 constant FLASH_PCROP2SR           \ Flash PCROP2 Start address register
  $48 constant FLASH_PCROP2ER           \ Flash PCROP2 End address register
  $4C constant FLASH_WRP1BR             \ Flash WRP1 area B address register
  $50 constant FLASH_WRP2BR             \ Flash Bank 2 WRP area B address register
  $130 constant FLASH_CFGR              \ Flash configuration register
