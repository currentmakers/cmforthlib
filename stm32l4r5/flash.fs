...
$00020000 constant FLASH_SR_PEMPTY                                  \ Program EMPTY
...
$001fffff constant FLASH_ECCR_ADDR_ECC                              \ ECC fail address
$00200000 constant FLASH_ECCR_BK_ECC                                \ ECC fail bank
$00400000 constant FLASH_ECCR_SYSF_ECC                              \ System Flash ECC fail
$01000000 constant FLASH_ECCR_ECCIE                                 \ ECC correction interrupt enable
$10000000 constant FLASH_ECCR_ECCC2                                 \ ECC correction
$20000000 constant FLASH_ECCR_ECCD2                                 \ ECC2 detection
...
$00200000 constant FLASH_OPTR_DB1M                                  \ Dual-bank on 1 Mbyte Flash memory devices
...
$0001ffff constant FLASH_PCROP1SR_PCROP1_STRT                       \ Bank 1 PCROP area start offset


\
\ @brief Flash Bank 1 PCROP End address register
\ Address offset: 0x28
\ Reset value: 0x0FF00000
\

$0001ffff constant FLASH_PCROP1ER_PCROP1_END                        \ Bank 1 PCROP area end offset
...
$000000ff constant FLASH_WRP1AR_WRP1A_STRT                          \ Bank 1 WRP first area start offset
...
$000000ff constant FLASH_WRP2AR_WRP2A_STRT                          \ WRP first area A start offset
$00ff0000 constant FLASH_WRP2AR_WRP2A_END                           \ WRP first area A end offset


\
\ @brief Flash PCROP2 Start address register
\ Address offset: 0x44
\ Reset value: 0xFFFFFFFF
\

$0001ffff constant FLASH_PCROP2SR_PCROP2_STRT                       \ PCROP area start offset


\
\ @brief Flash PCROP2 End address register
\ Address offset: 0x48
\ Reset value: 0x0FF00000
\

$0001ffff constant FLASH_PCROP2ER_PCROP2_END                        \ Bank 2 PCROP area end offset
...
$000000ff constant FLASH_WRP1BR_WRP1B_STRT                          \ Bank 2 WRP first area A start offset
$00ff0000 constant FLASH_WRP1BR_WRP1B_END                           \ Bank 2 WRP first area A end offset
...
$00000001 constant FLASH_CFGR_LVEN                                  \ Low voltage enable
...
$40022030 constant FLASH_WRP2AR   \ offset: 0x30 : Flash WRP2 area A address register
$40022044 constant FLASH_PCROP2SR  \ offset: 0x44 : Flash PCROP2 Start address register
$40022048 constant FLASH_PCROP2ER  \ offset: 0x48 : Flash PCROP2 End address register
$4002204c constant FLASH_WRP1BR   \ offset: 0x4C : Flash WRP1 area B address register
$40022050 constant FLASH_WRP2BR   \ offset: 0x50 : Flash Bank 2 WRP area B address register
$40022130 constant FLASH_CFGR     \ offset: 0x130 : Flash configuration register
