...
[ifndef] TIM5_DEF
  ...
  [ifdef] TIM5_SMCR_DEF
    ...
    $10 constant TIM5_SMS_3                     \ [0x10] Slave model selection - bit[3]
  [then]
  ...
  [ifdef] TIM5_CCMR1_Output_DEF
    ...
    $02 constant TIM5_OC1FE                     \ [0x02] OC1FE
    $03 constant TIM5_OC1PE                     \ [0x03] OC1PE
    $04 constant TIM5_OC1M                      \ [0x04 : 3] OC1M
    $07 constant TIM5_OC1CE                     \ [0x07] OC1CE
    $08 constant TIM5_CC2S                      \ [0x08 : 2] CC2S
    $0a constant TIM5_OC2FE                     \ [0x0a] OC2FE
    $0b constant TIM5_OC2PE                     \ [0x0b] OC2PE
    $0c constant TIM5_OC2M                      \ [0x0c : 3] OC2M
    $0f constant TIM5_OC2CE                     \ [0x0f] OC2CE
    $10 constant TIM5_OC1M_3                    \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM5_OC2M_3                    \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM5_CCMR1_Input_DEF
    ...
    $02 constant TIM5_ICPCS                     \ [0x02 : 2] Input capture 1 prescaler
    $04 constant TIM5_IC1F                      \ [0x04 : 4] Input capture 1 filter
    $08 constant TIM5_CC2S                      \ [0x08 : 2] Capture/Compare 2 selection
    $0a constant TIM5_IC2PCS                    \ [0x0a : 2] Input capture 2 prescaler
  ...
  [ifdef] TIM5_CCMR2_Output_DEF
    ...
    $02 constant TIM5_OC3FE                     \ [0x02] OC3FE
    $03 constant TIM5_OC3PE                     \ [0x03] OC3PE
    $04 constant TIM5_OC3M                      \ [0x04 : 3] OC3M
    $07 constant TIM5_OC3CE                     \ [0x07] OC3CE
    $08 constant TIM5_CC4S                      \ [0x08 : 2] CC4S
    $0a constant TIM5_OC4FE                     \ [0x0a] OC4FE
    $0b constant TIM5_OC4PE                     \ [0x0b] OC4PE
    $0c constant TIM5_OC4M                      \ [0x0c : 3] OC4M
    $0f constant TIM5_O24CE                     \ [0x0f] O24CE
    $10 constant TIM5_OC3M_3                    \ [0x10] Output Compare 1 mode - bit 3
    $18 constant TIM5_OC4M_3                    \ [0x18] Output Compare 2 mode - bit 3
  [then]
  ...
  [ifdef] TIM5_OR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $06 constant TIM5_TI4_RMP                   \ [0x06 : 2] Timer Input 4 remap
  [then]
  ...
  $50 constant TIM5_OR                  \ option register 1
