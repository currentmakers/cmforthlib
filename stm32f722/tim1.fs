...
[ifndef] TIM1_DEF
  ...
  [ifdef] TIM1_SMCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM1_SMS                       \ [0x00 : 3] Slave mode selection - bit[2:0]
    ...
    $10 constant TIM1_SMS_3                     \ [0x10] Slave model selection - bit[3]
  [then]
  ...
  $1C constant TIM1_CCMR2_INPUT         \ capture/compare mode register 1 (input mode)
