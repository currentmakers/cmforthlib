...
[ifndef] RTC_DEF
  ...
  [ifdef] RTC_CALR_DEF
    ...
    $15 constant RTC_LPCAL                      \ [0x15] Calibration low-power mode
  [then]
  ...
  [ifdef] RTC_ALRMBSSR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RTC_SS                         \ [0x00 : 15] Sub second value
    $18 constant RTC_MASKSS                     \ [0x18 : 4] Mask the most-significant bits starting at this bit
  [then]
  ...
  $28 constant RTC_CALR                 \ RTC calibration register
  ...
  $40 constant RTC_ALRMAR               \ RTC alarm A register
  $44 constant RTC_ALRMASSR             \ alarm A sub second register
  $48 constant RTC_ALRMBR               \ RTC alarm B register
  $4C constant RTC_ALRMBSSR             \ alarm B sub second register
  $50 constant RTC_SR                   \ RTC status register
  $54 constant RTC_MISR                 \ RTC masked interrupt status register
