...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_CCIPR_DEF
    ...
    $1c constant RCC_ADCSEL                     \ [0x1c : 2] ADCSEL
  [then]
  ...
  [ifdef] RCC_CCIPR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant RCC_I2C4SEL_0                  \ [0x00] I2C4 clock source selection
    $01 constant RCC_I2C4SEL_1                  \ [0x01] I2C4 clock source selection
  [then]
