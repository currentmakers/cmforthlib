...
[ifndef] RCC_DEF
  ...
  [ifdef] RCC_ICSCR_DEF
    ...
    $18 constant RCC_HSITRIM                    \ [0x18 : 5] HSI clock trimming
  [then]
  ...
  [ifdef] RCC_AHB1RSTR_DEF
    ...
    $0b constant RCC_CRCRST                     \ [0x0b] CRC reset
  ...
  [ifdef] RCC_APB1RSTR1_DEF
    ...
    $12 constant RCC_USART1RST                  \ [0x12] USART1 reset
  ...
  [ifdef] RCC_APB2RSTR_DEF
    ...
    $18 constant RCC_DFSDMRST                   \ [0x18] DFSDM filter reset
  [then]
  ...
  [ifdef] RCC_APB1ENR1_DEF
    ...
    $0e constant RCC_SPI1EN                     \ [0x0e] SPI1 clock enable
    $0f constant RCC_SPI3EN                     \ [0x0f] SPI3 clock enable
    $11 constant RCC_USART2EN                   \ [0x11] USART2 clock enable
    $12 constant RCC_USART1EN                   \ [0x12] USART1 clock enable
    ...
    $1a constant RCC_USBF                       \ [0x1a] USB FS clock enable
  ...
  [ifdef] RCC_APB1ENR2_DEF
    ...
    $18 constant RCC_DFSDMEN                    \ [0x18] DFSDMEN enable
  [then]
  ...
  [ifdef] RCC_APB1SMENR1_DEF
    ...
    $11 constant RCC_USART1SMEN                 \ [0x11] USART1 clocks enable during Sleep and Stop modes
    $12 constant RCC_USART2SMEN                 \ [0x12] USART2 clocks enable during Sleep and Stop modes
    ...
    $1a constant RCC_USBFSSMEN                  \ [0x1a] USB FS clock enable during Sleep and Stop modes
  ...
  [ifdef] RCC_CCIPR_DEF
    ...
    $06 constant RCC_USART4SEL                  \ [0x06 : 2] USART4 clock source selection
