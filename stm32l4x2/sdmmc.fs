...
[ifndef] SDMMC_DEF
  ...
  [ifdef] SDMMC_CMD_DEF
    ...
    $0c constant SDMMC_ENCMDcompl               \ [0x0c] Enable CMD completion
    $0d constant SDMMC_nIEN                     \ [0x0d] not Interrupt Enable
    $0e constant SDMMC_CE_ATACMD                \ [0x0e] CE-ATA command
  [then]
  ...
  [ifdef] SDMMC_STA_DEF
    ...
    $09 constant SDMMC_STBITERR                 \ [0x09] Start bit not detected on all data signals in wide bus mode
    ...
    $17 constant SDMMC_CEATAEND                 \ [0x17] CE-ATA command completion signal received for CMD61
  [then]
  ...
  [ifdef] SDMMC_ICR_DEF
    ...
    $09 constant SDMMC_STBITERRC                \ [0x09] STBITERR flag clear bit
    $0a constant SDMMC_DBCKENDC                 \ [0x0a] DBCKEND flag clear bit
    $16 constant SDMMC_SDIOITC                  \ [0x16] SDIOIT flag clear bit
    $17 constant SDMMC_CEATAENDC                \ [0x17] CEATAEND flag clear bit
  [then]
  ...
  [ifdef] SDMMC_MASK_DEF
    ...
    $09 constant SDMMC_STBITERRIE               \ [0x09] Start bit error interrupt enable
    ...
    $17 constant SDMMC_CEATAENDIE               \ [0x17] CE-ATA command completion signal received interrupt enable
  [then]
