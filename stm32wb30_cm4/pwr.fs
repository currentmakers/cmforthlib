...
[ifndef] PWR_DEF
  ...
  [ifdef] PWR_CR5_DEF
    ...
    \
    $00 constant PWR_SDVOS                      \ [0x00 : 4] Step Down converter voltage output scaling
    $04 constant PWR_SDSC                       \ [0x04 : 3] Step Down converter supplt startup current selection
    $08 constant PWR_BORHC                      \ [0x08] BORH configuration selection
    $09 constant PWR_SMPSCFG                    \ [0x09] VOS configuration selection (non user)
    $0e constant PWR_SDBEN                      \ [0x0e] Enable Step Down converter Bypass mode enabled
    $0f constant PWR_SDEB                       \ [0x0f] Enable Step Down converter SMPS mode enabled
  [then]
