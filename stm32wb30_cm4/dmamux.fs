...
[ifndef] DMAMUX_DEF
  ...
  [ifdef] DMAMUX_RGCFR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DMAMUX_COF0                    \ [0x00] Clear trigger Overrun Flag 0
    $01 constant DMAMUX_COF1                    \ [0x01] Clear trigger Overrun Flag 1
    $02 constant DMAMUX_COF2                    \ [0x02] Clear trigger Overrun Flag 2
    $03 constant DMAMUX_COF3                    \ [0x03] Clear trigger Overrun Flag 3
  [then]
