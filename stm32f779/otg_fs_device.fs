...
[ifndef] OTG_FS_DEVICE_DEF
  ...
  [ifdef] OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55_DEF
    \
  ...
  [ifdef] OTG_FS_DEVICE_OTG_FS_DTXFSTS55_DEF
    \
    \ @brief OTG_FS device IN endpoint transmit FIFO status register
  ...
  $194 constant OTG_FS_DEVICE_OTG_FS_DIEPTSIZ4    \ device endpoint-4 transfer size register
  $19C constant OTG_FS_DEVICE_OTG_FS_DTXFSTS4    \ OTG_FS device IN endpoint transmit FIFO status register
  ...
  $1B0 constant OTG_FS_DEVICE_OTG_FS_DIEPTSIZ55    \ device endpoint-5 transfer size register
  $1B8 constant OTG_FS_DEVICE_OTG_FS_DTXFSTS55    \ OTG_FS device IN endpoint transmit FIFO status register
  ...
  $378 constant OTG_FS_DEVICE_OTG_FS_DOEPCTL4    \ device endpoint-4 control register
  $380 constant OTG_FS_DEVICE_OTG_FS_DOEPINT4    \ device endpoint-4 interrupt register
  $388 constant OTG_FS_DEVICE_OTG_FS_DOEPTSIZ4    \ device OUT endpoint-4 transfer size register
  $390 constant OTG_FS_DEVICE_OTG_FS_DOEPCTL5    \ device endpoint-5 control register
  $398 constant OTG_FS_DEVICE_OTG_FS_DOEPINT5    \ device endpoint-5 interrupt register
  $3A0 constant OTG_FS_DEVICE_OTG_FS_DOEPTSIZ5    \ device OUT endpoint-5 transfer size register
