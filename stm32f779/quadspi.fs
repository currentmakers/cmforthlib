...
[ifndef] QUADSPI_DEF
  ...
  [ifdef] QUADSPI_CR_DEF
    ...
    $06 constant QUADSPI_DFM                    \ [0x06] Dual-flash mode
    $07 constant QUADSPI_FSEL                   \ [0x07] FLASH memory selection
  ...
  [ifdef] QUADSPI_SR_DEF
    ...
    $08 constant QUADSPI_FLEVEL                 \ [0x08 : 7] FIFO level
  [then]
  ...
  [ifdef] QUADSPI_CCR_DEF
    ...
    $1e constant QUADSPI_DHHC                   \ [0x1e] DDR hold half cycle
