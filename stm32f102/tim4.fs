...
[ifndef] TIM4_DEF
  ...
  [ifdef] TIM4_ARR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_ARR                       \ [0x00 : 16] Auto-reload value
  [then]
  ...
  [ifdef] TIM4_CCR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR1                      \ [0x00 : 16] Capture/Compare 1 value
  [then]
  ...
  [ifdef] TIM4_CCR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR2                      \ [0x00 : 16] Capture/Compare 2 value
  [then]
  ...
  [ifdef] TIM4_CCR3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR3                      \ [0x00 : 16] Capture/Compare value
  [then]
  ...
  [ifdef] TIM4_CCR4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM4_CCR4                      \ [0x00 : 16] Capture/Compare value
  [then]
