...
[ifndef] SDIO_DEF
  ...
  [ifdef] SDIO_RESP1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS1               \ [0x00 : 32] Card Status
  [then]
  ...
  [ifdef] SDIO_RESP2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS2               \ [0x00 : 32] Card Status
  [then]
  ...
  [ifdef] SDIO_RESP3_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS3               \ [0x00 : 32] Card Status
  [then]
  ...
  [ifdef] SDIO_RESP4_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant SDIO_CARDSTATUS4               \ [0x00 : 32] Card Status
  [then]
