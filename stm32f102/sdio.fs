...
\ @brief Secure digital input/output interface
\
$40018000 constant SDIO_POWER     \ offset: 0x00 : power control register
$40018004 constant SDIO_CLKCR     \ offset: 0x04 : SDI clock control register
$40018008 constant SDIO_ARG       \ offset: 0x08 : argument register
$4001800c constant SDIO_CMD       \ offset: 0x0C : command register
$40018010 constant SDIO_RESPCMD   \ offset: 0x10 : command response register
$40018014 constant SDIO_RESP1     \ offset: 0x14 : response 1..4 register
$40018018 constant SDIO_RESP2     \ offset: 0x18 : response 1..4 register
$4001801c constant SDIO_RESP3     \ offset: 0x1C : response 1..4 register
$40018020 constant SDIO_RESP4     \ offset: 0x20 : response 1..4 register
$40018024 constant SDIO_DTIMER    \ offset: 0x24 : data timer register
$40018028 constant SDIO_DLEN      \ offset: 0x28 : data length register
$4001802c constant SDIO_DCTRL     \ offset: 0x2C : data control register
$40018030 constant SDIO_DCOUNT    \ offset: 0x30 : data counter register
$40018034 constant SDIO_STA       \ offset: 0x34 : status register
$40018038 constant SDIO_ICR       \ offset: 0x38 : interrupt clear register
$4001803c constant SDIO_MASK      \ offset: 0x3C : mask register
$40018048 constant SDIO_FIFOCNT   \ offset: 0x48 : FIFO counter register
$40018080 constant SDIO_FIFO      \ offset: 0x80 : data FIFO register
