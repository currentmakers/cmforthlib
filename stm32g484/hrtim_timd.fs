...
[ifndef] HRTIM_TIMD_DEF
  ...
  [ifdef] HRTIM_TIMD_TIMDCR_DEF
    ...
    $07 constant HRTIM_TIMD_INTLVD              \ [0x07 : 2] Interleaved mode
    $09 constant HRTIM_TIMD_RSYNCU              \ [0x09] Re-Synchronized Update
  ...
  [ifdef] HRTIM_TIMD_TIMDISR_DEF
    ...
    $14 constant HRTIM_TIMD_O1CPY               \ [0x14] Output 1 Copy
    $15 constant HRTIM_TIMD_O2CPY               \ [0x15] Output 2 Copy
  [then]
  ...
  [ifdef] HRTIM_TIMD_CPT1DR_DEF
    ...
    $10 constant HRTIM_TIMD_DIR                 \ [0x10] Timerx Capture 1 Direction status
  [then]
  ...
  [ifdef] HRTIM_TIMD_RSTDR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_TIMD_TIMFCMP1            \ [0x00] Timer A Update reset
    ...
    $1f constant HRTIM_TIMD_TIMFCPM2            \ [0x1f] Timer F Compare 2
  [then]
  ...
  [ifdef] HRTIM_TIMD_CPT1DCR_DEF
    ...
    $18 constant HRTIM_TIMD_TF1SET              \ [0x18] TF1SET
    $19 constant HRTIM_TIMD_TF1RST              \ [0x19] TF1RST
    $1a constant HRTIM_TIMD_TFCMP1              \ [0x1a] TFCMP1
    $1b constant HRTIM_TIMD_TFCMP2              \ [0x1b] TFCMP2
  ...
  [ifdef] HRTIM_TIMD_OUTDR_DEF
    ...
    $0e constant HRTIM_TIMD_BIAR                \ [0x0e] Balanced Idle Automatic Resume
  ...
  [ifdef] HRTIM_TIMD_FLTDR_DEF
    ...
    $05 constant HRTIM_TIMD_FLT6EN              \ [0x05] Fault 6 enable
    $1f constant HRTIM_TIMD_FLTLCK              \ [0x1f] Fault sources Lock
  [then]


  [ifdef] HRTIM_TIMD_TIMDCR2_DEF
    \
    \ @brief HRTIM Timerx Control Register 2
    \ Address offset: 0x6C
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_TIMD_DCDE                \ [0x00] Dual Channel DAC trigger enable
    $01 constant HRTIM_TIMD_DCDS                \ [0x01] Dual Channel DAC Step trigger
    $02 constant HRTIM_TIMD_DCDR                \ [0x02] Dual Channel DAC Reset trigger
    $04 constant HRTIM_TIMD_UDM                 \ [0x04] Up-Down Mode
    $06 constant HRTIM_TIMD_ROM                 \ [0x06 : 2] Roll-Over Mode
    $08 constant HRTIM_TIMD_OUTROM              \ [0x08 : 2] Output Roll-Over Mode
    $0a constant HRTIM_TIMD_ADROM               \ [0x0a : 2] ADC Roll-Over Mode
    $0c constant HRTIM_TIMD_BMROM               \ [0x0c : 2] Burst Mode Roll-Over Mode
    $0e constant HRTIM_TIMD_FEROM               \ [0x0e : 2] Fault and Event Roll-Over Mode
    $10 constant HRTIM_TIMD_GTCMP1              \ [0x10] Greater than Compare 1 PWM mode
    $11 constant HRTIM_TIMD_GTCMP3              \ [0x11] Greater than Compare 3 PWM mode
    $14 constant HRTIM_TIMD_TRGHLF              \ [0x14] Triggered-half mode
  [then]


  [ifdef] HRTIM_TIMD_DEEFR3_DEF
    \
    \ @brief HRTIM Timerx External Event Filtering Register 3
    \ Address offset: 0x70
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_TIMD_EEVACE              \ [0x00] External Event A Counter Enable
    $01 constant HRTIM_TIMD_EEVACRES            \ [0x01] External Event A Counter Reset
    $02 constant HRTIM_TIMD_EEVARSTM            \ [0x02] External Event A Reset Mode
    $04 constant HRTIM_TIMD_EEVASEL             \ [0x04 : 4] External Event A Selection
    $08 constant HRTIM_TIMD_EEVACNT             \ [0x08 : 6] External Event A counter
  [then]
  ...
  $0C constant HRTIM_TIMD_TIMDDIER      \ TIMxDIER
  ...
  $6C constant HRTIM_TIMD_TIMDCR2       \ HRTIM Timerx Control Register 2
  $70 constant HRTIM_TIMD_DEEFR3        \ HRTIM Timerx External Event Filtering Register 3
