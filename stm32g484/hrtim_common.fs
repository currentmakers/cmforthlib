...
[ifndef] HRTIM_COMMON_DEF
  ...
  [ifdef] HRTIM_COMMON_CR1_DEF
    ...
    $06 constant HRTIM_COMMON_TFUDIS            \ [0x06] Timer f Update Disable
  ...
  [ifdef] HRTIM_COMMON_CR2_DEF
    ...
    $06 constant HRTIM_COMMON_TFSWU             \ [0x06] Timer f Software Update
    ...
    $0e constant HRTIM_COMMON_TFRST             \ [0x0e] Timer f counter software reset
    $10 constant HRTIM_COMMON_SWPA              \ [0x10] Swap Timer A outputs
    $11 constant HRTIM_COMMON_SWPB              \ [0x11] Swap Timer B outputs
    $12 constant HRTIM_COMMON_SWPC              \ [0x12] Swap Timer C outputs
    $13 constant HRTIM_COMMON_SWPD              \ [0x13] Swap Timer D outputs
    $14 constant HRTIM_COMMON_SWPE              \ [0x14] Swap Timer E outputs
    $15 constant HRTIM_COMMON_SWPF              \ [0x15] Swap Timer F outputs
  [then]
  ...
  [ifdef] HRTIM_COMMON_ISR_DEF
    ...
    $06 constant HRTIM_COMMON_FLT6              \ [0x06] Fault 6 Interrupt Flag
  ...
  [ifdef] HRTIM_COMMON_ICR_DEF
    ...
    $06 constant HRTIM_COMMON_FLT6C             \ [0x06] Fault 6 Interrupt Flag Clear
  ...
  [ifdef] HRTIM_COMMON_IER_DEF
    ...
    $06 constant HRTIM_COMMON_FLT6IE            \ [0x06] Fault 6 Interrupt Enable
  ...
  [ifdef] HRTIM_COMMON_OENR_DEF
    ...
    $0a constant HRTIM_COMMON_TF1ODS            \ [0x0a] Timer F Output 1 disable status
    $0b constant HRTIM_COMMON_TF2ODS            \ [0x0b] Timer F Output 2 disable status
  [then]
  ...
  [ifdef] HRTIM_COMMON_ODISR_DEF
    ...
    $0a constant HRTIM_COMMON_TF1ODIS           \ [0x0a] TF1ODIS
    $0b constant HRTIM_COMMON_TF2ODIS           \ [0x0b] TF2ODIS
  [then]
  ...
  [ifdef] HRTIM_COMMON_ODSR_DEF
    ...
    $0a constant HRTIM_COMMON_TF1ODS            \ [0x0a] TF1ODS
    $0b constant HRTIM_COMMON_TF2ODS            \ [0x0b] TF2ODS
  [then]
  ...
  [ifdef] HRTIM_COMMON_BMCR_DEF
    ...
    $16 constant HRTIM_COMMON_TFBM              \ [0x16] Timer f Burst Mode
    $1f constant HRTIM_COMMON_BMSTAT            \ [0x1f] Burst Mode Status
  [then]


  [ifdef] HRTIM_COMMON_BMTRG_DEF
    \
    \ @brief BMTRG
    \ Address offset: 0x24
    \ Reset value: 0x00000000
    ...
    $1b constant HRTIM_COMMON_TDEEV7            \ [0x1b] TDEEV7
  ...
  [ifdef] HRTIM_COMMON_EECR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_EE6SRC            \ [0x00 : 2] EE6SRC
    $02 constant HRTIM_COMMON_EE6POL            \ [0x02] EE6POL
    $03 constant HRTIM_COMMON_EE6SNS            \ [0x03 : 2] EE6SNS
    $06 constant HRTIM_COMMON_EE7SRC            \ [0x06 : 2] EE7SRC
    $08 constant HRTIM_COMMON_EE7POL            \ [0x08] EE7POL
    $09 constant HRTIM_COMMON_EE7SNS            \ [0x09 : 2] EE7SNS
    $0c constant HRTIM_COMMON_EE8SRC            \ [0x0c : 2] EE8SRC
    $0e constant HRTIM_COMMON_EE8POL            \ [0x0e] EE8POL
    $0f constant HRTIM_COMMON_EE8SNS            \ [0x0f : 2] EE8SNS
    $12 constant HRTIM_COMMON_EE9SRC            \ [0x12 : 2] EE9SRC
    $14 constant HRTIM_COMMON_EE9POL            \ [0x14] EE9POL
    $15 constant HRTIM_COMMON_EE9SNS            \ [0x15 : 2] EE9SNS
    $18 constant HRTIM_COMMON_EE10SRC           \ [0x18 : 2] EE10SRC
    $1a constant HRTIM_COMMON_EE10POL           \ [0x1a] EE10POL
    $1b constant HRTIM_COMMON_EE10SNS           \ [0x1b : 2] EE10SNS
  [then]
  ...
  [ifdef] HRTIM_COMMON_FLTINR2_DEF
    ...
    $08 constant HRTIM_COMMON_FLT6E             \ [0x08] FLT6E
    $09 constant HRTIM_COMMON_FLT6P             \ [0x09] FLT6P
    $0a constant HRTIM_COMMON_FLT6SRC_0         \ [0x0a] FLT6F
    $0b constant HRTIM_COMMON_FLT6F             \ [0x0b : 4] FLT6F
    $0f constant HRTIM_COMMON_FLT6LCK           \ [0x0f] FLT6LCK
    $10 constant HRTIM_COMMON_FLT1SRC_1         \ [0x10] FLT1SRC_1
    $11 constant HRTIM_COMMON_FLT2SRC_1         \ [0x11] FLT2SRC_1
    $12 constant HRTIM_COMMON_FLT3SRC_1         \ [0x12] FLT3SRC_1
    $13 constant HRTIM_COMMON_FLT4SRC_1         \ [0x13] FLT4SRC_1
    $14 constant HRTIM_COMMON_FLT5SRC_1         \ [0x14] FLT5SRC_1
    $15 constant HRTIM_COMMON_FLT6SRC_1         \ [0x15] FLT6SRC
  ...
  [ifdef] HRTIM_COMMON_BDTAUPR_DEF
    ...
    $15 constant HRTIM_COMMON_TIMxCR2           \ [0x15] TIMxCR2
    $16 constant HRTIM_COMMON_TIMxEEFR3         \ [0x16] TIMxEEFR3
  [then]
  ...
  [ifdef] HRTIM_COMMON_BDTFUPR_DEF
    \
    \ @brief Burst DMA Timerx update Register
    \ Address offset: 0x74
    \ Reset value: 0x00000000
  ...
  [ifdef] HRTIM_COMMON_ADCER_DEF
    \
    \ @brief HRTIM ADC Extended Trigger Register
    \ Address offset: 0x78
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_ADC5TRG           \ [0x00 : 5] ADC5TRG
    $05 constant HRTIM_COMMON_ADC6TRG           \ [0x05 : 5] ADC6TRG
    $0a constant HRTIM_COMMON_ADC7TRG           \ [0x0a : 5] ADC7TRG
    $10 constant HRTIM_COMMON_ADC8TRG           \ [0x10 : 5] ADC8TRG
    $15 constant HRTIM_COMMON_ADC9TRG           \ [0x15 : 5] ADC9TRG
    $1a constant HRTIM_COMMON_ADC10TRG          \ [0x1a : 5] ADC10TRG
  [then]


  [ifdef] HRTIM_COMMON_ADCUR_DEF
    \
    \ @brief HRTIM ADC Trigger Update Register
    \ Address offset: 0x7C
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_AD5USRC           \ [0x00 : 3] AD5USRC
    $04 constant HRTIM_COMMON_AD6USRC           \ [0x04 : 3] AD6USRC
    $08 constant HRTIM_COMMON_AD7USRC           \ [0x08 : 3] AD7USRC
    $0c constant HRTIM_COMMON_AD8USRC           \ [0x0c : 3] AD8USRC
    $10 constant HRTIM_COMMON_AD9USRC           \ [0x10 : 3] AD9USRC
    $14 constant HRTIM_COMMON_AD10USRC          \ [0x14 : 3] AD10USRC
  [then]


  [ifdef] HRTIM_COMMON_ADCPS1_DEF
    \
    \ @brief HRTIM ADC Post Scaler Register 1
    \ Address offset: 0x80
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_ADC1PSC           \ [0x00 : 5] ADC1PSC
    $06 constant HRTIM_COMMON_ADC2PSC           \ [0x06 : 5] ADC2PSC
    $0c constant HRTIM_COMMON_ADC3PSC           \ [0x0c : 5] ADC3PSC
    $12 constant HRTIM_COMMON_ADC4PSC           \ [0x12 : 5] ADC4PSC
    $18 constant HRTIM_COMMON_ADC5PSC           \ [0x18 : 5] ADC5PSC
  [then]


  [ifdef] HRTIM_COMMON_ADCPS2_DEF
    \
    \ @brief HRTIM ADC Post Scaler Register 2
    \ Address offset: 0x84
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_ADC6PSC           \ [0x00 : 5] ADC6PSC
    $06 constant HRTIM_COMMON_ADC7PSC           \ [0x06 : 5] ADC7PSC
    $0c constant HRTIM_COMMON_ADC8PSC           \ [0x0c : 5] ADC8PSC
    $12 constant HRTIM_COMMON_ADC9PSC           \ [0x12 : 5] ADC9PSC
    $18 constant HRTIM_COMMON_ADC10PSC          \ [0x18 : 5] ADC10PSC
  [then]


  [ifdef] HRTIM_COMMON_FLTINR3_DEF
    \
    \ @brief HRTIM Fault Input Register 3
    \ Address offset: 0x88
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_FLT1BLKE          \ [0x00] FLT1BLKE
    $01 constant HRTIM_COMMON_FLT1BLKS          \ [0x01] FLT1BLKS
    $02 constant HRTIM_COMMON_FLT1CNT           \ [0x02 : 4] FLT1CNT
    $06 constant HRTIM_COMMON_FLT1CRES          \ [0x06] FLT1CRES
    $07 constant HRTIM_COMMON_FLT1RSTM          \ [0x07] FLT1RSTM
    $08 constant HRTIM_COMMON_FLT2BLKE          \ [0x08] FLT2BLKE
    $09 constant HRTIM_COMMON_FLT2BLKS          \ [0x09] FLT2BLKS
    $0a constant HRTIM_COMMON_FLT2CNT           \ [0x0a : 4] FLT2CNT
    $0e constant HRTIM_COMMON_FLT2CRES          \ [0x0e] FLT2CRES
    $0f constant HRTIM_COMMON_FLT2RSTM          \ [0x0f] FLT2RSTM
    $10 constant HRTIM_COMMON_FLT3BLKE          \ [0x10] FLT3BLKE
    $11 constant HRTIM_COMMON_FLT3BLKS          \ [0x11] FLT3BLKS
    $12 constant HRTIM_COMMON_FLT3CNT           \ [0x12 : 4] FLT3CNT
    $16 constant HRTIM_COMMON_FLT3CRES          \ [0x16] FLT3CRES
    $17 constant HRTIM_COMMON_FLT3RSTM          \ [0x17] FLT3RSTM
    $18 constant HRTIM_COMMON_FLT4BLKE          \ [0x18] FLT4BLKE
    $19 constant HRTIM_COMMON_FLT4BLKS          \ [0x19] FLT4BLKS
    $1a constant HRTIM_COMMON_FLT4CNT           \ [0x1a : 4] FLT4CNT
    $1e constant HRTIM_COMMON_FLT4CRES          \ [0x1e] FLT4CRES
    $1f constant HRTIM_COMMON_FLT4RSTM          \ [0x1f] FLT4RSTM
  [then]


  [ifdef] HRTIM_COMMON_FLTINR4_DEF
    \
    \ @brief HRTIM Fault Input Register 4
    \ Address offset: 0x8C
    \ Reset value: 0x00000000
    \
    $00 constant HRTIM_COMMON_FLT5BLKE          \ [0x00] FLT5BLKE
    $01 constant HRTIM_COMMON_FLT5BLKS          \ [0x01] FLT5BLKS
    $02 constant HRTIM_COMMON_FLT5CNT           \ [0x02 : 4] FLT5CNT
    $06 constant HRTIM_COMMON_FLT5CRES          \ [0x06] FLT5CRES
    $07 constant HRTIM_COMMON_FLT5RSTM          \ [0x07] FLT5RSTM
    $08 constant HRTIM_COMMON_FLT6BLKE          \ [0x08] FLT6BLKE
    $09 constant HRTIM_COMMON_FLT6BLKS          \ [0x09] FLT6BLKS
    $0a constant HRTIM_COMMON_FLT6CNT           \ [0x0a : 4] FLT6CNT
    $0e constant HRTIM_COMMON_FLT6CRES          \ [0x0e] FLT6CRES
    $0f constant HRTIM_COMMON_FLT6RSTM          \ [0x0f] FLT6RSTM
  [then]
  ...
  $74 constant HRTIM_COMMON_BDTFUPR     \ Burst DMA Timerx update Register
  $78 constant HRTIM_COMMON_ADCER       \ HRTIM ADC Extended Trigger Register
  $7C constant HRTIM_COMMON_ADCUR       \ HRTIM ADC Trigger Update Register
  $80 constant HRTIM_COMMON_ADCPS1      \ HRTIM ADC Post Scaler Register 1
  $84 constant HRTIM_COMMON_ADCPS2      \ HRTIM ADC Post Scaler Register 2
  $88 constant HRTIM_COMMON_FLTINR3     \ HRTIM Fault Input Register 3
  $8C constant HRTIM_COMMON_FLTINR4     \ HRTIM Fault Input Register 4
