...
$00000004 constant RTC_RTC_ICSR_WUTWF                               \ Wake-up timer write flag This bit is set by hardware when WUT value can be changed, after the WUTE bit has been set to 0 in RTC_CR. It is cleared by hardware in initialization mode.
...
$00000010 constant RTC_RTC_CR_REFCKON                               \ RTC_REFIN reference clock detection enable (50 or 601Hz) Note: BIN must be 0x00 and PREDIV_S must be 0x00FF.
...
$00000400 constant RTC_RTC_CR_WUTE                                  \ Wake-up timer enable Note: When the wake-up timer is disabled, wait for WUTWF = 1 before enabling it again.
...
$00004000 constant RTC_RTC_CR_WUTIE                                 \ Wake-up timer interrupt enable
...
$00080000 constant RTC_RTC_CR_COSEL                                 \ Calibration output selection When COE = 1, this bit selects which signal is output on CALIB. These frequencies are valid for RTCCLK at 32.7681kHz and prescalers at their default values (PREDIV_A = 127 and PREDIV_S = 255). Refer to Section128.3.16: Calibration clock output.
...
$02000000 constant RTC_RTC_CR_TAMPTS                                \ Activate timestamp on tamper detection event TAMPTS is valid even if TSE = 0 in the RTC_CR register. Timestamp flag is set up to 3 ck_apre cycles after the tamper flags. Note: TAMPTS must be cleared before entering RTC initialization mode.
...
$80000000 constant RTC_RTC_CR_OUT2EN                                \ RTC_OUT2 output enable
...
$000001ff constant RTC_RTC_CALR_CALM                                \ Calibration minus The frequency of the calendar is reduced by masking CALM out of 2<sup>20</sup> RTCCLK pulses (321seconds if the input frequency is 327681Hz). This decreases the frequency of the calendar with a resolution of 0.95371ppm. To increase the frequency of the calendar, this feature should be used in conjunction with CALP. See Section128.3.14: RTC smooth digital calibration on page1733.
$00001000 constant RTC_RTC_CALR_LPCAL                               \ RTC low-power mode
$00002000 constant RTC_RTC_CALR_CALW16                              \ Use a 16-second calibration cycle period When CALW16 is set to 1, the 16-second calibration cycle period is selected. This bit must not be set to 1 if CALW8 = 1. Note: CALM[0] is stuck at 0 when CALW16 = 1. Refer to Section128.3.14: RTC smooth digital calibration.
$00004000 constant RTC_RTC_CALR_CALW8                               \ Use an 8-second calibration cycle period When CALW8 is set to 1, the 8-second calibration cycle period is selected. Note: CALM[1:0] are stuck at 00 when CALW8 = 1. Refer to Section128.3.14: RTC smooth digital calibration.
$00008000 constant RTC_RTC_CALR_CALP                                \ Increase frequency of RTC by 488.51ppm.
...
$00007fff constant RTC_RTC_ALRMASSR_SS                              \ Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm A is to be activated. Only bits 0 up MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRABINR, and so can also be read or written through RTC_ALRABINR.
...
$00007fff constant RTC_RTC_ALRMBSSR_SS                              \ Subseconds value This value is compared with the contents of the synchronous prescaler counter to determine if alarm B is to be activated. Only bits 0 up to MASKSS-1 are compared. This field is the mirror of SS[14:0] in the RTC_ALRBBINR, and so can also be read or written through RTC_ALRBBINR.
...
$00000004 constant RTC_RTC_MISR_WUTMF                               \ Wake-up timer masked flag This flag is set by hardware when the wake-up timer interrupt occurs. This flag must be cleared by software at least 1.5 RTCCLK periods before WUTF is set to 1 again.
...
$00000040 constant RTC_RTC_MISR_SSRUMF                              \ SSR underflow masked flag This flag is set by hardware when the SSR underflow interrupt occurs.
...
$00000004 constant RTC_RTC_SCR_CWUTF                                \ Clear wake-up timer flag Writing 1 in this bit clears the WUTF bit in the RTC_SR register.
$00000008 constant RTC_RTC_SCR_CTSF                                 \ Clear timestamp flag Writing 1 in this bit clears the TSF bit in the RTC_SR register. If ITSF flag is set, TSF must be cleared together with ITSF by setting CRSF and CITSF.
...
\ @brief RTC register block
\
$40002800 constant RTC_RTC_TR     \ offset: 0x00 : RTC time register
$40002804 constant RTC_RTC_DR     \ offset: 0x04 : RTC date register
$40002808 constant RTC_RTC_SSR    \ offset: 0x08 : RTC subsecond register
$4000280c constant RTC_RTC_ICSR   \ offset: 0x0C : RTC initialization control and status register
$40002810 constant RTC_RTC_PRER   \ offset: 0x10 : RTC prescaler register
$40002814 constant RTC_RTC_WUTR   \ offset: 0x14 : RTC wake-up timer register
$40002818 constant RTC_RTC_CR     \ offset: 0x18 : RTC control register
$40002824 constant RTC_RTC_WPR    \ offset: 0x24 : RTC write protection register
$40002828 constant RTC_RTC_CALR   \ offset: 0x28 : RTC calibration register
$4000282c constant RTC_RTC_SHIFTR  \ offset: 0x2C : RTC shift control register
$40002830 constant RTC_RTC_TSTR   \ offset: 0x30 : RTC timestamp time register
$40002834 constant RTC_RTC_TSDR   \ offset: 0x34 : RTC timestamp date register
$40002838 constant RTC_RTC_TSSSR  \ offset: 0x38 : RTC timestamp subsecond register
$40002840 constant RTC_RTC_ALRMAR  \ offset: 0x40 : RTC alarm A register
$40002844 constant RTC_RTC_ALRMASSR  \ offset: 0x44 : RTC alarm A subsecond register
$40002848 constant RTC_RTC_ALRMBR  \ offset: 0x48 : RTC alarm B register
$4000284c constant RTC_RTC_ALRMBSSR  \ offset: 0x4C : RTC alarm B subsecond register
$40002850 constant RTC_RTC_SR     \ offset: 0x50 : RTC status register
$40002854 constant RTC_RTC_MISR   \ offset: 0x54 : RTC masked interrupt status register
$4000285c constant RTC_RTC_SCR    \ offset: 0x5C : RTC status clear register
$40002870 constant RTC_RTC_ALRABINR  \ offset: 0x70 : RTC alarm A binary mode register
$40002874 constant RTC_RTC_ALRBBINR  \ offset: 0x74 : RTC alarm B binary mode register
