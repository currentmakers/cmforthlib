...
[ifndef] TIM8_DEF
  ...
  [ifdef] TIM8_TIM8_SMCR_DEF
    ...
    $0c constant TIM8_ETPS                      \ [0x0c : 2] External trigger prescaler External trigger signal ETRP frequency must be at most 1/4 of f<sub>CK_INT</sub> frequency. A prescaler can be enabled to reduce ETRP frequency. It is useful when inputting fast external clocks.
    ...
    $10 constant TIM8_SMS_1                     \ [0x10] SMS[3]
    $14 constant TIM8_TS_1                      \ [0x14 : 2] TS[4:3]
  [then]
  ...
  [ifdef] TIM8_TIM8_CCMR1_DEF
    ...
    $02 constant TIM8_IC1PSC                    \ [0x02 : 2] Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E= 0 (TIMx_CCER register).
  ...
  [ifdef] TIM8_TIM8_CCMR1_ALTERNATE_DEF
    \
    \ @brief TIM8 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
    ...
    $0c constant TIM8_OC2M                      \ [0x0c : 3] OC2M[2:0]: Output Compare 2 mode Refer to OC1M[3:0] description.
  ...
  [ifdef] TIM8_TIM8_CCMR2_ALTERNATE_DEF
    \
    \ @brief TIM8 capture/compare mode register 2
    \ Address offset: 0x1C
    \ Reset value: 0x00000000
    ...
    $04 constant TIM8_OC3M                      \ [0x04 : 3] OC3M[2:0]: Output compare 3 mode Refer to OC1M[3:0] description.
    ...
    $0c constant TIM8_OC4M                      \ [0x0c : 3] OC4M[2:0]: Output compare 4 mode Refer to OC3M[3:0] description.
  ...
  [ifdef] TIM8_TIM8_ARR_DEF
    ...
    \
    $00 constant TIM8_ARR                       \ [0x00 : 16] Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 24.3.1: Time-base unit on page 691 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM8_TIM8_CCMR3_DEF
    ...
    $04 constant TIM8_OC5M                      \ [0x04 : 3] OC5M[0]: Output compare 5 mode Refer to OC1M description.
    ...
    $0c constant TIM8_OC6M                      \ [0x0c : 3] OC6M[0]: Output compare 6 mode Refer to OC1M description.
  ...
  [ifdef] TIM8_TIM8_AF1_DEF
    ...
    \
    $00 constant TIM8_BKINE                     \ [0x00] BRK BKIN input enable This bit enables the BKIN alternate function input for the timer s BRK input. BKIN input is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM8_BKCMP1E                   \ [0x01] BRK COMP1 enable This bit enables the COMP1 for the timer s BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM8_BKCMP2E                   \ [0x02] BRK COMP2 enable This bit enables the COMP2 for the timer s BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $08 constant TIM8_BKDF1BK2E                 \ [0x08] BRK dfsdm1_break[2] enable This bit enables the dfsdm1_break[2] for the timer s BRK input. dfsdm1_break[2] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    ...
    $0a constant TIM8_BKCMP1P                   \ [0x0a] BRK COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $0b constant TIM8_BKCMP2P                   \ [0x0b] BRK COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  ...
  [ifdef] TIM8_TIM8_AF2_DEF
    ...
    \ Reset value: 0x00000001
    \
    $00 constant TIM8_BK2INE                    \ [0x00] BRK2 BKIN input enable This bit enables the BKIN2 alternate function input for the timer s BRK2 input. BKIN2 input is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM8_BK2CMP1E                  \ [0x01] BRK2 COMP1 enable This bit enables the COMP1 for the timer s BRK2 input. COMP1 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM8_BK2CMP2E                  \ [0x02] BRK2 COMP2 enable This bit enables the COMP2 for the timer s BRK2 input. COMP2 output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $08 constant TIM8_BK2DF1BK3E                \ [0x08] BRK2 dfsdm1_break[3] enable This bit enables the dfsdm1_break[3] for the timer s BRK2 input. dfsdm1_break[3] output is ORed with the other BRK2 sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    ...
    $0a constant TIM8_BK2CMP1P                  \ [0x0a] BRK2 COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $0b constant TIM8_BK2CMP2P                  \ [0x0b] BRK2 COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BK2P polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]
  ...
  $18 constant TIM8_TIM8_CCMR1_ALTERNATE    \ TIM8 capture/compare mode register 1
  $1C constant TIM8_TIM8_CCMR2          \ TIM8 capture/compare mode register 2
  $1C constant TIM8_TIM8_CCMR2_ALTERNATE    \ TIM8 capture/compare mode register 2
