...
[ifndef] DAC_DEF
  ...
  [ifdef] DAC_CR_DEF
    ...
    $0e constant DAC_CEN1                       \ [0x0e] DAC Channel 1 calibration enable
    ...
    $1e constant DAC_CEN2                       \ [0x1e] DAC Channel 2 calibration enable
  [then]
  ...
  [ifdef] DAC_SR_DEF
    ...
    $0e constant DAC_CAL_FLAG1                  \ [0x0e] DAC Channel 1 calibration offset status
    $0f constant DAC_BWST1                      \ [0x0f] DAC Channel 1 busy writing sample time flag
    $1d constant DAC_DMAUDR2                    \ [0x1d] DAC channel2 DMA underrun flag
    $1e constant DAC_CAL_FLAG2                  \ [0x1e] DAC Channel 2 calibration offset status
    $1f constant DAC_BWST2                      \ [0x1f] DAC Channel 2 busy writing sample time flag
  [then]
  ...
  [ifdef] DAC_MCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DAC_MODE1                      \ [0x00 : 3] DAC Channel 1 mode
    $10 constant DAC_MODE2                      \ [0x10 : 3] DAC Channel 2 mode
  [then]
  ...
  [ifdef] DAC_SHSR1_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DAC_TSAMPLE1                   \ [0x00 : 10] DAC Channel 1 sample Time
  [then]
  ...
  [ifdef] DAC_SHSR2_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant DAC_TSAMPLE2                   \ [0x00 : 10] DAC Channel 2 sample Time
  [then]
  ...
  [ifdef] DAC_SHHR_DEF
    ...
    \
    $00 constant DAC_THOLD1                     \ [0x00 : 10] DAC Channel 1 hold Time
    $10 constant DAC_THOLD2                     \ [0x10 : 10] DAC Channel 2 hold time
  [then]
  ...
  [ifdef] DAC_SHRR_DEF
    ...
    \
    $00 constant DAC_TREFRESH1                  \ [0x00 : 8] DAC Channel 1 refresh Time
    $10 constant DAC_TREFRESH2                  \ [0x10 : 8] DAC Channel 2 refresh Time
  [then]
  ...
  $38 constant DAC_CCR                  \ calibration control register
  $3C constant DAC_MCR                  \ mode control register
  $40 constant DAC_SHSR1                \ Sample and Hold sample time register 1
  $44 constant DAC_SHSR2                \ Sample and Hold sample time register 2
  $48 constant DAC_SHHR                 \ Sample and Hold hold time register
  $4C constant DAC_SHRR                 \ Sample and Hold refresh time register
