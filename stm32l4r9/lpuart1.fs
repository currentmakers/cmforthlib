...
[ifndef] LPUART1_DEF
  ...
  [ifdef] LPUART1_LPUART_CR1_ALTERNATE_DEF
    \
    \ @brief LPUART control register 1
    \ Address offset: 0x00
    \ Reset value: 0x00000000
  ...
  [ifdef] LPUART1_LPUART_ISR_ALTERNATE_DEF
    \
    \ @brief LPUART interrupt and status register
    \ Address offset: 0x1C
    \ Reset value: 0x008000C0
    \
    $00 constant LPUART1_PE                     \ [0x00] Parity error This bit is set by hardware when a parity error occurs in receiver mode. It is cleared by software, writing 1 to the PECF in the LPUART_ICR register. An interrupt is generated if PEIE = 1 in the LPUART_CR1 register.
  ...
  [ifdef] LPUART1_LPUART_ICR_DEF
    ...
    $14 constant LPUART1_WUCF                   \ [0x14] Wakeup from low-power mode clear flag Writing 1 to this bit clears the WUF flag in the LPUART_ISR register. Note: If the LPUART does not support the wakeup from Stop feature, this bit is reserved and kept at reset value. Refer to Section 33.4: USART implementation.
  [then]
  ...
  [ifdef] LPUART1_LPUART_RDR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant LPUART1_RDR                    \ [0x00 : 9] Receive data value Contains the received data character. The RDR register provides the parallel interface between the input shift register and the internal bus (see Figure 347). When receiving with the parity enabled, the value read in the MSB bit is the received parity bit.
  [then]
  ...
  $00 constant LPUART1_LPUART_CR1_ALTERNATE    \ LPUART control register 1
  ...
  $1C constant LPUART1_LPUART_ISR_ALTERNATE    \ LPUART interrupt and status register
