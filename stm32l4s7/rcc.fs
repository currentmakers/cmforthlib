...
$00100000 constant RCC_PLLSAI2CFGR_PLLSAI2QEN                       \ PLLSAI2 division factor for PLLDISCLK
$00600000 constant RCC_PLLSAI2CFGR_PLLSAI2Q                         \ SAI2PLL PLLSAI2CLK output enable
...
$00040000 constant RCC_AHB1RSTR_GFXMMURST                           \ GFXMMU reset
...
$00100000 constant RCC_AHB2RSTR_OSPIMRST                            \ OCTOSPI IO manager reset
...
$00000200 constant RCC_AHB3RSTR_OSPI2RST                            \ OctOSPI2 memory interface reset
...
$04000000 constant RCC_APB2RSTR_LTDCRST                             \ LCD-TFT reset
$08000000 constant RCC_APB2RSTR_DSIRST                              \ DSI reset
...
$00040000 constant RCC_AHB1ENR_GFXMMUEN                             \ Graphic MMU clock enable
...
$00100000 constant RCC_AHB2ENR_OSPIMEN                              \ OctoSPI IO manager clock enable
...
$00000200 constant RCC_AHB3ENR_OSPI2EN                              \ OSPI2EN memory interface clock enable
...
$00000080 constant RCC_APB2ENR_FWEN                                 \ Firewall clock enable
...
$04000000 constant RCC_APB2ENR_LTDCEN                               \ LCD-TFT clock enable
$08000000 constant RCC_APB2ENR_DSIEN                                \ DSI clock enable
...
$00040000 constant RCC_AHB1SMENR_GFXMMUSMEN                         \ GFXMMU clock enable during Sleep and Stop modes
...
$00000400 constant RCC_AHB2SMENR_SRAM3SMEN                          \ SRAM2 interface clocks enable during Sleep and Stop modes
...
$00100000 constant RCC_AHB2SMENR_OSPIMSMEN                          \ OctoSPI IO manager clocks enable during Sleep and Stop modes
...
$00000200 constant RCC_AHB3SMENR_OCTOSPI2                           \ OctoSPI2 memory interface clocks enable during Sleep and Stop modes
...
$04000000 constant RCC_APB2SMENR_LTDCSMEN                           \ LCD-TFT timer clocks enable during Sleep and Stop modes
$08000000 constant RCC_APB2SMENR_DSISMEN                            \ DSI clocks enable during Sleep and Stop modes
...
$01000000 constant RCC_CSR_FWRSTF                                   \ Firewall reset flag
...
$00001000 constant RCC_CCIPR2_DSISEL                                \ clock selection
$00004000 constant RCC_CCIPR2_SDMMCSEL                              \ SDMMC clock selection
$00030000 constant RCC_CCIPR2_PLLSAI2DIVR                           \ division factor for LTDC clock
