...
[ifndef] TIM16_DEF
  ...
  [ifdef] TIM16_TIM16_CR1_DEF
    ...
    $08 constant TIM16_CKD                      \ [0x08 : 2] Clock division This bit-field indicates the division ratio between the timer clock (CK_INT) frequency and the dead-time and sampling clock (t<sub>DTS</sub>)used by the dead-time generators and the digital filters (TIx),
  ...
  [ifdef] TIM16_TIM16_CR2_DEF
    ...
    $08 constant TIM16_OIS1                     \ [0x08] Output Idle state 1 (OC1 output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
    $09 constant TIM16_OIS1N                    \ [0x09] Output Idle state 1 (OC1N output) Note: This bit can not be modified as long as LOCK level 1, 2 or 3 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]
  ...
  [ifdef] TIM16_TIM16_SR_DEF
    ...
    $07 constant TIM16_BIF                      \ [0x07] Break interrupt flag This flag is set by hardware as soon as the break input goes active. It can be cleared by software if the break input is not active.
  ...
  [ifdef] TIM16_TIM16_CCMR1_DEF
    ...
    $02 constant TIM16_IC1PSC                   \ [0x02 : 2] Input capture 1 prescaler This bit-field defines the ratio of the prescaler acting on CC1 input (IC1). The prescaler is reset as soon as CC1E= 0 (TIMx_CCER register).
  ...
  [ifdef] TIM16_TIM16_CCMR1_ALTERNATE_DEF
    \
    \ @brief TIM16 capture/compare mode register 1
    \ Address offset: 0x18
    \ Reset value: 0x00000000
  ...
  [ifdef] TIM16_TIM16_CCER_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_CC1E                     \ [0x00] Capture/Compare 1 output enable When CC1 channel is configured as output, the OC1 level depends on MOE, OSSI, OSSR, OIS1, OIS1N and CC1NE bits, regardless of the CC1E bits state. Refer to Table 186 for details.
    ...
    $03 constant TIM16_CC1NP                    \ [0x03] Capture/Compare 1 complementary output polarity
  [then]
  ...
  [ifdef] TIM16_TIM16_CNT_DEF
    ...
    $1f constant TIM16_UIFCPY                   \ [0x1f] UIF Copy This bit is a read-only copy of the UIF bit of the TIMx_ISR register. If the UIFREMAP bit in TIMx_CR1 is reset, bit 31 is reserved and read as 0.
  [then]
  ...
  [ifdef] TIM16_TIM16_ARR_DEF
    ...
    \
    $00 constant TIM16_ARR                      \ [0x00 : 16] Auto-reload value ARR is the value to be loaded in the actual auto-reload register. Refer to the Section 26.5.1: Time-base unit on page 862 for more details about ARR update and behavior. The counter is blocked while the auto-reload value is null.
  [then]
  ...
  [ifdef] TIM16_TIM16_BDTR_DEF
    ...
    $0c constant TIM16_BKE                      \ [0x0c] Break enable 1; Break inputs (BRK and CCS clock failure event) enabled Note: This bit cannot be modified when LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register). Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become effective.
  ...
  [ifdef] TIM16_TIM16_AF1_DEF
    ...
    \
    $00 constant TIM16_BKINE                    \ [0x00] BRK BKIN input enable This bit enables the BKIN alternate function input for the timer s BRK input. BKIN input is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $01 constant TIM16_BKCMP1E                  \ [0x01] BRK COMP1 enable This bit enables the COMP1 for the timer s BRK input. COMP1 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $02 constant TIM16_BKCMP2E                  \ [0x02] BRK COMP2 enable This bit enables the COMP2 for the timer s BRK input. COMP2 output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $08 constant TIM16_BKDF1BK1E                \ [0x08] BRK dfsdm1_break[1] enable This bit enables the dfsdm1_break[1] for the timer s BRK input. dfsdm1_break[1] output is ORed with the other BRK sources. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $09 constant TIM16_BKINP                    \ [0x09] BRK BKIN input polarity This bit selects the BKIN alternate function input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $0a constant TIM16_BKCMP1P                  \ [0x0a] BRK COMP1 input polarity This bit selects the COMP1 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
    $0b constant TIM16_BKCMP2P                  \ [0x0b] BRK COMP2 input polarity This bit selects the COMP2 input sensitivity. It must be programmed together with the BKP polarity bit. Note: This bit can not be modified as long as LOCK level 1 has been programmed (LOCK bits in TIMx_BDTR register).
  [then]
  ...
  [ifdef] TIM16_TIM16_TISEL_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant TIM16_TI1SEL                   \ [0x00 : 4] selects TI1[0] to TI1[15] input Other: Reserved
  [then]
  ...
  $18 constant TIM16_TIM16_CCMR1        \ TIM16 capture/compare mode register 1
  $18 constant TIM16_TIM16_CCMR1_ALTERNATE    \ TIM16 capture/compare mode register 1
  ...
  $48 constant TIM16_TIM16_DCR          \ TIM16 DMA control register
  $4C constant TIM16_TIM16_DMAR         \ TIM16 DMA address for full transfer
