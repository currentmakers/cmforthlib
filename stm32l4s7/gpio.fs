...
[ifndef] GPIO_DEF
  ...
  [ifdef] GPIO_ASCR_DEF
    ...
    \ Reset value: 0x00000000
    \
    $00 constant GPIO_ASC0                      \ [0x00] Port analog switch control
    $01 constant GPIO_ASC1                      \ [0x01] Port analog switch control
    $02 constant GPIO_ASC2                      \ [0x02] Port analog switch control
    $03 constant GPIO_ASC3                      \ [0x03] Port analog switch control
    $04 constant GPIO_ASC4                      \ [0x04] Port analog switch control
    $05 constant GPIO_ASC5                      \ [0x05] Port analog switch control
    $06 constant GPIO_ASC6                      \ [0x06] Port analog switch control
    $07 constant GPIO_ASC7                      \ [0x07] Port analog switch control
    $08 constant GPIO_ASC8                      \ [0x08] Port analog switch control
    $09 constant GPIO_ASC9                      \ [0x09] Port analog switch control
    $0a constant GPIO_ASC10                     \ [0x0a] Port analog switch control
    $0b constant GPIO_ASC11                     \ [0x0b] Port analog switch control
    $0c constant GPIO_ASC12                     \ [0x0c] Port analog switch control
    $0d constant GPIO_ASC13                     \ [0x0d] Port analog switch control
    $0e constant GPIO_ASC14                     \ [0x0e] Port analog switch control
    $0f constant GPIO_ASC15                     \ [0x0f] Port analog switch control
  [then]
  ...
  $2C constant GPIO_ASCR                \ GPIO port analog switch control register
